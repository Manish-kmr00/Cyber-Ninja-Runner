...
public final class HttpMessagePropertiesKt {
    ...
    public static final List<String> vary(HttpMessageBuilder httpMessageBuilder) {
        ...
        while (it.hasNext()) {
            List listSplit$default = StringsKt.split$default((CharSequence) it.next(), new String[]{StringUtils.COMMA}, false, 0, 6, (Object) null);
    ...
    public static final List<String> splitSetCookieHeader(String str) {
        ...
        ArrayList arrayList = new ArrayList();
        int iIndexOf$default2 = StringsKt.indexOf$default((CharSequence) str2, cc.T, iIndexOf$default, false, 4, (Object) null);
        ...
        while (i3 < str.length() && i2 > 0) {
            if (iIndexOf$default4 < i2) {
                iIndexOf$default4 = StringsKt.indexOf$default((CharSequence) str2, cc.T, i2, false, 4, (Object) null);
            }
