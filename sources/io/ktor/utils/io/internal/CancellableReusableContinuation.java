...
public final class CancellableReusableContinuation<T> implements Continuation<T> {
    ...
    public final void close(T value) {
        ...
        resumeWith(Result.m7904constructorimpl(value));
    ...
    public final void close(Throwable cause) {
        ...
        Result.Companion companion = Result.INSTANCE;
        resumeWith(Result.m7904constructorimpl(ResultKt.createFailure(cause)));
        JobRelation jobRelation = (JobRelation) jobCancellationHandler$FU.getAndSet(this, null);
        if (jobRelation != null) {
            jobRelation.dispose();
        }
    ...
    public void resumeWith(Object result) throws Throwable {
        Object obj;
        Object objM7907exceptionOrNullimpl;
        do {
            obj = this.state;
            if (obj == null) {
                objM7907exceptionOrNullimpl = Result.m7907exceptionOrNullimpl(result);
                if (objM7907exceptionOrNullimpl == null) {
                    ResultKt.throwOnFailure(result);
                    objM7907exceptionOrNullimpl = result;
                }
            } else if (!(obj instanceof Continuation)) {
                return;
            } else {
                objM7907exceptionOrNullimpl = null;
            }
        } while (!AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(state$FU, this, obj, objM7907exceptionOrNullimpl));
    ...
    public final void resumeWithExceptionContinuationOnly(Job job, Throwable exception) {
        ...
        Result.Companion companion = Result.INSTANCE;
        continuation.resumeWith(Result.m7904constructorimpl(ResultKt.createFailure(exception)));
    }
}
