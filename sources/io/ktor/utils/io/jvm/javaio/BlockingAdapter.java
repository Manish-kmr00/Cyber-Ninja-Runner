...
abstract class BlockingAdapter {
    ...
    public BlockingAdapter(Job job) {
        ...
        Continuation<Unit> continuation = new Continuation<Unit>() { // from class: io.ktor.utils.io.jvm.javaio.BlockingAdapter$end$1
            ...
            public void resumeWith(Object result) {
                ...
                Job parent;
                Object objM7907exceptionOrNullimpl = Result.m7907exceptionOrNullimpl(result);
                if (objM7907exceptionOrNullimpl == null) {
                    objM7907exceptionOrNullimpl = Unit.INSTANCE;
                }
                ...
                } while (!AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(BlockingAdapter.state$FU, blockingAdapter, obj, objM7907exceptionOrNullimpl));
                if (z) {
                    PollersKt.getParkingImpl().unpark(obj);
                } else if ((obj instanceof Continuation) && (thM7907exceptionOrNullimpl = Result.m7907exceptionOrNullimpl(result)) != null) {
                    Result.Companion companion = Result.INSTANCE;
                    ((Continuation) obj).resumeWith(Result.m7904constructorimpl(ResultKt.createFailure(thM7907exceptionOrNullimpl)));
                }
                if (Result.m7910isFailureimpl(result) && !(Result.m7907exceptionOrNullimpl(result) instanceof CancellationException) && (parent = this.this$0.getParent()) != null) {
        ...
        this.disposable = job != null ? job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: io.ktor.utils.io.jvm.javaio.BlockingAdapter$disposable$1
            ...
            public final void invoke2(Throwable th) {
                if (th != null) {
                    ...
                    Result.Companion companion = Result.INSTANCE;
                    continuation2.resumeWith(Result.m7904constructorimpl(ResultKt.createFailure(th)));
                }
            }
        }) : null;
    ...
    public final void shutdown() {
        ...
        Result.Companion companion = Result.INSTANCE;
        continuation.resumeWith(Result.m7904constructorimpl(ResultKt.createFailure(new CancellationException("Stream closed"))));
    }
    ...
    public final int submitAndAwait(Object jobToken) throws Throwable {
        ...
        Result.Companion companion = Result.INSTANCE;
        continuation.resumeWith(Result.m7904constructorimpl(jobToken));
