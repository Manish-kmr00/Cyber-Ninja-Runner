...
public final class MemoryPrimitivesJvmKt {
    ...
    public static final short m7669loadShortAteY85DW0(ByteBuffer loadShortAt, int i) {
        Intrinsics.checkNotNullParameter(loadShortAt, "$this$loadShortAt");
        return loadShortAt.getShort(i);
    }

    /* JADX INFO: renamed from: loadShortAt-eY85DW0, reason: not valid java name */
    public static final short m7670loadShortAteY85DW0(ByteBuffer loadShortAt, long j) {
        Intrinsics.checkNotNullParameter(loadShortAt, "$this$loadShortAt");
        if (j < 2147483647L) {
    ...
    public static final int m7665loadIntAteY85DW0(ByteBuffer loadIntAt, int i) {
        Intrinsics.checkNotNullParameter(loadIntAt, "$this$loadIntAt");
        return loadIntAt.getInt(i);
    }

    /* JADX INFO: renamed from: loadIntAt-eY85DW0, reason: not valid java name */
    public static final int m7666loadIntAteY85DW0(ByteBuffer loadIntAt, long j) {
        Intrinsics.checkNotNullParameter(loadIntAt, "$this$loadIntAt");
        if (j < 2147483647L) {
    ...
    public static final long m7667loadLongAteY85DW0(ByteBuffer loadLongAt, int i) {
        Intrinsics.checkNotNullParameter(loadLongAt, "$this$loadLongAt");
        return loadLongAt.getLong(i);
    }

    /* JADX INFO: renamed from: loadLongAt-eY85DW0, reason: not valid java name */
    public static final long m7668loadLongAteY85DW0(ByteBuffer loadLongAt, long j) {
        Intrinsics.checkNotNullParameter(loadLongAt, "$this$loadLongAt");
        if (j < 2147483647L) {
    ...
    public static final float m7663loadFloatAteY85DW0(ByteBuffer loadFloatAt, int i) {
        Intrinsics.checkNotNullParameter(loadFloatAt, "$this$loadFloatAt");
        return loadFloatAt.getFloat(i);
    }

    /* JADX INFO: renamed from: loadFloatAt-eY85DW0, reason: not valid java name */
    public static final float m7664loadFloatAteY85DW0(ByteBuffer loadFloatAt, long j) {
        Intrinsics.checkNotNullParameter(loadFloatAt, "$this$loadFloatAt");
        if (j < 2147483647L) {
    ...
    public static final double m7661loadDoubleAteY85DW0(ByteBuffer loadDoubleAt, int i) {
        Intrinsics.checkNotNullParameter(loadDoubleAt, "$this$loadDoubleAt");
        return loadDoubleAt.getDouble(i);
    }

    /* JADX INFO: renamed from: loadDoubleAt-eY85DW0, reason: not valid java name */
    public static final double m7662loadDoubleAteY85DW0(ByteBuffer loadDoubleAt, long j) {
        Intrinsics.checkNotNullParameter(loadDoubleAt, "$this$loadDoubleAt");
        if (j < 2147483647L) {
    ...
    public static final void m7675storeIntAt62zg_DM(ByteBuffer storeIntAt, int i, int i2) {
    ...
    public static final void m7679storeShortAt62zg_DM(ByteBuffer storeShortAt, int i, short s) {
    ...
    public static final void m7677storeLongAt62zg_DM(ByteBuffer storeLongAt, int i, long j) {
    ...
    public static final void m7673storeFloatAt62zg_DM(ByteBuffer storeFloatAt, int i, float f) {
    ...
    public static final void m7671storeDoubleAt62zg_DM(ByteBuffer storeDoubleAt, int i, double d) {
        Intrinsics.checkNotNullParameter(storeDoubleAt, "$this$storeDoubleAt");
        storeDoubleAt.putDouble(i, d);
    }

    /* JADX INFO: renamed from: storeIntAt-62zg_DM, reason: not valid java name */
    public static final void m7676storeIntAt62zg_DM(ByteBuffer storeIntAt, long j, int i) {
        Intrinsics.checkNotNullParameter(storeIntAt, "$this$storeIntAt");
        if (j >= 2147483647L) {
            NumbersKt.failLongToIntConversion(j, "offset");
            throw new KotlinNothingValueException();
    ...
    /* JADX INFO: renamed from: storeShortAt-62zg_DM, reason: not valid java name */
    public static final void m7680storeShortAt62zg_DM(ByteBuffer storeShortAt, long j, short s) {
        Intrinsics.checkNotNullParameter(storeShortAt, "$this$storeShortAt");
        if (j >= 2147483647L) {
            NumbersKt.failLongToIntConversion(j, "offset");
            throw new KotlinNothingValueException();
    ...
    /* JADX INFO: renamed from: storeLongAt-62zg_DM, reason: not valid java name */
    public static final void m7678storeLongAt62zg_DM(ByteBuffer storeLongAt, long j, long j2) {
        Intrinsics.checkNotNullParameter(storeLongAt, "$this$storeLongAt");
        if (j >= 2147483647L) {
            NumbersKt.failLongToIntConversion(j, "offset");
            throw new KotlinNothingValueException();
    ...
    /* JADX INFO: renamed from: storeFloatAt-62zg_DM, reason: not valid java name */
    public static final void m7674storeFloatAt62zg_DM(ByteBuffer storeFloatAt, long j, float f) {
        Intrinsics.checkNotNullParameter(storeFloatAt, "$this$storeFloatAt");
        if (j >= 2147483647L) {
            NumbersKt.failLongToIntConversion(j, "offset");
            throw new KotlinNothingValueException();
    ...
    /* JADX INFO: renamed from: storeDoubleAt-62zg_DM, reason: not valid java name */
    public static final void m7672storeDoubleAt62zg_DM(ByteBuffer storeDoubleAt, long j, double d) {
        Intrinsics.checkNotNullParameter(storeDoubleAt, "$this$storeDoubleAt");
        if (j >= 2147483647L) {
            NumbersKt.failLongToIntConversion(j, "offset");
            throw new KotlinNothingValueException();
