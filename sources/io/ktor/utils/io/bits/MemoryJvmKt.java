...
public final class MemoryJvmKt {
    ...
    public static final void m7648copyTo9zorpBc(ByteBuffer copyTo, byte[] destination, int i, int i2, int i3) {
    ...
    /* JADX INFO: renamed from: copyTo-9zorpBc, reason: not valid java name */
    public static final void m7649copyTo9zorpBc(ByteBuffer copyTo, byte[] destination, long j, int i, int i2) {
        Intrinsics.checkNotNullParameter(copyTo, "$this$copyTo");
        Intrinsics.checkNotNullParameter(destination, "destination");
        if (j < 2147483647L) {
            m7648copyTo9zorpBc(copyTo, destination, (int) j, i, i2);
        } else {
    ...
    public static final void m7646copyTo62zg_DM(ByteBuffer copyTo, ByteBuffer destination, int i) {
        Intrinsics.checkNotNullParameter(copyTo, "$this$copyTo");
        Intrinsics.checkNotNullParameter(destination, "destination");
    ...
    /* JADX INFO: renamed from: copyTo-62zg_DM, reason: not valid java name */
    public static final void m7647copyTo62zg_DM(ByteBuffer copyTo, ByteBuffer destination, long j) {
        Intrinsics.checkNotNullParameter(copyTo, "$this$copyTo");
        Intrinsics.checkNotNullParameter(destination, "destination");
        if (j < 2147483647L) {
            m7646copyTo62zg_DM(copyTo, destination, (int) j);
        } else {
            NumbersKt.failLongToIntConversion(j, "offset");
            throw new KotlinNothingValueException();
        }
    ...
    public static final void m7650copyToSG11BkQ(ByteBuffer copyTo, ByteBuffer destination, int i) {
        Intrinsics.checkNotNullParameter(copyTo, "$this$copyTo");
        Intrinsics.checkNotNullParameter(destination, "destination");
        if (copyTo.hasArray() && !copyTo.isReadOnly()) {
            ...
            Memory.m7630copyToJT6ljtQ(Memory.m7629constructorimpl(byteBufferOrder), destination, 0, iRemaining, i);
    ...
    public static final void m7652fillJT6ljtQ(ByteBuffer fill, long j, long j2, byte b) {
        ...
        int i = (int) j;
        if (j2 < 2147483647L) {
            m7651fillJT6ljtQ(fill, i, (int) j2, b);
        } else {
    ...
    /* JADX INFO: renamed from: fill-JT6ljtQ, reason: not valid java name */
    public static final void m7651fillJT6ljtQ(ByteBuffer fill, int i, int i2, byte b) {
        Intrinsics.checkNotNullParameter(fill, "$this$fill");
        int i3 = i2 + i;
        while (i < i3) {
            fill.put(i, b);
