...
public final class Memory {
    ...
    public static final /* synthetic */ Memory m7628boximpl(ByteBuffer byteBuffer) {
        return new Memory(byteBuffer);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static ByteBuffer m7629constructorimpl(ByteBuffer buffer) {
        Intrinsics.checkNotNullParameter(buffer, "buffer");
        return buffer;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m7632equalsimpl(ByteBuffer byteBuffer, Object obj) {
        return (obj instanceof Memory) && Intrinsics.areEqual(byteBuffer, ((Memory) obj).m7644unboximpl());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m7633equalsimpl0(ByteBuffer byteBuffer, ByteBuffer byteBuffer2) {
        return Intrinsics.areEqual(byteBuffer, byteBuffer2);
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m7636hashCodeimpl(ByteBuffer byteBuffer) {
        return byteBuffer.hashCode();
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m7643toStringimpl(ByteBuffer byteBuffer) {
        return "Memory(buffer=" + byteBuffer + ')';
    }

    public boolean equals(Object obj) {
        return m7632equalsimpl(this.buffer, obj);
    }

    public int hashCode() {
        return m7636hashCodeimpl(this.buffer);
    }

    public String toString() {
        return m7643toStringimpl(this.buffer);
    }

    /* JADX INFO: renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ ByteBuffer m7644unboximpl() {
        return this.buffer;
    }
    ...
    public static final long m7634getSizeimpl(ByteBuffer byteBuffer) {
        return byteBuffer.limit();
    }

    /* JADX INFO: renamed from: getSize32-impl, reason: not valid java name */
    public static final int m7635getSize32impl(ByteBuffer byteBuffer) {
        return byteBuffer.limit();
    }

    /* JADX INFO: renamed from: loadAt-impl, reason: not valid java name */
    public static final byte m7637loadAtimpl(ByteBuffer byteBuffer, int i) {
        return byteBuffer.get(i);
    }

    /* JADX INFO: renamed from: loadAt-impl, reason: not valid java name */
    public static final byte m7638loadAtimpl(ByteBuffer byteBuffer, long j) {
        if (j < 2147483647L) {
    ...
    public static final void m7641storeAtimpl(ByteBuffer byteBuffer, int i, byte b) {
        byteBuffer.put(i, b);
    }

    /* JADX INFO: renamed from: storeAt-impl, reason: not valid java name */
    public static final void m7642storeAtimpl(ByteBuffer byteBuffer, long j, byte b) {
        if (j < 2147483647L) {
    ...
    public static final ByteBuffer m7639slice87lwejk(ByteBuffer byteBuffer, int i, int i2) {
        return m7629constructorimpl(MemoryJvmKt.sliceSafe(byteBuffer, i, i2));
    }

    /* JADX INFO: renamed from: slice-87lwejk, reason: not valid java name */
    public static final ByteBuffer m7640slice87lwejk(ByteBuffer byteBuffer, long j, long j2) {
        if (j >= 2147483647L) {
        ...
        int i = (int) j;
        if (j2 < 2147483647L) {
            return m7639slice87lwejk(byteBuffer, i, (int) j2);
        }
    ...
    public static final void m7630copyToJT6ljtQ(ByteBuffer byteBuffer, ByteBuffer destination, int i, int i2, int i3) {
    ...
    /* JADX INFO: renamed from: copyTo-JT6ljtQ, reason: not valid java name */
    public static final void m7631copyToJT6ljtQ(ByteBuffer byteBuffer, ByteBuffer destination, long j, long j2, long j3) {
        Intrinsics.checkNotNullParameter(destination, "destination");
        if (j >= 2147483647L) {
            NumbersKt.failLongToIntConversion(j, "offset");
            throw new KotlinNothingValueException();
        ...
        int i2 = (int) j2;
        if (j3 < 2147483647L) {
            m7630copyToJT6ljtQ(byteBuffer, destination, i, i2, (int) j3);
        } else {
    ...
    public static final class Companion {
        ...
        public final ByteBuffer m7645getEmptySK3TCg8() {
            return Memory.Empty;
        }
    }
    ...
    static {
        ...
        Empty = m7629constructorimpl(byteBufferOrder);
    }
}
