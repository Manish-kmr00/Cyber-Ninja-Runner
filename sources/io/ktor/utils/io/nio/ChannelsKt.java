...
public final class ChannelsKt {
        ...
        do {
            try {
                ...
                try {
                    ...
                    iWrite = writableByteChannel.write(byteBufferM7639slice87lwejk);
    ...
    private static final ByteReadPacket readPacketImpl(ReadableByteChannel readableByteChannel, long j, long j2) throws Throwable {
        long j3 = 0;
        ...
        while (true) {
            ...
            try {
                int iCoerceAtMost = (int) RangesKt.coerceAtMost(j2 - j3, 2147483647L);
                ChunkBuffer chunkBuffer3 = chunkBuffer2;
                int limit = chunkBuffer3.getLimit() - chunkBuffer3.getWritePosition();
                ChunkBuffer chunkBuffer4 = (limit > 200 || limit >= iCoerceAtMost) ? chunkBuffer2 : null;
                if (chunkBuffer4 == null) {
                    ChunkBuffer chunkBufferBorrow = pool.borrow();
                    ChunkBuffer chunkBuffer5 = chunkBufferBorrow;
                    if (chunkBuffer == empty) {
                        chunkBuffer = chunkBuffer5;
                        chunkBuffer2 = chunkBuffer;
                    }
                    chunkBuffer4 = chunkBufferBorrow;
                }
                if (chunkBuffer2 != chunkBuffer4) {
                    chunkBuffer2.setNext(chunkBuffer4);
                    chunkBuffer2 = chunkBuffer4;
                }
                try {
                    ChunkBuffer chunkBuffer6 = chunkBuffer4;
                    int limit2 = chunkBuffer6.getLimit() - chunkBuffer6.getWritePosition();
                    if (1 > limit2) {
                        throw new IllegalArgumentException(("size 1 is greater than buffer's remaining capacity " + limit2).toString());
                    }
                    ByteBuffer byteBufferDuplicate = chunkBuffer4.getMemory().duplicate();
                    Intrinsics.checkNotNull(byteBufferDuplicate);
                    int writePosition = chunkBuffer4.getWritePosition();
                    int i2 = i;
                    byteBufferDuplicate.limit(chunkBuffer4.getLimit());
                    ...
                    try {
                        ...
                        chunkBuffer4.commitWritten(iPosition);
                        chunkBuffer = chunkBuffer8;
                        i = i2;
                        empty = chunkBuffer7;
                    } catch (Throwable th) {
                        th = th;
    ...
    public static final int m7896readUAd2zVI(ReadableByteChannel read, ByteBuffer destination, int i, int i2) {
    ...
    public static final int m7898writeUAd2zVI(WritableByteChannel write, ByteBuffer source, int i, int i2) {
    ...
    public static /* synthetic */ int m7897readUAd2zVI$default(ReadableByteChannel readableByteChannel, ByteBuffer byteBuffer, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
        ...
        return m7896readUAd2zVI(readableByteChannel, byteBuffer, i, i2);
    }
    ...
    public static /* synthetic */ int m7899writeUAd2zVI$default(WritableByteChannel writableByteChannel, ByteBuffer byteBuffer, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
        ...
        return m7898writeUAd2zVI(writableByteChannel, byteBuffer, i, i2);
    }
}
