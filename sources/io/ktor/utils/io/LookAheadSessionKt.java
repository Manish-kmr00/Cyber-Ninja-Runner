...
public final class LookAheadSessionKt {
    ...
    @DebugMetadata(c = "io.ktor.utils.io.LookAheadSessionKt", f = "LookAheadSession.kt", i = {0, 0, 1, 1, 1}, l = {54, TokenParametersOuterClass$TokenParameters.PRIORCLICKS_FIELD_NUMBER}, m = "consumeEachRemaining", n = {"$this$consumeEachRemaining", "visitor", "$this$consumeEachRemaining", "visitor", "s"}, s = {"L$0", "L$1", "L$0", "L$1", "I$0"})
    ...
    public static final void consumeEachRemaining(LookAheadSession lookAheadSession, Function1<? super ByteBuffer, Boolean> visitor) {
        ...
        do {
            ...
            if (byteBufferRequest != null) {
                ...
                lookAheadSession.mo7895consumed(iRemaining);
                z = zBooleanValue;
            }
        } while (z);
    }
    ...
    private static final Object consumeEachRemaining$$forInline(LookAheadSuspendSession lookAheadSuspendSession, Function2<? super ByteBuffer, ? super Continuation<? super Boolean>, ? extends Object> function2, Continuation<? super Unit> continuation) {
        while (true) {
            ...
            if (byteBufferRequest == null) {
                ...
                lookAheadSuspendSession.mo7895consumed(iRemaining);
                if (!zBooleanValue) {
                    break;
                }
            }
