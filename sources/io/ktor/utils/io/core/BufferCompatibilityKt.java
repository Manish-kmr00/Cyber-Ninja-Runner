...
public final class BufferCompatibilityKt {
    ...
    public static final void m7774fillsEu17AQ(Buffer fill, int i, byte b) {
    ...
    public static final void fill(Buffer buffer, int i, byte b) {
        ...
        MemoryJvmKt.m7651fillJT6ljtQ(buffer.getMemory(), buffer.getWritePosition(), i, b);
    ...
    public static final int appendChars(Buffer buffer, CharSequence csq, int i, int i2) {
        Intrinsics.checkNotNullParameter(buffer, "<this>");
        Intrinsics.checkNotNullParameter(csq, "csq");
        int iM7891encodeUTF8lBXzO7A = UTF8Kt.m7891encodeUTF8lBXzO7A(buffer.getMemory(), csq, i, i2, buffer.getWritePosition(), buffer.getLimit());
        int iM7887getCharactersMh2AYeg = EncodeResult.m7887getCharactersMh2AYeg(iM7891encodeUTF8lBXzO7A) & UShort.MAX_VALUE;
        buffer.commitWritten(EncodeResult.m7886getBytesMh2AYeg(iM7891encodeUTF8lBXzO7A) & UShort.MAX_VALUE);
        return i + iM7887getCharactersMh2AYeg;
    }
