...
public abstract class Output implements Appendable, Closeable {
    ...
    protected abstract void mo7808flush62zg_DM(ByteBuffer source, int offset, int length);

    public Output(ObjectPool<ChunkBuffer> pool) {
        Intrinsics.checkNotNullParameter(pool, "pool");
        this.pool = pool;
        this.tailMemory = Memory.INSTANCE.m7645getEmptySK3TCg8();
    }
    ...
    public final void m7844setTailMemory3GNKZMM$ktor_io(ByteBuffer byteBuffer) {
    ...
    private final void flushChain() {
        ...
        do {
            try {
                ...
                mo7808flush62zg_DM(next.getMemory(), next.getReadPosition(), chunkBuffer.getWritePosition() - chunkBuffer.getReadPosition());
                next = next.getNext();
            } finally {
