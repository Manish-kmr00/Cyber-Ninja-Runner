...
public final class OutputKt {
    ...
    public static final void m7845writeFullyUAd2zVI(Output writeFully, ByteBuffer src, int i, int i2) {
        Intrinsics.checkNotNullParameter(writeFully, "$this$writeFully");
        Intrinsics.checkNotNullParameter(src, "src");
        m7846writeFullyUAd2zVI(writeFully, src, i, i2);
    }
    ...
    /* JADX INFO: renamed from: writeFully-UAd2zVI, reason: not valid java name */
    public static final void m7846writeFullyUAd2zVI(Output writeFully, ByteBuffer src, long j, long j2) {
        Intrinsics.checkNotNullParameter(writeFully, "$this$writeFully");
        Intrinsics.checkNotNullParameter(src, "src");
        ...
        while (true) {
            try {
                ...
                Memory.m7631copyToJT6ljtQ(src, chunkBuffer.getMemory(), j3, jMin, chunkBuffer.getWritePosition());
    ...
    public static final void fill(Output output, long j, byte b) {
        ...
        while (true) {
            try {
                ChunkBuffer chunkBuffer = chunkBufferPrepareWriteHead;
                int iMin = (int) Math.min(chunkBuffer.getLimit() - chunkBuffer.getWritePosition(), j - j2);
                BufferCompatibilityKt.fill((Buffer) chunkBuffer, iMin, b);
                j2 += (long) iMin;
                if (j2 < j) {
                    chunkBufferPrepareWriteHead = UnsafeKt.prepareWriteHead(output, 1, chunkBufferPrepareWriteHead);
                } else {
    ...
    private static final void writeFullyBytesTemplate(Output output, long j, long j2, Function4<? super Memory, ? super Long, ? super Long, ? super Long, Unit> function4) {
        ...
        while (true) {
            try {
                ...
                function4.invoke(Memory.m7628boximpl(chunkBuffer.getMemory()), Long.valueOf(chunkBuffer.getWritePosition()), Long.valueOf(j), Long.valueOf(jMin));
                chunkBuffer.commitWritten((int) jMin);
                j += jMin;
                j2 -= jMin;
                if (j2 > 0) {
