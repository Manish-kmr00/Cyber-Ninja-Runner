...
public final class BufferPrimitivesKt {
    public static final byte readUByte(Buffer buffer) {
        ...
        return UByte.m7922constructorimpl(buffer.readByte());
    }
    ...
    public static final void m7799writeUByteEK6454(Buffer writeUByte, byte b) throws InsufficientSpaceException {
        Intrinsics.checkNotNullParameter(writeUByte, "$this$writeUByte");
        writeUByte.writeByte(b);
    }

    /* JADX INFO: renamed from: writeUByte-EK-6454, reason: not valid java name */
    public static final void m7800writeUByteEK6454(ChunkBuffer writeUByte, byte b) throws InsufficientSpaceException {
        Intrinsics.checkNotNullParameter(writeUByte, "$this$writeUByte");
        m7799writeUByteEK6454((Buffer) writeUByte, b);
    }
    ...
    public static final void m7806writeUShorti8woANY(ChunkBuffer writeUShort, short s) throws InsufficientSpaceException {
        Intrinsics.checkNotNullParameter(writeUShort, "$this$writeUShort");
        m7805writeUShorti8woANY((Buffer) writeUShort, s);
    }
    ...
    public static final void m7802writeUIntQn1smSk(ChunkBuffer writeUInt, int i) throws InsufficientSpaceException {
        Intrinsics.checkNotNullParameter(writeUInt, "$this$writeUInt");
        m7801writeUIntQn1smSk((Buffer) writeUInt, i);
    }
    ...
    public static final void m7804writeULong2TYgG_w(ChunkBuffer writeULong, long j) throws InsufficientSpaceException {
        Intrinsics.checkNotNullParameter(writeULong, "$this$writeULong");
        m7803writeULong2TYgG_w((Buffer) writeULong, j);
    }
    ...
    public static /* synthetic */ void m7786readFullyo1GoV1E$default(Buffer buffer, byte[] bArr, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
            i2 = UByteArray.m7983getSizeimpl(bArr) - i;
        }
        m7785readFullyo1GoV1E(buffer, bArr, i, i2);
    }

    /* JADX INFO: renamed from: readFully-o1GoV1E, reason: not valid java name */
    public static final void m7785readFullyo1GoV1E(Buffer readFully, byte[] destination, int i, int i2) {
    ...
    public static /* synthetic */ int m7778readAvailableo1GoV1E$default(Buffer buffer, byte[] bArr, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
        ...
        return m7777readAvailableo1GoV1E(buffer, bArr, i, i2);
    }

    /* JADX INFO: renamed from: readAvailable-o1GoV1E, reason: not valid java name */
    public static final int m7777readAvailableo1GoV1E(Buffer readAvailable, byte[] destination, int i, int i2) {
    ...
    public static /* synthetic */ void m7794writeFullyo1GoV1E$default(Buffer buffer, byte[] bArr, int i, int i2, int i3, Object obj) throws InsufficientSpaceException {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
        ...
        m7793writeFullyo1GoV1E(buffer, bArr, i, i2);
    }

    /* JADX INFO: renamed from: writeFully-o1GoV1E, reason: not valid java name */
    public static final void m7793writeFullyo1GoV1E(Buffer writeFully, byte[] source, int i, int i2) throws InsufficientSpaceException {
    ...
    public static /* synthetic */ void m7784readFullyWt3Bwxc$default(Buffer buffer, short[] sArr, int i, int i2, int i3, Object obj) throws EOFException {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
            i2 = UShortArray.m8246getSizeimpl(sArr) - i;
        }
        m7783readFullyWt3Bwxc(buffer, sArr, i, i2);
    }

    /* JADX INFO: renamed from: readFully-Wt3Bwxc, reason: not valid java name */
    public static final void m7783readFullyWt3Bwxc(Buffer readFully, short[] destination, int i, int i2) throws EOFException {
        Intrinsics.checkNotNullParameter(readFully, "$this$readFully");
        Intrinsics.checkNotNullParameter(destination, "destination");
        readFully(readFully, destination, i, i2);
    }
    ...
    public static /* synthetic */ int m7776readAvailableWt3Bwxc$default(Buffer buffer, short[] sArr, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
        ...
        return m7775readAvailableWt3Bwxc(buffer, sArr, i, i2);
    }

    /* JADX INFO: renamed from: readAvailable-Wt3Bwxc, reason: not valid java name */
    public static final int m7775readAvailableWt3Bwxc(Buffer readAvailable, short[] destination, int i, int i2) {
        Intrinsics.checkNotNullParameter(readAvailable, "$this$readAvailable");
        Intrinsics.checkNotNullParameter(destination, "destination");
        return readAvailable(readAvailable, destination, i, i2);
    }
    ...
    public static /* synthetic */ void m7792writeFullyWt3Bwxc$default(Buffer buffer, short[] sArr, int i, int i2, int i3, Object obj) throws InsufficientSpaceException {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
        ...
        m7791writeFullyWt3Bwxc(buffer, sArr, i, i2);
    }

    /* JADX INFO: renamed from: writeFully-Wt3Bwxc, reason: not valid java name */
    public static final void m7791writeFullyWt3Bwxc(Buffer writeFully, short[] source, int i, int i2) throws InsufficientSpaceException {
        Intrinsics.checkNotNullParameter(writeFully, "$this$writeFully");
        Intrinsics.checkNotNullParameter(source, "source");
        writeFully(writeFully, source, i, i2);
    }
    ...
    public static /* synthetic */ void m7788readFullyo2ZM2JE$default(Buffer buffer, int[] iArr, int i, int i2, int i3, Object obj) throws EOFException {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
            i2 = UIntArray.m8062getSizeimpl(iArr) - i;
        }
        m7787readFullyo2ZM2JE(buffer, iArr, i, i2);
    }

    /* JADX INFO: renamed from: readFully-o2ZM2JE, reason: not valid java name */
    public static final void m7787readFullyo2ZM2JE(Buffer readFully, int[] destination, int i, int i2) throws EOFException {
        Intrinsics.checkNotNullParameter(readFully, "$this$readFully");
        Intrinsics.checkNotNullParameter(destination, "destination");
        readFully(readFully, destination, i, i2);
    }
    ...
    public static /* synthetic */ int m7780readAvailableo2ZM2JE$default(Buffer buffer, int[] iArr, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
        ...
        return m7779readAvailableo2ZM2JE(buffer, iArr, i, i2);
    }

    /* JADX INFO: renamed from: readAvailable-o2ZM2JE, reason: not valid java name */
    public static final int m7779readAvailableo2ZM2JE(Buffer readAvailable, int[] destination, int i, int i2) {
        Intrinsics.checkNotNullParameter(readAvailable, "$this$readAvailable");
        Intrinsics.checkNotNullParameter(destination, "destination");
        return readAvailable(readAvailable, destination, i, i2);
    }
    ...
    public static /* synthetic */ void m7796writeFullyo2ZM2JE$default(Buffer buffer, int[] iArr, int i, int i2, int i3, Object obj) throws InsufficientSpaceException {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
        ...
        m7795writeFullyo2ZM2JE(buffer, iArr, i, i2);
    }

    /* JADX INFO: renamed from: writeFully-o2ZM2JE, reason: not valid java name */
    public static final void m7795writeFullyo2ZM2JE(Buffer writeFully, int[] source, int i, int i2) throws InsufficientSpaceException {
        Intrinsics.checkNotNullParameter(writeFully, "$this$writeFully");
        Intrinsics.checkNotNullParameter(source, "source");
        writeFully(writeFully, source, i, i2);
    }
    ...
    public static /* synthetic */ void m7790readFullypqYNikA$default(Buffer buffer, long[] jArr, int i, int i2, int i3, Object obj) throws EOFException {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
            i2 = ULongArray.m8141getSizeimpl(jArr) - i;
        }
        m7789readFullypqYNikA(buffer, jArr, i, i2);
    }

    /* JADX INFO: renamed from: readFully-pqYNikA, reason: not valid java name */
    public static final void m7789readFullypqYNikA(Buffer readFully, long[] destination, int i, int i2) throws EOFException {
        Intrinsics.checkNotNullParameter(readFully, "$this$readFully");
        Intrinsics.checkNotNullParameter(destination, "destination");
        readFully(readFully, destination, i, i2);
    }
    ...
    public static /* synthetic */ int m7782readAvailablepqYNikA$default(Buffer buffer, long[] jArr, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
        ...
        return m7781readAvailablepqYNikA(buffer, jArr, i, i2);
    }

    /* JADX INFO: renamed from: readAvailable-pqYNikA, reason: not valid java name */
    public static final int m7781readAvailablepqYNikA(Buffer readAvailable, long[] destination, int i, int i2) {
        Intrinsics.checkNotNullParameter(readAvailable, "$this$readAvailable");
        Intrinsics.checkNotNullParameter(destination, "destination");
        return readAvailable(readAvailable, destination, i, i2);
    }
    ...
    public static /* synthetic */ void m7798writeFullypqYNikA$default(Buffer buffer, long[] jArr, int i, int i2, int i3, Object obj) throws InsufficientSpaceException {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
        ...
        m7797writeFullypqYNikA(buffer, jArr, i, i2);
    }

    /* JADX INFO: renamed from: writeFully-pqYNikA, reason: not valid java name */
    public static final void m7797writeFullypqYNikA(Buffer writeFully, long[] source, int i, int i2) throws InsufficientSpaceException {
        Intrinsics.checkNotNullParameter(writeFully, "$this$writeFully");
        Intrinsics.checkNotNullParameter(source, "source");
        writeFully(writeFully, source, i, i2);
    }
    ...
    public static final int readFully(Buffer buffer, Buffer dst, int i) throws EOFException {
        ...
        if (buffer.getWritePosition() - readPosition >= i) {
            Memory.m7630copyToJT6ljtQ(memory, dst.getMemory(), readPosition, i, dst.getWritePosition());
            dst.commitWritten(i);
    ...
    public static final short readUShort(Buffer buffer) throws EOFException {
        ...
        int readPosition = buffer.getReadPosition();
        if (buffer.getWritePosition() - readPosition >= 2) {
            UShort uShortM8181boximpl = UShort.m8181boximpl(UShort.m8187constructorimpl(memory.getShort(readPosition)));
            buffer.discardExact(2);
            return uShortM8181boximpl.getData();
        }
    ...
    public static final int readUInt(Buffer buffer) throws EOFException {
        ...
        int readPosition = buffer.getReadPosition();
        if (buffer.getWritePosition() - readPosition >= 4) {
            UInt uIntM7995boximpl = UInt.m7995boximpl(UInt.m8001constructorimpl(memory.getInt(readPosition)));
            buffer.discardExact(4);
            return uIntM7995boximpl.getData();
        }
    ...
    public static final long readULong(Buffer buffer) throws EOFException {
        ...
        int readPosition = buffer.getReadPosition();
        if (buffer.getWritePosition() - readPosition >= 8) {
            ULong uLongM8074boximpl = ULong.m8074boximpl(ULong.m8080constructorimpl(memory.getLong(readPosition)));
            buffer.discardExact(8);
            return uLongM8074boximpl.getData();
        }
    ...
    /* JADX INFO: renamed from: writeUShort-i8woANY, reason: not valid java name */
    public static final void m7805writeUShorti8woANY(Buffer writeUShort, short s) throws InsufficientSpaceException {
        Intrinsics.checkNotNullParameter(writeUShort, "$this$writeUShort");
    ...
    /* JADX INFO: renamed from: writeUInt-Qn1smSk, reason: not valid java name */
    public static final void m7801writeUIntQn1smSk(Buffer writeUInt, int i) throws InsufficientSpaceException {
        Intrinsics.checkNotNullParameter(writeUInt, "$this$writeUInt");
    ...
    /* JADX INFO: renamed from: writeULong-2TYgG_w, reason: not valid java name */
    public static final void m7803writeULong2TYgG_w(Buffer writeULong, long j) throws InsufficientSpaceException {
        Intrinsics.checkNotNullParameter(writeULong, "$this$writeULong");
    ...
    public static final void readFully(Buffer buffer, byte[] destination, int i, int i2) {
        ...
        MemoryJvmKt.m7648copyTo9zorpBc(memory, destination, readPosition, i2, i);
        Unit unit = Unit.INSTANCE;
    ...
    public static final void writeFully(Buffer buffer, byte[] source, int i, int i2) throws InsufficientSpaceException {
        ...
        Memory.m7630copyToJT6ljtQ(Memory.m7629constructorimpl(byteBufferOrder), memory, 0, i2, writePosition);
    ...
    public static final void readFully(Buffer buffer, short[] destination, int i, int i2) throws EOFException {
        ...
        if (buffer.getWritePosition() - readPosition >= i3) {
            PrimitiveArraysJvmKt.m7749loadShortArray9zorpBc(memory, readPosition, destination, i, i2);
            Unit unit = Unit.INSTANCE;
    ...
    public static final void writeFully(Buffer buffer, short[] source, int i, int i2) throws InsufficientSpaceException {
        ...
        int limit = buffer.getLimit() - writePosition;
        if (limit >= i3) {
            PrimitiveArraysJvmKt.m7769storeShortArray9zorpBc(memory, writePosition, source, i, i2);
    ...
    public static final void readFully(Buffer buffer, int[] destination, int i, int i2) throws EOFException {
        ...
        int readPosition = buffer.getReadPosition();
        if (buffer.getWritePosition() - readPosition >= i3) {
            PrimitiveArraysJvmKt.m7741loadIntArray9zorpBc(memory, readPosition, destination, i, i2);
            Unit unit = Unit.INSTANCE;
            buffer.discardExact(i3);
            return;
        }
    ...
    public static final void writeFully(Buffer buffer, int[] source, int i, int i2) throws InsufficientSpaceException {
        ...
        int limit = buffer.getLimit() - writePosition;
        if (limit >= i3) {
            PrimitiveArraysJvmKt.m7761storeIntArray9zorpBc(memory, writePosition, source, i, i2);
            buffer.commitWritten(i3);
            return;
        }
    ...
    public static final void readFully(Buffer buffer, long[] destination, int i, int i2) throws EOFException {
        ...
        int readPosition = buffer.getReadPosition();
        if (buffer.getWritePosition() - readPosition >= i3) {
            PrimitiveArraysJvmKt.m7745loadLongArray9zorpBc(memory, readPosition, destination, i, i2);
            Unit unit = Unit.INSTANCE;
            buffer.discardExact(i3);
            return;
        }
    ...
    public static final void writeFully(Buffer buffer, long[] source, int i, int i2) throws InsufficientSpaceException {
        ...
        int limit = buffer.getLimit() - writePosition;
        if (limit >= i3) {
            PrimitiveArraysJvmKt.m7765storeLongArray9zorpBc(memory, writePosition, source, i, i2);
            buffer.commitWritten(i3);
            return;
        }
    ...
    public static final void readFully(Buffer buffer, float[] destination, int i, int i2) throws EOFException {
        ...
        int readPosition = buffer.getReadPosition();
        if (buffer.getWritePosition() - readPosition >= i3) {
            PrimitiveArraysJvmKt.m7737loadFloatArray9zorpBc(memory, readPosition, destination, i, i2);
            Unit unit = Unit.INSTANCE;
            buffer.discardExact(i3);
            return;
        }
    ...
    public static final void writeFully(Buffer buffer, float[] source, int i, int i2) throws InsufficientSpaceException {
        ...
        int limit = buffer.getLimit() - writePosition;
        if (limit >= i3) {
            PrimitiveArraysJvmKt.m7757storeFloatArray9zorpBc(memory, writePosition, source, i, i2);
            buffer.commitWritten(i3);
            return;
        }
    ...
    public static final void readFully(Buffer buffer, double[] destination, int i, int i2) throws EOFException {
        ...
        int readPosition = buffer.getReadPosition();
        if (buffer.getWritePosition() - readPosition >= i3) {
            PrimitiveArraysJvmKt.m7733loadDoubleArray9zorpBc(memory, readPosition, destination, i, i2);
            Unit unit = Unit.INSTANCE;
            buffer.discardExact(i3);
            return;
        }
    ...
    public static final void writeFully(Buffer buffer, double[] source, int i, int i2) throws InsufficientSpaceException {
        ...
        int limit = buffer.getLimit() - writePosition;
        if (limit >= i3) {
            PrimitiveArraysJvmKt.m7753storeDoubleArray9zorpBc(memory, writePosition, source, i, i2);
            buffer.commitWritten(i3);
            return;
        }
        throw new InsufficientSpaceException("floating point numbers array", i3, limit);
    ...
    public static final int readAvailable(Buffer buffer, Buffer dst, int i) throws EOFException {
        ...
        if (buffer.getWritePosition() - readPosition >= iMin) {
            Memory.m7630copyToJT6ljtQ(memory, dst.getMemory(), readPosition, iMin, dst.getWritePosition());
    ...
    public static final void writeFully(Buffer buffer, Buffer src) throws InsufficientSpaceException {
        ...
        if (limit >= writePosition) {
            Memory.m7630copyToJT6ljtQ(src.getMemory(), memory, src.getReadPosition(), writePosition, writePosition2);
    ...
    public static final void writeFully(Buffer buffer, Buffer src, int i) {
        ...
        int limit = buffer.getLimit() - writePosition;
        if (limit >= i) {
            Memory.m7630copyToJT6ljtQ(src.getMemory(), memory, src.getReadPosition(), i, writePosition);
            src.discardExact(i);
    ...
    public static final <R> R readExact(Buffer buffer, int i, String name, Function2<? super Memory, ? super Integer, ? extends R> block) throws EOFException {
        ...
        R rInvoke = block.invoke(Memory.m7628boximpl(memory), Integer.valueOf(readPosition));
        buffer.discardExact(i);
        return rInvoke;
    }
    ...
    public static final void writeExact(Buffer buffer, int i, String name, Function2<? super Memory, ? super Integer, Unit> block) throws InsufficientSpaceException {
        ...
        block.invoke(Memory.m7628boximpl(memory), Integer.valueOf(writePosition));
        buffer.commitWritten(i);
    }
}
