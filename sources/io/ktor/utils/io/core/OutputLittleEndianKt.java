...
public final class OutputLittleEndianKt {
    ...
    public static /* synthetic */ void m7850writeFullyLittleEndianWt3Bwxc$default(Output output, short[] sArr, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
        ...
        m7848writeFullyLittleEndianWt3Bwxc(output, sArr, i, i2);
    }

    /* JADX INFO: renamed from: writeFullyLittleEndian-Wt3Bwxc, reason: not valid java name */
    public static final void m7848writeFullyLittleEndianWt3Bwxc(Output writeFullyLittleEndian, short[] source, int i, int i2) {
    ...
    /* JADX INFO: renamed from: writeFullyLittleEndian-Wt3Bwxc$default, reason: not valid java name */
    public static /* synthetic */ void m7849writeFullyLittleEndianWt3Bwxc$default(Buffer buffer, short[] sArr, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
        ...
        m7847writeFullyLittleEndianWt3Bwxc(buffer, sArr, i, i2);
    }

    /* JADX INFO: renamed from: writeFullyLittleEndian-Wt3Bwxc, reason: not valid java name */
    public static final void m7847writeFullyLittleEndianWt3Bwxc(Buffer writeFullyLittleEndian, short[] source, int i, int i2) {
        Intrinsics.checkNotNullParameter(writeFullyLittleEndian, "$this$writeFullyLittleEndian");
        Intrinsics.checkNotNullParameter(source, "source");
        writeFullyLittleEndian(writeFullyLittleEndian, source, i, i2);
    }
    ...
    public static /* synthetic */ void m7854writeFullyLittleEndiano2ZM2JE$default(Output output, int[] iArr, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
        ...
        m7852writeFullyLittleEndiano2ZM2JE(output, iArr, i, i2);
    }

    /* JADX INFO: renamed from: writeFullyLittleEndian-o2ZM2JE, reason: not valid java name */
    public static final void m7852writeFullyLittleEndiano2ZM2JE(Output writeFullyLittleEndian, int[] source, int i, int i2) {
        Intrinsics.checkNotNullParameter(writeFullyLittleEndian, "$this$writeFullyLittleEndian");
        Intrinsics.checkNotNullParameter(source, "source");
        writeFullyLittleEndian(writeFullyLittleEndian, source, i, i2);
    }
    ...
    public static /* synthetic */ void m7858writeFullyLittleEndianpqYNikA$default(Output output, long[] jArr, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
        ...
        m7856writeFullyLittleEndianpqYNikA(output, jArr, i, i2);
    }

    /* JADX INFO: renamed from: writeFullyLittleEndian-pqYNikA, reason: not valid java name */
    public static final void m7856writeFullyLittleEndianpqYNikA(Output writeFullyLittleEndian, long[] source, int i, int i2) {
        Intrinsics.checkNotNullParameter(writeFullyLittleEndian, "$this$writeFullyLittleEndian");
        Intrinsics.checkNotNullParameter(source, "source");
        writeFullyLittleEndian(writeFullyLittleEndian, source, i, i2);
    }
    ...
    /* JADX INFO: renamed from: writeFullyLittleEndian-o2ZM2JE$default, reason: not valid java name */
    public static /* synthetic */ void m7853writeFullyLittleEndiano2ZM2JE$default(Buffer buffer, int[] iArr, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
        ...
        m7851writeFullyLittleEndiano2ZM2JE(buffer, iArr, i, i2);
    }

    /* JADX INFO: renamed from: writeFullyLittleEndian-o2ZM2JE, reason: not valid java name */
    public static final void m7851writeFullyLittleEndiano2ZM2JE(Buffer writeFullyLittleEndian, int[] source, int i, int i2) {
        Intrinsics.checkNotNullParameter(writeFullyLittleEndian, "$this$writeFullyLittleEndian");
        Intrinsics.checkNotNullParameter(source, "source");
        writeFullyLittleEndian(writeFullyLittleEndian, source, i, i2);
    }
    ...
    /* JADX INFO: renamed from: writeFullyLittleEndian-pqYNikA$default, reason: not valid java name */
    public static /* synthetic */ void m7857writeFullyLittleEndianpqYNikA$default(Buffer buffer, long[] jArr, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
        ...
        m7855writeFullyLittleEndianpqYNikA(buffer, jArr, i, i2);
    }

    /* JADX INFO: renamed from: writeFullyLittleEndian-pqYNikA, reason: not valid java name */
    public static final void m7855writeFullyLittleEndianpqYNikA(Buffer writeFullyLittleEndian, long[] source, int i, int i2) {
        Intrinsics.checkNotNullParameter(writeFullyLittleEndian, "$this$writeFullyLittleEndian");
        Intrinsics.checkNotNullParameter(source, "source");
        writeFullyLittleEndian(writeFullyLittleEndian, source, i, i2);
    }
    ...
    private static final <T> void writePrimitiveTemplate(T t, Function1<? super T, Unit> function1, Function1<? super T, ? extends T> function2) {
    ...
    private static final <T> void writePrimitiveTemplate(T t, ByteOrder byteOrder, Function1<? super T, Unit> function1, Function1<? super T, ? extends T> function2) {
        ?? Invoke = t;
        if (WhenMappings.$EnumSwitchMapping$0[byteOrder.ordinal()] != 1) {
            Invoke = function2.invoke(t);
        }
