...
final /* synthetic */ class CryptoKt__CryptoJvmKt {
    ...
    public static final Digest Digest(String name) throws NoSuchAlgorithmException {
        ...
        return DigestImpl.m7602boximpl(DigestImpl.m7604constructorimpl(messageDigest));
    }

    public static final String generateNonce() {
        String str = (String) ChannelResult.m9424getOrNullimpl(NonceKt.getSeedChannel().mo9413tryReceivePtdJZtk());
