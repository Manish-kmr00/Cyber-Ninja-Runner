...
public final class PingPongKt {
    ...
    public static final SendChannel<Frame.Ping> ponger(CoroutineScope coroutineScope, SendChannel<? super Frame.Pong> outgoing) {
        ...
        BuildersKt__Builders_commonKt.launch$default(coroutineScope, PongerCoroutineName, null, new C48581(channelChannel$default, outgoing, null), 2, null);
    ...
    @DebugMetadata(c = "io.ktor.websocket.PingPongKt$ponger$1", f = "PingPong.kt", i = {0, 1}, l = {Sdk.SDKError.Reason.JSON_ENCODE_ERROR_VALUE, 32}, m = "invokeSuspend", n = {"$this$consume$iv$iv", "$this$consume$iv$iv"}, s = {"L$1", "L$1"})
    static final class C48581 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C48581(Channel<Frame.Ping> channel, SendChannel<? super Frame.Pong> sendChannel, Continuation<? super C48581> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C48581(this.$channel, this.$outgoing, continuation);
        }
        ...
        /* JADX WARN: Code duplicated, block: B:26:0x0065 A[Catch: all -> 0x003a, TryCatch #2 {all -> 0x003a, blocks: (B:7:0x001b, B:20:0x004b, B:24:0x005d, B:26:0x0065, B:30:0x008e, B:12:0x0034, B:18:0x0046), top: B:42:0x0009, outer: #1 }] */
        ...
        public final java.lang.Object invokeSuspend(java.lang.Object r12) {
            ...
            L9a:
                ...
                return r12
            */
            throw new UnsupportedOperationException("Method not decompiled: io.ktor.websocket.PingPongKt.C48581.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        static final class C07981 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C07981(Channel<Frame.Pong> channel, Continuation<? super C07981> continuation) {
                super(2, continuation);
                this.$channel = channel;
            }
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new C07981(this.$channel, continuation);
            }
