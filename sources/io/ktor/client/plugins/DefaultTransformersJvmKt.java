...
public final class DefaultTransformersJvmKt {
    ...
    static final class C46541 extends SuspendLambda implements Function3<PipelineContext<HttpResponseContainer, HttpClientCall>, HttpResponseContainer, Continuation<? super Unit>, Object> {
        private /* synthetic */ Object L$0;
        /* synthetic */ Object L$1;
        int label;

        C46541(Continuation<? super C46541> continuation) {
            super(3, continuation);
        }

        @Override // kotlin.jvm.functions.Function3
        public final Object invoke(PipelineContext<HttpResponseContainer, HttpClientCall> pipelineContext, HttpResponseContainer httpResponseContainer, Continuation<? super Unit> continuation) {
            C46541 c46541 = new C46541(continuation);
            c46541.L$0 = pipelineContext;
            c46541.L$1 = httpResponseContainer;
            return c46541.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final void platformResponseDefaultTransformers(HttpClient httpClient) {
        ...
        httpClient.getResponsePipeline().intercept(HttpResponsePipeline.INSTANCE.getParse(), new C46541(null));
    }
