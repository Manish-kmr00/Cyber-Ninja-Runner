...
public final class HttpCallValidator {
    ...
    @DebugMetadata(c = "io.ktor.client.plugins.HttpCallValidator", f = "HttpCallValidator.kt", i = {0, 0, 1, 1}, l = {TokenParametersOuterClass$TokenParameters.LASTADVERTISEDBUNDLES_FIELD_NUMBER, TokenParametersOuterClass$TokenParameters.PRIORCLICKS_FIELD_NUMBER}, m = "processException", n = {"cause", "request", "cause", "request"}, s = {"L$0", "L$1", "L$0", "L$1"})
    ...
    static final class C46551 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        C46551(Continuation<? super C46551> continuation) {
            super(continuation);
        }
    ...
    public final Object validateResponse(HttpResponse httpResponse, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Iterator it;
        if (continuation instanceof C46551) {
            c46551 = (C46551) continuation;
            if ((c46551.label & Integer.MIN_VALUE) != 0) {
                c46551.label -= Integer.MIN_VALUE;
            } else {
                c46551 = new C46551(continuation);
            }
        } else {
            c46551 = new C46551(continuation);
        }
        Object obj = c46551.result;
        ...
        if (i == 0) {
            ...
            it = (Iterator) c46551.L$1;
            HttpResponse httpResponse3 = (HttpResponse) c46551.L$0;
            ResultKt.throwOnFailure(obj);
            httpResponse2 = httpResponse3;
        }
        while (it.hasNext()) {
            Function2 function2 = (Function2) it.next();
            c46551.L$0 = httpResponse2;
            c46551.L$1 = it;
            c46551.label = 1;
            if (function2.invoke(httpResponse2, c46551) == coroutine_suspended) {
    ...
    /* JADX WARN: Code duplicated, block: B:36:0x00a3 A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:38:? A[LOOP:0: B:17:0x0075->B:38:?, LOOP_END, SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:7:0x0014  */
    ...
    /* JADX INFO: compiled from: HttpCallValidator.kt */
    @Metadata(d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0004J\u0018\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\u00032\u0006\u0010\f\u001a\u00020\rH\u0016J!\u0010\u000e\u001a\u00020\u00032\u0017\u0010\u000f\u001a\u0013\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\n0\u0010¢\u0006\u0002\b\u0011H\u0016R\u001a\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00030\u0006X\u0096\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\b¨\u0006\u0012"}, d2 = {"Lio/ktor/client/plugins/HttpCallValidator$Companion;", "Lio/ktor/client/plugins/HttpClientPlugin;", "Lio/ktor/client/plugins/HttpCallValidator$Config;", "Lio/ktor/client/plugins/HttpCallValidator;", "()V", "key", "Lio/ktor/util/AttributeKey;", "getKey", "()Lio/ktor/util/AttributeKey;", "install", "", fe.K, "scope", "Lio/ktor/client/HttpClient;", "prepare", "block", "Lkotlin/Function1;", "Lkotlin/ExtensionFunctionType;", "ktor-client-core"}, k = 1, mv = {1, 8, 0}, xi = 48)
