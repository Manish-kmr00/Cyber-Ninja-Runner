...
public final class SimpleCache implements Cache {
    ...
    /* JADX WARN: Type inference failed for: r3v2, types: [io.bidmachine.media3.datasource.cache.SimpleCache$1] */
    SimpleCache(File file, CacheEvictor cacheEvictor, CachedContentIndex cachedContentIndex, CacheFileMetadataIndex cacheFileMetadataIndex) {
        ...
        new Thread("ExoPlayer:SimpleCacheInit") { // from class: io.bidmachine.media3.datasource.cache.SimpleCache.1
