...
public interface HttpDataSource extends DataSource {
    public static final Predicate<String> REJECT_PAYWALL_TYPES = new Predicate() { // from class: io.bidmachine.media3.datasource.HttpDataSource$$ExternalSyntheticLambda0
