...
public final class ListenerSet<T> {
    ...
    private ListenerSet(CopyOnWriteArraySet<ListenerHolder<T>> copyOnWriteArraySet, Looper looper, Clock clock, IterationFinishedEvent<T> iterationFinishedEvent, boolean z) {
        ...
        this.handler = clock.createHandler(looper, new Handler.Callback() { // from class: io.bidmachine.media3.common.util.ListenerSet$$ExternalSyntheticLambda0
    ...
    public void queueEvent(final int i, final Event<T> event) {
        ...
        this.queuedEvents.add(new Runnable() { // from class: io.bidmachine.media3.common.util.ListenerSet$$ExternalSyntheticLambda1
