...
public final class NetworkTypeObserver {
    ...
    public void register(final Listener listener) {
        ...
        this.mainHandler.post(new Runnable() { // from class: io.bidmachine.media3.common.util.NetworkTypeObserver$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m7436x63b6138b(listener);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$register$0$io-bidmachine-media3-common-util-NetworkTypeObserver, reason: not valid java name */
    /* synthetic */ void m7436x63b6138b(Listener listener) {
