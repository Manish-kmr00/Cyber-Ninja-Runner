...
public final class TrackGroup {
    ...
    public static TrackGroup fromBundle(Bundle bundle) {
        ...
        if (parcelableArrayList == null) {
            ...
            immutableListFromBundleList = BundleCollectionUtil.fromBundleList(new Function() { // from class: io.bidmachine.media3.common.TrackGroup$$ExternalSyntheticLambda0
