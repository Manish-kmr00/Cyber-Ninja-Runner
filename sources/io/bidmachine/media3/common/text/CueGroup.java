...
public final class CueGroup {
    ...
    public Bundle toBundle() {
        ...
        bundle.putParcelableArrayList(FIELD_CUES, BundleCollectionUtil.toBundleArrayList(filterOutBitmapCues(this.cues), new Function() { // from class: io.bidmachine.media3.common.text.CueGroup$$ExternalSyntheticLambda1
    ...
    public static CueGroup fromBundle(Bundle bundle) {
        ...
        if (parcelableArrayList == null) {
            ...
            immutableListFromBundleList = BundleCollectionUtil.fromBundleList(new Function() { // from class: io.bidmachine.media3.common.text.CueGroup$$ExternalSyntheticLambda0
                @Override // com.google.common.base.Function
                public final Object apply(Object obj) {
