    ...
    public static class Builder {
        ...
        protected Builder(Bundle bundle) {
            ...
            if (parcelableArrayList == null) {
                ...
                immutableListFromBundleList = BundleCollectionUtil.fromBundleList(new Function() { // from class: io.bidmachine.media3.common.TrackSelectionParameters$Builder$$ExternalSyntheticLambda0
