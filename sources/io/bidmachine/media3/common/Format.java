...
public final class Format {
    ...
    public Bundle toBundle(boolean z) {
        ...
        bundle.putParcelableArrayList(FIELD_LABELS, BundleCollectionUtil.toBundleArrayList(this.labels, new Function() { // from class: io.bidmachine.media3.common.Format$$ExternalSyntheticLambda1
    ...
    public static Format fromBundle(Bundle bundle) {
        ...
        if (parcelableArrayList == null) {
            ...
            immutableListFromBundleList = BundleCollectionUtil.fromBundleList(new Function() { // from class: io.bidmachine.media3.common.Format$$ExternalSyntheticLambda0
                @Override // com.google.common.base.Function
                public final Object apply(Object obj) {
