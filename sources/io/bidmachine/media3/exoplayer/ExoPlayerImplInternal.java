...
final class ExoPlayerImplInternal implements Handler.Callback, MediaPeriod.Callback, TrackSelector.InvalidationListener, MediaSourceList.MediaSourceListInfoRefreshListener, DefaultMediaClock.PlaybackParametersListener, PlayerMessage.Sender {
    ...
    public ExoPlayerImplInternal(Renderer[] rendererArr, TrackSelector trackSelector, TrackSelectorResult trackSelectorResult, LoadControl loadControl, BandwidthMeter bandwidthMeter, int i, boolean z, AnalyticsCollector analyticsCollector, SeekParameters seekParameters, LivePlaybackSpeedControl livePlaybackSpeedControl, long j, boolean z2, boolean z3, Looper looper, Clock clock, PlaybackInfoUpdateListener playbackInfoUpdateListener, PlayerId playerId, Looper looper2, ExoPlayer.PreloadConfiguration preloadConfiguration) {
        ...
        this.queue = new MediaPeriodQueue(analyticsCollector, handlerWrapperCreateHandler, new MediaPeriodHolder.Factory() { // from class: io.bidmachine.media3.exoplayer.ExoPlayerImplInternal$$ExternalSyntheticLambda0
    ...
    public synchronized boolean release() {
        if (!this.released && this.playbackLooper.getThread().isAlive()) {
            ...
            waitUninterruptibly(new Supplier() { // from class: io.bidmachine.media3.exoplayer.ExoPlayerImplInternal$$ExternalSyntheticLambda3
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    return this.f$0.m7447x5a73b216();
                }
    ...
    /* JADX INFO: renamed from: lambda$release$0$io-bidmachine-media3-exoplayer-ExoPlayerImplInternal, reason: not valid java name */
    /* synthetic */ Boolean m7447x5a73b216() {
  ...
  0x00f8: PHI (r3v3 io.bidmachine.media3.common.Timeline) = 
  (r3v2 io.bidmachine.media3.common.Timeline)
  (r3v2 io.bidmachine.media3.common.Timeline)
  (r3v8 io.bidmachine.media3.common.Timeline)
  (r3v8 io.bidmachine.media3.common.Timeline)
 binds: [B:38:0x00b9, B:40:0x00bd, B:42:0x00d2, B:44:0x00e9] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    private void sendMessageToTargetThread(final PlayerMessage playerMessage) {
        ...
        if (!looper.getThread().isAlive()) {
            ...
            this.clock.createHandler(looper, null).post(new Runnable() { // from class: io.bidmachine.media3.exoplayer.ExoPlayerImplInternal$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m7448x94081d67(playerMessage);
                }
            });
        }
    }

    /* JADX INFO: renamed from: lambda$sendMessageToTargetThread$1$io-bidmachine-media3-exoplayer-ExoPlayerImplInternal, reason: not valid java name */
    /* synthetic */ void m7448x94081d67(PlayerMessage playerMessage) {
        try {
            deliverMessage(playerMessage);
    ...
    */
    ...
    /* JADX WARN: Code duplicated, block: B:90:0x019d A[ADDED_TO_REGION] */
    /* JADX WARN: Code duplicated, block: B:96:0x01b2  */
    /* JADX WARN: Code duplicated, block: B:99:0x01be  */
    /* JADX WARN: Not initialized variable reg: 26, insn: 0x0156: MOVE (r5 I:??[long, double]) = (r26 I:??[long, double]), block:B:75:0x0155 */
            ...
            try {
                ...
                try {
                        ...
                        if (timeline.isEmpty()) {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    th = th;
                                    j = j5;
                                    updatePlaybackSpeedSettingsForNewPeriod(timeline, mediaPeriodId, this.playbackInfo.timeline, this.playbackInfo.periodId, positionUpdateForPlaylistChangeResolvePositionForPlaylistChange.setTargetLiveOffset ? j5 : -9223372036854775807L, false);
                                    if (z4) {
                                        ...
                                        this.playbackInfo = handlePositionDiscontinuity(mediaPeriodId, j, j4, j6, z2, i2);
                                    } else {
                                        obj = this.playbackInfo.periodId.periodUid;
                    ...
                    if (z4 || j4 != this.playbackInfo.requestedContentPositionUs) {
                        ...
                        this.playbackInfo = handlePositionDiscontinuity(mediaPeriodId, jSeekToPeriodPosition, j4, this.playbackInfo.discontinuityStartPositionUs, z4 && z && !timeline5.isEmpty() && !timeline5.getPeriodByUid(obj2, this.period).isPlaceholder, timeline.getIndexOfPeriod(obj2) == i3 ? i : 3);
                    }
                    resetPendingPauseAtEndOfPeriod();
                    resolvePendingMessagePositions(timeline, this.playbackInfo.timeline);
                    this.playbackInfo = this.playbackInfo.copyWithTimeline(timeline);
    ...
    private void enableRenderer(int i, boolean z, long j) throws ExoPlaybackException {
        ...
        renderer.handleMessage(11, new Renderer.WakeupListener() { // from class: io.bidmachine.media3.exoplayer.ExoPlayerImplInternal.1
