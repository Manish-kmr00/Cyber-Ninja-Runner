...
public final class PreloadMediaSource extends WrappingMediaSource {
    ...
    public void preload(final long j) {
        this.preloadHandler.post(new Runnable() { // from class: io.bidmachine.media3.exoplayer.source.preload.PreloadMediaSource$$ExternalSyntheticLambda2
            ...
            public final void run() {
                this.f$0.m7528xdd841be6(j);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$preload$0$io-bidmachine-media3-exoplayer-source-preload-PreloadMediaSource, reason: not valid java name */
    /* synthetic */ void m7528xdd841be6(long j) {
    ...
    public void clear() {
        this.preloadHandler.post(new Runnable() { // from class: io.bidmachine.media3.exoplayer.source.preload.PreloadMediaSource$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m7526xae6f8081();
            }
        });
    }

    /* JADX INFO: renamed from: lambda$clear$1$io-bidmachine-media3-exoplayer-source-preload-PreloadMediaSource, reason: not valid java name */
    /* synthetic */ void m7526xae6f8081() {
    ...
    protected void onChildSourceInfoRefreshed(final Timeline timeline) {
        ...
        this.preloadHandler.post(new Runnable() { // from class: io.bidmachine.media3.exoplayer.source.preload.PreloadMediaSource$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m7527x84a30b9f(timeline);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$onChildSourceInfoRefreshed$2$io-bidmachine-media3-exoplayer-source-preload-PreloadMediaSource, reason: not valid java name */
    /* synthetic */ void m7527x84a30b9f(Timeline timeline) {
    ...
    public void releasePreloadMediaSource() {
        this.preloadHandler.post(new Runnable() { // from class: io.bidmachine.media3.exoplayer.source.preload.PreloadMediaSource$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m7529x3858eccf();
            }
        });
    }

    /* JADX INFO: renamed from: lambda$releasePreloadMediaSource$3$io-bidmachine-media3-exoplayer-source-preload-PreloadMediaSource, reason: not valid java name */
    /* synthetic */ void m7529x3858eccf() {
    ...
    class PreloadMediaPeriodCallback implements MediaPeriod.Callback {
        ...
        public void onPrepared(final MediaPeriod mediaPeriod) {
            ...
            PreloadMediaSource.this.preloadHandler.post(new Runnable() { // from class: io.bidmachine.media3.exoplayer.source.preload.PreloadMediaSource$PreloadMediaPeriodCallback$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m7531xe85ba24c(mediaPeriod);
                }
            });
        }

        /* JADX INFO: renamed from: lambda$onPrepared$0$io-bidmachine-media3-exoplayer-source-preload-PreloadMediaSource$PreloadMediaPeriodCallback, reason: not valid java name */
        /* synthetic */ void m7531xe85ba24c(MediaPeriod mediaPeriod) {
        ...
        public void onContinueLoadingRequested(final MediaPeriod mediaPeriod) {
            PreloadMediaSource.this.preloadHandler.post(new Runnable() { // from class: io.bidmachine.media3.exoplayer.source.preload.PreloadMediaSource$PreloadMediaPeriodCallback$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m7530x624db5e9(mediaPeriod);
                }
            });
        }

        /* JADX INFO: renamed from: lambda$onContinueLoadingRequested$1$io-bidmachine-media3-exoplayer-source-preload-PreloadMediaSource$PreloadMediaPeriodCallback, reason: not valid java name */
        /* synthetic */ void m7530x624db5e9(MediaPeriod mediaPeriod) {
            if (PreloadMediaSource.this.isUsedByPlayer()) {
                return;
            }
            PreloadMediaPeriod preloadMediaPeriod = (PreloadMediaPeriod) mediaPeriod;
