...
public abstract class CompositeMediaSource<T> extends BaseMediaSource {
    ...
    public abstract void m7507x416e9463(T t, MediaSource mediaSource, Timeline timeline);
    ...
    public final void prepareChildSource(final T t, MediaSource mediaSource) {
        ...
        MediaSource.MediaSourceCaller mediaSourceCaller = new MediaSource.MediaSourceCaller() { // from class: io.bidmachine.media3.exoplayer.source.CompositeMediaSource$$ExternalSyntheticLambda0
            @Override // io.bidmachine.media3.exoplayer.source.MediaSource.MediaSourceCaller
            public final void onSourceInfoRefreshed(MediaSource mediaSource2, Timeline timeline) {
                this.f$0.m7507x416e9463(t, mediaSource2, timeline);
            }
        };
