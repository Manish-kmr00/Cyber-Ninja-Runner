...
public final class ServerSideAdInsertionMediaSource extends BaseMediaSource implements MediaSource.MediaSourceCaller, MediaSourceEventListener, DrmSessionEventListener {
    ...
    public void setAdPlaybackStates(final ImmutableMap<Object, AdPlaybackState> immutableMap, final Timeline timeline) {
        ...
        synchronized (this) {
            ...
            if (handler == null) {
                ...
                handler.post(new Runnable() { // from class: io.bidmachine.media3.exoplayer.source.ads.ServerSideAdInsertionMediaSource$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m7524x8cbfd7fd(immutableMap, timeline);
                    }
                });
            }
        }
    ...
    /* JADX INFO: renamed from: lambda$setAdPlaybackStates$0$io-bidmachine-media3-exoplayer-source-ads-ServerSideAdInsertionMediaSource, reason: not valid java name */
    /* synthetic */ void m7524x8cbfd7fd(ImmutableMap immutableMap, Timeline timeline) {
