...
public final class AdsMediaSource extends CompositeMediaSource<MediaSource.MediaPeriodId> {
    ...
    protected void prepareSourceInternal(TransferListener transferListener) {
        ...
        this.mainHandler.post(new Runnable() { // from class: io.bidmachine.media3.exoplayer.source.ads.AdsMediaSource$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m7519xc6b90c02(componentListener);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$prepareSourceInternal$0$io-bidmachine-media3-exoplayer-source-ads-AdsMediaSource, reason: not valid java name */
    /* synthetic */ void m7519xc6b90c02(ComponentListener componentListener) {
    ...
    protected void releaseSourceInternal() {
        ...
        this.mainHandler.post(new Runnable() { // from class: io.bidmachine.media3.exoplayer.source.ads.AdsMediaSource$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m7520x8c516821(componentListener);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$releaseSourceInternal$1$io-bidmachine-media3-exoplayer-source-ads-AdsMediaSource, reason: not valid java name */
    /* synthetic */ void m7520x8c516821(ComponentListener componentListener) {
    ...
    public void m7507x416e9463(MediaSource.MediaPeriodId mediaPeriodId, MediaSource mediaSource, Timeline timeline) {
        if (mediaPeriodId.isAd()) {
    ...
    final class ComponentListener implements AdsLoader.EventListener {
        ...
        public void onAdPlaybackState(final AdPlaybackState adPlaybackState) {
            ...
            this.playerHandler.post(new Runnable() { // from class: io.bidmachine.media3.exoplayer.source.ads.AdsMediaSource$ComponentListener$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m7523xa2631a1a(adPlaybackState);
                }
            });
        }

        /* JADX INFO: renamed from: lambda$onAdPlaybackState$0$io-bidmachine-media3-exoplayer-source-ads-AdsMediaSource$ComponentListener, reason: not valid java name */
        /* synthetic */ void m7523xa2631a1a(AdPlaybackState adPlaybackState) {
            if (this.stopped) {
                return;
            }
    ...
    final class AdPrepareListener implements MaskingMediaPeriod.PrepareListener {
        ...
        public void onPrepareComplete(final MediaSource.MediaPeriodId mediaPeriodId) {
            AdsMediaSource.this.mainHandler.post(new Runnable() { // from class: io.bidmachine.media3.exoplayer.source.ads.AdsMediaSource$AdPrepareListener$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m7521x20815714(mediaPeriodId);
                }
            });
        }

        /* JADX INFO: renamed from: lambda$onPrepareComplete$0$io-bidmachine-media3-exoplayer-source-ads-AdsMediaSource$AdPrepareListener, reason: not valid java name */
        /* synthetic */ void m7521x20815714(MediaSource.MediaPeriodId mediaPeriodId) {
        ...
        public void onPrepareError(final MediaSource.MediaPeriodId mediaPeriodId, final IOException iOException) {
            ...
            AdsMediaSource.this.mainHandler.post(new Runnable() { // from class: io.bidmachine.media3.exoplayer.source.ads.AdsMediaSource$AdPrepareListener$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m7522x4609f9ba(mediaPeriodId, iOException);
                }
            });
        }

        /* JADX INFO: renamed from: lambda$onPrepareError$1$io-bidmachine-media3-exoplayer-source-ads-AdsMediaSource$AdPrepareListener, reason: not valid java name */
        /* synthetic */ void m7522x4609f9ba(MediaSource.MediaPeriodId mediaPeriodId, IOException iOException) {
