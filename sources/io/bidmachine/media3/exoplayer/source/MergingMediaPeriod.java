...
final class MergingMediaPeriod implements MediaPeriod, MediaPeriod.Callback {
    ...
    public long selectTracks(ExoTrackSelection[] exoTrackSelectionArr, boolean[] zArr, SampleStream[] sampleStreamArr, boolean[] zArr2, long j) {
        ...
        this.compositeSequenceableLoader = this.compositeSequenceableLoaderFactory.create(arrayList3, Lists.transform(arrayList3, new Function() { // from class: io.bidmachine.media3.exoplayer.source.MergingMediaPeriod$$ExternalSyntheticLambda0
