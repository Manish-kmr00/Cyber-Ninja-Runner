...
public final class ConcatenatingMediaSource2 extends CompositeMediaSource<Integer> {
    ...
    protected void prepareSourceInternal(TransferListener transferListener) {
        ...
        this.playbackThreadHandler = new Handler(new Handler.Callback() { // from class: io.bidmachine.media3.exoplayer.source.ConcatenatingMediaSource2$$ExternalSyntheticLambda0
    ...
    public void m7507x416e9463(Integer num, MediaSource mediaSource, Timeline timeline) {
        scheduleTimelineUpdate();
    }
    ...
    private ConcatenatedTimeline maybeCreateConcatenatedTimeline() {
        ...
        while (i < size) {
            ...
            while (i2 < timeline2.getWindowCount()) {
                ...
                boolean z7 = z3 && Util.areEqual(obj, window.manifest);
                ...
                while (i3 <= window.lastPeriodIndex) {
                    ...
                    if (i3 != window.firstPeriodIndex || ((mediaSourceHolder.index == 0 && i2 == 0) || j6 == -9223372036854775807L)) {
                        timeline = timeline2;
                        j = 0;
                    } else {
        ...
        return new ConcatenatedTimeline(getMediaItem(), builder.build(), builder2.build(), builder3.build(), z4, z6, j2, j3, z3 ? obj : null);
    }
