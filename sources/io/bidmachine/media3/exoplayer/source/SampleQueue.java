...
public class SampleQueue implements TrackOutput {
    ...
    private final SpannedData<SharedSampleMetadata> sharedSampleMetadata = new SpannedData<>(new Consumer() { // from class: io.bidmachine.media3.exoplayer.source.SampleQueue$$ExternalSyntheticLambda0
