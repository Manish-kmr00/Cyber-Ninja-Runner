...
final class ProgressiveMediaPeriod implements MediaPeriod, ExtractorOutput, Loader.Callback<ExtractingLoadable>, Loader.ReleaseCallback, SampleQueue.UpstreamFormatChangedListener {
    ...
    private final Runnable maybeFinishPrepareRunnable = new Runnable() { // from class: io.bidmachine.media3.exoplayer.source.ProgressiveMediaPeriod$$ExternalSyntheticLambda2
        @Override // java.lang.Runnable
        public final void run() {
            this.f$0.maybeFinishPrepare();
        }
    };
    private final Runnable onContinueLoadingRequestedRunnable = new Runnable() { // from class: io.bidmachine.media3.exoplayer.source.ProgressiveMediaPeriod$$ExternalSyntheticLambda3
        @Override // java.lang.Runnable
        public final void run() {
            this.f$0.m7516x694fb68f();
        }
    };
    ...
    /* JADX INFO: renamed from: lambda$new$0$io-bidmachine-media3-exoplayer-source-ProgressiveMediaPeriod, reason: not valid java name */
    /* synthetic */ void m7516x694fb68f() {
        if (this.released) {
            return;
        }
    ...
    public void seekMap(final SeekMap seekMap) {
        this.handler.post(new Runnable() { // from class: io.bidmachine.media3.exoplayer.source.ProgressiveMediaPeriod$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m7518x40d9a90a(seekMap);
            }
        });
    }
    ...
    public void onLengthKnown() {
        this.handler.post(new Runnable() { // from class: io.bidmachine.media3.exoplayer.source.ProgressiveMediaPeriod$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m7517xb240fecf();
            }
        });
    }

    /* JADX INFO: renamed from: lambda$onLengthKnown$2$io-bidmachine-media3-exoplayer-source-ProgressiveMediaPeriod, reason: not valid java name */
    /* synthetic */ void m7517xb240fecf() {
    ...
    public void m7518x40d9a90a(SeekMap seekMap) {
    ...
    public void maybeFinishPrepare() {
        ...
        if (this.isSingleSample && this.durationUs == -9223372036854775807L) {
            ...
            this.seekMap = new ForwardingSeekMap(this.seekMap) { // from class: io.bidmachine.media3.exoplayer.source.ProgressiveMediaPeriod.1
