...
public final class BundledExtractorsAdapter implements ProgressiveMediaExtractor {
    ...
    public void init(DataReader dataReader, Uri uri, Map<String, List<String>> map, long j, long j2, ExtractorOutput extractorOutput) throws IOException {
        ...
        if (extractorArrCreateExtractors.length == 1) {
            ...
            if (this.extractor == null) {
                throw new UnrecognizedInputFormatException("None of the available extractors (" + Joiner.on(", ").join(Lists.transform(ImmutableList.copyOf(extractorArrCreateExtractors), new Function() { // from class: io.bidmachine.media3.exoplayer.source.BundledExtractorsAdapter$$ExternalSyntheticLambda0
