...
final class HlsMediaPeriod implements MediaPeriod, HlsPlaylistTracker.PlaylistEventListener {
    ...
    public long selectTracks(ExoTrackSelection[] exoTrackSelectionArr, boolean[] zArr, SampleStream[] sampleStreamArr, boolean[] zArr2, long j) {
        ...
        this.compositeSequenceableLoader = this.compositeSequenceableLoaderFactory.create(immutableListCopyOf, Lists.transform(immutableListCopyOf, new Function() { // from class: io.bidmachine.media3.exoplayer.hls.HlsMediaPeriod$$ExternalSyntheticLambda0
    ...
    private void buildAndPrepareMainSampleStreamWrapper(HlsMultivariantPlaylist hlsMultivariantPlaylist, long j, List<HlsSampleStreamWrapper> list, List<int[]> list2, Map<String, DrmInitData> map) {
        ...
        HlsSampleStreamWrapper hlsSampleStreamWrapperBuildSampleStreamWrapper = buildSampleStreamWrapper(b9.h.Z, (z || codecCountOfType2 <= 0) ? 0 : 1, uriArr, formatArr, hlsMultivariantPlaylist.muxedAudioFormat, hlsMultivariantPlaylist.muxedCaptionFormats, map, j);
        ...
        if (this.allowChunklessPreparation && z3) {
            ...
            if (codecCountOfType > 0) {
                ...
                arrayList.add(new TrackGroup(b9.h.Z, formatArr2));
                ...
                i2 = 1;
                arrayList.add(new TrackGroup(b9.h.Z, formatArr3));
            }
            Format[] formatArr4 = new Format[i2];
            formatArr4[0] = new Format.Builder().setId("ID3").setSampleMimeType("application/id3").build();
