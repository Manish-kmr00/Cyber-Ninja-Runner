...
class DefaultDrmSession implements DrmSession {
    ...
    private boolean openInternal() {
        ...
        try {
            ...
            final int i = 3;
            this.state = 3;
            dispatchEvent(new Consumer() { // from class: io.bidmachine.media3.exoplayer.drm.DefaultDrmSession$$ExternalSyntheticLambda0
    ...
    private void doLicense(boolean z) {
        ...
        if (this.state == 4 || restoreKeys()) {
            ...
            if (this.mode == 0 && licenseDurationRemainingSec <= 60) {
                ...
                this.state = 4;
                dispatchEvent(new Consumer() { // from class: io.bidmachine.media3.exoplayer.drm.DefaultDrmSession$$ExternalSyntheticLambda1
                    @Override // io.bidmachine.media3.common.util.Consumer
                    public final void accept(Object obj) {
        ...
        if (obj == this.currentKeyRequest && isOpen()) {
            ...
            try {
                ...
                if (this.mode == 3) {
                    ...
                    dispatchEvent(new Consumer() { // from class: io.bidmachine.media3.exoplayer.drm.DefaultDrmSession$$ExternalSyntheticLambda3
                        @Override // io.bidmachine.media3.common.util.Consumer
                ...
                this.state = 4;
                dispatchEvent(new Consumer() { // from class: io.bidmachine.media3.exoplayer.drm.DefaultDrmSession$$ExternalSyntheticLambda4
                    @Override // io.bidmachine.media3.common.util.Consumer
                    public final void accept(Object obj3) {
    ...
    private void onError(final Throwable th, int i) {
        ...
        if (th instanceof Exception) {
            dispatchEvent(new Consumer() { // from class: io.bidmachine.media3.exoplayer.drm.DefaultDrmSession$$ExternalSyntheticLambda2
                @Override // io.bidmachine.media3.common.util.Consumer
                public final void accept(Object obj) {
