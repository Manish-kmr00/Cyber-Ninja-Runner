...
public final class OfflineLicenseHelper {
        ...
        try {
            ...
            this.handler.post(new Runnable() { // from class: io.bidmachine.media3.exoplayer.drm.OfflineLicenseHelper$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    this.f$0.m7493xf68af0ab(settableFutureCreate, drmSessionAcquireFirstSessionOnHandlerThread);
                }
            });
            try {
                try {
    ...
    /* JADX INFO: renamed from: lambda$getLicenseDurationRemainingSec$0$io-bidmachine-media3-exoplayer-drm-OfflineLicenseHelper, reason: not valid java name */
    /* synthetic */ void m7493xf68af0ab(SettableFuture settableFuture, DrmSession drmSession) {
        try {
    ...
    private byte[] acquireSessionAndGetOfflineLicenseKeySetIdOnHandlerThread(int i, byte[] bArr, Format format) throws DrmSession.DrmSessionException {
        ...
        this.handler.post(new Runnable() { // from class: io.bidmachine.media3.exoplayer.drm.OfflineLicenseHelper$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m7492x75b19e32(settableFutureCreate, drmSessionAcquireFirstSessionOnHandlerThread);
            }
        });
        try {
            try {
    ...
    /* JADX INFO: renamed from: lambda$acquireSessionAndGetOfflineLicenseKeySetIdOnHandlerThread$1$io-bidmachine-media3-exoplayer-drm-OfflineLicenseHelper, reason: not valid java name */
    /* synthetic */ void m7492x75b19e32(SettableFuture settableFuture, DrmSession drmSession) {
        try {
    ...
    private DrmSession acquireFirstSessionOnHandlerThread(final int i, final byte[] bArr, final Format format) throws DrmSession.DrmSessionException {
        ...
        this.handler.post(new Runnable() { // from class: io.bidmachine.media3.exoplayer.drm.OfflineLicenseHelper$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m7490x3fa8518c(i, bArr, settableFutureCreate, format);
            }
        });
        try {
            ...
            this.handler.post(new Runnable() { // from class: io.bidmachine.media3.exoplayer.drm.OfflineLicenseHelper$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m7491x653c5a8d(drmSession, settableFutureCreate2);
                }
            });
            try {
    ...
    /* JADX INFO: renamed from: lambda$acquireFirstSessionOnHandlerThread$2$io-bidmachine-media3-exoplayer-drm-OfflineLicenseHelper, reason: not valid java name */
    /* synthetic */ void m7490x3fa8518c(int i, byte[] bArr, SettableFuture settableFuture, Format format) {
        try {
    ...
    /* JADX INFO: renamed from: lambda$acquireFirstSessionOnHandlerThread$3$io-bidmachine-media3-exoplayer-drm-OfflineLicenseHelper, reason: not valid java name */
    /* synthetic */ void m7491x653c5a8d(DrmSession drmSession, SettableFuture settableFuture) {
        try {
    ...
    private void releaseManagerOnHandlerThread() {
        ...
        this.handler.post(new Runnable() { // from class: io.bidmachine.media3.exoplayer.drm.OfflineLicenseHelper$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m7494x5135c54a(settableFutureCreate);
            }
        });
        try {
    ...
    /* JADX INFO: renamed from: lambda$releaseManagerOnHandlerThread$4$io-bidmachine-media3-exoplayer-drm-OfflineLicenseHelper, reason: not valid java name */
    /* synthetic */ void m7494x5135c54a(SettableFuture settableFuture) {
        try {
            this.drmSessionManager.release();
