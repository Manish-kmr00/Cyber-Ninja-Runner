...
public final class DashMediaSource extends BaseMediaSource {
    ...
    private DashMediaSource(MediaItem mediaItem, DashManifest dashManifest, DataSource.Factory factory, ParsingLoadable.Parser<? extends DashManifest> parser, DashChunkSource.Factory factory2, CompositeSequenceableLoaderFactory compositeSequenceableLoaderFactory, CmcdConfiguration cmcdConfiguration, DrmSessionManager drmSessionManager, LoadErrorHandlingPolicy loadErrorHandlingPolicy, long j, long j2) {
        ...
        this.simulateManifestRefreshRunnable = new Runnable() { // from class: io.bidmachine.media3.exoplayer.dash.DashMediaSource$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m7478lambda$new$0$iobidmachinemedia3exoplayerdashDashMediaSource();
            }
        };
    }

    /* JADX INFO: renamed from: lambda$new$0$io-bidmachine-media3-exoplayer-dash-DashMediaSource, reason: not valid java name */
    /* synthetic */ void m7478lambda$new$0$iobidmachinemedia3exoplayerdashDashMediaSource() {
    ...
    private void updateLiveConfiguration(long j, long j2) {
        ...
        if (liveConfiguration.maxOffsetMs != -9223372036854775807L) {
            ...
            if (this.manifest.serviceDescription == null || this.manifest.serviceDescription.maxOffsetMs == -9223372036854775807L) {
                j3 = jUsToMs2;
            } else {
            ...
            if (f == -3.4028235E38f && f2 == -3.4028235E38f && (this.manifest.serviceDescription == null || this.manifest.serviceDescription.targetOffsetMs == -9223372036854775807L)) {
                f = 1.0f;
                f2 = 1.0f;
            }
