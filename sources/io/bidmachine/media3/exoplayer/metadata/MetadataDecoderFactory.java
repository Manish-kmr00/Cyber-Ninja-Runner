...
public interface MetadataDecoderFactory {
    public static final MetadataDecoderFactory DEFAULT = new MetadataDecoderFactory() { // from class: io.bidmachine.media3.exoplayer.metadata.MetadataDecoderFactory.1
