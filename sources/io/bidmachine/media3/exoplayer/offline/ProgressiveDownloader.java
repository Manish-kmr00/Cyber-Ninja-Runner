...
public final class ProgressiveDownloader implements Downloader {
    ...
    public ProgressiveDownloader(MediaItem mediaItem, CacheDataSource.Factory factory, Executor executor) {
        ...
        this.cacheWriter = new CacheWriter(cacheDataSourceCreateDataSourceForDownloading, dataSpecBuild, null, new CacheWriter.ProgressListener() { // from class: io.bidmachine.media3.exoplayer.offline.ProgressiveDownloader$$ExternalSyntheticLambda0
    ...
    public void download(Downloader.ProgressListener progressListener) throws InterruptedException, IOException {
        ...
        while (!z) {
            try {
                ...
                this.downloadRunnable = new RunnableFutureTask<Void, IOException>() { // from class: io.bidmachine.media3.exoplayer.offline.ProgressiveDownloader.1
