...
public final class DownloadHelper {
    ...
    public static RendererCapabilities[] getRendererCapabilities(RenderersFactory renderersFactory) {
        Renderer[] rendererArrCreateRenderers = renderersFactory.createRenderers(Util.createHandlerForCurrentOrMainLooper(), new VideoRendererEventListener() { // from class: io.bidmachine.media3.exoplayer.offline.DownloadHelper.1
        }, new AudioRendererEventListener() { // from class: io.bidmachine.media3.exoplayer.offline.DownloadHelper.2
        }, new TextOutput() { // from class: io.bidmachine.media3.exoplayer.offline.DownloadHelper$$ExternalSyntheticLambda3
            @Override // io.bidmachine.media3.exoplayer.text.TextOutput
            public final void onCues(CueGroup cueGroup) {
                DownloadHelper.lambda$getRendererCapabilities$0(cueGroup);
            }
        }, new MetadataOutput() { // from class: io.bidmachine.media3.exoplayer.offline.DownloadHelper$$ExternalSyntheticLambda4
    ...
    public DownloadHelper(MediaItem mediaItem, MediaSource mediaSource, TrackSelectionParameters trackSelectionParameters, RendererCapabilitiesList rendererCapabilitiesList) {
        ...
        defaultTrackSelector.init(new TrackSelector.InvalidationListener() { // from class: io.bidmachine.media3.exoplayer.offline.DownloadHelper$$ExternalSyntheticLambda6
        ...
        if (this.mediaSource != null) {
            ...
            this.callbackHandler.post(new Runnable() { // from class: io.bidmachine.media3.exoplayer.offline.DownloadHelper$$ExternalSyntheticLambda2
                ...
                public final void run() {
                    this.f$0.m7501xe899e367(callback);
                }
            });
        }
    }

    /* JADX INFO: renamed from: lambda$prepare$3$io-bidmachine-media3-exoplayer-offline-DownloadHelper, reason: not valid java name */
    /* synthetic */ void m7501xe899e367(Callback callback) {
    ...
    public void onMediaPrepared() throws ExoPlaybackException {
        ...
        ((Handler) Assertions.checkNotNull(this.callbackHandler)).post(new Runnable() { // from class: io.bidmachine.media3.exoplayer.offline.DownloadHelper$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m7500x79a8f443();
            }
        });
    }

    /* JADX INFO: renamed from: lambda$onMediaPrepared$4$io-bidmachine-media3-exoplayer-offline-DownloadHelper, reason: not valid java name */
    /* synthetic */ void m7500x79a8f443() {
    ...
    public void onMediaPreparationFailed(final IOException iOException) {
        ((Handler) Assertions.checkNotNull(this.callbackHandler)).post(new Runnable() { // from class: io.bidmachine.media3.exoplayer.offline.DownloadHelper$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m7499xf699cbeb(iOException);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$onMediaPreparationFailed$5$io-bidmachine-media3-exoplayer-offline-DownloadHelper, reason: not valid java name */
    /* synthetic */ void m7499xf699cbeb(IOException iOException) {
