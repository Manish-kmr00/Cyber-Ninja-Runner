...
public final class DefaultDownloadIndex implements WritableDownloadIndex {
    ...
    private static final String[] COLUMNS = {"id", "mime_type", "uri", COLUMN_STREAM_KEYS, COLUMN_CUSTOM_CACHE_KEY, "data", "state", COLUMN_START_TIME_MS, COLUMN_UPDATE_TIME_MS, COLUMN_CONTENT_LENGTH, "stop_reason", COLUMN_FAILURE_REASON, COLUMN_PERCENT_DOWNLOADED, COLUMN_BYTES_DOWNLOADED, COLUMN_KEY_SET_ID};
    ...
    @Override // io.bidmachine.media3.exoplayer.offline.WritableDownloadIndex
    ...
    private static List<StreamKey> decodeStreamKeys(String str) {
        ...
        for (String str2 : Util.split(str, StringUtils.COMMA)) {
            String[] strArrSplit = Util.split(str2, DnsName.ESCAPED_DOT);
