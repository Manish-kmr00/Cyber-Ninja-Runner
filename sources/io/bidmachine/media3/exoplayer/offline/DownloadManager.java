...
public final class DownloadManager {
    ...
    public DownloadManager(Context context, WritableDownloadIndex writableDownloadIndex, DownloaderFactory downloaderFactory) {
        ...
        Handler handlerCreateHandlerForCurrentOrMainLooper = Util.createHandlerForCurrentOrMainLooper(new Handler.Callback() { // from class: io.bidmachine.media3.exoplayer.offline.DownloadManager$$ExternalSyntheticLambda0
        ...
        RequirementsWatcher.Listener listener = new RequirementsWatcher.Listener() { // from class: io.bidmachine.media3.exoplayer.offline.DownloadManager$$ExternalSyntheticLambda1
