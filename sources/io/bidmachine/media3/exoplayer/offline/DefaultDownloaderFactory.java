...
public class DefaultDownloaderFactory implements DownloaderFactory {
    ...
    @Override // io.bidmachine.media3.exoplayer.offline.DownloaderFactory
    ...
    private static SparseArray<Constructor<? extends Downloader>> createDownloaderConstructors() {
        ...
        try {
            sparseArray.put(0, getDownloaderConstructor(Class.forName("io.bidmachine.media3.exoplayer.dash.offline.DashDownloader")));
        } catch (ClassNotFoundException unused) {
        }
        try {
            sparseArray.put(2, getDownloaderConstructor(Class.forName("io.bidmachine.media3.exoplayer.hls.offline.HlsDownloader")));
        } catch (ClassNotFoundException unused2) {
        }
        try {
            sparseArray.put(1, getDownloaderConstructor(Class.forName("io.bidmachine.media3.exoplayer.smoothstreaming.offline.SsDownloader")));
