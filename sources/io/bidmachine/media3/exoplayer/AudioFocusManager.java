...
final class AudioFocusManager {
    ...
    class AudioFocusListener implements AudioManager.OnAudioFocusChangeListener {
        ...
        /* JADX INFO: renamed from: lambda$onAudioFocusChange$0$io-bidmachine-media3-exoplayer-AudioFocusManager$AudioFocusListener, reason: not valid java name */
        /* synthetic */ void m7440x590ee217(int i) {
            AudioFocusManager.this.handlePlatformAudioFocusChange(i);
        }

        @Override // android.media.AudioManager.OnAudioFocusChangeListener
        public void onAudioFocusChange(final int i) {
            this.eventHandler.post(new Runnable() { // from class: io.bidmachine.media3.exoplayer.AudioFocusManager$AudioFocusListener$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m7440x590ee217(i);
                }
            });
        }
    }
