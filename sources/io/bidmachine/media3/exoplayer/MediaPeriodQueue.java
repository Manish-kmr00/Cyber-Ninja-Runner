...
final class MediaPeriodQueue {
    ...
    private void notifyQueueUpdate() {
        ...
        this.analyticsCollectorHandler.post(new Runnable() { // from class: io.bidmachine.media3.exoplayer.MediaPeriodQueue$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m7449x81ebb35a(builder, mediaPeriodId);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$notifyQueueUpdate$0$io-bidmachine-media3-exoplayer-MediaPeriodQueue, reason: not valid java name */
    /* synthetic */ void m7449x81ebb35a(ImmutableList.Builder builder, MediaSource.MediaPeriodId mediaPeriodId) {
