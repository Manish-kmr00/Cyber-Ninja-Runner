        ...
        for (Extractor extractor : extractorArrCreateExtractors) {
            try {
                if (extractor.sniff(extractorInput)) {
                    ...
                    throw new UnrecognizedInputFormatException("None of the available extractors (" + Joiner.on(", ").join(Lists.transform(ImmutableList.copyOf(extractorArrCreateExtractors), new Function() { // from class: io.bidmachine.media3.exoplayer.MediaExtractorCompat$$ExternalSyntheticLambda0
