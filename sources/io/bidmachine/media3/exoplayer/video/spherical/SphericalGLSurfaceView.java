...
public final class SphericalGLSurfaceView extends GLSurfaceView {
    ...
    protected void onDetachedFromWindow() {
        ...
        this.mainHandler.post(new Runnable() { // from class: io.bidmachine.media3.exoplayer.video.spherical.SphericalGLSurfaceView$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m7550x8980c754();
            }
        });
    }

    /* JADX INFO: renamed from: lambda$onDetachedFromWindow$0$io-bidmachine-media3-exoplayer-video-spherical-SphericalGLSurfaceView, reason: not valid java name */
    /* synthetic */ void m7550x8980c754() {
    ...
    public void onSurfaceTextureAvailable(final SurfaceTexture surfaceTexture) {
        this.mainHandler.post(new Runnable() { // from class: io.bidmachine.media3.exoplayer.video.spherical.SphericalGLSurfaceView$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m7551xdb90d08c(surfaceTexture);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$onSurfaceTextureAvailable$1$io-bidmachine-media3-exoplayer-video-spherical-SphericalGLSurfaceView, reason: not valid java name */
    /* synthetic */ void m7551xdb90d08c(SurfaceTexture surfaceTexture) {
