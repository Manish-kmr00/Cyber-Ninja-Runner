...
public final class CompositingVideoSinkProvider implements VideoSinkProvider, VideoGraph.Listener {
    private static final Executor NO_OP_EXECUTOR = new Executor() { // from class: io.bidmachine.media3.exoplayer.video.CompositingVideoSinkProvider$$ExternalSyntheticLambda0
    ...
    public VideoFrameProcessor initialize(Format format) throws VideoSink.VideoSinkException {
        ...
        try {
            ...
            this.videoGraph = factory.create(context, colorInfo, debugViewProvider, this, new Executor() { // from class: io.bidmachine.media3.exoplayer.video.CompositingVideoSinkProvider$$ExternalSyntheticLambda1
                @Override // java.util.concurrent.Executor
                public final void execute(Runnable runnable) {
    ...
    public void flush() {
        if (isInitialized()) {
            ...
            ((HandlerWrapper) Assertions.checkStateNotNull(this.handler)).post(new Runnable() { // from class: io.bidmachine.media3.exoplayer.video.CompositingVideoSinkProvider$$ExternalSyntheticLambda2
    ...
    final class VideoSinkImpl implements VideoSink, Listener {
        ...
        public void onFirstFrameRendered(CompositingVideoSinkProvider compositingVideoSinkProvider) {
            ...
            this.listenerExecutor.execute(new Runnable() { // from class: io.bidmachine.media3.exoplayer.video.CompositingVideoSinkProvider$VideoSinkImpl$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m7536x38321b7f(listener);
                }
            });
        }

        /* JADX INFO: renamed from: lambda$onFirstFrameRendered$0$io-bidmachine-media3-exoplayer-video-CompositingVideoSinkProvider$VideoSinkImpl, reason: not valid java name */
        /* synthetic */ void m7536x38321b7f(VideoSink.Listener listener) {
        ...
        public void onFrameDropped(CompositingVideoSinkProvider compositingVideoSinkProvider) {
            final VideoSink.Listener listener = this.listener;
            this.listenerExecutor.execute(new Runnable() { // from class: io.bidmachine.media3.exoplayer.video.CompositingVideoSinkProvider$VideoSinkImpl$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m7537x14b1f561(listener);
                }
            });
        }

        /* JADX INFO: renamed from: lambda$onFrameDropped$1$io-bidmachine-media3-exoplayer-video-CompositingVideoSinkProvider$VideoSinkImpl, reason: not valid java name */
        /* synthetic */ void m7537x14b1f561(VideoSink.Listener listener) {
        ...
        public void onVideoSizeChanged(CompositingVideoSinkProvider compositingVideoSinkProvider, final VideoSize videoSize) {
            final VideoSink.Listener listener = this.listener;
            this.listenerExecutor.execute(new Runnable() { // from class: io.bidmachine.media3.exoplayer.video.CompositingVideoSinkProvider$VideoSinkImpl$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m7538xd8fb5487(listener, videoSize);
                }
            });
        }

        /* JADX INFO: renamed from: lambda$onVideoSizeChanged$2$io-bidmachine-media3-exoplayer-video-CompositingVideoSinkProvider$VideoSinkImpl, reason: not valid java name */
        /* synthetic */ void m7538xd8fb5487(VideoSink.Listener listener, VideoSize videoSize) {
        ...
        public void onError(CompositingVideoSinkProvider compositingVideoSinkProvider, final VideoFrameProcessingException videoFrameProcessingException) {
            final VideoSink.Listener listener = this.listener;
            this.listenerExecutor.execute(new Runnable() { // from class: io.bidmachine.media3.exoplayer.video.CompositingVideoSinkProvider$VideoSinkImpl$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m7535x46011420(listener, videoFrameProcessingException);
                }
            });
        }

        /* JADX INFO: renamed from: lambda$onError$3$io-bidmachine-media3-exoplayer-video-CompositingVideoSinkProvider$VideoSinkImpl, reason: not valid java name */
        /* synthetic */ void m7535x46011420(VideoSink.Listener listener, VideoFrameProcessingException videoFrameProcessingException) {
    ...
    private static final class ReflectivePreviewingSingleInputVideoGraphFactory implements PreviewingVideoGraph.Factory {
        ...
        public PreviewingVideoGraph create(Context context, ColorInfo colorInfo, DebugViewProvider debugViewProvider, VideoGraph.Listener listener, Executor executor, List<Effect> list, long j) throws VideoFrameProcessingException {
            try {
                try {
                    return ((PreviewingVideoGraph.Factory) Class.forName("io.bidmachine.media3.effect.PreviewingSingleInputVideoGraph$Factory").getConstructor(VideoFrameProcessor.Factory.class).newInstance(this.videoFrameProcessorFactory)).create(context, colorInfo, debugViewProvider, listener, executor, list, j);
                } catch (Exception e) {
                    e = e;
    ...
    static final class ReflectiveDefaultVideoFrameProcessorFactory implements VideoFrameProcessor.Factory {
        private static final Supplier<VideoFrameProcessor.Factory> VIDEO_FRAME_PROCESSOR_FACTORY_SUPPLIER = Suppliers.memoize(new Supplier() { // from class: io.bidmachine.media3.exoplayer.video.CompositingVideoSinkProvider$ReflectiveDefaultVideoFrameProcessorFactory$$ExternalSyntheticLambda0
