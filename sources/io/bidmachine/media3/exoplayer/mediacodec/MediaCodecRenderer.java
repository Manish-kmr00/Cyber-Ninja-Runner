...
public abstract class MediaCodecRenderer extends BaseRenderer {
    ...
    */
    protected void onStreamChanged(io.bidmachine.media3.common.Format[] r13, long r14, long r16, io.bidmachine.media3.exoplayer.source.MediaSource.MediaPeriodId r18) throws io.bidmachine.media3.exoplayer.ExoPlaybackException {
        /*
            r12 = this;
            r0 = r12
            io.bidmachine.media3.exoplayer.mediacodec.MediaCodecRenderer$OutputStreamInfo r1 = r0.outputStreamInfo
            long r1 = r1.streamOffsetUs
            r3 = -9223372036854775807(0x8000000000000001, double:-4.9E-324)
            int r1 = (r1 > r3 ? 1 : (r1 == r3 ? 0 : -1))
            if (r1 != 0) goto L20
            io.bidmachine.media3.exoplayer.mediacodec.MediaCodecRenderer$OutputStreamInfo r1 = new io.bidmachine.media3.exoplayer.mediacodec.MediaCodecRenderer$OutputStreamInfo
            ...
            goto L65
        L20:
            java.util.ArrayDeque<io.bidmachine.media3.exoplayer.mediacodec.MediaCodecRenderer$OutputStreamInfo> r1 = r0.pendingOutputStreamChanges
        ...
        L55:
            java.util.ArrayDeque<io.bidmachine.media3.exoplayer.mediacodec.MediaCodecRenderer$OutputStreamInfo> r1 = r0.pendingOutputStreamChanges
            io.bidmachine.media3.exoplayer.mediacodec.MediaCodecRenderer$OutputStreamInfo r9 = new io.bidmachine.media3.exoplayer.mediacodec.MediaCodecRenderer$OutputStreamInfo
        ...
        L65:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: io.bidmachine.media3.exoplayer.mediacodec.MediaCodecRenderer.onStreamChanged(io.bidmachine.media3.common.Format[], long, long, io.bidmachine.media3.exoplayer.source.MediaSource$MediaPeriodId):void");
    }
    ...
    protected DecoderReuseEvaluation onInputFormatChanged(FormatHolder formatHolder) throws ExoPlaybackException {
        ...
        if (Objects.equals(formatBuild.sampleMimeType, "video/av01") && !formatBuild.initializationData.isEmpty()) {
