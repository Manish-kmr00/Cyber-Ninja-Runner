...
public final class MediaCodecUtil {
    ...
    public static List<MediaCodecInfo> getDecoderInfosSortedByFormatSupport(List<MediaCodecInfo> list, final Format format) {
        ...
        sortByScore(arrayList, new ScoreProvider() { // from class: io.bidmachine.media3.exoplayer.mediacodec.MediaCodecUtil$$ExternalSyntheticLambda3
            @Override // io.bidmachine.media3.exoplayer.mediacodec.MediaCodecUtil.ScoreProvider
    ...
    public static Pair<Integer, Integer> getCodecProfileAndLevel(Format format) {
        ...
        String[] strArrSplit = format.codecs.split(DnsName.ESCAPED_DOT);
    ...
    /* JADX WARN: Code duplicated, block: B:60:0x0109 A[Catch: Exception -> 0x015f, TRY_ENTER, TryCatch #0 {Exception -> 0x015f, blocks: (B:3:0x0009, B:5:0x001c, B:63:0x012b, B:8:0x002e, B:11:0x0039, B:57:0x0101, B:60:0x0109, B:62:0x010f, B:64:0x0135, B:65:0x015d), top: B:70:0x0009 }] */
    /* JADX WARN: Code duplicated, block: B:7:0x0026  */
    /* JADX WARN: Code duplicated, block: B:84:0x0135 A[ADDED_TO_REGION, REMOVE, SYNTHETIC] */
    ...
    private static boolean isCodecUsableDecoder(android.media.MediaCodecInfo mediaCodecInfo, String str, boolean z, String str2) {
        ...
        if (Util.SDK_INT < 24 && (("OMX.SEC.aac.dec".equals(str) || "OMX.Exynos.AAC.Decoder".equals(str)) && Constants.REFERRER_API_SAMSUNG.equals(Util.MANUFACTURER) && (Util.DEVICE.startsWith("zeroflte") || Util.DEVICE.startsWith("zerolte") || Util.DEVICE.startsWith("zenlte") || "SC-05G".equals(Util.DEVICE) || "marinelteatt".equals(Util.DEVICE) || "404SC".equals(Util.DEVICE) || "SC-04G".equals(Util.DEVICE) || "SCV31".equals(Util.DEVICE)))) {
            return false;
        }
        if (Util.SDK_INT == 19 && "OMX.SEC.vp8.dec".equals(str) && Constants.REFERRER_API_SAMSUNG.equals(Util.MANUFACTURER) && (Util.DEVICE.startsWith("d2") || Util.DEVICE.startsWith("serrano") || Util.DEVICE.startsWith("jflte") || Util.DEVICE.startsWith("santos") || Util.DEVICE.startsWith("t0"))) {
            return false;
        }
    ...
    private static void applyWorkarounds(String str, List<MediaCodecInfo> list) {
        if ("audio/raw".equals(str)) {
            ...
            sortByScore(list, new ScoreProvider() { // from class: io.bidmachine.media3.exoplayer.mediacodec.MediaCodecUtil$$ExternalSyntheticLambda1
                @Override // io.bidmachine.media3.exoplayer.mediacodec.MediaCodecUtil.ScoreProvider
                public final int getScore(Object obj) {
        ...
        if (Util.SDK_INT < 21 && list.size() > 1) {
            ...
            if ("OMX.SEC.mp3.dec".equals(str2) || "OMX.SEC.MP3.Decoder".equals(str2) || "OMX.brcm.audio.mp3.decoder".equals(str2)) {
                sortByScore(list, new ScoreProvider() { // from class: io.bidmachine.media3.exoplayer.mediacodec.MediaCodecUtil$$ExternalSyntheticLambda2
                    @Override // io.bidmachine.media3.exoplayer.mediacodec.MediaCodecUtil.ScoreProvider
                    public final int getScore(Object obj) {
    ...
    private static <T> void sortByScore(List<T> list, final ScoreProvider<T> scoreProvider) {
        Collections.sort(list, new Comparator() { // from class: io.bidmachine.media3.exoplayer.mediacodec.MediaCodecUtil$$ExternalSyntheticLambda0
    ...
    private static final class MediaCodecListCompatV21 implements MediaCodecListCompat {
        ...
        @Override // io.bidmachine.media3.exoplayer.mediacodec.MediaCodecUtil.MediaCodecListCompat
