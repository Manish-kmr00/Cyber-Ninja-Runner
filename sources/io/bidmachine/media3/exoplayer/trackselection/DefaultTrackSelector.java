...
public class DefaultTrackSelector extends MappingTrackSelector implements RendererCapabilities.Listener {
    ...
    private static final Ordering<Integer> FORMAT_VALUE_ORDERING = Ordering.from(new Comparator() { // from class: io.bidmachine.media3.exoplayer.trackselection.DefaultTrackSelector$$ExternalSyntheticLambda9
        ...
        public static final class Builder extends TrackSelectionParameters.Builder {
            ...
            private void setSelectionOverridesFromBundle(Bundle bundle) {
                ...
                if (parcelableArrayList == null) {
                    ...
                    immutableListFromBundleList = BundleCollectionUtil.fromBundleList(new Function() { // from class: io.bidmachine.media3.exoplayer.trackselection.DefaultTrackSelector$Parameters$Builder$$ExternalSyntheticLambda0
                ...
                if (sparseParcelableArray == null) {
                    ...
                    sparseArrayFromBundleSparseArray = BundleCollectionUtil.fromBundleSparseArray(new Function() { // from class: io.bidmachine.media3.exoplayer.trackselection.DefaultTrackSelector$Parameters$Builder$$ExternalSyntheticLambda1
                        @Override // com.google.common.base.Function
                        public final Object apply(Object obj) {
    ...
    protected Pair<ExoTrackSelection.Definition, Integer> selectVideoTrack(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, final int[] iArr2, final Parameters parameters) throws ExoPlaybackException {
        ...
        return selectTracksForType(2, mappedTrackInfo, iArr, new TrackInfo.Factory() { // from class: io.bidmachine.media3.exoplayer.trackselection.DefaultTrackSelector$$ExternalSyntheticLambda7
    ...
    protected Pair<ExoTrackSelection.Definition, Integer> selectAudioTrack(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, final int[] iArr2, final Parameters parameters) throws ExoPlaybackException {
        ...
        return selectTracksForType(1, mappedTrackInfo, iArr, new TrackInfo.Factory() { // from class: io.bidmachine.media3.exoplayer.trackselection.DefaultTrackSelector$$ExternalSyntheticLambda2
            @Override // io.bidmachine.media3.exoplayer.trackselection.DefaultTrackSelector.TrackInfo.Factory
            public final List create(int i2, TrackGroup trackGroup, int[] iArr3) {
                return this.f$0.m7532x577a29cb(parameters, z, iArr2, i2, trackGroup, iArr3);
            }
    ...
    /* JADX INFO: renamed from: lambda$selectAudioTrack$2$io-bidmachine-media3-exoplayer-trackselection-DefaultTrackSelector, reason: not valid java name */
    /* synthetic */ List m7532x577a29cb(Parameters parameters, boolean z, int[] iArr, int i, TrackGroup trackGroup, int[] iArr2) {
        return AudioTrackInfo.createForTrackGroup(i, trackGroup, parameters, iArr2, z, new Predicate() { // from class: io.bidmachine.media3.exoplayer.trackselection.DefaultTrackSelector$$ExternalSyntheticLambda4
    ...
    protected Pair<ExoTrackSelection.Definition, Integer> selectImageTrack(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, final Parameters parameters) throws ExoPlaybackException {
        ...
        return selectTracksForType(4, mappedTrackInfo, iArr, new TrackInfo.Factory() { // from class: io.bidmachine.media3.exoplayer.trackselection.DefaultTrackSelector$$ExternalSyntheticLambda5
            @Override // io.bidmachine.media3.exoplayer.trackselection.DefaultTrackSelector.TrackInfo.Factory
            public final List create(int i, TrackGroup trackGroup, int[] iArr2) {
                return DefaultTrackSelector.ImageTrackInfo.createForTrackGroup(i, trackGroup, parameters, iArr2);
            }
        }, new Comparator() { // from class: io.bidmachine.media3.exoplayer.trackselection.DefaultTrackSelector$$ExternalSyntheticLambda6
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
    ...
    static class SpatializerWrapperV32 {
        ...
        public void ensureInitialized(final DefaultTrackSelector defaultTrackSelector, Looper looper) {
            if (this.listener == null && this.handler == null) {
                this.listener = new Spatializer.OnSpatializerStateChangedListener() { // from class: io.bidmachine.media3.exoplayer.trackselection.DefaultTrackSelector.SpatializerWrapperV32.1
                ...
                spatializer.addOnSpatializerStateChangedListener(new Executor() { // from class: io.bidmachine.media3.exoplayer.trackselection.DefaultTrackSelector$SpatializerWrapperV32$$ExternalSyntheticLambda0
