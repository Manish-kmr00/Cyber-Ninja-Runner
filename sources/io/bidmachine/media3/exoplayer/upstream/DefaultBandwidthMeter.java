...
public final class DefaultBandwidthMeter implements BandwidthMeter, TransferListener {
    ...
    public static final ImmutableList<Long> DEFAULT_INITIAL_BITRATE_ESTIMATES_4G = ImmutableList.of(2500000L, 1700000L, (long) Long.valueOf(d.N), 970000L, 680000L);
    ...
    private DefaultBandwidthMeter(Context context, Map<Integer, Long> map, int i, Clock clock, boolean z) {
        ...
        if (context != null) {
            ...
            networkTypeObserver.register(new NetworkTypeObserver.Listener() { // from class: io.bidmachine.media3.exoplayer.upstream.DefaultBandwidthMeter$$ExternalSyntheticLambda0
