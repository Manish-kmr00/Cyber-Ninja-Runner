...
public final class CmcdConfiguration {
    ...
    public interface Factory {
        public static final Factory DEFAULT = new Factory() { // from class: io.bidmachine.media3.exoplayer.upstream.CmcdConfiguration$Factory$$ExternalSyntheticLambda0
        ...
        static /* synthetic */ CmcdConfiguration lambda$static$0(MediaItem mediaItem) {
            ...
            return new CmcdConfiguration(string, str, new RequestConfig() { // from class: io.bidmachine.media3.exoplayer.upstream.CmcdConfiguration.Factory.1
            });
        }
    }
