    ...
    final class NetworkCallback extends ConnectivityManager.NetworkCallback {
        ...
        private void postCheckRequirements() {
            RequirementsWatcher.this.handler.post(new Runnable() { // from class: io.bidmachine.media3.exoplayer.scheduler.RequirementsWatcher$NetworkCallback$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    this.f$0.m7505x5f4f1754();
                }
            });
        }

        /* JADX INFO: renamed from: lambda$postCheckRequirements$0$io-bidmachine-media3-exoplayer-scheduler-RequirementsWatcher$NetworkCallback, reason: not valid java name */
        /* synthetic */ void m7505x5f4f1754() {
        ...
        private void postRecheckNotMetNetworkRequirements() {
            RequirementsWatcher.this.handler.post(new Runnable() { // from class: io.bidmachine.media3.exoplayer.scheduler.RequirementsWatcher$NetworkCallback$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m7506x23621531();
                }
            });
        }

        /* JADX INFO: renamed from: lambda$postRecheckNotMetNetworkRequirements$1$io-bidmachine-media3-exoplayer-scheduler-RequirementsWatcher$NetworkCallback, reason: not valid java name */
        /* synthetic */ void m7506x23621531() {
            if (RequirementsWatcher.this.networkCallback != null) {
