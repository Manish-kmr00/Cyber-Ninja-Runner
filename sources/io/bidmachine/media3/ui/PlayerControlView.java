...
public class PlayerControlView extends FrameLayout {
    ...
    public PlayerControlView(Context context, AttributeSet attributeSet, int i, AttributeSet attributeSet2) throws Throwable {
        ...
        int i20 = R.layout.bm_exo_player_control_view;
        ...
        if (attributeSet2 != null) {
            ...
            try {
                ...
                try {
                    ...
                    boolean z11 = typedArrayObtainStyledAttributes.getBoolean(R.styleable.PlayerControlView_show_rewind_button, true);
                    boolean z12 = typedArrayObtainStyledAttributes.getBoolean(R.styleable.PlayerControlView_show_fastforward_button, true);
                    boolean z13 = typedArrayObtainStyledAttributes.getBoolean(R.styleable.PlayerControlView_show_previous_button, true);
                    boolean z14 = typedArrayObtainStyledAttributes.getBoolean(R.styleable.PlayerControlView_show_next_button, true);
                    boolean z15 = typedArrayObtainStyledAttributes.getBoolean(R.styleable.PlayerControlView_show_shuffle_button, false);
                    boolean z16 = typedArrayObtainStyledAttributes.getBoolean(R.styleable.PlayerControlView_show_subtitle_button, false);
                    boolean z17 = typedArrayObtainStyledAttributes.getBoolean(R.styleable.PlayerControlView_show_vr_button, false);
                    ...
                    boolean z18 = typedArrayObtainStyledAttributes.getBoolean(R.styleable.PlayerControlView_animation_enabled, true);
        ...
        initializeFullScreenButton(imageView2, new View.OnClickListener() { // from class: io.bidmachine.media3.ui.PlayerControlView$$ExternalSyntheticLambda1
        ...
        if (imageView5 != null) {
            imageView5.setImageDrawable(Util.getDrawable(context, resources, i3));
        ...
        if (imageView6 != null) {
            imageView6.setImageDrawable(Util.getDrawable(context, resources, i16));
        ...
        if (imageView7 != null) {
            z9 = z;
            imageView7.setImageDrawable(Util.getDrawable(context, resources, i4));
        ...
        if (imageView8 != null) {
            imageView8.setImageDrawable(Util.getDrawable(context, resources, i19));
        ...
        if (imageView11 != null) {
            imageView11.setImageDrawable(Util.getDrawable(context, resources, i2));
        ...
        public SettingViewHolder(View view) {
            ...
            view.setOnClickListener(new View.OnClickListener() { // from class: io.bidmachine.media3.ui.PlayerControlView$SettingViewHolder$$ExternalSyntheticLambda0
                ...
                public final void onClick(View view2) {
                    this.f$0.m7561xc7c173d2(view2);
                }
            });
        }

        /* JADX INFO: renamed from: lambda$new$0$io-bidmachine-media3-ui-PlayerControlView$SettingViewHolder, reason: not valid java name */
        /* synthetic */ void m7561xc7c173d2(View view) {
    ...
    final class PlaybackSpeedAdapter extends RecyclerView.Adapter<SubSettingViewHolder> {
        ...
        public void onBindViewHolder(SubSettingViewHolder subSettingViewHolder, final int i) {
            ...
            subSettingViewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: io.bidmachine.media3.ui.PlayerControlView$PlaybackSpeedAdapter$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.m7560x573f6ccb(i, view);
                }
            });
        }

        /* JADX INFO: renamed from: lambda$onBindViewHolder$0$io-bidmachine-media3-ui-PlayerControlView$PlaybackSpeedAdapter, reason: not valid java name */
        /* synthetic */ void m7560x573f6ccb(int i, View view) {
            if (i != this.selectedIndex) {
    ...
    final class TextTrackSelectionAdapter extends TrackSelectionAdapter {
        ...
        public void onBindViewHolderAtZeroPosition(SubSettingViewHolder subSettingViewHolder) {
            ...
            subSettingViewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: io.bidmachine.media3.ui.PlayerControlView$TextTrackSelectionAdapter$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.m7562x87ec72bd(view);
                }
            });
        }

        /* JADX INFO: renamed from: lambda$onBindViewHolderAtZeroPosition$0$io-bidmachine-media3-ui-PlayerControlView$TextTrackSelectionAdapter, reason: not valid java name */
        /* synthetic */ void m7562x87ec72bd(View view) {
    ...
    final class AudioTrackSelectionAdapter extends TrackSelectionAdapter {
        ...
        public void onBindViewHolderAtZeroPosition(SubSettingViewHolder subSettingViewHolder) {
            ...
            subSettingViewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: io.bidmachine.media3.ui.PlayerControlView$AudioTrackSelectionAdapter$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.m7559x1f07ce7c(view);
                }
            });
        }

        /* JADX INFO: renamed from: lambda$onBindViewHolderAtZeroPosition$0$io-bidmachine-media3-ui-PlayerControlView$AudioTrackSelectionAdapter, reason: not valid java name */
        /* synthetic */ void m7559x1f07ce7c(View view) {
            if (PlayerControlView.this.player == null || !PlayerControlView.this.player.isCommandAvailable(29)) {
                return;
            }
    ...
    abstract class TrackSelectionAdapter extends RecyclerView.Adapter<SubSettingViewHolder> {
        ...
        public void onBindViewHolder(SubSettingViewHolder subSettingViewHolder, int i) {
            ...
            subSettingViewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: io.bidmachine.media3.ui.PlayerControlView$TrackSelectionAdapter$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.m7563xb7f94e86(player, mediaTrackGroup, trackInformation, view);
                }
            });
        }

        /* JADX INFO: renamed from: lambda$onBindViewHolder$0$io-bidmachine-media3-ui-PlayerControlView$TrackSelectionAdapter, reason: not valid java name */
        /* synthetic */ void m7563xb7f94e86(Player player, TrackGroup trackGroup, TrackInformation trackInformation, View view) {
