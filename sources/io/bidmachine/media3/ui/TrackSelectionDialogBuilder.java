...
public final class TrackSelectionDialogBuilder {
    ...
    private Dialog buildForAndroidX() {
        try {
            ...
            View viewInflate = LayoutInflater.from((Context) cls.getMethod("getContext", new Class[0]).invoke(objNewInstance, new Object[0])).inflate(R.layout.bm_exo_track_selection_dialog, (ViewGroup) null);
    ...
    private DialogInterface.OnClickListener setUpDialogView(View view) {
        ...
        return new DialogInterface.OnClickListener() { // from class: io.bidmachine.media3.ui.TrackSelectionDialogBuilder$$ExternalSyntheticLambda1
            ...
            public final void onClick(DialogInterface dialogInterface, int i) {
                this.f$0.m7577xea8cab51(trackSelectionView, dialogInterface, i);
            }
        };
    }

    /* JADX INFO: renamed from: lambda$setUpDialogView$1$io-bidmachine-media3-ui-TrackSelectionDialogBuilder, reason: not valid java name */
    /* synthetic */ void m7577xea8cab51(TrackSelectionView trackSelectionView, DialogInterface dialogInterface, int i) {
