...
final class SsaStyle {
    ...
    public static SsaStyle fromStyleLine(String str, Format format) {
        ...
        String[] strArrSplit = TextUtils.split(str.substring("Style:".length()), StringUtils.COMMA);
    ...
    static final class Format {
        ...
        public static Format fromFormatLine(String str) {
            String[] strArrSplit = TextUtils.split(str.substring("Format:".length()), StringUtils.COMMA);
            int i = -1;
            int i2 = -1;
            int i3 = -1;
            int i4 = -1;
