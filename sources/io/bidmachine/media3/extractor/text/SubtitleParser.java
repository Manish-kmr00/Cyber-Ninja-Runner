...
public interface SubtitleParser {
    ...
    public interface Factory {
        public static final Factory UNSUPPORTED = new Factory() { // from class: io.bidmachine.media3.extractor.text.SubtitleParser.Factory.1
    ...
    default Subtitle parseToLegacySubtitle(byte[] bArr, int i, int i2) {
        ...
        parse(bArr, i, i2, outputOptions, new Consumer() { // from class: io.bidmachine.media3.extractor.text.SubtitleParser$$ExternalSyntheticLambda0
