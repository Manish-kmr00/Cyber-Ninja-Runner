...
public class SubtitleExtractor implements Extractor {
    ...
    private void parseAndWriteToOutput() throws IOException {
        ...
        try {
            ...
            this.subtitleParser.parse(this.subtitleData, 0, this.bytesRead, outputOptionsAllCues, new Consumer() { // from class: io.bidmachine.media3.extractor.text.SubtitleExtractor$$ExternalSyntheticLambda0
                @Override // io.bidmachine.media3.common.util.Consumer
                public final void accept(Object obj) {
                    this.f$0.m7553xad9c6879((CuesWithTiming) obj);
                }
            });
    ...
    /* JADX INFO: renamed from: lambda$parseAndWriteToOutput$0$io-bidmachine-media3-extractor-text-SubtitleExtractor, reason: not valid java name */
    /* synthetic */ void m7553xad9c6879(CuesWithTiming cuesWithTiming) {
