...
public final class DtsUtil {
    ...
    public static DtsHeader parseDtsHdHeader(byte[] bArr) throws ParserException {
        ...
        return new DtsHeader("audio/vnd.dts.hd;profile=lbr", bits2, i3, bits4, jScaleLargeTimestamp, 0);
    }
    ...
    public static DtsHeader parseDtsUhdHeader(byte[] bArr, AtomicInteger atomicInteger) throws ParserException {
        ...
        if (i3 == 0) {
            ...
            if (bits2 == 0) {
                ...
                i = DtbConstants.DEFAULT_PLAYER_HEIGHT;
            } else {
                if (bits2 != 2) {
        ...
        return new DtsHeader("audio/vnd.dts.uhd;profile=p2", 2, i4, unsignedVarInt + unsignedVarInt2 + (atomicInteger.get() != 0 ? parseUnsignedVarInt(normalizedFrame, UHD_AUDIO_CHUNK_SIZE_LENGTH_TABLE, true) : 0), j, 0);
    }
