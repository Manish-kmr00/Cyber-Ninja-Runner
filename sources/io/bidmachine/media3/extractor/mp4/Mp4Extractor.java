...
public final class Mp4Extractor implements Extractor, SeekMap {
    ...
    @Deprecated
    public static final ExtractorsFactory FACTORY = new ExtractorsFactory() { // from class: io.bidmachine.media3.extractor.mp4.Mp4Extractor$$ExternalSyntheticLambda0
    ...
    public static ExtractorsFactory newFactory(final SubtitleParser.Factory factory) {
        return new ExtractorsFactory() { // from class: io.bidmachine.media3.extractor.mp4.Mp4Extractor$$ExternalSyntheticLambda1
            @Override // io.bidmachine.media3.extractor.ExtractorsFactory
            public final Extractor[] createExtractors() {
    ...
    private void processMoovAtom(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        Metadata metadata3 = new Metadata(AtomParsers.parseMvhd(((Atom.LeafAtom) Assertions.checkNotNull(containerAtom.getLeafAtomOfType(1836476516))).data));
        long j = -9223372036854775807L;
        List<TrackSampleTable> traks = AtomParsers.parseTraks(containerAtom, gaplessInfoHolder, -9223372036854775807L, null, (this.flags & 1) != 0, z, new Function() { // from class: io.bidmachine.media3.extractor.mp4.Mp4Extractor$$ExternalSyntheticLambda2
