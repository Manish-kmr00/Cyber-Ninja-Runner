...
public final class TextInformationFrame extends Id3Frame {
    public static final Parcelable.Creator<TextInformationFrame> CREATOR = new Parcelable.Creator<TextInformationFrame>() { // from class: io.bidmachine.media3.extractor.metadata.id3.TextInformationFrame.1
    ...
    public void populateMediaMetadata(MediaMetadata.Builder builder) {
        ...
        try {
            switch (b) {
                ...
                case 6:
                case 21:
                    String[] strArrSplit = Util.split(this.values.get(0), RemoteSettings.FORWARD_SLASH_STRING);
