...
public final class InitProto {
    ...
    static {
        ...
        internal_static_bidmachine_protobuf_InitRequest_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor3, new String[]{"SellerId", "Bundle", "Os", "Osv", "Geo", "Sdk", "Sdkver", "Ifa", "Ifv", "BmIfv", "DeviceType", "Contype", "AppVer", "SessionId", "Ext", ExifInterface.TAG_MAKE, ExifInterface.TAG_MODEL, "Hwv", "Context", "Android", "Ios", "PlatformData"});
        Descriptors.Descriptor descriptor4 = descriptor3.getNestedTypes().get(0);
        internal_static_bidmachine_protobuf_InitRequest_AndroidPlatformData_descriptor = descriptor4;
        internal_static_bidmachine_protobuf_InitRequest_AndroidPlatformData_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor4, new String[]{"MinApiLevel", "KotlinVersion"});
        Descriptors.Descriptor descriptor5 = descriptor3.getNestedTypes().get(1);
        internal_static_bidmachine_protobuf_InitRequest_iOSPlatformData_descriptor = descriptor5;
        internal_static_bidmachine_protobuf_InitRequest_iOSPlatformData_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor5, new String[]{"MinOsVersion", "OsExecutionEnv"});
        ...
        internal_static_bidmachine_protobuf_AdNetwork_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor6, new String[]{"Name", "ClassName", "CustomParams", "AdUnits"});
        Descriptors.Descriptor descriptor7 = descriptor6.getNestedTypes().get(0);
        internal_static_bidmachine_protobuf_AdNetwork_CustomParamsEntry_descriptor = descriptor7;
        internal_static_bidmachine_protobuf_AdNetwork_CustomParamsEntry_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor7, new String[]{"Key", "Value"});
        ...
        internal_static_bidmachine_protobuf_AdNetwork_AdUnit_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor8, new String[]{"AdFormat", "CustomParams"});
        Descriptors.Descriptor descriptor9 = descriptor8.getNestedTypes().get(0);
        internal_static_bidmachine_protobuf_AdNetwork_AdUnit_CustomParamsEntry_descriptor = descriptor9;
        internal_static_bidmachine_protobuf_AdNetwork_AdUnit_CustomParamsEntry_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor9, new String[]{"Key", "Value"});
        ...
        internal_static_bidmachine_protobuf_AdCachePlacementControl_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor10, new String[]{"MaxCacheSize", "MaxRetainCount", "MaxAge"});
        ...
        internal_static_bidmachine_protobuf_SdkAnalyticConfig_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor11, new String[]{"Url", "Context", "Interval", "Count", "MetricConfigs"});
        Descriptors.Descriptor descriptor12 = descriptor11.getNestedTypes().get(0);
        internal_static_bidmachine_protobuf_SdkAnalyticConfig_MetricConfig_descriptor = descriptor12;
        internal_static_bidmachine_protobuf_SdkAnalyticConfig_MetricConfig_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor12, new String[]{"Name", "Dimensions", "Metrics"});
        ...
        internal_static_bidmachine_protobuf_TokenConfiguration_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor13, new String[]{"Type", "ExpirationTime", "AdNetworks"});
        ...
        internal_static_bidmachine_protobuf_InitResponse_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor14, new String[]{"Endpoint", "Event", "SessionResetAfter", "AdNetworks", "AdCacheControl", "AdCacheMaxAge", "AdRequestTmax", "AdCachePlacementControl", "AdNetworksLoadingTimeout", "SdkAnalyticConfig", "EventConfiguration", "TokenConfigurations", "ShowWithoutInternet", "Extras", "SdkAnalyticConfigV2"});
        ...
        internal_static_bidmachine_protobuf_InitResponse_AdCachePlacementControlEntry_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor15, new String[]{"Key", "Value"});
        ...
        internal_static_bidmachine_protobuf_SdkAnalyticContext_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor16, new String[]{"SourceId", "Bundle", "Os", "Osv", "Geo", "Sdk", "Sdkver", "Ifa", "Ifv", "BmIfv", "DeviceType", "Contype", "AppVer", "SessionId", "Dcid", "Ext", "Experiments"});
