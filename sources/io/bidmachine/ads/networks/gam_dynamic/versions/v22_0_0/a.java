...
class a extends InternalBannerAd {
    ...
    static final class b extends AdListener {
        ...
        public /* synthetic */ void a(LoadAdError loadAdError) {
            this.b.onAdLoadFailed(this.f12015a, e.a(BMError.NoFill, loadAdError));
        }

        @Override // com.google.android.gms.ads.AdListener
        public void onAdClicked() {
            InternalAdPresentListener adPresentListener = this.f12015a.getAdPresentListener();
        ...
        public void onAdFailedToLoad(final LoadAdError loadAdError) {
            this.f12015a.onBackground(new Runnable() { // from class: io.bidmachine.ads.networks.gam_dynamic.versions.v22_0_0.a$b$$ExternalSyntheticLambda0
        ...
        public void onAdLoaded() {
            this.f12015a.onBackground(new Runnable() { // from class: io.bidmachine.ads.networks.gam_dynamic.versions.v22_0_0.a$b$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.a();
                }
        ...
        public /* synthetic */ void a() {
            InternalAdLoadData internalAdLoadDataA = e.a(this.f12015a.b);
            this.f12015a.onAdLoaded(internalAdLoadDataA);
            this.b.onAdLoaded(this.f12015a, internalAdLoadDataA);
        }
    }
    ...
    static final class c implements OnPaidEventListener {
        ...
        public /* synthetic */ void a(AdValue adValue) {
            this.f12016a.onPaidEvent(e.a(adValue));
        }

        @Override // com.google.android.gms.ads.OnPaidEventListener
        public void onPaidEvent(final AdValue adValue) {
            this.f12016a.onBackground(new Runnable() { // from class: io.bidmachine.ads.networks.gam_dynamic.versions.v22_0_0.a$c$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.a(adValue);
                }
