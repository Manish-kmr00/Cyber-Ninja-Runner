...
class d extends InternalRewardedAd {
    ...
    static final class b extends RewardedAdLoadCallback {
        ...
        public /* synthetic */ void a(LoadAdError loadAdError) {
            this.b.onAdLoadFailed(this.f12011a, e.a(BMError.NoFill, loadAdError));
        }

        @Override // com.google.android.gms.ads.AdLoadCallback
        public void onAdFailedToLoad(final LoadAdError loadAdError) {
            this.f12011a.onBackground(new Runnable() { // from class: io.bidmachine.ads.networks.gam_dynamic.versions.v21_0_0.d$b$$ExternalSyntheticLambda0
        ...
        public void onAdLoaded(final RewardedAd rewardedAd) {
            ...
            this.f12011a.f12010a = rewardedAd;
            this.f12011a.onBackground(new Runnable() { // from class: io.bidmachine.ads.networks.gam_dynamic.versions.v21_0_0.d$b$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
        ...
        public /* synthetic */ void a(RewardedAd rewardedAd) {
            ...
            this.f12011a.onAdLoaded(internalAdLoadDataA);
            this.b.onAdLoaded(this.f12011a, internalAdLoadDataA);
        }
    }
    ...
    static final class c implements OnPaidEventListener {
        ...
        public /* synthetic */ void a(AdValue adValue) {
            this.f12012a.onPaidEvent(e.a(adValue));
        }

        @Override // com.google.android.gms.ads.OnPaidEventListener
        public void onPaidEvent(final AdValue adValue) {
            this.f12012a.onBackground(new Runnable() { // from class: io.bidmachine.ads.networks.gam_dynamic.versions.v21_0_0.d$c$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.a(adValue);
                }
    ...
    private static final class C0767d implements OnUserEarnedRewardListener {
        private C0767d() {
        }
    ...
    protected void destroyAd() {
        RewardedAd rewardedAd = this.f12010a;
        if (rewardedAd != null) {
            rewardedAd.setFullScreenContentCallback(null);
            this.f12010a.setOnPaidEventListener(null);
            this.f12010a = null;
        }
    }
    ...
    protected void showAd(Activity activity, InternalFullscreenAdPresentListener internalFullscreenAdPresentListener) {
        ...
        if (rewardedAd == null) {
            ...
            this.f12010a.show(activity, new C0767d());
        }
    }
}
