...
class c extends InternalGAMBannerAd {
    ...
    private static final class b extends AdListener {
        ...
        public void onAdFailedToLoad(LoadAdError loadAdError) {
            this.b.onAdLoadFailed(this.f11989a, new BMError(BMError.NoFill, loadAdError.getCode(), loadAdError.getMessage()));
        }
        ...
        public void onAdLoaded() {
            this.f11989a.onAdLoaded();
            this.b.onAdLoaded(this.f11989a);
        }
    ...
    public void loadAd(Context context, InternalLoadListener internalLoadListener) {
        ...
        this.b.setAdSize(this.f11988a);
        this.b.loadAd(io.bidmachine.ads.networks.gam.versions.v22_0_0.a.a(getGamLoader(), getGamUnitData()));
    }
}
