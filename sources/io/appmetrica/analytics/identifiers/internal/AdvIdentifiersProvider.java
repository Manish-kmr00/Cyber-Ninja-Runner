...
public class AdvIdentifiersProvider {
    ...
    public static Bundle requestIdentifiers(Context context, Bundle bundle) {
        c cVarA;
        b bVar = (b) retriever.f11037a.get(bundle.getString("io.appmetrica.analytics.identifiers.extra.PROVIDER"));
        ...
        if (aVar != null) {
            ...
            bundle3.putString("io.appmetrica.analytics.identifiers.extra.PROVIDER", aVar.f11035a);
        ...
        bundle2.putString("io.appmetrica.analytics.identifiers.extra.STATUS", cVarA.f11036a.getValue());
