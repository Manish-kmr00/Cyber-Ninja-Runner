...
import io.appmetrica.analytics.impl.AbstractC3982a4;
import io.appmetrica.analytics.impl.AbstractC4288mb;
import io.appmetrica.analytics.impl.C4003b0;
...
public class AppMetricaConfig {
    ...
    public static class Builder {
        private static final C4026bn D = new C4026bn(new C4003b0());
        private Integer A;
        private List B;
        private final HashMap C;

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final A5 f10911a;
        ...
        public Builder withMaxReportsInDatabaseCount(int i) {
            this.n = Integer.valueOf(this.f10911a.a(i));
            return this;
        }
    ...
    public static AppMetricaConfig fromJson(String str) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            try {
                ...
                builderNewConfigBuilder.withLocation(AbstractC3982a4.a(jSONObject.optString("location")));
                builderNewConfigBuilder.withPreloadInfo(AbstractC3982a4.b(jSONObject.optString("preload_info")));
                ...
                if (jSONObject.has("error_environment") && (mapC2 = AbstractC4288mb.c(jSONObject.optString("error_environment"))) != null) {
                ...
                if (jSONObject.has("app_environment") && (mapC = AbstractC4288mb.c(jSONObject.optString("app_environment"))) != null) {
                ...
                if (jSONObject.has("customHosts")) {
                    builderNewConfigBuilder.withCustomHosts(AbstractC4288mb.a(jSONObject.optJSONArray("customHosts")));
                }
    ...
    public String toJson() {
        ...
        try {
            ...
            jSONObject.put("location", AbstractC3982a4.a(this.location));
