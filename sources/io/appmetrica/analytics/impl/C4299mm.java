...
public final class C4299mm extends AbstractC4473tm {
    @Override // io.appmetrica.analytics.impl.AbstractC4473tm
    public final ProtobufStateStorage a(Context context, IBinaryDataHelper iBinaryDataHelper) {
        byte[] bArrA;
        byte[] bArrA2;
        C4000am c4000am = new C4000am();
        try {
        ...
        return new C4616zf("startup_state", iBinaryDataHelper, new F8(c4000am, new AESEncrypter(AESEncrypter.DEFAULT_ALGORITHM, bArrA, bArrA2)), new Il());
    }
