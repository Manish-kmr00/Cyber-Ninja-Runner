    ...
    public static ModuleAdRevenue a(AdValue adValue, ModuleAdType moduleAdType, String str, ResponseInfo responseInfo, String str2) {
        ...
        if (responseInfo == null || (loadedAdapterResponseInfo = responseInfo.getLoadedAdapterResponseInfo()) == null) {
            ...
            if (precisionType == 0) {
                ...
                str3 = precisionType == 3 ? "PRECISE" : "";
            }
            return new ModuleAdRevenue(bigDecimalValueOf, currency, moduleAdType, null, str2, null, null, null, str3, new c(str), true);
        }
        ...
        if (precisionType2 == 0) {
            ...
            str4 = precisionType2 == 3 ? "PRECISE" : "";
        }
        return new ModuleAdRevenue(bigDecimalValueOf2, currency2, moduleAdType, adapterClassName, str2, null, adSourceInstanceId, adSourceInstanceName, str4, new b(str), true);
    }
}
