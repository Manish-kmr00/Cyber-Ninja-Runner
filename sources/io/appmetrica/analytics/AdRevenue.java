...
public class AdRevenue {
    ...
    public static class Builder {
        ...
        private final BigDecimal f10908a;
        ...
        public AdRevenue build() {
            return new AdRevenue(this.f10908a, this.b, this.c, this.d, this.e, this.f, this.g, this.h, this.i, this.j, 0);
        }
    ...
    public static Builder newBuilder(long j, Currency currency) {
        return new Builder(In.a(j), currency, 0);
    }

    public static Builder newBuilder(double d, Currency currency) {
        return new Builder(new BigDecimal(In.a(d)), currency, 0);
    }
}
