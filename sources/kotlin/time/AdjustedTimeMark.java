...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo9223minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m9369minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: elapsedNow-UwyO8pc */
    public long mo9222elapsedNowUwyO8pc() {
        return Duration.m9267minusLRDsOJo(this.mark.mo9222elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    public TimeMark mo9225plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m9268plusLRDsOJo(this.adjustment, duration), null);
    }
}
