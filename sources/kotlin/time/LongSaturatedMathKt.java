...
public final class LongSaturatedMathKt {
    ...
    public static final long m9361saturatingAddNuflL3o(long j, DurationUnit unit, long j2) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        long jM9278toLongimpl = Duration.m9278toLongimpl(j2, unit);
        if (((j - 1) | 1) == Long.MAX_VALUE) {
            return m9360checkInfiniteSumDefinedPjuGub4(j, j2, jM9278toLongimpl);
        }
        if ((1 | (jM9278toLongimpl - 1)) == Long.MAX_VALUE) {
            return m9362saturatingAddInHalvesNuflL3o(j, unit, j2);
        }
        long j3 = j + jM9278toLongimpl;
        if (((j ^ j3) & (jM9278toLongimpl ^ j3)) < 0) {
    ...
    private static final long m9360checkInfiniteSumDefinedPjuGub4(long j, long j2, long j3) {
        if (!Duration.m9264isInfiniteimpl(j2) || (j ^ j3) >= 0) {
            return j;
        }
    ...
    private static final long m9362saturatingAddInHalvesNuflL3o(long j, DurationUnit durationUnit, long j2) {
        long jM9235divUwyO8pc = Duration.m9235divUwyO8pc(j2, 2);
        long jM9278toLongimpl = Duration.m9278toLongimpl(jM9235divUwyO8pc, durationUnit);
        return (1 | (jM9278toLongimpl - 1)) == Long.MAX_VALUE ? jM9278toLongimpl : m9361saturatingAddNuflL3o(m9361saturatingAddNuflL3o(j, durationUnit, jM9235divUwyO8pc), durationUnit, Duration.m9267minusLRDsOJo(j2, jM9235divUwyO8pc));
    }

    private static final long infinityOfSign(long j) {
        return j < 0 ? Duration.INSTANCE.m9334getNEG_INFINITEUwyO8pc$kotlin_stdlib() : Duration.INSTANCE.m9333getINFINITEUwyO8pc();
    }

    public static final long saturatingDiff(long j, long j2, DurationUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        if ((1 | (j2 - 1)) == Long.MAX_VALUE) {
            return Duration.m9285unaryMinusUwyO8pc(infinityOfSign(j2));
        }
    ...
    private static final long saturatingFiniteDiff(long j, long j2, DurationUnit durationUnit) {
        ...
        if (((j3 ^ j) & (~(j3 ^ j2))) < 0) {
            if (durationUnit.compareTo(DurationUnit.MILLISECONDS) < 0) {
                ...
                return Duration.m9268plusLRDsOJo(DurationKt.toDuration(j4, DurationUnit.MILLISECONDS), DurationKt.toDuration(j5, durationUnit));
            }
            return Duration.m9285unaryMinusUwyO8pc(infinityOfSign(j3));
        }
