...
public final class UStringsKt {
    ...
    public static final String m9219toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m9221toStringolVBNx4(short s, int i) {
    ...
    public static final String m9220toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m9218toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m8001constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m7916boximpl(UByte.m7922constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m8001constructorimpl(65535) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m8181boximpl(UShort.m8187constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM8001constructorimpl = UInt.m8001constructorimpl(i);
        int iM$1 = 119304647;
        while (i2 < length) {
            ...
            if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM$1 ^ Integer.MIN_VALUE) > 0) {
                if (iM$1 == 119304647) {
                    iM$1 = UByte$$ExternalSyntheticBackport0.m$1(-1, iM8001constructorimpl);
                    if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM$1 ^ Integer.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            int iM8001constructorimpl2 = UInt.m8001constructorimpl(i3 * iM8001constructorimpl);
            int iM8001constructorimpl3 = UInt.m8001constructorimpl(UInt.m8001constructorimpl(iDigitOf) + iM8001constructorimpl2);
            if (Integer.compare(iM8001constructorimpl3 ^ Integer.MIN_VALUE, iM8001constructorimpl2 ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            i3 = iM8001constructorimpl3;
        }
        return UInt.m7995boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM8080constructorimpl = ULong.m8080constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                if (jM$1 == 512409557603043100L) {
                    jM$1 = UByte$$ExternalSyntheticBackport0.m$1(-1L, jM8080constructorimpl);
                    if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            long jM8080constructorimpl2 = ULong.m8080constructorimpl(j * jM8080constructorimpl);
            long jM8080constructorimpl3 = ULong.m8080constructorimpl(ULong.m8080constructorimpl(((long) UInt.m8001constructorimpl(iDigitOf)) & 4294967295L) + jM8080constructorimpl2);
            if (Long.compare(jM8080constructorimpl3 ^ Long.MIN_VALUE, jM8080constructorimpl2 ^ Long.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            j = jM8080constructorimpl3;
        }
