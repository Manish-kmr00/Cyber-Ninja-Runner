...
public final class HexExtensionsKt {
    ...
    /* JADX WARN: Code duplicated, block: B:29:0x0083 A[SYNTHETIC] */
    ...
    public static final int formattedStringLength(int i, int i2, int i3, int i4, int i5, int i6, int i7) {
        ...
        throw new IllegalArgumentException("The resulting string length is too big: " + ((Object) ULong.m8126toStringimpl(ULong.m8080constructorimpl(j))));
    }
    ...
    private static final byte[] hexToByteArray(String str, int i, int i2, HexFormat hexFormat) {
        ...
        while (iCheckContainsAt < i2) {
            ...
            int iDecimalFromHexDigitAt2 = decimalFromHexDigitAt(str, iCheckContainsAt3) << 4;
            bArr[i4] = (byte) (iDecimalFromHexDigitAt2 | decimalFromHexDigitAt(str, iCheckContainsAt3 + 1));
            iCheckContainsAt = checkContainsAt(str, byteSuffix, iCheckContainsAt3 + 2, i2, "byte suffix");
            i4++;
            str2 = str2;
        }
        if (i4 == i3) {
    ...
    private static final int checkContainsAt(String str, String str2, int i, int i2, String str3) {
        ...
        StringBuilder sbAppend = new StringBuilder("Expected ").append(str3).append(" \"").append(str2).append("\" at index ").append(i).append(", but was ");
