...
public final class Regex implements Serializable {
    ...
    public final Sequence<String> splitToSequence(CharSequence input, int limit) {
        Intrinsics.checkNotNullParameter(input, "input");
        StringsKt.requireNonNegativeLimit(limit);
        return SequencesKt.sequence(new C49051(input, limit, null));
    }
    ...
    static final class C49051 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super String>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C49051(CharSequence charSequence, int i, Continuation<? super C49051> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C49051 c49051 = Regex.this.new C49051(this.$input, this.$limit, continuation);
            c49051.L$0 = obj;
            return c49051;
        }
        ...
        public final Object invoke(SequenceScope<? super String> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C49051) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
