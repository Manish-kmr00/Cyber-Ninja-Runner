...
public class FMODAudioDevice implements Runnable {
    ...
    private volatile Thread f12452a = null;
    ...
    public boolean isRunning() {
        return this.f12452a != null && this.f12452a.isAlive();
    }
    ...
    public synchronized void start() {
        ...
        this.f12452a = new Thread(this, "FMODAudioDevice");
        this.f12452a.setPriority(10);
        this.b = true;
        this.f12452a.start();
        if (this.g != null) {
            this.g.c();
