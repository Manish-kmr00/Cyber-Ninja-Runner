...
public class FmodAndroidAudioManager {
    ...
    private volatile Activity f12453a = null;
    ...
    public void setActivity(Activity activity) {
        if (this.f12453a != activity) {
            if (this.c != null) {
                this.f12453a.unregisterReceiver(this.c);
                this.c = null;
                this.e = false;
            }
            this.f12453a = activity;
            this.b = this.f12453a != null ? (AudioManager) this.f12453a.getSystemService("audio") : null;
        }
    }
    ...
    public void startBluetoothSco() {
        if (this.c == null) {
            ...
            this.f12453a.registerReceiver(this.c, new IntentFilter("android.media.ACTION_SCO_AUDIO_STATE_UPDATED"));
        }
