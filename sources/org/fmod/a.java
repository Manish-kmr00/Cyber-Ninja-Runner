...
final class a implements Runnable {
    ...
    private final FMODAudioDevice f12455a;
    ...
    public final void run() {
        ...
        while (this.f) {
            ...
            if (this.h && this.g.getRecordingState() == 3) {
                ...
                this.f12455a.fmodProcessMicData(this.b, audioRecord2.read(byteBuffer, byteBuffer.capacity()));
                this.b.position(0);
            }
        }
        b();
