...
public class EntityArrays {
    ...
    static {
        ...
        map.put("þ", "&thorn;");
        map.put("ÿ", "&yuml;");
        Map<CharSequence, CharSequence> mapUnmodifiableMap = Collections.unmodifiableMap(map);
        ...
        map2.put("ϖ", "&piv;");
        map2.put("•", "&bull;");
        map2.put(EllipsizedTextView.DEFAULT_ELLIPSIS, "&hellip;");
        map2.put("′", "&prime;");
        map2.put("″", "&Prime;");
        map2.put("‾", "&oline;");
        map2.put("⁄", "&frasl;");
        ...
        map2.put("›", "&rsaquo;");
        map2.put("€", "&euro;");
        Map<CharSequence, CharSequence> mapUnmodifiableMap2 = Collections.unmodifiableMap(map2);
        ...
        map3.put("<", "&lt;");
        map3.put(">", "&gt;");
        Map<CharSequence, CharSequence> mapUnmodifiableMap3 = Collections.unmodifiableMap(map3);
        BASIC_ESCAPE = mapUnmodifiableMap3;
        BASIC_UNESCAPE = Collections.unmodifiableMap(invert(mapUnmodifiableMap3));
        HashMap map4 = new HashMap();
        map4.put("'", "&apos;");
        Map<CharSequence, CharSequence> mapUnmodifiableMap4 = Collections.unmodifiableMap(map4);
        ...
        map5.put("\f", "\\f");
        map5.put("\r", "\\r");
        Map<CharSequence, CharSequence> mapUnmodifiableMap5 = Collections.unmodifiableMap(map5);
