    ...
    void placeFragmentInViewHolder(final FragmentViewHolder fragmentViewHolder) {
        ...
        if (!shouldDelayFragmentTransactions()) {
            ...
            try {
                ...
                this.mFragmentManager.beginTransaction().add(fragment, InneractiveMediationDefs.GENDER_FEMALE + fragmentViewHolder.getItemId()).setMaxLifecycle(fragment, Lifecycle.State.STARTED).commitNow();
