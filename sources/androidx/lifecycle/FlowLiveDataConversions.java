...
public final class FlowLiveDataConversions {
    ...
    @DebugMetadata(c = "androidx.lifecycle.FlowLiveDataConversions$asLiveData$1", f = "FlowLiveData.kt", i = {}, l = {IronSourceConstants.TROUBLESHOOTING_AD_QUALITY_SDK_INITIALIZED_SUCCESSFULLY_EVENT}, m = "invokeSuspend", n = {}, s = {})
    static final class C11701<T> extends SuspendLambda implements Function2<LiveDataScope<T>, Continuation<? super Unit>, Object> {
        ...
        C11701(Flow<? extends T> flow, Continuation<? super C11701> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C11701 c11701 = new C11701(this.$this_asLiveData, continuation);
            c11701.L$0 = obj;
            return c11701;
        }
        ...
        public final Object invoke(LiveDataScope<T> liveDataScope, Continuation<? super Unit> continuation) {
            return ((C11701) create(liveDataScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> LiveData<T> asLiveData(Flow<? extends T> flow, CoroutineContext context, long j) {
        Intrinsics.checkNotNullParameter(flow, "<this>");
        Intrinsics.checkNotNullParameter(context, "context");
        ComputableLiveData$_liveData$1 computableLiveData$_liveData$1 = (LiveData<T>) CoroutineLiveDataKt.liveData(context, j, new C11701(flow, null));
    ...
    static final class AnonymousClass1<T> extends SuspendLambda implements Function2<ProducerScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i == 0) {
                ...
                observer = new Observer() { // from class: androidx.lifecycle.FlowLiveDataConversions$asFlow$1$$ExternalSyntheticLambda0
                    ...
                    public final void onChanged(Object obj2) {
                        producerScope2.mo9408trySendJP2dKIU(obj2);
                    }
                };
                this.L$0 = producerScope2;
                this.L$1 = observer;
                this.label = 1;
                if (BuildersKt.withContext(Dispatchers.getMain().getImmediate(), new C01031(this.$this_asFlow, observer, null), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            ...
            if (ProduceKt.awaitClose(producerScope, new Function0<Unit>() { // from class: androidx.lifecycle.FlowLiveDataConversions.asFlow.1.2
                ...
                static final class C01041 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    C01041(LiveData<T> liveData, Observer<T> observer, Continuation<? super C01041> continuation) {
                        super(2, continuation);
                        this.$this_asFlow = liveData;
                    ...
                    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                        return new C01041(this.$this_asFlow, this.$observer, continuation);
                    }
                ...
                public final void invoke2() {
                    BuildersKt__Builders_commonKt.launch$default(GlobalScope.INSTANCE, Dispatchers.getMain().getImmediate(), null, new C01041(liveData, observer, null), 2, null);
                }
            }, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        ...
        static final class C01031 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C01031(LiveData<T> liveData, Observer<T> observer, Continuation<? super C01031> continuation) {
                super(2, continuation);
                this.$this_asFlow = liveData;
                this.$observer = observer;
            }
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new C01031(this.$this_asFlow, this.$observer, continuation);
            }
