...
public final class SharedPreferencesMigration<T> implements DataMigration<T> {
    ...
    static final class C11651 extends ContinuationImpl {
        ...
        C11651(SharedPreferencesMigration<T> sharedPreferencesMigration, Continuation<? super C11651> continuation) {
            super(continuation);
    ...
    public Object shouldMigrate(T t, Continuation<? super Boolean> continuation) throws Throwable {
        ...
        if (continuation instanceof C11651) {
            ...
            if ((c11651.label & Integer.MIN_VALUE) != 0) {
                ...
                c11651 = new C11651(this, continuation);
            }
        } else {
            c11651 = new C11651(this, continuation);
        }
        Object objInvoke = c11651.result;
        ...
        if (i == 0) {
            ...
            c11651.L$0 = this;
            c11651.label = 1;
            objInvoke = function2.invoke(t, c11651);
            ...
            sharedPreferencesMigration = (SharedPreferencesMigration) c11651.L$0;
            ResultKt.throwOnFailure(objInvoke);
        }
