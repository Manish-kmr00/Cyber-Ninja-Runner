...
public final class SimpleActor<T> {
    ...
    public SimpleActor(CoroutineScope scope, final Function1<? super Throwable, Unit> onComplete, final Function2<? super T, ? super Throwable, Unit> onUndeliveredElement, Function2<? super T, ? super Continuation<? super Unit>, ? extends Object> consumeMessage) {
        ...
        job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: androidx.datastore.core.SimpleActor.1
            ...
            public final void invoke2(Throwable th) {
                ...
                do {
                    Object objM9424getOrNullimpl = ChannelResult.m9424getOrNullimpl(((SimpleActor) this).messageQueue.mo9413tryReceivePtdJZtk());
                    if (objM9424getOrNullimpl == null) {
                        unit = null;
                    } else {
                        onUndeliveredElement.invoke((T) objM9424getOrNullimpl, th);
                        unit = Unit.INSTANCE;
                    }
                } while (unit != null);
            }
    ...
    public final void offer(T msg) {
        Object obj = this.messageQueue.mo9408trySendJP2dKIU(msg);
        if (obj instanceof ChannelResult.Closed) {
            Throwable thM9423exceptionOrNullimpl = ChannelResult.m9423exceptionOrNullimpl(obj);
            if (thM9423exceptionOrNullimpl != null) {
                throw thM9423exceptionOrNullimpl;
            }
            throw new ClosedSendChannelException("Channel was closed normally");
        }
        if (!ChannelResult.m9429isSuccessimpl(obj)) {
    ...
    @DebugMetadata(c = "androidx.datastore.core.SimpleActor$offer$2", f = "SimpleActor.kt", i = {}, l = {Sdk.SDKError.Reason.INVALID_ADS_ENDPOINT_VALUE, Sdk.SDKError.Reason.INVALID_ADS_ENDPOINT_VALUE}, m = "invokeSuspend", n = {}, s = {})
