...
public final class SharedPreferencesMigrationKt {
    ...
    static final class C11661 extends SuspendLambda implements Function2<Preferences, Continuation<? super Boolean>, Object> {
        final /* synthetic */ Set<String> $keysToMigrate;
        /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C11661(Set<String> set, Continuation<? super C11661> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C11661 c11661 = new C11661(this.$keysToMigrate, continuation);
            c11661.L$0 = obj;
            return c11661;
        }
        ...
        public final Object invoke(Preferences preferences, Continuation<? super Boolean> continuation) {
            return ((C11661) create(preferences, continuation)).invokeSuspend(Unit.INSTANCE);
        }
