        ...
        synchronized (this.mPendingOperations) {
            ...
            for (Operation operation : new ArrayList(this.mRunningOperations)) {
                if (FragmentManager.isLoggingEnabled(2)) {
                    ...
                    Log.v(FragmentManager.TAG, sbAppend.append(str2).append("Cancelling running operation ").append(operation).toString());
                }
                operation.cancel();
            }
            for (Operation operation2 : new ArrayList(this.mPendingOperations)) {
                if (FragmentManager.isLoggingEnabled(2)) {
                    ...
                    Log.v(FragmentManager.TAG, sbAppend2.append(str).append("Cancelling pending operation ").append(operation2).toString());
                }
                operation2.cancel();
            }
        }
