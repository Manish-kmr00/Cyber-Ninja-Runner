...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo4291clone = transition.mo4291clone();
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo4291clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo4291clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo4291clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo4291clone = transition.mo4291clone();
        sceneChangeSetup(viewGroup, transitionMo4291clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo4291clone);
    }
