...
class FontProvider {
    ...
    static FontsContractCompat.FontInfo[] query(Context context, FontRequest fontRequest, String str, CancellationSignal cancellationSignal) throws Throwable {
        ...
        try {
            int i = 1;
            Cursor cursorQuery = contentQueryWrapperMake.query(uriBuild, new String[]{DatabaseHelper._ID, FontsContractCompat.Columns.FILE_ID, FontsContractCompat.Columns.TTC_INDEX, FontsContractCompat.Columns.VARIATION_SETTINGS, FontsContractCompat.Columns.WEIGHT, FontsContractCompat.Columns.ITALIC, FontsContractCompat.Columns.RESULT_CODE}, "query = ?", new String[]{fontRequest.getQuery()}, null, cancellationSignal);
            if (cursorQuery != null) {
                try {
                    if (cursorQuery.getCount() > 0) {
                        int columnIndex = cursorQuery.getColumnIndex(FontsContractCompat.Columns.RESULT_CODE);
                        ArrayList arrayList3 = new ArrayList();
                        int columnIndex2 = cursorQuery.getColumnIndex(DatabaseHelper._ID);
                        ...
                        while (cursorQuery.moveToNext()) {
                            ...
                            arrayList3.add(FontsContractCompat.FontInfo.create(uriWithAppendedId, i3, columnIndex5 != -1 ? cursorQuery.getInt(columnIndex5) : 400, (columnIndex6 == -1 || cursorQuery.getInt(columnIndex6) != i) ? 0 : i, i2));
                            i = 1;
                        }
