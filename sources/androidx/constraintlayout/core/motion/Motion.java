...
public class Motion implements TypedValues {
    ...
    private float getPreCycleDistance() {
        ...
        while (i < 100) {
            ...
            fHypot = i2 > 0 ? (float) (((double) f6) + Math.hypot(d2 - ((double) fArr[1]), d - ((double) fArr[0]))) : f6;
            d = fArr[0];
            i = i2 + 1;
            d2 = fArr[1];
        }
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        if (!hashSet2.isEmpty()) {
            ...
            for (String str : hashSet2) {
                if (str.startsWith("CUSTOM,")) {
                    ...
                    String str2 = str.split(StringUtils.COMMA)[c];
        ...
        while (true) {
            ...
            for (int i7 = 0; i7 < i4; i7++) {
                if (motionPathsArr[i7].customAttributes.containsKey(str8) && (customVariable = motionPathsArr[i7].customAttributes.get(str8)) != null) {
        ...
        while (true) {
            ...
            for (int i18 = 0; i18 < i4; i18++) {
                if (motionPathsArr[i18].hasCustomData(str10)) {
                    if (dArr4 == null) {
                        dArr3 = new double[i4];
                        dArr4 = (double[][]) Array.newInstance((Class<?>) Double.TYPE, i4, motionPathsArr[i18].getCustomDataCount(str10));
                    }
                    dArr3[i17] = motionPathsArr[i18].time;
                    motionPathsArr[i18].getCustomData(str10, dArr4[i17], 0);
                    i17++;
                }
            }
            i16++;
