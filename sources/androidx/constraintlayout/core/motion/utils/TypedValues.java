...
public interface TypedValues {
    ...
    public interface OnSwipe {
        ...
        public static final String[] ON_TOUCH_UP_ENUM = {"autoComplete", "autoCompleteToStart", "autoCompleteToEnd", TimerController.STOP_COMMAND, "decelerate", "decelerateAndComplete", "neverCompleteToStart", "neverCompleteToEnd"};
        ...
        static int getId(String str) {
            ...
            switch (str.hashCode()) {
                ...
                case -908189617:
                    ...
                    break;
                case -880905839:
                    b = !str.equals(S_TARGET) ? (byte) -1 : Ascii.FF;
                    break;
                case -4379043:
                ...
                case 92909918:
                    ...
                    break;
                case 97692013:
                    b = !str.equals(S_FRAME) ? (byte) -1 : Ascii.SI;
                    break;
                case 579057826:
    ...
    public interface MotionType {
        ...
        static int getId(String str) {
            ...
            switch (str.hashCode()) {
                case -2033446275:
                    b = !str.equals(S_ANIMATE_CIRCLEANGLE_TO) ? (byte) -1 : (byte) 0;
                    break;
                case -1532277420:
                    b = !str.equals(S_QUANTIZE_MOTION_PHASE) ? (byte) -1 : (byte) 1;
                    break;
                case -1529145600:
                    b = !str.equals(S_QUANTIZE_MOTIONSTEPS) ? (byte) -1 : (byte) 2;
                    break;
                case -1498310144:
                    b = !str.equals(S_PATH_ROTATE) ? (byte) -1 : (byte) 3;
                    break;
                case -1030753096:
                    b = !str.equals(S_QUANTIZE_INTERPOLATOR) ? (byte) -1 : (byte) 4;
                    break;
                case -762370135:
                    b = !str.equals(S_DRAW_PATH) ? (byte) -1 : (byte) 5;
                    break;
                case -232872051:
                    b = !str.equals(S_STAGGER) ? (byte) -1 : (byte) 6;
                    break;
                case 1138491429:
                    b = !str.equals(S_POLAR_RELATIVETO) ? (byte) -1 : (byte) 7;
                    break;
                case 1539234834:
                    b = !str.equals(S_QUANTIZE_INTERPOLATOR_TYPE) ? (byte) -1 : (byte) 8;
                    break;
                case 1583722451:
                    b = !str.equals(S_QUANTIZE_INTERPOLATOR_ID) ? (byte) -1 : (byte) 9;
                    break;
                case 1639368448:
                    b = !str.equals(S_EASING) ? (byte) -1 : (byte) 10;
                    break;
                case 1900899336:
                    b = !str.equals(S_ANIMATE_RELATIVE_TO) ? (byte) -1 : Ascii.VT;
                    break;
                case 2109694967:
                    b = !str.equals(S_PATHMOTION_ARC) ? (byte) -1 : Ascii.FF;
                    break;
                default:
                    b = -1;
                    break;
    ...
    public interface TransitionType {
        ...
        public static final String[] KEY_WORDS = {"duration", S_FROM, "to", S_PATH_MOTION_ARC, S_AUTO_TRANSITION, S_INTERPOLATOR, S_STAGGERED, S_FROM, S_TRANSITION_FLAGS};
