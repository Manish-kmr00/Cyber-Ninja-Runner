...
public class ConstraintSet {
    ...
    static void parseDimensionConstraints(Object data, TypedArray a2, int attr, int orientation) {
        ...
        if (i == 3) {
            parseDimensionConstraintsString(data, a2.getString(attr), orientation);
            return;
        }
        int i2 = 0;
        if (i == 5) {
    ...
    public void clone(ConstraintSet set) {
        ...
        for (Integer num : set.mConstraints.keySet()) {
            Constraint constraint = set.mConstraints.get(num);
            if (constraint != null) {
                this.mConstraints.put(num, constraint.m4097clone());
            }
        }
    }
    ...
    public void parseIntAttributes(Constraint set, String attributes) {
        String[] strArrSplit = attributes.split(StringUtils.COMMA);
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            switch (overrideMapToConstant.get(index)) {
                ...
                case CONSTRAINT_TAG /* 77 */:
                    delta.add(CONSTRAINT_TAG, a2.getString(index));
                    break;
                case VISIBILITY_MODE /* 78 */:
                    delta.add(VISIBILITY_MODE, a2.getInt(index, c.propertySet.mVisibilityMode));
                    break;
                case MOTION_STAGGER /* 79 */:
                    delta.add(MOTION_STAGGER, a2.getFloat(index, c.motion.mMotionStagger));
                    break;
                case 80:
                ...
                case QUANTIZE_MOTION_PHASE /* 85 */:
                    delta.add(QUANTIZE_MOTION_PHASE, a2.getFloat(index, c.motion.mQuantizeMotionPhase));
                    break;
                ...
                case BASELINE_MARGIN /* 93 */:
                    delta.add(BASELINE_MARGIN, a2.getDimensionPixelSize(index, c.layout.baselineMargin));
                    break;
                case 94:
                ...
                case LAYOUT_WRAP_BEHAVIOR /* 97 */:
                    delta.add(LAYOUT_WRAP_BEHAVIOR, a2.getInt(index, c.layout.mWrapBehavior));
                    break;
                ...
                case GUIDELINE_USE_RTL /* 99 */:
                    delta.add(GUIDELINE_USE_RTL, a2.getBoolean(index, c.layout.guidelineUseRtl));
                    break;
            }
        }
    }
    ...
    private int[] convertReferenceString(View view, String referenceIdString) {
        ...
        String[] strArrSplit = referenceIdString.split(StringUtils.COMMA);
    ...
    class WriteXmlEngine {
        ...
        void writeCircle(int circleConstraint, float circleAngle, int circleRadius) throws IOException {
            ...
            this.writer.write(circleRadius + b9.i.e);
        }
        ...
        void writeVariable(String name, int[] value) throws IOException {
            ...
            while (i < value.length) {
                this.writer.write((i == 0 ? b9.i.d : ", ") + getName(value[i]));
                i++;
            }
            this.writer.write("],\n");
        }
