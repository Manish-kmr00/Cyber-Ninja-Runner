...
public final class URLUtilCompat {
    ...
    private static String suggestExtensionFromMimeType(String str) {
        ...
        if (str.equalsIgnoreCase(POBCommonConstants.CONTENT_TYPE_HTML)) {
            return ".html";
        }
    ...
    public static String getFilenameFromContentDisposition(String str) {
        ...
        if (strArrSplit.length < 2 || POBCommonConstants.BANNER_PLACEMENT_TYPE.equalsIgnoreCase(strArrSplit[0].trim())) {
            return null;
        }
        ...
        while (matcher.find()) {
            ...
            if (strGroup2 != null && strGroup != null) {
                if (ContentDisposition.Parameters.FileNameAsterisk.equalsIgnoreCase(strGroup2)) {
