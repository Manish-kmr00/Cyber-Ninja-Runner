...
final class DefaultChipColors implements ChipColors {
    ...
    public State<Color> backgroundColor(boolean z, Composer composer, int i) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m1621boximpl(z ? this.backgroundColor : this.disabledBackgroundColor), composer, 0);
    ...
    public State<Color> contentColor(boolean z, Composer composer, int i) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m1621boximpl(z ? this.contentColor : this.disabledContentColor), composer, 0);
        composer.endReplaceableGroup();
        return stateRememberUpdatedState;
    }
    ...
    public State<Color> leadingIconContentColor(boolean z, Composer composer, int i) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m1621boximpl(z ? this.leadingIconContentColor : this.disabledLeadingIconContentColor), composer, 0);
        composer.endReplaceableGroup();
        return stateRememberUpdatedState;
    }
    ...
    public boolean equals(Object other) {
        ...
        return Color.m1632equalsimpl0(this.backgroundColor, defaultChipColors.backgroundColor) && Color.m1632equalsimpl0(this.contentColor, defaultChipColors.contentColor) && Color.m1632equalsimpl0(this.leadingIconContentColor, defaultChipColors.leadingIconContentColor) && Color.m1632equalsimpl0(this.disabledBackgroundColor, defaultChipColors.disabledBackgroundColor) && Color.m1632equalsimpl0(this.disabledContentColor, defaultChipColors.disabledContentColor) && Color.m1632equalsimpl0(this.disabledLeadingIconContentColor, defaultChipColors.disabledLeadingIconContentColor);
    }

    public int hashCode() {
        return (((((((((Color.m1638hashCodeimpl(this.backgroundColor) * 31) + Color.m1638hashCodeimpl(this.contentColor)) * 31) + Color.m1638hashCodeimpl(this.leadingIconContentColor)) * 31) + Color.m1638hashCodeimpl(this.disabledBackgroundColor)) * 31) + Color.m1638hashCodeimpl(this.disabledContentColor)) * 31) + Color.m1638hashCodeimpl(this.disabledLeadingIconContentColor);
    }
}
