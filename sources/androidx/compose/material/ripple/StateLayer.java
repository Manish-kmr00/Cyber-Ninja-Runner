...
final class StateLayer {
    ...
    public final void m1268drawStateLayerH2RKhps(DrawScope drawStateLayer, float f, long j) {
        float fM1259getRippleEndRadiuscSwnlzA;
        Intrinsics.checkNotNullParameter(drawStateLayer, "$this$drawStateLayer");
        if (Float.isNaN(f)) {
            fM1259getRippleEndRadiuscSwnlzA = RippleAnimationKt.m1259getRippleEndRadiuscSwnlzA(drawStateLayer, this.bounded, drawStateLayer.mo2125getSizeNHjbRc());
        } else {
            fM1259getRippleEndRadiuscSwnlzA = drawStateLayer.mo318toPx0680j_4(f);
        }
        float f2 = fM1259getRippleEndRadiuscSwnlzA;
        float fFloatValue = this.animatedAlpha.getValue().floatValue();
        if (fFloatValue > 0.0f) {
            long jM1630copywmQWz5c$default = Color.m1630copywmQWz5c$default(j, fFloatValue, 0.0f, 0.0f, 0.0f, 14, null);
            if (this.bounded) {
                float fM1464getWidthimpl = Size.m1464getWidthimpl(drawStateLayer.mo2125getSizeNHjbRc());
                float fM1461getHeightimpl = Size.m1461getHeightimpl(drawStateLayer.mo2125getSizeNHjbRc());
                ...
                DrawScope.m2107drawCircleVaOC9Bg$default(drawStateLayer, jM1630copywmQWz5c$default, f2, 0L, 0.0f, null, null, 0, Sdk.SDKError.Reason.INVALID_LOG_ERROR_ENDPOINT_VALUE, null);
