...
public final class RippleHostView extends View {
    ...
    public final void m1262addRippleKOepWvA(PressInteraction.Press interaction, boolean bounded, long size, int radius, long color, float alpha, Function0<Unit> onInvalidateRipple) {
        ...
        m1263updateRipplePropertiesbiQXAtU(size, radius, color, alpha);
        if (bounded) {
            unprojectedRipple.setHotspot(Offset.m1395getXimpl(interaction.getPressPosition()), Offset.m1396getYimpl(interaction.getPressPosition()));
        } else {
    ...
    public final void m1263updateRipplePropertiesbiQXAtU(long size, int radius, long color, float alpha) {
        UnprojectedRipple unprojectedRipple = this.ripple;
        if (unprojectedRipple == null) {
            return;
        }
        unprojectedRipple.trySetRadius(radius);
        unprojectedRipple.m1270setColorDxMtmZc(color, alpha);
        Rect androidRect = RectHelper_androidKt.toAndroidRect(SizeKt.m1485toRectuvyYCjk(size));
        ...
        if (!pressed && jLongValue < 5) {
            Runnable runnable2 = new Runnable() { // from class: androidx.compose.material.ripple.RippleHostView$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    RippleHostView.m1261setRippleState$lambda2(this.f$0);
                }
            };
    ...
    public static final void m1261setRippleState$lambda2(RippleHostView this$0) {
