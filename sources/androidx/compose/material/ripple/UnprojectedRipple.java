...
final class UnprojectedRipple extends RippleDrawable {
    ...
    public final void m1270setColorDxMtmZc(long color, float alpha) {
        long jM1269calculateRippleColor5vOe2sY = m1269calculateRippleColor5vOe2sY(color, alpha);
        Color color2 = this.rippleColor;
        if (color2 == null ? false : Color.m1632equalsimpl0(color2.m1641unboximpl(), jM1269calculateRippleColor5vOe2sY)) {
            return;
        }
        this.rippleColor = Color.m1621boximpl(jM1269calculateRippleColor5vOe2sY);
        setColor(ColorStateList.valueOf(ColorKt.m1686toArgb8_81llA(jM1269calculateRippleColor5vOe2sY)));
    }
    ...
    private final long m1269calculateRippleColor5vOe2sY(long color, float alpha) {
        if (Build.VERSION.SDK_INT < 28) {
            alpha *= 2;
        }
        return Color.m1630copywmQWz5c$default(color, RangesKt.coerceAtMost(alpha, 1.0f), 0.0f, 0.0f, 0.0f, 14, null);
    }
