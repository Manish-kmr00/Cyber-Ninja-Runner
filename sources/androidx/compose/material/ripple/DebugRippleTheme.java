...
final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo1081defaultColorWaAFU9c(Composer composer, int i) {
        ...
        long jM1267defaultRippleColor5vOe2sY = RippleTheme.INSTANCE.m1267defaultRippleColor5vOe2sY(Color.INSTANCE.m1657getBlack0d7_KjU(), true);
    ...
    public RippleAlpha rippleAlpha(Composer composer, int i) {
        ...
        RippleAlpha rippleAlphaM1266defaultRippleAlphaDxMtmZc = RippleTheme.INSTANCE.m1266defaultRippleAlphaDxMtmZc(Color.INSTANCE.m1657getBlack0d7_KjU(), true);
        composer.endReplaceableGroup();
