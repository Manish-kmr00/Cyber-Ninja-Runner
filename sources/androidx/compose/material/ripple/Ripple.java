...
public abstract class Ripple implements Indication {
    ...
    public abstract RippleIndicationInstance mo1256rememberUpdatedRippleInstance942rkJo(InteractionSource interactionSource, boolean z, float f, State<Color> state, State<RippleAlpha> state2, Composer composer, int i);
    ...
    public final IndicationInstance rememberUpdatedInstance(InteractionSource interactionSource, Composer composer, int i) {
        long jMo1081defaultColorWaAFU9c;
        ...
        if (this.color.getValue().m1641unboximpl() != Color.INSTANCE.m1667getUnspecified0d7_KjU()) {
            jMo1081defaultColorWaAFU9c = this.color.getValue().m1641unboximpl();
        } else {
            jMo1081defaultColorWaAFU9c = rippleTheme.mo1081defaultColorWaAFU9c(composer, 0);
        }
        composer.endReplaceableGroup();
        RippleIndicationInstance rippleIndicationInstanceMo1256rememberUpdatedRippleInstance942rkJo = mo1256rememberUpdatedRippleInstance942rkJo(interactionSource, this.bounded, this.radius, SnapshotStateKt.rememberUpdatedState(Color.m1621boximpl(jMo1081defaultColorWaAFU9c), composer, 0), SnapshotStateKt.rememberUpdatedState(rippleTheme.rippleAlpha(composer, 0), composer, 0), composer, (i & 14) | ((i << 12) & 458752));
        EffectsKt.LaunchedEffect(rippleIndicationInstanceMo1256rememberUpdatedRippleInstance942rkJo, interactionSource, new AnonymousClass1(interactionSource, rippleIndicationInstanceMo1256rememberUpdatedRippleInstance942rkJo, null), composer, ((i << 3) & 112) | 8);
        composer.endReplaceableGroup();
        return rippleIndicationInstanceMo1256rememberUpdatedRippleInstance942rkJo;
    }
    ...
    public boolean equals(Object other) {
        ...
        return this.bounded == ripple.bounded && Dp.m3848equalsimpl0(this.radius, ripple.radius) && Intrinsics.areEqual(this.color, ripple.color);
    }

    public int hashCode() {
        return (((Boolean.hashCode(this.bounded) * 31) + Dp.m3849hashCodeimpl(this.radius)) * 31) + this.color.hashCode();
    }
