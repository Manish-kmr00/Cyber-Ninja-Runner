...
final class MaterialRippleTheme implements RippleTheme {
    ...
    public long mo1081defaultColorWaAFU9c(Composer composer, int i) {
        ...
        long jM1267defaultRippleColor5vOe2sY = companion.m1267defaultRippleColor5vOe2sY(((Color) objConsume).m1641unboximpl(), MaterialTheme.INSTANCE.getColors(composer, 6).isLight());
        composer.endReplaceableGroup();
        return jM1267defaultRippleColor5vOe2sY;
    }
    ...
    public RippleAlpha rippleAlpha(Composer composer, int i) {
        ...
        Object objConsume = composer.consume(localContentColor);
        ComposerKt.sourceInformationMarkerEnd(composer);
        RippleAlpha rippleAlphaM1266defaultRippleAlphaDxMtmZc = companion.m1266defaultRippleAlphaDxMtmZc(((Color) objConsume).m1641unboximpl(), MaterialTheme.INSTANCE.getColors(composer, 6).isLight());
        composer.endReplaceableGroup();
        return rippleAlphaM1266defaultRippleAlphaDxMtmZc;
    }
}
