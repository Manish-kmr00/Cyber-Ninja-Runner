...
public final class FloatingActionButtonDefaults {
    ...
    public final /* synthetic */ FloatingActionButtonElevation m1071elevationixp7dh8(float f, float f2, Composer composer, int i, int i2) {
        ...
        if ((i2 & 1) != 0) {
            f = Dp.m3843constructorimpl(6);
        }
        float f3 = f;
        if ((i2 & 2) != 0) {
            f2 = Dp.m3843constructorimpl(12);
        }
        float f4 = 8;
        FloatingActionButtonElevation floatingActionButtonElevationM1072elevationxZ9QkE = m1072elevationxZ9QkE(f3, f2, Dp.m3843constructorimpl(f4), Dp.m3843constructorimpl(f4), composer, (i & 14) | 3456 | (i & 112) | (57344 & (i << 6)), 0);
        composer.endReplaceableGroup();
        return floatingActionButtonElevationM1072elevationxZ9QkE;
    }

    /* JADX INFO: renamed from: elevation-xZ9-QkE, reason: not valid java name */
    public final FloatingActionButtonElevation m1072elevationxZ9QkE(float f, float f2, float f3, float f4, Composer composer, int i, int i2) {
        ...
        float f6 = f2;
        if ((i2 & 4) != 0) {
            f3 = Dp.m3843constructorimpl(8);
        }
        float f7 = f3;
        if ((i2 & 8) != 0) {
            f4 = Dp.m3843constructorimpl(8);
        }
        float f8 = f4;
        Object[] objArr = {Dp.m3841boximpl(f5), Dp.m3841boximpl(f6), Dp.m3841boximpl(f7), Dp.m3841boximpl(f8)};
