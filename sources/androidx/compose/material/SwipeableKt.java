...
public final class SwipeableKt {
    ...
    public static final <T> SwipeableState<T> rememberSwipeableState(final T initialValue, final AnimationSpec<Float> animationSpec, final Function1<? super T, Boolean> function1, Composer composer, int i, int i2) {
        ...
        SwipeableState<T> swipeableState = (SwipeableState) RememberSaveableKt.m1299rememberSaveable(new Object[0], (Saver) SwipeableState.INSTANCE.Saver(animationSpec, function1), (String) null, (Function0) new Function0<SwipeableState<T>>() { // from class: androidx.compose.material.SwipeableKt.rememberSwipeableState.2
    ...
    public static final <T> SwipeableState<T> rememberSwipeableStateFor(final T value, final Function1<? super T, Unit> onValueChange, AnimationSpec<Float> animationSpec, Composer composer, int i, int i2) {
        ...
        EffectsKt.LaunchedEffect(value, mutableState.getValue(), new C10811(value, swipeableState, null), composer, i & 14);
    ...
    */
    ...
    public static final <T> Modifier m1185swipeablepPrIpRY(Modifier swipeable, final SwipeableState<T> state, final Map<Float, ? extends T> anchors, final Orientation orientation, final boolean z, final boolean z2, final MutableInteractionSource mutableInteractionSource, final Function2<? super T, ? super T, ? extends ThresholdConfig> thresholds, final ResistanceConfig resistanceConfig, final float f) {
        ...
        return ComposedModifierKt.composed(swipeable, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.material.SwipeableKt$swipeable-pPrIpRY$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set("velocityThreshold", Dp.m3841boximpl(f));
            }
            ...
            public final Modifier invoke(Modifier composed, Composer composer, int i) {
                ...
                EffectsKt.LaunchedEffect(anchors, state, new AnonymousClass3(state, anchors, resistanceConfig, (Density) objConsume, thresholds, f, null), composer, 8);
                Modifier.Companion companion = Modifier.INSTANCE;
                Modifier.Companion companion2 = companion;
                Modifier modifierDraggable = DraggableKt.draggable(companion2, state.getDraggableState(), orientation, (32 & 4) != 0 ? true : z, (32 & 8) != 0 ? null : mutableInteractionSource, (32 & 16) != 0 ? false : state.isAnimationRunning(), (32 & 32) != 0 ? new DraggableKt.C09741(null) : null, (32 & 64) != 0 ? new DraggableKt.AnonymousClass2(null) : new AnonymousClass4(state, null), (32 & 128) != 0 ? false : z2);
                composer.endReplaceableGroup();
            ...
            static final class AnonymousClass3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                public final Object invokeSuspend(Object obj) throws Throwable {
                    ...
                    if (i == 0) {
                        ...
                        this.$state.setVelocityThreshold$material_release(this.$density.mo318toPx0680j_4(this.$velocityThreshold));
                        this.label = 1;
    ...
    static final class C10811 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C10811(T t, SwipeableState<T> swipeableState, Continuation<? super C10811> continuation) {
            super(2, continuation);
            this.$value = t;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C10811(this.$value, this.$swipeableState, continuation);
        }
