...
final class DefaultElevationOverlay implements ElevationOverlay {
    ...
    public long mo1013apply7g2Lkgo(long j, float f, Composer composer, int i) {
        ...
        if (Dp.m3842compareTo0680j_4(f, Dp.m3843constructorimpl(0)) > 0 && !colors.isLight()) {
            j = ColorKt.m1677compositeOverOWjLjI(ElevationOverlayKt.m1047calculateForegroundColorCLU3JFs(j, f, composer, i & 126), j);
        }
