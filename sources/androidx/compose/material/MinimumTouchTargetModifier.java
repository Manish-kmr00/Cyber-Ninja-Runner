...
final class MinimumTouchTargetModifier implements LayoutModifier {
    ...
    public MeasureResult mo33measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        final int iMax = Math.max(placeableMo3124measureBRTryo0.getWidth(), measure.mo312roundToPx0680j_4(DpSize.m3941getWidthD9Ej5fM(this.size)));
        final int iMax2 = Math.max(placeableMo3124measureBRTryo0.getHeight(), measure.mo312roundToPx0680j_4(DpSize.m3939getHeightD9Ej5fM(this.size)));
        return MeasureScope.layout$default(measure, iMax, iMax2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.MinimumTouchTargetModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.place$default(layout, placeableMo3124measureBRTryo0, MathKt.roundToInt((iMax - placeableMo3124measureBRTryo0.getWidth()) / 2.0f), MathKt.roundToInt((iMax2 - placeableMo3124measureBRTryo0.getHeight()) / 2.0f), 0.0f, 4, null);
            }
        }, 4, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return DpSize.m3938equalsimpl0(this.size, minimumTouchTargetModifier.size);
    }

    public int hashCode() {
        return DpSize.m3943hashCodeimpl(this.size);
    }
}
