...
final class DefaultSliderColors implements SliderColors {
    ...
    public State<Color> thumbColor(boolean z, Composer composer, int i) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m1621boximpl(z ? this.thumbColor : this.disabledThumbColor), composer, 0);
    ...
    public boolean equals(Object other) {
        ...
        return Color.m1632equalsimpl0(this.thumbColor, defaultSliderColors.thumbColor) && Color.m1632equalsimpl0(this.disabledThumbColor, defaultSliderColors.disabledThumbColor) && Color.m1632equalsimpl0(this.activeTrackColor, defaultSliderColors.activeTrackColor) && Color.m1632equalsimpl0(this.inactiveTrackColor, defaultSliderColors.inactiveTrackColor) && Color.m1632equalsimpl0(this.disabledActiveTrackColor, defaultSliderColors.disabledActiveTrackColor) && Color.m1632equalsimpl0(this.disabledInactiveTrackColor, defaultSliderColors.disabledInactiveTrackColor) && Color.m1632equalsimpl0(this.activeTickColor, defaultSliderColors.activeTickColor) && Color.m1632equalsimpl0(this.inactiveTickColor, defaultSliderColors.inactiveTickColor) && Color.m1632equalsimpl0(this.disabledActiveTickColor, defaultSliderColors.disabledActiveTickColor) && Color.m1632equalsimpl0(this.disabledInactiveTickColor, defaultSliderColors.disabledInactiveTickColor);
    }

    public int hashCode() {
        return (((((((((((((((((Color.m1638hashCodeimpl(this.thumbColor) * 31) + Color.m1638hashCodeimpl(this.disabledThumbColor)) * 31) + Color.m1638hashCodeimpl(this.activeTrackColor)) * 31) + Color.m1638hashCodeimpl(this.inactiveTrackColor)) * 31) + Color.m1638hashCodeimpl(this.disabledActiveTrackColor)) * 31) + Color.m1638hashCodeimpl(this.disabledInactiveTrackColor)) * 31) + Color.m1638hashCodeimpl(this.activeTickColor)) * 31) + Color.m1638hashCodeimpl(this.inactiveTickColor)) * 31) + Color.m1638hashCodeimpl(this.disabledActiveTickColor)) * 31) + Color.m1638hashCodeimpl(this.disabledInactiveTickColor);
    }
}
