...
final /* data */ class BottomAppBarCutoutShape implements Shape {
    ...
    public Outline mo211createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        ...
        Path.addRect(new Rect(0.0f, 0.0f, Size.m1464getWidthimpl(size), Size.m1461getHeightimpl(size)));
        Path Path2 = AndroidPath_androidKt.Path();
        addCutoutShape(Path2, layoutDirection, density);
        Path2.mo1528opN5in7k0(Path, Path2, PathOperation.INSTANCE.m1883getDifferenceb3I0S0c());
    ...
    private final void addCutoutShape(Path path, LayoutDirection layoutDirection, Density density) {
        float fMo318toPx0680j_4 = density.mo318toPx0680j_4(AppBarKt.BottomAppBarCutoutOffset);
        float f = 2 * fMo318toPx0680j_4;
        long jSize = SizeKt.Size(this.fabPlacement.getWidth() + f, this.fabPlacement.getHeight() + f);
        float left = this.fabPlacement.getLeft() - fMo318toPx0680j_4;
        float fM1464getWidthimpl = left + Size.m1464getWidthimpl(jSize);
        float fM1461getHeightimpl = Size.m1461getHeightimpl(jSize) / 2.0f;
        OutlineKt.addOutline(path, this.cutoutShape.mo211createOutlinePq9zytI(jSize, layoutDirection, density));
        path.mo1530translatek4lQ0M(OffsetKt.Offset(left, -fM1461getHeightimpl));
        if (Intrinsics.areEqual(this.cutoutShape, RoundedCornerShapeKt.getCircleShape())) {
            addRoundedEdges(path, left, fM1464getWidthimpl, fM1461getHeightimpl, density.mo318toPx0680j_4(AppBarKt.BottomAppBarRoundedEdgeRadius), 0.0f);
        }
    }
