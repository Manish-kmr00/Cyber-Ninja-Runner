...
final class DefaultTextFieldForExposedDropdownMenusColors implements TextFieldColorsWithIcons {
    ...
    public State<Color> leadingIconColor(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m1621boximpl(j), composer, 0);
    ...
    public State<Color> trailingIconColor(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (!z) {
            ...
            j = m1018trailingIconColor$lambda0(stateCollectIsFocusedAsState) ? this.focusedTrailingIconColor : this.trailingIconColor;
        }
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m1621boximpl(j), composer, 0);
        composer.endReplaceableGroup();
        return stateRememberUpdatedState;
    ...
    public State<Color> indicatorColor(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (!z) {
            ...
            j = m1016indicatorColor$lambda1(stateCollectIsFocusedAsState) ? this.focusedIndicatorColor : this.unfocusedIndicatorColor;
        }
        long j2 = j;
        if (z) {
            composer.startReplaceableGroup(182314778);
            ComposerKt.sourceInformation(composer, "635@27488L75");
            stateRememberUpdatedState = SingleValueAnimationKt.m92animateColorAsStateKTwxG1Y(j2, AnimationSpecKt.tween$default(150, 0, null, 6, null), null, composer, 48, 4);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(182314883);
            ComposerKt.sourceInformation(composer, "637@27593L33");
            stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m1621boximpl(j2), composer, 0);
            composer.endReplaceableGroup();
        }
        composer.endReplaceableGroup();
        return stateRememberUpdatedState;
    ...
    public State<Color> backgroundColor(boolean z, Composer composer, int i) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m1621boximpl(this.backgroundColor), composer, 0);
        composer.endReplaceableGroup();
        return stateRememberUpdatedState;
    }
    ...
    public State<Color> placeholderColor(boolean z, Composer composer, int i) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m1621boximpl(z ? this.placeholderColor : this.disabledPlaceholderColor), composer, 0);
        composer.endReplaceableGroup();
        return stateRememberUpdatedState;
    }
    ...
    public State<Color> labelColor(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (!z) {
            ...
            j = m1017labelColor$lambda2(stateCollectIsFocusedAsState) ? this.focusedLabelColor : this.unfocusedLabelColor;
        }
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m1621boximpl(j), composer, 0);
        composer.endReplaceableGroup();
        return stateRememberUpdatedState;
    ...
    public State<Color> textColor(boolean z, Composer composer, int i) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m1621boximpl(z ? this.textColor : this.disabledTextColor), composer, 0);
        composer.endReplaceableGroup();
        return stateRememberUpdatedState;
    }
    ...
    public State<Color> cursorColor(boolean z, Composer composer, int i) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m1621boximpl(z ? this.errorCursorColor : this.cursorColor), composer, 0);
        composer.endReplaceableGroup();
        return stateRememberUpdatedState;
    }
    ...
    public boolean equals(Object other) {
        ...
        return Color.m1632equalsimpl0(this.textColor, defaultTextFieldForExposedDropdownMenusColors.textColor) && Color.m1632equalsimpl0(this.disabledTextColor, defaultTextFieldForExposedDropdownMenusColors.disabledTextColor) && Color.m1632equalsimpl0(this.cursorColor, defaultTextFieldForExposedDropdownMenusColors.cursorColor) && Color.m1632equalsimpl0(this.errorCursorColor, defaultTextFieldForExposedDropdownMenusColors.errorCursorColor) && Color.m1632equalsimpl0(this.focusedIndicatorColor, defaultTextFieldForExposedDropdownMenusColors.focusedIndicatorColor) && Color.m1632equalsimpl0(this.unfocusedIndicatorColor, defaultTextFieldForExposedDropdownMenusColors.unfocusedIndicatorColor) && Color.m1632equalsimpl0(this.errorIndicatorColor, defaultTextFieldForExposedDropdownMenusColors.errorIndicatorColor) && Color.m1632equalsimpl0(this.disabledIndicatorColor, defaultTextFieldForExposedDropdownMenusColors.disabledIndicatorColor) && Color.m1632equalsimpl0(this.leadingIconColor, defaultTextFieldForExposedDropdownMenusColors.leadingIconColor) && Color.m1632equalsimpl0(this.disabledLeadingIconColor, defaultTextFieldForExposedDropdownMenusColors.disabledLeadingIconColor) && Color.m1632equalsimpl0(this.errorLeadingIconColor, defaultTextFieldForExposedDropdownMenusColors.errorLeadingIconColor) && Color.m1632equalsimpl0(this.trailingIconColor, defaultTextFieldForExposedDropdownMenusColors.trailingIconColor) && Color.m1632equalsimpl0(this.focusedTrailingIconColor, defaultTextFieldForExposedDropdownMenusColors.focusedTrailingIconColor) && Color.m1632equalsimpl0(this.disabledTrailingIconColor, defaultTextFieldForExposedDropdownMenusColors.disabledTrailingIconColor) && Color.m1632equalsimpl0(this.errorTrailingIconColor, defaultTextFieldForExposedDropdownMenusColors.errorTrailingIconColor) && Color.m1632equalsimpl0(this.backgroundColor, defaultTextFieldForExposedDropdownMenusColors.backgroundColor) && Color.m1632equalsimpl0(this.focusedLabelColor, defaultTextFieldForExposedDropdownMenusColors.focusedLabelColor) && Color.m1632equalsimpl0(this.unfocusedLabelColor, defaultTextFieldForExposedDropdownMenusColors.unfocusedLabelColor) && Color.m1632equalsimpl0(this.disabledLabelColor, defaultTextFieldForExposedDropdownMenusColors.disabledLabelColor) && Color.m1632equalsimpl0(this.errorLabelColor, defaultTextFieldForExposedDropdownMenusColors.errorLabelColor) && Color.m1632equalsimpl0(this.placeholderColor, defaultTextFieldForExposedDropdownMenusColors.placeholderColor) && Color.m1632equalsimpl0(this.disabledPlaceholderColor, defaultTextFieldForExposedDropdownMenusColors.disabledPlaceholderColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((((((((((((((((((((((Color.m1638hashCodeimpl(this.textColor) * 31) + Color.m1638hashCodeimpl(this.disabledTextColor)) * 31) + Color.m1638hashCodeimpl(this.cursorColor)) * 31) + Color.m1638hashCodeimpl(this.errorCursorColor)) * 31) + Color.m1638hashCodeimpl(this.focusedIndicatorColor)) * 31) + Color.m1638hashCodeimpl(this.unfocusedIndicatorColor)) * 31) + Color.m1638hashCodeimpl(this.errorIndicatorColor)) * 31) + Color.m1638hashCodeimpl(this.disabledIndicatorColor)) * 31) + Color.m1638hashCodeimpl(this.leadingIconColor)) * 31) + Color.m1638hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m1638hashCodeimpl(this.errorLeadingIconColor)) * 31) + Color.m1638hashCodeimpl(this.trailingIconColor)) * 31) + Color.m1638hashCodeimpl(this.focusedTrailingIconColor)) * 31) + Color.m1638hashCodeimpl(this.disabledTrailingIconColor)) * 31) + Color.m1638hashCodeimpl(this.errorTrailingIconColor)) * 31) + Color.m1638hashCodeimpl(this.backgroundColor)) * 31) + Color.m1638hashCodeimpl(this.focusedLabelColor)) * 31) + Color.m1638hashCodeimpl(this.unfocusedLabelColor)) * 31) + Color.m1638hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m1638hashCodeimpl(this.errorLabelColor)) * 31) + Color.m1638hashCodeimpl(this.placeholderColor)) * 31) + Color.m1638hashCodeimpl(this.disabledPlaceholderColor);
    }

    /* JADX INFO: renamed from: trailingIconColor$lambda-0, reason: not valid java name */
    private static final boolean m1018trailingIconColor$lambda0(State<Boolean> state) {
        return state.getValue().booleanValue();
    }

    /* JADX INFO: renamed from: indicatorColor$lambda-1, reason: not valid java name */
    private static final boolean m1016indicatorColor$lambda1(State<Boolean> state) {
        return state.getValue().booleanValue();
    }

    /* JADX INFO: renamed from: labelColor$lambda-2, reason: not valid java name */
    private static final boolean m1017labelColor$lambda2(State<Boolean> state) {
        return state.getValue().booleanValue();
    }
}
