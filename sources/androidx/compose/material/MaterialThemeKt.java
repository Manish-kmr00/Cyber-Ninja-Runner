...
public final class MaterialThemeKt {
    public static final void MaterialTheme(Colors colors, Typography typography, Shapes shapes, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i, final int i2) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(MaterialTheme)P(!1,3,2)59@2947L6,60@2998L10,61@3045L6,*64@3120L184,69@3367L16,70@3410L45,73@3581L4,71@3460L492:MaterialTheme.kt#jmzs0o");
        if ((i & 14) == 0) {
            if ((i2 & 1) == 0) {
                colors2 = colors;
        ...
        if ((i3 & 5851) != 1170 || !composerStartRestartGroup.getSkipping()) {
            ...
            if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
                ...
                objRememberedValue = colors3.m971copypvPzIIM((8191 & 1) != 0 ? colors3.m979getPrimary0d7_KjU() : 0L, (8191 & 2) != 0 ? colors3.m980getPrimaryVariant0d7_KjU() : 0L, (8191 & 4) != 0 ? colors3.m981getSecondary0d7_KjU() : 0L, (8191 & 8) != 0 ? colors3.m982getSecondaryVariant0d7_KjU() : 0L, (8191 & 16) != 0 ? colors3.m972getBackground0d7_KjU() : 0L, (8191 & 32) != 0 ? colors3.m983getSurface0d7_KjU() : 0L, (8191 & 64) != 0 ? colors3.m973getError0d7_KjU() : 0L, (8191 & 128) != 0 ? colors3.m976getOnPrimary0d7_KjU() : 0L, (8191 & 256) != 0 ? colors3.m977getOnSecondary0d7_KjU() : 0L, (8191 & 512) != 0 ? colors3.m974getOnBackground0d7_KjU() : 0L, (8191 & 1024) != 0 ? colors3.m978getOnSurface0d7_KjU() : 0L, (8191 & 2048) != 0 ? colors3.m975getOnError0d7_KjU() : 0L, (8191 & 4096) != 0 ? colors3.isLight() : false);
                composerStartRestartGroup.updateRememberedValue(objRememberedValue);
            }
            composerStartRestartGroup.endReplaceableGroup();
            Colors colors4 = (Colors) objRememberedValue;
            ColorsKt.updateColorsFrom(colors4, colors2);
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ColorsKt.getLocalColors().provides(colors4), ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(ContentAlpha.INSTANCE.getHigh(composerStartRestartGroup, 6))), IndicationKt.getLocalIndication().provides(RippleKt.m1265rememberRipple9IZ8Weo(false, 0.0f, 0L, composerStartRestartGroup, 0, 7)), RippleThemeKt.getLocalRippleTheme().provides(MaterialRippleTheme.INSTANCE), ShapesKt.getLocalShapes().provides(shapes4), TextSelectionColorsKt.getLocalTextSelectionColors().provides(MaterialTextSelectionColorsKt.rememberTextSelectionColors(colors4, composerStartRestartGroup, 0)), TypographyKt.getLocalTypography().provides(typography4)}, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1740102967, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.MaterialThemeKt.MaterialTheme.1
