...
public final class TabPosition {
    ...
    public final float m1201getRightD9Ej5fM() {
        return Dp.m3843constructorimpl(this.left + this.width);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m3848equalsimpl0(this.left, tabPosition.left) && Dp.m3848equalsimpl0(this.width, tabPosition.width);
    }

    public int hashCode() {
        return (Dp.m3849hashCodeimpl(this.left) * 31) + Dp.m3849hashCodeimpl(this.width);
    }

    public String toString() {
        return "TabPosition(left=" + ((Object) Dp.m3854toStringimpl(this.left)) + ", right=" + ((Object) Dp.m3854toStringimpl(m1201getRightD9Ej5fM())) + ", width=" + ((Object) Dp.m3854toStringimpl(this.width)) + ')';
    }
}
