...
public final class ExposedDropdownMenuPopupKt {
    ...
    public static final void ExposedDropdownMenuPopup(Function0<Unit> function0, final PopupPositionProvider popupPositionProvider, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i, final int i2) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(ExposedDropdownMenuPopup)P(1,2)82@3312L7,83@3351L7,84@3395L7,85@3450L7,86@3486L28,87@3541L29,88@3589L38,89@3650L907,116@4563L380,130@4949L192,138@5147L166,147@5491L647:ExposedDropdownMenuPopup.kt#mnwmf7");
        int i4 = i2 & 1;
        if (i4 != 0) {
            i3 = i | 6;
            function1 = function0;
            ...
            function1 = function0;
            i3 = (composerStartRestartGroup.changed(function1) ? 4 : 2) | i;
        } else {
            function1 = function0;
            i3 = i;
        }
        ...
        if ((i5 & 731) != 146 || !composerStartRestartGroup.getSkipping()) {
            final Function0<Unit> function2 = i4 != 0 ? null : function1;
            ...
            UUID popupId = (UUID) RememberSaveableKt.m1299rememberSaveable(new Object[0], (Saver) null, (String) null, (Function0) new Function0<UUID>() { // from class: androidx.compose.material.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$popupId$1
                @Override // kotlin.jvm.functions.Function0
                        ...
                        if ((i6 & 11) != 2 || !composer5.getSkipping()) {
                            ...
                            Modifier modifierAlpha = AlphaKt.alpha(OnRemeasuredModifierKt.onSizeChanged(modifierSemantics$default, new Function1<IntSize, Unit>() { // from class: androidx.compose.material.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$popupLayout$1$1$1.2
                                ...
                                public /* bridge */ /* synthetic */ Unit invoke(IntSize intSize) {
                                    m1252invokeozmzZPI(intSize.getPackedValue());
                                    return Unit.INSTANCE;
                                }

                                /* JADX INFO: renamed from: invoke-ozmzZPI, reason: not valid java name */
                                public final void m1252invokeozmzZPI(long j) {
                                    popupLayout2.m1254setPopupContentSizefhxjrPA(IntSize.m3995boximpl(j));
                            ...
                            ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(composer5, 2080999218, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$popupLayout$1$1$1.3
                                ...
                                public final void invoke(Composer composer6, int i7) {
                                    ...
                                    if ((i7 & 11) == 2 && composer6.getSkipping()) {
                                        ...
                                        ExposedDropdownMenuPopupKt.m1250ExposedDropdownMenuPopup$lambda0(state).invoke(composer6, 0);
                                    }
                                }
                            });
                            ...
                            ExposedDropdownMenuPopupKt.C10931 c10931 = ExposedDropdownMenuPopupKt.C10931.INSTANCE;
                            ...
                            Updater.m1293setimpl(composerM1286constructorimpl, c10931, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
            ...
            Modifier modifierOnGloballyPositioned = OnGloballyPositionedModifierKt.onGloballyPositioned(Modifier.INSTANCE, new Function1<LayoutCoordinates, Unit>() { // from class: androidx.compose.material.internal.ExposedDropdownMenuPopupKt.ExposedDropdownMenuPopup.5
                ...
                public final void invoke2(LayoutCoordinates childCoordinates) {
                    ...
                    long jMo3126getSizeYbymL2g = parentLayoutCoordinates.mo3126getSizeYbymL2g();
                    long jPositionInWindow = LayoutCoordinatesKt.positionInWindow(parentLayoutCoordinates);
                    popupLayout2.setParentBounds(IntRectKt.m3993IntRectVbeCjmY(IntOffsetKt.IntOffset(MathKt.roundToInt(Offset.m1395getXimpl(jPositionInWindow)), MathKt.roundToInt(Offset.m1396getYimpl(jPositionInWindow))), jMo3126getSizeYbymL2g));
                    popupLayout2.updatePosition();
                }
            });
            ...
            ProvidableCompositionLocal<Density> localDensity2 = CompositionLocalsKt.getLocalDensity();
            ComposerKt.sourceInformationMarkerStart(composer2, 2023513938, r2);
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.internal.ExposedDropdownMenuPopupKt.ExposedDropdownMenuPopup.7
            ...
            public final void invoke(Composer composer5, int i6) {
                ExposedDropdownMenuPopupKt.ExposedDropdownMenuPopup(function1, popupPositionProvider, content, composer5, i | 1, i2);
            }
        });
    }
    ...
    public static final class C10931 implements MeasurePolicy {
        ...
        public final MeasureResult mo18measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, long j) {
            ...
            if (size == 1) {
                ...
                return MeasureScope.layout$default(Layout, placeableMo3124measureBRTryo0.getWidth(), placeableMo3124measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.internal.ExposedDropdownMenuPopupKt$SimpleStack$1$measure$2
                    {
                        super(1);
                    }
            ...
            return MeasureScope.layout$default(Layout, i, i2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.internal.ExposedDropdownMenuPopupKt$SimpleStack$1$measure$3
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(1);
    ...
    public static final Function2<Composer, Integer, Unit> m1250ExposedDropdownMenuPopup$lambda0(State<? extends Function2<? super Composer, ? super Integer, Unit>> state) {
