...
final class PopupLayout extends AbstractComposeView implements ViewRootForInspector, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public PopupLayout(Function0<Unit> function0, String testTag, View composeView, Density density, PopupPositionProvider initialPositionProvider, UUID popupId) {
        ...
        this.canCalculatePosition = SnapshotStateKt.derivedStateOf(new Function0<Boolean>() { // from class: androidx.compose.material.internal.PopupLayout$canCalculatePosition$2
            ...
            public final Boolean invoke() {
                return Boolean.valueOf((this.this$0.getParentBounds() == null || this.this$0.m1253getPopupContentSizebOM6tXw() == null) ? false : true);
            }
        });
        float fM3843constructorimpl = Dp.m3843constructorimpl(30);
        this.maxSupportedElevation = fM3843constructorimpl;
        ...
        this.dismissOnOutsideClick = new Function2<Offset, IntRect, Boolean>() { // from class: androidx.compose.material.internal.PopupLayout$dismissOnOutsideClick$1
            ...
            public final Boolean invoke(Offset offset, IntRect bounds) {
                ...
                boolean z = false;
                if (offset != null && (Offset.m1395getXimpl(offset.getPackedValue()) < bounds.getLeft() || Offset.m1395getXimpl(offset.getPackedValue()) > bounds.getRight() || Offset.m1396getYimpl(offset.getPackedValue()) < bounds.getTop() || Offset.m1396getYimpl(offset.getPackedValue()) > bounds.getBottom())) {
                    z = true;
                }
        ...
        setElevation(density.mo318toPx0680j_4(fM3843constructorimpl));
        ...
        this.content = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(ComposableSingletons$ExposedDropdownMenuPopupKt.INSTANCE.m1249getLambda1$material_release(), null, 2, null);
    }
    ...
    public final IntSize m1253getPopupContentSizebOM6tXw() {
        return (IntSize) this.popupContentSize.getValue();
    }

    /* JADX INFO: renamed from: setPopupContentSize-fhxjrPA, reason: not valid java name */
    public final void m1254setPopupContentSizefhxjrPA(IntSize intSize) {
    ...
    public void Content(Composer composer, final int i) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(Content)298@11564L9:ExposedDropdownMenuPopup.kt#mnwmf7");
    ...
    public final void updatePosition() {
        IntSize intSizeM1253getPopupContentSizebOM6tXw;
        IntRect parentBounds = getParentBounds();
        if (parentBounds == null || (intSizeM1253getPopupContentSizebOM6tXw = m1253getPopupContentSizebOM6tXw()) == null) {
            return;
        }
        long packedValue = intSizeM1253getPopupContentSizebOM6tXw.getPackedValue();
        Rect rect = this.previousWindowVisibleFrame;
        this.composeView.getWindowVisibleDisplayFrame(rect);
        IntRect intBounds = toIntBounds(rect);
        long jMo785calculatePositionllwVHH4 = this.positionProvider.mo785calculatePositionllwVHH4(parentBounds, IntSizeKt.IntSize(intBounds.getWidth(), intBounds.getHeight()), this.parentLayoutDirection, packedValue);
        this.params.x = IntOffset.m3961getXimpl(jMo785calculatePositionllwVHH4);
        this.params.y = IntOffset.m3962getYimpl(jMo785calculatePositionllwVHH4);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:26:0x007f, code lost:
        ...
        if (r5.dismissOnOutsideClick.invoke((r6.getX() == 0.0f && r6.getY() == 0.0f) ? null : androidx.compose.ui.geometry.Offset.m1384boximpl(androidx.compose.ui.geometry.OffsetKt.Offset(r5.params.x + r6.getX(), r5.params.y + r6.getY())), r0).booleanValue() != false) goto L27;
     */
    @Override // android.view.View
    /*
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r6) {
        ...
        L59:
            ...
            androidx.compose.ui.geometry.Offset r1 = androidx.compose.ui.geometry.Offset.m1384boximpl(r3)
        L75:
