...
public final /* data */ class DropdownMenuPositionProvider implements PopupPositionProvider {
    ...
    public static /* synthetic */ DropdownMenuPositionProvider m1040copyrOJDEFc$default(DropdownMenuPositionProvider dropdownMenuPositionProvider, long j, Density density, Function2 function2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return dropdownMenuPositionProvider.m1042copyrOJDEFc(j, density, function2);
    }
    ...
    public final DropdownMenuPositionProvider m1042copyrOJDEFc(long contentOffset, Density density, Function2<? super IntRect, ? super IntRect, Unit> onPositionCalculated) {
    ...
    public boolean equals(Object other) {
        ...
        return DpOffset.m3903equalsimpl0(this.contentOffset, dropdownMenuPositionProvider.contentOffset) && Intrinsics.areEqual(this.density, dropdownMenuPositionProvider.density) && Intrinsics.areEqual(this.onPositionCalculated, dropdownMenuPositionProvider.onPositionCalculated);
    }

    public int hashCode() {
        return (((DpOffset.m3908hashCodeimpl(this.contentOffset) * 31) + this.density.hashCode()) * 31) + this.onPositionCalculated.hashCode();
    }

    public String toString() {
        return "DropdownMenuPositionProvider(contentOffset=" + ((Object) DpOffset.m3911toStringimpl(this.contentOffset)) + ", density=" + this.density + ", onPositionCalculated=" + this.onPositionCalculated + ')';
    }
    ...
    public final long m1043getContentOffsetRKDOV3M() {
        return this.contentOffset;
    }
    ...
    public long mo785calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        Sequence sequenceSequenceOf;
        Object obj;
        Object next;
        Intrinsics.checkNotNullParameter(anchorBounds, "anchorBounds");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        int iMo312roundToPx0680j_4 = this.density.mo312roundToPx0680j_4(MenuKt.getMenuVerticalMargin());
        int iMo312roundToPx0680j_5 = this.density.mo312roundToPx0680j_4(DpOffset.m3904getXD9Ej5fM(this.contentOffset));
        int iMo312roundToPx0680j_6 = this.density.mo312roundToPx0680j_4(DpOffset.m3906getYD9Ej5fM(this.contentOffset));
        int left = anchorBounds.getLeft() + iMo312roundToPx0680j_5;
        int right = (anchorBounds.getRight() - iMo312roundToPx0680j_5) - IntSize.m4003getWidthimpl(popupContentSize);
        int iM4003getWidthimpl = IntSize.m4003getWidthimpl(windowSize) - IntSize.m4003getWidthimpl(popupContentSize);
        if (layoutDirection == LayoutDirection.Ltr) {
            Integer[] numArr = new Integer[3];
            numArr[0] = Integer.valueOf(left);
            numArr[1] = Integer.valueOf(right);
            if (anchorBounds.getLeft() < 0) {
                iM4003getWidthimpl = 0;
            }
            numArr[2] = Integer.valueOf(iM4003getWidthimpl);
            sequenceSequenceOf = SequencesKt.sequenceOf(numArr);
        } else {
            Integer[] numArr2 = new Integer[3];
            numArr2[0] = Integer.valueOf(right);
            numArr2[1] = Integer.valueOf(left);
            if (anchorBounds.getRight() <= IntSize.m4003getWidthimpl(windowSize)) {
                iM4003getWidthimpl = 0;
            }
            numArr2[2] = Integer.valueOf(iM4003getWidthimpl);
        ...
        while (true) {
            ...
            if (iIntValue >= 0 && iIntValue + IntSize.m4003getWidthimpl(popupContentSize) <= IntSize.m4003getWidthimpl(windowSize)) {
                break;
            }
        }
        ...
        int iMax = Math.max(anchorBounds.getBottom() + iMo312roundToPx0680j_6, iMo312roundToPx0680j_4);
        int top = (anchorBounds.getTop() - iMo312roundToPx0680j_6) - IntSize.m4002getHeightimpl(popupContentSize);
        for (Object obj2 : SequencesKt.sequenceOf(Integer.valueOf(iMax), Integer.valueOf(top), Integer.valueOf(anchorBounds.getTop() - (IntSize.m4002getHeightimpl(popupContentSize) / 2)), Integer.valueOf((IntSize.m4002getHeightimpl(windowSize) - IntSize.m4002getHeightimpl(popupContentSize)) - iMo312roundToPx0680j_4))) {
            int iIntValue2 = ((Number) obj2).intValue();
            if (iIntValue2 >= iMo312roundToPx0680j_4 && iIntValue2 + IntSize.m4002getHeightimpl(popupContentSize) <= IntSize.m4002getHeightimpl(windowSize) - iMo312roundToPx0680j_4) {
                obj = obj2;
                break;
            }
        }
        ...
        this.onPositionCalculated.invoke(anchorBounds, new IntRect(right, top, IntSize.m4003getWidthimpl(popupContentSize) + right, IntSize.m4002getHeightimpl(popupContentSize) + top));
