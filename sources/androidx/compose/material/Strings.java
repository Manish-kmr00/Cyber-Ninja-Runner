...
public final class Strings {
    ...
    private static final int NavigationMenu = m1160constructorimpl(0);
    private static final int CloseDrawer = m1160constructorimpl(1);
    private static final int CloseSheet = m1160constructorimpl(2);
    private static final int DefaultErrorMessage = m1160constructorimpl(3);
    private static final int ExposedDropdownMenu = m1160constructorimpl(4);
    private static final int SliderRangeStart = m1160constructorimpl(5);
    private static final int SliderRangeEnd = m1160constructorimpl(6);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ Strings m1159boximpl(int i) {
        return new Strings(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static int m1160constructorimpl(int i) {
        return i;
    }
