...
final class DefaultButtonColors implements ButtonColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m1632equalsimpl0(this.backgroundColor, defaultButtonColors.backgroundColor) && Color.m1632equalsimpl0(this.contentColor, defaultButtonColors.contentColor) && Color.m1632equalsimpl0(this.disabledBackgroundColor, defaultButtonColors.disabledBackgroundColor) && Color.m1632equalsimpl0(this.disabledContentColor, defaultButtonColors.disabledContentColor);
    }

    public int hashCode() {
        return (((((Color.m1638hashCodeimpl(this.backgroundColor) * 31) + Color.m1638hashCodeimpl(this.contentColor)) * 31) + Color.m1638hashCodeimpl(this.disabledBackgroundColor)) * 31) + Color.m1638hashCodeimpl(this.disabledContentColor);
    }
}
