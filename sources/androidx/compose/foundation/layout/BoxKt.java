...
public final class BoxKt {
    ...
    private static final MeasurePolicy EmptyBoxMeasurePolicy = new MeasurePolicy() { // from class: androidx.compose.foundation.layout.BoxKt$EmptyBoxMeasurePolicy$1
        ...
        public final MeasureResult mo18measure3p2s80s(MeasureScope MeasurePolicy, List<? extends Measurable> list, long j) {
            Intrinsics.checkNotNullParameter(MeasurePolicy, "$this$MeasurePolicy");
            Intrinsics.checkNotNullParameter(list, "<anonymous parameter 0>");
            return MeasureScope.layout$default(MeasurePolicy, Constraints.m3801getMinWidthimpl(j), Constraints.m3800getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxKt$EmptyBoxMeasurePolicy$1$measure$1
    ...
    public static final MeasurePolicy boxMeasurePolicy(final Alignment alignment, final boolean z) {
        ...
        return new MeasurePolicy() { // from class: androidx.compose.foundation.layout.BoxKt.boxMeasurePolicy.1
            @Override // androidx.compose.ui.layout.MeasurePolicy
            /* JADX INFO: renamed from: measure-3p2s80s */
            public final MeasureResult mo18measure3p2s80s(final MeasureScope MeasurePolicy, final List<? extends Measurable> measurables, long j) {
                int iM3801getMinWidthimpl;
                final Placeable placeableMo3124measureBRTryo0;
                int iMax;
                Intrinsics.checkNotNullParameter(MeasurePolicy, "$this$MeasurePolicy");
                Intrinsics.checkNotNullParameter(measurables, "measurables");
                if (measurables.isEmpty()) {
                    return MeasureScope.layout$default(MeasurePolicy, Constraints.m3801getMinWidthimpl(j), Constraints.m3800getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxKt$boxMeasurePolicy$1$measure$1
                        /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
                        public final void invoke2(Placeable.PlacementScope layout) {
                            Intrinsics.checkNotNullParameter(layout, "$this$layout");
                        }
                ...
                long jM3790copyZbe2FdA$default = z ? j : Constraints.m3790copyZbe2FdA$default(j, 0, 0, 0, 0, 10, null);
                if (measurables.size() == 1) {
                    final Measurable measurable = measurables.get(0);
                    if (!BoxKt.getMatchesParentSize(measurable)) {
                        Placeable placeableMo3124measureBRTryo1 = measurable.mo3124measureBRTryo0(jM3790copyZbe2FdA$default);
                        int iMax2 = Math.max(Constraints.m3801getMinWidthimpl(j), placeableMo3124measureBRTryo1.getWidth());
                        iMax = Math.max(Constraints.m3800getMinHeightimpl(j), placeableMo3124measureBRTryo1.getHeight());
                        placeableMo3124measureBRTryo0 = placeableMo3124measureBRTryo1;
                        iM3801getMinWidthimpl = iMax2;
                    } else {
                        iM3801getMinWidthimpl = Constraints.m3801getMinWidthimpl(j);
                        int iM3800getMinHeightimpl = Constraints.m3800getMinHeightimpl(j);
                        placeableMo3124measureBRTryo0 = measurable.mo3124measureBRTryo0(Constraints.INSTANCE.m3807fixedJhjzzOo(Constraints.m3801getMinWidthimpl(j), Constraints.m3800getMinHeightimpl(j)));
                        iMax = iM3800getMinHeightimpl;
                    }
                    final Alignment alignment2 = alignment;
                    final int i = iM3801getMinWidthimpl;
                    final int i2 = iMax;
                    return MeasureScope.layout$default(MeasurePolicy, iM3801getMinWidthimpl, iMax, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxKt$boxMeasurePolicy$1$measure$2
                        ...
                        public final void invoke2(Placeable.PlacementScope layout) {
                            Intrinsics.checkNotNullParameter(layout, "$this$layout");
                            BoxKt.placeInBox(layout, placeableMo3124measureBRTryo0, measurable, MeasurePolicy.getLayoutDirection(), i, i2, alignment2);
                        }
                    }, 4, null);
                }
                final Placeable[] placeableArr = new Placeable[measurables.size()];
                final Ref.IntRef intRef = new Ref.IntRef();
                intRef.element = Constraints.m3801getMinWidthimpl(j);
                final Ref.IntRef intRef2 = new Ref.IntRef();
                intRef2.element = Constraints.m3800getMinHeightimpl(j);
                ...
                for (int i3 = 0; i3 < size; i3++) {
                    ...
                    if (BoxKt.getMatchesParentSize(measurable2)) {
                        ...
                        Placeable placeableMo3124measureBRTryo2 = measurable2.mo3124measureBRTryo0(jM3790copyZbe2FdA$default);
                        placeableArr[i3] = placeableMo3124measureBRTryo2;
                        intRef.element = Math.max(intRef.element, placeableMo3124measureBRTryo2.getWidth());
                        intRef2.element = Math.max(intRef2.element, placeableMo3124measureBRTryo2.getHeight());
                    }
                }
                if (z2) {
                    ...
                    for (int i4 = 0; i4 < size2; i4++) {
                        ...
                        if (BoxKt.getMatchesParentSize(measurable3)) {
                            placeableArr[i4] = measurable3.mo3124measureBRTryo0(jConstraints);
                        }
                    }
                }
    ...
    public static final void placeInBox(Placeable.PlacementScope placementScope, Placeable placeable, Measurable measurable, LayoutDirection layoutDirection, int i, int i2, Alignment alignment) {
        ...
        Placeable.PlacementScope.m3166place70tqf50$default(placementScope, placeable, ((boxChildData == null || (alignment2 = boxChildData.getAlignment()) == null) ? alignment : alignment2).mo1303alignKFBX0sM(IntSizeKt.IntSize(placeable.getWidth(), placeable.getHeight()), IntSizeKt.IntSize(i, i2), layoutDirection), 0.0f, 2, null);
    }
    ...
    public static final void Box(final Modifier modifier, Composer composer, final int i) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(Box)200@7989L70:Box.kt#2w3rfo");
        if ((i & 14) == 0) {
        ...
        if ((i2 & 11) != 2 || !composerStartRestartGroup.getSkipping()) {
            ...
            ComposerKt.sourceInformation(composerStartRestartGroup, "C:Box.kt#2w3rfo");
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.layout.BoxKt.Box.3
            ...
            public final void invoke(Composer composer2, int i3) {
                BoxKt.Box(modifier, composer2, i | 1);
            }
        });
    }
