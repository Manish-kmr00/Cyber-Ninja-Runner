...
public final /* data */ class OrientationIndependentConstraints {
    ...
    private OrientationIndependentConstraints(long j, LayoutOrientation layoutOrientation) {
        this(layoutOrientation == LayoutOrientation.Horizontal ? Constraints.m3801getMinWidthimpl(j) : Constraints.m3800getMinHeightimpl(j), layoutOrientation == LayoutOrientation.Horizontal ? Constraints.m3799getMaxWidthimpl(j) : Constraints.m3798getMaxHeightimpl(j), layoutOrientation == LayoutOrientation.Horizontal ? Constraints.m3800getMinHeightimpl(j) : Constraints.m3801getMinWidthimpl(j), layoutOrientation == LayoutOrientation.Horizontal ? Constraints.m3798getMaxHeightimpl(j) : Constraints.m3799getMaxWidthimpl(j));
    }
    ...
    public final long m415toBoxConstraintsOenEA2s(LayoutOrientation orientation) {
