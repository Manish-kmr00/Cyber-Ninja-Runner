...
final class AlignmentLineOffsetTextUnit extends InspectorValueInfo implements LayoutModifier {
    ...
    public MeasureResult mo33measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        return AlignmentLineKt.m345alignmentLineOffsetMeasuretjqqzMA(measure, this.alignmentLine, !TextUnitKt.m4042isUnspecifiedR2X_6o(this.before) ? measure.mo313toDpGaN1DYA(this.before) : Dp.INSTANCE.m3863getUnspecifiedD9Ej5fM(), !TextUnitKt.m4042isUnspecifiedR2X_6o(this.after) ? measure.mo313toDpGaN1DYA(this.after) : Dp.INSTANCE.m3863getUnspecifiedD9Ej5fM(), measurable, j);
    }

    public int hashCode() {
        return (((this.alignmentLine.hashCode() * 31) + TextUnit.m4025hashCodeimpl(this.before)) * 31) + TextUnit.m4025hashCodeimpl(this.after);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.alignmentLine, alignmentLineOffsetTextUnit.alignmentLine) && TextUnit.m4021equalsimpl0(this.before, alignmentLineOffsetTextUnit.before) && TextUnit.m4021equalsimpl0(this.after, alignmentLineOffsetTextUnit.after);
    }

    public String toString() {
        return "AlignmentLineOffset(alignmentLine=" + this.alignmentLine + ", before=" + ((Object) TextUnit.m4031toStringimpl(this.before)) + ", after=" + ((Object) TextUnit.m4031toStringimpl(this.after)) + ')';
    }
}
