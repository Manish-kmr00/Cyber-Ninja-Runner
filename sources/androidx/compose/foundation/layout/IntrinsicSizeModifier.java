...
interface IntrinsicSizeModifier extends LayoutModifier {
    ...
    long mo407calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j);
    ...
    default MeasureResult mo33measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(measure, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        long jMo407calculateContentConstraintsl58MMJ0 = mo407calculateContentConstraintsl58MMJ0(measure, measurable, j);
        if (getEnforceIncoming()) {
            jMo407calculateContentConstraintsl58MMJ0 = ConstraintsKt.m3811constrainN9IONVI(j, jMo407calculateContentConstraintsl58MMJ0);
        }
        final Placeable placeableMo3124measureBRTryo0 = measurable.mo3124measureBRTryo0(jMo407calculateContentConstraintsl58MMJ0);
        return MeasureScope.layout$default(measure, placeableMo3124measureBRTryo0.getWidth(), placeableMo3124measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.IntrinsicSizeModifier$measure$1
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.m3167placeRelative70tqf50$default(layout, placeableMo3124measureBRTryo0, IntOffset.INSTANCE.m3971getZeronOccac(), 0.0f, 2, null);
            }
        }, 4, null);
    }
