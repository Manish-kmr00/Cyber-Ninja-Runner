...
final /* data */ class BoxWithConstraintsScopeImpl implements BoxWithConstraintsScope, BoxScope {
    ...
    public static /* synthetic */ BoxWithConstraintsScopeImpl m400copy0kLqBqw$default(BoxWithConstraintsScopeImpl boxWithConstraintsScopeImpl, Density density, long j, int i, Object obj) {
        ...
        return boxWithConstraintsScopeImpl.m402copy0kLqBqw(density, j);
    }
    ...
    public final BoxWithConstraintsScopeImpl m402copy0kLqBqw(Density density, long constraints) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.density, boxWithConstraintsScopeImpl.density) && Constraints.m3792equalsimpl0(getConstraints(), boxWithConstraintsScopeImpl.getConstraints());
    }

    public int hashCode() {
        return (this.density.hashCode() * 31) + Constraints.m3802hashCodeimpl(getConstraints());
    }
    ...
    public String toString() {
        return "BoxWithConstraintsScopeImpl(density=" + this.density + ", constraints=" + ((Object) Constraints.m3804toStringimpl(getConstraints())) + ')';
    }
    ...
    public float mo399getMinWidthD9Ej5fM() {
        return this.density.mo315toDpu2uoSUM(Constraints.m3801getMinWidthimpl(getConstraints()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* JADX INFO: renamed from: getMaxWidth-D9Ej5fM */
    public float mo397getMaxWidthD9Ej5fM() {
        return Constraints.m3795getHasBoundedWidthimpl(getConstraints()) ? this.density.mo315toDpu2uoSUM(Constraints.m3799getMaxWidthimpl(getConstraints())) : Dp.INSTANCE.m3862getInfinityD9Ej5fM();
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* JADX INFO: renamed from: getMinHeight-D9Ej5fM */
    public float mo398getMinHeightD9Ej5fM() {
        return this.density.mo315toDpu2uoSUM(Constraints.m3800getMinHeightimpl(getConstraints()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* JADX INFO: renamed from: getMaxHeight-D9Ej5fM */
    public float mo396getMaxHeightD9Ej5fM() {
        return Constraints.m3794getHasBoundedHeightimpl(getConstraints()) ? this.density.mo315toDpu2uoSUM(Constraints.m3798getMaxHeightimpl(getConstraints())) : Dp.INSTANCE.m3862getInfinityD9Ej5fM();
    }
}
