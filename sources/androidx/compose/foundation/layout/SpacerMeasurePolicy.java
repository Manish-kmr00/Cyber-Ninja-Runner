...
final class SpacerMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo18measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long j) {
        ...
        return MeasureScope.layout$default(measure, Constraints.m3797getHasFixedWidthimpl(j) ? Constraints.m3799getMaxWidthimpl(j) : 0, Constraints.m3796getHasFixedHeightimpl(j) ? Constraints.m3798getMaxHeightimpl(j) : 0, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.SpacerMeasurePolicy$measure$1$1
