...
final class WindowInsetsNestedScrollConnection implements NestedScrollConnection, WindowInsetsAnimationControlListener {
    ...
    public long mo486onPreScrollOzD1aCk(long available, int source) {
        return m484scroll8S9VItk(available, this.sideCalculator.hideMotion(Offset.m1395getXimpl(available), Offset.m1396getYimpl(available)));
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* JADX INFO: renamed from: onPostScroll-DzOQY0M */
    public long mo324onPostScrollDzOQY0M(long consumed, long available, int source) {
        return m484scroll8S9VItk(available, this.sideCalculator.showMotion(Offset.m1395getXimpl(available), Offset.m1396getYimpl(available)));
    }

    /* JADX INFO: renamed from: scroll-8S9VItk, reason: not valid java name */
    private final long m484scroll8S9VItk(long available, float scrollAmount) {
        ...
        if (scrollAmount != 0.0f) {
            if (this.windowInsets.isVisible() != (scrollAmount > 0.0f) || windowInsetsAnimationController != null) {
                if (windowInsetsAnimationController == null) {
                    ...
                    requestAnimationController();
                    return this.sideCalculator.mo445consumedOffsetsMKHz9U(available);
                }
    ...
    public Object mo485onPreFlingQWom1Mo(long j, Continuation<? super Velocity> continuation) {
        return m483flinghuYlsQE(j, this.sideCalculator.hideMotion(Velocity.m4068getXimpl(j), Velocity.m4069getYimpl(j)), false, continuation);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* JADX INFO: renamed from: onPostFling-RZ2iAVY */
    public Object mo323onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        return m483flinghuYlsQE(j2, this.sideCalculator.showMotion(Velocity.m4068getXimpl(j2), Velocity.m4069getYimpl(j2)), true, continuation);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Code duplicated, block: B:7:0x001c  */
    /* JADX INFO: renamed from: fling-huYlsQE, reason: not valid java name */
    public final Object m483flinghuYlsQE(long j, float f, boolean z, Continuation<? super Velocity> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            if (i != 1) {
                if (i == 2) {
                    ...
                    ResultKt.throwOnFailure(obj);
                    return Velocity.m4059boximpl(windowInsetsNestedScrollConnection2.sideCalculator.mo446consumedVelocityQWom1Mo(j3, floatRef.element));
                }
                if (i == 3) {
                    ...
                    ResultKt.throwOnFailure(obj);
                    return Velocity.m4059boximpl(windowInsetsNestedScrollConnection3.sideCalculator.mo446consumedVelocityQWom1Mo(j4, 0.0f));
                }
