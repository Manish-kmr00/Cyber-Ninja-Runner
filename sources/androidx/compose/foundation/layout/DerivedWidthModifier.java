...
final class DerivedWidthModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer {
    ...
    public MeasureResult mo33measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        int iIntValue = this.widthCalc.invoke(getUnconsumedInsets(), measure.getLayoutDirection(), measure).intValue();
        if (iIntValue == 0) {
        ...
        final Placeable placeableMo3124measureBRTryo0 = measurable.mo3124measureBRTryo0(Constraints.m3790copyZbe2FdA$default(j, iIntValue, iIntValue, 0, 0, 12, null));
        return MeasureScope.layout$default(measure, iIntValue, placeableMo3124measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.DerivedWidthModifier$measure$2
            {
                super(1);
            }
