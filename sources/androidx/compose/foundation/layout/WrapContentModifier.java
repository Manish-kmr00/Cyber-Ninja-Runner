...
final class WrapContentModifier extends InspectorValueInfo implements LayoutModifier {
    ...
    public MeasureResult mo33measure3p2s80s(final MeasureScope measure, Measurable measurable, long j) {
        ...
        final Placeable placeableMo3124measureBRTryo0 = measurable.mo3124measureBRTryo0(ConstraintsKt.Constraints(this.direction != Direction.Vertical ? 0 : Constraints.m3801getMinWidthimpl(j), (this.direction == Direction.Vertical || !this.unbounded) ? Constraints.m3799getMaxWidthimpl(j) : Integer.MAX_VALUE, this.direction == Direction.Horizontal ? Constraints.m3800getMinHeightimpl(j) : 0, (this.direction == Direction.Horizontal || !this.unbounded) ? Constraints.m3798getMaxHeightimpl(j) : Integer.MAX_VALUE));
        final int iCoerceIn = RangesKt.coerceIn(placeableMo3124measureBRTryo0.getWidth(), Constraints.m3801getMinWidthimpl(j), Constraints.m3799getMaxWidthimpl(j));
        final int iCoerceIn2 = RangesKt.coerceIn(placeableMo3124measureBRTryo0.getHeight(), Constraints.m3800getMinHeightimpl(j), Constraints.m3798getMaxHeightimpl(j));
        return MeasureScope.layout$default(measure, iCoerceIn, iCoerceIn2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.WrapContentModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.m3166place70tqf50$default(layout, placeableMo3124measureBRTryo0, ((IntOffset) this.this$0.alignmentCallback.invoke(IntSize.m3995boximpl(IntSizeKt.IntSize(iCoerceIn - placeableMo3124measureBRTryo0.getWidth(), iCoerceIn2 - placeableMo3124measureBRTryo0.getHeight())), measure.getLayoutDirection())).getPackedValue(), 0.0f, 2, null);
            }
        }, 4, null);
    }
