...
final class DefaultDebugIndication implements Indication {
    ...
    private static final class DefaultDebugIndicationInstance implements IndicationInstance {
        ...
        public void drawIndication(ContentDrawScope contentDrawScope) {
            ...
            if (this.isPressed.getValue().booleanValue()) {
                DrawScope.m2120drawRectnJ9OG0$default(contentDrawScope, Color.m1630copywmQWz5c$default(Color.INSTANCE.m1657getBlack0d7_KjU(), 0.3f, 0.0f, 0.0f, 0.0f, 14, null), 0L, contentDrawScope.mo2125getSizeNHjbRc(), 0.0f, null, null, 0, Sdk.SDKError.Reason.INVALID_ADS_ENDPOINT_VALUE, null);
            } else if (this.isHovered.getValue().booleanValue() || this.isFocused.getValue().booleanValue()) {
                DrawScope.m2120drawRectnJ9OG0$default(contentDrawScope, Color.m1630copywmQWz5c$default(Color.INSTANCE.m1657getBlack0d7_KjU(), 0.1f, 0.0f, 0.0f, 0.0f, 14, null), 0L, contentDrawScope.mo2125getSizeNHjbRc(), 0.0f, null, null, 0, Sdk.SDKError.Reason.INVALID_ADS_ENDPOINT_VALUE, null);
            }
        }
    }
    ...
    public IndicationInstance rememberUpdatedInstance(InteractionSource interactionSource, Composer composer, int i) {
        ...
        composer.endReplaceableGroup();
        return (DefaultDebugIndicationInstance) objRememberedValue;
    }
}
