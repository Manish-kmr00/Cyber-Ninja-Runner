...
public final class ScrollState implements ScrollableState {
    ...
    private final ScrollableState scrollableState = ScrollableStateKt.ScrollableState(new Function1<Float, Float>() { // from class: androidx.compose.foundation.ScrollState$scrollableState$1
        ...
        public final Float invoke(float f) {
            ...
            int iRoundToInt = MathKt.roundToInt(value2);
            ScrollState scrollState = this.this$0;
            scrollState.setValue(scrollState.getValue() + iRoundToInt);
            this.this$0.accumulator = value2 - iRoundToInt;
            if (!z) {
                f = value2;
            }
    ...
    public final Object animateScrollTo(int i, AnimationSpec<Float> animationSpec, Continuation<? super Unit> continuation) throws Throwable {
