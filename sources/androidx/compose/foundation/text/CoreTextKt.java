...
public final class CoreTextKt {
    ...
    public static final void InlineChildren(final AnnotatedString text, final List<AnnotatedString.Range<Function3<String, Composer, Integer, Unit>>> inlineContents, Composer composer, final int i) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(InlineChildren)P(1)*80@3584L356:CoreText.kt#423gt5");
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            CoreTextKt$InlineChildren$1$2 coreTextKt$InlineChildren$1$2 = new MeasurePolicy() { // from class: androidx.compose.foundation.text.CoreTextKt$InlineChildren$1$2
                ...
                public final MeasureResult mo18measure3p2s80s(MeasureScope Layout, List<? extends Measurable> children, long j) {
                    Intrinsics.checkNotNullParameter(Layout, "$this$Layout");
                    Intrinsics.checkNotNullParameter(children, "children");
                    ArrayList arrayList = new ArrayList(children.size());
                    int size2 = children.size();
                    for (int i3 = 0; i3 < size2; i3++) {
                        arrayList.add(children.get(i3).mo3124measureBRTryo0(j));
                    }
                    final ArrayList arrayList2 = arrayList;
                    return MeasureScope.layout$default(Layout, Constraints.m3799getMaxWidthimpl(j), Constraints.m3798getMaxHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.CoreTextKt$InlineChildren$1$2$measure$1
            ...
            Updater.m1293setimpl(composerM1286constructorimpl, coreTextKt$InlineChildren$1$2, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
            ...
            ComposerKt.sourceInformation(composerStartRestartGroup, "C*81@3616L42:CoreText.kt#423gt5");
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.CoreTextKt.InlineChildren.2
            ...
            public final void invoke(Composer composer2, int i3) {
                CoreTextKt.InlineChildren(text, inlineContents, composer2, i | 1);
            }
        });
    }

    /* JADX INFO: renamed from: updateTextDelegate-x_uQXYA, reason: not valid java name */
    public static final TextDelegate m694updateTextDelegatex_uQXYA(TextDelegate current, AnnotatedString text, TextStyle style, Density density, FontFamily.Resolver fontFamilyResolver, boolean z, int i, int i2, List<AnnotatedString.Range<Placeholder>> placeholders) {
        ...
        if (Intrinsics.areEqual(current.getText(), text) && Intrinsics.areEqual(current.getStyle(), style)) {
            if (current.getSoftWrap() == z) {
                if (TextOverflow.m3777equalsimpl0(current.getOverflow(), i)) {
    ...
    public static final TextDelegate m696updateTextDelegatey0kMQk(TextDelegate current, String text, TextStyle style, Density density, FontFamily.Resolver fontFamilyResolver, boolean z, int i, int i2) {
        Intrinsics.checkNotNullParameter(current, "current");
        Intrinsics.checkNotNullParameter(text, "text");
        Intrinsics.checkNotNullParameter(style, "style");
        Intrinsics.checkNotNullParameter(density, "density");
