...
public final class TextDelegate {
    ...
    public /* synthetic */ TextDelegate(AnnotatedString annotatedString, TextStyle textStyle, int i, boolean z, int i2, Density density, FontFamily.Resolver resolver, List list, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, textStyle, (i3 & 4) != 0 ? Integer.MAX_VALUE : i, (i3 & 8) != 0 ? true : z, (i3 & 16) != 0 ? TextOverflow.INSTANCE.m3784getClipgIe3tQ8() : i2, density, resolver, (i3 & 128) != 0 ? CollectionsKt.emptyList() : list, null);
    }
    ...
    private final MultiParagraph m744layoutTextK40F9xA(long constraints, LayoutDirection layoutDirection) {
        layoutIntrinsics(layoutDirection);
        int iM3801getMinWidthimpl = Constraints.m3801getMinWidthimpl(constraints);
        int iM3799getMaxWidthimpl = ((this.softWrap || TextOverflow.m3777equalsimpl0(this.overflow, TextOverflow.INSTANCE.m3785getEllipsisgIe3tQ8())) && Constraints.m3795getHasBoundedWidthimpl(constraints)) ? Constraints.m3799getMaxWidthimpl(constraints) : Integer.MAX_VALUE;
        int i = (this.softWrap || !TextOverflow.m3777equalsimpl0(this.overflow, TextOverflow.INSTANCE.m3785getEllipsisgIe3tQ8())) ? this.maxLines : 1;
        if (iM3801getMinWidthimpl != iM3799getMaxWidthimpl) {
            iM3799getMaxWidthimpl = RangesKt.coerceIn(getMaxIntrinsicWidth(), iM3801getMinWidthimpl, iM3799getMaxWidthimpl);
        }
        return new MultiParagraph(getNonNullIntrinsics(), ConstraintsKt.Constraints$default(0, iM3799getMaxWidthimpl, 0, Constraints.m3798getMaxHeightimpl(constraints), 5, null), i, TextOverflow.m3777equalsimpl0(this.overflow, TextOverflow.INSTANCE.m3785getEllipsisgIe3tQ8()), null);
    }

    /* JADX INFO: renamed from: layout-NN6Ew-U$default, reason: not valid java name */
    public static /* synthetic */ TextLayoutResult m743layoutNN6EwU$default(TextDelegate textDelegate, long j, LayoutDirection layoutDirection, TextLayoutResult textLayoutResult, int i, Object obj) {
        if ((i & 4) != 0) {
            textLayoutResult = null;
        }
        return textDelegate.m746layoutNN6EwU(j, layoutDirection, textLayoutResult);
    }

    /* JADX INFO: renamed from: layout-NN6Ew-U, reason: not valid java name */
    public final TextLayoutResult m746layoutNN6EwU(long constraints, LayoutDirection layoutDirection, TextLayoutResult prevResult) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        if (prevResult != null && TextLayoutHelperKt.m768canReuse7_7YC6M(prevResult, this.text, this.style, this.placeholders, this.maxLines, this.softWrap, this.overflow, this.density, layoutDirection, this.fontFamilyResolver, constraints)) {
            return prevResult.m3473copyO0kMr_c(new TextLayoutInput(prevResult.getLayoutInput().getText(), this.style, prevResult.getLayoutInput().getPlaceholders(), prevResult.getLayoutInput().getMaxLines(), prevResult.getLayoutInput().getSoftWrap(), prevResult.getLayoutInput().getOverflow(), prevResult.getLayoutInput().getDensity(), prevResult.getLayoutInput().getLayoutDirection(), prevResult.getLayoutInput().getFontFamilyResolver(), constraints, (DefaultConstructorMarker) null), ConstraintsKt.m3810constrain4WqzIAM(constraints, IntSizeKt.IntSize((int) Math.ceil(prevResult.getMultiParagraph().getWidth()), (int) Math.ceil(prevResult.getMultiParagraph().getHeight()))));
        }
        MultiParagraph multiParagraphM744layoutTextK40F9xA = m744layoutTextK40F9xA(constraints, layoutDirection);
        return new TextLayoutResult(new TextLayoutInput(this.text, this.style, this.placeholders, this.maxLines, this.softWrap, this.overflow, this.density, layoutDirection, this.fontFamilyResolver, constraints, (DefaultConstructorMarker) null), multiParagraphM744layoutTextK40F9xA, ConstraintsKt.m3810constrain4WqzIAM(constraints, IntSizeKt.IntSize((int) Math.ceil(multiParagraphM744layoutTextK40F9xA.getWidth()), (int) Math.ceil(multiParagraphM744layoutTextK40F9xA.getHeight()))), null);
    }
