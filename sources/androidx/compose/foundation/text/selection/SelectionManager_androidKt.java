...
public final class SelectionManager_androidKt {
    ...
    public static final boolean m846isCopyKeyEventZmokQxo(KeyEvent keyEvent) {
    ...
    static final class AnonymousClass1 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
        ...
        public final Modifier invoke(Modifier composed, Composer composer, int i) {
            ...
            Modifier modifierAnimatedSelectionMagnifier = SelectionMagnifierKt.animatedSelectionMagnifier(composed, new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt.selectionMagnifier.1.1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
                }
                ...
                public /* bridge */ /* synthetic */ Offset invoke() {
                    return Offset.m1384boximpl(m851invokeF1C5BW0());
                }

                /* JADX INFO: renamed from: invoke-F1C5BW0, reason: not valid java name */
                public final long m851invokeF1C5BW0() {
                    return SelectionManagerKt.m844calculateSelectionMagnifierCenterAndroidO0kMr_c(selectionManager, AnonymousClass1.m849invoke$lambda1(mutableState));
                }
                ...
                public final Modifier invoke2(final Function0<Offset> center) {
                    ...
                    Function1<Density, Offset> function1 = new Function1<Density, Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt.selectionMagnifier.1.2.1
                        ...
                        public /* bridge */ /* synthetic */ Offset invoke(Density density2) {
                            return Offset.m1384boximpl(m852invoketuRUvjQ(density2));
                        }

                        /* JADX INFO: renamed from: invoke-tuRUvjQ, reason: not valid java name */
                        public final long m852invoketuRUvjQ(Density magnifier) {
                    ...
                    return MagnifierKt.magnifier$default(companion2, function1, null, 0.0f, textDefault, new Function1<DpSize, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt.selectionMagnifier.1.2.2
                        ...
                        public /* bridge */ /* synthetic */ Unit invoke(DpSize dpSize) {
                            m853invokeEaSLcWc(dpSize.getPackedValue());
                            return Unit.INSTANCE;
                        }

                        /* JADX INFO: renamed from: invoke-EaSLcWc, reason: not valid java name */
                        public final void m853invokeEaSLcWc(long j) {
                            MutableState<IntSize> mutableState3 = mutableState2;
                            Density density3 = density2;
                            AnonymousClass1.m850invoke$lambda2(mutableState3, IntSizeKt.IntSize(density3.mo312roundToPx0680j_4(DpSize.m3941getWidthD9Ej5fM(j)), density3.mo312roundToPx0680j_4(DpSize.m3939getHeightD9Ej5fM(j))));
                        }
                    }, 6, null);
                }
            });
        ...
        public static final long m849invoke$lambda1(MutableState<IntSize> mutableState) {
            return mutableState.getValue().getPackedValue();
        }

        /* JADX INFO: Access modifiers changed from: private */
        /* JADX INFO: renamed from: invoke$lambda-2, reason: not valid java name */
        public static final void m850invoke$lambda2(MutableState<IntSize> mutableState, long j) {
