...
public final class TextSelectionColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m1632equalsimpl0(this.handleColor, textSelectionColors.handleColor) && Color.m1632equalsimpl0(this.backgroundColor, textSelectionColors.backgroundColor);
    }

    public int hashCode() {
        return (Color.m1638hashCodeimpl(this.handleColor) * 31) + Color.m1638hashCodeimpl(this.backgroundColor);
    }

    public String toString() {
        return "SelectionColors(selectionHandleColor=" + ((Object) Color.m1639toStringimpl(this.handleColor)) + ", selectionBackgroundColor=" + ((Object) Color.m1639toStringimpl(this.backgroundColor)) + ')';
    }
}
