...
public final class TextFieldSelectionManager {
    ...
    public TextFieldSelectionManager(UndoManager undoManager) {
        ...
        this.dragBeginPosition = Offset.INSTANCE.m1411getZeroF1C5BW0();
        ...
        this.touchSelectionObserver = new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$touchSelectionObserver$1
            ...
            public void mo738onStartk4lQ0M(long startPoint) {
                ...
                if ((state2 == null || (layoutResult3 = state2.getLayoutResult()) == null || !layoutResult3.m773isPositionOnTextk4lQ0M(startPoint)) && (state = this.this$0.getState()) != null && (layoutResult = state.getLayoutResult()) != null) {
                    TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                    int iTransformedToOriginal = textFieldSelectionManager.getOffsetMapping().transformedToOriginal(TextLayoutResultProxy.getLineEnd$default(layoutResult, layoutResult.getLineForVerticalPosition(Offset.m1396getYimpl(startPoint)), false, 2, null));
                    HapticFeedback hapticFeedBack = textFieldSelectionManager.getHapticFeedBack();
                    if (hapticFeedBack != null) {
                        hapticFeedBack.mo2243performHapticFeedbackCdsT49E(HapticFeedbackType.INSTANCE.m2252getTextHandleMove5zf0vsI());
                    }
                    TextFieldValue textFieldValueM862createTextFieldValueFDrldGo = textFieldSelectionManager.m862createTextFieldValueFDrldGo(textFieldSelectionManager.getValue$foundation_release().getAnnotatedString(), TextRangeKt.TextRange(iTransformedToOriginal, iTransformedToOriginal));
                    textFieldSelectionManager.enterSelectionMode$foundation_release();
                    textFieldSelectionManager.getOnValueChange$foundation_release().invoke(textFieldValueM862createTextFieldValueFDrldGo);
                    return;
                }
                ...
                if (state3 != null && (layoutResult2 = state3.getLayoutResult()) != null) {
                    ...
                    int iM770getOffsetForPosition3MmeM6k$default = TextLayoutResultProxy.m770getOffsetForPosition3MmeM6k$default(layoutResult2, startPoint, false, 2, null);
                    textFieldSelectionManager2.updateSelection(textFieldSelectionManager2.getValue$foundation_release(), iM770getOffsetForPosition3MmeM6k$default, iM770getOffsetForPosition3MmeM6k$default, false, SelectionAdjustment.INSTANCE.getWord());
                    textFieldSelectionManager2.dragBeginOffsetInText = Integer.valueOf(iM770getOffsetForPosition3MmeM6k$default);
                }
                this.this$0.dragBeginPosition = startPoint;
                TextFieldSelectionManager textFieldSelectionManager3 = this.this$0;
                textFieldSelectionManager3.m864setCurrentDragPosition_kEHs6E(Offset.m1384boximpl(textFieldSelectionManager3.dragBeginPosition));
                this.this$0.dragTotalDistance = Offset.INSTANCE.m1411getZeroF1C5BW0();
            }
            ...
            public void mo737onDragk4lQ0M(long delta) {
                ...
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.dragTotalDistance = Offset.m1400plusMKHz9U(textFieldSelectionManager.dragTotalDistance, delta);
                TextFieldState state = this.this$0.getState();
                if (state != null && (layoutResult = state.getLayoutResult()) != null) {
                    TextFieldSelectionManager textFieldSelectionManager2 = this.this$0;
                    textFieldSelectionManager2.m864setCurrentDragPosition_kEHs6E(Offset.m1384boximpl(Offset.m1400plusMKHz9U(textFieldSelectionManager2.dragBeginPosition, textFieldSelectionManager2.dragTotalDistance)));
                    Integer num = textFieldSelectionManager2.dragBeginOffsetInText;
                    int iIntValue = num != null ? num.intValue() : layoutResult.m772getOffsetForPosition3MmeM6k(textFieldSelectionManager2.dragBeginPosition, false);
                    Offset offsetM867getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m867getCurrentDragPosition_m7T9E();
                    Intrinsics.checkNotNull(offsetM867getCurrentDragPosition_m7T9E);
                    textFieldSelectionManager2.updateSelection(textFieldSelectionManager2.getValue$foundation_release(), iIntValue, layoutResult.m772getOffsetForPosition3MmeM6k(offsetM867getCurrentDragPosition_m7T9E.getPackedValue(), false), false, SelectionAdjustment.INSTANCE.getWord());
                }
                TextFieldState state2 = this.this$0.getState();
                if (state2 == null) {
                    return;
            ...
            public void onStop() {
                ...
                this.this$0.m864setCurrentDragPosition_kEHs6E(null);
                TextFieldState state = this.this$0.getState();
                if (state != null) {
        ...
        this.mouseSelectionObserver = new MouseSelectionObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$mouseSelectionObserver$1
            ...
            public boolean mo740onExtendk4lQ0M(long downPosition) {
                ...
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.updateSelection(textFieldSelectionManager.getValue$foundation_release(), textFieldSelectionManager.getOffsetMapping().originalToTransformed(TextRange.m3489getStartimpl(textFieldSelectionManager.getValue$foundation_release().getSelection())), TextLayoutResultProxy.m770getOffsetForPosition3MmeM6k$default(layoutResult, downPosition, false, 2, null), false, SelectionAdjustment.INSTANCE.getNone());
                return true;
            }
            ...
            public boolean mo741onExtendDragk4lQ0M(long dragPosition) {
                ...
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.updateSelection(textFieldSelectionManager.getValue$foundation_release(), textFieldSelectionManager.getOffsetMapping().originalToTransformed(TextRange.m3489getStartimpl(textFieldSelectionManager.getValue$foundation_release().getSelection())), layoutResult.m772getOffsetForPosition3MmeM6k(dragPosition, false), false, SelectionAdjustment.INSTANCE.getNone());
                return true;
            }
            ...
            public boolean mo742onStart3MmeM6k(long downPosition, SelectionAdjustment adjustment) {
                ...
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.dragBeginOffsetInText = Integer.valueOf(TextLayoutResultProxy.m770getOffsetForPosition3MmeM6k$default(layoutResult, downPosition, false, 2, null));
                int iM770getOffsetForPosition3MmeM6k$default = TextLayoutResultProxy.m770getOffsetForPosition3MmeM6k$default(layoutResult, textFieldSelectionManager.dragBeginPosition, false, 2, null);
                textFieldSelectionManager.updateSelection(textFieldSelectionManager.getValue$foundation_release(), iM770getOffsetForPosition3MmeM6k$default, iM770getOffsetForPosition3MmeM6k$default, false, adjustment);
                return true;
            }
            ...
            public boolean mo739onDrag3MmeM6k(long dragPosition, SelectionAdjustment adjustment) {
                ...
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                int iM772getOffsetForPosition3MmeM6k = layoutResult.m772getOffsetForPosition3MmeM6k(dragPosition, false);
                ...
                textFieldSelectionManager.updateSelection(value$foundation_release, num.intValue(), iM772getOffsetForPosition3MmeM6k, false, adjustment);
                return true;
            }
        };
    }
    ...
    public final void m864setCurrentDragPosition_kEHs6E(Offset offset) {
        this.currentDragPosition.setValue(offset);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: getCurrentDragPosition-_m7T9-E, reason: not valid java name */
    public final Offset m867getCurrentDragPosition_m7T9E() {
    ...
    public final TextDragObserver handleDragObserver$foundation_release(final boolean isStartHandle) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$handleDragObserver$1
            ...
            public void mo736onDownk4lQ0M(long point) {
                ...
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.m864setCurrentDragPosition_kEHs6E(Offset.m1384boximpl(SelectionHandlesKt.m808getAdjustedCoordinatesk4lQ0M(textFieldSelectionManager.m869getHandlePositiontuRUvjQ$foundation_release(isStartHandle))));
            }
            ...
            public void mo738onStartk4lQ0M(long startPoint) {
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.dragBeginPosition = SelectionHandlesKt.m808getAdjustedCoordinatesk4lQ0M(textFieldSelectionManager.m869getHandlePositiontuRUvjQ$foundation_release(isStartHandle));
                TextFieldSelectionManager textFieldSelectionManager2 = this.this$0;
                textFieldSelectionManager2.m864setCurrentDragPosition_kEHs6E(Offset.m1384boximpl(textFieldSelectionManager2.dragBeginPosition));
                this.this$0.dragTotalDistance = Offset.INSTANCE.m1411getZeroF1C5BW0();
                this.this$0.setDraggingHandle(isStartHandle ? Handle.SelectionStart : Handle.SelectionEnd);
                TextFieldState state = this.this$0.getState();
                if (state == null) {
            ...
            public void mo737onDragk4lQ0M(long delta) {
                ...
                int iM3474getOffsetForPositionk4lQ0M;
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.dragTotalDistance = Offset.m1400plusMKHz9U(textFieldSelectionManager.dragTotalDistance, delta);
                TextFieldState state = this.this$0.getState();
                if (state != null && (layoutResult = state.getLayoutResult()) != null && (value = layoutResult.getValue()) != null) {
                    ...
                    if (z) {
                        Offset offsetM867getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m867getCurrentDragPosition_m7T9E();
                        Intrinsics.checkNotNull(offsetM867getCurrentDragPosition_m7T9E);
                        iOriginalToTransformed = value.m3474getOffsetForPositionk4lQ0M(offsetM867getCurrentDragPosition_m7T9E.getPackedValue());
                    } else {
                        iOriginalToTransformed = textFieldSelectionManager2.getOffsetMapping().originalToTransformed(TextRange.m3489getStartimpl(textFieldSelectionManager2.getValue$foundation_release().getSelection()));
                    }
                    int i = iOriginalToTransformed;
                    if (z) {
                        iM3474getOffsetForPositionk4lQ0M = textFieldSelectionManager2.getOffsetMapping().originalToTransformed(TextRange.m3484getEndimpl(textFieldSelectionManager2.getValue$foundation_release().getSelection()));
                    } else {
                        Offset offsetM867getCurrentDragPosition_m7T9E2 = textFieldSelectionManager2.m867getCurrentDragPosition_m7T9E();
                        Intrinsics.checkNotNull(offsetM867getCurrentDragPosition_m7T9E2);
                        iM3474getOffsetForPositionk4lQ0M = value.m3474getOffsetForPositionk4lQ0M(offsetM867getCurrentDragPosition_m7T9E2.getPackedValue());
                    }
                    textFieldSelectionManager2.updateSelection(textFieldSelectionManager2.getValue$foundation_release(), i, iM3474getOffsetForPositionk4lQ0M, z, SelectionAdjustment.INSTANCE.getCharacter());
                }
                TextFieldState state2 = this.this$0.getState();
                if (state2 == null) {
                    return;
    ...
    public final TextDragObserver cursorDragObserver$foundation_release() {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$cursorDragObserver$1
            ...
            public void mo736onDownk4lQ0M(long point) {
                ...
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.m864setCurrentDragPosition_kEHs6E(Offset.m1384boximpl(SelectionHandlesKt.m808getAdjustedCoordinatesk4lQ0M(textFieldSelectionManager.m869getHandlePositiontuRUvjQ$foundation_release(true))));
            }
            ...
            public void mo738onStartk4lQ0M(long startPoint) {
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.dragBeginPosition = SelectionHandlesKt.m808getAdjustedCoordinatesk4lQ0M(textFieldSelectionManager.m869getHandlePositiontuRUvjQ$foundation_release(true));
                TextFieldSelectionManager textFieldSelectionManager2 = this.this$0;
                textFieldSelectionManager2.m864setCurrentDragPosition_kEHs6E(Offset.m1384boximpl(textFieldSelectionManager2.dragBeginPosition));
                this.this$0.dragTotalDistance = Offset.INSTANCE.m1411getZeroF1C5BW0();
                this.this$0.setDraggingHandle(Handle.Cursor);
            ...
            public void mo737onDragk4lQ0M(long delta) {
                ...
                Offset offsetM867getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m867getCurrentDragPosition_m7T9E();
                Intrinsics.checkNotNull(offsetM867getCurrentDragPosition_m7T9E);
                int iM3474getOffsetForPositionk4lQ0M = value.m3474getOffsetForPositionk4lQ0M(offsetM867getCurrentDragPosition_m7T9E.getPackedValue());
                long jTextRange = TextRangeKt.TextRange(iM3474getOffsetForPositionk4lQ0M, iM3474getOffsetForPositionk4lQ0M);
                if (TextRange.m3482equalsimpl0(jTextRange, textFieldSelectionManager2.getValue$foundation_release().getSelection())) {
                    return;
                }
                ...
                textFieldSelectionManager2.getOnValueChange$foundation_release().invoke(textFieldSelectionManager2.m862createTextFieldValueFDrldGo(textFieldSelectionManager2.getValue$foundation_release().getAnnotatedString(), jTextRange));
            }
    ...
    public static /* synthetic */ void m863deselect_kEHs6E$foundation_release$default(TextFieldSelectionManager textFieldSelectionManager, Offset offset, int i, Object obj) {
        if ((i & 1) != 0) {
            offset = null;
        }
        textFieldSelectionManager.m866deselect_kEHs6E$foundation_release(offset);
    }

    /* JADX INFO: renamed from: deselect-_kEHs6E$foundation_release, reason: not valid java name */
    public final void m866deselect_kEHs6E$foundation_release(Offset position) {
        HandleState handleState;
        int iM3486getMaximpl;
        if (!TextRange.m3483getCollapsedimpl(getValue$foundation_release().getSelection())) {
            TextFieldState textFieldState = this.state;
            ...
            if (position != null && layoutResult != null) {
                iM3486getMaximpl = this.offsetMapping.transformedToOriginal(TextLayoutResultProxy.m770getOffsetForPosition3MmeM6k$default(layoutResult, position.getPackedValue(), false, 2, null));
            } else {
                iM3486getMaximpl = TextRange.m3486getMaximpl(getValue$foundation_release().getSelection());
            }
            this.onValueChange.invoke(TextFieldValue.m3662copy3r_uNRQ$default(getValue$foundation_release(), (AnnotatedString) null, TextRangeKt.TextRange(iM3486getMaximpl), (TextRange) null, 5, (Object) null));
        }
    ...
    public final void copy$foundation_release(boolean cancelSelection) {
        ...
        if (cancelSelection) {
            int iM3486getMaximpl = TextRange.m3486getMaximpl(getValue$foundation_release().getSelection());
            this.onValueChange.invoke(m862createTextFieldValueFDrldGo(getValue$foundation_release().getAnnotatedString(), TextRangeKt.TextRange(iM3486getMaximpl, iM3486getMaximpl)));
            setHandleState(HandleState.None);
        }
    }
    ...
    public final void paste$foundation_release() {
        ...
        int iM3487getMinimpl = TextRange.m3487getMinimpl(getValue$foundation_release().getSelection()) + text.length();
        this.onValueChange.invoke(m862createTextFieldValueFDrldGo(annotatedStringPlus, TextRangeKt.TextRange(iM3487getMinimpl, iM3487getMinimpl)));
        setHandleState(HandleState.None);
    ...
    public final void cut$foundation_release() {
        ...
        int iM3487getMinimpl = TextRange.m3487getMinimpl(getValue$foundation_release().getSelection());
        this.onValueChange.invoke(m862createTextFieldValueFDrldGo(annotatedStringPlus, TextRangeKt.TextRange(iM3487getMinimpl, iM3487getMinimpl)));
        setHandleState(HandleState.None);
        UndoManager undoManager = this.undoManager;
        if (undoManager != null) {
    ...
    public final void selectAll$foundation_release() {
        TextFieldValue textFieldValueM862createTextFieldValueFDrldGo = m862createTextFieldValueFDrldGo(getValue$foundation_release().getAnnotatedString(), TextRangeKt.TextRange(0, getValue$foundation_release().getText().length()));
        this.onValueChange.invoke(textFieldValueM862createTextFieldValueFDrldGo);
        this.oldValue = TextFieldValue.m3662copy3r_uNRQ$default(this.oldValue, (AnnotatedString) null, textFieldValueM862createTextFieldValueFDrldGo.getSelection(), (TextRange) null, 5, (Object) null);
        TextFieldState textFieldState = this.state;
        if (textFieldState == null) {
            return;
        }
    ...
    public final long m869getHandlePositiontuRUvjQ$foundation_release(boolean isStartHandle) {
        long selection = getValue$foundation_release().getSelection();
        int iM3489getStartimpl = isStartHandle ? TextRange.m3489getStartimpl(selection) : TextRange.m3484getEndimpl(selection);
        TextFieldState textFieldState = this.state;
        TextLayoutResultProxy layoutResult = textFieldState != null ? textFieldState.getLayoutResult() : null;
        Intrinsics.checkNotNull(layoutResult);
        return TextSelectionDelegateKt.getSelectionHandleCoordinates(layoutResult.getValue(), this.offsetMapping.originalToTransformed(iM3489getStartimpl), isStartHandle, TextRange.m3488getReversedimpl(getValue$foundation_release().getSelection()));
    }

    /* JADX INFO: renamed from: getCursorPosition-tuRUvjQ$foundation_release, reason: not valid java name */
    public final long m868getCursorPositiontuRUvjQ$foundation_release(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        int iOriginalToTransformed = this.offsetMapping.originalToTransformed(TextRange.m3489getStartimpl(getValue$foundation_release().getSelection()));
        TextFieldState textFieldState = this.state;
        TextLayoutResultProxy layoutResult = textFieldState != null ? textFieldState.getLayoutResult() : null;
        Intrinsics.checkNotNull(layoutResult);
        ...
        return OffsetKt.Offset(cursorRect.getLeft() + (density.mo318toPx0680j_4(TextFieldCursorKt.getDefaultCursorThickness()) / 2), cursorRect.getBottom());
    }
    ...
    public final void showSelectionToolbar$foundation_release() {
        ...
        Function0<Unit> function1 = (TextRange.m3483getCollapsedimpl(getValue$foundation_release().getSelection()) || z) ? null : new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$showSelectionToolbar$copy$1
            {
                super(0);
            }
        ...
        Function0<Unit> function2 = (TextRange.m3483getCollapsedimpl(getValue$foundation_release().getSelection()) || !getEditable() || z) ? null : new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$showSelectionToolbar$cut$1
            {
                super(0);
            }
        ...
        Function0<Unit> function3 = TextRange.m3485getLengthimpl(getValue$foundation_release().getSelection()) != getValue$foundation_release().getText().length() ? new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$showSelectionToolbar$selectAll$1
            {
                super(0);
            }
    ...
    public final void m865contextMenuOpenAdjustmentk4lQ0M(long position) {
        TextLayoutResultProxy layoutResult;
        TextFieldState textFieldState = this.state;
        if (textFieldState == null || (layoutResult = textFieldState.getLayoutResult()) == null) {
            return;
        }
        int iM770getOffsetForPosition3MmeM6k$default = TextLayoutResultProxy.m770getOffsetForPosition3MmeM6k$default(layoutResult, position, false, 2, null);
        if (TextRange.m3480containsimpl(getValue$foundation_release().getSelection(), iM770getOffsetForPosition3MmeM6k$default)) {
            return;
        }
        updateSelection(getValue$foundation_release(), iM770getOffsetForPosition3MmeM6k$default, iM770getOffsetForPosition3MmeM6k$default, false, SelectionAdjustment.INSTANCE.getWord());
    }
    ...
    private final Rect getContentRect() {
        ...
        TextFieldState textFieldState = this.state;
        if (textFieldState != null) {
            long jM1411getZeroF1C5BW0 = (textFieldState == null || (layoutCoordinates4 = textFieldState.getLayoutCoordinates()) == null) ? Offset.INSTANCE.m1411getZeroF1C5BW0() : layoutCoordinates4.mo3128localToRootMKHz9U(m869getHandlePositiontuRUvjQ$foundation_release(true));
            TextFieldState textFieldState2 = this.state;
            long jM1411getZeroF1C5BW1 = (textFieldState2 == null || (layoutCoordinates3 = textFieldState2.getLayoutCoordinates()) == null) ? Offset.INSTANCE.m1411getZeroF1C5BW0() : layoutCoordinates3.mo3128localToRootMKHz9U(m869getHandlePositiontuRUvjQ$foundation_release(false));
            TextFieldState textFieldState3 = this.state;
            float fM1396getYimpl2 = 0.0f;
            if (textFieldState3 == null || (layoutCoordinates2 = textFieldState3.getLayoutCoordinates()) == null) {
                fM1396getYimpl = 0.0f;
            } else {
                TextLayoutResultProxy layoutResult = textFieldState.getLayoutResult();
                fM1396getYimpl = Offset.m1396getYimpl(layoutCoordinates2.mo3128localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult == null || (value2 = layoutResult.getValue()) == null || (cursorRect2 = value2.getCursorRect(RangesKt.coerceIn(TextRange.m3489getStartimpl(getValue$foundation_release().getSelection()), 0, Math.max(0, getValue$foundation_release().getText().length() - 1)))) == null) ? 0.0f : cursorRect2.getTop())));
            }
            ...
            if (textFieldState4 != null && (layoutCoordinates = textFieldState4.getLayoutCoordinates()) != null) {
                ...
                fM1396getYimpl2 = Offset.m1396getYimpl(layoutCoordinates.mo3128localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult2 == null || (value = layoutResult2.getValue()) == null || (cursorRect = value.getCursorRect(RangesKt.coerceIn(TextRange.m3484getEndimpl(getValue$foundation_release().getSelection()), 0, Math.max(0, getValue$foundation_release().getText().length() - 1)))) == null) ? 0.0f : cursorRect.getTop())));
            }
            return new Rect(Math.min(Offset.m1395getXimpl(jM1411getZeroF1C5BW0), Offset.m1395getXimpl(jM1411getZeroF1C5BW1)), Math.min(fM1396getYimpl, fM1396getYimpl2), Math.max(Offset.m1395getXimpl(jM1411getZeroF1C5BW0), Offset.m1395getXimpl(jM1411getZeroF1C5BW1)), Math.max(Offset.m1396getYimpl(jM1411getZeroF1C5BW0), Offset.m1396getYimpl(jM1411getZeroF1C5BW1)) + (Dp.m3843constructorimpl(25) * textFieldState.getTextDelegate().getDensity().getDensity()));
        }
    ...
    public final void updateSelection(TextFieldValue value, int transformedStartOffset, int transformedEndOffset, boolean isStartHandle, SelectionAdjustment adjustment) {
        TextLayoutResultProxy layoutResult;
        long jTextRange = TextRangeKt.TextRange(this.offsetMapping.originalToTransformed(TextRange.m3489getStartimpl(value.getSelection())), this.offsetMapping.originalToTransformed(TextRange.m3484getEndimpl(value.getSelection())));
        TextFieldState textFieldState = this.state;
        long jM859getTextFieldSelectionbb3KNj8 = TextFieldSelectionDelegateKt.m859getTextFieldSelectionbb3KNj8((textFieldState == null || (layoutResult = textFieldState.getLayoutResult()) == null) ? null : layoutResult.getValue(), transformedStartOffset, transformedEndOffset, TextRange.m3483getCollapsedimpl(jTextRange) ? null : TextRange.m3477boximpl(jTextRange), isStartHandle, adjustment);
        long jTextRange2 = TextRangeKt.TextRange(this.offsetMapping.transformedToOriginal(TextRange.m3489getStartimpl(jM859getTextFieldSelectionbb3KNj8)), this.offsetMapping.transformedToOriginal(TextRange.m3484getEndimpl(jM859getTextFieldSelectionbb3KNj8)));
        if (TextRange.m3482equalsimpl0(jTextRange2, value.getSelection())) {
            return;
        }
        ...
        this.onValueChange.invoke(m862createTextFieldValueFDrldGo(value.getAnnotatedString(), jTextRange2));
        TextFieldState textFieldState2 = this.state;
        if (textFieldState2 != null) {
    ...
    public final TextFieldValue m862createTextFieldValueFDrldGo(AnnotatedString annotatedString, long selection) {
