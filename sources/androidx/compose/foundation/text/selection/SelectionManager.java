...
public final class SelectionManager {
    ...
    public SelectionManager(SelectionRegistrarImpl selectionRegistrar) {
        ...
        this.dragBeginPosition = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m1384boximpl(Offset.INSTANCE.m1411getZeroF1C5BW0()), null, 2, null);
        this.dragTotalDistance = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m1384boximpl(Offset.INSTANCE.m1411getZeroF1C5BW0()), null, 2, null);
        ...
        selectionRegistrar.setOnSelectionUpdateStartCallback$foundation_release(new Function3<LayoutCoordinates, Offset, SelectionAdjustment, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.2
            ...
            public /* bridge */ /* synthetic */ Unit invoke(LayoutCoordinates layoutCoordinates, Offset offset, SelectionAdjustment selectionAdjustment) {
                m840invoked4ec7I(layoutCoordinates, offset.getPackedValue(), selectionAdjustment);
                return Unit.INSTANCE;
            }

            /* JADX INFO: renamed from: invoke-d-4ec7I, reason: not valid java name */
            public final void m840invoked4ec7I(LayoutCoordinates layoutCoordinates, long j, SelectionAdjustment selectionMode) {
                Intrinsics.checkNotNullParameter(layoutCoordinates, "layoutCoordinates");
                Intrinsics.checkNotNullParameter(selectionMode, "selectionMode");
                Offset offsetM825convertToContainerCoordinatesQ7Q5hAU = SelectionManager.this.m825convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, j);
                if (offsetM825convertToContainerCoordinatesQ7Q5hAU != null) {
                    SelectionManager.this.m831startSelection9KIMszo(offsetM825convertToContainerCoordinatesQ7Q5hAU.getPackedValue(), false, selectionMode);
        ...
        selectionRegistrar.setOnSelectionUpdateCallback$foundation_release(new Function5<LayoutCoordinates, Offset, Offset, Boolean, SelectionAdjustment, Boolean>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.4
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(LayoutCoordinates layoutCoordinates, Offset offset, Offset offset2, Boolean bool, SelectionAdjustment selectionAdjustment) {
                return m841invoke5iVPX68(layoutCoordinates, offset.getPackedValue(), offset2.getPackedValue(), bool.booleanValue(), selectionAdjustment);
            }

            /* JADX INFO: renamed from: invoke-5iVPX68, reason: not valid java name */
            public final Boolean m841invoke5iVPX68(LayoutCoordinates layoutCoordinates, long j, long j2, boolean z, SelectionAdjustment selectionMode) {
                Intrinsics.checkNotNullParameter(layoutCoordinates, "layoutCoordinates");
                Intrinsics.checkNotNullParameter(selectionMode, "selectionMode");
                return Boolean.valueOf(SelectionManager.this.m839updateSelectionRHHTvR4$foundation_release(SelectionManager.this.m825convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, j), SelectionManager.this.m825convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, j2), z, selectionMode));
            }
        });
        selectionRegistrar.setOnSelectionUpdateEndCallback$foundation_release(new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.5
            ...
            public final void invoke2() {
                ...
                SelectionManager.this.m826setCurrentDragPosition_kEHs6E(null);
            }
        });
        ...
        selectionRegistrar.setAfterSelectableUnsubscribe$foundation_release(new Function1<Long, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.7
            ...
            public final void invoke(long j) {
                ...
                SelectionManager.this.m830setStartHandlePosition_kEHs6E(null);
                SelectionManager.this.m829setEndHandlePosition_kEHs6E(null);
            }
        });
    }
    ...
    public final Modifier getModifier() {
        return KeyInputModifierKt.onKeyEvent(FocusableKt.focusable$default(FocusChangedModifierKt.onFocusChanged(FocusRequesterModifierKt.focusRequester(OnGloballyPositionedModifierKt.onGloballyPositioned(onClearSelectionRequested(Modifier.INSTANCE, new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager$modifier$1
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m842invokeZmokQxo(keyEvent.m2854unboximpl());
            }

            /* JADX INFO: renamed from: invoke-ZmokQxo, reason: not valid java name */
            public final Boolean m842invokeZmokQxo(android.view.KeyEvent it) {
                boolean z;
                Intrinsics.checkNotNullParameter(it, "it");
                if (SelectionManager_androidKt.m846isCopyKeyEventZmokQxo(it)) {
    ...
    public final void setContainerLayoutCoordinates(LayoutCoordinates layoutCoordinates) {
        ...
        Offset offsetM1384boximpl = layoutCoordinates != null ? Offset.m1384boximpl(LayoutCoordinatesKt.positionInWindow(layoutCoordinates)) : null;
        if (Intrinsics.areEqual(this.previousPosition, offsetM1384boximpl)) {
            return;
        }
        this.previousPosition = offsetM1384boximpl;
        updateHandleOffsets();
    ...
    public final void m827setDragBeginPositionk4lQ0M(long j) {
        this.dragBeginPosition.setValue(Offset.m1384boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: getDragBeginPosition-F1C5BW0$foundation_release, reason: not valid java name */
    public final long m834getDragBeginPositionF1C5BW0$foundation_release() {
    ...
    public final void m828setDragTotalDistancek4lQ0M(long j) {
        this.dragTotalDistance.setValue(Offset.m1384boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: getDragTotalDistance-F1C5BW0$foundation_release, reason: not valid java name */
    public final long m835getDragTotalDistanceF1C5BW0$foundation_release() {
    ...
    public final void m826setCurrentDragPosition_kEHs6E(Offset offset) {
        this.currentDragPosition.setValue(offset);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: getCurrentDragPosition-_m7T9-E, reason: not valid java name */
    public final Offset m833getCurrentDragPosition_m7T9E() {
    ...
    public final void updateHandleOffsets() {
        ...
        if (selection == null || layoutCoordinates == null || !layoutCoordinates.isAttached() || layoutCoordinates2 == null || layoutCoordinates3 == null) {
            m830setStartHandlePosition_kEHs6E(null);
            m829setEndHandlePosition_kEHs6E(null);
            return;
        }
        long jMo3127localPositionOfR5De75A = layoutCoordinates.mo3127localPositionOfR5De75A(layoutCoordinates2, anchorSelectable$foundation_release.mo786getHandlePositiondBAh8RU(selection, true));
        long jMo3127localPositionOfR5De75A2 = layoutCoordinates.mo3127localPositionOfR5De75A(layoutCoordinates3, anchorSelectable$foundation_release2.mo786getHandlePositiondBAh8RU(selection, false));
        Rect rectVisibleBounds = SelectionManagerKt.visibleBounds(layoutCoordinates);
        m830setStartHandlePosition_kEHs6E(SelectionManagerKt.m845containsInclusiveUv8p0NA(rectVisibleBounds, jMo3127localPositionOfR5De75A) ? Offset.m1384boximpl(jMo3127localPositionOfR5De75A) : null);
        m829setEndHandlePosition_kEHs6E(SelectionManagerKt.m845containsInclusiveUv8p0NA(rectVisibleBounds, jMo3127localPositionOfR5De75A2) ? Offset.m1384boximpl(jMo3127localPositionOfR5De75A2) : null);
    }
    ...
    private final Rect getContentRect() {
        ...
        if (layoutCoordinates3 != null && layoutCoordinates3.isAttached()) {
            long jMo3127localPositionOfR5De75A = layoutCoordinates3.mo3127localPositionOfR5De75A(layoutCoordinates, anchorSelectable$foundation_release.mo786getHandlePositiondBAh8RU(selection, true));
            long jMo3127localPositionOfR5De75A2 = layoutCoordinates3.mo3127localPositionOfR5De75A(layoutCoordinates2, anchorSelectable$foundation_release2.mo786getHandlePositiondBAh8RU(selection, false));
            long jMo3128localToRootMKHz9U = layoutCoordinates3.mo3128localToRootMKHz9U(jMo3127localPositionOfR5De75A);
            long jMo3128localToRootMKHz9U2 = layoutCoordinates3.mo3128localToRootMKHz9U(jMo3127localPositionOfR5De75A2);
            return new Rect(Math.min(Offset.m1395getXimpl(jMo3128localToRootMKHz9U), Offset.m1395getXimpl(jMo3128localToRootMKHz9U2)), Math.min(Offset.m1396getYimpl(layoutCoordinates3.mo3128localToRootMKHz9U(layoutCoordinates3.mo3127localPositionOfR5De75A(layoutCoordinates, OffsetKt.Offset(0.0f, anchorSelectable$foundation_release.getBoundingBox(selection.getStart().getOffset()).getTop())))), Offset.m1396getYimpl(layoutCoordinates3.mo3128localToRootMKHz9U(layoutCoordinates3.mo3127localPositionOfR5De75A(layoutCoordinates2, OffsetKt.Offset(0.0f, anchorSelectable$foundation_release2.getBoundingBox(selection.getEnd().getOffset()).getTop()))))), Math.max(Offset.m1395getXimpl(jMo3128localToRootMKHz9U), Offset.m1395getXimpl(jMo3128localToRootMKHz9U2)), Math.max(Offset.m1396getYimpl(jMo3128localToRootMKHz9U), Offset.m1396getYimpl(jMo3128localToRootMKHz9U2)) + ((float) (((double) SelectionHandlesKt.getHandleHeight()) * 4.0d)));
        }
        return Rect.INSTANCE.getZero();
    }
    ...
    public final TextDragObserver handleDragObserver(final boolean isStartHandle) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.SelectionManager.handleDragObserver.1
            ...
            public void mo736onDownk4lQ0M(long point) {
                ...
                long jM808getAdjustedCoordinatesk4lQ0M = SelectionHandlesKt.m808getAdjustedCoordinatesk4lQ0M(anchorSelectable$foundation_release.mo786getHandlePositiondBAh8RU(selection, isStartHandle));
                SelectionManager selectionManager = SelectionManager.this;
                selectionManager.m826setCurrentDragPosition_kEHs6E(Offset.m1384boximpl(selectionManager.requireContainerCoordinates$foundation_release().mo3127localPositionOfR5De75A(layoutCoordinates, jM808getAdjustedCoordinatesk4lQ0M)));
            ...
            public void mo738onStartk4lQ0M(long startPoint) {
                LayoutCoordinates layoutCoordinates;
                long jMo786getHandlePositiondBAh8RU;
                SelectionManager.this.hideSelectionToolbar$foundation_release();
                Selection selection = SelectionManager.this.getSelection();
                ...
                if (isStartHandle) {
                    ...
                    jMo786getHandlePositiondBAh8RU = selectable.mo786getHandlePositiondBAh8RU(selection, true);
                } else {
                    Intrinsics.checkNotNull(selectable2);
                    jMo786getHandlePositiondBAh8RU = selectable2.mo786getHandlePositiondBAh8RU(selection, false);
                }
                long jM808getAdjustedCoordinatesk4lQ0M = SelectionHandlesKt.m808getAdjustedCoordinatesk4lQ0M(jMo786getHandlePositiondBAh8RU);
                SelectionManager selectionManager = SelectionManager.this;
                selectionManager.m827setDragBeginPositionk4lQ0M(selectionManager.requireContainerCoordinates$foundation_release().mo3127localPositionOfR5De75A(layoutCoordinates, jM808getAdjustedCoordinatesk4lQ0M));
                SelectionManager.this.m828setDragTotalDistancek4lQ0M(Offset.INSTANCE.m1411getZeroF1C5BW0());
            }
            ...
            public void mo737onDragk4lQ0M(long delta) {
                SelectionManager selectionManager = SelectionManager.this;
                selectionManager.m828setDragTotalDistancek4lQ0M(Offset.m1400plusMKHz9U(selectionManager.m835getDragTotalDistanceF1C5BW0$foundation_release(), delta));
                long jM1400plusMKHz9U = Offset.m1400plusMKHz9U(SelectionManager.this.m834getDragBeginPositionF1C5BW0$foundation_release(), SelectionManager.this.m835getDragTotalDistanceF1C5BW0$foundation_release());
                if (SelectionManager.this.m839updateSelectionRHHTvR4$foundation_release(Offset.m1384boximpl(jM1400plusMKHz9U), Offset.m1384boximpl(SelectionManager.this.m834getDragBeginPositionF1C5BW0$foundation_release()), isStartHandle, SelectionAdjustment.INSTANCE.getCharacterWithWordAccelerate())) {
                    SelectionManager.this.m827setDragBeginPositionk4lQ0M(jM1400plusMKHz9U);
                    SelectionManager.this.m828setDragTotalDistancek4lQ0M(Offset.INSTANCE.m1411getZeroF1C5BW0());
                }
            }
    ...
    static final class C10462 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        C10462(Function1<? super Offset, Unit> function1, Continuation<? super C10462> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C10462 c10462 = new C10462(this.$onTap, continuation);
            c10462.L$0 = obj;
            return c10462;
        }
        ...
        public final Object invoke(PointerInputScope pointerInputScope, Continuation<? super Unit> continuation) {
            return ((C10462) create(pointerInputScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            static final class C00481 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                C00481(Function1<? super Offset, Unit> function1, Continuation<? super C00481> continuation) {
                    super(2, continuation);
                    this.$onTap = function1;
                }
                ...
                @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                    C00481 c00481 = new C00481(this.$onTap, continuation);
                    c00481.L$0 = obj;
                    return c00481;
                }
                ...
                public final Object invokeSuspend(Object obj) throws Throwable {
                    ...
                    if (pointerInputChange != null) {
                        this.$onTap.invoke(Offset.m1384boximpl(pointerInputChange.getPosition()));
                    }
                    return Unit.INSTANCE;
                }
            }
            ...
            public final Object invokeSuspend(Object obj) throws Throwable {
                ...
                if (i == 0) {
                    ResultKt.throwOnFailure(obj);
                    this.label = 1;
                    if (this.$$this$forEachGesture.awaitPointerEventScope(new C00481(this.$onTap, null), this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
                    if (i != 1) {
    ...
    public final Object detectNonConsumingTap(PointerInputScope pointerInputScope, Function1<? super Offset, Unit> function1, Continuation<? super Unit> continuation) {
        Object objForEachGesture = ForEachGestureKt.forEachGesture(pointerInputScope, new C10462(function1, null), continuation);
    ...
    /* JADX INFO: compiled from: SelectionManager.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, d2 = {"<anonymous>", "", "Landroidx/compose/ui/input/pointer/PointerInputScope;"}, k = 3, mv = {1, 6, 0}, xi = 48)
    @DebugMetadata(c = "androidx.compose.foundation.text.selection.SelectionManager$onClearSelectionRequested$1", f = "SelectionManager.kt", i = {}, l = {LevelPlayAdError.ERROR_CODE_SHOW_WHILE_SHOW}, m = "invokeSuspend", n = {}, s = {})
    static final class C10481 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ Function0<Unit> $block;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C10481(Function0<Unit> function0, Continuation<? super C10481> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C10481 c10481 = SelectionManager.this.new C10481(this.$block, continuation);
            c10481.L$0 = obj;
            return c10481;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(PointerInputScope pointerInputScope, Continuation<? super Unit> continuation) {
            return ((C10481) create(pointerInputScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
            ...
            if (i == 0) {
                ...
                if (selectionManager.detectNonConsumingTap(pointerInputScope, new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.onClearSelectionRequested.1.1
                    ...
                    public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                        m843invokek4lQ0M(offset.getPackedValue());
                        return Unit.INSTANCE;
                    }
    ...
    private final Modifier onClearSelectionRequested(Modifier modifier, Function0<Unit> function0) {
        return getHasFocus() ? SuspendingPointerInputFilterKt.pointerInput(modifier, Unit.INSTANCE, new C10481(function0, null)) : modifier;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: convertToContainerCoordinates-Q7Q5hAU, reason: not valid java name */
    public final Offset m825convertToContainerCoordinatesQ7Q5hAU(LayoutCoordinates layoutCoordinates, long offset) {
        LayoutCoordinates layoutCoordinates2 = this.containerLayoutCoordinates;
        if (layoutCoordinates2 == null || !layoutCoordinates2.isAttached()) {
            return null;
        }
        return Offset.m1384boximpl(requireContainerCoordinates$foundation_release().mo3127localPositionOfR5De75A(layoutCoordinates, offset));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: startSelection-9KIMszo, reason: not valid java name */
    public final void m831startSelection9KIMszo(long position, boolean isStartHandle, SelectionAdjustment adjustment) {
        m838updateSelection3R_tFg$foundation_release(position, position, null, isStartHandle, adjustment);
    }

    /* JADX INFO: renamed from: updateSelection-RHHTvR4$foundation_release, reason: not valid java name */
    public final boolean m839updateSelectionRHHTvR4$foundation_release(Offset newPosition, Offset previousPosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        Selection selection;
        long selectableId;
        Offset offsetM825convertToContainerCoordinatesQ7Q5hAU;
        ...
        if (selectable == null) {
            offsetM825convertToContainerCoordinatesQ7Q5hAU = null;
        } else {
            LayoutCoordinates layoutCoordinates = selectable.getLayoutCoordinates();
            Intrinsics.checkNotNull(layoutCoordinates);
            offsetM825convertToContainerCoordinatesQ7Q5hAU = m825convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, SelectionHandlesKt.m808getAdjustedCoordinatesk4lQ0M(selectable.mo786getHandlePositiondBAh8RU(selection, !isStartHandle)));
        }
        if (offsetM825convertToContainerCoordinatesQ7Q5hAU == null) {
            return false;
        }
        long packedValue = offsetM825convertToContainerCoordinatesQ7Q5hAU.getPackedValue();
        long packedValue2 = isStartHandle ? newPosition.getPackedValue() : packedValue;
        if (!isStartHandle) {
            packedValue = newPosition.getPackedValue();
        }
        return m838updateSelection3R_tFg$foundation_release(packedValue2, packedValue, previousPosition, isStartHandle, adjustment);
    }

    /* JADX INFO: renamed from: updateSelection-3R_-tFg$foundation_release, reason: not valid java name */
    public final boolean m838updateSelection3R_tFg$foundation_release(long startHandlePosition, long endHandlePosition, Offset previousHandlePosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        Intrinsics.checkNotNullParameter(adjustment, "adjustment");
        setDraggingHandle(isStartHandle ? Handle.SelectionStart : Handle.SelectionEnd);
        m826setCurrentDragPosition_kEHs6E(isStartHandle ? Offset.m1384boximpl(startHandlePosition) : Offset.m1384boximpl(endHandlePosition));
        LinkedHashMap linkedHashMap = new LinkedHashMap();
        List<Selectable> listSort = this.selectionRegistrar.sort(requireContainerCoordinates$foundation_release());
        int size = listSort.size();
        Selection selectionMerge = null;
        ...
        while (i < size) {
            ...
            Pair<Selection, Boolean> pairMo788updateSelectionqCDeeow = selectable.mo788updateSelectionqCDeeow(startHandlePosition, endHandlePosition, previousHandlePosition, isStartHandle, requireContainerCoordinates$foundation_release(), adjustment, this.selectionRegistrar.getSubselections().get(Long.valueOf(selectable.getSelectableId())));
            Selection selectionComponent1 = pairMo788updateSelectionqCDeeow.component1();
            z = z || pairMo788updateSelectionqCDeeow.component2().booleanValue();
    ...
    public final void m832contextMenuOpenAdjustmentk4lQ0M(long position) {
        Selection selection = getSelection();
        if (selection != null ? TextRange.m3483getCollapsedimpl(selection.m795toTextRanged9O1mEE()) : true) {
            m831startSelection9KIMszo(position, true, SelectionAdjustment.INSTANCE.getWord());
        }
    }
}
