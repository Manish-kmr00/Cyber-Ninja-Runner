...
public final class HandlePositionProvider implements PopupPositionProvider {
    ...
    public long mo785calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        ...
        if (i == 1) {
            return IntOffsetKt.IntOffset(anchorBounds.getLeft() + IntOffset.m3961getXimpl(this.offset), anchorBounds.getTop() + IntOffset.m3962getYimpl(this.offset));
        }
        if (i == 2) {
            return IntOffsetKt.IntOffset((anchorBounds.getLeft() + IntOffset.m3961getXimpl(this.offset)) - IntSize.m4003getWidthimpl(popupContentSize), anchorBounds.getTop() + IntOffset.m3962getYimpl(this.offset));
        }
        if (i == 3) {
            return IntOffsetKt.IntOffset((anchorBounds.getLeft() + IntOffset.m3961getXimpl(this.offset)) - (IntSize.m4003getWidthimpl(popupContentSize) / 2), anchorBounds.getTop() + IntOffset.m3962getYimpl(this.offset));
        }
