...
public final class SelectionManagerKt {
    ...
    private static final long calculateSelectionMagnifierCenterAndroid_O0kMr_c$getMagnifierCenter(SelectionManager selectionManager, long j, Selection.AnchorInfo anchorInfo, boolean z) {
        ...
        if (anchorSelectable$foundation_release != null && (containerLayoutCoordinates = selectionManager.getContainerLayoutCoordinates()) != null && (layoutCoordinates = anchorSelectable$foundation_release.getLayoutCoordinates()) != null) {
            ...
            Offset offsetM833getCurrentDragPosition_m7T9E = selectionManager.m833getCurrentDragPosition_m7T9E();
            Intrinsics.checkNotNull(offsetM833getCurrentDragPosition_m7T9E);
            float fM1395getXimpl = Offset.m1395getXimpl(layoutCoordinates.mo3127localPositionOfR5De75A(containerLayoutCoordinates, offsetM833getCurrentDragPosition_m7T9E.getPackedValue()));
            long jMo787getRangeOfLineContainingjx7JFs = anchorSelectable$foundation_release.mo787getRangeOfLineContainingjx7JFs(offset);
            Rect boundingBox = anchorSelectable$foundation_release.getBoundingBox(TextRange.m3487getMinimpl(jMo787getRangeOfLineContainingjx7JFs));
            Rect boundingBox2 = anchorSelectable$foundation_release.getBoundingBox(RangesKt.coerceAtLeast(TextRange.m3486getMaximpl(jMo787getRangeOfLineContainingjx7JFs) - 1, TextRange.m3487getMinimpl(jMo787getRangeOfLineContainingjx7JFs)));
            float fCoerceIn = RangesKt.coerceIn(fM1395getXimpl, Math.min(boundingBox.getLeft(), boundingBox2.getLeft()), Math.max(boundingBox.getRight(), boundingBox2.getRight()));
            if (Math.abs(fM1395getXimpl - fCoerceIn) > IntSize.m4003getWidthimpl(j) / 2) {
                return Offset.INSTANCE.m1410getUnspecifiedF1C5BW0();
            }
            return containerLayoutCoordinates.mo3127localPositionOfR5De75A(layoutCoordinates, OffsetKt.Offset(fCoerceIn, Offset.m1396getYimpl(anchorSelectable$foundation_release.getBoundingBox(offset).m1425getCenterF1C5BW0())));
        }
        return Offset.INSTANCE.m1410getUnspecifiedF1C5BW0();
    }

    /* JADX INFO: renamed from: calculateSelectionMagnifierCenterAndroid-O0kMr_c, reason: not valid java name */
    public static final long m844calculateSelectionMagnifierCenterAndroidO0kMr_c(SelectionManager manager, long j) {
    ...
    public static final Rect visibleBounds(LayoutCoordinates layoutCoordinates) {
        ...
        return RectKt.m1433Rect0a9Yr6o(layoutCoordinates.mo3130windowToLocalMKHz9U(rectBoundsInWindow.m1430getTopLeftF1C5BW0()), layoutCoordinates.mo3130windowToLocalMKHz9U(rectBoundsInWindow.m1424getBottomRightF1C5BW0()));
    }

    /* JADX INFO: renamed from: containsInclusive-Uv8p0NA, reason: not valid java name */
    public static final boolean m845containsInclusiveUv8p0NA(Rect containsInclusive, long j) {
