...
public final class SelectionHandlesKt {
    ...
    public static final long m808getAdjustedCoordinatesk4lQ0M(long j) {
        return OffsetKt.Offset(Offset.m1395getXimpl(j), Offset.m1396getYimpl(j) - 1.0f);
    }

    static {
        float f = 25;
        HandleWidth = Dp.m3843constructorimpl(f);
        HandleHeight = Dp.m3843constructorimpl(f);
    }
}
