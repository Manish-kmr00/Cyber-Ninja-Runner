...
public final class KeyEventHelpers_androidKt {
    ...
    public static final boolean m698cancelsTextSelectionZmokQxo(KeyEvent cancelsTextSelection) {
        Intrinsics.checkNotNullParameter(cancelsTextSelection, "$this$cancelsTextSelection");
        return cancelsTextSelection.getKeyCode() == 4 && KeyEventType.m2858equalsimpl0(KeyEvent_androidKt.m2866getTypeZmokQxo(cancelsTextSelection), KeyEventType.INSTANCE.m2863getKeyUpCS__XNY());
    }
}
