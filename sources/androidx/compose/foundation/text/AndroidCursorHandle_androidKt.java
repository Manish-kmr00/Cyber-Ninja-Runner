...
public final class AndroidCursorHandle_androidKt {
    ...
    public static final void m676CursorHandleULxng0E(final long j, final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        final int i2;
        Intrinsics.checkNotNullParameter(modifier, "modifier");
        Composer composerStartRestartGroup = composer.startRestartGroup(-5185995);
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(CursorHandle)P(1:c#ui.geometry.Offset,2)43@1674L256:AndroidCursorHandle.android.kt#423gt5");
        if ((i & 14) == 0) {
        ...
        if ((i2 & 731) != 146 || !composerStartRestartGroup.getSkipping()) {
            AndroidSelectionHandles_androidKt.m780HandlePopupULxng0E(j, HandleReferencePoint.TopMiddle, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1458480226, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$CursorHandle$1
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$CursorHandle$2
            ...
            public final void invoke(Composer composer2, int i3) {
                AndroidCursorHandle_androidKt.m676CursorHandleULxng0E(j, modifier, function2, composer2, i | 1);
            }
        });
    }
    ...
    public static final void DefaultCursorHandle(final Modifier modifier, Composer composer, final int i) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(DefaultCursorHandle)58@2028L79:AndroidCursorHandle.android.kt#423gt5");
        if ((i & 14) == 0) {
        ...
        if ((i2 & 11) != 2 || !composerStartRestartGroup.getSkipping()) {
            SpacerKt.Spacer(drawCursorHandle(SizeKt.m466sizeVpY3zN4(modifier, CursorHandleWidth, CursorHandleHeight)), composerStartRestartGroup, 0);
        } else {
            composerStartRestartGroup.skipToGroupEnd();
        }
        ScopeUpdateScope scopeUpdateScopeEndRestartGroup = composerStartRestartGroup.endRestartGroup();
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt.DefaultCursorHandle.1
            ...
            public final void invoke(Composer composer2, int i3) {
                AndroidCursorHandle_androidKt.DefaultCursorHandle(modifier, composer2, i | 1);
            }
        });
    }
    ...
    public static final Modifier drawCursorHandle(Modifier modifier) {
        ...
        return ComposedModifierKt.composed$default(modifier, null, new Function3<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt.drawCursorHandle.1
            ...
            public final Modifier invoke(Modifier composed, Composer composer, int i) {
                ...
                Modifier modifierThen = composed.then(DrawModifierKt.drawWithCache(Modifier.INSTANCE, new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt.drawCursorHandle.1.1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    }
                    ...
                    public final DrawResult invoke(CacheDrawScope drawWithCache) {
                        ...
                        final float fM1464getWidthimpl = Size.m1464getWidthimpl(drawWithCache.m1318getSizeNHjbRc()) / 2.0f;
                        final ImageBitmap imageBitmapCreateHandleImage = AndroidSelectionHandles_androidKt.createHandleImage(drawWithCache, fM1464getWidthimpl);
                        ...
                        return drawWithCache.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt.drawCursorHandle.1.1.1
                            ...
                            public final void invoke2(ContentDrawScope onDrawWithContent) {
                                ...
                                transform.mo2056rotateUv8p0NA(45.0f, Offset.INSTANCE.m1411getZeroF1C5BW0());
    ...
    static {
        float fM3843constructorimpl = Dp.m3843constructorimpl(25);
        CursorHandleHeight = fM3843constructorimpl;
        CursorHandleWidth = Dp.m3843constructorimpl(Dp.m3843constructorimpl(fM3843constructorimpl * 2.0f) / 2.4142137f);
    }
}
