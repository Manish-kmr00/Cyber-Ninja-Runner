...
final class ExcludeFromSystemGestureModifier implements OnGloballyPositionedModifier {
    ...
    public void onGloballyPositioned(LayoutCoordinates coordinates) {
        ...
        if (function1 == null) {
            rectCalcBounds = RectHelper_androidKt.toAndroidRect(LayoutCoordinatesKt.boundsInRoot(coordinates));
        } else {
    ...
    private final android.graphics.Rect calcBounds(LayoutCoordinates layoutCoordinates, Rect rect) {
        ...
        long jMo3127localPositionOfR5De75A = layoutCoordinatesFindRoot.mo3127localPositionOfR5De75A(layoutCoordinates, rect.m1430getTopLeftF1C5BW0());
        long jMo3127localPositionOfR5De75A2 = layoutCoordinatesFindRoot.mo3127localPositionOfR5De75A(layoutCoordinates, rect.m1431getTopRightF1C5BW0());
        long jMo3127localPositionOfR5De75A3 = layoutCoordinatesFindRoot.mo3127localPositionOfR5De75A(layoutCoordinates, rect.m1423getBottomLeftF1C5BW0());
        long jMo3127localPositionOfR5De75A4 = layoutCoordinatesFindRoot.mo3127localPositionOfR5De75A(layoutCoordinates, rect.m1424getBottomRightF1C5BW0());
        return new android.graphics.Rect(MathKt.roundToInt(ComparisonsKt.minOf(Offset.m1395getXimpl(jMo3127localPositionOfR5De75A), Offset.m1395getXimpl(jMo3127localPositionOfR5De75A2), Offset.m1395getXimpl(jMo3127localPositionOfR5De75A3), Offset.m1395getXimpl(jMo3127localPositionOfR5De75A4))), MathKt.roundToInt(ComparisonsKt.minOf(Offset.m1396getYimpl(jMo3127localPositionOfR5De75A), Offset.m1396getYimpl(jMo3127localPositionOfR5De75A2), Offset.m1396getYimpl(jMo3127localPositionOfR5De75A3), Offset.m1396getYimpl(jMo3127localPositionOfR5De75A4))), MathKt.roundToInt(ComparisonsKt.maxOf(Offset.m1395getXimpl(jMo3127localPositionOfR5De75A), Offset.m1395getXimpl(jMo3127localPositionOfR5De75A2), Offset.m1395getXimpl(jMo3127localPositionOfR5De75A3), Offset.m1395getXimpl(jMo3127localPositionOfR5De75A4))), MathKt.roundToInt(ComparisonsKt.maxOf(Offset.m1396getYimpl(jMo3127localPositionOfR5De75A), Offset.m1396getYimpl(jMo3127localPositionOfR5De75A2), Offset.m1396getYimpl(jMo3127localPositionOfR5De75A3), Offset.m1396getYimpl(jMo3127localPositionOfR5De75A4))));
    }
