...
final class PressGestureScopeImpl implements PressGestureScope, Density {
    ...
    @DebugMetadata(c = "androidx.compose.foundation.gestures.PressGestureScopeImpl", f = "TapGestureDetector.kt", i = {}, l = {320}, m = "awaitRelease", n = {}, s = {})
    ...
    public Object tryAwaitRelease(Continuation<? super Boolean> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            if (!this.isReleased && !this.isCanceled) {
                ...
                c09751.L$0 = this;
                c09751.label = 1;
                if (Mutex.DefaultImpls.lock$default(mutex, null, c09751, 1, null) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
            ...
            pressGestureScopeImpl = (PressGestureScopeImpl) c09751.L$0;
            ResultKt.throwOnFailure(obj);
        }
