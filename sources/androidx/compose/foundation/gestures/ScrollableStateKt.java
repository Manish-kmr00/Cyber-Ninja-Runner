...
public final class ScrollableStateKt {
    ...
    public static final ScrollableState rememberScrollableState(Function1<? super Float, Float> consumeScrollDelta, Composer composer, int i) {
        ...
        ComposerKt.sourceInformation(composer, "C(rememberScrollableState)116@5523L40,117@5575L61:ScrollableState.kt#8bwon0");
        final State stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(consumeScrollDelta, composer, i & 14);
