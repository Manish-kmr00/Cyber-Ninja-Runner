...
final class ScrollDraggableState implements PointerAwareDraggableState, PointerAwareDragScope {
    ...
    public void mo286dragByUv8p0NA(float pixels, long pointerPosition) {
        ...
        value.m325dispatchScrollf0eR0lY(this.latestScrollScope, value.m331toOffsettuRUvjQ(pixels), Offset.m1384boximpl(pointerPosition), NestedScrollSource.INSTANCE.m2898getDragWNlRxjI());
    }
    ...
    public void dispatchRawDelta(float delta) {
        ScrollingLogic value = this.scrollLogic.getValue();
        value.m327performRawScrollMKHz9U(value.m331toOffsettuRUvjQ(delta));
    }
}
