...
final class ScrollingLogic$doFlingAnimation$2 extends SuspendLambda implements Function2<ScrollScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            final Function1<Offset, Offset> function1 = new Function1<Offset, Offset>() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2$outerScopeScroll$1
                ...
                public /* bridge */ /* synthetic */ Offset invoke(Offset offset) {
                    return Offset.m1384boximpl(m334invokeMKHz9U(offset.getPackedValue()));
                }

                /* JADX INFO: renamed from: invoke-MK-Hz9U, reason: not valid java name */
                public final long m334invokeMKHz9U(long j2) {
                    ScrollingLogic scrollingLogic4 = scrollingLogic3;
                    return Offset.m1399minusMKHz9U(j2, scrollingLogic3.m328reverseIfNeededMKHz9U(scrollingLogic4.m325dispatchScrollf0eR0lY(scrollScope, scrollingLogic4.m328reverseIfNeededMKHz9U(j2), null, NestedScrollSource.INSTANCE.m2899getFlingWNlRxjI())));
                }
            };
            ...
            ScrollScope scrollScope2 = new ScrollScope() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2$scope$1
                ...
                public float scrollBy(float pixels) {
                    ...
                    return scrollingLogic5.m330toFloatk4lQ0M(function1.invoke(Offset.m1384boximpl(scrollingLogic5.m331toOffsettuRUvjQ(pixels))).getPackedValue());
                }
            };
            ...
            float fReverseIfNeeded = scrollingLogic.reverseIfNeeded(scrollingLogic.m329toFloatTH1AsA0(j2));
        ...
        longRef.element = scrollingLogic.m333updateQWom1Mo(j, scrollingLogic2.reverseIfNeeded(((Number) obj).floatValue()));
