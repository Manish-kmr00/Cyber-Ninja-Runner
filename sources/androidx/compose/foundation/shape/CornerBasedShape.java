...
public abstract class CornerBasedShape implements Shape {
    ...
    public abstract Outline mo656createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection);
    ...
    public final Outline mo211createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Intrinsics.checkNotNullParameter(density, "density");
        float fMo664toPxTmRCtEA = this.topStart.mo664toPxTmRCtEA(size, density);
        float fMo664toPxTmRCtEA2 = this.topEnd.mo664toPxTmRCtEA(size, density);
        float fMo664toPxTmRCtEA3 = this.bottomEnd.mo664toPxTmRCtEA(size, density);
        float fMo664toPxTmRCtEA4 = this.bottomStart.mo664toPxTmRCtEA(size, density);
        float fM1463getMinDimensionimpl = Size.m1463getMinDimensionimpl(size);
        float f = fMo664toPxTmRCtEA + fMo664toPxTmRCtEA4;
        if (f > fM1463getMinDimensionimpl) {
            float f2 = fM1463getMinDimensionimpl / f;
            fMo664toPxTmRCtEA *= f2;
            fMo664toPxTmRCtEA4 *= f2;
        }
        float f3 = fMo664toPxTmRCtEA4;
        float f4 = fMo664toPxTmRCtEA2 + fMo664toPxTmRCtEA3;
        if (f4 > fM1463getMinDimensionimpl) {
            float f5 = fM1463getMinDimensionimpl / f4;
            fMo664toPxTmRCtEA2 *= f5;
            fMo664toPxTmRCtEA3 *= f5;
        }
        if (fMo664toPxTmRCtEA < 0.0f || fMo664toPxTmRCtEA2 < 0.0f || fMo664toPxTmRCtEA3 < 0.0f || f3 < 0.0f) {
            throw new IllegalArgumentException(("Corner size in Px can't be negative(topStart = " + fMo664toPxTmRCtEA + ", topEnd = " + fMo664toPxTmRCtEA2 + ", bottomEnd = " + fMo664toPxTmRCtEA3 + ", bottomStart = " + f3 + ")!").toString());
        }
        return mo656createOutlineLjSzlW0(size, fMo664toPxTmRCtEA, fMo664toPxTmRCtEA2, fMo664toPxTmRCtEA3, f3, layoutDirection);
    }
