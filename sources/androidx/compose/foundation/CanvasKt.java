...
public final class CanvasKt {
    public static final void Canvas(final Modifier modifier, final Function1<? super DrawScope, Unit> onDraw, Composer composer, final int i) {
        ...
        if ((i & 112) == 0) {
            i2 |= composerStartRestartGroup.changed(onDraw) ? 32 : 16;
        }
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.CanvasKt.Canvas.1
            ...
            public final void invoke(Composer composer2, int i3) {
                CanvasKt.Canvas(modifier, onDraw, composer2, i | 1);
            }
        });
    }
    ...
    public static final void Canvas(final Modifier modifier, final String contentDescription, final Function1<? super DrawScope, Unit> onDraw, Composer composer, final int i) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(Canvas)P(1)64@3203L48,64@3158L94:Canvas.kt#71ulvw");
        if ((i & 14) == 0) {
            i2 = (composerStartRestartGroup.changed(modifier) ? 4 : 2) | i;
        } else {
            i2 = i;
        ...
        if ((i & 896) == 0) {
            i2 |= composerStartRestartGroup.changed(onDraw) ? 256 : 128;
        }
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.CanvasKt.Canvas.3
            ...
            public final void invoke(Composer composer2, int i3) {
                CanvasKt.Canvas(modifier, contentDescription, onDraw, composer2, i | 1);
            }
        });
    }
}
