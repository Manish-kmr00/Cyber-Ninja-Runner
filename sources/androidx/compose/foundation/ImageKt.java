...
public final class ImageKt {
    ...
    public static final /* synthetic */ void Image(ImageBitmap bitmap, String str, Modifier modifier, Alignment alignment, ContentScale contentScale, float f, ColorFilter colorFilter, Composer composer, int i, int i2) {
        ...
        m222Image5hnEew(bitmap, str, (i2 & 4) != 0 ? Modifier.INSTANCE : modifier, (i2 & 8) != 0 ? Alignment.INSTANCE.getCenter() : alignment, (i2 & 16) != 0 ? ContentScale.INSTANCE.getFit() : contentScale, (i2 & 32) != 0 ? 1.0f : f, (i2 & 64) != 0 ? null : colorFilter, FilterQuality.INSTANCE.m1717getLowfv9h1I(), composer, (i & 112) | 8 | (i & 896) | (i & 7168) | (57344 & i) | (458752 & i) | (i & 3670016), 0);
        composer.endReplaceableGroup();
    }

    /* JADX INFO: renamed from: Image-5h-nEew, reason: not valid java name */
    public static final void m222Image5hnEew(ImageBitmap bitmap, String str, Modifier modifier, Alignment alignment, ContentScale contentScale, float f, ColorFilter colorFilter, int i, Composer composer, int i2, int i3) {
        Intrinsics.checkNotNullParameter(bitmap, "bitmap");
        ...
        int iM2127getDefaultFilterQualityfv9h1I = (i3 & 128) != 0 ? DrawScope.INSTANCE.m2127getDefaultFilterQualityfv9h1I() : i;
        composer.startReplaceableGroup(1157296644);
        ComposerKt.sourceInformation(composer, "C(remember)P(1):Composables.kt#9igjgp");
        boolean zChanged = composer.changed(bitmap);
        Object objRememberedValue = composer.rememberedValue();
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = BitmapPainterKt.m2197BitmapPainterQZhYCtY$default(bitmap, 0L, 0L, iM2127getDefaultFilterQualityfv9h1I, 6, null);
    ...
    public static final void Image(final Painter painter, final String str, Modifier modifier, Alignment alignment, ContentScale contentScale, float f, ColorFilter colorFilter, Composer composer, final int i, final int i2) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(Image)P(6,3,5!1,4)255@11931L341:Image.kt#71ulvw");
        ...
        composerStartRestartGroup.endReplaceableGroup();
        Modifier modifierPaint$default = PainterModifierKt.paint$default(ClipKt.clipToBounds(modifier2.then(companionSemantics$default)), painter, false, center, fit, f2, colorFilter2, 2, null);
        AnonymousClass2 anonymousClass2 = new MeasurePolicy() { // from class: androidx.compose.foundation.ImageKt.Image.2
            ...
            public final MeasureResult mo18measure3p2s80s(MeasureScope Layout, List<? extends Measurable> list, long j) {
                ...
                return MeasureScope.layout$default(Layout, Constraints.m3801getMinWidthimpl(j), Constraints.m3800getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.ImageKt$Image$2$measure$1
                    /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C:Image.kt#71ulvw");
        composerStartRestartGroup.endReplaceableGroup();
        composerStartRestartGroup.endReplaceableGroup();
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.ImageKt.Image.3
            ...
            public final void invoke(Composer composer2, int i3) {
                ImageKt.Image(painter, str, modifier3, alignment2, contentScale2, f3, colorFilter3, composer2, i | 1, i2);
            }
        });
    }
}
