...
final class BringIntoViewRequesterModifier extends BringIntoViewChildModifier {
    ...
    public final Object bringIntoView(Rect rect, Continuation<? super Unit> continuation) {
        ...
        if (rect == null) {
            rect = SizeKt.m1485toRectuvyYCjk(IntSizeKt.m4013toSizeozmzZPI(layoutCoordinates.mo3126getSizeYbymL2g()));
        }
        Object objBringChildIntoView = getParent().bringChildIntoView(rect, layoutCoordinates, continuation);
