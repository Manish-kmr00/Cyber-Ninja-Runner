...
public final class LazyListItemProviderImplKt {
    ...
    public static final LazyListItemProvider rememberItemProvider(LazyListState state, Function1<? super LazyListScope, Unit> content, Composer composer, int i) {
        ...
        if (zChanged2 || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
            objRememberedValue2 = new LazyListItemProviderImpl(SnapshotStateKt.derivedStateOf(new Function0<LazyListItemsSnapshot>() { // from class: androidx.compose.foundation.lazy.LazyListItemProviderImplKt$rememberItemProvider$2$1
        ...
        composer.endReplaceableGroup();
        composer.endReplaceableGroup();
        return (LazyListItemProviderImpl) objRememberedValue2;
    }
    ...
    public static final Map<Object, Integer> generateKeyToIndexMap(IntRange range, IntervalList<LazyListIntervalContent> list) {
        ...
        list.forEach(first, iMin, new Function1<IntervalList.Interval<LazyListIntervalContent>, Unit>() { // from class: androidx.compose.foundation.lazy.LazyListItemProviderImplKt$generateKeyToIndexMap$1$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
    ...
    /* JADX INFO: renamed from: androidx.compose.foundation.lazy.LazyListItemProviderImplKt$rememberItemProvider$1, reason: invalid class name */
    /* JADX INFO: compiled from: LazyListItemProviderImpl.kt */
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass1(LazyListState lazyListState, MutableState<IntRange> mutableState, Continuation<? super AnonymousClass1> continuation) {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i == 0) {
                ...
                Flow flowSnapshotFlow = SnapshotStateKt.snapshotFlow(new Function0<IntRange>() { // from class: androidx.compose.foundation.lazy.LazyListItemProviderImplKt.rememberItemProvider.1.1
                    {
                        super(0);
                    }
                    ...
                    public final IntRange invoke() {
                        return LazyListItemProviderImplKt.calculateNearestItemsRange(lazyListState.getFirstVisibleItemIndex());
                    }
                });
                final MutableState<IntRange> mutableState = this.$nearestItemsRangeState;
                this.label = 1;
                if (flowSnapshotFlow.collect(new FlowCollector<IntRange>() { // from class: androidx.compose.foundation.lazy.LazyListItemProviderImplKt.rememberItemProvider.1.2
