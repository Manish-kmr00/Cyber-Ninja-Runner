...
public final class LazyMeasuredItemProvider {
    ...
    private LazyMeasuredItemProvider(long j, boolean z, LazyListItemProvider lazyListItemProvider, LazyLayoutMeasureScope lazyLayoutMeasureScope, MeasuredItemFactory measuredItemFactory) {
        ...
        this.childConstraints = ConstraintsKt.Constraints$default(0, z ? Constraints.m3799getMaxWidthimpl(j) : Integer.MAX_VALUE, 0, z ? Integer.MAX_VALUE : Constraints.m3798getMaxHeightimpl(j), 5, null);
    }
    ...
    public final LazyMeasuredItem m553getAndMeasureZjPyQlc(int index) {
        return this.measuredItemFactory.mo539createItemHK0c1C0(index, this.itemProvider.getKey(index), this.measureScope.mo635measure0kLqBqw(index, this.childConstraints));
    }
