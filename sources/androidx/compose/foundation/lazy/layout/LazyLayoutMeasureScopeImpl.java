...
public final class LazyLayoutMeasureScopeImpl implements LazyLayoutMeasureScope, MeasureScope {
    ...
    public int mo311roundToPxR2X_6o(long j) {
        return this.subcomposeMeasureScope.mo311roundToPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* JADX INFO: renamed from: roundToPx-0680j_4 */
    public int mo312roundToPx0680j_4(float f) {
        return this.subcomposeMeasureScope.mo312roundToPx0680j_4(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* JADX INFO: renamed from: toPx--R2X_6o */
    public float mo317toPxR2X_6o(long j) {
        return this.subcomposeMeasureScope.mo317toPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* JADX INFO: renamed from: toPx-0680j_4 */
    public float mo318toPx0680j_4(float f) {
        return this.subcomposeMeasureScope.mo318toPx0680j_4(f);
    }
    ...
    public Placeable[] mo635measure0kLqBqw(int index, long constraints) {
        ...
        for (int i = 0; i < size; i++) {
            placeableArr2[i] = listSubcompose.get(i).mo3124measureBRTryo0(constraints);
        }
    ...
    public float mo313toDpGaN1DYA(long j) {
        return this.subcomposeMeasureScope.mo313toDpGaN1DYA(j);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* JADX INFO: renamed from: toDp-u2uoSUM */
    public float mo315toDpu2uoSUM(int i) {
        return this.subcomposeMeasureScope.mo315toDpu2uoSUM(i);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* JADX INFO: renamed from: toDp-u2uoSUM */
    public float mo314toDpu2uoSUM(float f) {
        return this.subcomposeMeasureScope.mo314toDpu2uoSUM(f);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* JADX INFO: renamed from: toSp-kPz2Gy4 */
    public long mo321toSpkPz2Gy4(float f) {
        return this.subcomposeMeasureScope.mo321toSpkPz2Gy4(f);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* JADX INFO: renamed from: toSp-kPz2Gy4 */
    public long mo322toSpkPz2Gy4(int i) {
        return this.subcomposeMeasureScope.mo322toSpkPz2Gy4(i);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* JADX INFO: renamed from: toSp-0xMU5do */
    public long mo320toSp0xMU5do(float f) {
        return this.subcomposeMeasureScope.mo320toSp0xMU5do(f);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* JADX INFO: renamed from: toSize-XkaWNTQ */
    public long mo319toSizeXkaWNTQ(long j) {
        return this.subcomposeMeasureScope.mo319toSizeXkaWNTQ(j);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* JADX INFO: renamed from: toDpSize-k-rfVVM */
    public long mo316toDpSizekrfVVM(long j) {
        return this.subcomposeMeasureScope.mo316toDpSizekrfVVM(j);
    }
}
