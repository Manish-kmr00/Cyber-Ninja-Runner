...
public final class LazyLayoutPrefetcher implements RememberObserver, LazyLayoutPrefetchState.Prefetcher, Runnable, Choreographer.FrameCallback {
                ...
                if (index >= 0 && index < itemCount) {
                    if (prefetchRequest.getPrecomposeHandle() != null) {
                        ...
                        try {
                            ...
                            if (enoughTimeLeft(jNanoTime, nanos, this.averagePremeasureTimeNs)) {
                                ...
                                for (int i = 0; i < placeablesCount; i++) {
                                    precomposeHandle.mo3133premeasure0kLqBqw(i, prefetchRequest.getConstraints());
                                }
                        ...
                        try {
                            ...
                            if (enoughTimeLeft(jNanoTime2, nanos, this.averagePrecomposeTimeNs)) {
    ...
    public LazyLayoutPrefetchState.PrefetchHandle mo637schedulePrefetch0kLqBqw(int index, long constraints) {
