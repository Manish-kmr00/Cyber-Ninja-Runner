...
public final class LazyListPositionedItem implements LazyListItemInfo {
    ...
    public final long m544getOffsetBjo55l4(int index) {
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        for (int i = 0; i < placeablesCount; i++) {
            ...
            if (getAnimationSpec(i) != null) {
                jM544getOffsetBjo55l4 = this.placementAnimator.m537getAnimatedOffsetYT5a7pE(getKey(), i, mainAxisSize, i2, m544getOffsetBjo55l4(i));
            } else {
                jM544getOffsetBjo55l4 = m544getOffsetBjo55l4(i);
            }
            if (this.isVertical) {
                long j = this.visualOffset;
                Placeable.PlacementScope.m3169placeWithLayeraW9wM$default(scope, placeable, IntOffsetKt.IntOffset(IntOffset.m3961getXimpl(jM544getOffsetBjo55l4) + IntOffset.m3961getXimpl(j), IntOffset.m3962getYimpl(jM544getOffsetBjo55l4) + IntOffset.m3962getYimpl(j)), 0.0f, null, 6, null);
            } else {
                long j2 = this.visualOffset;
                Placeable.PlacementScope.m3168placeRelativeWithLayeraW9wM$default(scope, placeable, IntOffsetKt.IntOffset(IntOffset.m3961getXimpl(jM544getOffsetBjo55l4) + IntOffset.m3961getXimpl(j2), IntOffset.m3962getYimpl(jM544getOffsetBjo55l4) + IntOffset.m3962getYimpl(j2)), 0.0f, null, 6, null);
            }
        }
    }
