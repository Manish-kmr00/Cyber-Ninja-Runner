...
public final class LazyListState implements ScrollableState {
    ...
    public LazyListState(int i, int i2) {
        ...
        this.premeasureConstraints = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Constraints.m3787boximpl(ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null)), null, 2, null);
    ...
    public final int getFirstVisibleItemIndex() {
        return this.scrollPosition.m546getIndexjQJCoq8();
    }
    ...
    public final long m551getPremeasureConstraintsmsEJaDk$foundation_release() {
    ...
    public final void m552setPremeasureConstraintsBRTryo0$foundation_release(long j) {
        this.premeasureConstraints.setValue(Constraints.m3787boximpl(j));
    }
    ...
    public final void snapToItemIndexInternal$foundation_release(int index, int scrollOffset) {
        this.scrollPosition.m547requestPositionAhXoVpI(DataIndex.m512constructorimpl(index), scrollOffset);
    ...
    private final void notifyPrefetch(float delta) {
        ...
        if (this.prefetchingEnabled) {
            ...
            this.currentPrefetchHandle = this.prefetchState.m636schedulePrefetch0kLqBqw(index, m551getPremeasureConstraintsmsEJaDk$foundation_release());
        }
    }
    ...
    public final Object animateScrollToItem(int i, int i2, Continuation<? super Unit> continuation) {
        Object objDoSmoothScrollToItem = LazyListScrollingKt.doSmoothScrollToItem(this, i, i2, continuation);
