...
final class PlaceableInfo {
    ...
    private PlaceableInfo(long j, int i) {
        this.mainAxisSize = i;
        this.animatedOffset = new Animatable<>(IntOffset.m3952boximpl(j), VectorConvertersKt.getVectorConverter(IntOffset.INSTANCE), null, 4, null);
        this.targetOffset = j;
    ...
    public final void m632setTargetOffsetgyyYBs(long j) {
        this.targetOffset = j;
    }
