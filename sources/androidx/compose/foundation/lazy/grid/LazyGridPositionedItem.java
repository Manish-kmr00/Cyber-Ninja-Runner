...
public final class LazyGridPositionedItem implements LazyGridItemInfo {
    ...
    public final int getMainAxisSizeWithSpacings() {
        return this.mainAxisSpacing + (this.isVertical ? IntSize.m4002getHeightimpl(getSize()) : IntSize.m4003getWidthimpl(getSize()));
    }
    ...
    public final int getCrossAxisSize() {
        return this.isVertical ? IntSize.m4003getWidthimpl(getSize()) : IntSize.m4002getHeightimpl(getSize());
    }

    public final int getCrossAxisOffset() {
        return this.isVertical ? IntOffset.m3961getXimpl(getOffset()) : IntOffset.m3962getYimpl(getOffset());
    }
    ...
    public final void place(Placeable.PlacementScope scope) {
        long jM592getAnimatedOffsetYT5a7pE;
        ...
        for (int i = 0; i < placeablesCount; i++) {
            ...
            if (getAnimationSpec(i) != null) {
                jM592getAnimatedOffsetYT5a7pE = this.placementAnimator.m592getAnimatedOffsetYT5a7pE(getKey(), i, mainAxisSize, i2, this.placeableOffset);
            } else {
                jM592getAnimatedOffsetYT5a7pE = this.placeableOffset;
            }
            if (m600getMainAxisgyyYBs(jM592getAnimatedOffsetYT5a7pE) > mainAxisSize && m600getMainAxisgyyYBs(jM592getAnimatedOffsetYT5a7pE) < i2) {
                if (this.isVertical) {
                    long j = this.visualOffset;
                    Placeable.PlacementScope.m3169placeWithLayeraW9wM$default(scope, placeable, IntOffsetKt.IntOffset(IntOffset.m3961getXimpl(jM592getAnimatedOffsetYT5a7pE) + IntOffset.m3961getXimpl(j), IntOffset.m3962getYimpl(jM592getAnimatedOffsetYT5a7pE) + IntOffset.m3962getYimpl(j)), 0.0f, null, 6, null);
                } else {
                    long j2 = this.visualOffset;
                    Placeable.PlacementScope.m3168placeRelativeWithLayeraW9wM$default(scope, placeable, IntOffsetKt.IntOffset(IntOffset.m3961getXimpl(jM592getAnimatedOffsetYT5a7pE) + IntOffset.m3961getXimpl(j2), IntOffset.m3962getYimpl(jM592getAnimatedOffsetYT5a7pE) + IntOffset.m3962getYimpl(j2)), 0.0f, null, 6, null);
                }
            }
        }
    }
    ...
    private final int m600getMainAxisgyyYBs(long j) {
