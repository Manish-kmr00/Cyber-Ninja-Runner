...
public final class LazySemanticsKt {
    public static final Modifier lazyGridSemantics(Modifier modifier, final LazyGridItemProvider itemProvider, final LazyGridState state, final CoroutineScope coroutineScope, final boolean z, boolean z2, boolean z3, Composer composer, int i) {
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            final Function1<Object, Integer> function3 = new Function1<Object, Integer>() { // from class: androidx.compose.foundation.lazy.grid.LazySemanticsKt$lazyGridSemantics$1$indexForKeyMapping$1
                {
                    super(1);
                }
                ...
                public final Integer invoke(Object needle) {
                    ...
                    LazySemanticsKt$lazyGridSemantics$1$indexForKeyMapping$1$key$1 lazySemanticsKt$lazyGridSemantics$1$indexForKeyMapping$1$key$1 = new LazySemanticsKt$lazyGridSemantics$1$indexForKeyMapping$1$key$1(itemProvider);
            ...
            objRememberedValue = SemanticsModifierKt.semantics$default(Modifier.INSTANCE, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.foundation.lazy.grid.LazySemanticsKt$lazyGridSemantics$1$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                ...
                public final void invoke2(SemanticsPropertyReceiver semantics) {
                    ...
                    Function1<Integer, Boolean> function5 = function1;
                    if (function5 != null) {
