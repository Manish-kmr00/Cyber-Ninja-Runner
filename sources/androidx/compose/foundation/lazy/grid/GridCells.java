...
public interface GridCells {
    ...
    public static final class Adaptive implements GridCells {
        ...
        public List<Integer> calculateCrossAxisCellSizes(Density density, int i, int i2) {
            Intrinsics.checkNotNullParameter(density, "<this>");
            return LazyGridDslKt.calculateCellsCrossAxisSizeImpl(i, Math.max((i + i2) / (density.mo312roundToPx0680j_4(this.minSize) + i2), 1), i2);
        }

        public int hashCode() {
            return Dp.m3849hashCodeimpl(this.minSize);
        }

        public boolean equals(Object other) {
            return (other instanceof Adaptive) && Dp.m3848equalsimpl0(this.minSize, ((Adaptive) other).minSize);
        }
    }
}
