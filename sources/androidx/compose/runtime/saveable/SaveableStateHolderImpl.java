...
final class SaveableStateHolderImpl implements SaveableStateHolder {
    ...
    public void SaveableStateProvider(final Object key, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(ReusableContent)P(1)145@5253L9:Composables.kt#9igjgp");
        composerStartRestartGroup.startReusableGroup(207, key);
        composerStartRestartGroup.startReplaceableGroup(-642722479);
        ComposerKt.sourceInformation(composerStartRestartGroup, "C76@3023L321,83@3357L150,87@3520L360:SaveableStateHolder.kt#r2ddri");
