...
final class DerivedSnapshotState<T> implements StateObject, DerivedState<T> {
    ...
    private static final class ResultRecord<T> extends StateRecord {
        ...
        public final int readableHash(DerivedState<?> derivedState, Snapshot snapshot) {
            ...
            if (hashSet != null) {
                ...
                PersistentList persistentList = persistentListPersistentListOf;
                int size = persistentList.size();
                int i = 0;
                for (int i2 = 0; i2 < size; i2++) {
                    ((Function1) ((Pair) persistentList.get(i2)).component1()).invoke(derivedState);
                }
                try {
                    ...
                    while (i < size2) {
                        ((Function1) ((Pair) persistentList.get(i)).component2()).invoke(derivedState);
                        i++;
                    }
                }
            }
    ...
    private final ResultRecord<T> currentRecord(ResultRecord<T> readable, Snapshot snapshot, Function0<? extends T> calculation) {
        ...
        int size = persistentList.size();
        for (int i2 = 0; i2 < size; i2++) {
            ((Function1) ((Pair) persistentList.get(i2)).component1()).invoke(derivedSnapshotState);
        }
        if (!zBooleanValue) {
            try {
                ...
                int size2 = persistentList.size();
                while (i < size2) {
                    ((Function1) ((Pair) persistentList.get(i)).component2()).invoke(derivedSnapshotState);
                    i++;
                }
                throw th;
            }
