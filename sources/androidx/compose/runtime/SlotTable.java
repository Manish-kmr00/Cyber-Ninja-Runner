...
public final class SlotTable implements CompositionData, Iterable<CompositionGroup>, KMappedMarker {
    ...
    public final void close$runtime_release(SlotReader reader) {
        ...
        if (reader.getTable() != this || (i = this.readers) <= 0) {
    ...
    public final List<RecomposeScopeImpl> invalidateGroupsWithKey$runtime_release(int target) {
        ...
        SlotReader slotReaderOpenReader = openReader();
        try {
            m1284invalidateGroupsWithKey$lambda14$scanGroup(slotReaderOpenReader, target, arrayList, booleanRef, this, arrayList2);
    ...
    private static final void m1284invalidateGroupsWithKey$lambda14$scanGroup(SlotReader slotReader, int i, List<Anchor> list, Ref.BooleanRef booleanRef, SlotTable slotTable, List<RecomposeScopeImpl> list2) {
        ...
        while (!slotReader.isGroupEnd()) {
            m1284invalidateGroupsWithKey$lambda14$scanGroup(slotReader, i, list, booleanRef, slotTable, list2);
        }
        slotReader.endGroup();
    }
