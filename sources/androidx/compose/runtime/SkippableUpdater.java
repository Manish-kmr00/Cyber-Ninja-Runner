...
public final class SkippableUpdater<T> {
    ...
    public static final /* synthetic */ SkippableUpdater m1276boximpl(Composer composer) {
        return new SkippableUpdater(composer);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static <T> Composer m1277constructorimpl(Composer composer) {
        Intrinsics.checkNotNullParameter(composer, "composer");
        return composer;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m1278equalsimpl(Composer composer, Object obj) {
        return (obj instanceof SkippableUpdater) && Intrinsics.areEqual(composer, ((SkippableUpdater) obj).getComposer());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1279equalsimpl0(Composer composer, Composer composer2) {
    ...
    public static int m1280hashCodeimpl(Composer composer) {
    ...
    public boolean equals(Object obj) {
        return m1278equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m1280hashCodeimpl(this.composer);
    }
    ...
    public static final void m1282updateimpl(Composer composer, Function1<? super Updater<T>, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        composer.startReplaceableGroup(509942095);
        block.invoke(Updater.m1285boximpl(Updater.m1286constructorimpl(composer)));
