...
public final class SlotReader {
    ...
    public final void restoreParent(int index) {
        ...
        if (i < index || i > iGroupSize) {
            throw new IllegalArgumentException(("Index " + index + " is not a parent of " + i).toString());
        }
        this.parent = index;
