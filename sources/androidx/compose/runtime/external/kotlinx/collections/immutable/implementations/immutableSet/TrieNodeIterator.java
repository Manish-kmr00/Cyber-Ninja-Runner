...
public final class TrieNodeIterator<E> {
    ...
    public final void moveToNextCell() {
        CommonFunctionsKt.m1298assert(hasNextCell());
        this.index++;
    }
    ...
    public final E currentElement() {
        CommonFunctionsKt.m1298assert(hasNextElement());
