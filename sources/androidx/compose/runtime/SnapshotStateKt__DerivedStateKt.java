...
final /* synthetic */ class SnapshotStateKt__DerivedStateKt {
    ...
    public static final <R> void observeDerivedStateRecalculations(Function1<? super State<?>, Unit> start, Function1<? super State<?>, Unit> done, Function0<? extends R> block) {
        ...
        try {
            PersistentList<Pair<Function1<DerivedState<?>, Unit>, Function1<DerivedState<?>, Unit>>> persistentListPersistentListOf = snapshotThreadLocal.get();
            if (persistentListPersistentListOf == null) {
                persistentListPersistentListOf = ExtensionsKt.persistentListOf();
            }
            snapshotThreadLocal.set(persistentListPersistentListOf.add(TuplesKt.to(start, done)));
            block.invoke();
        } finally {
