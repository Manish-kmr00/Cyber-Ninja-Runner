...
public final class GlobalSnapshot extends MutableSnapshot {
    ...
    public GlobalSnapshot(int i, SnapshotIdSet invalid) {
        ...
        Intrinsics.checkNotNullParameter(invalid, "invalid");
        synchronized (SnapshotKt.getLock()) {
            final List mutableList = !SnapshotKt.globalWriteObservers.isEmpty() ? CollectionsKt.toMutableList((Collection) SnapshotKt.globalWriteObservers) : null;
            if (mutableList != null) {
                function1 = (Function1) CollectionsKt.singleOrNull(mutableList);
                if (function1 == null) {
        ...
        super(i, invalid, null, function1);
    }
