...
public final class ComposerKt {
    ...
    public static final PersistentMap<CompositionLocal<Object>, State<Object>> compositionLocalMapOf(ProvidedValue<?>[] providedValueArr, PersistentMap<CompositionLocal<Object>, ? extends State<? extends Object>> persistentMap, Composer composer, int i) {
        ...
        sourceInformation(composer, "C(compositionLocalMapOf)P(1)*317@11596L24:Composer.kt#9igjgp");
    ...
    public static final List<Object> collectNodesFrom(SlotTable slotTable, Anchor anchor) {
        ...
        try {
            m1275collectNodesFrom$lambda10$collectFromGroup(slotReaderOpenReader, arrayList, slotTable.anchorIndex(anchor));
            Unit unit = Unit.INSTANCE;
            return arrayList;
        } finally {
    ...
    private static final void m1275collectNodesFrom$lambda10$collectFromGroup(SlotReader slotReader, List<Object> list, int i) {
        ...
        while (iGroupSize < iGroupSize2) {
            m1275collectNodesFrom$lambda10$collectFromGroup(slotReader, list, iGroupSize);
