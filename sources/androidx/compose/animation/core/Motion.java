...
public final class Motion {
    ...
    public static final /* synthetic */ Motion m117boximpl(long j) {
        return new Motion(j);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static long m118constructorimpl(long j) {
        return j;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m121equalsimpl(long j, Object obj) {
        return (obj instanceof Motion) && j == ((Motion) obj).m127unboximpl();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m122equalsimpl0(long j, long j2) {
        return j == j2;
    }
    ...
    public boolean equals(Object obj) {
        return m121equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m125hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m126toStringimpl(this.packedValue);
    }
    ...
    public static final long m119copyXB9eQnU(long j, float f, float f2) {
        return SpringSimulationKt.Motion(f, f2);
    }

    /* JADX INFO: renamed from: copy-XB9eQnU$default, reason: not valid java name */
    public static /* synthetic */ long m120copyXB9eQnU$default(long j, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = m123getValueimpl(j);
        }
        if ((i & 2) != 0) {
            f2 = m124getVelocityimpl(j);
        }
        return m119copyXB9eQnU(j, f, f2);
    }

    /* JADX INFO: renamed from: getValue-impl, reason: not valid java name */
    public static final float m123getValueimpl(long j) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
        return Float.intBitsToFloat((int) (j >> 32));
    }

    /* JADX INFO: renamed from: getVelocity-impl, reason: not valid java name */
    public static final float m124getVelocityimpl(long j) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
