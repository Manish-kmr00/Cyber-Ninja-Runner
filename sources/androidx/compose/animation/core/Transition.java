...
public final class Transition<S> {
    ...
    public final void animateTo$animation_core_release(final S s, Composer composer, final int i) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(animateTo)426@16592L25,430@16862L655,430@16841L676:Transition.kt#pdpnli");
        if ((i & 14) == 0) {
            i2 = (composerStartRestartGroup.changed(s) ? 4 : 2) | i;
        } else {
            i2 = i;
        ...
        if ((i2 & 91) != 18 || !composerStartRestartGroup.getSkipping()) {
            if (!isSeeking()) {
                ...
                if (!Intrinsics.areEqual(s, getCurrentState()) || isRunning() || getUpdateChildrenNeeded$animation_core_release()) {
                    ...
                    EffectsKt.LaunchedEffect(this, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) transition$animateTo$1$1RememberedValue, composerStartRestartGroup, i3);
                }
            }
        } else {
            composerStartRestartGroup.skipToGroupEnd();
    ...
    public final class TransitionAnimationState<T, V extends AnimationVector> implements State<T> {
        ...
        public final void onPlayTimeChanged$animation_core_release(long playTimeNanos, float durationScale) {
            ...
            this.velocityVector = (V) getAnimation().getVelocityVectorFromNanos(offsetTimeNanos);
