...
public final class EasingFunctionsKt {
    ...
    private static final Easing EaseInElastic = new Easing() { // from class: androidx.compose.animation.core.EasingFunctionsKt$EaseInElastic$1
        ...
        public final float transform(float f) {
            ...
            float f2 = f * 10.0f;
            return (float) (((double) (-((float) Math.pow(2.0f, f2 - 10.0f)))) * Math.sin(((double) (f2 - 10.75f)) * 2.0943951023931953d));
        }
    };
    ...
    private static final Easing EaseInOutElastic = new Easing() { // from class: androidx.compose.animation.core.EasingFunctionsKt$EaseInOutElastic$1
        ...
        public final float transform(float f) {
            ...
            if (0.0f <= f && f <= 0.5f) {
                double d = 2.0f;
                float f2 = f * 20.0f;
                return (float) ((-(((double) ((float) Math.pow(d, f2 - 10.0f))) * Math.sin(((double) (f2 - 11.125f)) * 1.3962634015954636d))) / d);
            }
            double d2 = 2.0f;
            return ((float) ((((double) ((float) Math.pow(d2, ((-20.0f) * f) + 10.0f))) * Math.sin(((double) ((f * 20.0f) - 11.125f)) * 1.3962634015954636d)) / d2)) + 1.0f;
        }
    };
    ...
    private static final Easing EaseInOutBounce = new Easing() { // from class: androidx.compose.animation.core.EasingFunctionsKt$EaseInOutBounce$1
        ...
        public final float transform(float f) {
            float fTransform;
            if (f < 0.5d) {
                fTransform = 1 - EasingFunctionsKt.getEaseOutBounce().transform(1.0f - (f * 2.0f));
            } else {
                fTransform = 1 + EasingFunctionsKt.getEaseOutBounce().transform((f * 2.0f) - 1.0f);
            }
