...
public final class AnimatedContentScope<S> implements Transition.Segment<S> {
    ...
    public AnimatedContentScope(Transition<S> transition, Alignment contentAlignment, LayoutDirection layoutDirection) {
        ...
        this.measuredSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m3995boximpl(IntSize.INSTANCE.m4008getZeroYbymL2g()), null, 2, null);
    ...
    public static final class SlideDirection {
        ...
        public static final /* synthetic */ SlideDirection m35boximpl(int i) {
        ...
        public static String m40toStringimpl(int i) {
            if (m38equalsimpl0(i, Left)) {
                return "Left";
            }
            if (m38equalsimpl0(i, Right)) {
                return "Right";
            }
            if (m38equalsimpl0(i, Up)) {
                return "Up";
            }
            if (m38equalsimpl0(i, Down)) {
                return "Down";
            }
            if (m38equalsimpl0(i, Start)) {
                return "Start";
            }
            return m38equalsimpl0(i, End) ? "End" : "Invalid";
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: slideIntoContainer-HTTW7Ok$default, reason: not valid java name */
    public static /* synthetic */ EnterTransition m27slideIntoContainerHTTW7Ok$default(AnimatedContentScope animatedContentScope, int i, FiniteAnimationSpec finiteAnimationSpec, Function1 function1, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            finiteAnimationSpec = AnimationSpecKt.spring$default(0.0f, 0.0f, IntOffset.m3952boximpl(VisibilityThresholdsKt.getVisibilityThreshold(IntOffset.INSTANCE)), 3, null);
        }
        if ((i2 & 4) != 0) {
        ...
        return animatedContentScope.m31slideIntoContainerHTTW7Ok(i, finiteAnimationSpec, function1);
    }

    /* JADX INFO: renamed from: slideIntoContainer-HTTW7Ok, reason: not valid java name */
    public final EnterTransition m31slideIntoContainerHTTW7Ok(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> initialOffset) {
        Intrinsics.checkNotNullParameter(animationSpec, "animationSpec");
        Intrinsics.checkNotNullParameter(initialOffset, "initialOffset");
        if (m25isLeft9jb1Dl8(towards)) {
            return EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentScope$slideIntoContainer$2
                ...
                public final Integer invoke(int i) {
                    return initialOffset.invoke(Integer.valueOf(IntSize.m4003getWidthimpl(this.m24getCurrentSizeYbymL2g()) - IntOffset.m3961getXimpl(this.m21calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), this.m24getCurrentSizeYbymL2g()))));
                }
            });
        }
        if (m26isRight9jb1Dl8(towards)) {
            return EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentScope$slideIntoContainer$3
                ...
                public final Integer invoke(int i) {
                    return initialOffset.invoke(Integer.valueOf((-IntOffset.m3961getXimpl(this.m21calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), this.m24getCurrentSizeYbymL2g()))) - i));
                }
            });
        }
        if (SlideDirection.m38equalsimpl0(towards, SlideDirection.INSTANCE.m47getUpaUPqQNE())) {
            return EnterExitTransitionKt.slideInVertically(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentScope$slideIntoContainer$4
                ...
                public final Integer invoke(int i) {
                    return initialOffset.invoke(Integer.valueOf(IntSize.m4002getHeightimpl(this.m24getCurrentSizeYbymL2g()) - IntOffset.m3962getYimpl(this.m21calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), this.m24getCurrentSizeYbymL2g()))));
                }
            });
        }
        return SlideDirection.m38equalsimpl0(towards, SlideDirection.INSTANCE.m42getDownaUPqQNE()) ? EnterExitTransitionKt.slideInVertically(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentScope$slideIntoContainer$5
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int i) {
                return initialOffset.invoke(Integer.valueOf((-IntOffset.m3962getYimpl(this.m21calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), this.m24getCurrentSizeYbymL2g()))) - i));
            }
        }) : EnterTransition.INSTANCE.getNone();
    }

    /* JADX INFO: renamed from: isLeft-9jb1Dl8, reason: not valid java name */
    private final boolean m25isLeft9jb1Dl8(int i) {
        return SlideDirection.m38equalsimpl0(i, SlideDirection.INSTANCE.m44getLeftaUPqQNE()) || (SlideDirection.m38equalsimpl0(i, SlideDirection.INSTANCE.m46getStartaUPqQNE()) && this.layoutDirection == LayoutDirection.Ltr) || (SlideDirection.m38equalsimpl0(i, SlideDirection.INSTANCE.m43getEndaUPqQNE()) && this.layoutDirection == LayoutDirection.Rtl);
    }

    /* JADX INFO: renamed from: isRight-9jb1Dl8, reason: not valid java name */
    private final boolean m26isRight9jb1Dl8(int i) {
        return SlideDirection.m38equalsimpl0(i, SlideDirection.INSTANCE.m45getRightaUPqQNE()) || (SlideDirection.m38equalsimpl0(i, SlideDirection.INSTANCE.m46getStartaUPqQNE()) && this.layoutDirection == LayoutDirection.Rtl) || (SlideDirection.m38equalsimpl0(i, SlideDirection.INSTANCE.m43getEndaUPqQNE()) && this.layoutDirection == LayoutDirection.Ltr);
    }
    ...
    public final long m21calculateOffsetemnUabE(long fullSize, long currentSize) {
        return this.contentAlignment.mo1303alignKFBX0sM(fullSize, currentSize, LayoutDirection.Ltr);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: slideOutOfContainer-HTTW7Ok$default, reason: not valid java name */
    public static /* synthetic */ ExitTransition m28slideOutOfContainerHTTW7Ok$default(AnimatedContentScope animatedContentScope, int i, FiniteAnimationSpec finiteAnimationSpec, Function1 function1, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            finiteAnimationSpec = AnimationSpecKt.spring$default(0.0f, 0.0f, IntOffset.m3952boximpl(VisibilityThresholdsKt.getVisibilityThreshold(IntOffset.INSTANCE)), 3, null);
        }
        if ((i2 & 4) != 0) {
        ...
        return animatedContentScope.m32slideOutOfContainerHTTW7Ok(i, finiteAnimationSpec, function1);
    }

    /* JADX INFO: renamed from: slideOutOfContainer-HTTW7Ok, reason: not valid java name */
    public final ExitTransition m32slideOutOfContainerHTTW7Ok(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> targetOffset) {
        Intrinsics.checkNotNullParameter(animationSpec, "animationSpec");
        ...
        if (m25isLeft9jb1Dl8(towards)) {
            return EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentScope$slideOutOfContainer$2
                ...
                public final Integer invoke(int i) {
                    ...
                    return targetOffset.invoke(Integer.valueOf((-IntOffset.m3961getXimpl(this.this$0.m21calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m4008getZeroYbymL2g()))) - i));
                }
            });
        }
        if (m26isRight9jb1Dl8(towards)) {
            return EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentScope$slideOutOfContainer$3
                ...
                public final Integer invoke(int i) {
                    State state = (State) this.this$0.getTargetSizeMap$animation_release().get(this.this$0.getTransition$animation_release().getTargetState());
                    long packedValue = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m4008getZeroYbymL2g();
                    return targetOffset.invoke(Integer.valueOf((-IntOffset.m3961getXimpl(this.this$0.m21calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), packedValue))) + IntSize.m4003getWidthimpl(packedValue)));
                }
            });
        }
        if (SlideDirection.m38equalsimpl0(towards, SlideDirection.INSTANCE.m47getUpaUPqQNE())) {
            return EnterExitTransitionKt.slideOutVertically(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentScope$slideOutOfContainer$4
                ...
                public final Integer invoke(int i) {
                    State state = (State) this.this$0.getTargetSizeMap$animation_release().get(this.this$0.getTransition$animation_release().getTargetState());
                    return targetOffset.invoke(Integer.valueOf((-IntOffset.m3962getYimpl(this.this$0.m21calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m4008getZeroYbymL2g()))) - i));
                }
            });
        }
        return SlideDirection.m38equalsimpl0(towards, SlideDirection.INSTANCE.m42getDownaUPqQNE()) ? EnterExitTransitionKt.slideOutVertically(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentScope$slideOutOfContainer$5
            final /* synthetic */ AnimatedContentScope<S> this$0;
            ...
            public final Integer invoke(int i) {
                State state = (State) this.this$0.getTargetSizeMap$animation_release().get(this.this$0.getTransition$animation_release().getTargetState());
                long packedValue = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m4008getZeroYbymL2g();
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m3962getYimpl(this.this$0.m21calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), packedValue))) + IntSize.m4002getHeightimpl(packedValue)));
            }
    ...
    public final void m30setMeasuredSizeozmzZPI$animation_release(long j) {
        this.measuredSize.setValue(IntSize.m3995boximpl(j));
    }
    ...
    private static final boolean m22createSizeAnimationModifier$lambda2(MutableState<Boolean> mutableState) {
        return mutableState.getValue().booleanValue();
    }

    /* JADX INFO: renamed from: createSizeAnimationModifier$lambda-3, reason: not valid java name */
    private static final void m23createSizeAnimationModifier$lambda3(MutableState<Boolean> mutableState, boolean z) {
    ...
    public final Modifier createSizeAnimationModifier$animation_release(ContentTransform contentTransform, Composer composer, int i) {
        ...
        if (Intrinsics.areEqual(this.transition.getCurrentState(), this.transition.getTargetState())) {
            m23createSizeAnimationModifier$lambda3(mutableState, false);
        } else if (stateRememberUpdatedState.getValue() != null) {
            m23createSizeAnimationModifier$lambda3(mutableState, true);
        }
        if (m22createSizeAnimationModifier$lambda2(mutableState)) {
        ...
        public MeasureResult mo33measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
            ...
            Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>> function1 = new Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>>() { // from class: androidx.compose.animation.AnimatedContentScope$SizeModifier$measure$size$1
                ...
                public final FiniteAnimationSpec<IntSize> invoke(Transition.Segment<S> animate) {
                    FiniteAnimationSpec<IntSize> finiteAnimationSpecMo99createAnimationSpecTemP2vQ;
                    Intrinsics.checkNotNullParameter(animate, "$this$animate");
                    State<IntSize> state = animatedContentScope.getTargetSizeMap$animation_release().get(animate.getInitialState());
                    long packedValue = state != null ? state.getValue().getPackedValue() : IntSize.INSTANCE.m4008getZeroYbymL2g();
                    State<IntSize> state2 = animatedContentScope.getTargetSizeMap$animation_release().get(animate.getTargetState());
                    long packedValue2 = state2 != null ? state2.getValue().getPackedValue() : IntSize.INSTANCE.m4008getZeroYbymL2g();
                    SizeTransform value = this.getSizeTransform().getValue();
                    return (value == null || (finiteAnimationSpecMo99createAnimationSpecTemP2vQ = value.mo99createAnimationSpecTemP2vQ(packedValue, packedValue2)) == null) ? AnimationSpecKt.spring$default(0.0f, 0.0f, null, 7, null) : finiteAnimationSpecMo99createAnimationSpecTemP2vQ;
                }
            };
            ...
            State<IntSize> stateAnimate = deferredAnimation.animate(function1, new Function1<S, IntSize>() { // from class: androidx.compose.animation.AnimatedContentScope$SizeModifier$measure$size$2
                ...
                public /* bridge */ /* synthetic */ IntSize invoke(Object obj) {
                    return IntSize.m3995boximpl(m34invokeYEO4UFw(obj));
                }

                /* JADX INFO: renamed from: invoke-YEO4UFw, reason: not valid java name */
                public final long m34invokeYEO4UFw(S s) {
                    State<IntSize> state = animatedContentScope2.getTargetSizeMap$animation_release().get(s);
                    return state != null ? state.getValue().getPackedValue() : IntSize.INSTANCE.m4008getZeroYbymL2g();
                }
            });
            this.this$0.setAnimatedSize$animation_release(stateAnimate);
            final long jMo1303alignKFBX0sM = this.this$0.getContentAlignment().mo1303alignKFBX0sM(IntSizeKt.IntSize(placeableMo3124measureBRTryo0.getWidth(), placeableMo3124measureBRTryo0.getHeight()), stateAnimate.getValue().getPackedValue(), LayoutDirection.Ltr);
            return MeasureScope.layout$default(measure, IntSize.m4003getWidthimpl(stateAnimate.getValue().getPackedValue()), IntSize.m4002getHeightimpl(stateAnimate.getValue().getPackedValue()), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentScope$SizeModifier$measure$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(Placeable.PlacementScope layout) {
                    ...
                    Placeable.PlacementScope.m3166place70tqf50$default(layout, placeableMo3124measureBRTryo0, jMo1303alignKFBX0sM, 0.0f, 2, null);
                }
            }, 4, null);
        }
    }
