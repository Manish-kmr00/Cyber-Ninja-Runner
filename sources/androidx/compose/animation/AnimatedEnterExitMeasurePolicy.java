...
final class AnimatedEnterExitMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo18measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long j) {
        ...
        while (it.hasNext()) {
            arrayList.add(((Measurable) it.next()).mo3124measureBRTryo0(j));
        }
        ...
        this.scope.getTargetSize$animation_release().setValue(IntSize.m3995boximpl(IntSizeKt.IntSize(width3, height3)));
