...
public final class SingleValueAnimationKt {
    ...
    public static final State<Color> m92animateColorAsStateKTwxG1Y(long j, AnimationSpec<Color> animationSpec, Function1<? super Color, Unit> function1, Composer composer, int i, int i2) {
        composer.startReplaceableGroup(-1942442407);
        ComposerKt.sourceInformation(composer, "C(animateColorAsState)P(2:c#ui.graphics.Color)60@2717L96,63@2825L109:SingleValueAnimation.kt#xbi5r1");
        if ((i2 & 2) != 0) {
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = (TwoWayConverter) ColorVectorConverterKt.getVectorConverter(Color.INSTANCE).invoke(Color.m1635getColorSpaceimpl(j));
            composer.updateRememberedValue(objRememberedValue);
        }
        composer.endReplaceableGroup();
        State<Color> stateAnimateValueAsState = AnimateAsStateKt.animateValueAsState(Color.m1621boximpl(j), (TwoWayConverter) objRememberedValue, animationSpec2, null, function2, composer, (i & 14) | 576 | ((i << 6) & 57344), 8);
        composer.endReplaceableGroup();
    ...
    public static final Animatable<Color, AnimationVector4D> m91Animatable8_81llA(long j) {
        return new Animatable<>(Color.m1621boximpl(j), ColorVectorConverterKt.getVectorConverter(Color.INSTANCE).invoke(Color.m1635getColorSpaceimpl(j)), null, 4, null);
    }
}
