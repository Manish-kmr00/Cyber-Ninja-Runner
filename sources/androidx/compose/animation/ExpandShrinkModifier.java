...
final class ExpandShrinkModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public final long m83sizeByStateUzc_VyU(EnterExitState targetState, long fullSize) {
        Intrinsics.checkNotNullParameter(targetState, "targetState");
        ChangeSize value = this.expand.getValue();
        long packedValue = value != null ? value.getSize().invoke(IntSize.m3995boximpl(fullSize)).getPackedValue() : fullSize;
        ChangeSize value2 = this.shrink.getValue();
        long packedValue2 = value2 != null ? value2.getSize().invoke(IntSize.m3995boximpl(fullSize)).getPackedValue() : fullSize;
    ...
    public final long m84targetOffsetByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        Intrinsics.checkNotNullParameter(targetState, "targetState");
        if (this.currentAlignment != null && this.alignment.getValue() != null && !Intrinsics.areEqual(this.currentAlignment, this.alignment.getValue())) {
            int i = WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()];
            if (i == 1) {
                return IntOffset.INSTANCE.m3971getZeronOccac();
            }
            if (i == 2) {
                return IntOffset.INSTANCE.m3971getZeronOccac();
            }
            ...
            if (value != null) {
                long packedValue = value.getSize().invoke(IntSize.m3995boximpl(fullSize)).getPackedValue();
                Alignment value2 = this.alignment.getValue();
                Intrinsics.checkNotNull(value2);
                long jMo1303alignKFBX0sM = value2.mo1303alignKFBX0sM(fullSize, packedValue, LayoutDirection.Ltr);
                Alignment alignment = this.currentAlignment;
                Intrinsics.checkNotNull(alignment);
                long jMo1303alignKFBX0sM2 = alignment.mo1303alignKFBX0sM(fullSize, packedValue, LayoutDirection.Ltr);
                return IntOffsetKt.IntOffset(IntOffset.m3961getXimpl(jMo1303alignKFBX0sM) - IntOffset.m3961getXimpl(jMo1303alignKFBX0sM2), IntOffset.m3962getYimpl(jMo1303alignKFBX0sM) - IntOffset.m3962getYimpl(jMo1303alignKFBX0sM2));
            }
            return IntOffset.INSTANCE.m3971getZeronOccac();
        }
        return IntOffset.INSTANCE.m3971getZeronOccac();
    ...
    public MeasureResult mo33measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        final long jIntSize = IntSizeKt.IntSize(placeableMo3124measureBRTryo0.getWidth(), placeableMo3124measureBRTryo0.getHeight());
        long packedValue = this.sizeAnimation.animate(this.sizeTransitionSpec, new Function1<EnterExitState, IntSize>() { // from class: androidx.compose.animation.ExpandShrinkModifier$measure$currentSize$1
            ...
            public /* bridge */ /* synthetic */ IntSize invoke(EnterExitState enterExitState) {
                return IntSize.m3995boximpl(m85invokeYEO4UFw(enterExitState));
            }

            /* JADX INFO: renamed from: invoke-YEO4UFw, reason: not valid java name */
            public final long m85invokeYEO4UFw(EnterExitState it) {
                Intrinsics.checkNotNullParameter(it, "it");
                return this.this$0.m83sizeByStateUzc_VyU(it, jIntSize);
            }
        ...
        final long packedValue2 = this.offsetAnimation.animate(new Function1<Transition.Segment<EnterExitState>, FiniteAnimationSpec<IntOffset>>() { // from class: androidx.compose.animation.ExpandShrinkModifier$measure$offsetDelta$1
            ...
            public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                return IntOffset.m3952boximpl(m86invokeBjo55l4(enterExitState));
            }

            /* JADX INFO: renamed from: invoke-Bjo55l4, reason: not valid java name */
            public final long m86invokeBjo55l4(EnterExitState it) {
                Intrinsics.checkNotNullParameter(it, "it");
                return this.this$0.m84targetOffsetByStateoFUgxo0(it, jIntSize);
            }
        }).getValue().getPackedValue();
        Alignment alignment = this.currentAlignment;
        final long jMo1303alignKFBX0sM = alignment != null ? alignment.mo1303alignKFBX0sM(jIntSize, packedValue, LayoutDirection.Ltr) : IntOffset.INSTANCE.m3971getZeronOccac();
        return MeasureScope.layout$default(measure, IntSize.m4003getWidthimpl(packedValue), IntSize.m4002getHeightimpl(packedValue), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.ExpandShrinkModifier$measure$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.place$default(layout, placeableMo3124measureBRTryo0, IntOffset.m3961getXimpl(jMo1303alignKFBX0sM) + IntOffset.m3961getXimpl(packedValue2), IntOffset.m3962getYimpl(jMo1303alignKFBX0sM) + IntOffset.m3962getYimpl(packedValue2), 0.0f, 4, null);
            }
        }, 4, null);
    }
}
