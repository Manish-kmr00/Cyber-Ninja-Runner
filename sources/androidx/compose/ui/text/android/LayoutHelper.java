...
public final class LayoutHelper {
    ...
    public final Bidi analyzeBidi(int paragraphIndex) {
        ...
        char[] cArr3 = cArr2;
        TextUtils.getChars(this.layout.getText(), iIntValue, iIntValue2, cArr3, 0);
        if (Bidi.requiresBidi(cArr3, 0, i)) {
            bidi = new Bidi(cArr3, 0, null, 0, i, isRtlParagraph(paragraphIndex) ? 1 : 0);
    ...
    public final float getHorizontalPosition(int offset, boolean usePrimaryDirection, boolean upstream) {
        ...
        int i2 = iLineEndToVisibleEnd - paragraphStart;
