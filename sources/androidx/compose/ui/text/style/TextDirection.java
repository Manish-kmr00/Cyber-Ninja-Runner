...
public final class TextDirection {
    ...
    private static final int Ltr = m3758constructorimpl(1);
    private static final int Rtl = m3758constructorimpl(2);
    private static final int Content = m3758constructorimpl(3);
    private static final int ContentOrLtr = m3758constructorimpl(4);
    private static final int ContentOrRtl = m3758constructorimpl(5);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TextDirection m3757boximpl(int i) {
        return new TextDirection(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m3758constructorimpl(int i) {
        return i;
    }
    ...
    public static String m3762toStringimpl(int i) {
        if (m3760equalsimpl0(i, Ltr)) {
            return "Ltr";
        }
        if (m3760equalsimpl0(i, Rtl)) {
            return "Rtl";
        }
        if (m3760equalsimpl0(i, Content)) {
            return "Content";
        }
        if (m3760equalsimpl0(i, ContentOrLtr)) {
            return "ContentOrLtr";
        }
        return m3760equalsimpl0(i, ContentOrRtl) ? "ContentOrRtl" : "Invalid";
    }
