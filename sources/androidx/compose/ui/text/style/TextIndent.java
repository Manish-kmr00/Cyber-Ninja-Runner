...
public final class TextIndent {
    ...
    public static /* synthetic */ TextIndent m3770copyNB67dxo$default(TextIndent textIndent, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textIndent.m3771copyNB67dxo(j, j2);
    }

    /* JADX INFO: renamed from: copy-NB67dxo, reason: not valid java name */
    public final TextIndent m3771copyNB67dxo(long firstLine, long restLine) {
    ...
    public boolean equals(Object other) {
        ...
        return TextUnit.m4021equalsimpl0(this.firstLine, textIndent.firstLine) && TextUnit.m4021equalsimpl0(this.restLine, textIndent.restLine);
    }

    public int hashCode() {
        return (TextUnit.m4025hashCodeimpl(this.firstLine) * 31) + TextUnit.m4025hashCodeimpl(this.restLine);
    }

    public String toString() {
        return "TextIndent(firstLine=" + ((Object) TextUnit.m4031toStringimpl(this.firstLine)) + ", restLine=" + ((Object) TextUnit.m4031toStringimpl(this.restLine)) + ')';
    }
}
