...
public final class TextOverflow {
    ...
    private static final int Clip = m3775constructorimpl(1);
    private static final int Ellipsis = m3775constructorimpl(2);
    private static final int Visible = m3775constructorimpl(3);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TextOverflow m3774boximpl(int i) {
    ...
    public static String m3779toStringimpl(int i) {
        if (m3777equalsimpl0(i, Clip)) {
            return "Clip";
        }
        if (m3777equalsimpl0(i, Ellipsis)) {
            return "Ellipsis";
        }
        return m3777equalsimpl0(i, Visible) ? "Visible" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m3781getClipgIe3tQ8$annotations() {
        }

        /* JADX INFO: renamed from: getEllipsis-gIe3tQ8$annotations, reason: not valid java name */
        public static /* synthetic */ void m3782getEllipsisgIe3tQ8$annotations() {
        }

        /* JADX INFO: renamed from: getVisible-gIe3tQ8$annotations, reason: not valid java name */
        public static /* synthetic */ void m3783getVisiblegIe3tQ8$annotations() {
        }
