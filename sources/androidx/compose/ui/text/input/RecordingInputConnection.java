...
public final class RecordingInputConnection implements InputConnection {
    ...
    public final void updateInputState(TextFieldValue state, InputMethodManager inputMethodManager, View view) {
        ...
        if (this.isActive) {
            ...
            int iM3487getMinimpl = composition != null ? TextRange.m3487getMinimpl(composition.getPackedValue()) : -1;
            TextRange composition2 = state.getComposition();
            inputMethodManager.updateSelection(view, TextRange.m3487getMinimpl(state.getSelection()), TextRange.m3486getMaximpl(state.getSelection()), iM3487getMinimpl, composition2 != null ? TextRange.m3486getMaximpl(composition2.getPackedValue()) : -1);
        }
    }
    ...
    public CharSequence getSelectedText(int flags) {
        if (TextRange.m3483getCollapsedimpl(this.mTextFieldValue.getSelection())) {
            return null;
        }
    ...
    public int getCursorCapsMode(int reqModes) {
        return TextUtils.getCapsMode(this.mTextFieldValue.getText(), TextRange.m3487getMinimpl(this.mTextFieldValue.getSelection()), reqModes);
    }
        ...
        if (z) {
            ...
            switch (id) {
                ...
                case R.id.cut:
                    ...
                    break;
                case R.id.copy:
                    sendSynthesizedKeyEvent(POBNativeConstants.POB_NATIVE_MAIN_IMG_W);
                    break;
                case R.id.paste:
    ...
    public boolean performEditorAction(int editorAction) {
        int iM3620getDefaulteUduSuo;
        boolean z = this.isActive;
        if (!z) {
            return z;
        }
        if (editorAction == 0) {
            iM3620getDefaulteUduSuo = ImeAction.INSTANCE.m3620getDefaulteUduSuo();
        } else {
            switch (editorAction) {
                case 2:
                    iM3620getDefaulteUduSuo = ImeAction.INSTANCE.m3622getGoeUduSuo();
                    break;
                case 3:
                    iM3620getDefaulteUduSuo = ImeAction.INSTANCE.m3626getSearcheUduSuo();
                    break;
                case 4:
                    iM3620getDefaulteUduSuo = ImeAction.INSTANCE.m3627getSendeUduSuo();
                    break;
                case 5:
                    iM3620getDefaulteUduSuo = ImeAction.INSTANCE.m3623getNexteUduSuo();
                    break;
                case 6:
                    iM3620getDefaulteUduSuo = ImeAction.INSTANCE.m3621getDoneeUduSuo();
                    break;
                case 7:
                    iM3620getDefaulteUduSuo = ImeAction.INSTANCE.m3625getPreviouseUduSuo();
                    break;
                default:
        ...
        this.eventCallback.mo3634onImeActionKlQnJC8(iM3620getDefaulteUduSuo);
        return true;
    }
