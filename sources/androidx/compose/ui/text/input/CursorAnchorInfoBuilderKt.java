...
public final class CursorAnchorInfoBuilderKt {
    public static final CursorAnchorInfo build(CursorAnchorInfo.Builder builder, TextFieldValue textFieldValue, TextLayoutResult textLayoutResult, Matrix matrix) {
        ...
        int iM3487getMinimpl = TextRange.m3487getMinimpl(textFieldValue.getSelection());
        builder.setSelectionRange(iM3487getMinimpl, TextRange.m3486getMaximpl(textFieldValue.getSelection()));
        setInsertionMarker(builder, iM3487getMinimpl, textLayoutResult);
        TextRange composition = textFieldValue.getComposition();
        int iM3487getMinimpl2 = composition != null ? TextRange.m3487getMinimpl(composition.getPackedValue()) : -1;
        TextRange composition2 = textFieldValue.getComposition();
        int iM3486getMaximpl = composition2 != null ? TextRange.m3486getMaximpl(composition2.getPackedValue()) : -1;
        if (iM3487getMinimpl2 >= 0 && iM3487getMinimpl2 < iM3486getMaximpl) {
            builder.setComposingText(iM3487getMinimpl2, textFieldValue.getText().subSequence(iM3487getMinimpl2, iM3486getMaximpl));
        }
