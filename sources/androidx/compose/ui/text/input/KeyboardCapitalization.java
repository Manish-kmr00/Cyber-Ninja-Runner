...
public final class KeyboardCapitalization {
    ...
    private static final int None = m3636constructorimpl(0);
    private static final int Characters = m3636constructorimpl(1);
    private static final int Words = m3636constructorimpl(2);
    private static final int Sentences = m3636constructorimpl(3);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ KeyboardCapitalization m3635boximpl(int i) {
    ...
    public static String m3640toStringimpl(int i) {
        ...
        if (m3638equalsimpl0(i, Characters)) {
            return "Characters";
        }
        if (m3638equalsimpl0(i, Words)) {
            return "Words";
        }
        return m3638equalsimpl0(i, Sentences) ? "Sentences" : "Invalid";
    }
