...
public final class InputState_androidKt {
    public static final ExtractedText toExtractedText(TextFieldValue textFieldValue) {
        ...
        extractedText.selectionStart = TextRange.m3487getMinimpl(textFieldValue.getSelection());
        extractedText.selectionEnd = TextRange.m3486getMaximpl(textFieldValue.getSelection());
