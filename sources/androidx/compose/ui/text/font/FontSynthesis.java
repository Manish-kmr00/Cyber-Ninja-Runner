...
public final class FontSynthesis {
    ...
    private static final int None = m3575constructorimpl(0);
    private static final int All = m3575constructorimpl(1);
    private static final int Weight = m3575constructorimpl(2);
    private static final int Style = m3575constructorimpl(3);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FontSynthesis m3574boximpl(int i) {
    ...
    public static String m3581toStringimpl(int i) {
        if (m3577equalsimpl0(i, None)) {
            return "None";
        }
        if (m3577equalsimpl0(i, All)) {
            return "All";
        }
        if (m3577equalsimpl0(i, Weight)) {
            return "Weight";
        }
        return m3577equalsimpl0(i, Style) ? "Style" : "Invalid";
    }
