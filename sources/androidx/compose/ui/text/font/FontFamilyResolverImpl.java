...
public final class FontFamilyResolverImpl implements FontFamily.Resolver {
    ...
    @DebugMetadata(c = "androidx.compose.ui.text.font.FontFamilyResolverImpl", f = "FontFamilyResolver.kt", i = {0, 0}, l = {47}, m = LinkHeader.Rel.PreLoad, n = {"this", "fontFamily"}, s = {"L$0", "L$1"})
    ...
    public FontFamilyResolverImpl(PlatformFontLoader platformFontLoader, PlatformResolveInterceptor platformResolveInterceptor, TypefaceRequestCache typefaceRequestCache, FontListFontFamilyTypefaceAdapter fontListFontFamilyTypefaceAdapter, PlatformFontFamilyTypefaceAdapter platformFamilyTypefaceAdapter) {
        ...
        this.createDefaultTypeface = new Function1<TypefaceRequest, Object>() { // from class: androidx.compose.ui.text.font.FontFamilyResolverImpl$createDefaultTypeface$1
            ...
            public final Object invoke(TypefaceRequest it) {
                ...
                return this.this$0.resolve(TypefaceRequest.m3604copye1PVR60$default(it, null, null, 0, 0, null, 30, null)).getValue();
            }
        };
    }
    ...
    public Object preload(FontFamily fontFamily, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            anonymousClass1.L$1 = fontFamily2;
            anonymousClass1.label = 1;
            if (fontListFontFamilyTypefaceAdapter.preload(fontFamily2, platformFontLoader, anonymousClass1) == coroutine_suspended) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            arrayList.add(new TypefaceRequest(fontFamilyResolverImpl.platformResolveInterceptor.interceptFontFamily(fontFamily2), fontFamilyResolverImpl.platformResolveInterceptor.interceptFontWeight(font.getWeight()), fontFamilyResolverImpl.platformResolveInterceptor.m3588interceptFontStyleT2F_aPo(font.getStyle()), FontSynthesis.INSTANCE.m3583getAllGVVA2EU(), fontFamilyResolverImpl.platformFontLoader.getCacheKey(), null));
        }
    ...
    public State<Object> mo3547resolveDPcqOEQ(FontFamily fontFamily, FontWeight fontWeight, int fontStyle, int fontSynthesis) {
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        return resolve(new TypefaceRequest(this.platformResolveInterceptor.interceptFontFamily(fontFamily), this.platformResolveInterceptor.interceptFontWeight(fontWeight), this.platformResolveInterceptor.m3588interceptFontStyleT2F_aPo(fontStyle), this.platformResolveInterceptor.m3589interceptFontSynthesisMscr08Y(fontSynthesis), this.platformFontLoader.getCacheKey(), null));
    }
