...
final class AndroidFileDescriptorHelper {
    ...
    public final android.graphics.Typeface create(ParcelFileDescriptor fileDescriptor) {
        ...
        android.graphics.Typeface typefaceBuild = new android.graphics.Typeface.Builder(fileDescriptor.getFileDescriptor()).build();
        Intrinsics.checkNotNullExpressionValue(typefaceBuild, "Builder(fileDescriptor.fileDescriptor).build()");
