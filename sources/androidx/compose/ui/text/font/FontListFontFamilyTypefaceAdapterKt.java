            ...
            if (!FontLoadingStrategy.m3555equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m3560getBlockingPKNRLFQ())) {
                if (!FontLoadingStrategy.m3555equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m3561getOptionalLocalPKNRLFQ())) {
                    if (FontLoadingStrategy.m3555equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m3559getAsyncPKNRLFQ())) {
                        AsyncTypefaceCache.AsyncTypefaceResult asyncTypefaceResultM3527get1ASDuI8 = asyncTypefaceCache.m3527get1ASDuI8(font, platformFontLoader);
                        if (asyncTypefaceResultM3527get1ASDuI8 != null) {
                            if (!AsyncTypefaceCache.AsyncTypefaceResult.m3533isPermanentFailureimpl(asyncTypefaceResultM3527get1ASDuI8.m3535unboximpl()) && asyncTypefaceResultM3527get1ASDuI8.m3535unboximpl() != null) {
                                return TuplesKt.to(listMutableListOf, FontSynthesis_androidKt.m3587synthesizeTypefaceFxwP2eA(typefaceRequest.m3609getFontSynthesisGVVA2EU(), asyncTypefaceResultM3527get1ASDuI8.m3535unboximpl(), font, typefaceRequest.getFontWeight(), typefaceRequest.m3608getFontStyle_LCdwA()));
                            }
                    ...
                    synchronized (asyncTypefaceCache.cacheLock) {
                        ...
                        if (asyncTypefaceResult != null) {
                            objM7904constructorimpl = asyncTypefaceResult.m3535unboximpl();
                        } else {
                            Unit unit = Unit.INSTANCE;
                            try {
                                Result.Companion companion = Result.INSTANCE;
                                objM7904constructorimpl = Result.m7904constructorimpl(platformFontLoader.loadBlocking(font));
                            } catch (Throwable th) {
                            ...
                            AsyncTypefaceCache.put$default(asyncTypefaceCache, font, platformFontLoader, objM7904constructorimpl, false, 8, null);
                        }
                    }
                    if (objM7904constructorimpl != null) {
                        return TuplesKt.to(listMutableListOf, FontSynthesis_androidKt.m3587synthesizeTypefaceFxwP2eA(typefaceRequest.m3609getFontSynthesisGVVA2EU(), objM7904constructorimpl, font, typefaceRequest.getFontWeight(), typefaceRequest.m3608getFontStyle_LCdwA()));
                    }
                }
            } else {
                synchronized (asyncTypefaceCache.cacheLock) {
                    ...
                    if (asyncTypefaceResult2 != null) {
                        objLoadBlocking = asyncTypefaceResult2.m3535unboximpl();
                    } else {
                ...
                return TuplesKt.to(listMutableListOf, FontSynthesis_androidKt.m3587synthesizeTypefaceFxwP2eA(typefaceRequest.m3609getFontSynthesisGVVA2EU(), objLoadBlocking, font, typefaceRequest.getFontWeight(), typefaceRequest.m3608getFontStyle_LCdwA()));
            }
        }
