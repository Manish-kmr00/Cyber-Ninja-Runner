...
public final class FontStyle {
    ...
    private static final int Normal = m3566constructorimpl(0);
    private static final int Italic = m3566constructorimpl(1);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FontStyle m3565boximpl(int i) {
    ...
    public static boolean m3567equalsimpl(int i, Object obj) {
        return (obj instanceof FontStyle) && i == ((FontStyle) obj).m3571unboximpl();
    }
    ...
    public static String m3570toStringimpl(int i) {
        if (m3568equalsimpl0(i, Normal)) {
            return "Normal";
        }
        return m3568equalsimpl0(i, Italic) ? "Italic" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public final int m3573getNormal_LCdwA() {
            return FontStyle.Normal;
        }

        /* JADX INFO: renamed from: getItalic-_-LCdwA, reason: not valid java name */
        public final int m3572getItalic_LCdwA() {
            return FontStyle.Italic;
        }

        public final List<FontStyle> values() {
            return CollectionsKt.listOf((Object[]) new FontStyle[]{FontStyle.m3565boximpl(m3573getNormal_LCdwA()), FontStyle.m3565boximpl(m3572getItalic_LCdwA())});
        }
    }
}
