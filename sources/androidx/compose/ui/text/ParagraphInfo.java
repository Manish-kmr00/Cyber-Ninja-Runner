...
public final /* data */ class ParagraphInfo {
    ...
    public final long m3413toLocalMKHz9U(long j) {
        return OffsetKt.Offset(Offset.m1395getXimpl(j), Offset.m1396getYimpl(j) - this.top);
    }

    public final Rect toGlobal(Rect rect) {
        Intrinsics.checkNotNullParameter(rect, "<this>");
        return rect.m1432translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
    }

    public final Path toGlobal(Path path) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        path.mo1530translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
        return path;
    }

    /* JADX INFO: renamed from: toGlobal-GEjPoXI, reason: not valid java name */
    public final long m3412toGlobalGEjPoXI(long j) {
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m3489getStartimpl(j)), toGlobalIndex(TextRange.m3484getEndimpl(j)));
    }
}
