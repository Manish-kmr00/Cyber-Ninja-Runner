...
public final class SpannableExtensions_androidKt {
    ...
    public static final void setTextIndent(Spannable spannable, TextIndent textIndent, float f, Density density) {
        float fM4024getValueimpl;
        Intrinsics.checkNotNullParameter(spannable, "<this>");
        Intrinsics.checkNotNullParameter(density, "density");
        if (textIndent != null) {
            if ((TextUnit.m4021equalsimpl0(textIndent.getFirstLine(), TextUnitKt.getSp(0)) && TextUnit.m4021equalsimpl0(textIndent.getRestLine(), TextUnitKt.getSp(0))) || TextUnitKt.m4042isUnspecifiedR2X_6o(textIndent.getFirstLine()) || TextUnitKt.m4042isUnspecifiedR2X_6o(textIndent.getRestLine())) {
                return;
            }
            long jM4023getTypeUIouoOA = TextUnit.m4023getTypeUIouoOA(textIndent.getFirstLine());
            float fM4024getValueimpl2 = 0.0f;
            if (TextUnitType.m4052equalsimpl0(jM4023getTypeUIouoOA, TextUnitType.INSTANCE.m4057getSpUIouoOA())) {
                fM4024getValueimpl = density.mo317toPxR2X_6o(textIndent.getFirstLine());
            } else {
                fM4024getValueimpl = TextUnitType.m4052equalsimpl0(jM4023getTypeUIouoOA, TextUnitType.INSTANCE.m4056getEmUIouoOA()) ? TextUnit.m4024getValueimpl(textIndent.getFirstLine()) * f : 0.0f;
            }
            long jM4023getTypeUIouoOA2 = TextUnit.m4023getTypeUIouoOA(textIndent.getRestLine());
            if (TextUnitType.m4052equalsimpl0(jM4023getTypeUIouoOA2, TextUnitType.INSTANCE.m4057getSpUIouoOA())) {
                fM4024getValueimpl2 = density.mo317toPxR2X_6o(textIndent.getRestLine());
            } else if (TextUnitType.m4052equalsimpl0(jM4023getTypeUIouoOA2, TextUnitType.INSTANCE.m4056getEmUIouoOA())) {
                fM4024getValueimpl2 = TextUnit.m4024getValueimpl(textIndent.getRestLine()) * f;
            }
            setSpan(spannable, new LeadingMarginSpan.Standard((int) Math.ceil(fM4024getValueimpl), (int) Math.ceil(fM4024getValueimpl2)), 0, spannable.length());
        }
    }

    /* JADX INFO: renamed from: setLineHeight-KmRG4DE, reason: not valid java name */
    public static final void m3696setLineHeightKmRG4DE(Spannable setLineHeight, long j, float f, Density density, LineHeightStyle lineHeightStyle) {
        Intrinsics.checkNotNullParameter(setLineHeight, "$this$setLineHeight");
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(lineHeightStyle, "lineHeightStyle");
        float fM3691resolveLineHeightInPxo2QH7mI = m3691resolveLineHeightInPxo2QH7mI(j, f, density);
        if (Float.isNaN(fM3691resolveLineHeightInPxo2QH7mI)) {
            return;
        }
        setSpan(setLineHeight, new LineHeightStyleSpan(fM3691resolveLineHeightInPxo2QH7mI, 0, setLineHeight.length(), LineHeightStyle.Trim.m3736isTrimFirstLineTopimpl$ui_text_release(lineHeightStyle.getTrim()), LineHeightStyle.Trim.m3737isTrimLastLineBottomimpl$ui_text_release(lineHeightStyle.getTrim()), lineHeightStyle.getAlignment()), 0, setLineHeight.length());
    }

    /* JADX INFO: renamed from: setLineHeight-r9BaKPg, reason: not valid java name */
    public static final void m3697setLineHeightr9BaKPg(Spannable setLineHeight, long j, float f, Density density) {
        Intrinsics.checkNotNullParameter(setLineHeight, "$this$setLineHeight");
        Intrinsics.checkNotNullParameter(density, "density");
        float fM3691resolveLineHeightInPxo2QH7mI = m3691resolveLineHeightInPxo2QH7mI(j, f, density);
        if (Float.isNaN(fM3691resolveLineHeightInPxo2QH7mI)) {
        ...
        setSpan(setLineHeight, new LineHeightSpan(fM3691resolveLineHeightInPxo2QH7mI), 0, setLineHeight.length());
    }

    /* JADX INFO: renamed from: resolveLineHeightInPx-o2QH7mI, reason: not valid java name */
    private static final float m3691resolveLineHeightInPxo2QH7mI(long j, float f, Density density) {
        long jM4023getTypeUIouoOA = TextUnit.m4023getTypeUIouoOA(j);
        if (TextUnitType.m4052equalsimpl0(jM4023getTypeUIouoOA, TextUnitType.INSTANCE.m4057getSpUIouoOA())) {
            return density.mo317toPxR2X_6o(j);
        }
        if (TextUnitType.m4052equalsimpl0(jM4023getTypeUIouoOA, TextUnitType.INSTANCE.m4056getEmUIouoOA())) {
            return TextUnit.m4024getValueimpl(j) * f;
        }
        return Float.NaN;
    }
    ...
    public static final void setSpanStyles(Spannable spannable, TextStyle contextTextStyle, List<AnnotatedString.Range<SpanStyle>> spanStyles, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> resolveTypeface) {
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            SpanRange spanRange = (SpanRange) arrayList2.get(i2);
    ...
    private static final void setSpanStyle(Spannable spannable, AnnotatedString.Range<SpanStyle> range, Density density, ArrayList<SpanRange> arrayList) {
        ...
        m3693setBaselineShift0ocSgnM(spannable, item.getBaselineShift(), start, end);
        m3694setColorRPmYEkk(spannable, item.m3462getColor0d7_KjU(), start, end);
        setBrush(spannable, item.getBrush(), start, end);
        setTextDecoration(spannable, item.getTextDecoration(), start, end);
        m3695setFontSizeKmRG4DE(spannable, item.getFontSize(), density, start, end);
        ...
        m3692setBackgroundRPmYEkk(spannable, item.getBackground(), start, end);
        setShadow(spannable, item.getShadow(), start, end);
        MetricAffectingSpan metricAffectingSpanM3690createLetterSpacingSpaneAf_CNQ = m3690createLetterSpacingSpaneAf_CNQ(item.getLetterSpacing(), density);
        if (metricAffectingSpanM3690createLetterSpacingSpaneAf_CNQ != null) {
            arrayList.add(new SpanRange(metricAffectingSpanM3690createLetterSpacingSpaneAf_CNQ, start, end));
        }
    }
    ...
    private static final MetricAffectingSpan m3690createLetterSpacingSpaneAf_CNQ(long j, Density density) {
        long jM4023getTypeUIouoOA = TextUnit.m4023getTypeUIouoOA(j);
        if (TextUnitType.m4052equalsimpl0(jM4023getTypeUIouoOA, TextUnitType.INSTANCE.m4057getSpUIouoOA())) {
            return new LetterSpacingSpanPx(density.mo317toPxR2X_6o(j));
        }
        if (TextUnitType.m4052equalsimpl0(jM4023getTypeUIouoOA, TextUnitType.INSTANCE.m4056getEmUIouoOA())) {
            return new LetterSpacingSpanEm(TextUnit.m4024getValueimpl(j));
        }
        return null;
    }
    ...
    private static final void setShadow(Spannable spannable, Shadow shadow, int i, int i2) {
        if (shadow != null) {
            setSpan(spannable, new ShadowSpan(ColorKt.m1686toArgb8_81llA(shadow.getColor()), Offset.m1395getXimpl(shadow.getOffset()), Offset.m1396getYimpl(shadow.getOffset()), shadow.getBlurRadius()), i, i2);
        }
    }
    ...
    public static final void m3695setFontSizeKmRG4DE(Spannable setFontSize, long j, Density density, int i, int i2) {
        Intrinsics.checkNotNullParameter(setFontSize, "$this$setFontSize");
        Intrinsics.checkNotNullParameter(density, "density");
        long jM4023getTypeUIouoOA = TextUnit.m4023getTypeUIouoOA(j);
        if (TextUnitType.m4052equalsimpl0(jM4023getTypeUIouoOA, TextUnitType.INSTANCE.m4057getSpUIouoOA())) {
            setSpan(setFontSize, new AbsoluteSizeSpan(MathKt.roundToInt(density.mo317toPxR2X_6o(j)), false), i, i2);
        } else if (TextUnitType.m4052equalsimpl0(jM4023getTypeUIouoOA, TextUnitType.INSTANCE.m4056getEmUIouoOA())) {
            setSpan(setFontSize, new RelativeSizeSpan(TextUnit.m4024getValueimpl(j)), i, i2);
        }
    }
    ...
    private static final void m3693setBaselineShift0ocSgnM(Spannable spannable, BaselineShift baselineShift, int i, int i2) {
        if (baselineShift != null) {
            setSpan(spannable, new BaselineShiftSpan(baselineShift.m3706unboximpl()), i, i2);
        }
    }
    ...
    private static final void setBrush(Spannable spannable, Brush brush, int i, int i2) {
        if (brush != null) {
            if (brush instanceof SolidColor) {
                m3694setColorRPmYEkk(spannable, ((SolidColor) brush).getValue(), i, i2);
    ...
    private static final boolean hasFontAttributes(TextStyle textStyle) {
        return TextPaintExtensions_androidKt.hasFontAttributes(textStyle.toSpanStyle()) || textStyle.m3508getFontSynthesisZQGJjVo() != null;
    }
    ...
    private static final void setFontAttributes(final Spannable spannable, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, final Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4) {
        ...
        if (hasFontAttributes(textStyle)) {
            spanStyle = new SpanStyle(0L, 0L, textStyle.getFontWeight(), textStyle.m3507getFontStyle4Lr2A7w(), textStyle.m3508getFontSynthesisZQGJjVo(), textStyle.getFontFamily(), (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, 16323, (DefaultConstructorMarker) null);
        } else {
            spanStyle = null;
        }
        flattenFontStylesAndApply(spanStyle, arrayList2, new Function3<SpanStyle, Integer, Integer, Unit>() { // from class: androidx.compose.ui.text.platform.extensions.SpannableExtensions_androidKt.setFontAttributes.1
            ...
            public final void invoke(SpanStyle spanStyle2, int i2, int i3) {
                ...
                FontStyle fontStyleM3565boximpl = FontStyle.m3565boximpl(fontStyle != null ? fontStyle.m3571unboximpl() : FontStyle.INSTANCE.m3573getNormal_LCdwA());
                FontSynthesis fontSynthesis = spanStyle2.getFontSynthesis();
                spannable2.setSpan(new TypefaceSpan(function5.invoke(fontFamily, fontWeight, fontStyleM3565boximpl, FontSynthesis.m3574boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m3583getAllGVVA2EU()))), i2, i3, 33);
            }
        });
    }

    /* JADX INFO: renamed from: setBackground-RPmYEkk, reason: not valid java name */
    public static final void m3692setBackgroundRPmYEkk(Spannable setBackground, long j, int i, int i2) {
        Intrinsics.checkNotNullParameter(setBackground, "$this$setBackground");
        if (j != Color.INSTANCE.m1667getUnspecified0d7_KjU()) {
            setSpan(setBackground, new BackgroundColorSpan(ColorKt.m1686toArgb8_81llA(j)), i, i2);
        }
    }

    /* JADX INFO: renamed from: setColor-RPmYEkk, reason: not valid java name */
    public static final void m3694setColorRPmYEkk(Spannable setColor, long j, int i, int i2) {
        Intrinsics.checkNotNullParameter(setColor, "$this$setColor");
        if (j != Color.INSTANCE.m1667getUnspecified0d7_KjU()) {
            setSpan(setColor, new ForegroundColorSpan(ColorKt.m1686toArgb8_81llA(j)), i, i2);
        }
    }
}
