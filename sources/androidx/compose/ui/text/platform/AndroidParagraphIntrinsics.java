...
public final class AndroidParagraphIntrinsics implements ParagraphIntrinsics {
    ...
    public AndroidParagraphIntrinsics(String text, TextStyle style, List<AnnotatedString.Range<SpanStyle>> spanStyles, List<AnnotatedString.Range<Placeholder>> placeholders, FontFamily.Resolver fontFamilyResolver, Density density) {
        ...
        int iM3677resolveTextDirectionHeuristics9GRLPo0 = AndroidParagraphIntrinsics_androidKt.m3677resolveTextDirectionHeuristics9GRLPo0(style.m3512getTextDirectionmmuk1to(), style.getLocaleList());
        this.textDirectionHeuristic = iM3677resolveTextDirectionHeuristics9GRLPo0;
        Function4<FontFamily, FontWeight, FontStyle, FontSynthesis, Typeface> function4 = new Function4<FontFamily, FontWeight, FontStyle, FontSynthesis, Typeface>() { // from class: androidx.compose.ui.text.platform.AndroidParagraphIntrinsics$resolveTypeface$1
            ...
            public /* bridge */ /* synthetic */ Typeface invoke(FontFamily fontFamily, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis) {
                return m3676invokeDPcqOEQ(fontFamily, fontWeight, fontStyle.m3571unboximpl(), fontSynthesis.getValue());
            }

            /* JADX INFO: renamed from: invoke-DPcqOEQ, reason: not valid java name */
            public final Typeface m3676invokeDPcqOEQ(FontFamily fontFamily, FontWeight fontWeight, int i, int i2) {
                Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
                TypefaceDirtyTracker typefaceDirtyTracker = new TypefaceDirtyTracker(this.this$0.getFontFamilyResolver().mo3547resolveDPcqOEQ(fontFamily, fontWeight, i, i2));
                this.this$0.resolvedTypefaces.add(typefaceDirtyTracker);
                return typefaceDirtyTracker.getTypeface();
            }
        };
        CharSequence charSequenceCreateCharSequence = AndroidParagraphHelper_androidKt.createCharSequence(text, androidTextPaint.getTextSize(), style, CollectionsKt.plus((Collection) CollectionsKt.listOf(new AnnotatedString.Range(TextPaintExtensions_androidKt.applySpanStyle(androidTextPaint, style.toSpanStyle(), function4, density), 0, text.length())), (Iterable) spanStyles), placeholders, density, function4);
        this.charSequence = charSequenceCreateCharSequence;
        this.layoutIntrinsics = new LayoutIntrinsics(charSequenceCreateCharSequence, androidTextPaint, iM3677resolveTextDirectionHeuristics9GRLPo0);
    }
