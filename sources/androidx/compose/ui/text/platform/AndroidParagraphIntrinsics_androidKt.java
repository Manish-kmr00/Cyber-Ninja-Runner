...
public final class AndroidParagraphIntrinsics_androidKt {
    ...
    public static /* synthetic */ int m3678resolveTextDirectionHeuristics9GRLPo0$default(TextDirection textDirection, LocaleList localeList, int i, Object obj) {
        if ((i & 1) != 0) {
            textDirection = null;
        }
        if ((i & 2) != 0) {
        ...
        return m3677resolveTextDirectionHeuristics9GRLPo0(textDirection, localeList);
    }

    /* JADX INFO: renamed from: resolveTextDirectionHeuristics-9GRLPo0, reason: not valid java name */
    public static final int m3677resolveTextDirectionHeuristics9GRLPo0(TextDirection textDirection, LocaleList localeList) {
        Locale javaLocale;
        int value = textDirection != null ? textDirection.getValue() : TextDirection.INSTANCE.m3764getContents_7Xco();
        if (TextDirection.m3760equalsimpl0(value, TextDirection.INSTANCE.m3765getContentOrLtrs_7Xco())) {
            return 2;
        }
        if (!TextDirection.m3760equalsimpl0(value, TextDirection.INSTANCE.m3766getContentOrRtls_7Xco())) {
            if (TextDirection.m3760equalsimpl0(value, TextDirection.INSTANCE.m3767getLtrs_7Xco())) {
                return 0;
            }
            if (TextDirection.m3760equalsimpl0(value, TextDirection.INSTANCE.m3768getRtls_7Xco())) {
                return 1;
            }
            if (TextDirection.m3760equalsimpl0(value, TextDirection.INSTANCE.m3764getContents_7Xco())) {
                if (localeList == null || (javaLocale = ((AndroidLocale) localeList.get(0).getPlatformLocale()).getJavaLocale()) == null) {
