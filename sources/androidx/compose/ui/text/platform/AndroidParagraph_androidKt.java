...
public final class AndroidParagraph_androidKt {
    ...
    public static final int m3682toLayoutAlignAMY3VfE(TextAlign textAlign) {
        if (textAlign == null ? false : TextAlign.m3747equalsimpl0(textAlign.getValue(), TextAlign.INSTANCE.m3754getLefte0LSkKk())) {
            return 3;
        }
        if (textAlign == null ? false : TextAlign.m3747equalsimpl0(textAlign.getValue(), TextAlign.INSTANCE.m3755getRighte0LSkKk())) {
            return 4;
        }
        if (textAlign == null ? false : TextAlign.m3747equalsimpl0(textAlign.getValue(), TextAlign.INSTANCE.m3751getCentere0LSkKk())) {
            return 2;
        }
        if (textAlign == null ? false : TextAlign.m3747equalsimpl0(textAlign.getValue(), TextAlign.INSTANCE.m3756getStarte0LSkKk())) {
            return 0;
        }
        return textAlign == null ? false : TextAlign.m3747equalsimpl0(textAlign.getValue(), TextAlign.INSTANCE.m3752getEnde0LSkKk()) ? 1 : 0;
    }
    ...
    public static final Paragraph m3680ActualParagraphO3s9Psw(String text, TextStyle style, List<AnnotatedString.Range<SpanStyle>> spanStyles, List<AnnotatedString.Range<Placeholder>> placeholders, int i, boolean z, long j, Density density, FontFamily.Resolver fontFamilyResolver) {
        Intrinsics.checkNotNullParameter(text, "text");
        Intrinsics.checkNotNullParameter(style, "style");
        Intrinsics.checkNotNullParameter(spanStyles, "spanStyles");
        Intrinsics.checkNotNullParameter(placeholders, "placeholders");
    ...
    public static final Paragraph m3679ActualParagraphhBUhpc(ParagraphIntrinsics paragraphIntrinsics, int i, boolean z, long j) {
