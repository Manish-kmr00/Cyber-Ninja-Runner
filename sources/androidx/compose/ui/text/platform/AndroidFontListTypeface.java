...
public final class AndroidFontListTypeface implements AndroidTypeface {
    ...
    public AndroidFontListTypeface(FontListFontFamily fontFamily, Context context, List<Pair<FontWeight, FontStyle>> list, FontMatcher fontMatcher2) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (FontLoadingStrategy.m3555equalsimpl0(font.getLoadingStrategy(), FontLoadingStrategy.INSTANCE.m3560getBlockingPKNRLFQ())) {
                arrayList2.add(font);
            }
        }
        ...
        if (list != null) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                arrayList4.add((Font) CollectionsKt.firstOrNull((List) this.fontMatcher.m3564matchFontRetOiIg(arrayList3, pair.component1(), pair.component2().m3571unboximpl())));
            }
            List listFastFilterNotNull = TempListUtilsKt.fastFilterNotNull(arrayList4);
    ...
    public Typeface mo3672getNativeTypefacePYhJU0U(FontWeight fontWeight, int fontStyle, int synthesis) {
        ...
        Font font = (Font) CollectionsKt.firstOrNull((List) this.fontMatcher.m3564matchFontRetOiIg(new ArrayList(this.loadedTypefaces.keySet()), fontWeight, fontStyle));
        if (font == null) {
        ...
        return (Typeface) FontSynthesis_androidKt.m3587synthesizeTypefaceFxwP2eA(synthesis, typeface, font, fontWeight, fontStyle);
    }
}
