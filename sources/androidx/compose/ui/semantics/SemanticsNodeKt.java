...
public final class SemanticsNodeKt {
    public static final SemanticsEntity getOuterSemantics(LayoutNode layoutNode) {
        ...
        while (outerLayoutNodeWrapper$ui_release != null && !EntityList.m3224has0OSVbXo(outerLayoutNodeWrapper$ui_release.m3274getEntitiesCHwCgZE(), EntityList.INSTANCE.m3235getSemanticsEntityTypeEEbPh1w())) {
            outerLayoutNodeWrapper$ui_release = outerLayoutNodeWrapper$ui_release.getWrapped();
        }
        if (outerLayoutNodeWrapper$ui_release == null || (semanticsEntity = (SemanticsEntity) EntityList.m3226head0OSVbXo(outerLayoutNodeWrapper$ui_release.m3274getEntitiesCHwCgZE(), EntityList.INSTANCE.m3235getSemanticsEntityTypeEEbPh1w())) == null) {
            return null;
        }
        ...
        while (layoutNodeWrapper != null) {
            ...
            semanticsEntity = layoutNodeWrapper != null ? (SemanticsEntity) EntityList.m3226head0OSVbXo(layoutNodeWrapper.m3274getEntitiesCHwCgZE(), EntityList.INSTANCE.m3235getSemanticsEntityTypeEEbPh1w()) : null;
        }
        return null;
    }
    ...
    public static final SemanticsEntity getOuterMergingSemantics(LayoutNode layoutNode) {
        ...
        if (outerLayoutNodeWrapper$ui_release == null || (next = (SemanticsEntity) EntityList.m3226head0OSVbXo(outerLayoutNodeWrapper$ui_release.m3274getEntitiesCHwCgZE(), EntityList.INSTANCE.m3235getSemanticsEntityTypeEEbPh1w())) == null) {
            return null;
        }
        ...
        while (layoutNodeWrapper != null) {
            ...
            layoutNodeWrapper = layoutNodeWrapper.getWrapped();
            next = layoutNodeWrapper != null ? (SemanticsEntity) EntityList.m3226head0OSVbXo(layoutNodeWrapper.m3274getEntitiesCHwCgZE(), EntityList.INSTANCE.m3235getSemanticsEntityTypeEEbPh1w()) : null;
        }
        return null;
    }
    ...
    public static final SemanticsEntity nearestSemantics(LayoutNodeWrapper layoutNodeWrapper, Function1<? super SemanticsEntity, Boolean> predicate) {
        ...
        while (layoutNodeWrapper != null && !EntityList.m3224has0OSVbXo(layoutNodeWrapper.m3274getEntitiesCHwCgZE(), EntityList.INSTANCE.m3235getSemanticsEntityTypeEEbPh1w())) {
            layoutNodeWrapper = layoutNodeWrapper.getWrapped();
        }
        if (layoutNodeWrapper == null || (next = (SemanticsEntity) EntityList.m3226head0OSVbXo(layoutNodeWrapper.m3274getEntitiesCHwCgZE(), EntityList.INSTANCE.m3235getSemanticsEntityTypeEEbPh1w())) == null) {
            return null;
        }
        ...
        while (layoutNodeWrapper2 != null) {
            ...
            next = layoutNodeWrapper2 != null ? (SemanticsEntity) EntityList.m3226head0OSVbXo(layoutNodeWrapper2.m3274getEntitiesCHwCgZE(), EntityList.INSTANCE.m3235getSemanticsEntityTypeEEbPh1w()) : null;
        }
        return null;
    }
