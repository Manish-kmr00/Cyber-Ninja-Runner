    ...
    public void onModifierLocalsUpdated(ModifierLocalReadScope scope) {
        ...
        if (!Intrinsics.areEqual(focusModifier, this.parent)) {
            if (focusModifier == null) {
                ...
                if ((i == 1 || i == 2) && (layoutNodeWrapper = this.layoutNodeWrapper) != null && (layoutNode$ui_release = layoutNodeWrapper.getLayoutNode()) != null && (owner = layoutNode$ui_release.getOwner()) != null && (focusManager = owner.getFocusManager()) != null) {
