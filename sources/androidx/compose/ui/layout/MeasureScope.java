...
public interface MeasureScope extends IntrinsicMeasureScope {
    ...
    public static final class DefaultImpls {
        ...
        public static int m3146roundToPxR2X_6o(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo311roundToPxR2X_6o(j);
        }

        @Deprecated
        /* JADX INFO: renamed from: roundToPx-0680j_4, reason: not valid java name */
        public static int m3147roundToPx0680j_4(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo312roundToPx0680j_4(f);
        }

        @Deprecated
        /* JADX INFO: renamed from: toDp-GaN1DYA, reason: not valid java name */
        public static float m3148toDpGaN1DYA(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo313toDpGaN1DYA(j);
        }

        @Deprecated
        /* JADX INFO: renamed from: toDp-u2uoSUM, reason: not valid java name */
        public static float m3149toDpu2uoSUM(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo314toDpu2uoSUM(f);
        }

        @Deprecated
        /* JADX INFO: renamed from: toDp-u2uoSUM, reason: not valid java name */
        public static float m3150toDpu2uoSUM(MeasureScope measureScope, int i) {
            return MeasureScope.super.mo315toDpu2uoSUM(i);
        }

        @Deprecated
        /* JADX INFO: renamed from: toDpSize-k-rfVVM, reason: not valid java name */
        public static long m3151toDpSizekrfVVM(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo316toDpSizekrfVVM(j);
        }

        @Deprecated
        /* JADX INFO: renamed from: toPx--R2X_6o, reason: not valid java name */
        public static float m3152toPxR2X_6o(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo317toPxR2X_6o(j);
        }

        @Deprecated
        /* JADX INFO: renamed from: toPx-0680j_4, reason: not valid java name */
        public static float m3153toPx0680j_4(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo318toPx0680j_4(f);
        }
        ...
        public static long m3154toSizeXkaWNTQ(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo319toSizeXkaWNTQ(j);
        }

        @Deprecated
        /* JADX INFO: renamed from: toSp-0xMU5do, reason: not valid java name */
        public static long m3155toSp0xMU5do(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo320toSp0xMU5do(f);
        }

        @Deprecated
        /* JADX INFO: renamed from: toSp-kPz2Gy4, reason: not valid java name */
        public static long m3156toSpkPz2Gy4(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo321toSpkPz2Gy4(f);
        }

        @Deprecated
        /* JADX INFO: renamed from: toSp-kPz2Gy4, reason: not valid java name */
        public static long m3157toSpkPz2Gy4(MeasureScope measureScope, int i) {
            return MeasureScope.super.mo322toSpkPz2Gy4(i);
        }
