...
public final class SubcomposeLayoutKt {
    public static final void SubcomposeLayout(final Modifier modifier, final Function2<? super SubcomposeMeasureScope, ? super Constraints, ? extends MeasureResult> measurePolicy, Composer composer, final int i, final int i2) {
        ...
        if ((i2 & 2) != 0) {
            ...
            i3 |= composerStartRestartGroup.changed(measurePolicy) ? 32 : 16;
        }
        if ((i3 & 91) != 18 || !composerStartRestartGroup.getSkipping()) {
            ...
            int i5 = i3 << 3;
            SubcomposeLayout((SubcomposeLayoutState) objRememberedValue, modifier, measurePolicy, composerStartRestartGroup, (i5 & 112) | 8 | (i5 & 896), 0);
        } else {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.layout.SubcomposeLayoutKt.SubcomposeLayout.2
            ...
            public final void invoke(Composer composer2, int i6) {
                SubcomposeLayoutKt.SubcomposeLayout(modifier, measurePolicy, composer2, i | 1, i2);
            }
        });
    }
    ...
    public static final void SubcomposeLayout(final SubcomposeLayoutState state, Modifier modifier, final Function2<? super SubcomposeMeasureScope, ? super Constraints, ? extends MeasureResult> measurePolicy, Composer composer, final int i, final int i2) {
        ...
        Updater.m1293setimpl(composerM1286constructorimpl, state, state.getSetRoot$ui_release());
        Updater.m1293setimpl(composerM1286constructorimpl, compositionContextRememberCompositionContext, state.getSetCompositionContext$ui_release());
        Updater.m1293setimpl(composerM1286constructorimpl, modifierMaterialize, ComposeUiNode.INSTANCE.getSetModifier());
        Updater.m1293setimpl(composerM1286constructorimpl, measurePolicy, state.getSetMeasurePolicy$ui_release());
        ...
        composerStartRestartGroup.endReplaceableGroup();
        EffectsKt.DisposableEffect(unit, (Function1<? super DisposableEffectScope, ? extends DisposableEffectResult>) objRememberedValue, composerStartRestartGroup, 0);
        ScopeUpdateScope scopeUpdateScopeEndRestartGroup = composerStartRestartGroup.endRestartGroup();
        if (scopeUpdateScopeEndRestartGroup == null) {
            return;
        }
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.layout.SubcomposeLayoutKt.SubcomposeLayout.6
            ...
            public final void invoke(Composer composer2, int i3) {
                SubcomposeLayoutKt.SubcomposeLayout(state, modifier2, measurePolicy, composer2, i | 1, i2);
            }
        });
    }
