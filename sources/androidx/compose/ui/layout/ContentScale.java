...
public interface ContentScale {
    ...
    long mo3115computeScaleFactorH7hwNQA(long srcSize, long dstSize);
    ...
    public static final class Companion {
        ...
        private static final ContentScale Crop = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Crop$1
            ...
            public long mo3115computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM3121computeFillMaxDimensioniLBOSCw = ContentScaleKt.m3121computeFillMaxDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM3121computeFillMaxDimensioniLBOSCw, fM3121computeFillMaxDimensioniLBOSCw);
            }
        };
        private static final ContentScale Fit = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Fit$1
            ...
            /* JADX INFO: renamed from: computeScaleFactor-H7hwNQA */
            public long mo3115computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM3122computeFillMinDimensioniLBOSCw = ContentScaleKt.m3122computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM3122computeFillMinDimensioniLBOSCw, fM3122computeFillMinDimensioniLBOSCw);
            }
        };
        private static final ContentScale FillHeight = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillHeight$1
            ...
            /* JADX INFO: renamed from: computeScaleFactor-H7hwNQA */
            public long mo3115computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM3120computeFillHeightiLBOSCw = ContentScaleKt.m3120computeFillHeightiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM3120computeFillHeightiLBOSCw, fM3120computeFillHeightiLBOSCw);
            }
        };
        private static final ContentScale FillWidth = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillWidth$1
            ...
            /* JADX INFO: renamed from: computeScaleFactor-H7hwNQA */
            public long mo3115computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM3123computeFillWidthiLBOSCw = ContentScaleKt.m3123computeFillWidthiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM3123computeFillWidthiLBOSCw, fM3123computeFillWidthiLBOSCw);
            }
        };
        private static final ContentScale Inside = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Inside$1
            ...
            /* JADX INFO: renamed from: computeScaleFactor-H7hwNQA */
            public long mo3115computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                if (Size.m1464getWidthimpl(srcSize) > Size.m1464getWidthimpl(dstSize) || Size.m1461getHeightimpl(srcSize) > Size.m1461getHeightimpl(dstSize)) {
                    float fM3122computeFillMinDimensioniLBOSCw = ContentScaleKt.m3122computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                    return ScaleFactorKt.ScaleFactor(fM3122computeFillMinDimensioniLBOSCw, fM3122computeFillMinDimensioniLBOSCw);
                }
        ...
        private static final ContentScale FillBounds = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillBounds$1
            ...
            /* JADX INFO: renamed from: computeScaleFactor-H7hwNQA */
            public long mo3115computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                return ScaleFactorKt.ScaleFactor(ContentScaleKt.m3123computeFillWidthiLBOSCw(srcSize, dstSize), ContentScaleKt.m3120computeFillHeightiLBOSCw(srcSize, dstSize));
            }
        };
