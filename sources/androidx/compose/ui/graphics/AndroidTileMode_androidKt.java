...
public final class AndroidTileMode_androidKt {
    ...
    public static final boolean m1537isSupported0vamqd0(int i) {
        return Build.VERSION.SDK_INT >= 31 || !TileMode.m1951equalsimpl0(i, TileMode.INSTANCE.m1956getDecal3opZhB0());
    }

    /* JADX INFO: renamed from: toAndroidTileMode-0vamqd0, reason: not valid java name */
    public static final Shader.TileMode m1538toAndroidTileMode0vamqd0(int i) {
        if (TileMode.m1951equalsimpl0(i, TileMode.INSTANCE.m1955getClamp3opZhB0())) {
            return Shader.TileMode.CLAMP;
        }
        if (TileMode.m1951equalsimpl0(i, TileMode.INSTANCE.m1958getRepeated3opZhB0())) {
            return Shader.TileMode.REPEAT;
        }
        if (TileMode.m1951equalsimpl0(i, TileMode.INSTANCE.m1957getMirror3opZhB0())) {
            return Shader.TileMode.MIRROR;
        }
        if (TileMode.m1951equalsimpl0(i, TileMode.INSTANCE.m1956getDecal3opZhB0())) {
    ...
    public static final int toComposeTileMode(Shader.TileMode tileMode) {
        ...
        if (i == 1) {
            return TileMode.INSTANCE.m1955getClamp3opZhB0();
        }
        if (i == 2) {
            return TileMode.INSTANCE.m1957getMirror3opZhB0();
        }
        if (i == 3) {
            return TileMode.INSTANCE.m1958getRepeated3opZhB0();
        }
        if (Build.VERSION.SDK_INT >= 31 && tileMode == Shader.TileMode.DECAL) {
            return TileModeVerificationHelper.INSTANCE.m1959getComposeTileModeDecal3opZhB0();
        }
        return TileMode.INSTANCE.m1955getClamp3opZhB0();
    }
}
