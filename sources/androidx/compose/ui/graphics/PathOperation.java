...
public final class PathOperation {
    ...
    private static final int Difference = m1877constructorimpl(0);
    private static final int Intersect = m1877constructorimpl(1);
    private static final int Union = m1877constructorimpl(2);
    private static final int Xor = m1877constructorimpl(3);
    private static final int ReverseDifference = m1877constructorimpl(4);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PathOperation m1876boximpl(int i) {
        return new PathOperation(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m1877constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m1878equalsimpl(int i, Object obj) {
        return (obj instanceof PathOperation) && i == ((PathOperation) obj).getValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1879equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m1880hashCodeimpl(int i) {
    ...
    public static String m1881toStringimpl(int i) {
        if (m1879equalsimpl0(i, Difference)) {
            return "Difference";
        }
        if (m1879equalsimpl0(i, Intersect)) {
            return "Intersect";
        }
        if (m1879equalsimpl0(i, Union)) {
            return "Union";
        }
        if (m1879equalsimpl0(i, Xor)) {
            return "Xor";
        }
        return m1879equalsimpl0(i, ReverseDifference) ? "ReverseDifference" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
