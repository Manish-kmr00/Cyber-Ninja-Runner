...
public interface Path {
    ...
    void mo1526addPathUv8p0NA(Path path, long offset);
    ...
    boolean mo1528opN5in7k0(Path path1, Path path2, int operation);
    ...
    void mo1529setFillTypeoQ8Xj4U(int i);

    /* JADX INFO: renamed from: translate-k-4lQ0M */
    void mo1530translatek4lQ0M(long offset);
    ...
    static /* synthetic */ void m1863addPathUv8p0NA$default(Path path, Path path2, long j, int i, Object obj) {
        if (obj != null) {
        ...
        path.mo1526addPathUv8p0NA(path2, j);
    }
    ...
    public static final class Companion {
        ...
        public final Path m1864combinexh6zSI8(int operation, Path path1, Path path2) {
            Intrinsics.checkNotNullParameter(path1, "path1");
            Intrinsics.checkNotNullParameter(path2, "path2");
            Path Path = AndroidPath_androidKt.Path();
            if (Path.mo1528opN5in7k0(path1, path2, operation)) {
                return Path;
            }
