...
public final class AndroidCanvas implements Canvas {
    ...
    public void mo1491concat58bKbWc(float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        if (MatrixKt.m1849isIdentity58bKbWc(matrix)) {
            return;
        }
        android.graphics.Matrix matrix2 = new android.graphics.Matrix();
        AndroidMatrixConversions_androidKt.m1506setFromEL8BTi8(matrix2, matrix);
        this.internalCanvas.concat(matrix2);
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* JADX INFO: renamed from: clipRect-N_I0leg, reason: not valid java name */
    public void mo1490clipRectN_I0leg(float left, float top, float right, float bottom, int clipOp) {
        this.internalCanvas.clipRect(left, top, right, bottom, m1499toRegionOp7u2Bmg(clipOp));
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* JADX INFO: renamed from: clipPath-mtrdD-E, reason: not valid java name */
    public void mo1489clipPathmtrdDE(Path path, int clipOp) {
        Intrinsics.checkNotNullParameter(path, "path");
        android.graphics.Canvas canvas = this.internalCanvas;
        if (path instanceof AndroidPath) {
            canvas.clipPath(((AndroidPath) path).getInternalPath(), m1499toRegionOp7u2Bmg(clipOp));
            return;
        }
    ...
    public final Region.Op m1499toRegionOp7u2Bmg(int i) {
        return ClipOp.m1615equalsimpl0(i, ClipOp.INSTANCE.m1619getDifferencertfAjoo()) ? Region.Op.DIFFERENCE : Region.Op.INTERSECT;
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* JADX INFO: renamed from: drawLine-Wko1d7g, reason: not valid java name */
    public void mo1495drawLineWko1d7g(long p1, long p2, Paint paint) {
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawLine(Offset.m1395getXimpl(p1), Offset.m1396getYimpl(p1), Offset.m1395getXimpl(p2), Offset.m1396getYimpl(p2), paint.getInternalPaint());
    }
    ...
    public void mo1492drawCircle9KIMszo(long center, float radius, Paint paint) {
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawCircle(Offset.m1395getXimpl(center), Offset.m1396getYimpl(center), radius, paint.getInternalPaint());
    }
    ...
    public void mo1493drawImaged4ec7I(ImageBitmap image, long topLeftOffset, Paint paint) {
        Intrinsics.checkNotNullParameter(image, "image");
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawBitmap(AndroidImageBitmap_androidKt.asAndroidBitmap(image), Offset.m1395getXimpl(topLeftOffset), Offset.m1396getYimpl(topLeftOffset), paint.getInternalPaint());
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* JADX INFO: renamed from: drawImageRect-HPBpro0, reason: not valid java name */
    public void mo1494drawImageRectHPBpro0(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, Paint paint) {
        Intrinsics.checkNotNullParameter(image, "image");
        Intrinsics.checkNotNullParameter(paint, "paint");
        android.graphics.Canvas canvas = this.internalCanvas;
        Bitmap bitmapAsAndroidBitmap = AndroidImageBitmap_androidKt.asAndroidBitmap(image);
        Rect rect = this.srcRect;
        rect.left = IntOffset.m3961getXimpl(srcOffset);
        rect.top = IntOffset.m3962getYimpl(srcOffset);
        rect.right = IntOffset.m3961getXimpl(srcOffset) + IntSize.m4003getWidthimpl(srcSize);
        rect.bottom = IntOffset.m3962getYimpl(srcOffset) + IntSize.m4002getHeightimpl(srcSize);
        Unit unit = Unit.INSTANCE;
        Rect rect2 = this.dstRect;
        rect2.left = IntOffset.m3961getXimpl(dstOffset);
        rect2.top = IntOffset.m3962getYimpl(dstOffset);
        rect2.right = IntOffset.m3961getXimpl(dstOffset) + IntSize.m4003getWidthimpl(dstSize);
        rect2.bottom = IntOffset.m3962getYimpl(dstOffset) + IntSize.m4002getHeightimpl(dstSize);
    ...
    public void mo1496drawPointsO7TthRY(int pointMode, List<Offset> points, Paint paint) {
        Intrinsics.checkNotNullParameter(points, "points");
        Intrinsics.checkNotNullParameter(paint, "paint");
        if (PointMode.m1892equalsimpl0(pointMode, PointMode.INSTANCE.m1896getLinesr_lszbg())) {
            drawLines(points, paint, 2);
        } else if (PointMode.m1892equalsimpl0(pointMode, PointMode.INSTANCE.m1898getPolygonr_lszbg())) {
            drawLines(points, paint, 1);
        } else if (PointMode.m1892equalsimpl0(pointMode, PointMode.INSTANCE.m1897getPointsr_lszbg())) {
    ...
    private final void drawLines(List<Offset> points, Paint paint, int stepBy) {
        ...
        IntProgression intProgressionStep = RangesKt.step(RangesKt.until(0, points.size() - 1), stepBy);
        ...
        while (true) {
            ...
            this.internalCanvas.drawLine(Offset.m1395getXimpl(packedValue), Offset.m1396getYimpl(packedValue), Offset.m1395getXimpl(packedValue2), Offset.m1396getYimpl(packedValue2), paint.getInternalPaint());
            if (first == last) {
                return;
            } else {
                first += step;
    ...
    public void mo1497drawRawPointsO7TthRY(int pointMode, float[] points, Paint paint) {
        Intrinsics.checkNotNullParameter(points, "points");
        Intrinsics.checkNotNullParameter(paint, "paint");
    ...
    private final void drawRawPoints(float[] points, Paint paint, int stepBy) {
        ...
        IntProgression intProgressionStep = RangesKt.step(RangesKt.until(0, points.length - 1), stepBy);
        int first = intProgressionStep.getFirst();
        int last = intProgressionStep.getLast();
        int step = intProgressionStep.getStep();
        if ((step <= 0 || first > last) && (step >= 0 || last > first)) {
    ...
    private final void drawRawLines(float[] points, Paint paint, int stepBy) {
        ...
        IntProgression intProgressionStep = RangesKt.step(RangesKt.until(0, points.length - 3), stepBy * 2);
        int first = intProgressionStep.getFirst();
        int last = intProgressionStep.getLast();
        int step = intProgressionStep.getStep();
        if ((step <= 0 || first > last) && (step >= 0 || last > first)) {
    ...
    public void mo1498drawVerticesTPEHhCM(Vertices vertices, int blendMode, Paint paint) {
        Intrinsics.checkNotNullParameter(vertices, "vertices");
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawVertices(AndroidVertexMode_androidKt.m1539toAndroidVertexModeJOOmi9M(vertices.getVertexMode()), vertices.getPositions().length, vertices.getPositions(), 0, vertices.getTextureCoordinates(), 0, vertices.getColors(), 0, vertices.getIndices(), 0, vertices.getIndices().length, paint.getInternalPaint());
    }
    ...
    private final void drawPoints(List<Offset> points, Paint paint) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            this.internalCanvas.drawPoint(Offset.m1395getXimpl(packedValue), Offset.m1396getYimpl(packedValue), paint.getInternalPaint());
        }
    }
}
