...
public final class Stroke extends DrawStyle {
    ...
    private static final int DefaultCap = StrokeCap.INSTANCE.m1935getButtKaPHkGw();
    private static final int DefaultJoin = StrokeJoin.INSTANCE.m1946getMiterLxFBmk8();
    ...
    public /* synthetic */ Stroke(float f, float f2, int i, int i2, PathEffect pathEffect, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this((i3 & 1) != 0 ? 0.0f : f, (i3 & 2) != 0 ? 4.0f : f2, (i3 & 4) != 0 ? StrokeCap.INSTANCE.m1935getButtKaPHkGw() : i, (i3 & 8) != 0 ? StrokeJoin.INSTANCE.m1946getMiterLxFBmk8() : i2, (i3 & 16) != 0 ? null : pathEffect, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return this.width == stroke.width && this.miter == stroke.miter && StrokeCap.m1931equalsimpl0(this.cap, stroke.cap) && StrokeJoin.m1941equalsimpl0(this.join, stroke.join) && Intrinsics.areEqual(this.pathEffect, stroke.pathEffect);
    }

    public int hashCode() {
        int iHashCode = ((((((Float.hashCode(this.width) * 31) + Float.hashCode(this.miter)) * 31) + StrokeCap.m1932hashCodeimpl(this.cap)) * 31) + StrokeJoin.m1942hashCodeimpl(this.join)) * 31;
        PathEffect pathEffect = this.pathEffect;
        return iHashCode + (pathEffect != null ? pathEffect.hashCode() : 0);
    }

    public String toString() {
        return "Stroke(width=" + this.width + ", miter=" + this.miter + ", cap=" + ((Object) StrokeCap.m1933toStringimpl(this.cap)) + ", join=" + ((Object) StrokeJoin.m1943toStringimpl(this.join)) + ", pathEffect=" + this.pathEffect + ')';
    }
}
