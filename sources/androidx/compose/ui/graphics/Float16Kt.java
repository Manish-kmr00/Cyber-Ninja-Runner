...
public final class Float16Kt {
    ...
    public static final short m1764minAoSsdG0(short s, short s2) {
        if (Float16.m1736isNaNimpl(s) || Float16.m1736isNaNimpl(s2)) {
            return Float16.INSTANCE.m1758getNaNslo4al4();
        }
        return Float16.m1723compareTo41bOqos(s, s2) <= 0 ? s : s2;
    }

    /* JADX INFO: renamed from: max-AoSsdG0, reason: not valid java name */
    public static final short m1763maxAoSsdG0(short s, short s2) {
        if (Float16.m1736isNaNimpl(s) || Float16.m1736isNaNimpl(s2)) {
            return Float16.INSTANCE.m1758getNaNslo4al4();
        }
        return Float16.m1723compareTo41bOqos(s, s2) >= 0 ? s : s2;
