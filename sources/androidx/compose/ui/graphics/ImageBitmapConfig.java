...
public final class ImageBitmapConfig {
    ...
    private static final int Argb8888 = m1810constructorimpl(0);
    private static final int Alpha8 = m1810constructorimpl(1);
    private static final int Rgb565 = m1810constructorimpl(2);
    private static final int F16 = m1810constructorimpl(3);
    private static final int Gpu = m1810constructorimpl(4);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ImageBitmapConfig m1809boximpl(int i) {
    ...
    public static boolean m1811equalsimpl(int i, Object obj) {
        return (obj instanceof ImageBitmapConfig) && i == ((ImageBitmapConfig) obj).m1815unboximpl();
    }
    ...
    public String toString() {
        return m1814toStringimpl(this.value);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m1814toStringimpl(int i) {
        if (m1812equalsimpl0(i, Argb8888)) {
            return "Argb8888";
        }
        if (m1812equalsimpl0(i, Alpha8)) {
            return "Alpha8";
        }
        if (m1812equalsimpl0(i, Rgb565)) {
            return "Rgb565";
        }
        if (m1812equalsimpl0(i, F16)) {
            return "F16";
        }
        return m1812equalsimpl0(i, Gpu) ? "Gpu" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
