...
public final class AndroidPath implements Path {
    ...
    public int mo1527getFillTypeRgk1Os() {
        if (this.internalPath.getFillType() == android.graphics.Path.FillType.EVEN_ODD) {
            return PathFillType.INSTANCE.m1874getEvenOddRgk1Os();
        }
        return PathFillType.INSTANCE.m1875getNonZeroRgk1Os();
    }

    @Override // androidx.compose.ui.graphics.Path
    /* JADX INFO: renamed from: setFillType-oQ8Xj4U, reason: not valid java name */
    public void mo1529setFillTypeoQ8Xj4U(int i) {
        android.graphics.Path.FillType fillType;
        android.graphics.Path path = this.internalPath;
        if (PathFillType.m1870equalsimpl0(i, PathFillType.INSTANCE.m1874getEvenOddRgk1Os())) {
    ...
    public void addRoundRect(RoundRect roundRect) {
        ...
        this.radii[0] = CornerRadius.m1370getXimpl(roundRect.m1445getTopLeftCornerRadiuskKHJgLs());
        this.radii[1] = CornerRadius.m1371getYimpl(roundRect.m1445getTopLeftCornerRadiuskKHJgLs());
        this.radii[2] = CornerRadius.m1370getXimpl(roundRect.m1446getTopRightCornerRadiuskKHJgLs());
        this.radii[3] = CornerRadius.m1371getYimpl(roundRect.m1446getTopRightCornerRadiuskKHJgLs());
        this.radii[4] = CornerRadius.m1370getXimpl(roundRect.m1444getBottomRightCornerRadiuskKHJgLs());
        this.radii[5] = CornerRadius.m1371getYimpl(roundRect.m1444getBottomRightCornerRadiuskKHJgLs());
        this.radii[6] = CornerRadius.m1370getXimpl(roundRect.m1443getBottomLeftCornerRadiuskKHJgLs());
        this.radii[7] = CornerRadius.m1371getYimpl(roundRect.m1443getBottomLeftCornerRadiuskKHJgLs());
    ...
    public void mo1526addPathUv8p0NA(Path path, long offset) {
        Intrinsics.checkNotNullParameter(path, "path");
        android.graphics.Path path2 = this.internalPath;
        if (path instanceof AndroidPath) {
            path2.addPath(((AndroidPath) path).getInternalPath(), Offset.m1395getXimpl(offset), Offset.m1396getYimpl(offset));
            return;
        }
    ...
    public void mo1530translatek4lQ0M(long offset) {
        this.mMatrix.reset();
        this.mMatrix.setTranslate(Offset.m1395getXimpl(offset), Offset.m1396getYimpl(offset));
    ...
    public boolean mo1528opN5in7k0(Path path1, Path path2, int operation) {
        android.graphics.Path.Op op;
        Intrinsics.checkNotNullParameter(path1, "path1");
        Intrinsics.checkNotNullParameter(path2, "path2");
        if (PathOperation.m1879equalsimpl0(operation, PathOperation.INSTANCE.m1883getDifferenceb3I0S0c())) {
            op = android.graphics.Path.Op.DIFFERENCE;
        } else if (PathOperation.m1879equalsimpl0(operation, PathOperation.INSTANCE.m1884getIntersectb3I0S0c())) {
            op = android.graphics.Path.Op.INTERSECT;
        } else if (PathOperation.m1879equalsimpl0(operation, PathOperation.INSTANCE.m1885getReverseDifferenceb3I0S0c())) {
            op = android.graphics.Path.Op.REVERSE_DIFFERENCE;
        } else {
            op = PathOperation.m1879equalsimpl0(operation, PathOperation.INSTANCE.m1886getUnionb3I0S0c()) ? android.graphics.Path.Op.UNION : android.graphics.Path.Op.XOR;
        }
        android.graphics.Path path = this.internalPath;
