...
public final class RenderIntent {
    ...
    private static final int Perceptual = m2006constructorimpl(0);
    private static final int Relative = m2006constructorimpl(1);
    private static final int Saturation = m2006constructorimpl(2);
    private static final int Absolute = m2006constructorimpl(3);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ RenderIntent m2005boximpl(int i) {
    ...
    public static boolean m2007equalsimpl(int i, Object obj) {
        return (obj instanceof RenderIntent) && i == ((RenderIntent) obj).getValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2008equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m2009hashCodeimpl(int i) {
    ...
    public static String m2010toStringimpl(int i) {
        if (m2008equalsimpl0(i, Perceptual)) {
            return "Perceptual";
        }
        if (m2008equalsimpl0(i, Relative)) {
            return "Relative";
        }
        if (m2008equalsimpl0(i, Saturation)) {
            return ExifInterface.TAG_SATURATION;
        }
        return m2008equalsimpl0(i, Absolute) ? "Absolute" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
