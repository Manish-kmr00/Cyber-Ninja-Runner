...
public class Connector {
    ...
    private Connector(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
        this(colorSpace, colorSpace2, ColorModel.m1989equalsimpl0(colorSpace.getModel(), ColorModel.INSTANCE.m1996getRgbxdoWZVw()) ? ColorSpaceKt.adapt$default(colorSpace, Illuminant.INSTANCE.getD50(), null, 2, null) : colorSpace, ColorModel.m1989equalsimpl0(colorSpace2.getModel(), ColorModel.INSTANCE.m1996getRgbxdoWZVw()) ? ColorSpaceKt.adapt$default(colorSpace2, Illuminant.INSTANCE.getD50(), null, 2, null) : colorSpace2, i, INSTANCE.m2003computeTransformYBCOT_4(colorSpace, colorSpace2, i), null);
    }
    ...
    public static final class RgbConnector extends Connector {
        ...
        private RgbConnector(Rgb rgb, Rgb rgb2, int i) {
            ...
            this.mTransform = m2004computeTransformYBCOT_4(rgb, rgb2, i);
        }
        ...
        private final float[] m2004computeTransformYBCOT_4(Rgb source, Rgb destination, int intent) {
            ...
            if (RenderIntent.m2008equalsimpl0(intent, RenderIntent.INSTANCE.m2012getAbsoluteuksYyKA())) {
    ...
    public static final class Companion {
        ...
        /* JADX INFO: renamed from: computeTransform-YBCOT_4, reason: not valid java name */
        public final float[] m2003computeTransformYBCOT_4(ColorSpace source, ColorSpace destination, int intent) {
            if (!RenderIntent.m2008equalsimpl0(intent, RenderIntent.INSTANCE.m2012getAbsoluteuksYyKA())) {
                return null;
            }
            boolean zM1989equalsimpl0 = ColorModel.m1989equalsimpl0(source.getModel(), ColorModel.INSTANCE.m1996getRgbxdoWZVw());
            boolean zM1989equalsimpl1 = ColorModel.m1989equalsimpl0(destination.getModel(), ColorModel.INSTANCE.m1996getRgbxdoWZVw());
            if (zM1989equalsimpl0 && zM1989equalsimpl1) {
                return null;
            }
            if (!zM1989equalsimpl0 && !zM1989equalsimpl1) {
                return null;
            }
            if (!zM1989equalsimpl0) {
                source = destination;
            }
            Rgb rgb = (Rgb) source;
            float[] xyz$ui_graphics_release = zM1989equalsimpl0 ? rgb.getWhitePoint().toXyz$ui_graphics_release() : Illuminant.INSTANCE.getD50Xyz$ui_graphics_release();
            float[] xyz$ui_graphics_release2 = zM1989equalsimpl1 ? rgb.getWhitePoint().toXyz$ui_graphics_release() : Illuminant.INSTANCE.getD50Xyz$ui_graphics_release();
        ...
        public final Connector identity$ui_graphics_release(final ColorSpace source) {
            ...
            final int iM2014getRelativeuksYyKA = RenderIntent.INSTANCE.m2014getRelativeuksYyKA();
            return new Connector(source, iM2014getRelativeuksYyKA) { // from class: androidx.compose.ui.graphics.colorspace.Connector$Companion$identity$1
                @Override // androidx.compose.ui.graphics.colorspace.Connector
                public float[] transform(float[] v) {
                    Intrinsics.checkNotNullParameter(v, "v");
                    return v;
                ...
                {
                    super(source, source, iM2014getRelativeuksYyKA, null);
                }
            };
        }
    }
