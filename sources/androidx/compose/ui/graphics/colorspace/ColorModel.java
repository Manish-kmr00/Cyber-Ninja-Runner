...
public final class ColorModel {
    ...
    public static final /* synthetic */ ColorModel m1986boximpl(long j) {
        return new ColorModel(j);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static long m1987constructorimpl(long j) {
        return j;
    }
    ...
    public static final int m1990getComponentCountimpl(long j) {
        return (int) (j >> 32);
    }
    ...
    public boolean equals(Object obj) {
        return m1988equalsimpl(this.packedValue, obj);
    }
    ...
    static {
        long j = 3;
        long j2 = j << 32;
        Rgb = m1987constructorimpl((((long) 0) & 4294967295L) | j2);
        Xyz = m1987constructorimpl((((long) 1) & 4294967295L) | j2);
        Lab = m1987constructorimpl(j2 | (((long) 2) & 4294967295L));
        Cmyk = m1987constructorimpl((j & 4294967295L) | (((long) 4) << 32));
    }

    public String toString() {
        return m1992toStringimpl(this.packedValue);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m1992toStringimpl(long j) {
        if (m1989equalsimpl0(j, Rgb)) {
            return "Rgb";
        }
        if (m1989equalsimpl0(j, Xyz)) {
            return "Xyz";
        }
        if (m1989equalsimpl0(j, Lab)) {
            return "Lab";
        }
        return m1989equalsimpl0(j, Cmyk) ? "Cmyk" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
