...
public final class AndroidPathEffect_androidKt {
    ...
    public static final PathEffect m1531actualStampedPathEffect7aD1DOk(Path shape, float f, float f2, int i) {
        Intrinsics.checkNotNullParameter(shape, "shape");
        if (shape instanceof AndroidPath) {
            return new AndroidPathEffect(new PathDashPathEffect(((AndroidPath) shape).getInternalPath(), f, f2, m1532toAndroidPathDashPathEffectStyleoQv6xUo(i)));
        }
        throw new UnsupportedOperationException("Unable to obtain android.graphics.Path");
    }

    /* JADX INFO: renamed from: toAndroidPathDashPathEffectStyle-oQv6xUo, reason: not valid java name */
    public static final PathDashPathEffect.Style m1532toAndroidPathDashPathEffectStyleoQv6xUo(int i) {
        if (StampedPathEffectStyle.m1921equalsimpl0(i, StampedPathEffectStyle.INSTANCE.m1925getMorphYpspkwk())) {
            return PathDashPathEffect.Style.MORPH;
        }
        if (StampedPathEffectStyle.m1921equalsimpl0(i, StampedPathEffectStyle.INSTANCE.m1926getRotateYpspkwk())) {
            return PathDashPathEffect.Style.ROTATE;
        }
        return StampedPathEffectStyle.m1921equalsimpl0(i, StampedPathEffectStyle.INSTANCE.m1927getTranslateYpspkwk()) ? PathDashPathEffect.Style.TRANSLATE : PathDashPathEffect.Style.TRANSLATE;
    }
}
