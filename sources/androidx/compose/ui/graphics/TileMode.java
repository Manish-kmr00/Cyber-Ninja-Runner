...
public final class TileMode {
    ...
    private static final int Clamp = m1949constructorimpl(0);
    private static final int Repeated = m1949constructorimpl(1);
    private static final int Mirror = m1949constructorimpl(2);
    private static final int Decal = m1949constructorimpl(3);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TileMode m1948boximpl(int i) {
    ...
    public boolean equals(Object obj) {
        return m1950equalsimpl(this.value, obj);
    }
    ...
    public static String m1953toStringimpl(int i) {
        if (m1951equalsimpl0(i, Clamp)) {
            return "Clamp";
        }
        if (m1951equalsimpl0(i, Repeated)) {
            return "Repeated";
        }
        if (m1951equalsimpl0(i, Mirror)) {
            return "Mirror";
        }
        return m1951equalsimpl0(i, Decal) ? "Decal" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
