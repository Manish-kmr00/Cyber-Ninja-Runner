...
public final class PointMode {
    ...
    private static final int Points = m1890constructorimpl(0);
    private static final int Lines = m1890constructorimpl(1);
    private static final int Polygon = m1890constructorimpl(2);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PointMode m1889boximpl(int i) {
    ...
    public static String m1894toStringimpl(int i) {
        if (m1892equalsimpl0(i, Points)) {
            return "Points";
        }
        if (m1892equalsimpl0(i, Lines)) {
            return "Lines";
        }
        return m1892equalsimpl0(i, Polygon) ? "Polygon" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
