...
public final class VertexMode {
    ...
    private static final int Triangles = m1975constructorimpl(0);
    private static final int TriangleStrip = m1975constructorimpl(1);
    private static final int TriangleFan = m1975constructorimpl(2);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ VertexMode m1974boximpl(int i) {
    ...
    public static final boolean m1977equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m1978hashCodeimpl(int i) {
    ...
    public int hashCode() {
        return m1978hashCodeimpl(this.value);
    }
    ...
    public String toString() {
        return m1979toStringimpl(this.value);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m1979toStringimpl(int i) {
        if (m1977equalsimpl0(i, Triangles)) {
            return "Triangles";
        }
        if (m1977equalsimpl0(i, TriangleStrip)) {
            return "TriangleStrip";
        }
        return m1977equalsimpl0(i, TriangleFan) ? "TriangleFan" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
