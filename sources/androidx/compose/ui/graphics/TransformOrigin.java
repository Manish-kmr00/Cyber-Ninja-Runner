...
public final class TransformOrigin {
    ...
    public static final /* synthetic */ TransformOrigin m1960boximpl(long j) {
        return new TransformOrigin(j);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static long m1963constructorimpl(long j) {
        return j;
    }
    ...
    public static final float m1961component1impl(long j) {
        return m1968getPivotFractionXimpl(j);
    }

    /* JADX INFO: renamed from: component2-impl, reason: not valid java name */
    public static final float m1962component2impl(long j) {
        return m1969getPivotFractionYimpl(j);
    }

    /* JADX INFO: renamed from: copy-zey9I6w$default, reason: not valid java name */
    public static /* synthetic */ long m1965copyzey9I6w$default(long j, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = m1968getPivotFractionXimpl(j);
        }
        if ((i & 2) != 0) {
            f2 = m1969getPivotFractionYimpl(j);
        }
        return m1964copyzey9I6w(j, f, f2);
    }

    /* JADX INFO: renamed from: copy-zey9I6w, reason: not valid java name */
    public static final long m1964copyzey9I6w(long j, float f, float f2) {
    ...
    public static final float m1968getPivotFractionXimpl(long j) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
        return Float.intBitsToFloat((int) (j >> 32));
    }

    /* JADX INFO: renamed from: getPivotFractionY-impl, reason: not valid java name */
    public static final float m1969getPivotFractionYimpl(long j) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
