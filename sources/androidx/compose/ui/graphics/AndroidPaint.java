...
public final class AndroidPaint implements Paint {
    ...
    private int _blendMode = BlendMode.INSTANCE.m1575getSrcOver0nO6VwU();
    ...
    public long mo1509getColor0d7_KjU() {
    ...
    public void mo1515setColor8_81llA(long j) {
        AndroidPaint_androidKt.m1521setNativeColor4WTKRHQ(this.internalPaint, j);
    }
    ...
    public void mo1514setBlendModes9anfk8(int i) {
        this._blendMode = i;
        AndroidPaint_androidKt.m1520setNativeBlendModeGB0RdKg(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* JADX INFO: renamed from: getStyle-TiuSbCo, reason: not valid java name */
    public int mo1513getStyleTiuSbCo() {
    ...
    public void mo1519setStylek9PVt8s(int i) {
        AndroidPaint_androidKt.m1525setNativeStyle5YerkU(this.internalPaint, i);
    }
    ...
    public int mo1511getStrokeCapKaPHkGw() {
    ...
    public void mo1517setStrokeCapBeK7IIE(int i) {
        AndroidPaint_androidKt.m1523setNativeStrokeCapCSYIeUk(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* JADX INFO: renamed from: getStrokeJoin-LxFBmk8, reason: not valid java name */
    public int mo1512getStrokeJoinLxFBmk8() {
    ...
    public void mo1518setStrokeJoinWw9F2mQ(int i) {
        AndroidPaint_androidKt.m1524setNativeStrokeJoinkLtJ_vA(this.internalPaint, i);
    }
    ...
    public int mo1510getFilterQualityfv9h1I() {
    ...
    public void mo1516setFilterQualityvDHp3xo(int i) {
        AndroidPaint_androidKt.m1522setNativeFilterQuality50PEsBU(this.internalPaint, i);
    }
