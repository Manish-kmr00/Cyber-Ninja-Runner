...
public abstract class Painter {
    ...
    public abstract long mo2194getIntrinsicSizeNHjbRc();
    ...
    public static /* synthetic */ void m2199drawx_KDEd0$default(Painter painter, DrawScope drawScope, long j, float f, ColorFilter colorFilter, int i, Object obj) {
        if (obj != null) {
        ...
        painter.m2200drawx_KDEd0(drawScope, j, f2, colorFilter);
    }

    /* JADX INFO: renamed from: draw-x_KDEd0, reason: not valid java name */
    public final void m2200drawx_KDEd0(DrawScope draw, long j, float f, ColorFilter colorFilter) {
        Intrinsics.checkNotNullParameter(draw, "$this$draw");
        configureAlpha(f);
        configureColorFilter(colorFilter);
        configureLayoutDirection(draw.getLayoutDirection());
        float fM1464getWidthimpl = Size.m1464getWidthimpl(draw.mo2125getSizeNHjbRc()) - Size.m1464getWidthimpl(j);
        float fM1461getHeightimpl = Size.m1461getHeightimpl(draw.mo2125getSizeNHjbRc()) - Size.m1461getHeightimpl(j);
        draw.getDrawContext().getTransform().inset(0.0f, 0.0f, fM1464getWidthimpl, fM1461getHeightimpl);
        if (f > 0.0f && Size.m1464getWidthimpl(j) > 0.0f && Size.m1461getHeightimpl(j) > 0.0f) {
            if (this.useLayer) {
                Rect rectM1435Recttz77jQw = RectKt.m1435Recttz77jQw(Offset.INSTANCE.m1411getZeroF1C5BW0(), SizeKt.Size(Size.m1464getWidthimpl(j), Size.m1461getHeightimpl(j)));
                Canvas canvas = draw.getDrawContext().getCanvas();
                try {
                    canvas.saveLayer(rectM1435Recttz77jQw, obtainPaint());
                    onDraw(draw);
                    canvas.restore();
                } catch (Throwable th) {
                    canvas.restore();
