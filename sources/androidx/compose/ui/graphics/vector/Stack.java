...
final class Stack<T> {
    ...
    public static final /* synthetic */ Stack m2216boximpl(ArrayList arrayList) {
        return new Stack(arrayList);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static <T> ArrayList<T> m2217constructorimpl(ArrayList<T> backing) {
        Intrinsics.checkNotNullParameter(backing, "backing");
        return backing;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m2219equalsimpl(ArrayList<T> arrayList, Object obj) {
        return (obj instanceof Stack) && Intrinsics.areEqual(arrayList, ((Stack) obj).getBacking());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2220equalsimpl0(ArrayList<?> arrayList, ArrayList<?> arrayList2) {
        return Intrinsics.areEqual(arrayList, arrayList2);
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m2222hashCodeimpl(ArrayList<T> arrayList) {
        return arrayList.hashCode();
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m2226toStringimpl(ArrayList<T> arrayList) {
        return "Stack(backing=" + arrayList + ')';
    }

    public boolean equals(Object obj) {
        return m2219equalsimpl(this.backing, obj);
    }

    public int hashCode() {
        return m2222hashCodeimpl(this.backing);
    }

    public String toString() {
        return m2226toStringimpl(this.backing);
    }
    ...
    public static /* synthetic */ ArrayList m2218constructorimpl$default(ArrayList arrayList, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            arrayList = new ArrayList();
        }
        return m2217constructorimpl(arrayList);
    }

    /* JADX INFO: renamed from: getSize-impl, reason: not valid java name */
    public static final int m2221getSizeimpl(ArrayList<T> arrayList) {
        return arrayList.size();
    }

    /* JADX INFO: renamed from: push-impl, reason: not valid java name */
    public static final boolean m2225pushimpl(ArrayList<T> arrayList, T t) {
        return arrayList.add(t);
    }

    /* JADX INFO: renamed from: pop-impl, reason: not valid java name */
    public static final T m2224popimpl(ArrayList<T> arrayList) {
        return arrayList.remove(m2221getSizeimpl(arrayList) - 1);
    }

    /* JADX INFO: renamed from: peek-impl, reason: not valid java name */
    public static final T m2223peekimpl(ArrayList<T> arrayList) {
        return arrayList.get(m2221getSizeimpl(arrayList) - 1);
    }
}
