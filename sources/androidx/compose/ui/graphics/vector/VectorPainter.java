...
public final class VectorPainter extends Painter {
    ...
    private final MutableState size = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m1452boximpl(Size.INSTANCE.m1473getZeroNHjbRc()), null, 2, null);
    ...
    public final long m2232getSizeNHjbRc$ui_release() {
    ...
    public final void m2233setSizeuvyYCjk$ui_release(long j) {
        this.size.setValue(Size.m1452boximpl(j));
    }
    ...
    private final Composition composeVector(CompositionContext parent, final Function4<? super Float, ? super Float, ? super Composer, ? super Integer, Unit> composable) {
        ...
        Composition.setContent(ComposableLambdaKt.composableLambdaInstance(-1916507005, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorPainter.composeVector.1
            ...
            public final void invoke(Composer composer, int i) {
                ComposerKt.sourceInformation(composer, "C212@8139L55:VectorPainter.kt#huu6hf");
    ...
    public final void RenderVector$ui_release(final String name, final float f, final float f2, final Function4<? super Float, ? super Float, ? super Composer, ? super Integer, Unit> content, Composer composer, final int i) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(RenderVector)P(1,3,2)232@8713L28,236@8782L117:VectorPainter.kt#huu6hf");
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorPainter$RenderVector$3
            ...
            public final void invoke(Composer composer2, int i2) {
                this.$tmp0_rcvr.RenderVector$ui_release(name, f, f2, content, composer2, i | 1);
            }
        });
    }
    ...
    public long getIntrinsicSize() {
        return m2232getSizeNHjbRc$ui_release();
    }
