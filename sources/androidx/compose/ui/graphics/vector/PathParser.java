...
public final class PathParser {
    ...
    /* JADX INFO: compiled from: PathParser.kt */
    @Metadata(d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0007\n\u0002\b\f\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\b\u0082\b\u0018\u00002\u00020\u0001B\u0019\u0012\b\b\u0002\u0010\u0002\u001a\u00020\u0003\u0012\b\b\u0002\u0010\u0004\u001a\u00020\u0003¢\u0006\u0002\u0010\u0005J\t\u0010\f\u001a\u00020\u0003HÆ\u0003J\t\u0010\r\u001a\u00020\u0003HÆ\u0003J\u001d\u0010\u000e\u001a\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u00032\b\b\u0002\u0010\u0004\u001a\u00020\u0003HÆ\u0001J\u0013\u0010\u000f\u001a\u00020\u00102\b\u0010\u0011\u001a\u0004\u0018\u00010\u0001HÖ\u0003J\t\u0010\u0012\u001a\u00020\u0013HÖ\u0001J\u0006\u0010\u0014\u001a\u00020\u0015J\t\u0010\u0016\u001a\u00020\u0017HÖ\u0001R\u001a\u0010\u0002\u001a\u00020\u0003X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0006\u0010\u0007\"\u0004\b\b\u0010\tR\u001a\u0010\u0004\u001a\u00020\u0003X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\n\u0010\u0007\"\u0004\b\u000b\u0010\t¨\u0006\u0018"}, d2 = {"Landroidx/compose/ui/graphics/vector/PathParser$PathPoint;", "", VastAttributes.HORIZONTAL_POSITION, "", VastAttributes.VERTICAL_POSITION, "(FF)V", "getX", "()F", "setX", "(F)V", "getY", "setY", "component1", "component2", "copy", "equals", "", "other", "hashCode", "", TimerController.RESET_COMMAND, "", "toString", "", "ui-graphics_release"}, k = 1, mv = {1, 6, 0}, xi = 48)
    ...
    private final void drawArc(Path p, double x0, double y0, double x1, double y1, double a2, double b, double theta, boolean isMoreThanHalf, boolean isPositiveArc) {
        ...
        double d16 = d * a2;
        double d17 = d2 * b;
        arcToBezier(p, (d16 * dCos) - (d17 * dSin), (d16 * dSin) + (d17 * dCos), a2, b, x0, y0, radians, dAtan2, dAtan3);
    }
    ...
    private final void arcToBezier(Path p, double cx, double cy, double a2, double b, double e1x, double e1y, double theta, double start, double sweep) {
        ...
        while (i < iCeil) {
            ...
            double d21 = d16 - d15;
            double dTan = Math.tan(d21 / ((double) 2));
            double dSin4 = (Math.sin(d21) * (Math.sqrt(d2 + ((3.0d * dTan) * dTan)) - ((double) 1))) / ((double) 3);
