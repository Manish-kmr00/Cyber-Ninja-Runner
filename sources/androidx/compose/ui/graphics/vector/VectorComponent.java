...
public final class VectorComponent extends VNode {
    ...
    public VectorComponent() {
        ...
        this.previousDrawSize = Size.INSTANCE.m1472getUnspecifiedNHjbRc();
    ...
    public final void draw(DrawScope drawScope, float f, ColorFilter colorFilter) {
        ...
        if (this.isDirty || !Size.m1460equalsimpl0(this.previousDrawSize, drawScope.mo2125getSizeNHjbRc())) {
            this.root.setScaleX(Size.m1464getWidthimpl(drawScope.mo2125getSizeNHjbRc()) / this.viewportWidth);
            this.root.setScaleY(Size.m1461getHeightimpl(drawScope.mo2125getSizeNHjbRc()) / this.viewportHeight);
            this.cacheDrawScope.m2201drawCachedImageCJJARo(IntSizeKt.IntSize((int) Math.ceil(Size.m1464getWidthimpl(drawScope.mo2125getSizeNHjbRc())), (int) Math.ceil(Size.m1461getHeightimpl(drawScope.mo2125getSizeNHjbRc()))), drawScope, drawScope.getLayoutDirection(), this.drawVectorBlock);
            this.isDirty = false;
            this.previousDrawSize = drawScope.mo2125getSizeNHjbRc();
        }
