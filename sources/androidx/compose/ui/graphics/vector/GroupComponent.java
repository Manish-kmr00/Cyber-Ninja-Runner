...
public final class GroupComponent extends VNode {
    ...
    private final void updateMatrix() {
        float[] fArrM1825constructorimpl$default = this.groupMatrix;
        if (fArrM1825constructorimpl$default == null) {
            fArrM1825constructorimpl$default = Matrix.m1825constructorimpl$default(null, 1, null);
            this.groupMatrix = fArrM1825constructorimpl$default;
        } else {
            Matrix.m1834resetimpl(fArrM1825constructorimpl$default);
        }
        Matrix.m1845translateimpl$default(fArrM1825constructorimpl$default, this.pivotX + this.translationX, this.pivotY + this.translationY, 0.0f, 4, null);
        Matrix.m1837rotateZimpl(fArrM1825constructorimpl$default, this.rotation);
        Matrix.m1838scaleimpl(fArrM1825constructorimpl$default, this.scaleX, this.scaleY, 1.0f);
        Matrix.m1845translateimpl$default(fArrM1825constructorimpl$default, -this.pivotX, -this.pivotY, 0.0f, 4, null);
    }
    ...
    public void draw(DrawScope drawScope) {
        ...
        if (fArr != null) {
            transform.mo2058transform58bKbWc((fArr != null ? Matrix.m1823boximpl(fArr) : null).m1846unboximpl());
        }
        Path path = this.clipPath;
        if (getWillClipPath() && path != null) {
            DrawTransform.m2175clipPathmtrdDE$default(transform, path, 0, 2, null);
        }
        List<VNode> list = this.children;
        int size = list.size();
        for (int i = 0; i < size; i++) {
