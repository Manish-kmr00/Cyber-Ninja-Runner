...
public final class XmlVectorParser_androidKt {
    ...
    static /* synthetic */ int m2240getStrokeLineCapCSYIeUk$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeCap.INSTANCE.m1935getButtKaPHkGw();
        }
        return m2239getStrokeLineCapCSYIeUk(i, i2);
    }

    /* JADX INFO: renamed from: getStrokeLineCap-CSYIeUk, reason: not valid java name */
    private static final int m2239getStrokeLineCapCSYIeUk(int i, int i2) {
        if (i == 0) {
            return StrokeCap.INSTANCE.m1935getButtKaPHkGw();
        }
        if (i != 1) {
            return i != 2 ? i2 : StrokeCap.INSTANCE.m1937getSquareKaPHkGw();
        }
        return StrokeCap.INSTANCE.m1936getRoundKaPHkGw();
    }

    /* JADX INFO: renamed from: getStrokeLineJoin-kLtJ_vA$default, reason: not valid java name */
    static /* synthetic */ int m2242getStrokeLineJoinkLtJ_vA$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeJoin.INSTANCE.m1946getMiterLxFBmk8();
        }
        return m2241getStrokeLineJoinkLtJ_vA(i, i2);
    }

    /* JADX INFO: renamed from: getStrokeLineJoin-kLtJ_vA, reason: not valid java name */
    private static final int m2241getStrokeLineJoinkLtJ_vA(int i, int i2) {
        if (i == 0) {
            return StrokeJoin.INSTANCE.m1946getMiterLxFBmk8();
        }
        if (i != 1) {
            return i != 2 ? i2 : StrokeJoin.INSTANCE.m1945getBevelLxFBmk8();
        }
        return StrokeJoin.INSTANCE.m1947getRoundLxFBmk8();
    }
    ...
    public static final int parseCurrentVectorNode(AndroidVectorParser androidVectorParser, Resources res, AttributeSet attrs, Resources.Theme theme, ImageVector.Builder builder, int i) throws XmlPullParserException {
    ...
    public static final ImageVector.Builder createVectorImageBuilder(AndroidVectorParser androidVectorParser, Resources res, Resources.Theme theme, AttributeSet attrs) throws XmlPullParserException {
        long jM1667getUnspecified0d7_KjU;
        int iM1573getSrcIn0nO6VwU;
        ...
        if (typedArrayObtainAttributes.hasValue(AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
            ...
            if (typedValue.type != 2 && (namedColorStateList = androidVectorParser.getNamedColorStateList(typedArrayObtainAttributes, theme, "tint", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) != null) {
                jM1667getUnspecified0d7_KjU = ColorKt.Color(namedColorStateList.getDefaultColor());
            } else {
        ...
        long j = jM1667getUnspecified0d7_KjU;
        ...
        if (i == -1) {
            iM1573getSrcIn0nO6VwU = BlendMode.INSTANCE.m1573getSrcIn0nO6VwU();
        } else if (i == 3) {
            iM1573getSrcIn0nO6VwU = BlendMode.INSTANCE.m1575getSrcOver0nO6VwU();
        } else if (i == 5) {
            iM1573getSrcIn0nO6VwU = BlendMode.INSTANCE.m1573getSrcIn0nO6VwU();
        } else if (i == 9) {
            iM1573getSrcIn0nO6VwU = BlendMode.INSTANCE.m1572getSrcAtop0nO6VwU();
        } else {
            switch (i) {
                case 14:
                    iM1573getSrcIn0nO6VwU = BlendMode.INSTANCE.m1564getModulate0nO6VwU();
                    break;
                case 15:
                    iM1573getSrcIn0nO6VwU = BlendMode.INSTANCE.m1569getScreen0nO6VwU();
                    break;
                case 16:
                    iM1573getSrcIn0nO6VwU = BlendMode.INSTANCE.m1567getPlus0nO6VwU();
                    break;
                default:
                    iM1573getSrcIn0nO6VwU = BlendMode.INSTANCE.m1573getSrcIn0nO6VwU();
                    break;
        ...
        int i2 = iM1573getSrcIn0nO6VwU;
        float fM3843constructorimpl = Dp.m3843constructorimpl(dimension / res.getDisplayMetrics().density);
        float fM3843constructorimpl2 = Dp.m3843constructorimpl(dimension2 / res.getDisplayMetrics().density);
        typedArrayObtainAttributes.recycle();
        return new ImageVector.Builder(null, fM3843constructorimpl, fM3843constructorimpl2, namedFloat, namedFloat2, j, i2, namedBoolean, 1, null);
    }
    ...
    public static final void parsePath(AndroidVectorParser androidVectorParser, Resources res, Resources.Theme theme, AttributeSet attrs, ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        Intrinsics.checkNotNullParameter(attrs, "attrs");
        Intrinsics.checkNotNullParameter(builder, "builder");
        TypedArray typedArrayObtainAttributes = androidVectorParser.obtainAttributes(res, theme, attrs, AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH());
        ...
        String str = string;
        List<PathNode> listAddPathNodes = VectorKt.addPathNodes(androidVectorParser.getString(typedArrayObtainAttributes, AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_PATH_DATA()));
        ...
        int iM2239getStrokeLineCapCSYIeUk = m2239getStrokeLineCapCSYIeUk(androidVectorParser.getNamedInt(typedArrayObtainAttributes, "strokeLineCap", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_CAP(), -1), StrokeCap.INSTANCE.m1935getButtKaPHkGw());
        int iM2241getStrokeLineJoinkLtJ_vA = m2241getStrokeLineJoinkLtJ_vA(androidVectorParser.getNamedInt(typedArrayObtainAttributes, "strokeLineJoin", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_JOIN(), -1), StrokeJoin.INSTANCE.m1945getBevelLxFBmk8());
        ...
        builder.m2207addPathoIyEayM(listAddPathNodes, namedInt == 0 ? companion.m1875getNonZeroRgk1Os() : companion.m1874getEvenOddRgk1Os(), str, brushObtainBrushFromComplexColor, namedFloat, brushObtainBrushFromComplexColor2, namedFloat3, namedFloat4, iM2239getStrokeLineCapCSYIeUk, iM2241getStrokeLineJoinkLtJ_vA, namedFloat2, namedFloat7, namedFloat5, namedFloat6);
    }
    ...
    public static final void parseClipPath(AndroidVectorParser androidVectorParser, Resources res, Resources.Theme theme, AttributeSet attrs, ImageVector.Builder builder) {
        ...
        Intrinsics.checkNotNullParameter(attrs, "attrs");
        Intrinsics.checkNotNullParameter(builder, "builder");
        TypedArray typedArrayObtainAttributes = androidVectorParser.obtainAttributes(res, theme, attrs, AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_CLIP_PATH());
    ...
    public static final void parseGroup(AndroidVectorParser androidVectorParser, Resources res, Resources.Theme theme, AttributeSet attrs, ImageVector.Builder builder) {
        ...
        Intrinsics.checkNotNullParameter(attrs, "attrs");
        Intrinsics.checkNotNullParameter(builder, "builder");
        TypedArray typedArrayObtainAttributes = androidVectorParser.obtainAttributes(res, theme, attrs, AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_GROUP());
