...
final class BlendModeColorFilterHelper {
    ...
    public final BlendModeColorFilter m1577BlendModeColorFilterxETnrds(long color, int blendMode) {
        return new BlendModeColorFilter(ColorKt.m1686toArgb8_81llA(color), AndroidBlendMode_androidKt.m1487toAndroidBlendModes9anfk8(blendMode));
    }
}
