...
final /* data */ class PointAtTime {
    ...
    public static /* synthetic */ PointAtTime m3088copy3MmeM6k$default(PointAtTime pointAtTime, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
            j = pointAtTime.point;
        }
        if ((i & 2) != 0) {
        ...
        return pointAtTime.m3090copy3MmeM6k(j, j2);
    }
    ...
    public final PointAtTime m3090copy3MmeM6k(long point, long time) {
    ...
    public boolean equals(Object other) {
        ...
        return Offset.m1392equalsimpl0(this.point, pointAtTime.point) && this.time == pointAtTime.time;
    }

    public int hashCode() {
        return (Offset.m1397hashCodeimpl(this.point) * 31) + Long.hashCode(this.time);
    }

    public String toString() {
        return "PointAtTime(point=" + ((Object) Offset.m1403toStringimpl(this.point)) + ", time=" + this.time + ')';
    }
    ...
    public final long m3091getPointF1C5BW0() {
        return this.point;
    }
