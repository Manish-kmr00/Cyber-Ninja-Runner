...
final /* data */ class VelocityEstimate {
    ...
    private static final VelocityEstimate None = new VelocityEstimate(Offset.INSTANCE.m1411getZeroF1C5BW0(), 1.0f, 0, Offset.INSTANCE.m1411getZeroF1C5BW0(), null);
    ...
    public final VelocityEstimate m3095copyPZAlG8E(long pixelsPerSecond, float confidence, long durationMillis, long offset) {
    ...
    public boolean equals(Object other) {
        ...
        return Offset.m1392equalsimpl0(this.pixelsPerSecond, velocityEstimate.pixelsPerSecond) && Intrinsics.areEqual((Object) Float.valueOf(this.confidence), (Object) Float.valueOf(velocityEstimate.confidence)) && this.durationMillis == velocityEstimate.durationMillis && Offset.m1392equalsimpl0(this.offset, velocityEstimate.offset);
    }

    public int hashCode() {
        return (((((Offset.m1397hashCodeimpl(this.pixelsPerSecond) * 31) + Float.hashCode(this.confidence)) * 31) + Long.hashCode(this.durationMillis)) * 31) + Offset.m1397hashCodeimpl(this.offset);
    }

    public String toString() {
        return "VelocityEstimate(pixelsPerSecond=" + ((Object) Offset.m1403toStringimpl(this.pixelsPerSecond)) + ", confidence=" + this.confidence + ", durationMillis=" + this.durationMillis + ", offset=" + ((Object) Offset.m1403toStringimpl(this.offset)) + ')';
    }
    ...
    public final long m3097getPixelsPerSecondF1C5BW0() {
        return this.pixelsPerSecond;
    }
    ...
    public final long m3096getOffsetF1C5BW0() {
        return this.offset;
    }
