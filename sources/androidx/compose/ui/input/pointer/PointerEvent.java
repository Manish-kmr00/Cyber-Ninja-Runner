...
public final class PointerEvent {
    ...
    public PointerEvent(List<PointerInputChange> changes, InternalPointerEvent internalPointerEvent) {
        ...
        this.buttons = PointerButtons.m2935constructorimpl(motionEvent$ui_release != null ? motionEvent$ui_release.getButtonState() : 0);
        MotionEvent motionEvent$ui_release2 = getMotionEvent$ui_release();
        this.keyboardModifiers = PointerKeyboardModifiers.m3059constructorimpl(motionEvent$ui_release2 != null ? motionEvent$ui_release2.getMetaState() : 0);
        this.type = m2941calculatePointerEventType7fucELk();
    }
    ...
    public final void m2945setTypeEhbLWgg$ui_release(int i) {
        this.type = i;
    }

    /* JADX INFO: renamed from: calculatePointerEventType-7fucELk, reason: not valid java name */
    private final int m2941calculatePointerEventType7fucELk() {
        MotionEvent motionEvent$ui_release = getMotionEvent$ui_release();
                    ...
                    if (actionMasked != 2) {
                        switch (actionMasked) {
                            ...
                            case 7:
                                break;
                            case 8:
                                return PointerEventType.INSTANCE.m2960getScroll7fucELk();
                            case 9:
                                return PointerEventType.INSTANCE.m2955getEnter7fucELk();
                            case 10:
                                return PointerEventType.INSTANCE.m2956getExit7fucELk();
                            default:
                                return PointerEventType.INSTANCE.m2961getUnknown7fucELk();
                        }
                    }
                    return PointerEventType.INSTANCE.m2957getMove7fucELk();
                }
                return PointerEventType.INSTANCE.m2959getRelease7fucELk();
            }
            return PointerEventType.INSTANCE.m2958getPress7fucELk();
        }
    ...
    public final PointerEvent copy(List<PointerInputChange> changes, MotionEvent motionEvent) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            linkedHashMap.put(PointerId.m2981boximpl(pointerInputChange.getId()), pointerInputChange);
        }
        ...
        while (i2 < size2) {
            ...
            if (internalPointerEvent != null) {
                z = true;
                if (!internalPointerEvent.m2931issuesEnterExitEvent0FcD4WY(pointerInputChange2.getId())) {
                    z = false;
                }
            } else {
                z = false;
