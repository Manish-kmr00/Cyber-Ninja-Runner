...
final class PointerInputChangeEventProducer {
    ...
    public final InternalPointerEvent produce(PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            PointerInputData pointerInputData = this.previousPointerInputData.get(PointerId.m2981boximpl(pointerInputEventData.m3010getIdJ3iCeTQ()));
            if (pointerInputData == null) {
                uptime = pointerInputEventData.getUptime();
                jMo3078screenToLocalMKHz9U = pointerInputEventData.m3011getPositionF1C5BW0();
                down = false;
            } else {
                long uptime2 = pointerInputData.getUptime();
                uptime = uptime2;
                down = pointerInputData.getDown();
                jMo3078screenToLocalMKHz9U = positionCalculator.mo3078screenToLocalMKHz9U(pointerInputData.getPositionOnScreen());
            }
            linkedHashMap.put(PointerId.m2981boximpl(pointerInputEventData.m3010getIdJ3iCeTQ()), new PointerInputChange(pointerInputEventData.m3010getIdJ3iCeTQ(), pointerInputEventData.getUptime(), pointerInputEventData.m3011getPositionF1C5BW0(), pointerInputEventData.getDown(), uptime, jMo3078screenToLocalMKHz9U, down, false, pointerInputEventData.m3014getTypeT8wyACA(), (List) pointerInputEventData.getHistorical(), pointerInputEventData.m3013getScrollDeltaF1C5BW0(), (DefaultConstructorMarker) null));
            if (pointerInputEventData.getDown()) {
                this.previousPointerInputData.put(PointerId.m2981boximpl(pointerInputEventData.m3010getIdJ3iCeTQ()), new PointerInputData(pointerInputEventData.getUptime(), pointerInputEventData.m3012getPositionOnScreenF1C5BW0(), pointerInputEventData.getDown(), pointerInputEventData.m3014getTypeT8wyACA(), null));
            } else {
                this.previousPointerInputData.remove(PointerId.m2981boximpl(pointerInputEventData.m3010getIdJ3iCeTQ()));
            }
        }
