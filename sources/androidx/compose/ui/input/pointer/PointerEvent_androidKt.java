...
public final class PointerEvent_androidKt {
    ...
    public static final boolean m2962getAreAnyPressedaHzCxE(int i) {
        return i != 0;
    }

    /* JADX INFO: renamed from: indexOfFirstPressed-aHzCx-E, reason: not valid java name */
    public static final int m2963indexOfFirstPressedaHzCxE(int i) {
        if (i == 0) {
            return -1;
        }
        int i2 = 0;
    ...
    public static final int m2964indexOfLastPressedaHzCxE(int i) {
        int i2 = -1;
