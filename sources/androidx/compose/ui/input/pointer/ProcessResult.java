...
public final class ProcessResult {
    ...
    public static final /* synthetic */ ProcessResult m3079boximpl(int i) {
    ...
    public static final boolean m3083getAnyMovementConsumedimpl(int i) {
        return (i & 2) != 0;
    }

    /* JADX INFO: renamed from: getDispatchedToAPointerInputModifier-impl, reason: not valid java name */
    public static final boolean m3084getDispatchedToAPointerInputModifierimpl(int i) {
        return (i & 1) != 0;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m3085hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m3086toStringimpl(int i) {
        return "ProcessResult(value=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m3081equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m3085hashCodeimpl(this.value);
    }

    public String toString() {
        return m3086toStringimpl(this.value);
    }
