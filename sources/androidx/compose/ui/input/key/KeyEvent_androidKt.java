...
public final class KeyEvent_androidKt {
    ...
    public static final long m2865getKeyZmokQxo(android.view.KeyEvent key) {
    ...
    public static final int m2867getUtf16CodePointZmokQxo(android.view.KeyEvent utf16CodePoint) {
    ...
    public static final int m2866getTypeZmokQxo(android.view.KeyEvent type) {
        Intrinsics.checkNotNullParameter(type, "$this$type");
        int action = type.getAction();
        if (action == 0) {
            return KeyEventType.INSTANCE.m2862getKeyDownCS__XNY();
        }
        if (action == 1) {
            return KeyEventType.INSTANCE.m2863getKeyUpCS__XNY();
        }
        return KeyEventType.INSTANCE.m2864getUnknownCS__XNY();
    }

    /* JADX INFO: renamed from: isAltPressed-ZmokQxo, reason: not valid java name */
    public static final boolean m2868isAltPressedZmokQxo(android.view.KeyEvent isAltPressed) {
    ...
    public static final boolean m2869isCtrlPressedZmokQxo(android.view.KeyEvent isCtrlPressed) {
    ...
    public static final boolean m2870isMetaPressedZmokQxo(android.view.KeyEvent isMetaPressed) {
    ...
    public static final boolean m2871isShiftPressedZmokQxo(android.view.KeyEvent isShiftPressed) {
