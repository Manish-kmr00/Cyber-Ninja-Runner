...
public final class NestedScrollSource {
    ...
    public static final /* synthetic */ NestedScrollSource m2890boximpl(int i) {
        return new NestedScrollSource(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m2891constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m2892equalsimpl(int i, Object obj) {
        return (obj instanceof NestedScrollSource) && i == ((NestedScrollSource) obj).getValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2893equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m2894hashCodeimpl(int i) {
    ...
    public static String m2895toStringimpl(int i) {
        if (m2893equalsimpl0(i, Drag)) {
            return "Drag";
        }
        if (m2893equalsimpl0(i, Fling)) {
            return "Fling";
        }
        if (m2893equalsimpl0(i, Relocate)) {
            return "Relocate";
        }
        return "Invalid";
    }
