...
public final class HapticFeedbackType {
    ...
    public static final /* synthetic */ HapticFeedbackType m2244boximpl(int i) {
        return new HapticFeedbackType(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m2245constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m2246equalsimpl(int i, Object obj) {
        return (obj instanceof HapticFeedbackType) && i == ((HapticFeedbackType) obj).getValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2247equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m2248hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object obj) {
        return m2246equalsimpl(this.value, obj);
    }
    ...
    public static String m2249toStringimpl(int i) {
        ...
        if (m2247equalsimpl0(i, companion.m2251getLongPress5zf0vsI())) {
            return "LongPress";
        }
        return m2247equalsimpl0(i, companion.m2252getTextHandleMove5zf0vsI()) ? "TextHandleMove" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public final int m2251getLongPress5zf0vsI() {
            return PlatformHapticFeedbackType.INSTANCE.m2253getLongPress5zf0vsI();
        }

        /* JADX INFO: renamed from: getTextHandleMove-5zf0vsI, reason: not valid java name */
        public final int m2252getTextHandleMove5zf0vsI() {
            return PlatformHapticFeedbackType.INSTANCE.m2254getTextHandleMove5zf0vsI();
        }

        public final List<HapticFeedbackType> values() {
            return CollectionsKt.listOf((Object[]) new HapticFeedbackType[]{HapticFeedbackType.m2244boximpl(m2251getLongPress5zf0vsI()), HapticFeedbackType.m2244boximpl(m2252getTextHandleMove5zf0vsI())});
        }
    }
}
