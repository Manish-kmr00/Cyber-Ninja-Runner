...
public final /* data */ class Rect {
    ...
    public static /* synthetic */ void m1420getSizeNHjbRc$annotations() {
    }
    ...
    public final long m1428getSizeNHjbRc() {
    ...
    public final Rect m1432translatek4lQ0M(long offset) {
        return new Rect(this.left + Offset.m1395getXimpl(offset), this.top + Offset.m1396getYimpl(offset), this.right + Offset.m1395getXimpl(offset), this.bottom + Offset.m1396getYimpl(offset));
    }
    ...
    public final long m1427getCenterRightF1C5BW0() {
    ...
    public final long m1424getBottomRightF1C5BW0() {
        return OffsetKt.Offset(this.right, this.bottom);
    }

    /* JADX INFO: renamed from: contains-k-4lQ0M, reason: not valid java name */
    public final boolean m1421containsk4lQ0M(long offset) {
        return Offset.m1395getXimpl(offset) >= this.left && Offset.m1395getXimpl(offset) < this.right && Offset.m1396getYimpl(offset) >= this.top && Offset.m1396getYimpl(offset) < this.bottom;
    }
