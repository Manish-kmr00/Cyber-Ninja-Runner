...
public final class Size {
    ...
    public static final /* synthetic */ Size m1452boximpl(long j) {
        return new Size(j);
    }
    ...
    public boolean equals(Object obj) {
        return m1459equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m1465hashCodeimpl(this.packedValue);
    }
    ...
    public static final float m1464getWidthimpl(long j) {
        if (j == Unspecified) {
    ...
    public static final float m1461getHeightimpl(long j) {
        if (j == Unspecified) {
            throw new IllegalStateException("Size is unspecified".toString());
        }
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
    ...
    public static final float m1453component1impl(long j) {
        return m1464getWidthimpl(j);
    }

    /* JADX INFO: renamed from: component2-impl, reason: not valid java name */
    public static final float m1454component2impl(long j) {
        return m1461getHeightimpl(j);
    }

    /* JADX INFO: renamed from: copy-xjbvk4A, reason: not valid java name */
    public static final long m1456copyxjbvk4A(long j, float f, float f2) {
        return SizeKt.Size(f, f2);
    }

    /* JADX INFO: renamed from: copy-xjbvk4A$default, reason: not valid java name */
    public static /* synthetic */ long m1457copyxjbvk4A$default(long j, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = m1464getWidthimpl(j);
        }
        if ((i & 2) != 0) {
            f2 = m1461getHeightimpl(j);
        }
        return m1456copyxjbvk4A(j, f, f2);
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m1470getUnspecifiedNHjbRc$annotations() {
        }

        /* JADX INFO: renamed from: getZero-NH-jbRc$annotations, reason: not valid java name */
        public static /* synthetic */ void m1471getZeroNHjbRc$annotations() {
        }
        ...
        public final long m1473getZeroNHjbRc() {
            return Size.Zero;
        }

        /* JADX INFO: renamed from: getUnspecified-NH-jbRc, reason: not valid java name */
        public final long m1472getUnspecifiedNHjbRc() {
            return Size.Unspecified;
        }
    }

    /* JADX INFO: renamed from: isEmpty-impl, reason: not valid java name */
    public static final boolean m1466isEmptyimpl(long j) {
        return m1464getWidthimpl(j) <= 0.0f || m1461getHeightimpl(j) <= 0.0f;
    }

    /* JADX INFO: renamed from: times-7Ah8Wj8, reason: not valid java name */
    public static final long m1467times7Ah8Wj8(long j, float f) {
        return SizeKt.Size(m1464getWidthimpl(j) * f, m1461getHeightimpl(j) * f);
    }

    /* JADX INFO: renamed from: div-7Ah8Wj8, reason: not valid java name */
    public static final long m1458div7Ah8Wj8(long j, float f) {
        return SizeKt.Size(m1464getWidthimpl(j) / f, m1461getHeightimpl(j) / f);
    }

    /* JADX INFO: renamed from: getMinDimension-impl, reason: not valid java name */
    public static final float m1463getMinDimensionimpl(long j) {
        return Math.min(Math.abs(m1464getWidthimpl(j)), Math.abs(m1461getHeightimpl(j)));
    }

    /* JADX INFO: renamed from: getMaxDimension-impl, reason: not valid java name */
    public static final float m1462getMaxDimensionimpl(long j) {
        return Math.max(Math.abs(m1464getWidthimpl(j)), Math.abs(m1461getHeightimpl(j)));
    }

    public String toString() {
        return m1468toStringimpl(this.packedValue);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m1468toStringimpl(long j) {
        if (j != INSTANCE.m1472getUnspecifiedNHjbRc()) {
            return "Size(" + GeometryUtilsKt.toStringAsFixed(m1464getWidthimpl(j), 1) + ", " + GeometryUtilsKt.toStringAsFixed(m1461getHeightimpl(j), 1) + ')';
        }
        return "Size.Unspecified";
    }
}
