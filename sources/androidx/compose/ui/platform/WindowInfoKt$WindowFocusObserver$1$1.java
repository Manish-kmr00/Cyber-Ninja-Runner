...
final class WindowInfoKt$WindowFocusObserver$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (flowSnapshotFlow.collect(new FlowCollector<Boolean>() { // from class: androidx.compose.ui.platform.WindowInfoKt$WindowFocusObserver$1$1.2
                ...
                public final Object emit(boolean z, Continuation<? super Unit> continuation) {
                    Unit unitInvoke = state.getValue().invoke(Boxing.boxBoolean(z));
                    return unitInvoke == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? unitInvoke : Unit.INSTANCE;
                }
