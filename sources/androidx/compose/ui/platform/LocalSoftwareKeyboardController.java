...
public final class LocalSoftwareKeyboardController {
    ...
    public final SoftwareKeyboardController getCurrent(Composer composer, int i) {
        ...
        SoftwareKeyboardController softwareKeyboardControllerDelegatingController = (SoftwareKeyboardController) objConsume;
    ...
    private final SoftwareKeyboardController delegatingController(Composer composer, int i) {
        ...
        ComposerKt.sourceInformationMarkerStart(composer, 2023513938, "C:CompositionLocal.kt#9igjgp");
        Object objConsume = composer.consume(localTextInputService);
        ComposerKt.sourceInformationMarkerEnd(composer);
        TextInputService textInputService = (TextInputService) objConsume;
        ...
        composer.endReplaceableGroup();
        composer.endReplaceableGroup();
        return (DelegatingSoftwareKeyboardController) objRememberedValue;
    }
