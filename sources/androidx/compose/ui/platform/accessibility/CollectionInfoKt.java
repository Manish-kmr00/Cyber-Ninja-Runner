...
public final class CollectionInfoKt {
    public static final void setCollectionInfo(SemanticsNode node, AccessibilityNodeInfoCompat info) {
        ...
        info.setCollectionInfo(AccessibilityNodeInfoCompat.CollectionInfoCompat.obtain(zCalculateIfHorizontallyStacked ? 1 : arrayList2.size(), zCalculateIfHorizontallyStacked ? arrayList2.size() : 1, false, 0));
    }
        ...
        if ((collectionInfo == null || !isLazyCollection(collectionInfo)) && node.getConfig().contains(SemanticsProperties.INSTANCE.getSelected())) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (semanticsNode2.getId() == node.getId()) {
                    AccessibilityNodeInfoCompat.CollectionItemInfoCompat collectionItemInfoCompatObtain = AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(zCalculateIfHorizontallyStacked ? 0 : i2, 1, zCalculateIfHorizontallyStacked ? i2 : 0, 1, false, ((Boolean) semanticsNode2.getConfig().getOrElse(SemanticsProperties.INSTANCE.getSelected(), new Function0<Boolean>() { // from class: androidx.compose.ui.platform.accessibility.CollectionInfoKt$setCollectionItemInfo$2$itemInfo$1
    ...
    private static final boolean calculateIfHorizontallyStacked(List<SemanticsNode> list) {
        ...
        if (list.size() == 0 || list.size() == 1) {
            ...
            while (i < lastIndex) {
                ...
                arrayListEmptyList.add(Offset.m1384boximpl(OffsetKt.Offset(Math.abs(Offset.m1395getXimpl(semanticsNode4.getBoundsInRoot().m1425getCenterF1C5BW0()) - Offset.m1395getXimpl(semanticsNode3.getBoundsInRoot().m1425getCenterF1C5BW0())), Math.abs(Offset.m1396getYimpl(semanticsNode4.getBoundsInRoot().m1425getCenterF1C5BW0()) - Offset.m1396getYimpl(semanticsNode3.getBoundsInRoot().m1425getCenterF1C5BW0())))));
        ...
        if (arrayListEmptyList.size() == 1) {
            ...
            if (1 <= lastIndex2) {
                int i2 = 1;
                while (true) {
                    objFirst = Offset.m1384boximpl(Offset.m1400plusMKHz9U(((Offset) objFirst).getPackedValue(), ((Offset) arrayListEmptyList.get(i2)).getPackedValue()));
                    if (i2 == lastIndex2) {
                        break;
                    }
                    i2++;
        ...
        return Offset.m1386component2impl(packedValue) < Offset.m1385component1impl(packedValue);
    }
