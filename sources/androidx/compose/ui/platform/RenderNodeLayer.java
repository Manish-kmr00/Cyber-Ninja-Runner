...
public final class RenderNodeLayer implements OwnedLayer, GraphicLayerInfo {
    ...
    public RenderNodeLayer(AndroidComposeView ownerView, Function1<? super Canvas, Unit> drawBlock, Function0<Unit> invalidateParentLayer) {
        ...
        this.transformOrigin = TransformOrigin.INSTANCE.m1973getCenterSzJe1aQ();
    ...
    public void mo3295updateLayerPropertiesNHXXZp8(float scaleX, float scaleY, float alpha, float translationX, float translationY, float shadowElevation, float rotationX, float rotationY, float rotationZ, float cameraDistance, long transformOrigin, Shape shape, boolean clip, RenderEffect renderEffect, long ambientShadowColor, long spotShadowColor, LayoutDirection layoutDirection, Density density) {
        ...
        this.renderNode.setAmbientShadowColor(ColorKt.m1686toArgb8_81llA(ambientShadowColor));
        this.renderNode.setSpotShadowColor(ColorKt.m1686toArgb8_81llA(spotShadowColor));
        ...
        this.renderNode.setPivotX(TransformOrigin.m1968getPivotFractionXimpl(transformOrigin) * this.renderNode.getWidth());
        this.renderNode.setPivotY(TransformOrigin.m1969getPivotFractionYimpl(transformOrigin) * this.renderNode.getHeight());
    ...
    public boolean mo3291isInLayerk4lQ0M(long position) {
        ...
        if (this.renderNode.getClipToBounds()) {
            return 0.0f <= fM1395getXimpl && fM1395getXimpl < ((float) this.renderNode.getWidth()) && 0.0f <= fM1396getYimpl && fM1396getYimpl < ((float) this.renderNode.getHeight());
        }
    ...
    public void mo3294resizeozmzZPI(long size) {
        ...
        this.renderNode.setPivotX(TransformOrigin.m1968getPivotFractionXimpl(this.transformOrigin) * f);
        float f2 = iM4002getHeightimpl;
        this.renderNode.setPivotY(TransformOrigin.m1969getPivotFractionYimpl(this.transformOrigin) * f2);
        DeviceRenderNode deviceRenderNode = this.renderNode;
        if (deviceRenderNode.setPosition(deviceRenderNode.getLeft(), this.renderNode.getTop(), this.renderNode.getLeft() + iM4003getWidthimpl, this.renderNode.getTop() + iM4002getHeightimpl)) {
    ...
    public void mo3293movegyyYBs(long position) {
        ...
        if (left == iM3961getXimpl && top == iM3962getYimpl) {
            return;
        }
        this.renderNode.offsetLeftAndRight(iM3961getXimpl - left);
        this.renderNode.offsetTopAndBottom(iM3962getYimpl - top);
        triggerRepaint();
        this.matrixCache.invalidate();
    }
    ...
    public void drawLayer(Canvas canvas) {
        ...
        canvas.mo1491concat58bKbWc(this.matrixCache.m3342calculateMatrixGrdbGEg(this.renderNode));
    ...
    public long mo3292mapOffset8S9VItk(long point, boolean inverse) {
        if (inverse) {
            float[] fArrM3341calculateInverseMatrixbWbORWo = this.matrixCache.m3341calculateInverseMatrixbWbORWo(this.renderNode);
        ...
        return androidx.compose.ui.graphics.Matrix.m1831mapMKHz9U(this.matrixCache.m3342calculateMatrixGrdbGEg(this.renderNode), point);
    }
    ...
    public void mapBounds(MutableRect rect, boolean inverse) {
        ...
        androidx.compose.ui.graphics.Matrix.m1833mapimpl(this.matrixCache.m3342calculateMatrixGrdbGEg(this.renderNode), rect);
    }
