...
final class WrappedComposition implements Composition, LifecycleEventObserver {
    ...
    public WrappedComposition(AndroidComposeView owner, Composition original) {
        ...
        this.lastContent = ComposableSingletons$Wrapper_androidKt.INSTANCE.m3326getLambda1$ui_release();
    }
                ...
                if (WrappedComposition.this.addedToLifecycle == null) {
                    ...
                    original.setContent(ComposableLambdaKt.composableLambdaInstance(-2000640158, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.platform.WrappedComposition.setContent.1.1
                        ...
                        public final void invoke(Composer composer, int i) {
                            ComposerKt.sourceInformation(composer, "C152@6048L61,153@6134L56,155@6216L176:Wrapper.android.kt#itgzvw");
                            if ((i & 11) != 2 || !composer.getSkipping()) {
                                ...
                                EffectsKt.LaunchedEffect(wrappedComposition.getOwner(), new C00971(wrappedComposition, null), composer, 8);
                                ...
                                CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer, -1193460702, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.platform.WrappedComposition.setContent.1.1.3
                                    ...
                                    public final void invoke(Composer composer2, int i2) {
                                        ComposerKt.sourceInformation(composer2, "C156@6319L47:Wrapper.android.kt#itgzvw");
                        ...
                        static final class C00971 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                            ...
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            C00971(WrappedComposition wrappedComposition, Continuation<? super C00971> continuation) {
                            ...
                            public final Object invokeSuspend(Object obj) throws Throwable {
                                ...
                                if (i == 0) {
                                    ...
                                    this.label = 1;
                                    if (this.this$0.getOwner().keyboardVisibilityEventLoop(this) == coroutine_suspended) {
