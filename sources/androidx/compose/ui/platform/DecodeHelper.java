...
public final class DecodeHelper {
    ...
    public final SpanStyle decodeSpanStyle() {
        ...
        while (this.parcel.dataAvail() > 1) {
            ...
            if (bDecodeByte != 1) {
                ...
                if (bDecodeByte == 2) {
                    if (dataAvailable() >= 5) {
                        mutableSpanStyle.m3353setFontSizeR2X_6o(m3332decodeTextUnitXSAIIZE());
                    ...
                    if (dataAvailable() >= 1) {
                        mutableSpanStyle.m3354setFontStylemLjRB2g(FontStyle.m3565boximpl(m3330decodeFontStyle_LCdwA()));
                        mutableSpanStyle2 = mutableSpanStyle;
                    } else {
                        return mutableSpanStyle.toSpanStyle();
                    }
                    ...
                    if (bDecodeByte == 6) {
                        ...
                        if (dataAvailable() >= 5) {
                            mutableSpanStyle.m3356setLetterSpacingR2X_6o(m3332decodeTextUnitXSAIIZE());
                        } else {
                            return mutableSpanStyle.toSpanStyle();
                        }
                    } else if (bDecodeByte == 8) {
                        if (dataAvailable() >= 4) {
                            mutableSpanStyle.m3351setBaselineShift_isdbwI(BaselineShift.m3700boximpl(m3327decodeBaselineShifty9eOQZs()));
                        } else {
                            return mutableSpanStyle.toSpanStyle();
                        }
                        ...
                        if (dataAvailable() >= 8) {
                            mutableSpanStyle.m3350setBackground8_81llA(m3329decodeColor0d7_KjU());
                        } else {
                            return mutableSpanStyle.toSpanStyle();
                        }
                    ...
                    mutableSpanStyle.m3355setFontSynthesistDdu0R4(FontSynthesis.m3574boximpl(m3331decodeFontSynthesisGVVA2EU()));
                    mutableSpanStyle2 = mutableSpanStyle;
                } else {
                    return mutableSpanStyle.toSpanStyle();
                }
                ...
                mutableSpanStyle2.m3352setColor8_81llA(m3329decodeColor0d7_KjU());
            }
        }
        mutableSpanStyle = mutableSpanStyle2;
        return mutableSpanStyle.toSpanStyle();
    ...
    public final long m3329decodeColor0d7_KjU() {
        return Color.m1627constructorimpl(m3328decodeULongsVKNKU());
    }

    /* JADX INFO: renamed from: decodeTextUnit-XSAIIZE, reason: not valid java name */
    public final long m3332decodeTextUnitXSAIIZE() {
        long jM4058getUnspecifiedUIouoOA;
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 1) {
            jM4058getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m4057getSpUIouoOA();
        } else if (bDecodeByte == 2) {
            jM4058getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m4056getEmUIouoOA();
        } else {
            jM4058getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m4058getUnspecifiedUIouoOA();
        }
        if (TextUnitType.m4052equalsimpl0(jM4058getUnspecifiedUIouoOA, TextUnitType.INSTANCE.m4058getUnspecifiedUIouoOA())) {
            return TextUnit.INSTANCE.m4035getUnspecifiedXSAIIZE();
        }
        return TextUnitKt.m4036TextUnitanM5pPY(decodeFloat(), jM4058getUnspecifiedUIouoOA);
    }
    ...
    public final int m3330decodeFontStyle_LCdwA() {
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 0) {
            return FontStyle.INSTANCE.m3573getNormal_LCdwA();
        }
        if (bDecodeByte == 1) {
            return FontStyle.INSTANCE.m3572getItalic_LCdwA();
        }
        return FontStyle.INSTANCE.m3573getNormal_LCdwA();
    }

    /* JADX INFO: renamed from: decodeFontSynthesis-GVVA2EU, reason: not valid java name */
    public final int m3331decodeFontSynthesisGVVA2EU() {
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 0) {
            return FontSynthesis.INSTANCE.m3584getNoneGVVA2EU();
        }
        if (bDecodeByte == 1) {
            return FontSynthesis.INSTANCE.m3583getAllGVVA2EU();
        }
        if (bDecodeByte == 3) {
            return FontSynthesis.INSTANCE.m3585getStyleGVVA2EU();
        }
        if (bDecodeByte == 2) {
            return FontSynthesis.INSTANCE.m3586getWeightGVVA2EU();
        }
        return FontSynthesis.INSTANCE.m3584getNoneGVVA2EU();
    }

    /* JADX INFO: renamed from: decodeBaselineShift-y9eOQZs, reason: not valid java name */
    private final float m3327decodeBaselineShifty9eOQZs() {
        return BaselineShift.m3701constructorimpl(decodeFloat());
    }
    ...
    private final Shadow decodeShadow() {
        return new Shadow(m3329decodeColor0d7_KjU(), OffsetKt.Offset(decodeFloat(), decodeFloat()), decodeFloat(), null);
    }
    ...
    private final long m3328decodeULongsVKNKU() {
        return ULong.m8080constructorimpl(this.parcel.readLong());
    }
