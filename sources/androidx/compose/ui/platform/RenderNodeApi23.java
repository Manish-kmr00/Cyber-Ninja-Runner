...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    public void record(CanvasHolder canvasHolder, Path clipPath, Function1<? super Canvas, Unit> drawBlock) {
        ...
        Intrinsics.checkNotNullExpressionValue(displayListCanvasStart, "renderNode.start(width, height)");
        ...
        if (clipPath != null) {
            androidCanvas.save();
            Canvas.m1602clipPathmtrdDE$default(androidCanvas, clipPath, 0, 2, null);
        }
