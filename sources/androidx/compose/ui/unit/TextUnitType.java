...
public final class TextUnitType {
    ...
    private static final long Unspecified = m4050constructorimpl(0);
    private static final long Sp = m4050constructorimpl(4294967296L);
    private static final long Em = m4050constructorimpl(8589934592L);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TextUnitType m4049boximpl(long j) {
        return new TextUnitType(j);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static long m4050constructorimpl(long j) {
        return j;
    }
    ...
    public boolean equals(Object obj) {
        return m4051equalsimpl(this.type, obj);
    }

    public int hashCode() {
        return m4053hashCodeimpl(this.type);
    }
    ...
    public String toString() {
        return m4054toStringimpl(this.type);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m4054toStringimpl(long j) {
        if (m4052equalsimpl0(j, Unspecified)) {
            return "Unspecified";
        }
        if (m4052equalsimpl0(j, Sp)) {
            return "Sp";
        }
        return m4052equalsimpl0(j, Em) ? "Em" : "Invalid";
    }
