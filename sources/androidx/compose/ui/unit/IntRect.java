...
public final /* data */ class IntRect {
    ...
    public static /* synthetic */ void m3979getSizeYbymL2g$annotations() {
    }
    ...
    public final long m3987getSizeYbymL2g() {
    ...
    public final IntRect m3991translategyyYBs(long offset) {
        return new IntRect(this.left + IntOffset.m3961getXimpl(offset), this.top + IntOffset.m3962getYimpl(offset), this.right + IntOffset.m3961getXimpl(offset), this.bottom + IntOffset.m3962getYimpl(offset));
    }
    ...
    public final long m3984getCenternOccac() {
    ...
    public final long m3986getCenterRightnOccac() {
    ...
    public final long m3982getBottomLeftnOccac() {
    ...
    public final long m3981getBottomCenternOccac() {
    ...
    public final long m3983getBottomRightnOccac() {
        return IntOffsetKt.IntOffset(this.right, this.bottom);
    }

    /* JADX INFO: renamed from: contains--gyyYBs, reason: not valid java name */
    public final boolean m3980containsgyyYBs(long offset) {
        return IntOffset.m3961getXimpl(offset) >= this.left && IntOffset.m3961getXimpl(offset) < this.right && IntOffset.m3962getYimpl(offset) >= this.top && IntOffset.m3962getYimpl(offset) < this.bottom;
    }
