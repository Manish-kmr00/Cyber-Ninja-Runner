...
public final class Constraints {
    ...
    public static final /* synthetic */ Constraints m3787boximpl(long j) {
    ...
    private static final int m3793getFocusIndeximpl(long j) {
        return (int) (j & 3);
    }
    ...
    public static int m3802hashCodeimpl(long j) {
    ...
    public int hashCode() {
        return m3802hashCodeimpl(this.value);
    }
    ...
    public static final int m3801getMinWidthimpl(long j) {
        return ((int) (j >> 2)) & WidthMask[m3793getFocusIndeximpl(j)];
    }

    /* JADX INFO: renamed from: getMaxWidth-impl, reason: not valid java name */
    public static final int m3799getMaxWidthimpl(long j) {
        int i = ((int) (j >> 33)) & WidthMask[m3793getFocusIndeximpl(j)];
        if (i == 0) {
    ...
    public static final int m3800getMinHeightimpl(long j) {
        int iM3793getFocusIndeximpl = m3793getFocusIndeximpl(j);
        return ((int) (j >> MinHeightOffsets[iM3793getFocusIndeximpl])) & HeightMask[iM3793getFocusIndeximpl];
    }

    /* JADX INFO: renamed from: getMaxHeight-impl, reason: not valid java name */
    public static final int m3798getMaxHeightimpl(long j) {
        int iM3793getFocusIndeximpl = m3793getFocusIndeximpl(j);
        int i = ((int) (j >> (MinHeightOffsets[iM3793getFocusIndeximpl] + 31))) & HeightMask[iM3793getFocusIndeximpl];
        if (i == 0) {
            return Integer.MAX_VALUE;
        }
        return i - 1;
    ...
    public static final boolean m3795getHasBoundedWidthimpl(long j) {
        return (((int) (j >> 33)) & WidthMask[m3793getFocusIndeximpl(j)]) != 0;
    }

    /* JADX INFO: renamed from: getHasBoundedHeight-impl, reason: not valid java name */
    public static final boolean m3794getHasBoundedHeightimpl(long j) {
        int iM3793getFocusIndeximpl = m3793getFocusIndeximpl(j);
        return (((int) (j >> (MinHeightOffsets[iM3793getFocusIndeximpl] + 31))) & HeightMask[iM3793getFocusIndeximpl]) != 0;
    }

    /* JADX INFO: renamed from: getHasFixedWidth-impl, reason: not valid java name */
    public static final boolean m3797getHasFixedWidthimpl(long j) {
        return m3799getMaxWidthimpl(j) == m3801getMinWidthimpl(j);
    }

    /* JADX INFO: renamed from: getHasFixedHeight-impl, reason: not valid java name */
    public static final boolean m3796getHasFixedHeightimpl(long j) {
        return m3798getMaxHeightimpl(j) == m3800getMinHeightimpl(j);
    }

    /* JADX INFO: renamed from: isZero-impl, reason: not valid java name */
    public static final boolean m3803isZeroimpl(long j) {
        return m3799getMaxWidthimpl(j) == 0 || m3798getMaxHeightimpl(j) == 0;
    }

    /* JADX INFO: renamed from: copy-Zbe2FdA$default, reason: not valid java name */
    public static /* synthetic */ long m3790copyZbe2FdA$default(long j, int i, int i2, int i3, int i4, int i5, Object obj) {
        if ((i5 & 1) != 0) {
            i = m3801getMinWidthimpl(j);
        }
        int i6 = i;
        if ((i5 & 2) != 0) {
            i2 = m3799getMaxWidthimpl(j);
        }
        int i7 = i2;
        if ((i5 & 4) != 0) {
            i3 = m3800getMinHeightimpl(j);
        }
        int i8 = i3;
        if ((i5 & 8) != 0) {
            i4 = m3798getMaxHeightimpl(j);
        }
        return m3789copyZbe2FdA(j, i6, i7, i8, i4);
    }

    /* JADX INFO: renamed from: copy-Zbe2FdA, reason: not valid java name */
    public static final long m3789copyZbe2FdA(long j, int i, int i2, int i3, int i4) {
        if (i3 < 0 || i < 0) {
        ...
        return INSTANCE.m3806createConstraintsZbe2FdA$ui_unit_release(i, i2, i3, i4);
    }
    ...
    public static String m3804toStringimpl(long j) {
        int iM3799getMaxWidthimpl = m3799getMaxWidthimpl(j);
        String strValueOf = "Infinity";
        String strValueOf2 = iM3799getMaxWidthimpl == Integer.MAX_VALUE ? "Infinity" : String.valueOf(iM3799getMaxWidthimpl);
        int iM3798getMaxHeightimpl = m3798getMaxHeightimpl(j);
        if (iM3798getMaxHeightimpl != Integer.MAX_VALUE) {
            strValueOf = String.valueOf(iM3798getMaxHeightimpl);
        }
        return "Constraints(minWidth = " + m3801getMinWidthimpl(j) + ", maxWidth = " + strValueOf2 + ", minHeight = " + m3800getMinHeightimpl(j) + ", maxHeight = " + strValueOf + ')';
    }
    ...
    public static final class Companion {
        ...
        public final long m3807fixedJhjzzOo(int width, int height) {
            if (width < 0 || height < 0) {
                throw new IllegalArgumentException(("width(" + width + ") and height(" + height + ") must be >= 0").toString());
            }
            return m3806createConstraintsZbe2FdA$ui_unit_release(width, width, height, height);
        }

        /* JADX INFO: renamed from: fixedWidth-OenEA2s, reason: not valid java name */
        public final long m3809fixedWidthOenEA2s(int width) {
            if (width < 0) {
                throw new IllegalArgumentException(("width(" + width + ") must be >= 0").toString());
            }
            return m3806createConstraintsZbe2FdA$ui_unit_release(width, width, 0, Integer.MAX_VALUE);
        }

        /* JADX INFO: renamed from: fixedHeight-OenEA2s, reason: not valid java name */
        public final long m3808fixedHeightOenEA2s(int height) {
            if (height < 0) {
                throw new IllegalArgumentException(("height(" + height + ") must be >= 0").toString());
            }
            return m3806createConstraintsZbe2FdA$ui_unit_release(0, Integer.MAX_VALUE, height, height);
        }

        /* JADX INFO: renamed from: createConstraints-Zbe2FdA$ui_unit_release, reason: not valid java name */
        public final long m3806createConstraintsZbe2FdA$ui_unit_release(int minWidth, int maxWidth, int minHeight, int maxHeight) {
            long j;
            ...
            if (iBitsNeedForSize + iBitsNeedForSize2 <= 31) {
                ...
                return Constraints.m3788constructorimpl((((long) i3) << 33) | j | (((long) minWidth) << 2) | (((long) minHeight) << i5) | (((long) i4) << (i5 + 31)));
            }
