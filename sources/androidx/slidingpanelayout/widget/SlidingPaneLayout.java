...
public class SlidingPaneLayout extends ViewGroup implements Openable {
    ...
    /* JADX WARN: Code duplicated, block: B:111:0x00f2 A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:113:0x00f2 A[SYNTHETIC] */
        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.width != 0) {
                    iMax2 = Math.max(iMax3 - (layoutParams.leftMargin + layoutParams.rightMargin), (int) r8);
        ...
        if (z2 || f > 0.0f) {
            ...
            while (i10 < childCount) {
                ...
                if (childAt2.getVisibility() != i3) {
                    ...
                    int measuredWidth3 = (layoutParams2.width != 0 || layoutParams2.weight <= 0.0f) ? childAt2.getMeasuredWidth() : 0;
                    if (z2) {
                        ...
                        iMax = measuredWidth3 + ((int) ((layoutParams2.weight * Math.max(0, i9)) / f));
                        iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(iMax, 1073741824);
                    } else {
                        iMax = measuredWidth3;
                        iMakeMeasureSpec = 0;
            ...
            for (int i11 = 0; i11 < childCount; i11++) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if ((childAt3.getMeasuredWidthAndState() & 16777216) == 1 || (getMinimumWidth(childAt3) != 0 && rect.width() < getMinimumWidth(childAt3))) {
                        childAt3.measure(View.MeasureSpec.makeMeasureSpec(iMax3 - i12, 1073741824), iMakeMeasureSpec3);
                        if (i11 != 0) {
