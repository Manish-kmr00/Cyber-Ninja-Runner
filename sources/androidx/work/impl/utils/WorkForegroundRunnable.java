...
public class WorkForegroundRunnable implements Runnable {
    ...
    public void run() {
        ...
        this.mTaskExecutor.getMainThreadExecutor().execute(new Runnable() { // from class: androidx.work.impl.utils.WorkForegroundRunnable$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m4312lambda$run$0$androidxworkimplutilsWorkForegroundRunnable(settableFutureCreate);
            }
        });
    ...
    /* JADX INFO: renamed from: lambda$run$0$androidx-work-impl-utils-WorkForegroundRunnable, reason: not valid java name */
    /* synthetic */ void m4312lambda$run$0$androidxworkimplutilsWorkForegroundRunnable(SettableFuture settableFuture) {
