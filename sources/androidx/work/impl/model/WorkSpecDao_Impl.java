        ...
        try {
            ...
            try {
                ...
                if (cursorQuery.moveToFirst()) {
                    ...
                    int i7 = cursorQuery.getInt(columnIndexOrThrow20);
                    WorkTypeConverters workTypeConverters4 = WorkTypeConverters.INSTANCE;
        ...
        try {
            ...
            try {
                ...
                while (cursorQuery.moveToNext()) {
                    ...
                    WorkTypeConverters workTypeConverters4 = WorkTypeConverters.INSTANCE;
                    NetworkType networkTypeIntToNetworkType = WorkTypeConverters.intToNetworkType(i14);
                    ...
                    byte[] blob = cursorQuery.isNull(i16) ? null : cursorQuery.getBlob(i16);
                    WorkTypeConverters workTypeConverters5 = WorkTypeConverters.INSTANCE;
                    ...
                    arrayList.add(new WorkSpec(string, stateIntToState, string2, string3, dataFromByteArray, dataFromByteArray2, j, j2, j3, constraints, i3, backoffPolicyIntToBackoffPolicy, j4, j5, j6, j7, z, outOfQuotaPolicyIntToOutOfQuotaPolicy, i10, i12));
