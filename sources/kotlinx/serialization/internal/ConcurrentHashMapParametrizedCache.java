...
final class ConcurrentHashMapParametrizedCache<T> implements ParametrizedSerializerCache<T> {
    ...
    public Object mo9477getgIAlus(KClass<Object> key, List<? extends KType> types) {
        ...
        if (obj == null) {
            try {
                ...
                objM7904constructorimpl = Result.m7904constructorimpl(this.compute.invoke(key, types));
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM7904constructorimpl = Result.m7904constructorimpl(ResultKt.createFailure(th));
            }
            Result resultM7903boximpl = Result.m7903boximpl(objM7904constructorimpl);
            Object objPutIfAbsent = concurrentHashMap2.putIfAbsent(arrayList2, resultM7903boximpl);
            obj = objPutIfAbsent == null ? resultM7903boximpl : objPutIfAbsent;
        }
