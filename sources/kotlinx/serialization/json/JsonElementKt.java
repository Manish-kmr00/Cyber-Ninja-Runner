...
public final class JsonElementKt {
    ...
    public static final JsonPrimitive m9515JsonPrimitive7apg3OU(byte b) {
        return m9516JsonPrimitiveVKZWuLQ(ULong.m8080constructorimpl(((long) b) & 255));
    }

    @ExperimentalSerializationApi
    /* JADX INFO: renamed from: JsonPrimitive-xj2QHRw, reason: not valid java name */
    public static final JsonPrimitive m9518JsonPrimitivexj2QHRw(short s) {
        return m9516JsonPrimitiveVKZWuLQ(ULong.m8080constructorimpl(((long) s) & 65535));
    }

    @ExperimentalSerializationApi
    /* JADX INFO: renamed from: JsonPrimitive-WZ4Q5Ns, reason: not valid java name */
    public static final JsonPrimitive m9517JsonPrimitiveWZ4Q5Ns(int i) {
        return m9516JsonPrimitiveVKZWuLQ(ULong.m8080constructorimpl(((long) i) & 4294967295L));
    }

    @ExperimentalSerializationApi
    /* JADX INFO: renamed from: JsonPrimitive-VKZWuLQ, reason: not valid java name */
    public static final JsonPrimitive m9516JsonPrimitiveVKZWuLQ(long j) {
