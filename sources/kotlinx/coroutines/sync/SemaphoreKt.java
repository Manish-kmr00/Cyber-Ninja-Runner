...
public final class SemaphoreKt {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.sync.SemaphoreKt", f = "Semaphore.kt", i = {0, 0}, l = {IronSourceConstants.TROUBLESHOOTING_AD_QUALITY_SDK_INITIALIZED_SUCCESSFULLY_EVENT}, m = "withPermit", n = {"$this$withPermit", "action"}, s = {"L$0", "L$1"})
