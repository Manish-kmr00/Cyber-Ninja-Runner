...
public final class TimeoutKt {
    ...
    public static final <T> Object m9405withTimeoutKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeout(DelayKt.m9397toDelayMillisLRDsOJo(j), function2, continuation);
    }
    ...
    public static final <T> Object m9406withTimeoutOrNullKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeoutOrNull(DelayKt.m9397toDelayMillisLRDsOJo(j), function2, continuation);
    }
    ...
    public static final TimeoutCancellationException TimeoutCancellationException(long j, Delay delay, Job job) {
        String strM9398timeoutMessageLRDsOJo;
        ...
        if (delayWithTimeoutDiagnostics != null) {
            ...
            strM9398timeoutMessageLRDsOJo = delayWithTimeoutDiagnostics.m9398timeoutMessageLRDsOJo(DurationKt.toDuration(j, DurationUnit.MILLISECONDS));
            if (strM9398timeoutMessageLRDsOJo == null) {
                strM9398timeoutMessageLRDsOJo = "Timed out waiting for " + j + " ms";
            }
        } else {
            strM9398timeoutMessageLRDsOJo = "Timed out waiting for " + j + " ms";
        }
        return new TimeoutCancellationException(strM9398timeoutMessageLRDsOJo, job);
    }
}
