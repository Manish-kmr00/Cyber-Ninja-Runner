...
public class SelectImplementation<R> implements CancelHandler, SelectBuilder<R>, SelectInstanceInternal<R> {
    ...
    /* JADX INFO: compiled from: Select.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    @DebugMetadata(c = "kotlinx.coroutines.selects.SelectImplementation", f = "Select.kt", i = {}, l = {IronSourceError.ERROR_NT_INSTANCE_INIT_EXCEPTION}, m = "processResultAndInvokeBlockRecoveringException", n = {}, s = {})
    static final class C49731 extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;
        final /* synthetic */ SelectImplementation<R> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C49731(SelectImplementation<R> selectImplementation, Continuation<? super C49731> continuation) {
            super(continuation);
            this.this$0 = selectImplementation;
        }
    ...
    public final Object doSelectSuspend(Continuation<? super R> continuation) throws Throwable {
        ...
        if (i != 0) {
            if (i == 1) {
                ...
                ResultKt.throwOnFailure(objComplete);
    ...
    public final Object processResultAndInvokeBlockRecoveringException(SelectImplementation<R>.ClauseData clauseData, Object obj, Continuation<? super R> continuation) throws Throwable {
        C49731 c49731;
        if (continuation instanceof C49731) {
            c49731 = (C49731) continuation;
            if ((c49731.label & Integer.MIN_VALUE) != 0) {
                c49731.label -= Integer.MIN_VALUE;
            } else {
                c49731 = new C49731(this, continuation);
            }
        } else {
            c49731 = new C49731(this, continuation);
        }
        Object objInvokeBlock = c49731.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c49731.label;
        try {
            if (i == 0) {
                ResultKt.throwOnFailure(objInvokeBlock);
                Object objProcessResult = clauseData.processResult(obj);
                c49731.label = 1;
                objInvokeBlock = clauseData.invokeBlock(objProcessResult, c49731);
            ...
            if (DebugKt.getRECOVER_STACK_TRACES() && (c49731 instanceof CoroutineStackFrame)) {
                throw StackTraceRecoveryKt.recoverFromStackFrame(th, c49731);
            }
            throw th;
        }
    }
