...
public final class BroadcastChannelImpl<E> extends BufferedChannel<E> implements BroadcastChannel<E> {
        ...
        try {
            ...
            if (!isClosedForSend() || this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                if (this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                    subscriberConflated.mo9408trySendJP2dKIU(getValue());
                }
    ...
    public Object mo9408trySendJP2dKIU(E element) {
        ...
        try {
            ...
            if (!(list instanceof Collection) || !list.isEmpty()) {
                ...
                while (it.hasNext()) {
                    if (((BufferedChannel) it.next()).shouldSendSuspend$kotlinx_coroutines_core()) {
                        Object objM9433failurePtdJZtk = ChannelResult.INSTANCE.m9433failurePtdJZtk();
                        reentrantLock.unlock();
                        return objM9433failurePtdJZtk;
                    }
                }
            }
            if (this.capacity == -1) {
            ...
            while (it2.hasNext()) {
                ((BufferedChannel) it2.next()).mo9408trySendJP2dKIU(element);
            }
            Object objM9434successJP2dKIU = ChannelResult.INSTANCE.m9434successJP2dKIU(Unit.INSTANCE);
            reentrantLock.unlock();
            return objM9434successJP2dKIU;
        } catch (Throwable th) {
            reentrantLock.unlock();
            throw th;
        }
