...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM9436trySendImplMj0NB7M = conflatedBufferedChannel.m9436trySendImplMj0NB7M(e, true);
        if (objM9436trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m9423exceptionOrNullimpl(objM9436trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM9436trySendImplMj0NB7M = conflatedBufferedChannel.m9436trySendImplMj0NB7M(e, true);
        if (!(objM9436trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo9408trySendJP2dKIU(E element) {
        return m9436trySendImplMj0NB7M(element, false);
    }

    /* JADX INFO: renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m9436trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m9435trySendDropLatestMj0NB7M(element, isSendOp) : m9414trySendDropOldestJP2dKIU(element);
    }

    /* JADX INFO: renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m9435trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo9408trySendJP2dKIU = super.mo9408trySendJP2dKIU(element);
        if (ChannelResult.m9429isSuccessimpl(objMo9408trySendJP2dKIU) || ChannelResult.m9427isClosedimpl(objMo9408trySendJP2dKIU)) {
            return objMo9408trySendJP2dKIU;
        }
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo9408trySendJP2dKIU = mo9408trySendJP2dKIU(element);
        if (!(objMo9408trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo9408trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m9423exceptionOrNullimpl(objMo9408trySendJP2dKIU);
