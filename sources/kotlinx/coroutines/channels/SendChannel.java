...
public interface SendChannel<E> {
    ...
    Object mo9408trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m9429isSuccessimpl(objMo9408trySendJP2dKIU)) {
                return true;
            }
            Throwable thM9423exceptionOrNullimpl = ChannelResult.m9423exceptionOrNullimpl(objMo9408trySendJP2dKIU);
