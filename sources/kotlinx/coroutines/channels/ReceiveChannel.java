...
public interface ReceiveChannel<E> {
    ...
    Object mo9412receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo9413tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo9413tryReceivePtdJZtk = receiveChannel.mo9413tryReceivePtdJZtk();
            if (ChannelResult.m9429isSuccessimpl(objMo9413tryReceivePtdJZtk)) {
                return (E) ChannelResult.m9425getOrThrowimpl(objMo9413tryReceivePtdJZtk);
            }
            Throwable thM9423exceptionOrNullimpl = ChannelResult.m9423exceptionOrNullimpl(objMo9413tryReceivePtdJZtk);
            if (thM9423exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM9423exceptionOrNullimpl);
        }
        ...
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) throws Throwable {
            ...
            if (i == 0) {
                ...
                objMo9412receiveCatchingJP2dKIU = receiveChannel.mo9412receiveCatchingJP2dKIU(anonymousClass1);
            ...
            return ChannelResult.m9424getOrNullimpl(objMo9412receiveCatchingJP2dKIU);
        }
