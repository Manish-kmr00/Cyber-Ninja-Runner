...
public final class CombineKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Code duplicated, block: B:28:0x00d0 A[LOOP:0: B:28:0x00d0->B:48:?, LOOP_START, PHI: r6 r10
  ...
  0x00d0: PHI (r10v8 kotlin.collections.IndexedValue) = (r10v7 kotlin.collections.IndexedValue), (r10v21 kotlin.collections.IndexedValue) binds: [B:25:0x00cb, B:48:?] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        /* JADX WARN: Code duplicated, block: B:46:0x00f5 A[EDGE_INSN: B:46:0x00f5->B:35:0x00f5 BREAK  A[LOOP:0: B:28:0x00d0->B:48:?], SYNTHETIC] */
        ...
        static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public final Object invokeSuspend(Object obj) throws Throwable {
                ...
                try {
                    if (i == 0) {
                        ...
                        this.label = 1;
                        if (this.$flows[this.$i].collect(new C08011(this.$resultChannel, this.$i), this) == coroutine_suspended) {
            ...
            static final class C08011<T> implements FlowCollector {
                final /* synthetic */ int $i;
                final /* synthetic */ Channel<IndexedValue<Object>> $resultChannel;

                C08011(Channel<IndexedValue<Object>> channel, int i) {
                    this.$resultChannel = channel;
                    this.$i = i;
                }
