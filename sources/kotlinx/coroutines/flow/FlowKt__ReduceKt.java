...
final /* synthetic */ class FlowKt__ReduceKt {
    ...
    static final class C49591<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        C49591(Continuation<? super C49591> continuation) {
            super(continuation);
        }
    ...
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ReduceKt", f = "Reduce.kt", i = {0, 0}, l = {179}, m = "firstOrNull", n = {"result", "collector$iv"}, s = {"L$0", "L$1"})
    static final class C49603<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        C49603(Continuation<? super C49603> continuation) {
            super(continuation);
        }
    ...
    static final class C49611<T, R> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        C49611(Continuation<? super C49611> continuation) {
            super(continuation);
        }
    ...
    static final class C49621<T> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        C49621(Continuation<? super C49621> continuation) {
            super(continuation);
        }
    ...
    static final class C49641<T> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        C49641(Continuation<? super C49641> continuation) {
            super(continuation);
        }
    ...
    static final class C49661<S, T extends S> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        C49661(Continuation<? super C49661> continuation) {
            super(continuation);
        }
    ...
    static final class C49681<T> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        C49681(Continuation<? super C49681> continuation) {
            super(continuation);
        }
    ...
    static final class C49701<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        C49701(Continuation<? super C49701> continuation) {
            super(continuation);
        }
    ...
    public static final <S, T extends S> Object reduce(Flow<? extends T> flow, Function3<? super S, ? super T, ? super Continuation<? super S>, ? extends Object> function3, Continuation<? super S> continuation) throws Throwable {
        ...
        if (continuation instanceof C49661) {
            ...
            if ((c49661.label & Integer.MIN_VALUE) != 0) {
                c49661.label -= Integer.MIN_VALUE;
            } else {
        ...
        if (i == 0) {
            ...
            FlowCollector<? super Object> c49672 = new C49672<>(objectRef2, function3);
            c49661.L$0 = objectRef2;
            c49661.label = 1;
            if (flow.collect(c49672, c49661) == coroutine_suspended) {
            ...
            objectRef = (Ref.ObjectRef) c49661.L$0;
            ResultKt.throwOnFailure(obj);
        }
    ...
    /* JADX INFO: compiled from: Reduce.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0005\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\b\b\u0001\u0010\u0003*\u0002H\u00022\u0006\u0010\u0004\u001a\u0002H\u0003H\u008a@¢\u0006\u0004\b\u0005\u0010\u0006"}, d2 = {"<anonymous>", "", ExifInterface.LATITUDE_SOUTH, "T", "value", "emit", "(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;"}, k = 3, mv = {1, 9, 0}, xi = 48)
    static final class C49672<T> implements FlowCollector {
        final /* synthetic */ Ref.ObjectRef<Object> $accumulator;
        final /* synthetic */ Function3<S, T, Continuation<? super S>, Object> $operation;

        /* JADX WARN: Multi-variable type inference failed */
        C49672(Ref.ObjectRef<Object> objectRef, Function3<? super S, ? super T, ? super Continuation<? super S>, ? extends Object> function3) {
    ...
    public static final <T, R> Object fold(Flow<? extends T> flow, R r, Function3<? super R, ? super T, ? super Continuation<? super R>, ? extends Object> function3, Continuation<? super R> continuation) throws Throwable {
        C49611 c49611;
        Ref.ObjectRef objectRef;
        if (continuation instanceof C49611) {
            c49611 = (C49611) continuation;
            if ((c49611.label & Integer.MIN_VALUE) != 0) {
                c49611.label -= Integer.MIN_VALUE;
            } else {
                c49611 = new C49611(continuation);
            }
        } else {
            c49611 = new C49611(continuation);
        }
        Object obj = c49611.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c49611.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            ...
            c49611.L$0 = objectRef2;
            c49611.label = 1;
            if (flow.collect(anonymousClass2, c49611) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c49611.L$0;
            ResultKt.throwOnFailure(obj);
        }
        return objectRef.element;
    }
    ...
    public static final <T> Object single(Flow<? extends T> flow, Continuation<? super T> continuation) throws Throwable {
        C49681 c49681;
        Ref.ObjectRef objectRef;
        if (continuation instanceof C49681) {
            c49681 = (C49681) continuation;
            if ((c49681.label & Integer.MIN_VALUE) != 0) {
                c49681.label -= Integer.MIN_VALUE;
            } else {
                c49681 = new C49681(continuation);
            }
        } else {
            c49681 = new C49681(continuation);
        }
        Object obj = c49681.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c49681.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            ...
            c49681.L$0 = objectRef2;
            c49681.label = 1;
            if (flow.collect(flowCollector, c49681) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c49681.L$0;
            ResultKt.throwOnFailure(obj);
        }
        if (objectRef.element == NullSurrogateKt.NULL) {
    ...
    public static final <T> Object singleOrNull(Flow<? extends T> flow, Continuation<? super T> continuation) throws Throwable {
        ...
        if (continuation instanceof C49701) {
            c49701 = (C49701) continuation;
            if ((c49701.label & Integer.MIN_VALUE) != 0) {
                c49701.label -= Integer.MIN_VALUE;
            } else {
                c49701 = new C49701(continuation);
            }
        } else {
            c49701 = new C49701(continuation);
        }
        Object obj = c49701.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c49701.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            ...
            try {
                c49701.L$0 = objectRef2;
                c49701.L$1 = flowCollector2;
                c49701.label = 1;
                if (flow.collect(flowCollector2, c49701) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                objectRef = objectRef2;
            ...
            flowCollector = (FlowKt__ReduceKt$singleOrNull$$inlined$collectWhile$1) c49701.L$1;
            objectRef = (Ref.ObjectRef) c49701.L$0;
            try {
                ResultKt.throwOnFailure(obj);
    ...
    public static final <T> Object firstOrNull(Flow<? extends T> flow, Continuation<? super T> continuation) throws Throwable {
        ...
        AbortFlowException e;
        FlowCollector<T> flowCollector;
        if (continuation instanceof C49591) {
            c49591 = (C49591) continuation;
            if ((c49591.label & Integer.MIN_VALUE) != 0) {
                c49591.label -= Integer.MIN_VALUE;
            } else {
                c49591 = new C49591(continuation);
            }
        } else {
            c49591 = new C49591(continuation);
        }
        Object obj = c49591.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c49591.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            ...
            try {
                c49591.L$0 = objectRef2;
                c49591.L$1 = flowCollector2;
                c49591.label = 1;
                if (flow.collect(flowCollector2, c49591) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                objectRef = objectRef2;
            } catch (AbortFlowException e2) {
            ...
            flowCollector = (FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$1) c49591.L$1;
            objectRef = (Ref.ObjectRef) c49591.L$0;
            try {
                ResultKt.throwOnFailure(obj);
            } catch (AbortFlowException e3) {
                e = e3;
    ...
    public static final <T> Object firstOrNull(Flow<? extends T> flow, Function2<? super T, ? super Continuation<? super Boolean>, ? extends Object> function2, Continuation<? super T> continuation) throws Throwable {
        ...
        AbortFlowException e;
        FlowCollector<? super Object> flowCollector;
        if (continuation instanceof C49603) {
            c49603 = (C49603) continuation;
            if ((c49603.label & Integer.MIN_VALUE) != 0) {
                c49603.label -= Integer.MIN_VALUE;
            } else {
                c49603 = new C49603(continuation);
            }
        } else {
            c49603 = new C49603(continuation);
        }
        Object obj = c49603.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c49603.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            ...
            try {
                c49603.L$0 = objectRef2;
                c49603.L$1 = flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2;
                c49603.label = 1;
                if (flow.collect(flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2, c49603) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                objectRef = objectRef2;
            } catch (AbortFlowException e2) {
            ...
            flowCollector = (FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2) c49603.L$1;
            objectRef = (Ref.ObjectRef) c49603.L$0;
            try {
                ResultKt.throwOnFailure(obj);
            } catch (AbortFlowException e3) {
                e = e3;
    ...
    public static final <T> Object last(Flow<? extends T> flow, Continuation<? super T> continuation) throws Throwable {
        C49621 c49621;
        Ref.ObjectRef objectRef;
        if (continuation instanceof C49621) {
            c49621 = (C49621) continuation;
            if ((c49621.label & Integer.MIN_VALUE) != 0) {
                c49621.label -= Integer.MIN_VALUE;
            } else {
                c49621 = new C49621(continuation);
            }
        } else {
            c49621 = new C49621(continuation);
        }
        Object obj = c49621.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c49621.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            ...
            c49621.L$0 = objectRef2;
            c49621.label = 1;
            if (flow.collect(flowCollector, c49621) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c49621.L$0;
            ResultKt.throwOnFailure(obj);
        }
        if (objectRef.element == NullSurrogateKt.NULL) {
            throw new NoSuchElementException("Expected at least one element");
    ...
    public static final <T> Object lastOrNull(Flow<? extends T> flow, Continuation<? super T> continuation) throws Throwable {
        C49641 c49641;
        Ref.ObjectRef objectRef;
        if (continuation instanceof C49641) {
            c49641 = (C49641) continuation;
            if ((c49641.label & Integer.MIN_VALUE) != 0) {
                c49641.label -= Integer.MIN_VALUE;
            } else {
                c49641 = new C49641(continuation);
            }
        } else {
            c49641 = new C49641(continuation);
        }
        Object obj = c49641.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c49641.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            ...
            c49641.L$0 = objectRef2;
            c49641.label = 1;
            if (flow.collect(flowCollector, c49641) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c49641.L$0;
            ResultKt.throwOnFailure(obj);
        }
        return objectRef.element;
    }
