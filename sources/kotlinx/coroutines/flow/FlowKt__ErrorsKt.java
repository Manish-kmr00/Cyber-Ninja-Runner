...
final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    static final class C49541 extends SuspendLambda implements Function2<Throwable, Continuation<? super Boolean>, Object> {
        int label;

        C49541(Continuation<? super C49541> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C49541(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Throwable th, Continuation<? super Boolean> continuation) {
            return ((C49541) create(th, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    static final class AnonymousClass2<T> implements FlowCollector {
        ...
        public static final <T> Flow<T> m9448catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
