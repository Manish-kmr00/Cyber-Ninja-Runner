...
public final class DelayKt {
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo9465scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final Object m9396delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m9397toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m9397toDelayMillisLRDsOJo(long j) {
        boolean zM9266isPositiveimpl = Duration.m9266isPositiveimpl(j);
        if (zM9266isPositiveimpl) {
            Duration.Companion companion = Duration.INSTANCE;
            return Duration.m9250getInWholeMillisecondsimpl(Duration.m9268plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        }
        if (zM9266isPositiveimpl) {
