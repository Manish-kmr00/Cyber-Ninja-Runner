...
public class MeasurementEvent {
    ...
    private static Bundle getApplinkLogData(Context context, String str, Bundle bundle, Intent intent) {
        ...
        if (componentNameResolveActivity != null) {
            bundle2.putString(SdksMapping.KEY_INSTALLED_MEDIATION_ADAPTERS_CLASS, componentNameResolveActivity.getShortClassName());
        }
        ...
        for (String str2 : bundle.keySet()) {
            ...
            if (obj instanceof Bundle) {
                ...
                for (String str3 : bundle3.keySet()) {
                    ...
                    bundle2.putString(str2 + RemoteSettings.FORWARD_SLASH_STRING + str3, strObjectToJSONString);
                }
            } else {
