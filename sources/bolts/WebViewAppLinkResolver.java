...
public class WebViewAppLinkResolver implements AppLinkResolver {
            ...
            public Task<JSONArray> then(Task<Void> task) throws Exception {
                ...
                webView.setWebViewClient(new WebViewClient() { // from class: bolts.WebViewAppLinkResolver.2.1
                    ...
                    public void onPageStarted(WebView view, String url, Bitmap favicon) {
                        ...
                        BrandSafetyUtils.onWebViewPageStarted("bolts", view, url);
                    }

                    @Override // android.webkit.WebViewClient
                    public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                        super.onReceivedError(view, errorCode, description, failingUrl);
                        BrandSafetyUtils.onWebViewReceivedError("bolts", view, errorCode, description, failingUrl);
                    }

                    @Override // android.webkit.WebViewClient
                    public WebResourceResponse shouldInterceptRequest(WebView view, WebResourceRequest webResourceRequest) {
                        return CreativeInfoManager.onWebViewResponseWithHeaders("bolts", view, webResourceRequest, super.shouldInterceptRequest(view, webResourceRequest));
                    }

                    @Override // android.webkit.WebViewClient
                    public boolean shouldOverrideUrlLoading(WebView view, String url) {
                        boolean zShouldOverrideUrlLoading = super.shouldOverrideUrlLoading(view, url);
                        BrandSafetyUtils.onShouldOverrideUrlLoading("bolts", view, url, zShouldOverrideUrlLoading);
    ...
    public static AppLink makeAppLinkFromAlData(Map<String, Object> map, Uri uri) {
        ...
        if (list == null || list.size() <= 0) {
            ...
            uriTryCreateUrl = (list3 == null || list3.size() <= 0 || !Arrays.asList("no", "false", "0").contains(((String) ((Map) list3.get(0)).get("value")).toLowerCase())) ? uri : null;
