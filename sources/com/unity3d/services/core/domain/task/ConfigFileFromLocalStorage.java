...
public final class ConfigFileFromLocalStorage extends MetricTask<Params, Configuration> {
    ...
    public /* bridge */ /* synthetic */ Object mo5926doWorkgIAlus(BaseParams baseParams, Continuation continuation) {
        return m5929doWorkgIAlus((Params) baseParams, (Continuation<? super Result<? extends Configuration>>) continuation);
    }
    ...
    public Object m5929doWorkgIAlus(Params params, Continuation<? super Result<? extends Configuration>> continuation) {
        ...
        if (i == 0) {
            ...
            objWithContext = BuildersKt.withContext(io2, configFileFromLocalStorage$doWork$2, configFileFromLocalStorage$doWork$1);
