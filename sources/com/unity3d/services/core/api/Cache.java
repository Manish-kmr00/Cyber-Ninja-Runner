...
public class Cache {
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:38:0x0075 -> B:54:0x0078). Please report as a decompilation issue!!! */
    @WebViewExposed
    public static void setFileContent(String str, String str2, String str3, WebViewCallback webViewCallback) throws Throwable {
        ...
        try {
            ...
            try {
                try {
                    try {
                        FileOutputStream fileOutputStreamFileOutputStreamCtor = UnityCoreFilesBridge.fileOutputStreamCtor(strFileIdToFilename);
                        try {
    ...
    private static String fileIdToFilename(String str) {
        return SdkProperties.getCacheDirectory() == null ? "" : SdkProperties.getCacheDirectory() + RemoteSettings.FORWARD_SLASH_STRING + SdkProperties.getCacheFilePrefix() + str;
    }
