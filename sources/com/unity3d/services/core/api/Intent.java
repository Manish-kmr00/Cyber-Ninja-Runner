...
public class Intent {
    ...
    public static void safedk_Activity_startActivity_9d898b58165fa4ba0e12c3900a2b8533(Activity p0, android.content.Intent p1) {
        Logger.d("SafeDK-Special|SafeDK: Call> Landroid/app/Activity;->startActivity(Landroid/content/Intent;)V");
        if (p1 == null) {
            return;
        }
        BrandSafetyUtils.detectAdClick(p1, h.m);
        p0.startActivity(p1);
    }
    ...
    public static void launch(JSONObject jSONObject, WebViewCallback webViewCallback) {
        ...
        if (launchIntentForPackage != null) {
            if (getStartingActivity() != null) {
                safedk_Activity_startActivity_9d898b58165fa4ba0e12c3900a2b8533(getStartingActivity(), launchIntentForPackage);
