...
class CacheThreadHandler extends Handler {
    ...
    /*  JADX ERROR: Type inference failed
        jadx.core.utils.exceptions.JadxOverflowException: Type inference error: updates count limit reached with updateSeq = 8231. Try increasing type updates limit count.
        	at jadx.core.utils.ErrorsCounter.addError(ErrorsCounter.java:59)
        	at jadx.core.utils.ErrorsCounter.error(ErrorsCounter.java:31)
        	at jadx.core.dex.attributes.nodes.NotificationAttrNode.addError(NotificationAttrNode.java:19)
        	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.visit(TypeInferenceVisitor.java:79)
        */
    private void downloadFile(java.lang.String r23, java.lang.String r24, int r25, int r26, int r27, java.util.HashMap<java.lang.String, java.util.List<java.lang.String>> r28, boolean r29, com.unity3d.services.core.cache.CacheEventSender r30) {
        /*
