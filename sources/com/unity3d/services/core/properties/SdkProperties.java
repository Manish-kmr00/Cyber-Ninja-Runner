...
public class SdkProperties {
    ...
    public static String getDefaultConfigUrl(String str) {
        return "https://" + getConfigVersion(ClientProperties.getApplicationContext()) + '.' + (isChinaLocale(Device.getNetworkCountryISO()) ? new String(Base64.decode(CHINA_CONFIG_HOSTNAME, 0)) : DEFAULT_CONFIG_HOSTNAME) + "/webview/" + getWebViewBranch() + RemoteSettings.FORWARD_SLASH_STRING + str + "/config.json";
    }
