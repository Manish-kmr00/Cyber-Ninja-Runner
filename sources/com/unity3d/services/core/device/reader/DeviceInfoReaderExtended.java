...
public class DeviceInfoReaderExtended implements IDeviceInfoReader {
    ...
    public Map<String, Object> getDeviceInfoData() {
        ...
        deviceInfoData.put(DtbDeviceData.DEVICE_DATA_OS_VERSION_KEY, Device.getOsVersion());
        deviceInfoData.put(b9.i.l, Device.getModel());
        deviceInfoData.put(POBConstants.KEY_LANGUAGE, Locale.getDefault().toString());
        deviceInfoData.put(b9.i.t, Device.getConnectionType());
        ...
        deviceInfoData.put(b9.i.Y, Float.valueOf(Device.getBatteryLevel()));
        deviceInfoData.put("networkMetered", Boolean.valueOf(Device.getNetworkMetered()));
        deviceInfoData.put(POBConstants.TEST_MODE, Boolean.valueOf(SdkProperties.isTestMode()));
