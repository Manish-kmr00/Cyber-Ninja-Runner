...
public class StorageManager {
    ...
    public static boolean init(Context context) {
        ...
        addStorageLocation(StorageType.PUBLIC, filesDir + RemoteSettings.FORWARD_SLASH_STRING + SdkProperties.getLocalStorageFilePrefix() + "public-data.json");
        if (!setupStorage(StorageType.PUBLIC)) {
            return false;
        }
        addStorageLocation(StorageType.PRIVATE, filesDir + RemoteSettings.FORWARD_SLASH_STRING + SdkProperties.getLocalStorageFilePrefix() + "private-data.json");
