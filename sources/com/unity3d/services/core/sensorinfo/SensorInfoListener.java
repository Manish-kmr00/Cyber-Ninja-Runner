...
public class SensorInfoListener implements SensorEventListener {
    ...
    public static JSONObject getAccelerometerData() {
        ...
        try {
            jSONObject.put(VastAttributes.HORIZONTAL_POSITION, _latestAccelerometerEvent.values[0]);
            jSONObject.put(VastAttributes.VERTICAL_POSITION, _latestAccelerometerEvent.values[1]);
