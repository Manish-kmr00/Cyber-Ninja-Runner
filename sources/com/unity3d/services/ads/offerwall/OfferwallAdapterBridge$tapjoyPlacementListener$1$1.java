...
@DebugMetadata(c = "com.unity3d.services.ads.offerwall.OfferwallAdapterBridge$tapjoyPlacementListener$1$1", f = "OfferwallAdapterBridge.kt", i = {}, l = {76, IronSourceConstants.TROUBLESHOOTING_AD_QUALITY_SDK_INITIALIZED_SUCCESSFULLY_EVENT}, m = "invokeSuspend", n = {}, s = {})
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            if (this.$placementAvailable) {
                ...
                this.label = 1;
                if (mutableSharedFlow.emit(new OfferwallEventData(offerwallEvent, str2, null, null, 12, null), this) == coroutine_suspended) {
                ...
                this.label = 2;
                if (mutableSharedFlow2.emit(new OfferwallEventData(offerwallEvent2, str4, null, null, 12, null), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
        } else {
