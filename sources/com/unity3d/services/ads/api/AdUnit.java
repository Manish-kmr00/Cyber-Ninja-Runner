    ...
    public static void getViewFrame(String str, WebViewCallback webViewCallback) {
        if (getAdUnitActivity() != null) {
            if (getAdUnitActivity().getViewFrame(str) != null) {
                ...
                webViewCallback.invoke(viewFrame.get(VastAttributes.HORIZONTAL_POSITION), viewFrame.get(VastAttributes.VERTICAL_POSITION), viewFrame.get("width"), viewFrame.get("height"));
                return;
            } else {
                ...
                for (int i3 = 0; i3 < events.size(); i3++) {
                    ...
                    for (int i4 = 0; i4 < sparseArray2.size(); i4++) {
                        ...
                        try {
                            ...
                            jSONObject4.put(VastAttributes.HORIZONTAL_POSITION, adUnitMotionEvent.getX());
                            jSONObject4.put(VastAttributes.VERTICAL_POSITION, adUnitMotionEvent.getY());
                ...
                if (rootWindowInsets != null) {
                    ...
                    try {
                        ...
                        if (objInvoke != null) {
                            ...
                            jSONObject.put(ViewHierarchyConstants.DIMENSION_TOP_KEY, objInvoke2);
