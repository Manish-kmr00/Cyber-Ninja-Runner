...
public class AdUnitActivityController {
    ...
    public Map<String, Integer> getViewFrame(String str) {
        ...
        if (str.equals("adunit")) {
            ...
            map.put(VastAttributes.HORIZONTAL_POSITION, Integer.valueOf(layoutParams.leftMargin));
            map.put(VastAttributes.VERTICAL_POSITION, Integer.valueOf(layoutParams.topMargin));
        ...
        map2.put(VastAttributes.HORIZONTAL_POSITION, Integer.valueOf(layoutParams2.leftMargin));
        map2.put(VastAttributes.VERTICAL_POSITION, Integer.valueOf(layoutParams2.topMargin));
