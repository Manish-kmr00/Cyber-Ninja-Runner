...
final class S extends RelativeLayout {
    ...
    protected void createUI() {
        ...
        this.f8247a.setText(this.c.getResources().getIdentifier("ok", "string", "android"));
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.addRule(15);
        layoutParams.addRule(11);
        this.f8247a.setLayoutParams(layoutParams);
        this.f8247a.setBackgroundColor(0);
        addView(this.f8247a);
        this.b.setId(View.generateViewId());
        RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(-1, -2);
        layoutParams2.addRule(15);
        layoutParams2.addRule(0, this.f8247a.getId());
