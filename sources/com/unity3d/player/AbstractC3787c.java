...
abstract class AbstractC3787c {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private static final int[] f8268a = {android.R.attr.progressBarStyleLarge, android.R.attr.progressBarStyleLargeInverse, android.R.attr.progressBarStyleSmall, android.R.attr.progressBarStyleSmallInverse};
    ...
    public static void a(Activity activity, FrameLayout frameLayout, int i) {
        if (i >= 0) {
            ...
            view.requestFocus();
            view.setOnTouchListener(new ViewOnTouchListenerC3781a());
            view.setOnKeyListener(new ViewOnKeyListenerC3784b());
            c = view;
