...
abstract class U implements TextWatcher {
    ...
    public U(Context context, UnityPlayerForActivityOrService unityPlayerForActivityOrService) {
        this.f8250a = context;
    ...
    protected abstract EditText createEditText(U u);

    public abstract void d();

    public final void e() {
        ((InputMethodManager) this.f8250a.getSystemService(InputMethodManager.class)).showSoftInput(this.c, 0);
    }
