...
public final class E1 extends FrameLayout implements MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnVideoSizeChangedListener, SurfaceHolder.Callback, MediaController.MediaPlayerControl {
    ...
    protected E1(Context context, UnityPlayer unityPlayer, String str, int i, int i2, int i3, boolean z, long j, long j2, C1 c1) {
        super(context);
        this.q = false;
        this.r = false;
        this.s = 0;
        ...
        this.w = F.a(unityPlayer.getActivity(), 1000000, new B1(this));
    }
    ...
    public boolean exitOnKeypress(int i, KeyEvent keyEvent) {
        ...
        com.unity3d.player.a.e eVar = this.w.f8213a;
        if (eVar == null || (runnable = ((D) eVar).f8210a) == null) {
            return true;
        }
        runnable.run();
        return true;
    ...
    public void onPrepared(MediaPlayer mediaPlayer) {
        ...
        int i = this.e;
        if (i == 0 || i == 1) {
            MediaController mediaController = new MediaController(this.f8215a);
    ...
    public void surfaceCreated(SurfaceHolder surfaceHolder) {
        ...
        try {
            ...
            this.o = mediaPlayer3;
            if (this.g) {
                mediaPlayer3.setDataSource(this.f8215a, Uri.parse(this.d));
            } else {
                if (this.i != 0) {
    ...
    */
    protected void updateVideoLayout() {
        /*
            ...
            return
        L5:
            android.content.Context r0 = r10.f8215a
            android.graphics.Point r0 = com.unity3d.player.N1.a(r0)
            int r1 = r0.x
            if (r1 <= 0) goto L17
            int r0 = r0.y
            if (r0 <= 0) goto L17
        ...
        L4b:
            ...
            r1 = 17
            r0.<init>(r2, r4, r1)
            com.unity3d.player.E1 r1 = r10.j
            android.view.SurfaceView r2 = r10.b
            r1.updateViewLayout(r2, r0)
        L59:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.unity3d.player.E1.updateVideoLayout():void");
    }
}
