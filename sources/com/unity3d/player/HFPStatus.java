...
public class HFPStatus {
    ...
    protected void clearHFPStat() {
        ...
        if (broadcastReceiver != null) {
            this.f8221a.unregisterReceiver(broadcastReceiver);
            this.b = null;
        }
        this.f = 1;
        a();
    ...
    protected void requestHFPStat() {
        ...
        this.f8221a.registerReceiver(broadcastReceiver, new IntentFilter("android.media.ACTION_SCO_AUDIO_STATE_UPDATED"));
        try {
            this.e = true;
            this.d.startBluetoothSco();
        } catch (NullPointerException unused) {
            B.Log(5, "startBluetoothSco() failed. no bluetooth device connected.");
        }
    }
