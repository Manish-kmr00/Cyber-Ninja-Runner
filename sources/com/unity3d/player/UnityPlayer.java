...
public abstract class UnityPlayer implements IUnityPlayerLifecycleEvents {
    ...
    U0 m_PhoneCallListener = new U0(this);
    private GoogleARCoreApi m_ARCoreApi = null;
    private R0 m_FakeListener = new R0();
    ...
    private C m_NetworkConnectivity = null;
    private E m_OnBackPressedDispatcher = null;
    private C3844y0 m_Cursor = null;
    ...
    protected UnityPlayer(Context context, EnumC3841x enumC3841x, IUnityPlayerLifecycleEvents iUnityPlayerLifecycleEvents) {
        this.mInitialScreenOrientation = -1;
        this.m_UnityPlayerLifecycleEvents = null;
        this.mContext = context;
        this.mContextType = enumC3841x;
        this.m_UnityPlayerLifecycleEvents = iUnityPlayerLifecycleEvents == null ? this : iUnityPlayerLifecycleEvents;
        C3846z0.a(getUnityNativeLibraryPath(context));
    ...
    private void EarlyEnableFullScreenIfEnabled() {
        ...
        AbstractC3843y.a(this.mActivity);
    }
    ...
    public static void UnitySendMessage(String str, String str2, String str3) {
        byte[] bytes;
        if (!A1.d()) {
            B.Log(5, "Native libraries not loaded - dropping message for " + str + "." + str2);
            return;
        }
        if (str3 == null) {
            bytes = null;
    ...
    public void invokeOnMainThread(V0 v0) {
        if (isFinishing()) {
            return;
        }
        invokeOnMainThread((Runnable) v0);
    }
        ...
        try {
            try {
                try {
                    ...
                    System.loadLibrary(b9.h.Z);
                }
                if (NativeLoader.load(str)) {
                    A1.e();
                    return "";
                }
                B.Log(6, "NativeLoader.load failure, Unity libraries were not loaded.");
    ...
    private static void preloadJavaPlugins() {
        try {
            ...
            B.Log(6, "Java class preloading failed: " + e.getMessage());
        }
    }
    ...
    private void requestUserAuthorization(String str, long j) {
        ...
        UnityPermissions.requestUserPermissions(activity, new String[]{str}, j != 0 ? new T0(this, j) : null);
    }
    ...
    private void setBackButtonLeavesApp(boolean z) {
        E e = this.m_OnBackPressedDispatcher;
        if (e != null) {
            if (z) {
                e.unregisterOnBackPressedCallback();
            } else {
                e.registerOnBackPressedCallback();
            }
        }
    }
    ...
    private void setScreenBrightness(float f) {
        ...
        runOnUiThread(new Q0(this, fMax));
    }
    ...
    public synchronized void addPermissionRequest(PermissionRequest permissionRequest) {
        ...
        if (this.m_PermissionRequests.size() == 1) {
            requestPermissionsFromActivity(permissionRequest.getPermissionNames(), numValueOf.intValue());
        }
    }
    ...
    public boolean addViewToPlayer(View view, boolean z) {
        ...
        if (!z2) {
            if (!z3) {
                B.Log(6, "addViewToPlayer: Failure adding view to hierarchy");
            }
            if (!z4 && !z5) {
                B.Log(6, "addViewToPlayer: Failure removing old view from hierarchy");
            }
        }
        return z2;
    }
    ...
    public void destroy() {
        ...
        C c = this.m_NetworkConnectivity;
        if (c != null) {
            c.a();
    ...
    protected String getKeyboardLayout() {
        ...
        String strA = A.a(currentInputMethodSubtype);
    ...
    protected int getNetworkConnectivity() {
        ...
        this.m_NetworkConnectivity = PlatformSupport.NOUGAT_SUPPORT ? new com.unity3d.player.a.d(this.mContext) : new C(this.mContext);
    ...
    protected void initialize(FrameLayout frameLayout) {
        ...
        if (!A1.d()) {
            B.Log(6, "Your hardware does not support this application.");
            AlertDialog alertDialogCreate = new AlertDialog.Builder(this.mContext).setTitle("Failure to initialize!").setPositiveButton("OK", new I0(this)).setMessage("Your hardware does not support this application.\n\n" + strLoadNative + "\n\n Press OK to quit.").create();
            alertDialogCreate.setCancelable(false);
            alertDialogCreate.show();
            return;
        }
        initJni(this.mContext, this.mContextType.f8314a);
        this.mState.d(true);
        ...
        this.m_Cursor = new C3844y0(this);
        ...
        this.m_OnBackPressedDispatcher = F.a(getContext(), 1, new J0(this));
        Activity activity = this.mActivity;
        if (activity != null) {
    ...
    public void removeViewFromPlayer(View view) {
        ...
        if (!z) {
            B.Log(6, "removeViewFromPlayer: Failure removing view from hierarchy");
        }
        if (z2) {
            return;
        }
        B.Log(6, "removeViewFromPlayer: Failure adding old view to hierarchy");
    }
    ...
    void setLaunchURL(Uri uri) {
        invokeOnMainThread(new M0(uri != null ? uri.toString() : null));
    }
    ...
    protected void setupUnityToBeResumed() {
        ...
        if (this.m_OrientationLockListener == null && A1.d()) {
    ...
    protected boolean showVideoPlayer(String str, int i, int i2, int i3, boolean z, int i4, int i5) {
        if (this.mVideoPlayerProxy == null) {
            this.mVideoPlayerProxy = new M1(this);
        }
        boolean zA = this.mVideoPlayerProxy.a(this.mContext, str, i, i2, i3, z, i4, i5, new N0(this));
        if (zA) {
    ...
    public boolean startOrientationListener(int i) {
        ...
        if (this.mOrientationListener != null) {
            ...
            P0 p0 = new P0(this, this.mContext, i);
            this.mOrientationListener = p0;
    ...
    public boolean stopOrientationListener() {
        ...
        if (orientationEventListener == null) {
            B.Log(5, "Orientation Listener was not started.");
            return false;
        }
