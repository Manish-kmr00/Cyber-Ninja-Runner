...
public final class OperativeEventObserver {
    ...
    public OperativeEventObserver(GetUniversalRequestForPayLoad getUniversalRequestForPayLoad, CoroutineDispatcher defaultDispatcher, OperativeEventRepository operativeEventRepository, UniversalRequestDataSource universalRequestDataSource, BackgroundWorker backgroundWorker) {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (this.label == 0) {
                ...
                FlowKt.launchIn(FlowKt.onEach(OperativeEventObserver.this.operativeEventRepository.getOperativeEvents(), new C07212(OperativeEventObserver.this, null)), CoroutineScopeKt.CoroutineScope(OperativeEventObserver.this.defaultDispatcher));
                return Unit.INSTANCE;
            }
        ...
        static final class C07212 extends SuspendLambda implements Function2<OperativeEventRequestOuterClass.OperativeEventRequest, Continuation<? super Unit>, Object> {
            /* synthetic */ Object L$0;
            int label;
            final /* synthetic */ OperativeEventObserver this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C07212(OperativeEventObserver operativeEventObserver, Continuation<? super C07212> continuation) {
                super(2, continuation);
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                C07212 c07212 = new C07212(this.this$0, continuation);
                c07212.L$0 = obj;
                return c07212;
            }
            ...
            public final Object invoke(OperativeEventRequestOuterClass.OperativeEventRequest operativeEventRequest, Continuation<? super Unit> continuation) {
                return ((C07212) create(operativeEventRequest, continuation)).invokeSuspend(Unit.INSTANCE);
            }
