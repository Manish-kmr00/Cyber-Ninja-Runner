...
public final class AndroidOmStartSession extends AndroidOmInteraction {
    ...
    public Object invoke(AdObject adObject, JSONObject jSONObject, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objStartSession = anonymousClass1.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = anonymousClass1.label;
        if (i == 0) {
            ResultKt.throwOnFailure(objStartSession);
            ...
            androidOmStartSession = (AndroidOmStartSession) anonymousClass1.L$0;
            ResultKt.throwOnFailure(objStartSession);
        }
        ...
        if (oMResult instanceof OMResult.Success) {
            ...
            SendDiagnosticEvent.DefaultImpls.invoke$default(sendDiagnosticEvent, "om_session_start_failure", null, MapsKt.build(mapCreateMapBuilder), null, adObject2, 10, null);
        }
