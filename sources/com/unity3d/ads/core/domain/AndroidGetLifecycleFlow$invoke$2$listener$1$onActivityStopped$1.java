...
final class AndroidGetLifecycleFlow$invoke$2$listener$1$onActivityStopped$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    AndroidGetLifecycleFlow$invoke$2$listener$1$onActivityStopped$1(ProducerScope<? super LifecycleEvent> producerScope, Activity activity, Continuation<? super AndroidGetLifecycleFlow$invoke$2$listener$1$onActivityStopped$1> continuation) {
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (this.$$this$channelFlow.send(new LifecycleEvent.Stopped(new WeakReference(this.$activity)), this) == coroutine_suspended) {
