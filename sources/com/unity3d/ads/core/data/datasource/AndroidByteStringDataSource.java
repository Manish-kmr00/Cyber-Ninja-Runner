...
public final class AndroidByteStringDataSource implements ByteStringDataSource {
    ...
    public Object get(Continuation<? super ByteStringStoreOuterClass.ByteStringStore> continuation) {
        return FlowKt.first(FlowKt.m9437catch(this.dataStore.getData(), new AnonymousClass2(null)), continuation);
    }
    ...
    static final class C37032 extends SuspendLambda implements Function2<ByteStringStoreOuterClass.ByteStringStore, Continuation<? super ByteStringStoreOuterClass.ByteStringStore>, Object> {
        final /* synthetic */ ByteString $data;
        /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C37032(ByteString byteString, Continuation<? super C37032> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C37032 c37032 = new C37032(this.$data, continuation);
            c37032.L$0 = obj;
            return c37032;
        }
        ...
        public final Object invoke(ByteStringStoreOuterClass.ByteStringStore byteStringStore, Continuation<? super ByteStringStoreOuterClass.ByteStringStore> continuation) {
            return ((C37032) create(byteStringStore, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public Object set(ByteString byteString, Continuation<? super Unit> continuation) {
        Object objUpdateData = this.dataStore.updateData(new C37032(byteString, null), continuation);
