...
public final class UniversalRequestDataSource {
    ...
    public final Object get(Continuation<? super UniversalRequestStoreOuterClass.UniversalRequestStore> continuation) {
        return FlowKt.first(FlowKt.m9437catch(this.universalRequestStore.getData(), new AnonymousClass2(null)), continuation);
    }
    ...
    static final class C37062 extends SuspendLambda implements Function2<UniversalRequestStoreOuterClass.UniversalRequestStore, Continuation<? super UniversalRequestStoreOuterClass.UniversalRequestStore>, Object> {
        ...
        C37062(String str, ByteString byteString, Continuation<? super C37062> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C37062 c37062 = new C37062(this.$key, this.$data, continuation);
            c37062.L$0 = obj;
            return c37062;
        }
        ...
        public final Object invoke(UniversalRequestStoreOuterClass.UniversalRequestStore universalRequestStore, Continuation<? super UniversalRequestStoreOuterClass.UniversalRequestStore> continuation) {
            return ((C37062) create(universalRequestStore, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Object set(String str, ByteString byteString, Continuation<? super Unit> continuation) {
        Object objUpdateData = this.universalRequestStore.updateData(new C37062(str, byteString, null), continuation);
    ...
    static final class C37052 extends SuspendLambda implements Function2<UniversalRequestStoreOuterClass.UniversalRequestStore, Continuation<? super UniversalRequestStoreOuterClass.UniversalRequestStore>, Object> {
        final /* synthetic */ String $key;
        /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C37052(String str, Continuation<? super C37052> continuation) {
            super(2, continuation);
            this.$key = str;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C37052 c37052 = new C37052(this.$key, continuation);
            c37052.L$0 = obj;
            return c37052;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(UniversalRequestStoreOuterClass.UniversalRequestStore universalRequestStore, Continuation<? super UniversalRequestStoreOuterClass.UniversalRequestStore> continuation) {
            return ((C37052) create(universalRequestStore, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Object remove(String str, Continuation<? super Unit> continuation) {
        Object objUpdateData = this.universalRequestStore.updateData(new C37052(str, null), continuation);
        return objUpdateData == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objUpdateData : Unit.INSTANCE;
    }
}
