...
public class CollectionUtils {
    ...
    public static <T> boolean addUniqueObjectIfExists(T t, List<T> list) {
    ...
    public static String implode(Collection<String> collection, int i) {
        return implode(collection, io.appmetrica.analytics.coreutils.internal.StringUtils.COMMA, i);
    }
