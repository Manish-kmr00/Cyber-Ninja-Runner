...
public class ArrayService extends IAppHubDirectDownloadServiceCallback.Stub {
    ...
    public ArrayService(final k kVar) {
        ...
        this.minVersionCodeWithGenericEventsSupport = ((Integer) kVar.a(v4.c0)).intValue();
    ...
    public void collectAppHubData() {
        if (isAppHubInstalled()) {
            ...
            if (TextUtils.isEmpty(this.randomUserToken) && ((Boolean) this.sdk.a(v4.a0)).booleanValue()) {
    ...
    public void maybeSendAdEvent(v2 v2Var, String str) {
        ...
        if (((Boolean) this.sdk.a(v4.b0)).booleanValue() && (iAppHubService = this.appHubService) != null && t3.b(v2Var)) {
            if (o.a()) {
    ...
    public void onError(String str, String str2) {
        ...
        this.sdk.E().d(c2.v0, healthEventExtraParameters);
        DirectDownloadState directDownloadState = this.currentDownloadState;
        if (directDownloadState == null) {
            return;
        }
    ...
    public void onEvent(String str, Bundle bundle) {
        if (o.a()) {
            this.logger.a(TAG, "Received event: " + str);
        }
        if (shouldUseGenericDirectDownloadEvent()) {
