...
public abstract class e2 {
    public static Map a(AppLovinAdImpl appLovinAdImpl) {
        ...
        CollectionUtils.putStringIfValid(CreativeInfo.c, String.valueOf(appLovinAdImpl.getAdIdNumber()), map);
        ...
        CollectionUtils.putStringIfValid(Reporting.Key.AD_SIZE, appLovinAdImpl.getSize().getLabel(), map);
    ...
    public static Map a(AppLovinNativeAdImpl appLovinNativeAdImpl) {
        ...
        CollectionUtils.putStringIfValid(CreativeInfo.c, String.valueOf(appLovinNativeAdImpl.getAdIdNumber()), map);
        ...
        CollectionUtils.putStringIfValid(Reporting.Key.AD_SIZE, AppLovinAdSize.NATIVE.toString(), map);
    ...
    public static Map a(v2 v2Var) {
        ...
        CollectionUtils.putStringIfValid("creative_id", v2Var.getCreativeId(), mapA);
    ...
    public static Map a(h3 h3Var) {
        ...
        CollectionUtils.putStringIfValid(BrandSafetyEvent.ad, h3Var.c(), map);
        String strB = h3Var.b();
        CollectionUtils.putStringIfValid("adapter_class", strB, map);
        CollectionUtils.putStringIfValid("adapter_version", t3.a(strB).getAdapterVersion(), map);
        return map;
    }
