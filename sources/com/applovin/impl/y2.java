...
public class y2 extends e3 {
    ...
    public long l0() {
        ...
        return jA >= 0 ? jA : b("ad_refresh_ms", ((Long) this.f436a.a(o3.p7)).longValue());
    }
    ...
    public long o0() {
        return a("viewability_imp_delay_ms", ((Long) this.f436a.a(v4.l1)).longValue());
    }
    ...
    public boolean r0() {
        return a("proe", (Boolean) this.f436a.a(o3.R7)).booleanValue();
    }

    private y2(y2 y2Var, com.applovin.impl.mediation.h hVar) {
        super(y2Var.M(), y2Var.a(), y2Var.g(), hVar, y2Var.f436a);
    }
}
