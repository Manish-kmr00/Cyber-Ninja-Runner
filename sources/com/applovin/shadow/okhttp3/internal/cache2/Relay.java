        ...
        public long read(Buffer sink, long byteCount) throws IOException {
            ...
            synchronized (relay) {
                ...
                try {
                    ...
                    fileOperator2.write(Relay.this.getUpstreamPos() + 32, Relay.this.getUpstreamBuffer().m4715clone(), j);
