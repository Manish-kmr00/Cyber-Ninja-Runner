...
public final class HttpUrl {
    ...
    public final String m4634deprecated_encodedUsername() {
    ...
    public final String m4630deprecated_encodedPassword() {
    ...
    public static final class Builder {
        ...
        public final Builder query(String query) {
            ...
            this.encodedQueryNamesAndValues = (query == null || (strCanonicalize$okhttp$default = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, query, 0, 0, " \"'<>#", false, false, true, false, null, Sdk.SDKError.Reason.MRAID_JS_COPY_FAILED_VALUE, null)) == null) ? null : HttpUrl.INSTANCE.toQueryNamesAndValues$okhttp(strCanonicalize$okhttp$default);
            return this;
        }

        public final Builder encodedQuery(String encodedQuery) {
            String strCanonicalize$okhttp$default;
            this.encodedQueryNamesAndValues = (encodedQuery == null || (strCanonicalize$okhttp$default = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, encodedQuery, 0, 0, " \"'<>#", true, false, true, false, null, 211, null)) == null) ? null : HttpUrl.INSTANCE.toQueryNamesAndValues$okhttp(strCanonicalize$okhttp$default);
            return this;
        }
        ...
        public final Builder reencodeForUri$okhttp() {
            ...
            for (int i = 0; i < size; i++) {
                this.encodedPathSegments.set(i, Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, this.encodedPathSegments.get(i), 0, 0, "[]", true, true, false, false, null, 227, null));
            }
            List<String> list = this.encodedQueryNamesAndValues;
            if (list != null) {
                int size2 = list.size();
        ...
        public final Builder parse$okhttp(HttpUrl base, String input) {
            ...
            if (iSchemeDelimiterOffset != -1) {
                ...
                if (input.length() > 6) {
                    input2 = StringsKt.take(input2, 6) + APSSharedUtil.TRUNCATE_SEPARATOR;
                }
            ...
            if (iSlashCount >= 2 || base == null || !Intrinsics.areEqual(base.scheme(), this.scheme)) {
                ...
                while (true) {
                    ...
                    if (bCharAt == 64) {
                        if (z4) {
                            i2 = iDelimiterOffset;
                            z = z3;
                            this.encodedPassword += "%40" + Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, i3, i2, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, 240, null);
                        } else {
                            int iDelimiterOffset2 = Util.delimiterOffset(input2, AbstractJsonLexerKt.COLON, i3, iDelimiterOffset);
                            z = z3;
                            String strCanonicalize$okhttp$default = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, i3, iDelimiterOffset2, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, 240, null);
                            if (z5) {
                            ...
                            if (iDelimiterOffset2 != i2) {
                                this.encodedPassword = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, iDelimiterOffset2 + 1, i2, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, 240, null);
                                z2 = z;
                            } else {
                                z2 = z4;
                            }
                ...
                int iPortColonOffset = companion2.portColonOffset(input2, i3, iDelimiterOffset);
                ...
                if (i4 < iDelimiterOffset) {
                    ...
                    int port = companion2.parsePort(input2, i4, iDelimiterOffset);
                    this.port = port;
                    if (port == -1) {
            ...
            if (iDelimiterOffset3 < i5 && input2.charAt(iDelimiterOffset3) == '?') {
                ...
                this.encodedQueryNamesAndValues = HttpUrl.INSTANCE.toQueryNamesAndValues$okhttp(Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, iDelimiterOffset3 + 1, iDelimiterOffset4, " \"'<>#", true, false, true, false, null, 208, null));
        ...
        /* JADX INFO: compiled from: HttpUrl.kt */
        @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0002\b\u0007\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J \u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u00042\u0006\u0010\b\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\u0006H\u0002J \u0010\n\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u00042\u0006\u0010\b\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\u0006H\u0002J \u0010\u000b\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u00042\u0006\u0010\b\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\u0006H\u0002J\u001c\u0010\f\u001a\u00020\u0006*\u00020\u00042\u0006\u0010\b\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\u0006H\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0080T¢\u0006\u0002\n\u0000¨\u0006\r"}, d2 = {"Lcom/applovin/shadow/okhttp3/HttpUrl$Builder$Companion;", "", "()V", "INVALID_HOST", "", "parsePort", "", "input", POBConstants.KEY_POSITION, "limit", "portColonOffset", "schemeDelimiterOffset", "slashCount", OkHttp3Client.NETWORK_CLIENT_OKHTTP}, k = 1, mv = {1, 8, 0}, xi = 48)
    ...
    public static final class Companion {
        ...
        public final List<String> toQueryNamesAndValues$okhttp(String str) {
            ...
            while (i <= str.length()) {
                ...
                int iIndexOf$default2 = StringsKt.indexOf$default((CharSequence) str2, cc.T, i, false, 4, (Object) null);
        ...
        public final HttpUrl m4648deprecated_get(String url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return get(url);
        }
        ...
        public final HttpUrl m4651deprecated_parse(String url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return parse(url);
        }
        ...
        @Deprecated(level = DeprecationLevel.ERROR, message = "moved to extension function", replaceWith = @ReplaceWith(expression = "url.toHttpUrlOrNull()", imports = {"com.applovin.shadow.okhttp3.HttpUrl.Companion.toHttpUrlOrNull"}))
        /* JADX INFO: renamed from: -deprecated_get, reason: not valid java name */
        public final HttpUrl m4650deprecated_get(URL url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return get(url);
        }
        ...
        /* JADX INFO: renamed from: -deprecated_get, reason: not valid java name */
        public final HttpUrl m4649deprecated_get(URI uri) {
