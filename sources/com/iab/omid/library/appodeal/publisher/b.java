...
public class b extends AdSessionStatePublisher {
    ...
    class RunnableC0337b implements Runnable {
        ...
        private final WebView f2536a;

        RunnableC0337b() {
            this.f2536a = b.this.g;
        }
    ...
    public void b() {
        super.b();
        new Handler().postDelayed(new RunnableC0337b(), Math.max(4000 - (this.h == null ? 4000L : TimeUnit.MILLISECONDS.convert(f.b() - this.h.longValue(), TimeUnit.NANOSECONDS)), 2000L));
        this.g = null;
    }
