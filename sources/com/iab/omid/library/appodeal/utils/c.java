...
public class c {
    ...
    private static WindowManager f2538a;
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f2538a != null) {
            ...
            f2538a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            ...
            f2538a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, com.iab.omid.library.appodeal.walking.a.C0338a c0338a) {
        com.iab.omid.library.appodeal.internal.e eVarA = c0338a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0338a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f2539a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f2540a);
