...
public class TreeWalker implements com.iab.omid.library.appodeal.processor.a.InterfaceC0336a {
    ...
    private List<TreeWalkerTimeLogger> f2542a = new ArrayList();
    ...
    private void a(long j2) {
        if (this.f2542a.size() > 0) {
            for (TreeWalkerTimeLogger treeWalkerTimeLogger : this.f2542a) {
    ...
    private void a(String str, View view, JSONObject jSONObject) {
        com.iab.omid.library.appodeal.processor.a aVarB = this.e.b();
    ...
    private boolean a(View view, JSONObject jSONObject) {
        com.iab.omid.library.appodeal.walking.a.C0338a c0338aB = this.f.b(view);
        if (c0338aB == null) {
            return false;
        }
        com.iab.omid.library.appodeal.utils.c.a(jSONObject, c0338aB);
        return true;
    }
    ...
    private boolean b(View view, JSONObject jSONObject) {
        ...
        com.iab.omid.library.appodeal.utils.c.b(jSONObject, Boolean.valueOf(this.f.c(strC)));
        this.f.d();
        return true;
    }
    ...
    @Override // com.iab.omid.library.appodeal.processor.a.InterfaceC0336a
    public void a(View view, com.iab.omid.library.appodeal.processor.a aVar, JSONObject jSONObject, boolean z) {
        ...
        if (h.f(view) && (cVarD = this.f.d(view)) != com.iab.omid.library.appodeal.walking.c.UNDERLYING_VIEW) {
            JSONObject jSONObjectA = aVar.a(view);
            com.iab.omid.library.appodeal.utils.c.a(jSONObject, jSONObjectA);
            if (!b(view, jSONObjectA)) {
                boolean z2 = z || a(view, jSONObjectA);
                if (this.c && cVarD == com.iab.omid.library.appodeal.walking.c.OBSTRUCTION_VIEW && !z2) {
    ...
    public void addTimeLogger(TreeWalkerTimeLogger treeWalkerTimeLogger) {
        if (this.f2542a.contains(treeWalkerTimeLogger)) {
            return;
        }
        this.f2542a.add(treeWalkerTimeLogger);
    }

    void f() {
        this.f.e();
        long jB = f.b();
        com.iab.omid.library.appodeal.processor.a aVarA = this.e.a();
        if (this.f.b().size() > 0) {
    ...
    public void removeTimeLogger(TreeWalkerTimeLogger treeWalkerTimeLogger) {
        if (this.f2542a.contains(treeWalkerTimeLogger)) {
            this.f2542a.remove(treeWalkerTimeLogger);
        }
    }
}
