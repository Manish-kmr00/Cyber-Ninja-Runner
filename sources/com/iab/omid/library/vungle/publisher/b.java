...
public class b extends AdSessionStatePublisher {
    ...
    class RunnableC0387b implements Runnable {
        ...
        private final WebView f2997a;

        RunnableC0387b() {
            this.f2997a = b.this.g;
        }
    ...
    public void b() {
        super.b();
        new Handler().postDelayed(new RunnableC0387b(), Math.max(4000 - (this.h == null ? 4000L : TimeUnit.MILLISECONDS.convert(f.b() - this.h.longValue(), TimeUnit.NANOSECONDS)), 2000L));
        this.g = null;
    }
