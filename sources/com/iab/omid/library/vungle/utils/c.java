...
public class c {
    ...
    private static WindowManager f2999a;
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f2999a != null) {
            ...
            f2999a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            ...
            f2999a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, com.iab.omid.library.vungle.walking.a.C0388a c0388a) {
        com.iab.omid.library.vungle.internal.e eVarA = c0388a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0388a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f3000a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f3001a);
