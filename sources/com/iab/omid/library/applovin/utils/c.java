...
public class c {
    ...
    private static WindowManager f2501a;
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f2501a != null) {
            ...
            f2501a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            ...
            f2501a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, com.iab.omid.library.applovin.walking.a.C0334a c0334a) {
        com.iab.omid.library.applovin.internal.e eVarA = c0334a.a();
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f2502a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f2503a);
