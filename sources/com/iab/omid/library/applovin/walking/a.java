...
public class a {
    ...
    private final HashMap<View, String> f2507a = new HashMap<>();
    private final HashMap<View, C0334a> b = new HashMap<>();
    ...
    private void a(e eVar, com.iab.omid.library.applovin.adsession.a aVar) {
        ...
        C0334a c0334a = this.b.get(view);
        if (c0334a != null) {
            c0334a.a(aVar.c());
        } else {
            this.b.put(view, new C0334a(eVar, aVar.c()));
        }
    }
    ...
    public String c(View view) {
        ...
        String str = this.f2507a.get(view);
        if (str != null) {
            this.f2507a.remove(view);
        }
        return str;
    }
