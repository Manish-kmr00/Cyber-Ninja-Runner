...
public class b extends AdSessionStatePublisher {
    ...
    class RunnableC0333b implements Runnable {
        ...
        private final WebView f2499a;

        RunnableC0333b() {
            this.f2499a = b.this.g;
        }
    ...
    public void b() {
        super.b();
        new Handler().postDelayed(new RunnableC0333b(), Math.max(4000 - (this.h == null ? 4000L : TimeUnit.MILLISECONDS.convert(f.b() - this.h.longValue(), TimeUnit.NANOSECONDS)), 2000L));
        this.g = null;
    }
