...
public class b extends AdSessionStatePublisher {
    ...
    class RunnableC0383b implements Runnable {
        ...
        private final WebView f2960a;

        RunnableC0383b() {
            this.f2960a = b.this.g;
        }
    ...
    public void b() {
        super.b();
        new Handler().postDelayed(new RunnableC0383b(), Math.max(4000 - (this.h == null ? 4000L : TimeUnit.MILLISECONDS.convert(f.b() - this.h.longValue(), TimeUnit.NANOSECONDS)), 2000L));
        this.g = null;
    }
