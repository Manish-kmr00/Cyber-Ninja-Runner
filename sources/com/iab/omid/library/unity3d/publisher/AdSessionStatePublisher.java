...
public abstract class AdSessionStatePublisher {
    ...
    public void a(float f) {
        g.a().a(getWebView(), this.f2957a, f);
    }
    ...
    public void a(AdSessionConfiguration adSessionConfiguration) {
        g.a().a(getWebView(), this.f2957a, adSessionConfiguration.toJsonObject());
    }

    public void a(ErrorType errorType, String str) {
        g.a().a(getWebView(), this.f2957a, errorType, str);
    }
    ...
    protected void a(com.iab.omid.library.unity3d.adsession.a aVar, AdSessionContext adSessionContext, JSONObject jSONObject) {
        ...
        c.a(jSONObject2, POBCrashAnalyticsConstants.DEVICE_INFO_KEY, com.iab.omid.library.unity3d.utils.b.d());
    ...
    public void a(String str, long j) {
        if (j >= this.f) {
            ...
            if (aVar != aVar2) {
                this.e = aVar2;
                g.a().a(getWebView(), this.f2957a, str);
            }
        }
    }

    public void a(String str, JSONObject jSONObject) {
        g.a().a(getWebView(), this.f2957a, str, jSONObject);
    }
    ...
    public void a(JSONObject jSONObject) {
        g.a().b(getWebView(), this.f2957a, jSONObject);
    }

    public void a(boolean z) {
        if (e()) {
            g.a().b(getWebView(), this.f2957a, z ? "foregrounded" : "backgrounded");
        }
    }
    ...
    public void f() {
        g.a().a(getWebView(), this.f2957a);
    }

    public void g() {
        g.a().b(getWebView(), this.f2957a);
    }
