...
public class c {
    ...
    private static WindowManager f2962a;
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f2962a != null) {
            ...
            f2962a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            ...
            f2962a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, com.iab.omid.library.unity3d.walking.a.C0384a c0384a) {
        com.iab.omid.library.unity3d.internal.e eVarA = c0384a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0384a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f2963a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f2964a);
