...
public class TreeWalker implements com.iab.omid.library.unity3d.processor.a.InterfaceC0382a {
    ...
    private List<TreeWalkerTimeLogger> f2966a = new ArrayList();
    ...
    private void a(long j2) {
        if (this.f2966a.size() > 0) {
            for (TreeWalkerTimeLogger treeWalkerTimeLogger : this.f2966a) {
    ...
    private boolean a(View view, JSONObject jSONObject) {
        com.iab.omid.library.unity3d.walking.a.C0384a c0384aC = this.f.c(view);
        if (c0384aC == null) {
            return false;
        }
        com.iab.omid.library.unity3d.utils.c.a(jSONObject, c0384aC);
        return true;
    }
    ...
    @Override // com.iab.omid.library.unity3d.processor.a.InterfaceC0382a
    ...
    public void addTimeLogger(TreeWalkerTimeLogger treeWalkerTimeLogger) {
        if (this.f2966a.contains(treeWalkerTimeLogger)) {
            return;
        }
        this.f2966a.add(treeWalkerTimeLogger);
    }
    ...
    public void removeTimeLogger(TreeWalkerTimeLogger treeWalkerTimeLogger) {
        if (this.f2966a.contains(treeWalkerTimeLogger)) {
            this.f2966a.remove(treeWalkerTimeLogger);
        }
    }
}
