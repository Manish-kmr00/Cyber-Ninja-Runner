...
public class a {
    ...
    private final HashMap<View, String> f2968a = new HashMap<>();
    private final HashMap<View, C0384a> b = new HashMap<>();
    ...
    public static class C0384a {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final e f2969a;
        private final ArrayList<String> b = new ArrayList<>();

        public C0384a(e eVar, String str) {
            this.f2969a = eVar;
            a(str);
        }
    ...
    private void a(e eVar, com.iab.omid.library.unity3d.adsession.a aVar) {
        ...
        C0384a c0384a = this.b.get(view);
        if (c0384a != null) {
            c0384a.a(aVar.getAdSessionId());
        } else {
            this.b.put(view, new C0384a(eVar, aVar.getAdSessionId()));
        }
    }
    ...
    public String d(View view) {
        ...
        String str = this.f2968a.get(view);
        if (str != null) {
            this.f2968a.remove(view);
        }
        return str;
    }
                ...
                if (aVar.f()) {
                    ...
                    if (viewC != null) {
                        ...
                        if (strA == null) {
                            ...
                            this.f2968a.put(viewC, adSessionId);
                            a(aVar);
