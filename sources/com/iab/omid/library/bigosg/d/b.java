...
public class b {
    ...
    static float f2568a = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void a(Context context) {
        if (context != null) {
            f2568a = context.getResources().getDisplayMetrics().density;
    ...
    public static void a(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", aVarB.f2569a);
            jSONObject.put("height", aVarB.b);
        } catch (JSONException unused) {
        }
    }

    public static void a(JSONObject jSONObject, com.iab.omid.library.bigosg.walking.a.C0341a c0341a) {
        com.iab.omid.library.bigosg.b.c cVarA = c0341a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0341a.b().iterator();
        while (it.hasNext()) {
