...
public class b extends AdSessionStatePublisher {
    ...
    /* JADX INFO: renamed from: com.iab.omid.library.smaato.publisher.b$b, reason: collision with other inner class name */
    class RunnableC0379b implements Runnable {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final WebView f2926a;

        RunnableC0379b() {
            this.f2926a = b.this.g;
        }
    ...
    public void b() {
        super.b();
        new Handler().postDelayed(new RunnableC0379b(), Math.max(4000 - (this.h == null ? 4000L : TimeUnit.MILLISECONDS.convert(f.b() - this.h.longValue(), TimeUnit.NANOSECONDS)), 2000L));
        this.g = null;
    }
