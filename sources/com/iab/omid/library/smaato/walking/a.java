...
public class a {
    ...
    private final HashMap<View, String> f2934a = new HashMap<>();
    private final HashMap<View, C0380a> b = new HashMap<>();
    ...
    /* JADX INFO: renamed from: com.iab.omid.library.smaato.walking.a$a, reason: collision with other inner class name */
    public static class C0380a {
        ...
        public C0380a(e eVar, String str) {
            this.f2935a = eVar;
            a(str);
        }
    ...
    private void a(e eVar, com.iab.omid.library.smaato.adsession.a aVar) {
        View view = eVar.c().get();
        if (view == null) {
            return;
        }
        C0380a c0380a = this.b.get(view);
        if (c0380a != null) {
            c0380a.a(aVar.getAdSessionId());
        } else {
            this.b.put(view, new C0380a(eVar, aVar.getAdSessionId()));
        }
    }
    ...
    public String c(View view) {
        ...
        String str = this.f2934a.get(view);
        if (str != null) {
    ...
    public void e() {
        ...
        if (cVarC != null) {
            for (com.iab.omid.library.smaato.adsession.a aVar : cVarC.a()) {
                View viewC = aVar.c();
                if (aVar.f()) {
                    ...
                    if (viewC != null) {
                        ...
                        if (strA == null) {
                            ...
                            this.f2934a.put(viewC, adSessionId);
                            a(aVar);
