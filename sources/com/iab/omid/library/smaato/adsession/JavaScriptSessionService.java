...
import com.iab.omid.library.smaato.utils.i;
...
public class JavaScriptSessionService {
    ...
    private com.iab.omid.library.smaato.weakreference.a weakAdView;
    ...
    private void addWebViewListener() {
        ...
        webViewUtil.a(this.webView, JS_MESSAGE_LISTENER_JS_SESSION_SERVICE, new HashSet(Arrays.asList("*")), new WebViewCompat.WebMessageListener() { // from class: com.iab.omid.library.smaato.adsession.JavaScriptSessionService.2
    ...
    View getAdView() {
        com.iab.omid.library.smaato.weakreference.a aVar = this.weakAdView;
        if (aVar == null) {
            return null;
        }
        return aVar.get();
    ...
    public void setAdView(View view) {
        ...
        this.weakAdView = new com.iab.omid.library.smaato.weakreference.a(view);
    }
    ...
    public void tearDown(final TearDownHandler tearDownHandler) {
        ...
        timer.schedule(new TimerTask() { // from class: com.iab.omid.library.smaato.adsession.JavaScriptSessionService.1
