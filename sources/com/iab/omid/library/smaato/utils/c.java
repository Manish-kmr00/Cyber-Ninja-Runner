...
public class c {
    ...
    private static WindowManager f2928a;
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f2928a != null) {
            ...
            f2928a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            ...
            f2928a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, com.iab.omid.library.smaato.walking.a.C0380a c0380a) {
        com.iab.omid.library.smaato.internal.e eVarA = c0380a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0380a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f2929a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f2930a);
