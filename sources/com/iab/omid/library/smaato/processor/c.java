...
public class c implements a {
    ...
    ArrayList<View> a() {
        ...
        if (cVarC != null) {
            Collection<com.iab.omid.library.smaato.adsession.a> collectionA = cVarC.a();
            IdentityHashMap identityHashMap = new IdentityHashMap((collectionA.size() * 2) + 3);
            Iterator<com.iab.omid.library.smaato.adsession.a> it = collectionA.iterator();
            while (it.hasNext()) {
    ...
    public JSONObject a(View view) {
        JSONObject jSONObjectA = com.iab.omid.library.smaato.utils.c.a(0, 0, 0, 0);
        com.iab.omid.library.smaato.utils.c.a(jSONObjectA, e.a());
        return jSONObjectA;
    }
    ...
    public void a(View view, JSONObject jSONObject, a.InterfaceC0378a interfaceC0378a, boolean z, boolean z2) {
        ...
        while (it.hasNext()) {
            interfaceC0378a.a(it.next(), this.f2921a, jSONObject, z2);
        }
    }
}
