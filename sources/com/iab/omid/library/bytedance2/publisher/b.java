...
public class b extends AdSessionStatePublisher {
    ...
    class RunnableC0344b implements Runnable {
        ...
        private final WebView f2604a;

        RunnableC0344b() {
            this.f2604a = b.this.g;
        }
    ...
    public void b() {
        super.b();
        new Handler().postDelayed(new RunnableC0344b(), Math.max(4000 - (this.h == null ? 4000L : TimeUnit.MILLISECONDS.convert(f.b() - this.h.longValue(), TimeUnit.NANOSECONDS)), 2000L));
        this.g = null;
    }
