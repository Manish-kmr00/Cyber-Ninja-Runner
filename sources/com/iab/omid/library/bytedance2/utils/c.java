...
public class c {
    ...
    private static WindowManager f2606a;
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f2606a != null) {
            ...
            f2606a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            ...
            f2606a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, com.iab.omid.library.bytedance2.walking.a.C0345a c0345a) {
        com.iab.omid.library.bytedance2.internal.e eVarA = c0345a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0345a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f2607a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f2608a);
