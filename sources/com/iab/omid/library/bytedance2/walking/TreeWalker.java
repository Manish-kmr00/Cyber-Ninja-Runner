...
public class TreeWalker implements com.iab.omid.library.bytedance2.processor.a.InterfaceC0343a {
    ...
    private List<TreeWalkerTimeLogger> f2610a = new ArrayList();
    ...
    private void a(long j2) {
        if (this.f2610a.size() > 0) {
            for (TreeWalkerTimeLogger treeWalkerTimeLogger : this.f2610a) {
    ...
    private boolean a(View view, JSONObject jSONObject) {
        com.iab.omid.library.bytedance2.walking.a.C0345a c0345aC = this.f.c(view);
        if (c0345aC == null) {
            return false;
        }
        com.iab.omid.library.bytedance2.utils.c.a(jSONObject, c0345aC);
        return true;
    }
    ...
    @Override // com.iab.omid.library.bytedance2.processor.a.InterfaceC0343a
    public void a(View view, com.iab.omid.library.bytedance2.processor.a aVar, JSONObject jSONObject, boolean z) {
        ...
        if (h.d(view) && (cVarE = this.f.e(view)) != com.iab.omid.library.bytedance2.walking.c.UNDERLYING_VIEW) {
    ...
    public void addTimeLogger(TreeWalkerTimeLogger treeWalkerTimeLogger) {
        if (this.f2610a.contains(treeWalkerTimeLogger)) {
            return;
        }
        this.f2610a.add(treeWalkerTimeLogger);
    }
    ...
    public void removeTimeLogger(TreeWalkerTimeLogger treeWalkerTimeLogger) {
        if (this.f2610a.contains(treeWalkerTimeLogger)) {
            this.f2610a.remove(treeWalkerTimeLogger);
        }
    }
}
