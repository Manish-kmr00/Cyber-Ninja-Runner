...
public class h {
    ...
    private static h f2878a = new h();

    class a implements Runnable {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ WebView f2879a;
    ...
    void a(WebView webView, String str, Object... objArr) {
        if (webView == null) {
            com.iab.omid.library.pubnativenet.utils.d.a("The WebView is null for " + str);
            return;
        }
