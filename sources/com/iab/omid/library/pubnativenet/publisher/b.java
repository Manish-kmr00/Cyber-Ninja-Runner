...
public class b extends AdSessionStatePublisher {
    ...
    class RunnableC0375b implements Runnable {
        ...
        private final WebView f2889a;

        RunnableC0375b() {
            this.f2889a = b.this.g;
        }
    ...
    public void b() {
        super.b();
        new Handler().postDelayed(new RunnableC0375b(), Math.max(4000 - (this.h == null ? 4000L : TimeUnit.MILLISECONDS.convert(f.b() - this.h.longValue(), TimeUnit.NANOSECONDS)), 2000L));
        this.g = null;
    }
