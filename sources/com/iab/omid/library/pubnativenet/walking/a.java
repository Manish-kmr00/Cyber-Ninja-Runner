...
public class a {
    ...
    private final HashMap<View, String> f2897a = new HashMap<>();
    private final HashMap<View, C0376a> b = new HashMap<>();
    ...
    public static class C0376a {
        ...
        public C0376a(e eVar, String str) {
            this.f2898a = eVar;
            a(str);
        }
    ...
    private void a(e eVar, com.iab.omid.library.pubnativenet.adsession.a aVar) {
        ...
        C0376a c0376a = this.b.get(view);
        if (c0376a != null) {
            c0376a.a(aVar.getAdSessionId());
        } else {
            this.b.put(view, new C0376a(eVar, aVar.getAdSessionId()));
        }
    }
    ...
    public String c(View view) {
        ...
        String str = this.f2897a.get(view);
        if (str != null) {
            this.f2897a.remove(view);
        }
        return str;
    }
                ...
                if (aVar.f()) {
                    ...
                    if (viewC != null) {
                        ...
                        if (strA == null) {
                            ...
                            this.f2897a.put(viewC, adSessionId);
                            a(aVar);
