...
public class c {
    ...
    private static WindowManager f2464a;
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f2464a != null) {
            ...
            f2464a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            ...
            f2464a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, com.iab.omid.library.amazon.walking.a.C0330a c0330a) {
        com.iab.omid.library.amazon.internal.e eVarA = c0330a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0330a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f2465a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f2466a);
