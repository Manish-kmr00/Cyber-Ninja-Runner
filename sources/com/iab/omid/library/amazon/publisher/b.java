...
public class b extends AdSessionStatePublisher {
    ...
    class RunnableC0329b implements Runnable {
        ...
        private final WebView f2462a;

        RunnableC0329b() {
            this.f2462a = b.this.g;
        }
    ...
    public void b() {
        super.b();
        new Handler().postDelayed(new RunnableC0329b(), Math.max(4000 - (this.h == null ? 4000L : TimeUnit.MILLISECONDS.convert(f.b() - this.h.longValue(), TimeUnit.NANOSECONDS)), 2000L));
        this.g = null;
    }
