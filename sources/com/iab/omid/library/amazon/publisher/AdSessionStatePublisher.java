...
public abstract class AdSessionStatePublisher {
    ...
    private com.iab.omid.library.amazon.weakreference.b b;
    private AdEvents c;
    ...
    public AdSessionStatePublisher(String str) {
        a();
        this.f2459a = str;
        this.b = new com.iab.omid.library.amazon.weakreference.b(null);
    }
    ...
    public void a(float f) {
        h.a().a(getWebView(), this.f2459a, f);
    }

    void a(WebView webView) {
        this.b = new com.iab.omid.library.amazon.weakreference.b(webView);
    }
    ...
    public void a(AdSessionConfiguration adSessionConfiguration) {
        h.a().a(getWebView(), this.f2459a, adSessionConfiguration.toJsonObject());
    }

    public void a(ErrorType errorType, String str) {
        h.a().a(getWebView(), this.f2459a, errorType, str);
    }
    ...
    protected void a(com.iab.omid.library.amazon.adsession.a aVar, AdSessionContext adSessionContext, JSONObject jSONObject) {
        String adSessionId = aVar.getAdSessionId();
        JSONObject jSONObject2 = new JSONObject();
        c.a(jSONObject2, "environment", "app");
        c.a(jSONObject2, "adSessionType", adSessionContext.getAdSessionContextType());
        c.a(jSONObject2, POBCrashAnalyticsConstants.DEVICE_INFO_KEY, com.iab.omid.library.amazon.utils.b.d());
        c.a(jSONObject2, "deviceCategory", com.iab.omid.library.amazon.utils.a.a().toString());
        ...
        c.a(jSONObject4, "libraryVersion", "1.4.10-Amazon");
    ...
    public void a(String str, long j) {
        if (j >= this.f) {
            ...
            if (aVar != aVar2) {
                this.e = aVar2;
                h.a().a(getWebView(), this.f2459a, str);
            }
        }
    }

    public void a(String str, JSONObject jSONObject) {
        h.a().a(getWebView(), this.f2459a, str, jSONObject);
    }
    ...
    public void a(JSONObject jSONObject) {
        h.a().b(getWebView(), this.f2459a, jSONObject);
    }

    public void a(boolean z) {
        if (e()) {
            h.a().b(getWebView(), this.f2459a, z ? "foregrounded" : "backgrounded");
        }
    }
    ...
    public void f() {
        h.a().a(getWebView(), this.f2459a);
    }

    public void g() {
        h.a().b(getWebView(), this.f2459a);
    }
