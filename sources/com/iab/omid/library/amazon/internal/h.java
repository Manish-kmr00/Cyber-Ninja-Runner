...
public class h {
    ...
    private static h f2453a = new h();

    class a implements Runnable {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ WebView f2454a;
    ...
    void a(WebView webView, String str, Object... objArr) {
        if (webView == null) {
            com.iab.omid.library.amazon.utils.d.a("The WebView is null for " + str);
            return;
        }
