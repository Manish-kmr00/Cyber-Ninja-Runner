...
public class a {
    ...
    private final HashMap<View, String> f2470a = new HashMap<>();
    private final HashMap<View, C0330a> b = new HashMap<>();
    ...
    private void a(e eVar, com.iab.omid.library.amazon.adsession.a aVar) {
        ...
        C0330a c0330a = this.b.get(view);
        if (c0330a != null) {
            c0330a.a(aVar.getAdSessionId());
        } else {
            this.b.put(view, new C0330a(eVar, aVar.getAdSessionId()));
        }
    }
    ...
    public String d(View view) {
        ...
        String str = this.f2470a.get(view);
        if (str != null) {
            this.f2470a.remove(view);
        }
        return str;
    }
                ...
                if (aVar.f()) {
                    ...
                    if (viewC != null) {
                        ...
                        if (strA == null) {
                            ...
                            this.f2470a.put(viewC, adSessionId);
                            a(aVar);
