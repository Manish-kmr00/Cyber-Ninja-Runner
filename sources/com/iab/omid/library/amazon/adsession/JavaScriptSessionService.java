...
public class JavaScriptSessionService {
    ...
    private com.iab.omid.library.amazon.weakreference.a weakAdView;
    ...
    private void addWebViewListener() {
        ...
        webViewUtil.a(this.webView, JS_MESSAGE_LISTENER_JS_SESSION_SERVICE, new HashSet(Arrays.asList("*")), new WebViewCompat.WebMessageListener() { // from class: com.iab.omid.library.amazon.adsession.JavaScriptSessionService.2
    ...
    View getAdView() {
        com.iab.omid.library.amazon.weakreference.a aVar = this.weakAdView;
        if (aVar == null) {
            return null;
        }
        return aVar.get();
    ...
    public void setAdView(View view) {
        if (this.isHtmlAdView) {
            ...
            this.weakAdView = new com.iab.omid.library.amazon.weakreference.a(view);
        }
    }
    ...
    public void tearDown(final TearDownHandler tearDownHandler) {
        ...
        timer.schedule(new TimerTask() { // from class: com.iab.omid.library.amazon.adsession.JavaScriptSessionService.1
