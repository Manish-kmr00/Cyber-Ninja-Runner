...
public class c {
    ...
    private static WindowManager f2715a;
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f2715a != null) {
            ...
            f2715a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            ...
            f2715a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, com.iab.omid.library.ironsrc.walking.a.C0357a c0357a) {
        com.iab.omid.library.ironsrc.internal.e eVarA = c0357a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0357a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f2716a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f2717a);
