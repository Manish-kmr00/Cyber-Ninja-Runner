...
public class TreeWalker implements com.iab.omid.library.ironsrc.processor.a.InterfaceC0355a {
    ...
    private List<TreeWalkerTimeLogger> f2719a = new ArrayList();
    ...
    private void a(long j2) {
        if (this.f2719a.size() > 0) {
            for (TreeWalkerTimeLogger treeWalkerTimeLogger : this.f2719a) {
    ...
    private boolean a(View view, JSONObject jSONObject) {
        com.iab.omid.library.ironsrc.walking.a.C0357a c0357aB = this.f.b(view);
        if (c0357aB == null) {
            return false;
        }
        com.iab.omid.library.ironsrc.utils.c.a(jSONObject, c0357aB);
        return true;
    }
    ...
    private boolean b(View view, JSONObject jSONObject) {
        ...
        com.iab.omid.library.ironsrc.utils.c.b(jSONObject, Boolean.valueOf(this.f.c(strC)));
        this.f.d();
        return true;
    }
    ...
    @Override // com.iab.omid.library.ironsrc.processor.a.InterfaceC0355a
    public void a(View view, com.iab.omid.library.ironsrc.processor.a aVar, JSONObject jSONObject, boolean z) {
        ...
        if (h.f(view) && (cVarD = this.f.d(view)) != com.iab.omid.library.ironsrc.walking.c.UNDERLYING_VIEW) {
            JSONObject jSONObjectA = aVar.a(view);
            com.iab.omid.library.ironsrc.utils.c.a(jSONObject, jSONObjectA);
            if (!b(view, jSONObjectA)) {
                boolean z2 = z || a(view, jSONObjectA);
                if (this.c && cVarD == com.iab.omid.library.ironsrc.walking.c.OBSTRUCTION_VIEW && !z2) {
    ...
    public void addTimeLogger(TreeWalkerTimeLogger treeWalkerTimeLogger) {
        if (this.f2719a.contains(treeWalkerTimeLogger)) {
            return;
        }
        this.f2719a.add(treeWalkerTimeLogger);
    }
    ...
    public void removeTimeLogger(TreeWalkerTimeLogger treeWalkerTimeLogger) {
        if (this.f2719a.contains(treeWalkerTimeLogger)) {
            this.f2719a.remove(treeWalkerTimeLogger);
        }
    }
}
