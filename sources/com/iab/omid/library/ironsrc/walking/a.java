...
public class a {
    ...
    private final HashMap<View, String> f2721a = new HashMap<>();
    private final HashMap<View, C0357a> b = new HashMap<>();
    ...
    private void a(e eVar, com.iab.omid.library.ironsrc.adsession.a aVar) {
        ...
        C0357a c0357a = this.b.get(view);
        if (c0357a != null) {
            c0357a.a(aVar.getAdSessionId());
        } else {
            this.b.put(view, new C0357a(eVar, aVar.getAdSessionId()));
        }
    }
    ...
    public String c(View view) {
        ...
        String str = this.f2721a.get(view);
        if (str != null) {
            this.f2721a.remove(view);
        }
        return str;
    }
                ...
                if (aVar.f()) {
                    ...
                    if (viewC != null) {
                        ...
                        if (strA == null) {
                            ...
                            this.f2721a.put(viewC, adSessionId);
                            a(aVar);
