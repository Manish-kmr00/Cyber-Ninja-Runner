...
public class c {
    ...
    private static WindowManager f2854a;
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f2854a != null) {
            ...
            f2854a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            ...
            f2854a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, com.iab.omid.library.pubmatic.walking.a.C0372a c0372a) {
        com.iab.omid.library.pubmatic.internal.e eVarA = c0372a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0372a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f2855a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f2856a);
