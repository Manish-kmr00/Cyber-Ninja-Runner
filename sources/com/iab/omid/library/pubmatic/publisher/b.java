...
public class b extends AdSessionStatePublisher {
    ...
    class RunnableC0371b implements Runnable {
        ...
        private final WebView f2852a;

        RunnableC0371b() {
            this.f2852a = b.this.g;
        }
    ...
    public void b() {
        super.b();
        new Handler().postDelayed(new RunnableC0371b(), Math.max(4000 - (this.h == null ? 4000L : TimeUnit.MILLISECONDS.convert(f.b() - this.h.longValue(), TimeUnit.NANOSECONDS)), 2000L));
        this.g = null;
    }
