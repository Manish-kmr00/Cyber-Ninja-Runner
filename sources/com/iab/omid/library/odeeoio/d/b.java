...
public class b {
    ...
    static float f2780a = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void a(Context context) {
        if (context != null) {
            f2780a = context.getResources().getDisplayMetrics().density;
    ...
    public static void a(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", aVarB.f2781a);
    ...
    public static void a(JSONObject jSONObject, com.iab.omid.library.odeeoio.walking.a.C0364a c0364a) {
        com.iab.omid.library.odeeoio.b.c cVarA = c0364a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0364a.b().iterator();
        while (it.hasNext()) {
    ...
    public static void a(JSONObject jSONObject, String str, Object obj) {
        try {
            ...
            c.a("JSONException during JSONObject.put for name [" + str + b9.i.e, e);
        }
    }
