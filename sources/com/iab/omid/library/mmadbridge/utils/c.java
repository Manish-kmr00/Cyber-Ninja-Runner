...
public class c {
    ...
    private static WindowManager f2752a;
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f2752a != null) {
            ...
            f2752a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            ...
            f2752a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, com.iab.omid.library.mmadbridge.walking.a.C0361a c0361a) {
        com.iab.omid.library.mmadbridge.internal.e eVarA = c0361a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0361a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f2753a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f2754a);
