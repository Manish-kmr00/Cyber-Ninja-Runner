...
public class TreeWalker implements com.iab.omid.library.mmadbridge.processor.a.InterfaceC0359a {
    ...
    private List<TreeWalkerTimeLogger> f2756a = new ArrayList();
    ...
    private void a(long j2) {
        if (this.f2756a.size() > 0) {
            for (TreeWalkerTimeLogger treeWalkerTimeLogger : this.f2756a) {
    ...
    private boolean a(View view, JSONObject jSONObject) {
        com.iab.omid.library.mmadbridge.walking.a.C0361a c0361aB = this.f.b(view);
        if (c0361aB == null) {
            return false;
        }
        com.iab.omid.library.mmadbridge.utils.c.a(jSONObject, c0361aB);
        return true;
    }
    ...
    public void addTimeLogger(TreeWalkerTimeLogger treeWalkerTimeLogger) {
        if (this.f2756a.contains(treeWalkerTimeLogger)) {
            return;
        }
        this.f2756a.add(treeWalkerTimeLogger);
    }
    ...
    public void removeTimeLogger(TreeWalkerTimeLogger treeWalkerTimeLogger) {
        if (this.f2756a.contains(treeWalkerTimeLogger)) {
            this.f2756a.remove(treeWalkerTimeLogger);
        }
    }
}
