...
public class a {
    ...
    private final HashMap<View, String> f2758a = new HashMap<>();
    private final HashMap<View, C0361a> b = new HashMap<>();
    ...
    private void a(e eVar, com.iab.omid.library.mmadbridge.adsession.a aVar) {
        ...
        C0361a c0361a = this.b.get(view);
        if (c0361a != null) {
            c0361a.a(aVar.getAdSessionId());
        } else {
            this.b.put(view, new C0361a(eVar, aVar.getAdSessionId()));
        }
    }
    ...
    public String c(View view) {
        ...
        String str = this.f2758a.get(view);
        if (str != null) {
                ...
                if (aVar.f()) {
                    ...
                    if (viewC != null) {
                        ...
                        if (strA == null) {
                            ...
                            this.f2758a.put(viewC, adSessionId);
                            a(aVar);
