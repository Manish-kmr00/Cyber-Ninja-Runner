...
public abstract class AdSessionStatePublisher {
    ...
    private com.iab.omid.library.ogury.weakreference.b f2812a;
    private AdEvents b;
    ...
    public AdSessionStatePublisher() {
        a();
        this.f2812a = new com.iab.omid.library.ogury.weakreference.b(null);
    }
    ...
    void a(WebView webView) {
        this.f2812a = new com.iab.omid.library.ogury.weakreference.b(webView);
    }
    ...
    protected void a(com.iab.omid.library.ogury.adsession.a aVar, AdSessionContext adSessionContext, JSONObject jSONObject) {
        ...
        c.a(jSONObject4, "libraryVersion", "1.4.7-Ogury");
        c.a(jSONObject4, RemoteConfigConstants.RequestFieldKey.APP_ID, com.iab.omid.library.ogury.internal.f.b().a().getApplicationContext().getPackageName());
