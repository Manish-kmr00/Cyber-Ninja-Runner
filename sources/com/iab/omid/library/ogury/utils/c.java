...
public class c {
    ...
    private static WindowManager f2817a;
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f2817a != null) {
            ...
            f2817a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            ...
            f2817a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, com.iab.omid.library.ogury.walking.a.C0368a c0368a) {
        com.iab.omid.library.ogury.internal.e eVarA = c0368a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0368a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f2818a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f2819a);
