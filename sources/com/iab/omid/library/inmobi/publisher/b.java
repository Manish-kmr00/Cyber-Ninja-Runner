...
public class b extends AdSessionStatePublisher {
    ...
    class RunnableC0352b implements Runnable {
        ...
        private final WebView f2676a;

        RunnableC0352b() {
            this.f2676a = b.this.g;
        }
    ...
    public void b() {
        super.b();
        new Handler().postDelayed(new RunnableC0352b(), Math.max(4000 - (this.h == null ? 4000L : TimeUnit.MILLISECONDS.convert(f.b() - this.h.longValue(), TimeUnit.NANOSECONDS)), 2000L));
        this.g = null;
    }
