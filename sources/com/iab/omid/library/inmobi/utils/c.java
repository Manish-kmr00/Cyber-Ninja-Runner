...
public class c {
    ...
    private static WindowManager f2678a;
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f2678a != null) {
            ...
            f2678a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            ...
            f2678a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, com.iab.omid.library.inmobi.walking.a.C0353a c0353a) {
        com.iab.omid.library.inmobi.internal.e eVarA = c0353a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0353a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f2679a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f2680a);
