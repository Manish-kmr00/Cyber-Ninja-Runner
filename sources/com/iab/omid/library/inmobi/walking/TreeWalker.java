...
public class TreeWalker implements com.iab.omid.library.inmobi.processor.a.InterfaceC0351a {
    ...
    private List<TreeWalkerTimeLogger> f2682a = new ArrayList();
    ...
    private void a(long j2) {
        if (this.f2682a.size() > 0) {
            for (TreeWalkerTimeLogger treeWalkerTimeLogger : this.f2682a) {
    ...
    private boolean a(View view, JSONObject jSONObject) {
        com.iab.omid.library.inmobi.walking.a.C0353a c0353aC = this.f.c(view);
        if (c0353aC == null) {
            return false;
        }
        com.iab.omid.library.inmobi.utils.c.a(jSONObject, c0353aC);
        return true;
    }
    ...
    @Override // com.iab.omid.library.inmobi.processor.a.InterfaceC0351a
    ...
    public void addTimeLogger(TreeWalkerTimeLogger treeWalkerTimeLogger) {
        if (this.f2682a.contains(treeWalkerTimeLogger)) {
            return;
        }
        this.f2682a.add(treeWalkerTimeLogger);
    }
    ...
    public void removeTimeLogger(TreeWalkerTimeLogger treeWalkerTimeLogger) {
        if (this.f2682a.contains(treeWalkerTimeLogger)) {
            this.f2682a.remove(treeWalkerTimeLogger);
        }
    }
}
