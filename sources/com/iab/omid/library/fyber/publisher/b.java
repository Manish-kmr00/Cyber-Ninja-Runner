...
public class b extends AdSessionStatePublisher {
    ...
    class RunnableC0348b implements Runnable {
        ...
        private final WebView f2641a;

        RunnableC0348b() {
            this.f2641a = b.this.g;
        }
    ...
    public void b() {
        super.b();
        new Handler().postDelayed(new RunnableC0348b(), Math.max(4000 - (this.h == null ? 4000L : TimeUnit.MILLISECONDS.convert(f.b() - this.h.longValue(), TimeUnit.NANOSECONDS)), 2000L));
        this.g = null;
    }
