...
public abstract class AdSessionStatePublisher {
    ...
    public void a(float f) {
        h.a().a(getWebView(), this.f2638a, f);
    }
    ...
    public void a(AdSessionConfiguration adSessionConfiguration) {
        h.a().a(getWebView(), this.f2638a, adSessionConfiguration.toJsonObject());
    }

    public void a(ErrorType errorType, String str) {
        h.a().a(getWebView(), this.f2638a, errorType, str);
    }
    ...
    protected void a(com.iab.omid.library.fyber.adsession.a aVar, AdSessionContext adSessionContext, JSONObject jSONObject) {
        ...
        c.a(jSONObject2, POBCrashAnalyticsConstants.DEVICE_INFO_KEY, com.iab.omid.library.fyber.utils.b.d());
        ...
        c.a(jSONObject4, "libraryVersion", "1.5.1-Fyber");
    ...
    public void a(String str, long j) {
        if (j >= this.f) {
            ...
            if (aVar != aVar2) {
                this.e = aVar2;
                h.a().b(getWebView(), this.f2638a, str);
            }
        }
    }

    public void a(String str, JSONObject jSONObject) {
        h.a().a(getWebView(), this.f2638a, str, jSONObject);
    }
    ...
    public void a(JSONObject jSONObject) {
        h.a().b(getWebView(), this.f2638a, jSONObject);
    }

    public void a(boolean z) {
        if (e()) {
            h.a().c(getWebView(), this.f2638a, z ? "foregrounded" : "backgrounded");
        }
    }
    ...
    public void b(boolean z) {
        if (e()) {
            h.a().a(getWebView(), this.f2638a, z ? "locked" : "unlocked");
        }
    }
    ...
    public void f() {
        h.a().a(getWebView(), this.f2638a);
    }

    public void g() {
        h.a().b(getWebView(), this.f2638a);
    }
