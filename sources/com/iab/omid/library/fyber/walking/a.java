...
public class a {
    ...
    private final HashMap<View, String> f2649a = new HashMap<>();
    private final HashMap<View, C0349a> b = new HashMap<>();
    ...
    private void a(e eVar, com.iab.omid.library.fyber.adsession.a aVar) {
        ...
        C0349a c0349a = this.b.get(view);
        if (c0349a != null) {
            c0349a.a(aVar.getAdSessionId());
        } else {
            this.b.put(view, new C0349a(eVar, aVar.getAdSessionId()));
        }
    }
    ...
    public String c(View view) {
        ...
        String str = this.f2649a.get(view);
        if (str != null) {
            this.f2649a.remove(view);
        }
        return str;
    }
                ...
                if (aVar.f()) {
                    ...
                    if (viewC != null) {
                        ...
                        if (strA == null) {
                            ...
                            this.f2649a.put(viewC, adSessionId);
                            a(aVar);
