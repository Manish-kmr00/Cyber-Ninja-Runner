...
public class TreeWalker implements com.iab.omid.library.fyber.processor.a.InterfaceC0347a {
    ...
    private List<TreeWalkerTimeLogger> f2647a = new ArrayList();
    ...
    private void a(long j2) {
        if (this.f2647a.size() > 0) {
            for (TreeWalkerTimeLogger treeWalkerTimeLogger : this.f2647a) {
    ...
    private void a(String str, View view, JSONObject jSONObject) {
        com.iab.omid.library.fyber.processor.a aVarB = this.e.b();
    ...
    private boolean a(View view, JSONObject jSONObject) {
        com.iab.omid.library.fyber.walking.a.C0349a c0349aB = this.f.b(view);
        if (c0349aB == null) {
            return false;
        }
        com.iab.omid.library.fyber.utils.c.a(jSONObject, c0349aB);
        return true;
    }
    ...
    private boolean b(View view, JSONObject jSONObject) {
        ...
        com.iab.omid.library.fyber.utils.c.b(jSONObject, Boolean.valueOf(this.f.c(strC)));
        this.f.d();
        return true;
    }
    ...
    @Override // com.iab.omid.library.fyber.processor.a.InterfaceC0347a
    public void a(View view, com.iab.omid.library.fyber.processor.a aVar, JSONObject jSONObject, boolean z) {
        ...
        if (h.f(view) && (cVarD = this.f.d(view)) != com.iab.omid.library.fyber.walking.c.UNDERLYING_VIEW) {
            JSONObject jSONObjectA = aVar.a(view);
            com.iab.omid.library.fyber.utils.c.a(jSONObject, jSONObjectA);
            if (!b(view, jSONObjectA)) {
                boolean z2 = z || a(view, jSONObjectA);
                if (this.c && cVarD == com.iab.omid.library.fyber.walking.c.OBSTRUCTION_VIEW && !z2) {
    ...
    public void addTimeLogger(TreeWalkerTimeLogger treeWalkerTimeLogger) {
        if (this.f2647a.contains(treeWalkerTimeLogger)) {
            return;
        }
        this.f2647a.add(treeWalkerTimeLogger);
    }

    void f() {
        this.f.e();
        long jB = f.b();
        com.iab.omid.library.fyber.processor.a aVarA = this.e.a();
        if (this.f.b().size() > 0) {
    ...
    public void removeTimeLogger(TreeWalkerTimeLogger treeWalkerTimeLogger) {
        if (this.f2647a.contains(treeWalkerTimeLogger)) {
            this.f2647a.remove(treeWalkerTimeLogger);
        }
    }
}
