...
public class c {
    ...
    private static WindowManager f2643a;
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f2643a != null) {
            ...
            f2643a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            ...
            f2643a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, com.iab.omid.library.fyber.walking.a.C0349a c0349a) {
        com.iab.omid.library.fyber.internal.e eVarA = c0349a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0349a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f2644a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f2645a);
