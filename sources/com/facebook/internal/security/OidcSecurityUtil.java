...
public final class OidcSecurityUtil {
    ...
    public static final String getRawKeyFromEndPoint(final String kid) {
        ...
        FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.internal.security.OidcSecurityUtil$$ExternalSyntheticLambda0
            ...
            public final void run() throws IOException {
                OidcSecurityUtil.m4937getRawKeyFromEndPoint$lambda1(url, objectRef, kid, reentrantLock, conditionNewCondition);
            }
        });
    ...
    /* JADX INFO: renamed from: getRawKeyFromEndPoint$lambda-1, reason: not valid java name */
    public static final void m4937getRawKeyFromEndPoint$lambda1(URL openIdKeyUrl, Ref.ObjectRef result, String kid, ReentrantLock lock, Condition condition) throws IOException {
