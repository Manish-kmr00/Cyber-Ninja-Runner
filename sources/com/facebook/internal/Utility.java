...
public final class Utility {
    ...
    public static final Bundle parseUrlQueryString(String queryString) {
        ...
        if (!isNullOrEmpty(queryString)) {
            ...
            Object[] array = StringsKt.split$default((CharSequence) queryString, new String[]{b9.i.c}, false, 0, 6, (Object) null).toArray(new String[0]);
            if (array != null) {
        ...
        if (attributionIdentifiers != null) {
            ...
            if (attributionIdentifiers.getAttributionId() != null) {
                ...
                if (FeatureManager.isEnabled(FeatureManager.Feature.ServiceUpdateCompliance)) {
                    ...
                    params.put(c9.ATTRIBUTION, attributionIdentifiers.getAttributionId());
                }
            }
    ...
    public static final String getGraphDomainFromTokenDomain(String tokenGraphDomain) {
        ...
        return Intrinsics.areEqual(tokenGraphDomain, FacebookSdk.INSTAGRAM) ? StringsKt.replace$default(facebookDomain, FacebookSdk.FACEBOOK_COM, FacebookSdk.INSTAGRAM_COM, false, 4, (Object) null) : facebookDomain;
    }
    ...
    public static final void getGraphMeRequestWithCacheAsync(final String accessToken, final GraphMeRequestWithCacheCallback callback) {
        ...
        GraphRequest.Callback callback2 = new GraphRequest.Callback() { // from class: com.facebook.internal.Utility$$ExternalSyntheticLambda0
            ...
            public final void onCompleted(GraphResponse graphResponse) {
                Utility.m4910getGraphMeRequestWithCacheAsync$lambda3(callback, accessToken, graphResponse);
            }
        };
    ...
    /* JADX INFO: renamed from: getGraphMeRequestWithCacheAsync$lambda-3, reason: not valid java name */
    public static final void m4910getGraphMeRequestWithCacheAsync$lambda3(GraphMeRequestWithCacheCallback callback, String accessToken, GraphResponse response) {
        Intrinsics.checkNotNullParameter(callback, "$callback");
        Intrinsics.checkNotNullParameter(accessToken, "$accessToken");
        ...
        try {
            File[] fileArrListFiles = new File("/sys/devices/system/cpu/").listFiles(new FilenameFilter() { // from class: com.facebook.internal.Utility$$ExternalSyntheticLambda1
                ...
                public final boolean accept(File file, String str) {
                    return Utility.m4911refreshBestGuessNumberOfCPUCores$lambda4(file, str);
                }
            });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: refreshBestGuessNumberOfCPUCores$lambda-4, reason: not valid java name */
    public static final boolean m4911refreshBestGuessNumberOfCPUCores$lambda4(File file, String str) {
