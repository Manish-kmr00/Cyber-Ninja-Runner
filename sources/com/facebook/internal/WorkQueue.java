...
public final class WorkQueue {
    ...
    public static final class Companion {
        ...
        public final void m4919assert(boolean condition) {
            if (!condition) {
    ...
    public final void validate() {
        ...
        try {
            ...
            INSTANCE.m4919assert(this.runningCount == i);
            Unit unit = Unit.INSTANCE;
            reentrantLock.unlock();
        } catch (Throwable th) {
            reentrantLock.unlock();
    ...
    private final void execute(final WorkNode node) {
        this.executor.execute(new Runnable() { // from class: com.facebook.internal.WorkQueue$$ExternalSyntheticLambda0
            ...
            public final void run() {
                WorkQueue.m4918execute$lambda2(node, this);
            }
        });
    }
    ...
    public static final void m4918execute$lambda2(WorkNode node, WorkQueue this$0) {
    ...
    final class WorkNode implements WorkItem {
        ...
        public final WorkNode addToList(WorkNode list, boolean addToFront) {
            WorkQueue.INSTANCE.m4919assert(this.next == null);
            WorkQueue.INSTANCE.m4919assert(this.prev == null);
            if (list == null) {
                this.prev = this;
                this.next = this;
                list = this;
        ...
        public final void verify(boolean shouldBeRunning) {
            ...
            companion.m4919assert(workNode == this);
            Companion companion2 = WorkQueue.INSTANCE;
            WorkNode workNode4 = this.next;
            if (workNode4 == null || (workNode2 = workNode4.prev) == null) {
                workNode2 = this;
            }
            companion2.m4919assert(workNode2 == this);
            WorkQueue.INSTANCE.m4919assert(getIsRunning() == shouldBeRunning);
        }
    }
}
