...
public abstract class FacebookDialogBase<CONTENT, RESULT> implements FacebookDialog<CONTENT, RESULT> {
    ...
    protected final void startActivityForResult(Intent intent, int requestCode) {
        ...
        if (activityContext instanceof ActivityResultRegistryOwner) {
            ...
            safedk_Activity_startActivityForResult_206f42f0b65887e835d87ee52d14d221(activityContext, intent, requestCode);
        } else {
            FragmentWrapper fragmentWrapper = this.fragmentWrapper;
            if (fragmentWrapper != null) {
                safedk_FragmentWrapper_startActivityForResult_51accca8f1bb017fcda2a6aac31602e6(fragmentWrapper, intent, requestCode);
            } else {
