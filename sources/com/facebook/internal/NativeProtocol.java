...
public final class NativeProtocol {
            ...
            if (protocolVersionsAsyncUpdating.compareAndSet(false, true)) {
                ...
                FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.internal.NativeProtocol$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        NativeProtocol.m4907updateAllAvailableProtocolVersionsAsync$lambda1();
                    }
                });
            }
        } catch (Throwable th) {
    ...
    public static final void m4907updateAllAvailableProtocolVersionsAsync$lambda1() {
        if (CrashShieldHandler.isObjectCrashing(NativeProtocol.class)) {
            return;
        }
        try {
    ...
    public static abstract class NativeAppInfo {
        ...
        public final TreeSet<Integer> getAvailableVersions() {
            ...
            if (treeSet == null) {
                ...
                if (!Intrinsics.areEqual((Object) (treeSet == null ? null : Boolean.valueOf(treeSet.isEmpty())), (Object) false)) {
                    fetchAvailableVersions(false);
                }
            }
        ...
        /* JADX WARN: Code duplicated, block: B:11:0x001e A[Catch: all -> 0x0037, TryCatch #0 {, blocks: (B:4:0x0003, B:9:0x0013, B:12:0x0026, B:14:0x002c, B:16:0x0032, B:8:0x000b, B:11:0x001e), top: B:22:0x0003 }] */
        /* JADX WARN: Code duplicated, block: B:16:0x0032 A[Catch: all -> 0x0037, TRY_LEAVE, TryCatch #0 {, blocks: (B:4:0x0003, B:9:0x0013, B:12:0x0026, B:14:0x002c, B:16:0x0032, B:8:0x000b, B:11:0x001e), top: B:22:0x0003 }] */
        public final synchronized void fetchAvailableVersions(boolean force) {
            ...
            if (!force) {
                ...
                if (treeSet2 == null) {
                    ...
                    if (!Intrinsics.areEqual((Object) (treeSet2 == null ? null : Boolean.valueOf(treeSet2.isEmpty())), (Object) false)) {
                        this.availableVersions = NativeProtocol.access$fetchAllAvailableProtocolVersionsForAppInfo(NativeProtocol.INSTANCE, this);
                    }
                }
    ...
    private static final class MessengerAppInfo extends NativeAppInfo {
        ...
        public Void m4909getLoginActivity() {
            return null;
        }

        @Override // com.facebook.internal.NativeProtocol.NativeAppInfo
        public /* bridge */ /* synthetic */ String getLoginActivity() {
            return (String) m4909getLoginActivity();
        }
    ...
    private static final class EffectTestAppInfo extends NativeAppInfo {
        /* JADX INFO: renamed from: getLoginActivity, reason: collision with other method in class */
        public Void m4908getLoginActivity() {
            return null;
        }

        @Override // com.facebook.internal.NativeProtocol.NativeAppInfo
        public /* bridge */ /* synthetic */ String getLoginActivity() {
            return (String) m4908getLoginActivity();
        }
