...
public final class ContextChooseDialog extends FacebookDialogBase<ContextChooseContent, Result> {
    ...
    private final void showForCloud(ContextChooseContent content) {
        ...
        DaemonRequest.Callback callback = new DaemonRequest.Callback() { // from class: com.facebook.gamingservices.ContextChooseDialog$$ExternalSyntheticLambda1
            ...
            public final void onCompleted(GraphResponse graphResponse) {
                ContextChooseDialog.m4874showForCloud$lambda2(this.f$0, graphResponse);
            }
        };
    ...
    public static final void m4874showForCloud$lambda2(ContextChooseDialog this$0, GraphResponse response) {
        Unit unit;
    ...
    protected void registerCallbackImpl(CallbackManagerImpl callbackManager, final FacebookCallback<Result> callback) {
        ...
        callbackManager.registerCallback(getRequestCodeField(), new CallbackManagerImpl.Callback() { // from class: com.facebook.gamingservices.ContextChooseDialog$$ExternalSyntheticLambda0
            ...
            public final boolean onActivityResult(int i, Intent intent) {
                return ContextChooseDialog.m4873registerCallbackImpl$lambda4(this.f$0, r0, i, intent);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: registerCallbackImpl$lambda-4, reason: not valid java name */
    public static final boolean m4873registerCallbackImpl$lambda4(ContextChooseDialog this$0, ContextChooseDialog$registerCallbackImpl$resultProcessor$1 resultProcessor, int i, Intent intent) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
