...
public final class ContextCreateDialog extends FacebookDialogBase<ContextCreateContent, Result> {
    ...
    private final void showForCloud(ContextCreateContent content) {
        ...
        DaemonRequest.Callback callback = new DaemonRequest.Callback() { // from class: com.facebook.gamingservices.ContextCreateDialog$$ExternalSyntheticLambda1
            ...
            public final void onCompleted(GraphResponse graphResponse) {
                ContextCreateDialog.m4877showForCloud$lambda2(this.f$0, graphResponse);
            }
        };
    ...
    /* JADX INFO: renamed from: showForCloud$lambda-2, reason: not valid java name */
    public static final void m4877showForCloud$lambda2(ContextCreateDialog this$0, GraphResponse response) {
        Unit unit;
    ...
    protected void registerCallbackImpl(CallbackManagerImpl callbackManager, final FacebookCallback<Result> callback) {
        ...
        callbackManager.registerCallback(getRequestCodeField(), new CallbackManagerImpl.Callback() { // from class: com.facebook.gamingservices.ContextCreateDialog$$ExternalSyntheticLambda0
            ...
            public final boolean onActivityResult(int i, Intent intent) {
                return ContextCreateDialog.m4876registerCallbackImpl$lambda3(this.f$0, resultProcessor, i, intent);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: registerCallbackImpl$lambda-3, reason: not valid java name */
    public static final boolean m4876registerCallbackImpl$lambda3(ContextCreateDialog this$0, ResultProcessor resultProcessor, int i, Intent intent) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
