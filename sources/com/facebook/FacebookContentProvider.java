...
public final class FacebookContentProvider extends ContentProvider {
    ...
    private final Pair<UUID, String> parseCallIdAndAttachmentName(Uri uri) {
        try {
            ...
            Object[] array = StringsKt.split$default((CharSequence) strSubstring, new String[]{RemoteSettings.FORWARD_SLASH_STRING}, false, 0, 6, (Object) null).toArray(new String[0]);
            if (array != null) {
