...
public final class ProgressOutputStream extends FilterOutputStream implements RequestOutputStream {
                ...
                if (callback instanceof GraphRequestBatch.OnProgressCallback) {
                    ...
                    if ((callbackHandler == null ? null : Boolean.valueOf(callbackHandler.post(new Runnable() { // from class: com.facebook.ProgressOutputStream$$ExternalSyntheticLambda0
                        ...
                        public final void run() {
                            ProgressOutputStream.m4773reportBatchProgress$lambda0(callback, this);
                        }
                    }))) == null) {
    ...
    /* JADX INFO: renamed from: reportBatchProgress$lambda-0, reason: not valid java name */
    public static final void m4773reportBatchProgress$lambda0(GraphRequestBatch.Callback callback, ProgressOutputStream this$0) {
