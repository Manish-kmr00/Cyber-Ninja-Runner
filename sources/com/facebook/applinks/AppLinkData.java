...
public class AppLinkData {
    ...
    public static void fetchDeferredAppLinkFromServer(Context context, String applicationId, final CompletionHandler completionHandler) {
        ...
        try {
            jSONObject3.put("event", DEFERRED_APP_LINK_EVENT);
            ...
            try {
                JSONObject graphObject = GraphRequest.newPostRequest(null, str, jSONObject3, null).executeAndWait().getGraphObject();
                if (graphObject != null) {
