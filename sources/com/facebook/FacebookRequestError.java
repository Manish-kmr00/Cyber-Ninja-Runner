...
public final class FacebookRequestError implements Parcelable {
    ...
    public static final class Companion {
        ...
        /* JADX WARN: Code duplicated, block: B:47:0x00d5 A[Catch: JSONException -> 0x012f, TryCatch #0 {JSONException -> 0x012f, blocks: (B:3:0x0013, B:5:0x0019, B:7:0x0025, B:9:0x0029, B:12:0x0037, B:47:0x00d5, B:33:0x007d, B:30:0x0074, B:27:0x006a, B:24:0x0062, B:21:0x005b, B:18:0x0051, B:15:0x0046, B:35:0x0089, B:38:0x0096, B:40:0x009f, B:44:0x00b0, B:49:0x00f6, B:51:0x0100, B:53:0x0108, B:55:0x0116, B:54:0x0112), top: B:59:0x0013 }] */
        @JvmStatic
                ...
                if (singleResult.has("code")) {
                    ...
                    if (stringPropertyAsJSON != null && (stringPropertyAsJSON instanceof JSONObject)) {
                        ...
                        if (((JSONObject) stringPropertyAsJSON).has("error")) {
                            ...
                            strOptString2 = jSONObject2 == null ? null : jSONObject2.optString(FacebookRequestError.ERROR_USER_MSG_KEY, null);
                            strOptString3 = jSONObject2 == null ? null : jSONObject2.optString(FacebookRequestError.ERROR_USER_TITLE_KEY, null);
                            if (jSONObject2 != null) {
                                zOptBoolean = jSONObject2.optBoolean(FacebookRequestError.ERROR_IS_TRANSIENT_KEY, false);
                            }
                            z = zOptBoolean;
                            str = strOptString4;
                            iOptInt = iOptInt2;
