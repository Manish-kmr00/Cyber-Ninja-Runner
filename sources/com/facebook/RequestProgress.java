...
public final class RequestProgress {
        ...
        if (this.progress > this.lastReportedProgress) {
            ...
            if ((handler == null ? null : Boolean.valueOf(handler.post(new Runnable() { // from class: com.facebook.RequestProgress$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    RequestProgress.m4774reportProgress$lambda0(callback, j2, j);
                }
            }))) == null) {
    ...
    /* JADX INFO: renamed from: reportProgress$lambda-0, reason: not valid java name */
    public static final void m4774reportProgress$lambda0(GraphRequest.Callback callback, long j, long j2) {
