...
public enum EnumC1764Mn {
    ...
    public static EnumC1764Mn[] valuesCustom() {
        EnumC1764Mn[] enumC1764MnArr = (EnumC1764Mn[]) values().clone();
        String[] strArr = A01;
        if (strArr[5].charAt(20) == strArr[4].charAt(20)) {
            throw new RuntimeException();
        }
        A01[3] = "UcBpUNe8sR";
        return enumC1764MnArr;
    }
}
