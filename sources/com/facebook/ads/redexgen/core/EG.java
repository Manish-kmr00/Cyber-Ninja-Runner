...
public final class EG extends RelativeLayout {
    ...
    public EG(EF ef) {
        super(ef.A0C);
        this.A03 = ef.A0C;
        this.A02 = AbstractC12933h.A00(this.A03.A02());
        this.A04 = ef.A02;
        this.A01 = ef.A0B ? A0E : A0F;
        this.A00 = ef.A0B ? A0B : A0C;
        this.A05 = ef.A07;
        setFocusable(true);
        View viewA01 = A01(ef);
        View viewA00 = A00(ef);
        ...
        footerView.setVisibility(ef.A08 ? 0 : 8);
    }
    ...
    private View A00(EF ef) {
        ...
        if (ef.A09) {
            ...
            if (!TextUtils.isEmpty(ef.A04)) {
                ...
                new AsyncTaskC2494gc(c1580Ff, this.A03).A05(A0F, A0F).A07(ef.A04);
                linearLayout2.addView(c1580Ff, iconParams);
            }
            EL el = new EL(this.A03);
            el.setData(ef.A03, DB.CHECKMARK);
            el.setSelected(true);
