...
public final class C1747Lr {
    ...
    public static final C1746Lq A04;
    public final String A00;
    public final BlockingDeque<C1748Ls> A01 = new LinkedBlockingDeque();
    ...
    static {
        A02();
        A04 = new C1746Lq(null);
    }

    public C1747Lr(String str) {
        this.A00 = str;
    }

    @JvmStatic
    public static final String A01(List<C1748Ls> list) {
        return A04.A0A(list);
    }

    public final List<C1748Ls> A03() {
    ...
    public final void A04(C1748Ls c1748Ls) {
        C2923nk.A09(c1748Ls, A00(0, 5, 47));
        C1748Ls c1748LsPeekLast = this.A01.peekLast();
        if (c1748LsPeekLast != null) {
            long a03 = c1748LsPeekLast.getA03();
            long a04 = c1748Ls.getA03();
            if (A03[4].charAt(10) == 'f') {
                A03[1] = "";
                if (a03 == a04 && c1748LsPeekLast.getA01() == c1748Ls.getA01()) {
                    return;
                }
                this.A01.add(c1748Ls);
                if (A03[4].charAt(10) == 'f') {
