...
public final class AnonymousClass29 {
     ...
     */
    public final synchronized void A0A(String str) throws JSONException, C14138b {
        if (str != null) {
            if (!str.trim().isEmpty()) {
    ...
    private final synchronized C12662g A00(String str, JSONObject jSONObject) throws JSONException, C14138b {
        C12662g frequencyCappingData;
        if (str.equals(jSONObject.optString(A01(29, 12, 70), null))) {
            frequencyCappingData = new C12662g(str);
            A03(frequencyCappingData, jSONObject);
        } else {
            C14138b c14138b = new C14138b(new IllegalArgumentException());
    ...
    private void A03(C12662g c12662g, JSONObject jSONObject) throws JSONException {
        ...
        if (jSONObject.has(strA01)) {
            c12662g.A06((JSONArray) jSONObject.get(strA01));
        }
        String strA02 = A01(81, 20, 107);
        if (jSONObject.has(strA02)) {
            int cappingTimeSecs = jSONObject.optInt(strA02);
            c12662g.A04(cappingTimeSecs);
        }
        c12662g.A05(iOptInt, iOptInt2, jOptLong, maxCappedArrayLength);
    }
    ...
    public final synchronized void A08(String str) throws JSONException {
        if (str != null) {
            if (!str.trim().isEmpty()) {
                ...
                for (int i = 0; i < jSONArray.length() && i < C12662g.A00(); i++) {
    ...
    public final synchronized void A0B(JSONObject jSONObject) throws JSONException {
        ...
        if (this.A00.has(strOptString) && (this.A00.get(strOptString) instanceof C12662g)) {
            frequencyCappingData = (C12662g) this.A00.get(strOptString);
        } else {
            frequencyCappingData = new C12662g(strOptString);
        }
        A03(frequencyCappingData, jSONObject);
