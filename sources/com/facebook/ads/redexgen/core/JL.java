...
public final class JL {
    ...
    public final WeakReference<JK> A0E;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:27:0x00a3, code lost:
        ...
        return new com.facebook.ads.redexgen.core.JM(com.facebook.ads.redexgen.core.EnumC12371d.A0G);
     */
    ...
    */
    public static com.facebook.ads.redexgen.core.JM A0E(android.view.View r7, int r8, com.facebook.ads.redexgen.core.C2699k1 r9) {
        /*
            Method dump skipped, instruction units count: 659
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.JL.A0E(android.view.View, int, com.facebook.ads.redexgen.X.k1):com.facebook.ads.redexgen.X.JM");
    }
    ...
    public final synchronized String A0R() {
        return EnumC12371d.values()[this.A05.A01()].toString() + String.format(Locale.US, A0H(0, 9, 46), Float.valueOf(this.A05.A00() * 100.0f));
    }

    static {
        A0M();
        A0I = JL.class.getSimpleName();
    }

    public JL(View view, int i, int i2, boolean z, WeakReference<JK> weakReference, C2699k1 c2699k1) {
        this.A0B = new Handler();
        this.A01 = 0;
        this.A02 = 1000;
        this.A08 = true;
        this.A05 = new JM(EnumC12371d.A0L);
    ...
    public JL(View view, int i, WeakReference<JK> weakReference, C2699k1 c2699k1) {
        this(view, i, 0, false, weakReference, c2699k1);
    }

    public JL(View view, int i, boolean z, WeakReference<JK> weakReference, C2699k1 c2699k1) {
        this(view, i, 0, z, weakReference, c2699k1);
    }
    ...
    public static /* synthetic */ int A05(JL jl) {
        int i = jl.A00;
        jl.A00 = i + 1;
        return i;
    }
    ...
    public static Vector<Rect> A0K(View view) {
        ...
        for (int iIndexOfChild = viewGroup.indexOfChild(view) + 1; iIndexOfChild < viewGroup.getChildCount(); iIndexOfChild++) {
            ...
            int childIndex = 1;
            boolean z = !(childAt instanceof C1638Hl);
            if ((childAt instanceof C2412fH) && JN.A00(childAt)) {
                childIndex = 0;
            }
            if (z && childIndex != 0) {
    ...
    public static Vector<Rect> A0L(View view) {
        ...
        if ((view instanceof ViewGroup) && (JN.A00(view) || isTransparentToolbar)) {
    ...
    public final synchronized Map<String, String> A0S() {
        ...
        map.put(A0H(592, 2, 13), C1517Cu.A06(this.A03));
    ...
    public final synchronized void A0U() {
        ...
        this.A04 = new C1633Hg(this, this.A0D);
