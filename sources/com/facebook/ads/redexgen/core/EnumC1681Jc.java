...
public enum EnumC1681Jc {
    ...
    EnumC1681Jc(boolean z, boolean z2) {
        this.A00 = z;
        this.A01 = z2;
    }
    ...
    public static EnumC1681Jc[] valuesCustom() {
        EnumC1681Jc[] enumC1681JcArrValuesCustom = values();
        if (A03[7].charAt(2) != 'p') {
            throw new RuntimeException();
        }
        A03[7] = "eYpi2UA0ZlC7PiDY55aF0B4EyL2494ge";
        return (EnumC1681Jc[]) enumC1681JcArrValuesCustom.clone();
    }
}
