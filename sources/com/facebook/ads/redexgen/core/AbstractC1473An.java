...
public abstract class AbstractC1473An {
    ...
    public static EnumC1472Al A00(DisplayMetrics displayMetrics) {
        int i = (int) (displayMetrics.widthPixels / displayMetrics.density);
        int screenWidth = displayMetrics.heightPixels;
        int screenHeight = (int) (screenWidth / displayMetrics.density);
        if (CQ.A04(i, screenHeight)) {
            return EnumC1472Al.A0I;
        }
        if (screenHeight > i) {
            EnumC1472Al enumC1472Al = EnumC1472Al.A0K;
            String[] strArr = A00;
            String str = strArr[5];
        ...
        return EnumC1472Al.A0H;
    }

    public static void A01(DisplayMetrics displayMetrics, View view, EnumC1470Aj enumC1470Aj) {
        int iCeil;
        int i = (int) (displayMetrics.widthPixels / displayMetrics.density);
        int screenWidth = enumC1470Aj.A04();
        if (i >= screenWidth) {
            iCeil = displayMetrics.widthPixels;
        } else {
            int screenWidth2 = enumC1470Aj.A04();
            iCeil = (int) Math.ceil(screenWidth2 * displayMetrics.density);
        }
        int screenWidth3 = enumC1470Aj.A03();
