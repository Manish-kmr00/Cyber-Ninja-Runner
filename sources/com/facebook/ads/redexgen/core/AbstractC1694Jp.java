...
public abstract class AbstractC1694Jp {
    ...
    public static boolean A00(JSONArray jSONArray, JSONArray jSONArray2) {
        ...
        for (int i = 0; i < i; i++) {
            EnumC1693Jo t1 = EnumC1693Jo.A00(jSONArray, i);
            if (t1 != EnumC1693Jo.A00(jSONArray2, i) || !t1.A06(jSONArray, jSONArray2, i)) {
                return false;
            }
        }
        String[] strArr = A00;
    ...
    public static boolean A02(JSONObject jSONObject, JSONObject jSONObject2) {
        ...
        while (itKeys.hasNext()) {
            ...
            strArr[0] = "wJhB";
            String str = next;
            if (!jSONObject2.has(str) || (enumC1693JoA01 = EnumC1693Jo.A01(jSONObject, str)) != EnumC1693Jo.A01(jSONObject2, str) || !enumC1693JoA01.A08(jSONObject, jSONObject2, str)) {
                return false;
            }
        }
        String[] strArr2 = A00;
