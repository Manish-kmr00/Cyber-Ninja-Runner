...
public final class AnonymousClass72 implements NativeAdsManagerApi {
    ...
    public AnonymousClass72(Context context, String str, int i) {
    ...
    public final void loadAds(NativeAdBase.MediaCacheFlag mediaCacheFlag) {
        EnumC1472Al enumC1472Al = EnumC1472Al.A06;
        int i = this.A06;
        C2828mB c2828mB = this.A02;
        this.A02 = new C2828mB(this.A07, this.A08, enumC1472Al, null, i);
        if (this.A05) {
            this.A02.A06();
        }
        this.A02.A09(this.A03);
        this.A02.A08(new C2722kO(this, this.A07, mediaCacheFlag));
        this.A02.A07();
    }
    ...
    public final NativeAd nextNativeAd(NativeAdListener nativeAdListener) {
        ...
        if (nativeAdListener != null) {
            ((C2615ie) nativeAd.getInternalNativeAd()).A1U(nativeAd, nativeAdListener);
        }
