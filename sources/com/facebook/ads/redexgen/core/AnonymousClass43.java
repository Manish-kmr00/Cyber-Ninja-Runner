...
public abstract class AnonymousClass43 {
    ...
    public static int A04(int i, int i2) {
        ...
        int a2 = A06(fgAlpha2, iAlpha2, bgAlpha2, iAlpha, g);
        int fgAlpha3 = Color.blue(i);
        int bgAlpha3 = Color.blue(i2);
        return Color.argb(g, r, a2, A06(fgAlpha3, iAlpha2, bgAlpha3, iAlpha, g));
    }

    public static int A05(int i, int i2, float f) {
        float f2 = 1.0f - f;
        float fAlpha = Color.alpha(i) * f2;
        float inverseRatio = Color.alpha(i2);
        float g = fAlpha + (inverseRatio * f);
        float fRed = Color.red(i) * f2;
