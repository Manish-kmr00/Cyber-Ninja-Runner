...
public final class C12752p implements Serializable {
    public static byte[] A0J = null;
    public static final EnumC12762q A0K;
    public static final FF A0L;
    ...
    public C12752p(String str, String str2, int i, String str3, String str4, FF ff, int i2, boolean z, boolean z2, EnumC12762q enumC12762q, boolean z3, String str5, boolean z4, boolean z5, int i3, String str6, String str7, boolean z6) {
        if (z3) {
            this.A0E = UUID.randomUUID().toString();
            this.A0D = C5.A00(str).buildUpon().appendQueryParameter(A03(143, 11, 90), this.A0E).appendQueryParameter(A03(69, 12, 101), str5).build().toString();
        } else {
            this.A0D = str;
            this.A0E = null;
        }
    ...
    public static C12752p A01(JSONObject jSONObject) {
        JSONObject jSONObjectOptJSONObject = jSONObject.optJSONObject(A03(255, 13, 26));
        if (jSONObjectOptJSONObject == null) {
            return null;
        }
        EnumC12762q enumC12762qA00 = EnumC12762q.A00(jSONObjectOptJSONObject.optString(A03(339, 17, 62), A0K.name()));
        ...
        FF ffA02 = A02(jSONObjectOptJSONObject);
        ...
        return new C12752p(strOptString, strOptString2, iA00, strA05, strA04, ffA02, iOptInt, z, zOptBoolean2, enumC12762qA00, zOptBoolean3, strOptString3, zOptBoolean, zOptBoolean4, iOptInt2, strOptString4, strOptString5, jSONObjectOptJSONObject.optBoolean(precachingMethodStr9, false));
    }

    public static FF A02(JSONObject jSONObject) {
        int orientation = jSONObject.optInt(A03(229, 11, 36), A0L.A04());
        return FF.A00(orientation);
    }
