...
public class C14389b {
     ...
     */
    public static C14389b A04(File file) throws IOException {
        try {
            ...
            return new C14389b(randomAccessFile, jArr, randomAccessFile.length());
    ...
    public C14389b(RandomAccessFile randomAccessFile, long[] jArr, long j) throws IOException {
    ...
    public static C14389b A03(File file) throws IOException {
        RandomAccessFile randomAccessFile = new RandomAccessFile(file, A05(416, 3, 33));
        try {
            randomAccessFile.writeLong(-360011992771067903L);
            randomAccessFile.writeLong(C14399c.A03);
            randomAccessFile.write(new byte[C14399c.A03 * 8]);
            randomAccessFile.getFD().sync();
            return new C14389b(randomAccessFile, new long[C14399c.A03], randomAccessFile.length());
        } catch (IOException unused) {
