...
public final class ViewOnSystemUiVisibilityChangeListenerC1513Cq implements View.OnSystemUiVisibilityChangeListener {
    ...
    public EnumC1512Cp A02 = EnumC1512Cp.A02;
    public final Runnable A04 = new C2583i6(this);

    public ViewOnSystemUiVisibilityChangeListenerC1513Cq(View view) {
        this.A03 = view;
    ...
    public void A02(boolean z) {
        if (EnumC1512Cp.A02.equals(this.A02)) {
            return;
        }
        int i = 3840;
        if (!z) {
    ...
    public final void A05(EnumC1512Cp enumC1512Cp) {
        this.A02 = enumC1512Cp;
        switch (this.A02) {
            case A03:
                A00(67108864, true);
                A00(134217728, true);
