...
public final class C13856y implements NativeAdApi {
    public static String[] A02 = {"Qf6uI4y6btMkRXvA96gvAPpQqYMeMLVQ", "xsH0pc0gEvMtYCBpu3k37P2MSYje76", "eIeN", "vYRtnf0lNdhCyq", Protocol.VAST_1_0_WRAPPER, "0cPKH6qR821KJSq9ovGwsT1tt", "LdRpqMhVSgJGWZUoheR2iPgR57uht61Q", "hYjvJgOs8spNmgMi7B8jHFIGUAKFh9RM"};
    ...
    public C13856y(NativeAd nativeAd, NativeAdBaseApi nativeAdBaseApi) {
        this.A00 = nativeAd;
        this.A01 = nativeAdBaseApi;
        C2615ie.A0L(nativeAdBaseApi).A1b(EnumC1472Al.A06);
    }

    public C13856y(NativeAdBase nativeAdBase, NativeAd nativeAd, NativeAdBaseApi nativeAdBaseApi) {
        this.A00 = nativeAd;
        this.A01 = nativeAdBaseApi;
    }

    private C2615ie A00() {
        return C2615ie.A0L(this.A01);
    }
    ...
    public final List<NativeAd> A03() {
        ...
        for (C2615ie internalNativeAd : A00().A1I()) {
    ...
    public final void registerViewForInteraction(View view, MediaView mediaView, ImageView imageView, List<View> clickableViews) {
        if (imageView != null) {
            C2699k1 c2699k1A12 = A00().A12();
            C2699k1 downloadContext = C13766p.A03(imageView.getContext());
            downloadContext.A0L(c2699k1A12);
            C2615ie.A0k(A00().getAdIcon(), imageView, downloadContext);
        }
    ...
    public final void registerViewForInteraction(View view, MediaView mediaView, MediaView mediaView2, List<View> list) {
        if (mediaView != null) {
            ((C2729kV) mediaView.getMediaViewApi()).A0L(this.A00);
        }
        if (mediaView2 != null) {
            ((C2729kV) mediaView2.getMediaViewApi()).A0M(this.A01, false);
        }
        if (list != null) {
            A00().A1P(view, mediaView, list);
            return;
        }
        C2615ie c2615ieA00 = A00();
        String[] strArr = A02;
        if (strArr[0].charAt(20) == strArr[7].charAt(20)) {
            throw new RuntimeException();
        }
        A02[4] = "Y8dslRp9uWVtvGXxjU2U0Td790Xm7bcp";
        c2615ieA00.A1O(view, mediaView);
    }
}
