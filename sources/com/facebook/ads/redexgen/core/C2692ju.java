...
public final class C2692ju implements C8M {
    ...
    public C2692ju(Context context, C8L c8l) {
        this.A00 = context;
        this.A02 = c8l;
    }
    ...
    public final void A04(String[] strArr, Integer num, Integer num2) {
        ...
        this.A01 = c8j;
        this.A03.set(true);
        SharedPreferences.Editor editorEdit = BJ.A00(this.A00).edit();
    ...
    public final boolean AAW() {
        ...
        Set<String> setA0Z = C14499m.A0Z(this.A00);
        String identifier = this.A01.A07();
        Iterator<String> it = setA0Z.iterator();
        while (it.hasNext()) {
