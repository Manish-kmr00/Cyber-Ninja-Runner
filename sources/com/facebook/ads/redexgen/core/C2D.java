...
public abstract class C2D<E> extends AbstractC1778Ne<E> implements List<E> {
    ...
    public static final C2931nu A02;
    ...
    public int indexOf(E element) {
        ...
        while (it.hasNext()) {
            if (C2923nk.A0C(it.next(), element)) {
                return i;
            }
            i++;
        }
    ...
    public int lastIndexOf(E element) {
        C2D<E> c2d = this;
        ListIterator<E> listIterator = c2d.listIterator(c2d.size());
        while (listIterator.hasPrevious()) {
            if (C2923nk.A0C(listIterator.previous(), element)) {
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC1778Ne, java.util.Collection, java.lang.Iterable, java.util.List
    public Iterator<E> iterator() {
        return new C1777Nd(this);
    }

    @Override // java.util.List
    public ListIterator<E> listIterator() {
        return new C2Q(this, 0);
    }

    @Override // java.util.List
    public ListIterator<E> listIterator(int index) {
        return new C2Q(this, index);
    }

    @Override // java.util.List
    public final List<E> subList(int fromIndex, int toIndex) {
        return new C12130e(this, fromIndex, toIndex);
    }
}
