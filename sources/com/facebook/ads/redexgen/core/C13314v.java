...
public class C13314v extends ViewGroup {
    ...
    public static final C13304u A0w;
    public static final Comparator<C13234n> A0x;
    public int A00;
    public C4S A01;
    public float A02;
    public float A03;
    ...
    public final C13234n A0p;
    public final Runnable A0q;
    public final ArrayList<C13234n> A0r;
    ...
    private C13234n A03() {
        ...
        float f3 = 0.0f;
        boolean z = true;
        C13234n c13234n = null;
        int i2 = 0;
        while (i2 < this.A0r.size()) {
            C13234n c13234n2 = this.A0r.get(i2);
            if (!z && c13234n2.A02 != i + 1) {
                c13234n2 = this.A0p;
                c13234n2.A00 = f2 + f3 + f;
                c13234n2.A02 = i + 1;
                c13234n2.A01 = this.A01.A00(c13234n2.A02);
                i2--;
            }
            f2 = c13234n2.A00;
            float f4 = c13234n2.A01 + f2;
            String[] strArr = A0t;
    ...
    public final void addTouchables(ArrayList<View> arrayList) {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            if (childAt.getVisibility() == 0 && (c13234nA07 = A07(childAt)) != null && c13234nA07.A02 == this.A00) {
    ...
    public void onMeasure(int i, int i2) {
        ...
        for (int i5 = 0; i5 < childCount; i5++) {
            ...
            if (childAt.getVisibility() != 8 && (c13244o2 = (C13244o) childAt.getLayoutParams()) != null && c13244o2.A05) {
                int i6 = c13244o2.A04 & 7;
                int i7 = c13244o2.A04 & 112;
                ...
                if (c13244o2.width != -2) {
                    i8 = 1073741824;
                    i3 = c13244o2.width != -1 ? c13244o2.width : paddingLeft;
                } else {
                    i3 = paddingLeft;
                }
                if (c13244o2.height != -2) {
                    i9 = 1073741824;
                    i4 = c13244o2.height != -1 ? c13244o2.height : measuredHeight;
                } else {
                    i4 = measuredHeight;
                }
        ...
        for (int i10 = 0; i10 < childCount2; i10++) {
            ...
            if (childAt2.getVisibility() != 8 && ((c13244o = (C13244o) childAt2.getLayoutParams()) == null || !c13244o.A05)) {
                childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (paddingLeft * c13244o.A00), 1073741824), this.A0A);
            }
        }
    }
  ...
  0x0164: PHI (r5v4 float) = (r5v3 float), (r5v5 float) binds: [B:56:0x01c3, B:44:0x0162] A[DONT_GENERATE, DONT_INLINE]] */
            ...
            switch (motionEvent.getAction() & 255) {
                ...
                case 1:
                    if (this.A0i) {
                        ...
                        C13234n c13234nA03 = A03();
                        A0O(A01(c13234nA03.A02, ((scrollX / clientWidth) - c13234nA03.A00) / (c13234nA03.A01 + (this.A0M / clientWidth)), xVelocity, (int) (motionEvent.getX(motionEvent.findPointerIndex(this.A08)) - this.A03)), true, true, xVelocity);
                        zA0U = A0U();
                    }
                    if (zA0U) {
                        C4h.A07(this);
    ...
    /* JADX WARN: Type inference failed for: r0v13, types: [com.facebook.ads.redexgen.X.4u] */
    static {
        A0C();
        A0u = new int[]{R.attr.layout_gravity};
        A0x = new Comparator<C13234n>() { // from class: com.facebook.ads.redexgen.X.4j
            /* JADX INFO: Access modifiers changed from: private */
            @Override // java.util.Comparator
            /* JADX INFO: renamed from: A00, reason: merged with bridge method [inline-methods] */
            public final int compare(C13234n c13234n, C13234n c13234n2) {
                return c13234n.A02 - c13234n2.A02;
            }
        };
        A0v = new Interpolator() { // from class: com.facebook.ads.redexgen.X.4k
        ...
        A0w = new Comparator<View>() { // from class: com.facebook.ads.redexgen.X.4u
            /* JADX INFO: Access modifiers changed from: private */
            @Override // java.util.Comparator
            /* JADX INFO: renamed from: A00, reason: merged with bridge method [inline-methods] */
            public final int compare(View view, View view2) {
                C13244o c13244o = (C13244o) view.getLayoutParams();
                C13244o c13244o2 = (C13244o) view2.getLayoutParams();
                if (c13244o.A05 != c13244o2.A05) {
                    return c13244o.A05 ? 1 : -1;
                }
                return c13244o.A02 - c13244o2.A02;
            }
        };
    }

    public C13314v(Context context) {
        super(context);
        this.A0r = new ArrayList<>();
        this.A0p = new C13234n();
        this.A0o = new Rect();
        this.A0O = -1;
        this.A0T = null;
        this.A0a = null;
        ...
        this.A0g = true;
        this.A0l = false;
        this.A0q = new Runnable() { // from class: com.facebook.ads.redexgen.X.4l
    ...
    private int A01(int i, float f, int i2, int i3) {
        ...
        if (targetPage2 > 0) {
            C13234n lastItem = this.A0r.get(0);
            ArrayList<C13234n> arrayList = this.A0r;
            int targetPage3 = this.A0r.size();
            C13234n c13234n = arrayList.get(targetPage3 - 1);
            int i4 = lastItem.A02;
            int targetPage4 = c13234n.A02;
    ...
    private final C13234n A04(int i) {
        for (int i2 = 0; i2 < i; i2++) {
            C13234n c13234n = this.A0r.get(i2);
            int i3 = c13234n.A02;
            if (A0t[6].charAt(18) == '5') {
                throw new RuntimeException();
            }
    ...
    private final C13234n A05(int i, int i2) {
        C13234n c13234n = new C13234n();
        c13234n.A02 = i;
        c13234n.A03 = this.A01.A04(this, i);
        c13234n.A01 = this.A01.A00(i);
        if (i2 < 0 || i2 >= this.A0r.size()) {
            this.A0r.add(c13234n);
        } else {
            this.A0r.add(i2, c13234n);
        }
        return c13234n;
    }

    private final C13234n A06(View view) {
        while (true) {
    ...
    private final C13234n A07(View view) {
        for (int i = 0; i < i; i++) {
            C13234n c13234n = this.A0r.get(i);
            if (this.A01.A08(view, c13234n.A03)) {
                return c13234n;
            }
        }
        return null;
    ...
    private void A0A() {
        int i = 0;
        while (i < i) {
            if (!((C13244o) getChildAt(i).getLayoutParams()).A05) {
                removeViewAt(i);
                i--;
            }
            i++;
    ...
    private final void A0D() {
        ...
        C4h.A0B(this, new C2780lN(this));
        if (C4h.A00(this) == 0) {
            C4h.A09(this, 1);
        }
        C4h.A0C(this, new C2781lO(this));
    }

    private void A0E(int i) {
        List<InterfaceC13264q> list = this.A0d;
        String[] strArr = A0t;
        if (strArr[5].charAt(3) == strArr[3].charAt(3)) {
            throw new RuntimeException();
        }
    ...
    private final void A0G(int i) {
        ...
        int iCharAt;
        int curIndex4;
        C13234n c13234nA04 = null;
        if (this.A00 != i) {
            c13234nA04 = A04(this.A00);
            this.A00 = i;
        }
        if (this.A01 == null) {
            A0B();
        ...
        if (N == this.A0G) {
            ...
            int i7 = 0;
            while (i7 < curIndex) {
                C13234n c13234n2 = this.A0r.get(i7);
                int i8 = c13234n2.A02;
            ...
            if (ii2 != null) {
                ...
                for (int i11 = curIndex9 - 1; i11 >= 0; i11--) {
                    if (f3 >= f && i11 < pos) {
                        ...
                        int curIndex10 = c13234n.A02;
                        if (i11 == curIndex10 && !c13234n.A04) {
                            this.A0r.remove(i10);
                            this.A01.A07(this, i11, c13234n.A03);
                            i10--;
                            i7--;
                            c13234n = i10 >= 0 ? this.A0r.get(i10) : null;
                        }
                    } else if (c13234n != null) {
                        int curIndex11 = c13234n.A02;
                        if (i11 == curIndex11) {
                            f3 += c13234n.A01;
                            i10--;
                            c13234n = i10 >= 0 ? this.A0r.get(i10) : null;
                        ...
                        if (extraWidthLeft >= leftWidthNeeded && i12 > startPos) {
                            ...
                            if (i12 == curIndex19) {
                                ...
                                if (itemIndex < curIndex20) {
                                    C13234n ii3 = this.A0r.get(itemIndex);
                                    String[] strArr6 = A0t;
                                ...
                                C13234n c13234nA05 = A05(i12, itemIndex);
                                itemIndex++;
                                extraWidthLeft += c13234nA05.A01;
                                size = this.A0r.size();
                                if (A0t[0].length() != 15) {
                            ...
                            C13234n c13234nA09 = A05(i12, itemIndex);
                            itemIndex++;
                            extraWidthLeft += c13234nA09.A01;
                            size = this.A0r.size();
                            if (A0t[0].length() != 15) {
                                A0t[0] = "BbpcE6tkf1K6OjJ";
                                if (itemIndex < size) {
                ...
                A0Q(ii2, i7, c13234nA04);
                childCount = getChildCount();
                for (i2 = 0; i2 < childCount; i2++) {
                    View childAt = getChildAt(i2);
                    c13244o = (C13244o) childAt.getLayoutParams();
                    c13244o.A01 = i2;
                    if (c13244o.A05 && c13244o.A00 == 0.0f && (c13234nA08 = A07(childAt)) != null) {
                        c13244o.A00 = c13234nA08.A01;
                        String[] strArr8 = A0t;
                        ...
                        if (iCharAt3 == curIndex22) {
                            ...
                            int curIndex23 = c13234nA08.A02;
                            c13244o.A02 = curIndex23;
                        }
                    }
                }
                A0B();
            ...
            while (i2 < childCount) {
                ...
                c13244o = (C13244o) childAt3.getLayoutParams();
                c13244o.A01 = i2;
                if (c13244o.A05) {
                }
            }
    ...
    private final void A0I(int i, float f, int i2) {
        ...
        if (this.A0D > 0) {
            ...
            for (int childCount = 0; childCount < i3; childCount++) {
                ...
                C13244o lp = (C13244o) childAt.getLayoutParams();
        ...
        if (0 != 0) {
            ...
            for (int i5 = 0; i5 < childCount2; i5++) {
                ...
                if (!((C13244o) childAt2.getLayoutParams()).A05) {
                    childAt2.getLeft();
                    getClientWidth();
    ...
    private void A0M(int i, boolean z, int i2, boolean z2) {
        C13234n c13234nA04 = A04(i);
        int destX = 0;
        if (c13234nA04 != null) {
            destX = (int) (getClientWidth() * Math.max(this.A02, Math.min(c13234nA04.A00, this.A07)));
        }
        if (z) {
            A0J(destX, 0, i2);
            if (z2) {
    ...
    private void A0Q(C13234n c13234n, int i, C13234n c13234n2) {
        float f;
        float f2;
        int pos;
        C13234n c13234n3;
        ...
        if (c13234n2 != null) {
            int width2 = c13234n2.A02;
            int N2 = c13234n.A02;
            if (width2 < N2) {
                int itemIndex = 0;
                float fA00 = c13234n2.A00 + c13234n2.A01 + f;
                int i2 = width2 + 1;
                while (i2 <= N) {
                    ...
                    C13234n c13234n5 = this.A0r.get(itemIndex);
                    while (true) {
                        c13234n4 = c13234n5;
                        int i3 = c13234n4.A02;
                        String[] strArr = A0t;
                        ...
                        if (width3 == N4) {
                            ...
                            itemIndex++;
                            c13234n5 = this.A0r.get(itemIndex);
                            String[] strArr2 = A0t;
                ...
                if (width2 > N7) {
                    ...
                    int i4 = N8 - 1;
                    float fA01 = c13234n2.A00;
                    int itemIndex2 = width2 - 1;
                    while (itemIndex2 >= N && i4 >= 0) {
                        C13234n c13234n6 = this.A0r.get(i4);
                        String[] strArr4 = A0t;
                        ...
                        while (true) {
                            c13234n3 = c13234n6;
                            int N10 = c13234n3.A02;
                            if (itemIndex2 >= N10 || i4 <= 0) {
                                break;
                            }
                            i4--;
                            c13234n6 = this.A0r.get(i4);
                        }
                        while (itemIndex2 > N) {
        ...
        int size = this.A0r.size();
        float offset = c13234n.A00;
        int N11 = c13234n.A02;
        int itemCount = N11 - 1;
        int N12 = c13234n.A02;
        this.A02 = N12 == 0 ? c13234n.A00 : -3.4028235E38f;
        int N13 = iA01 - 1;
        if (c13234n.A02 == N13) {
            float f3 = c13234n.A00;
            if (A0t[6].charAt(18) != 53) {
                String[] strArr6 = A0t;
                strArr6[5] = "UG1gT2jUNjrId2t7MfTS74a15LtMOaPg";
                strArr6[3] = "2ozfqeZF2OaiC2JUfBmasK4DPIGaXMZO";
                f2 = (f3 + c13234n.A01) - 1.0f;
            } else {
                f2 = (f3 + c13234n.A01) - 1.0f;
            }
        } else {
        ...
        while (pos >= 0) {
            C13234n c13234n7 = this.A0r.get(pos);
            while (itemCount > N) {
                offset -= this.A01.A00(itemCount) + f;
                itemCount--;
            }
            float f4 = c13234n7.A01 + f;
            String[] strArr9 = A0t;
        ...
        float fA02 = c13234n.A00 + c13234n.A01 + f;
        int N17 = c13234n.A02;
        int i5 = N17 + 1;
        int pos2 = i + 1;
        while (pos2 < size) {
            C13234n c13234n8 = this.A0r.get(pos2);
            while (i5 < N) {
            ...
            int N18 = iA01 - 1;
            if (c13234n8.A02 == N18) {
                this.A07 = (c13234n8.A01 + fA02) - 1.0f;
            }
            c13234n8.A00 = fA02;
            fA02 += c13234n8.A01 + f;
            pos2++;
    ...
    private void A0R(boolean z) {
        ...
        for (int i = 0; i < this.A0r.size(); i++) {
            C13234n c13234n = this.A0r.get(i);
            boolean needPopulate2 = c13234n.A04;
            if (needPopulate2) {
                z2 = true;
                c13234n.A04 = false;
            }
    ...
    private boolean A0X(float f) {
        ...
        C13234n c13234n = this.A0r.get(0);
        C13234n c13234n2 = this.A0r.get(this.A0r.size() - 1);
        if (c13234n.A02 != 0) {
            rightAbsolute = false;
            f3 = c13234n.A00 * clientWidth;
        }
        if (c13234n2.A02 != this.A01.A01() - 1) {
            leftAbsolute = false;
            float leftBound3 = c13234n2.A00;
    ...
    private boolean A0Z(int i) {
        ...
        int i2 = c13234nA03.A02;
        float f2 = ((i / currentPage) - c13234nA03.A00) / (c13234nA03.A01 + f);
        this.A0e = false;
        ...
        if (size < (adapterCount6 * 2) + 1) {
            ...
            if (A0t[0].length() == 15) {
                ...
                while (i2 < adapterCount) {
                    c13234n = this.A0r.get(i2);
                    newPos = this.A01.A02(c13234n.A03);
                    if (newPos != -1) {
                        if (newPos == -2) {
                            this.A0r.remove(i2);
                            i2--;
                            ...
                            this.A01.A07(this, c13234n.A02, c13234n.A03);
                            z = true;
                            i5 = this.A00;
                            adapterCount5 = c13234n.A02;
                            if (i5 == adapterCount5) {
                ...
                if (z) {
                    ...
                    for (newCurrItem = 0; newCurrItem < childCount; newCurrItem++) {
                        c13244o = (C13244o) getChildAt(newCurrItem).getLayoutParams();
                        if (!c13244o.A05) {
                            c13244o.A00 = 0.0f;
                        }
                    }
    ...
    public final void addFocusables(ArrayList<View> views, int i, int i2) {
        ...
        if (descendantFocusability != 393216) {
            ...
            while (true) {
                ...
                if (focusableCount == 0 && (c13234nA07 = A07(childAt)) != null) {
                    int descendantFocusability3 = c13234nA07.A02;
    ...
    public final void addView(View view, int i, ViewGroup.LayoutParams layoutParams) {
        ...
        C13244o c13244o = (C13244o) layoutParams;
        boolean z = c13244o.A05;
        String[] strArr = A0t;
        if (strArr[4].charAt(21) != strArr[2].charAt(21)) {
            throw new RuntimeException();
        }
        A0t[6] = "0hKurRTmjdCHvNVYXWivI507L49T3Iz9";
        c13244o.A05 = z | A0c(view);
        if (this.A0h) {
            if (c13244o == null || !c13244o.A05) {
                c13244o.A03 = true;
    ...
    public final boolean checkLayoutParams(ViewGroup.LayoutParams layoutParams) {
        return (layoutParams instanceof C13244o) && super.checkLayoutParams(layoutParams);
    }
        ...
        if (accessibilityEvent.getEventType() == 4096) {
            ...
            if (A0t[0].length() == 15) {
                ...
                for (int i = 0; i < childCount; i++) {
                    ...
                    if (childCount2 == 0) {
                        C13234n c13234nA07 = A07(childAt);
                        String[] strArr3 = A0t;
    ...
    public final ViewGroup.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        return new C13244o(getContext(), attributeSet);
    }
    ...
    public final int getChildDrawingOrder(int i, int i2) {
        ...
        int index = ((C13244o) this.A0b.get(result).getLayoutParams()).A01;
        return index;
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.A0M > 0 && this.A0S != null && this.A0r.size() > 0 && this.A01 != null) {
            ...
            int firstPos = 0;
            C13234n c13234n = this.A0r.get(0);
            float marginOffset = c13234n.A00;
            int itemCount = this.A0r.size();
            int i = this.A0r.get(itemCount - 1).A02;
            for (int i2 = c13234n.A02; i2 < i; i2++) {
                while (i2 > c13234n.A02 && firstPos < itemCount) {
                    firstPos++;
                    c13234n = this.A0r.get(firstPos);
                }
                if (i2 == c13234n.A02) {
                    f = (c13234n.A00 + c13234n.A01) * pos;
                    float marginOffset2 = c13234n.A00;
                    marginOffset = marginOffset2 + c13234n.A01 + f2;
                } else {
  ...
  0x0073: PHI (r1v19 float) = (r1v12 float), (r1v20 float) binds: [B:35:0x00a0, B:27:0x0071] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        while (true) {
            ...
            if (paddingTop < scrollX) {
                ...
                if (childAt.getVisibility() != 8) {
                    C13244o c13244o = (C13244o) childAt.getLayoutParams();
                    if (c13244o.A05) {
                        int count3 = c13244o.A04 & 7;
                        int childTop2 = c13244o.A04 & 112;
                        switch (count3) {
                            case 1:
                ...
                while (paddingBottom3 < scrollX) {
                    ...
                    if (childAt2.getVisibility() != count2) {
                        C13244o c13244o2 = (C13244o) childAt2.getLayoutParams();
                        if (!c13244o2.A05 && (c13234nA07 = A07(childAt2)) != null) {
                            int i6 = vgrav + ((int) (childLeft2 * c13234nA07.A00));
                            if (c13244o2.A03) {
                                c13244o2.A03 = false;
                                int widthSpec = View.MeasureSpec.makeMeasureSpec((int) (childLeft2 * c13244o2.A00), 1073741824);
    ...
    public final boolean onRequestFocusInDescendants(int i, Rect rect) {
        ...
        while (i2 != childCount) {
            ...
            if (count2 == 0 && (c13234nA07 = A07(childAt)) != null) {
                int index = c13234nA07.A02;
                int count3 = this.A00;
    ...
    /* JADX WARN: Type inference failed for: r0v17, types: [com.facebook.ads.redexgen.X.4s] */
    public void setAdapter(C4S c4s) {
        if (this.A01 != null) {
            this.A01.A06(null);
            for (int i = 0; i < i; i++) {
                C13234n c13234n = this.A0r.get(i);
        ...
        this.A01 = c4s;
        this.A0G = 0;
        C4S oldAdapter = this.A01;
        if (oldAdapter != null) {
            if (this.A0Z == null) {
                this.A0Z = new DataSetObserver() { // from class: com.facebook.ads.redexgen.X.4s
    ...
    @Deprecated
    public void setOnPageChangeListener(InterfaceC13264q interfaceC13264q) {
        this.A0Y = interfaceC13264q;
    }
    ...
    public void setPageMarginDrawable(int i) {
        setPageMarginDrawable(AbstractC13103y.A00(getContext(), i));
    }
