...
public final class C2660jO<T> implements C9Z<T> {
    ...
    public C9R A00;
    public C9R A01;
    public List<C2660jO<T>.RecordFileBasedFetch> A02 = new ArrayList();
    public boolean A03;
    public final C9Q A04;
    public final C14439g A05;
     ...
     */
    /* JADX WARN: Incorrect inner types in method signature: (Lcom/facebook/ads/redexgen/X/jO<TT;>.RecordFileBasedFetch;)Z */
    public synchronized boolean A06(C2661jP c2661jP) {
        if (!this.A02.remove(c2661jP)) {
            return false;
        }
        if (c2661jP.A6N() > 0 && c2661jP.A01().A02.A05(c2661jP.A01().A01).equals(this.A01)) {
            this.A01 = c2661jP.A00().A02;
        }
        return true;
    }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.jO != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T> */
    public C2660jO(C9W c9w, InterfaceC14419e interfaceC14419e) throws IOException {
        this.A05 = new C14439g(c9w.A04(A00(IronSourceConstants.SDK_INIT_FAILED, 4, 103)), interfaceC14419e);
        this.A04 = new C9Q(new File(c9w.A05(), A00(509, 6, 60)));
        this.A00 = this.A04.A03();
        A05(interfaceC14419e);
        this.A01 = this.A00;
    }
    ...
    /* JADX WARN: Incorrect inner types in method signature: (Lcom/facebook/ads/redexgen/X/jO<TT;>.RecordFileBasedFetch;)V */
    public synchronized void A03(C2661jP c2661jP) throws C14459i {
        if (!this.A03) {
            if (A06(c2661jP)) {
                if (c2661jP.A6N() == 0) {
                    return;
                }
                if (this.A00.A04(c2661jP.A00().A02) == 0) {
                    try {
                        Iterator<C14409d> it = c2661jP.A00.iterator();
                        while (it.hasNext()) {
                            if (it.next().A00 == this.A05.A07() && this.A05.A0D()) {
                                A02(this.A05.A06(), 0);
                            } else {
                                A02(this.A05.A06(), c2661jP.A00().A00);
                                break;
                            }
                        }
                        ...
                        throw new C14459i(A00(361, 30, 22), e);
                    }
                }
                throw new C14459i(A00(0, 54, 30));
            }
            throw new C14459i(A00(466, 43, 59));
        }
        throw new C14459i(A00(427, 39, 60));
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.jO != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T> */
    private void A05(InterfaceC14419e interfaceC14419e) throws IOException {
        C9R c9r = new C9R(this.A05.A06(), 0);
        C9R recordSequenceStart = this.A00;
        if (c9r.A04(recordSequenceStart) > 0) {
            Locale locale = Locale.US;
            C9R recordSequenceStart2 = this.A00;
            Integer numValueOf = Integer.valueOf(recordSequenceStart2.A02());
            C9R recordSequenceStart3 = this.A00;
            interfaceC14419e.AHi(String.format(locale, A00(54, 102, 13), numValueOf, Integer.valueOf(recordSequenceStart3.A03()), Integer.valueOf(c9r.A02()), Integer.valueOf(c9r.A03())));
            this.A00 = c9r;
            return;
        }
        while (iA02 < recordSequenceStart.A02()) {
            if (this.A05.A0D()) {
                c9r = new C9R(this.A05.A06(), 0);
            } else {
                Locale locale2 = Locale.US;
                C9R recordSequenceStart4 = this.A00;
                Integer numValueOf2 = Integer.valueOf(recordSequenceStart4.A02());
                C9R recordSequenceStart5 = this.A00;
                interfaceC14419e.AHi(String.format(locale2, A00(156, 101, 70), numValueOf2, Integer.valueOf(recordSequenceStart5.A03()), Integer.valueOf(c9r.A02())));
                C9R recordSequenceStart6 = new C9R(this.A05.A06(), this.A05.A07());
                this.A00 = recordSequenceStart6;
                C9Q c9q = this.A04;
                C9R recordSequenceStart7 = this.A00;
                c9q.A04(recordSequenceStart7);
            }
        }
    }
    ...
    public final synchronized C9Y A6M(byte[] bArr, int[] iArr) throws C14459i {
        C2660jO<T>.RecordFileBasedFetch c2661jP;
        if (!this.A03) {
            int i = 0;
            int i2 = 0;
            try {
                ...
                while (true) {
                    C9U c9uA0A = this.A05.A0A(this.A01.A02(), this.A01.A03(), bArr, i, iArr, i2);
                    int iA00 = c9uA0A.A01().A00();
                    int storageOffset = c9uA0A.A01().A01();
                    int i3 = iA00 - storageOffset;
                    int storageOffset2 = c9uA0A.A01().A02();
                    i += storageOffset2;
                    i2 += i3;
                    if (c9uA0A.A01().A03() == C9S.A03) {
                        arrayList.add(c9uA0A);
                    }
                    if (c9uA0A.A01().A03() == C9S.A04) {
                        break;
                    }
                    if (c9uA0A.A01().A03() == C9S.A05) {
                        ...
                        this.A01 = new C9R(storageOffset5 + 1, 0);
                    } else {
                        this.A01 = this.A01.A05(i3);
                    }
                }
                c2661jP = new C2661jP(this, arrayList, mayHaveMoreData);
                this.A02.add(c2661jP);
                if (!arrayList.isEmpty()) {
                    C9R c9r = c2661jP.A01().A02;
                    int storageOffset6 = c2661jP.A01().A01;
                    this.A01 = c9r.A05(storageOffset6);
                }
            } catch (IOException e) {
                throw new C14459i(A00(306, 29, 84), e);
            }
        } else {
            throw new C14459i(A00(391, 36, Sdk.SDKError.Reason.INVALID_RI_ENDPOINT_VALUE));
        }
        return c2661jP;
    }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.jO != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T> */
    @Override // com.facebook.ads.redexgen.core.C9Z
    public final synchronized int A8i() throws C14459i {
        int iA09;
        if (!this.A03) {
            try {
                iA09 = this.A05.A09();
                ...
                throw new C14459i(A00(335, 26, 57), e);
            }
        } else {
            throw new C14459i(A00(427, 39, 60));
        }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.jO != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T> */
    @Override // com.facebook.ads.redexgen.core.C9Z
    public final synchronized void AJM(byte[] bArr) throws C14459i {
        if (!this.A03) {
            try {
                this.A05.A0C(bArr);
            } catch (IOException e) {
                throw new C14459i(A00(257, 25, 62), e);
            }
        } else {
            throw new C14459i(A00(427, 39, 60));
        }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.jO != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T> */
    @Override // com.facebook.ads.redexgen.core.C9Z
    public final synchronized void clear() throws C14459i {
        try {
            this.A05.A0B();
            A02(this.A05.A06(), 0);
            this.A02.clear();
        } catch (IOException e) {
            throw new C14459i(A00(282, 24, 87), e);
        }
    }
