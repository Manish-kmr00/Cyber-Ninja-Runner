...
public class C6D {
    ...
    public C6D(int i, int i2) {
        this(i, i2, Integer.MIN_VALUE, null);
    }

    public C6D(int i, int i2, int i3, Interpolator interpolator) {
        this.A04 = -1;
        this.A06 = false;
        this.A00 = 0;
        this.A02 = i;
        ...
        if (this.A06) {
            ...
            if (interpolator == null) {
                if (this.A01 == Integer.MIN_VALUE) {
                    mg.A08.A0A(this.A02, this.A03);
                } else {
                    C6J c6j = mg.A08;
                    int i2 = this.A02;
                    int i3 = this.A03;
                    if (A08[1].length() != 25) {
                        c6j.A0B(i2, i3, this.A01);
                    } else {
                        String[] strArr2 = A08;
                ...
                mg.A08.A0C(this.A02, this.A03, this.A01, this.A05);
            }
            this.A00++;
            if (this.A00 > 10) {
