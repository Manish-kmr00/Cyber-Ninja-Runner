...
public abstract class EnumC1693Jo {
    ...
    public static final /* synthetic */ EnumC1693Jo[] A02;
    public static final EnumC1693Jo A03;
    public static final EnumC1693Jo A04;
    public static final EnumC1693Jo A05;
    public static final EnumC1693Jo A06;
    public static final EnumC1693Jo A07;
    public static final EnumC1693Jo A08;
    ...
    static {
        ...
        final int i = 0;
        A03 = new EnumC1693Jo(strA02, i) { // from class: com.facebook.ads.redexgen.X.aa
            @Override // com.facebook.ads.redexgen.core.EnumC1693Jo
            ...
            public final boolean A06(JSONArray jSONArray, JSONArray jSONArray2, int i2) {
                return AbstractC1694Jp.A00(jSONArray.optJSONArray(i2), jSONArray2.optJSONArray(i2));
            }
            ...
            public final boolean A08(JSONObject jSONObject, JSONObject jSONObject2, String str) {
                return AbstractC1694Jp.A00(jSONObject.optJSONArray(str), jSONObject2.optJSONArray(str));
            }
        };
        final String strA03 = A02(5, 7, 74);
        final int i2 = 1;
        A04 = new EnumC1693Jo(strA03, i2) { // from class: com.facebook.ads.redexgen.X.aZ
            @Override // com.facebook.ads.redexgen.core.EnumC1693Jo
        ...
        final String strA04 = A02(12, 6, 109);
        final int i3 = 2;
        A05 = new EnumC1693Jo(strA04, i3) { // from class: com.facebook.ads.redexgen.X.aQ
        ...
        final String strA05 = A02(18, 3, 111);
        final int i4 = 3;
        A06 = new EnumC1693Jo(strA05, i4) { // from class: com.facebook.ads.redexgen.X.aO
        ...
        final String strA06 = A02(21, 6, 95);
        final int i5 = 4;
        A07 = new EnumC1693Jo(strA06, i5) { // from class: com.facebook.ads.redexgen.X.aN
            @Override // com.facebook.ads.redexgen.core.EnumC1693Jo
            ...
            public final boolean A06(JSONArray jSONArray, JSONArray jSONArray2, int i6) {
                return AbstractC1694Jp.A02(jSONArray.optJSONObject(i6), jSONArray2.optJSONObject(i6));
            }
            ...
            @Override // com.facebook.ads.redexgen.core.EnumC1693Jo
            public final boolean A08(JSONObject jSONObject, JSONObject jSONObject2, String str) {
                return AbstractC1694Jp.A02(jSONObject.optJSONObject(str), jSONObject2.optJSONObject(str));
            }
        };
        final String strA07 = A02(27, 6, 50);
        final int i6 = 5;
        A08 = new EnumC1693Jo(strA07, i6) { // from class: com.facebook.ads.redexgen.X.aM
            @Override // com.facebook.ads.redexgen.core.EnumC1693Jo
    ...
    public EnumC1693Jo(String str, int i) {
        super(str, i);
    }

    public static EnumC1693Jo A00(JSONArray jSONArray, int i) {
        for (EnumC1693Jo type : values()) {
    ...
    public static EnumC1693Jo A01(JSONObject jSONObject, String str) {
        for (EnumC1693Jo type : values()) {
            String[] strArr = A01;
    ...
    public static /* synthetic */ EnumC1693Jo[] A04() {
        return new EnumC1693Jo[]{A03, A04, A05, A06, A07, A08};
    }

    public static EnumC1693Jo valueOf(String str) {
        return (EnumC1693Jo) Enum.valueOf(EnumC1693Jo.class, str);
    }

    public static EnumC1693Jo[] values() {
        return (EnumC1693Jo[]) A02.clone();
    }
}
