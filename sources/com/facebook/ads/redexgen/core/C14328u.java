...
public final class C14328u {
     ...
     */
    public C14328u(Map<String, String> map) {
        byte b;
        this.A01 = -1;
        this.A00 = -1;
        this.A0B = A0G;
        ...
        for (Map.Entry<String, String> entry : map.entrySet()) {
            ...
            switch (key.hashCode()) {
                ...
                case 700812481:
                    ...
                    break;
                case 858630459:
                    if (key.equals(A01(225, 24, Sdk.SDKError.Reason.JSON_ENCODE_ERROR_VALUE))) {
                        b = 2;
                    } else {
                        b = -1;
                    }
