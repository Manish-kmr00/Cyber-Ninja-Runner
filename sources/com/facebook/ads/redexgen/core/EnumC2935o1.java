...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.o1, reason: case insensitive filesystem */
...
public enum EnumC2935o1 {
    ...
    public static EnumC2935o1[] valuesCustom() {
        EnumC2935o1[] enumC2935o1ArrValuesCustom = values();
        if (A01[4].length() == 0) {
            throw new RuntimeException();
        }
        A01[5] = "kC8OQjnUJR";
        return (EnumC2935o1[]) enumC2935o1ArrValuesCustom.clone();
    }
