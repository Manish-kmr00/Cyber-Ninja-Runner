...
public abstract class AbstractC1778Ne<E> implements Collection<E> {
    ...
    public boolean contains(E element) {
        AbstractC1778Ne<E> abstractC1778Ne = this;
        if ((abstractC1778Ne instanceof Collection) && abstractC1778Ne.isEmpty()) {
            return false;
        }
        Iterator<E> it = abstractC1778Ne.iterator();
        while (it.hasNext()) {
    ...
    public final boolean containsAll(Collection<? extends Object> elements) {
        C2923nk.A09(elements, A08(60, 8, 90));
    ...
    public Object[] toArray() {
        return AbstractC2925nm.A02(this);
    }

    @Override // java.util.Collection
    public <T> T[] toArray(T[] array) {
        C2923nk.A09(array, A08(55, 5, 15));
        return (T[]) AbstractC2925nm.A03(this, array);
    }

    public final String toString() {
        return AnonymousClass05.A03(this, A08(0, 2, 33), A08(53, 1, 93), A08(54, 1, 109), 0, null, new C12140f(this), 24, null);
    }
}
