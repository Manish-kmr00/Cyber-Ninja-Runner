...
public final class DX extends AdNativeComponentView {
    ...
    public static final int A09 = ((int) CP.A02) * 500;
    public static final int A0H = (int) (CP.A02 * 500.0f);
    public static final int A0D = (int) (CP.A02 * 4.0f);
    public static final int A0B = (int) (CP.A02 * 8.0f);
    public static final int A0G = (int) (CP.A02 * 8.0f);
    public static final int A0E = (int) (CP.A02 * 4.0f);
    public static final int A0C = (int) CP.A02;
    public static final int A0F = (int) (CP.A02 * 4.0f);
    public static final int A0A = (int) (((double) CP.A02) * 0.5d);

    public DX(C2699k1 c2699k1, AW aw) {
        super(c2699k1);
        this.A06 = aw;
        this.A05 = new TextView(c2699k1);
        this.A04 = new TextView(c2699k1);
        this.A03 = new TextView(c2699k1);
        this.A02 = new RelativeLayout(c2699k1);
        this.A00 = new LinearLayout(c2699k1);
        this.A01 = new RelativeLayout(c2699k1);
        this.A07 = new C2538hK(c2699k1);
        A09();
        A0D();
        A05();
        A0A();
    ...
    public final void onMeasure(int i, int i2) {
        int iA0F = ((int) CP.A02) * C14499m.A0F(getContext());
