...
public class C13013p<K, V> extends OG<Map.Entry<K, V>> {
    public final transient int A00;
    public final transient int A01;
    public final transient AbstractC2804lm<K, V> A02;
    ...
    public C13013p(AbstractC2804lm<K, V> map, Object[] alternatingKeysAndValues, int keyOffset, int size) {
        this.A02 = map;
    ...
    public final OI<Map.Entry<K, V>> A0M() {
        return new OI<Map.Entry<K, V>>() { // from class: com.facebook.ads.redexgen.X.3q
            ...
            public final Map.Entry<K, V> get(int index) {
                AbstractC2589iD.A00(index, this.A00.A01);
    ...
    public final AbstractC2964oj<Map.Entry<K, V>> iterator() {
        return A0J().iterator();
    }
