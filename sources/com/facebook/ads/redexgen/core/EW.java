...
public final class EW extends LinearLayout {
    ...
    public static final int A06 = (int) (((double) CP.A02) * 14.5d);
    ...
    public void setInfo(DB db, String str, String str2) {
        this.A00.setImageBitmap(DC.A01(db));
        this.A02.setText(str);
        if (!TextUtils.isEmpty(str2)) {
            TextView textView = new TextView(getContext());
            D3.A0W(textView, false, 14);
