...
public class C2618ii extends JK {
    ...
    public C2618ii(C2615ie c2615ie, View view, boolean z, C2873mv c2873mv) {
        this.A02 = c2615ie;
        this.A00 = view;
        this.A03 = z;
        this.A01 = c2873mv;
    ...
    public final void A03() {
        this.A02.A0e.A0B();
        if (C14499m.A29(this.A02.A12()) && (this.A00 instanceof AdNativeComponentView)) {
            View adContentsView = ((AdNativeComponentView) this.A00).getAdContentsView();
            if ((adContentsView instanceof IM) && !((IM) adContentsView).A05()) {
                this.A02.A0R.A0T();
                this.A02.A0e.A08();
                return;
            }
        ...
        if (this.A03) {
            ...
            C2615ie.A0f(drawable, imageView);
        }
        ...
        if (this.A02.A09 != null && this.A02.A04 != null) {
            ...
            if (view != null) {
                ...
                this.A02.A09.A0D(EI.A00(this.A02.A07));
