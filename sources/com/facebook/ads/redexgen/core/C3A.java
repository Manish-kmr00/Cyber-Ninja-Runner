...
public abstract class C3A {
    ...
    public static AdSettings.IntegrationErrorMode A00(C2699k1 c2699k1) {
        ...
        if (integrationErrorMode == integrationErrorMode2 && !A03(c2699k1)) {
    ...
    public static boolean A03(C2699k1 c2699k1) {
        return (c2699k1.getApplicationInfo().flags & 2) != 0;
    }
}
