...
public class C5J extends OP<String, List<String>> {
    ...
    @Override // com.facebook.ads.redexgen.core.OP, java.util.Map
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC2784lS
    ...
    public final Set<Map.Entry<String, List<String>>> entrySet() {
        return AbstractC2933nx.A07(super.entrySet(), new InterfaceC2590iE() { // from class: com.facebook.ads.redexgen.X.Pr
    ...
    public final Set<String> keySet() {
        return AbstractC2933nx.A07(super.keySet(), new InterfaceC2590iE() { // from class: com.facebook.ads.redexgen.X.Ps
            @Override // com.facebook.ads.redexgen.core.InterfaceC2590iE
            public final boolean A42(Object obj) {
