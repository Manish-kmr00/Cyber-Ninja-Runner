...
public final class C4A<K, V> implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V> {
    ...
    public int A00;
    public final /* synthetic */ C4C A03;
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.4A != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V>$MapIterator */
    public C4A(C4C c4c) {
        this.A03 = c4c;
        this.A00 = c4c.A04() - 1;
    }
    ...
    public final boolean equals(Object obj) {
        if (this.A02) {
            ...
            return AnonymousClass45.A04(entry.getKey(), this.A03.A0B(this.A01, 0)) && AnonymousClass45.A04(entry.getValue(), this.A03.A0B(this.A01, 1));
        }
