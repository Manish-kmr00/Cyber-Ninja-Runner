...
public final class A4 {
    ...
    public A4(AnonymousClass85 anonymousClass85, String str, double d, String str2, Map<String, String> map, A9 a9, AA aa, boolean z) {
        this.A05 = str;
        this.A00 = d;
        this.A04 = str2;
        this.A02 = a9;
        ...
        String strA01 = AH.A01(str);
        if (!TextUtils.isEmpty(strA01) && (z || aa == AA.A0C)) {
            map2.put(A00(6, 21, 46), strA01);
        }
        if (A0B()) {
            Map<String, String> extraData = anonymousClass85.A04().A6m();
            map2.put(A00(0, 6, 111), CV.A01(extraData));
        }
