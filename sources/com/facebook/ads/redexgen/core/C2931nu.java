...
public final class C2931nu {
    ...
    public /* synthetic */ C2931nu(AbstractC2924nl abstractC2924nl) {
        this();
    }
    ...
    public final int A02(Collection<?> collection) {
        C2923nk.A09(collection, A00(31, 1, 39));
        int i = 1;
    ...
    public final boolean A06(Collection<?> collection, Collection<?> collection2) {
        C2923nk.A09(collection, A00(31, 1, 39));
        C2923nk.A09(collection2, A00(50, 5, 95));
        ...
        while (it2.hasNext()) {
            if (!C2923nk.A0C(it2.next(), it.next())) {
                return false;
            }
        }
        return true;
