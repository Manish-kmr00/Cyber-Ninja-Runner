...
public class C13435h {
    ...
    private View A00() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (!anonymousClass63.A02()) {
                int i2 = this.A01;
                int size2 = anonymousClass63.A00();
                if (i2 == size2) {
                    A02(view);
                    return view;
                }
    ...
    private final View A01(View view) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            AnonymousClass63 anonymousClass63 = (AnonymousClass63) view3.getLayoutParams();
            if (view3 != view) {
                boolean zA02 = anonymousClass63.A02();
    ...
    private final void A02(View view) {
        ...
        if (closest == null) {
            ...
            this.A01 = ((AnonymousClass63) closest.getLayoutParams()).A00();
        }
    }

    public final View A03(C6A c6a) {
        if (this.A08 != null) {
            return A00();
        }
        View viewA0G = c6a.A0G(this.A01);
        this.A01 += this.A03;
        return viewA0G;
    }
    ...
    public final boolean A05(C6H c6h) {
        return this.A01 >= 0 && this.A01 < c6h.A03();
    }
}
