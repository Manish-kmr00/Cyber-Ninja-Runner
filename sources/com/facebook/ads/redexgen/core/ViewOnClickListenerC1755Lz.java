...
public final class ViewOnClickListenerC1755Lz extends C2572hu implements View.OnClickListener, View.OnTouchListener {
    ...
    public ViewOnClickListenerC1755Lz(C13656e c13656e, C2699k1 c2699k1, A7 a7, DR dr, String str, int i) {
        super(c13656e, c2699k1, a7, dr);
        this.A00 = 0;
        this.A01 = 0;
        this.A03 = false;
        this.A07 = new DU(this);
        this.A08 = str;
        this.A05 = new Handler(Looper.getMainLooper());
        this.A06 = (InputMethodManager) c2699k1.getSystemService(A05(112, 12, 70));
        this.A04 = i;
    }

    public static /* synthetic */ int A02(ViewOnClickListenerC1755Lz viewOnClickListenerC1755Lz) {
        int i = viewOnClickListenerC1755Lz.A00;
        viewOnClickListenerC1755Lz.A00 = i + 1;
        return i;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A06() {
        D3.A0K(this, 1610612736);
    }
    ...
    @Override // com.facebook.ads.redexgen.core.C2572hu
    public final InterfaceC1570Ev A0E() {
        return new C2576hy(this);
    }
    ...
    public final void A0F() {
        ...
        this.A0B.setOnTouchListener(new View.OnTouchListener() { // from class: com.facebook.ads.redexgen.X.DT
            @Override // android.view.View.OnTouchListener
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return ViewOnClickListenerC1755Lz.A0B(view, motionEvent);
            }
        });
        ...
        RelativeLayout.LayoutParams layoutParams3 = new RelativeLayout.LayoutParams(-1, (int) (CP.A02 * 2.0f));
        layoutParams3.addRule(3, this.A0B.getId());
        this.A0C.setProgress(0);
        addView(this.A0C, layoutParams3);
        A06();
        this.A0A.A3v(this, new RelativeLayout.LayoutParams(-1, -1));
    }
    ...
    public final void A0H(String str) {
        if (this.A04 > 0 && !this.A03) {
            ...
            if (this.A02 != null) {
                this.A02.A04(AE.A0J, mapA05);
            }
            A07();
            this.A09.AB3(super.A04, mapA05);
            if (C14499m.A2L(super.A08)) {
                ...
                this.A09.ABC(super.A04, map);
            }
        }
    }

    @Override // com.facebook.ads.redexgen.core.C2572hu, com.facebook.ads.redexgen.core.DS
    public final void AAj(Intent intent, Bundle bundle, C13656e c13656e) {
        super.AAj(intent, bundle, c13656e);
        this.A02 = new AF(super.A04, this.A09);
    }
