...
public class C2654jI<K> implements Iterator<K> {
    ...
    public C2654jI(final C4X this$1, final Iterator val$entryIterator) {
        this.A01 = this$1;
    ...
    public final void remove() {
        AbstractC2589iD.A0F(this.A00 != null, A00(0, 50, 26));
        Collection collection = (Collection) this.A00.getValue();
        this.A02.remove();
        C4U.A03(this.A01.A00, collection.size());
        collection.clear();
        this.A00 = null;
    }
}
