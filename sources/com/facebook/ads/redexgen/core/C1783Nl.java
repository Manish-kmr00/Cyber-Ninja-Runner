...
public final class C1783Nl implements InterfaceC2962of {
    ...
    private final void A02(List<Rect> list) {
        ...
        Iterator<InterfaceC2967om> it = this.A03.iterator();
        if (it.hasNext()) {
            it.next();
    ...
    public C1783Nl(View view, InterfaceC2966ol interfaceC2966ol) {
        this.A00 = new WeakReference<>(view);
        this.A03 = interfaceC2966ol;
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC2962of
