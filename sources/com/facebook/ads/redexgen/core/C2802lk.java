...
public class C2802lk<K, V> {
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.lk != com.google.common.collect.ImmutableMap$Builder<K, V> */
    public C2802lk() {
        this(4);
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.lk != com.google.common.collect.ImmutableMap$Builder<K, V> */
    public C2802lk(int initialCapacity) {
    ...
    private AbstractC2804lm<K, V> A00(boolean throwIfDuplicateKeys) {
        Object[] objArrA03;
        int length;
        int localSize;
        if (!throwIfDuplicateKeys || this.A01 == null) {
            ...
            C1793Nv c1793NvA00 = C1793Nv.A00(i, objArrA03, this);
            if (!throwIfDuplicateKeys || this.A01 == null) {
                return c1793NvA00;
            }
            throw this.A01.A02();
    ...
    private void A01(int minCapacity) {
        if (minCapacity * 2 > this.A04.length) {
            this.A04 = Arrays.copyOf(this.A04, AbstractC2794lc.A03(this.A04.length, minCapacity * 2));
            this.A03 = false;
        }
    }
    ...
    public static <V> void A02(Object[] alternatingKeysAndValues, int size, Comparator<? super V> valueComparator) {
        ...
        Arrays.sort(entryArr, 0, size, AbstractC2912nY.A04(valueComparator).A05(AbstractC2880n2.A04()));
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.lk != com.google.common.collect.ImmutableMap$Builder<K, V> */
    public C2802lk<K, V> A04(Iterable<? extends Map.Entry<? extends K, ? extends V>> entries) {
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.lk != com.google.common.collect.ImmutableMap$Builder<K, V> */
    public C2802lk<K, V> A05(K key, V value) {
        A01(this.A00 + 1);
        AbstractC2748ko.A03(key, value);
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.lk != com.google.common.collect.ImmutableMap$Builder<K, V> */
    public C2802lk<K, V> A06(Map.Entry<? extends K, ? extends V> entry) {
        return A05(entry.getKey(), entry.getValue());
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.lk != com.google.common.collect.ImmutableMap$Builder<K, V> */
    public AbstractC2804lm<K, V> A07() {
        return A08();
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.lk != com.google.common.collect.ImmutableMap$Builder<K, V> */
    public AbstractC2804lm<K, V> A08() {
        return A00(true);
    }
}
