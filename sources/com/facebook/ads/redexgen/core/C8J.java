...
public final class C8J {
    ...
    public C8J(Set<String> options, Integer num, Integer num2, String str) {
        this.A03 = options;
    ...
    public C8J(String[] strArr, Integer num, Integer num2) {
    ...
    public static C8J A00(String str) {
        if (str == null) {
            return null;
        }
        ...
        while (true) {
            ...
            if (zFind) {
                ...
                return new C8J(linkedHashSet, numValueOf, numValueOf2, str);
            }
        }
    }
    ...
    public final boolean equals(Object obj) {
        ...
        C8J c8j = (C8J) obj;
        if (this.A00 == c8j.A00 || (this.A00 != null && this.A00.equals(c8j.A00))) {
            return (this.A01 == c8j.A01 || (this.A01 != null && this.A01.equals(c8j.A01))) && this.A03.equals(c8j.A03);
        }
        return false;
    }
