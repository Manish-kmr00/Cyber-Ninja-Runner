...
public final class C14399c {
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public final synchronized C9T A06(int i, byte[] bArr, int i2, int[] iArr, int i3) throws IOException {
        C14389b c14389bA00 = A00();
        int i4 = 1;
        if (i < 0) {
        ...
        long j = -1;
        boolean z = false;
        while (i5 < c14389bA00.A00) {
            if ((i5 - i) + i3 >= iArr.length) {
                z = true;
                break;
            }
            long j2 = c14389bA00.A03[i5];
            long j3 = (i5 == c14389bA00.A00 - i4 ? c14389bA00.A01 : c14389bA00.A03[i5 + 1]) - j2;
            if (j == -1) {
                j = j2;
            }
        ...
        if (i5 <= i) {
            return new C9T(z ? C9S.A04 : C9S.A05, i, i, 0);
        }
        c14389bA00.A02.seek(j);
        c14389bA00.A02.read(bArr, i2, i6);
        return new C9T(C9S.A03, i, i5, i6);
    }
    ...
    public final synchronized boolean A09(byte[] bArr) throws IOException {
        ...
        A03(c14389bA00.A00, c14389bA00.A01);
        A04(c14389bA00.A01, bArr);
        c14389bA00.A02.getFD().sync();
        c14389bA00.A00++;
        c14389bA00.A01 += (long) bArr.length;
        return true;
    }
    ...
    public C14399c(File file) throws IOException {
        this.A02 = file;
        if (!file.exists()) {
            this.A00 = C14389b.A03(file);
        } else if (!file.isFile()) {
            throw new IOException(String.format(Locale.US, A01(25, 32, 2), file.getCanonicalPath()));
        }
    }

    private C14389b A00() throws IOException {
        if (!this.A01) {
            if (this.A00 == null) {
                this.A00 = C14389b.A04(this.A02);
            }
            return this.A00;
        }
    ...
    private void A03(int i, long j) throws IOException {
        this.A00.A03[i] = j;
        this.A00.A02.seek(C14389b.A02(i));
