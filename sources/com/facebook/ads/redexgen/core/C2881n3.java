...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.n3, reason: case insensitive filesystem */
/* JADX INFO: loaded from: assets/audience_network.dex */
public final class C2881n3 implements AnonymousClass23, InterfaceC12802u {
    ...
    private final void A07(C2699k1 c2699k1, C2E c2e, AnonymousClass38 anonymousClass38, EnumSet<CacheFlag> cacheFlags, String str) {
        C12812v c12812v = new C12812v(c2699k1, anonymousClass38, this, str);
        C2S c2sA0D = c12812v.A0D();
        if (C14499m.A0u(c2699k1) && (c2sA0D instanceof AbstractC2855md) && AbstractC12591z.A06(this.A05, AbstractC12591z.A01(c2699k1, anonymousClass38.A03(), ((AbstractC2855md) c2sA0D).A1g()), c2699k1.A0A())) {
            this.A05.A0F().A4s();
            this.A02.ADV(this, AdError.NO_FILL);
        } else {
            this.A04 = c12812v;
            A08(c12812v.A0E());
            c12812v.A0J(c2699k1, cacheFlags);
        }
    }

    private void A08(BG bg) {
        if (bg.equals(BG.A04)) {
            this.A05.A0F().AIz(EnumC12511r.A05);
            return;
        }
        if (bg.equals(BG.A0A)) {
            this.A05.A0F().AIz(EnumC12511r.A04);
            return;
        }
        if (bg.equals(BG.A0B)) {
            this.A05.A0F().AIz(EnumC12511r.A0B);
            return;
        }
        if (bg.equals(BG.A0D)) {
            this.A05.A0F().AIz(EnumC12511r.A0D);
            return;
        }
        if (bg.equals(BG.A0C)) {
            this.A05.A0F().AIz(EnumC12511r.A0C);
            return;
        }
        if (!bg.equals(BG.A06)) {
            return;
        ...
        if (this.A04.A0K()) {
            this.A05.A0F().AIz(EnumC12511r.A08);
            return;
        }
        if ((A09() instanceof AbstractC2855md) && this.A04.A0L((AbstractC2855md) A09())) {
            InterfaceC12391f interfaceC12391fA0F = this.A05.A0F();
            if (A0C[1].length() == 29) {
                throw new RuntimeException();
            }
            String[] strArr = A0C;
            ...
            interfaceC12391fA0F.AIz(EnumC12511r.A0A);
            return;
        }
        this.A05.A0F().AIz(EnumC12511r.A09);
    }
    ...
    public final void A0A(C2699k1 c2699k1, C2E c2e, AnonymousClass38 anonymousClass38, EnumSet<CacheFlag> enumSet, String str, String str2, RewardData rewardData) {
        this.A05 = c2699k1;
        this.A02 = c2e;
        ...
        this.A07 = str2;
        this.A01 = rewardData;
        A07(c2699k1, c2e, anonymousClass38, enumSet, str);
    }
    ...
    public final boolean A0B() {
        ...
        AdActivityIntent adActivityIntentA05 = C1491Bq.A05(this.A05);
        ...
        BG bgA01 = A01();
        A08(bgA01);
        adActivityIntentA05.putExtra(A03(186, 8, 88), bgA01);
        if (this.A07 != null) {
        ...
        try {
            ...
            if (ProcessUtils.isRemoteRenderingProcess()) {
                if (!C1491Bq.A0I(this.A05, adActivityIntentA05)) {
                    this.A05.A0F().AHI();
                    if (this.A02 != null) {
            ...
            C1491Bq.A0B(this.A05, adActivityIntentA05);
            return true;
        } catch (C1489Bo e) {
            ...
            this.A05.A08().AAu(A03(108, 11, 27), AbstractC14128a.A0D, new C14138b(cause2));
