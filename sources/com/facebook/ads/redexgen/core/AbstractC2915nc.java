...
public abstract class AbstractC2915nc implements C1O {
    ...
    static {
        A04();
        A03 = AbstractC2915nc.class.getSimpleName();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A06(File file) throws IOException {
        C1R.A03(file);
        List<File> files = C1R.A01(file.getParentFile());
        A07(files);
    }

    @Override // com.facebook.ads.redexgen.core.C1O
    public void AJW(final File file) throws IOException {
        this.A00.submit(new Callable<Void>(file) { // from class: com.facebook.ads.redexgen.X.1S
