...
public final class C1907Sk {
    ...
    public final C1906Sj A09;

    public C1907Sk() {
        this.A09 = AbstractC2471gE.A02 >= 24 ? new C1906Sj(this.A08) : null;
    }
    ...
    public final void A02(int i, int[] iArr, int[] iArr2, byte[] bArr, byte[] bArr2, int i2, int i3, int i4) {
        ...
        if (AbstractC2471gE.A02 >= 24) {
            ((C1906Sj) AbstractC2388es.A01(this.A09)).A00(i3, i4);
        }
    }
}
