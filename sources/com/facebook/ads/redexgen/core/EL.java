...
public final class EL extends LinearLayout {
    ...
    public static final int A04 = (int) (CP.A02 * 16.0f);
    public static final int A05 = (int) (CP.A02 * 12.0f);
    public static final int A06 = (int) (CP.A02 * 12.0f);
    public static final int A03 = (int) (CP.A02 * 16.0f);

    public EL(C2699k1 c2699k1) {
        super(c2699k1);
        this.A00 = false;
        setOrientation(0);
    ...
    public void setData(String str, DB db) {
