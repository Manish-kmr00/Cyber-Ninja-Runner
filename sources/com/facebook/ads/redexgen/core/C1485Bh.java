...
public final class C1485Bh {
    public static C1485Bh A03;
    ...
    public final C1484Bg A01 = new C1484Bg();
    ...
    public C1485Bh(AnonymousClass85 anonymousClass85) {
        this.A00 = anonymousClass85;
    }

    public static C1485Bh A00(AnonymousClass85 anonymousClass85) {
        if (A03 == null) {
            A03 = new C1485Bh(anonymousClass85);
        }
        return A03;
    }
    ...
    private boolean A08(String str, String str2) {
        ...
        if (this.A02.get(str) != null) {
            ...
            if (maxLoadedAdsAllowed <= iA0I && this.A02.get(str).contains(str2)) {
                return true;
            }
        }
        return false;
    ...
    public final int A0A(String str) {
        ...
        A05[3] = "fotbcTaHfC";
        return c1484Bg.A03(anonymousClass85, strA01, 0);
    }
                ...
                try {
                    ...
                    if (!A08(str, clientToken)) {
                        ...
                        if (!jSONObject.has(strA01)) {
                            ...
                            if (System.currentTimeMillis() - jSONObject.getLong(strA01) < C14499m.A02(this.A00)) {
    ...
    public final boolean A0F(String str) {
        return !C14499m.A18(this.A00) && (str.equals(AdPlacementType.BANNER.toString()) || str.equals(AdPlacementType.MEDIUM_RECTANGLE.toString()));
    }
}
