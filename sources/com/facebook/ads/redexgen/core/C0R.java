...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.0R, reason: invalid class name */
...
public final class C0R<K> extends C4U<K, V>.SortedKeySet implements NavigableSet<K> {
    ...
    public final K pollFirst() {
        return (K) AbstractC2841mO.A05(iterator());
    }
    ...
    public final K pollLast() {
        return (K) AbstractC2841mO.A05(descendingIterator());
    }
