...
public abstract class C1T extends MG implements View.OnTouchListener {
    ...
    public C1T(C2699k1 c2699k1, AttributeSet attributeSet) {
    ...
    public C1T(C2699k1 c2699k1, AttributeSet attributeSet, int i) {
    ...
    private int A06(int i) {
        ...
        int iA8e = this.A02.A8e(delta);
        int scrollX = this.A06;
        if (delta > scrollX) {
            int scrollX2 = this.A05;
            return A08(scrollX2, iA8e);
        }
    ...
    public void setLayoutManager(AnonymousClass62 anonymousClass62) {
        if (anonymousClass62 instanceof C2771lC) {
            super.setLayoutManager(anonymousClass62);
            this.A01 = (C2771lC) anonymousClass62;
            return;
        }
