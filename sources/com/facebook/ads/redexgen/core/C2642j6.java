...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.j6, reason: case insensitive filesystem */
/* JADX INFO: loaded from: assets/audience_network.dex */
public final class C2642j6 implements A6 {
    ...
    public final C2698k0 A06;
    public final A5 A07;
    public final JR A08;
    public volatile boolean A0C;
    public final Runnable A0A = new C2644j8(this);
    public final Runnable A09 = new C2643j7(this);
    ...
    static {
        A07();
        A0F = A6.class.getSimpleName();
    }

    public C2642j6(C2698k0 c2698k0, A5 a5) {
        this.A07 = a5;
        this.A06 = c2698k0;
        this.A04 = (ConnectivityManager) c2698k0.getSystemService(A03(293, 12, 115));
        this.A08 = C1688Jj.A01(c2698k0);
        this.A03 = AbstractC14519o.A0K(c2698k0);
        this.A02 = AbstractC14519o.A0J(c2698k0);
    }

    public static /* synthetic */ int A00(C2642j6 c2642j6) {
        int i = c2642j6.A00 + 1;
        c2642j6.A00 = i;
        return i;
    }
    ...
    private void A06() {
        if (this.A00 >= AbstractC14519o.A09(this.A06)) {
            A05();
            A5r();
            return;
        }
        ...
        if (A0E[4].charAt(15) == 'm') {
            ...
            if (i == 1) {
                this.A01 = AbstractC14519o.A0I(this.A06);
            } else {
                long j = this.A01 * 2;
                String[] strArr2 = A0E;
    ...
    private void A09(JSONObject jSONObject) throws JSONException {
        Map<String, String> shortEvnData = this.A06.A04().A5Q();
    ...
    public final void A0B() throws Exception {
        try {
            ...
            this.A06.A05().AAD();
            JSONObject jSONObjectA5B = this.A07.A5B();
            if (jSONObjectA5B == null) {
                this.A06.A05().AAD();
                A05();
                return;
            }
            boolean zAAD = this.A06.A05().AAD();
            String strA03 = A03(309, 6, 43);
            if (zAAD && jSONObjectA5B.has(strA03)) {
                JSONArray jSONArray = jSONObjectA5B.getJSONArray(strA03);
            ...
            A09(jSONObject);
            jSONObjectA5B.put(A03(305, 4, 9), jSONObject);
            C1684Jf c1684Jf = new C1684Jf();
            c1684Jf.put(A03(315, 7, 6), jSONObjectA5B.toString());
            JQ jqAG5 = this.A08.AG5(this.A06.A05().A7w(), c1684Jf.A08());
            String strA6t = jqAG5 != null ? jqAG5.A6t() : null;
            if (!TextUtils.isEmpty(strA6t) && jqAG5 != null) {
                if (jqAG5.A92() != 200) {
                    if (this.A06.A05().AAD()) {
                        String responseBody = A0F;
                        Log.e(responseBody, A03(138, 48, 30) + jqAG5.A92() + A03(3, 1, 55));
                    }
                    if (jqAG5.A92() == 413 && C14499m.A2P(this.A06)) {
                        this.A07.AEk();
                        A05();
                        return;
                    } else {
                        if (jSONObjectA5B.has(strA03)) {
                            this.A07.ACt(jSONObjectA5B.getJSONArray(strA03));
                        }
                        A06();
                        return;
                    }
                }
                if (!this.A07.ACu(new JSONArray(strA6t))) {
                    if (this.A06.A05().AAD()) {
            ...
            if (C14499m.A2E(this.A06) && jSONObjectA5B.has(strA03)) {
                this.A07.ACt(jSONObjectA5B.getJSONArray(strA03));
            }
            A06();
        } catch (Exception e) {
            C2698k0 c2698k0 = this.A06;
            String[] strArr = A0E;
