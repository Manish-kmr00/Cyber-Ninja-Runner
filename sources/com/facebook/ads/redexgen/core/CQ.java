...
public final class CQ {
    ...
    public static void A01() {
        A00 = new byte[]{Ascii.ESC, 57, 54, 127, 44, 120, 60, Base64.padSymbol, 44, Base64.padSymbol, 42, 53, 49, 54, Base64.padSymbol, 120, 49, 62, 120, 57, 40, 40, 120, 49, 43, 120, Ascii.CR, 54, 49, 44, 33, 118, 55, Ascii.CR, 94, 43, Ascii.DLE, Ascii.ETB, 10, 7, 94, Ascii.US, Ascii.SO, Ascii.SO, 68, 94, 88, 84, 86, Ascii.NAK, 93, 90, 88, 94, 89, 84, 84, 80, Ascii.NAK, 73, 94, 90, 88, 79, Ascii.NAK, 105, 94, 90, 88, 79, 122, 88, 79, 82, 77, 82, 79, 66, Ascii.DC2, Ascii.RS, Ascii.FS, 95, 4, Ascii.US, Ascii.CAN, 5, 8, 66, Ascii.NAK, 95, 1, Ascii.GS, Ascii.DLE, 8, Ascii.DC4, 3, 95, 36, Ascii.US, Ascii.CAN, 5, 8, 33, Ascii.GS, Ascii.DLE, 8, Ascii.DC4, 3, 48, Ascii.DC2, 5, Ascii.CAN, 7, Ascii.CAN, 5, 8};
    }

    static {
        A01();
        A02 = CQ.class.getSimpleName();
    }
    ...
    public static boolean A05(AnonymousClass85 anonymousClass85) {
        boolean z = false;
        try {
            ...
            ActivityInfo[] activityInfoArr = packageManager.getPackageInfo(anonymousClass85.getPackageName(), 1).activities;
            ...
            boolean activityDeclared3 = anonymousClass85.A05().AAD();
