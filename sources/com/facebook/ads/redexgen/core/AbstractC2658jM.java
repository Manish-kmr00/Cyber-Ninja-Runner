...
public abstract class AbstractC2658jM<K, V> implements Map.Entry<K, V> {
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.jM != com.google.common.collect.AbstractMapEntry<K, V> */
    @Override // java.util.Map.Entry
    public boolean equals(@CheckForNull Object object) {
        ...
        if (!AbstractC1813Or.A01(getKey(), entry.getKey())) {
            return false;
        }
        V value = getValue();
        ...
        return AbstractC1813Or.A01(value, value2);
    }
