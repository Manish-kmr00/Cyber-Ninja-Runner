...
public abstract class C6F {
    ...
    public View A01;
    public AnonymousClass62 A02;
    public MG A03;
    public boolean A04;
    public boolean A05;
    public int A00 = -1;
    public final C6D A06 = new C6D(0, 0);
    ...
    public abstract void A0H(int i, int i2, C6H c6h, C6D c6d);

    public abstract void A0I(View view, C6H c6h, C6D c6d);
    ...
    public void A04(int i, int i2) {
        MG mg = this.A03;
        if (!this.A05 || this.A00 == -1 || mg == null) {
            A09();
        }
        this.A04 = false;
        if (this.A01 != null) {
            if (A00(this.A01) == this.A00) {
                A0I(this.A01, mg.A0s, this.A06);
                this.A06.A05(mg);
                A09();
            } else {
    ...
    public final AnonymousClass62 A08() {
        return this.A02;
    }
    ...
    public final void A0D(MG mg, AnonymousClass62 anonymousClass62) {
        this.A03 = mg;
