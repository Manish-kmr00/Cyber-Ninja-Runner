...
public final class C6U extends Thread {
    ...
    public C6U(C2699k1 c2699k1, C6W c6w) {
        this(c2699k1, c6w, C14499m.A08(c2699k1));
    }

    public C6U(C2699k1 c2699k1, C6W c6w, int i) {
            ...
            while (!isInterrupted()) {
                ...
                try {
                    ...
                    if (interval2 != 0 && !this.A06 && !Debug.isDebuggerConnected()) {
                        if (this.A02.A05()) {
                            this.A03.A08().AAu(A01(15, 7, 8), AbstractC14128a.A1D, new C14138b(this.A02.A04()));
                        }
                        this.A06 = true;
                    }
