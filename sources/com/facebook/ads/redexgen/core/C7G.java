...
public final class C7G {
    ...
    public C7G(C2699k1 c2699k1, AudienceNetworkActivity audienceNetworkActivity) {
        this.A02 = c2699k1;
    ...
    public final C1638Hl A03(Intent intent, RelativeLayout relativeLayout) {
        ...
        if (stringExtra != null) {
            ...
            C1638Hl c1638HlA01 = AbstractC1637Hk.A01(c2699k1, stringExtra);
            if (c1638HlA01 != null) {
                relativeLayout.addView(c1638HlA01, new RelativeLayout.LayoutParams(-1, -1));
            }
            return c1638HlA01;
        }
        return null;
    ...
    public final void A04() {
        if (C14499m.A2A(this.A01)) {
            A02(16777216, 16777216);
        }
    }

    public final void A05() {
        if (this.A00 != null && C14499m.A1A(this.A01)) {
            this.A00.A07();
        }
    }

    public final void A06() {
        if (C14499m.A2I(this.A01)) {
            A02(128, 128);
        }
    }

    public final void A07(Intent intent, BG bg, final RelativeLayout relativeLayout) {
        if (C14499m.A1A(this.A01)) {
            BG bg2 = BG.A03;
            if (A04[1].length() == 14) {
                throw new RuntimeException();
            }
            ...
            if (bg != bg2) {
                ...
                final F9 f11 = this.A00;
                View.OnLongClickListener onLongClickListener = new View.OnLongClickListener(f11, relativeLayout) { // from class: com.facebook.ads.redexgen.X.6q
                    ...
                    public final boolean onLongClick(View view) {
                        if (this.A01 != null && this.A00 != null) {
                            ...
                            A02[7] = "";
                            f12.setBounds(0, 0, width, relativeLayout2.getHeight());
    ...
    public final void A08(BG bg, boolean z) {
