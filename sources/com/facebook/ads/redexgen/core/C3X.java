...
public abstract class C3X {
    ...
    public static Bundle A00(AnonymousClass85 anonymousClass85) {
        ...
        String strA06 = A06(Sdk.SDKError.Reason.INVALID_RI_ENDPOINT_VALUE, 19, 81);
    ...
    public static Bundle A02(String str, C2812lu c2812lu) {
        Bundle bundle = new Bundle();
        A08(bundle, c2812lu.A05());
        bundle.putString(A06(451, 17, 16), c2812lu.A0A());
        bundle.putString(A06(259, 13, 76), str);
        bundle.putString(A06(292, 19, 18), c2812lu.A07());
        bundle.putString(A06(366, 19, 0), c2812lu.A08());
        bundle.putString(A06(404, 22, 98), c2812lu.A09());
        bundle.putString(A06(385, 19, 96), C3T.A01(c2812lu.A0B()));
        RewardData rewardDataA03 = c2812lu.A03();
        if (rewardDataA03 != null) {
            C3Y.A00(bundle, rewardDataA03);
        }
        C2699k1 c2699k1A05 = c2812lu.A05();
        if (A01[7].charAt(1) != 'G') {
            throw new RuntimeException();
        }
        String[] strArr = A01;
        ...
        bundle.putBundle(A06(Sdk.SDKError.Reason.INVALID_RI_ENDPOINT_VALUE, 19, 81), A01(c2699k1A05));
        return bundle;
    }

    public static Bundle A03(String str, C2800li c2800li) {
        Bundle bundle = new Bundle();
        A08(bundle, c2800li.A0B);
        bundle.putString(A06(451, 17, 16), c2800li.A0D);
        bundle.putString(A06(259, 13, 76), str);
        bundle.putString(A06(292, 19, 18), c2800li.A05);
        bundle.putString(A06(366, 19, 0), c2800li.A06);
        bundle.putString(A06(404, 22, 98), c2800li.A07);
        AdExperienceType adExperienceType = c2800li.A02;
        if (adExperienceType != null) {
            bundle.putString(A06(237, 22, 24), C3S.A02(adExperienceType));
        }
        bundle.putBoolean(A06(90, 33, 27), c2800li.A08);
        RewardData rewardData = c2800li.A03;
        if (rewardData != null) {
            C3Y.A00(bundle, rewardData);
        }
        bundle.putBundle(A06(Sdk.SDKError.Reason.INVALID_RI_ENDPOINT_VALUE, 19, 81), A01(c2800li.A0B));
        return bundle;
    }

    public static C2812lu A04(C2699k1 c2699k1, Bundle bundle, String str) {
        ...
        C2812lu c2812lu = new C2812lu(c2699k1, null, string, new C2807lp(str, string4, bundle2));
        c2812lu.A0I(string3);
        c2812lu.A0H(string2);
        c2812lu.A0J(sdkVersion);
        String placement6 = A06(385, 19, 96);
        c2812lu.A0K(C3T.A02(bundle.getString(placement6)));
        RewardData rewardDataA01 = C3Y.A01(bundle);
        if (rewardDataA01 != null) {
            c2812lu.A0F(rewardDataA01);
        }
        return c2812lu;
    }

    public static C2800li A05(C2699k1 c2699k1, Bundle bundle, String str) {
        String string = bundle.getString(A06(451, 17, 16));
        ...
        C2800li c2800li = new C2800li(c2699k1, string, null, new C2807lp(str, string4, bundle2));
        c2800li.A06 = adExperienceType;
        c2800li.A05 = string2;
        c2800li.A08 = z;
        c2800li.A02 = C3S.A00(string3);
        c2800li.A07 = mediationData;
        RewardData rewardDataA01 = C3Y.A01(bundle);
        if (rewardDataA01 != null) {
            c2800li.A03 = rewardDataA01;
        }
        return c2800li;
    }
    ...
    public static void A08(Bundle bundle, AnonymousClass85 anonymousClass85) {
        ...
        boolean zAAI = false;
        boolean isForcedFunnelLogging = anonymousClass85 instanceof C2699k1;
        if (isForcedFunnelLogging) {
            zAAI = ((C2699k1) anonymousClass85).A0F().AAI();
        }
        boolean isForcedFunnelLogging2 = C8U.A0I(anonymousClass85);
        bundle.putBoolean(A06(33, 21, 55), isForcedFunnelLogging2 || zAAI);
        bundle.putString(A06(330, 14, 30), anonymousClass85.getPackageName());
        boolean isForcedFunnelLogging3 = AbstractC14529p.A0D(anonymousClass85);
        if (isForcedFunnelLogging3) {
            bundle.putString(A06(311, 19, 51), new C13967j().A03(anonymousClass85));
        }
    }
}
