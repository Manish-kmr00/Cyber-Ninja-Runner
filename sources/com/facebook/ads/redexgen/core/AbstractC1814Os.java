...
public abstract class AbstractC1814Os implements InterfaceC2590iE<Character> {
    ...
    /* JADX WARN: Type inference failed for: r0v0, types: [com.facebook.ads.redexgen.X.0l] */
    public static C12200l A02(final char match) {
        return new AbstractC13134b(match) { // from class: com.facebook.ads.redexgen.X.0l
            ...
            public final String toString() {
                return A00(2, 16, 41) + AbstractC1814Os.A04(this.A00) + A00(0, 2, 99);
            }
        };
    }

    public static AbstractC1814Os A03() {
        AbstractC1814Os abstractC1814Os = C0S.A01;
        if (A01[1].charAt(7) == 'R') {
            throw new RuntimeException();
        }
        A01[1] = "RCT2CzV9IWXJqUHkaSW8fbkoFpPJrj9F";
        return abstractC1814Os;
    }
