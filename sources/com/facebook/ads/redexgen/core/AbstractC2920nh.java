...
public abstract class AbstractC2920nh {
    ...
    public static final <T> void A02(Appendable appendable, T t, NT<? super T, ? extends CharSequence> nt) throws IOException {
        C2923nk.A09(appendable, A00(0, 6, 22));
        if (nt != null) {
            appendable.append(nt.AA9(t));
            return;
        }
