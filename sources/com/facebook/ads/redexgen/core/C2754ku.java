...
public class C2754ku<K, V> extends AbstractSet<Map.Entry<K, V>> {
    ...
    public C2754ku(final C2758ky this$0) {
        this.A00 = this$0;
    }
    ...
    public final boolean contains(@CheckForNull Object o) {
        ...
        return iA07 != -1 && AbstractC1813Or.A01(this.A00.A0F(iA07), entry.getValue());
    }
    ...
    public final boolean remove(@CheckForNull Object o) {
        ...
        Map.Entry entry = (Map.Entry) o;
        if (this.A00.A0p() || (iA06 = AbstractC2760l1.A06(entry.getKey(), entry.getValue(), (iA00 = this.A00.A00()), this.A00.A0C(), this.A00.A0T(), this.A00.A0V(), this.A00.A0W())) == -1) {
            return false;
        }
