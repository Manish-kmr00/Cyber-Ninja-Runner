...
public final class C2638j2 implements A5 {
    ...
    static {
        A05();
        A04 = C2638j2.class.getSimpleName();
    }

    public C2638j2(C2698k0 c2698k0, InterfaceC2667jV interfaceC2667jV) {
        this.A00 = c2698k0;
        this.A01 = interfaceC2667jV;
    }

    public static JSONArray A01(C2698k0 c2698k0, JSONArray jSONArray, JSONArray jSONArray2) {
        int i = 0;
        if (jSONArray != null) {
        ...
        return A02(c2698k0, jSONArray, jSONArray2, i);
    }

    public static JSONArray A02(C2698k0 c2698k0, JSONArray jSONArray, JSONArray jSONArray2, int i) {
        if (jSONArray == null) {
            return jSONArray2;
        }
        if (jSONArray2 == null) {
    ...
    private JSONObject A03() {
        ...
        JSONObject jSONObjectA6j = this.A01.A6j();
        JSONArray jSONArrayA6i = this.A01.A6i();
        if (AbstractC14519o.A0P(this.A00) && (jSONArrayA03 = C14148c.A03(this.A00)) != null && jSONArrayA03.length() > 0) {
            C2698k0 c2698k0 = this.A00;
            if (A03[2].length() != 5) {
                throw new RuntimeException();
            }
            String[] strArr = A03;
            ...
            jSONArrayA6i = A01(c2698k0, jSONArrayA03, jSONArrayA6i);
        }
        JSONObject jSONObject = null;
        String[] strArr2 = A03;
        if (strArr2[4].charAt(22) != strArr2[7].charAt(22)) {
            ...
            if (jSONArrayA6i != null) {
                try {
                    jSONObject = new JSONObject();
                    if (jSONObjectA6j != null) {
                        jSONObject.put(A00(439, 6, 2), jSONObjectA6j);
                    }
                    jSONObject.put(A00(387, 6, 47), jSONArrayA6i);
                } catch (JSONException unused) {
                    return null;
                }
            }
        } else if (jSONArrayA6i != null) {
            jSONObject = new JSONObject();
            if (jSONObjectA6j != null) {
                jSONObject.put(A00(439, 6, 2), jSONObjectA6j);
            }
    ...
    private JSONObject A04(int i) {
        ...
        Pair<JSONObject, JSONArray> tokensAndEvents = this.A01.A98(i);
        JSONObject jSONObject = (JSONObject) tokensAndEvents.first;
        JSONArray jSONArrayA02 = (JSONArray) tokensAndEvents.second;
        if (AbstractC14519o.A0P(this.A00) && (jSONArrayA04 = C14148c.A04(this.A00, (iA08 = AbstractC14519o.A08(this.A00)))) != null && jSONArrayA04.length() > 0) {
    ...
    public final JSONObject A5B() {
        int eventLimit = AbstractC14519o.A0F(this.A00);
        return eventLimit > 0 ? A04(eventLimit) : A03();
    }

    @Override // com.facebook.ads.redexgen.core.A5
    public final boolean AAQ() {
        int eventCount = AbstractC14519o.A0F(this.A00);
        if (eventCount < 1) {
            return false;
        }
        int iA7s = this.A01.A7s();
        int eventLimit = C14148c.A00(this.A00);
        return iA7s + eventLimit > eventCount;
    }

    @Override // com.facebook.ads.redexgen.core.A5
    public final void ACC() {
        int iA4q = this.A01.A4q(AbstractC14519o.A0G(this.A00));
        if (iA4q > 0) {
            this.A00.A08().AAu(A00(379, 8, 37), AbstractC14128a.A10, new C14138b(A00(28, 44, 62) + iA4q));
        }
        C14148c.A0F(this.A00);
    }
    ...
    public final boolean ACu(JSONArray jSONArray) {
        ...
        boolean z = true;
        boolean zA0P = AbstractC14519o.A0P(this.A00);
        for (int errorCode = 0; errorCode < jSONArray.length(); errorCode++) {
            try {
                ...
                if (A00(393, 26, 39).equals(eventId)) {
                    C14499m.A0U(this.A00).A2w(jSONObject.getString(A00(419, 14, 16)));
                    this.A00.A04().ABl();
                } else {
                    ...
                    if (i == 1) {
                        if (this.A00.A05().AAD()) {
                            ...
                            String strA7v = this.A01.A7v(eventId);
                            if (strA7v != null) {
                                String str2 = A00(72, 36, 104) + strA7v;
                            }
                        }
                        if (!this.A01.A5g(eventId) && zA0P) {
                            C14148c.A0D(eventId);
                        }
                    } else {
                        String[] strArr = A03;
                        ...
                        String strA01 = A00(0, 13, 50);
                        if (i >= 1000 && i < 2000) {
                            if (this.A00.A05().AAD()) {
                                Log.e(A04, A00(236, 37, 69) + i + strA01 + eventId + strA00);
                            }
                            A06(eventId);
                            z = false;
                        } else if (i >= 2000) {
                            if (A03[5].length() == 16) {
                                ...
                                if (i < 3000) {
                                    if (this.A00.A05().AAD()) {
                                        Log.e(A04, A00(195, 41, 103) + i + strA01 + eventId + strA00);
                                    }
                                    if (this.A01.A5g(eventId)) {
                                    }
                                }
                            } else if (i < 3000) {
                                if (this.A00.A05().AAD()) {
