...
public final class C6 {
    ...
    public static int A00(C2699k1 c2699k1, int i) {
        return BJ.A00(c2699k1).getInt(A01(0, 21, 52), i);
    }

    public static String A02(C2699k1 c2699k1, String str) {
        int iA00 = A00(c2699k1, -1);
        if (iA00 == -1) {
            return null;
        }
        try {
    ...
    public final InterstitialAd A06(C2699k1 c2699k1, String str, String str2) {
        if (c2699k1 == null) {
            return null;
        }
        try {
            InterstitialAd interstitialAd = new InterstitialAd(c2699k1, str);
    ...
    public final RewardedVideoAd A07(C2699k1 c2699k1, String str, String str2) {
        if (c2699k1 == null) {
            return null;
        }
        try {
            RewardedVideoAd rewardedVideoAd = new RewardedVideoAd(c2699k1, str);
    ...
    public final void A08(C2699k1 c2699k1, boolean z) {
        int i = 0;
        String strA01 = A01(0, 21, 52);
        if (!z) {
            int lastNonChainedAds = BJ.A00(c2699k1).getInt(strA01, 0);
            i = lastNonChainedAds + 1;
        }
        BJ.A00(c2699k1).edit().putInt(strA01, i).apply();
    }

    public final boolean A09(C2699k1 c2699k1, String str, int i) {
        if (i <= 0) {
            return false;
        }
        try {
            if (!A05(str)) {
                int lastNonChainedAds = A00(c2699k1, i - 1);
