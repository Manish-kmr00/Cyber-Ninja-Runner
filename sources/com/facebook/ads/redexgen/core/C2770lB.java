...
public class C2770lB extends C6F {
    ...
    private final int A03(View view, int i) {
        ...
        if (anonymousClass62A08 == null || !anonymousClass62A08.A21()) {
            return 0;
        }
        AnonymousClass63 anonymousClass63 = (AnonymousClass63) view.getLayoutParams();
        return A0N(anonymousClass62A08.A0o(view) - anonymousClass63.topMargin, anonymousClass62A08.A0j(view) + anonymousClass63.bottomMargin, anonymousClass62A08.A0g(), anonymousClass62A08.A0X() - anonymousClass62A08.A0d(), i);
    }
    ...
    public int A0O(View view, int i) {
        AnonymousClass62 anonymousClass62A08 = A08();
        if (anonymousClass62A08 == null || !anonymousClass62A08.A20()) {
            return 0;
        }
        AnonymousClass63 anonymousClass63 = (AnonymousClass63) view.getLayoutParams();
        return A0N(anonymousClass62A08.A0k(view) - anonymousClass63.leftMargin, anonymousClass62A08.A0n(view) + anonymousClass63.rightMargin, anonymousClass62A08.A0e(), anonymousClass62A08.A0h() - anonymousClass62A08.A0f(), i);
    }
    ...
    public C2770lB(Context context) {
    ...
    private final void A07(C6D c6d) {
        ...
        c6d.A04(i, i2, time2, this.A05);
    }

    @Override // com.facebook.ads.redexgen.core.C6F
    ...
    @Override // com.facebook.ads.redexgen.core.C6F
    public final void A0H(int i, int i2, C6H c6h, C6D c6d) {
        if (A06() == 0) {
            A09();
            if (A07[2].length() != 19) {
                throw new RuntimeException();
    ...
    @Override // com.facebook.ads.redexgen.core.C6F
    public void A0I(View view, C6H c6h, C6D c6d) {
        ...
        if (time > 0) {
            int distance = -iA0O;
            int dy2 = -iA03;
            c6d.A04(distance, dy2, time, this.A04);
        }
    }
    ...
    public PointF A0P(int i) {
        Object objA08 = A08();
        if (objA08 instanceof C6E) {
            return ((C6E) objA08).A4w(i);
        }
        Log.w(A04(0, 20, 26), A04(20, 93, 94) + C6E.class.getCanonicalName());
        return null;
    }
}
