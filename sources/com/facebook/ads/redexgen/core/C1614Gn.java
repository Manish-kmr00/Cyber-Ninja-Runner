...
public class C1614Gn extends WebViewClient {
    ...
    public final /* synthetic */ C1618Gr A00;
    ...
    public C1614Gn(C1618Gr c1618Gr) {
        this.A00 = c1618Gr;
    }
    ...
    private void A02(int i, String str, String str2, boolean z) {
        ...
        this.A00.A0B.A0F().A64(string);
        this.A00.A0E.A04(AbstractC14128a.A16, string);
    }

    @Override // android.webkit.WebViewClient
    public final void onPageFinished(WebView webView, String str) {
        this.A00.A0D.A04(AE.A0R, null);
        this.A00.A0B.A0F().A65(C1517Cu.A01(this.A00.A00));
        this.A00.A0S();
        this.A00.A06 = true;
        this.A00.A0E();
    ...
    public final boolean onRenderProcessGone(WebView webView, RenderProcessGoneDetail renderProcessGoneDetail) {
        ...
        String string = jSONObject.toString();
        C2699k1 c2699k1 = this.A00.A0B;
        String message = A02[5];
        if (message.charAt(10) == 'q') {
            A02[3] = "cKmn9F08G0LbJgt48cswTZGSotGQ5jj";
            c2699k1.A0F().A60(string);
            AbstractC1619Gs.A04(this.A00.A09.A0r());
    ...
    public final WebResourceResponse shouldInterceptRequest(WebView webView, WebResourceRequest webResourceRequest) {
        return H2.A00(this.A00.A0B, this.A00.A0A, webResourceRequest, this.A00.A0H, this.A00.A09.A16());
    }
}
