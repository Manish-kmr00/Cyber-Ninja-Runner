...
public abstract class AbstractC13043s extends FrameLayout {
    public int A00;
    public int A01;
    public boolean A02;
    public boolean A03;
    ...
    public final InterfaceC13053t A06;
    ...
    public static final InterfaceC13063u A0A = new C2788lW();
     ...
     */
    public AbstractC13043s(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        this.A04 = new Rect();
        this.A05 = new Rect();
        this.A06 = new C2790lY(this);
        ...
        this.A01 = 0;
        this.A00 = 0;
        A0A.AA6(this.A06, context, colorStateListValueOf, 10.0f, 10.0f, f);
    }
    ...
    public AbstractC13043s(Context context) {
        this(context, null);
    }

    public AbstractC13043s(Context context, AttributeSet attributeSet) {
    ...
    public final void onMeasure(int i, int i2) {
        if (!(A0A instanceof C2788lW)) {
            ...
            switch (mode2) {
                case Integer.MIN_VALUE:
                case 1073741824:
                    i2 = View.MeasureSpec.makeMeasureSpec(Math.max((int) Math.ceil(A0A.A8N(this.A06)), View.MeasureSpec.getSize(i2)), mode2);
                    break;
            }
    ...
    public void setCardBackgroundColor(int i) {
        A0A.AIP(this.A06, ColorStateList.valueOf(i));
    }
