...
public final class C2F extends BroadcastReceiver {
    ...
    public C2F(C2699k1 c2699k1, String str, C2881n3 c2881n3, C2E c2e) {
        this.A02 = c2699k1;
        this.A03 = str;
        this.A01 = c2e;
        this.A00 = c2881n3;
    ...
    public final void onReceive(Context context, Intent intent) {
        ...
        if (intentAction6.equals(str)) {
            this.A01.ADW(this.A00);
            return;
        }
        String intentAction7 = A00(331, 35, 104);
        if (intentAction7.equals(str)) {
            if (C14499m.A1r(context)) {
                this.A01.ADV(this.A00, AdError.AD_PRESENTATION_ERROR);
                return;
            } else {
                this.A01.ADV(this.A00, AdError.INTERNAL_ERROR);
                return;
            }
        }
