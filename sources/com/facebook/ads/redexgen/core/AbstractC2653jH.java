...
public abstract class AbstractC2653jH<T> implements Iterator<T> {
    ...
    public Iterator<V> A02 = AbstractC2841mO.A02();
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.jH != com.google.common.collect.AbstractMapBasedMultimap<K, V>$Itr<T> */
    public AbstractC2653jH(final C4U this$0) {
        this.A04 = this$0;
    ...
    public final T next() {
        ...
        return A00(AbstractC2907nT.A01(this.A00), this.A02.next());
    }
