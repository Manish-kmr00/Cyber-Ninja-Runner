...
public class C1802Oe<K, V> extends AbstractC2879n1<K, Collection<V>> {
    public final transient Map<K, Collection<V>> A00;
    public final /* synthetic */ C4U A01;

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Oe != com.google.common.collect.AbstractMapBasedMultimap<K, V>$AsMap */
    public C1802Oe(final C4U this$0, Map<K, Collection<V>> submap) {
        this.A01 = this$0;
        this.A00 = submap;
    }
    ...
    public final Collection<V> get(@CheckForNull Object key) {
        Collection<V> collection = (Collection) AbstractC2880n2.A05(this.A00, key);
        if (collection == null) {
            return null;
        }
    ...
    public final Collection<V> remove(@CheckForNull Object key) {
        ...
        C4U.A03(this.A01, collectionRemove.size());
        collectionRemove.clear();
        return collectionA0D;
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Oe != com.google.common.collect.AbstractMapBasedMultimap<K, V>$AsMap */
    @Override // com.facebook.ads.redexgen.core.AbstractC2879n1
    public final Set<Map.Entry<K, Collection<V>>> A09() {
        return new O2<K, Collection<V>>() { // from class: com.facebook.ads.redexgen.X.4Y
            ...
            /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.4Y != com.google.common.collect.AbstractMapBasedMultimap<K, V>$AsMap$AsMapEntries */
            @Override // com.facebook.ads.redexgen.core.O2
            ...
            public final boolean contains(@CheckForNull Object o) {
                return AbstractC2753kt.A03(this.A00.A00.entrySet(), o);
            }

            /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.4Y != com.google.common.collect.AbstractMapBasedMultimap<K, V>$AsMap$AsMapEntries */
            @Override // java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, java.util.Set
            public final Iterator<Map.Entry<K, Collection<V>>> iterator() {
                return new C2652jG(this.A00);
            }
            ...
            public final boolean remove(@CheckForNull Object o) {
                ...
                C1802Oe c1802Oe = this.A00;
                if (A01[2].length() == 19) {
                    throw new RuntimeException();
                }
                A01[3] = "G2qcJwlII5HIikaXRsYLysr3qmkTj7oM";
                c1802Oe.A01.A0A(entry.getKey());
                return true;
            }
        };
    }
    ...
    public final Map.Entry<K, Collection<V>> A0A(Map.Entry<K, Collection<V>> entry) {
        K key = entry.getKey();
        return AbstractC2880n2.A01(key, this.A01.A0F(key, entry.getValue()));
    }
    ...
    public final void clear() {
        if (this.A00 == this.A01.A01) {
            ...
            AbstractC2841mO.A0A(new C2652jG(this));
        }
    }
    ...
    public final boolean containsKey(@CheckForNull Object key) {
        return AbstractC2880n2.A0C(this.A00, key);
    }
