...
public final class C2496ge extends F1 {
    ...
    static {
        A06();
        A0H = C2496ge.class.getSimpleName();
    }

    public C2496ge(C2699k1 c2699k1, WeakReference<F4> weakReference, int i, String str) {
        this(c2699k1, weakReference, i, false);
        if (C14499m.A1s(c2699k1)) {
            c2699k1.A02().A0B().AJt(this, str == null ? A04(0, 0, 91) : str, false, true);
            this.A06 = true;
        }
    }

    public C2496ge(C2699k1 c2699k1, WeakReference<F4> weakReference, int i, boolean z) {
        super(c2699k1);
        ...
        this.A01 = new C1518Cv();
        this.A05 = true;
        this.A06 = false;
        this.A09 = c2699k1;
        this.A04 = z;
        this.A0A = weakReference;
        this.A02 = new C2509gr(this);
        this.A03 = new JL(this, i, new WeakReference(this.A02), this.A09);
    ...
    public final void A0F() {
        this.A09.A0F().AJv();
        this.A0B.set(true);
        new Handler(Looper.getMainLooper()).post(new C2498gg(this.A03));
    }
