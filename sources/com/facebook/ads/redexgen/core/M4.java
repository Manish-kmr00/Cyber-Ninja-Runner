...
public class M4 extends AbstractC2695jx<String> {
    ...
    public M4(C8E c8e, String str, String str2, int i, double d, double d2, String str3, Map map) {
        this.A03 = c8e;
        this.A06 = str;
        this.A05 = str2;
        this.A02 = i;
    ...
    @Override // com.facebook.ads.redexgen.core.C8H
    /* JADX INFO: renamed from: A00, reason: merged with bridge method [inline-methods] */
    public final String A03() {
        String eventId = A01(0, 8, 90);
        this.A03.A01.A08().A9t(this.A06);
            ...
            try {
                ...
                if (sQLiteDatabaseA0E != null && sQLiteDatabaseA0E.isOpen()) {
                    try {
                        ...
                        this.A03.A01.A08().AAu(eventId, AbstractC14128a.A0z, new C14138b(e));
                    }
                }
                C8E.A07.unlock();
                return strA0E;
                ...
                A01(C8G.A05);
                this.A03.A01.A08().AAu(eventId, AbstractC14128a.A0y, new C14138b(e2));
                if (sQLiteDatabaseA0E != null && sQLiteDatabaseA0E.isOpen()) {
                    try {
                        if (sQLiteDatabaseA0E.inTransaction()) {
                            sQLiteDatabaseA0E.endTransaction();
                        ...
                        this.A03.A01.A08().AAu(eventId, AbstractC14128a.A0z, new C14138b(e3));
                    }
                }
                C8E.A07.unlock();
                return null;
            ...
            if (sQLiteDatabaseA0E != null) {
                ...
                if (zIsOpen) {
                    try {
                        ...
                        this.A03.A01.A08().AAu(eventId, AbstractC14128a.A0z, new C14138b(e4));
                    }
                }
            }
            C8E.A07.unlock();
