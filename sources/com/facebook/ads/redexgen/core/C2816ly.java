...
public final class C2816ly implements C3G {
    ...
    static {
        A0A();
        A0A = C2816ly.class.getSimpleName();
    }

    public C2816ly(C2812lu c2812lu, C3W c3w, String str) {
        this.A08 = c2812lu;
        this.A06 = c2812lu.A05();
        this.A07 = new C2798lg(str, c3w, this);
    }
    ...
    public final void A0G(EnumSet<CacheFlag> cacheFlags, String str) {
        ...
        this.A05 = false;
        if (this.A04 && !C14499m.A0h(this.A06)) {
            this.A06.A08().AAu(A09(130, 3, 68), AbstractC14128a.A0L, new C14138b(A09(78, 52, 22)));
            AdErrorType adErrorType = AdErrorType.LOAD_CALLED_WHILE_SHOWING_AD;
            this.A06.A0F().A3D(C1517Cu.A01(this.A00), adErrorType.getErrorCode(), adErrorType.getDefaultErrorMessage());
            this.A07.onError(this.A08.A6a(), new AdError(adErrorType.getErrorCode(), adErrorType.getDefaultErrorMessage()));
            return;
        }
        if (this.A03 != null) {
            this.A03.A0S(new C2820m3(this));
            this.A03.A0N();
            this.A03.A0K();
            this.A03 = null;
        }
        AnonymousClass37 anonymousClass37 = new AnonymousClass37(this.A08.A0A(), AbstractC1473An.A00(this.A06.getResources().getDisplayMetrics()), AdPlacementType.INTERSTITIAL, EnumC1470Aj.A08, 1, cacheFlags, this.A08.A06());
        if (C14499m.A2W(this.A06) && (strA02 = C6.A02(this.A06, this.A08.A08())) != null) {
            this.A08.A0I(strA02);
        }
        anonymousClass37.A06(this.A08.A08());
        anonymousClass37.A07(this.A08.A09());
        anonymousClass37.A04(this.A08.A03());
        this.A03 = new C1766Mr(this.A06, anonymousClass37);
        this.A03.A0S(new C2818m0(this));
        this.A03.A0W(str);
    }
    ...
    public final boolean A0J() {
        ...
        if (!this.A05) {
            this.A06.A0F().A3D(C1517Cu.A01(this.A00), adError.getErrorCode(), adError.getErrorMessage());
            this.A07.onError(this.A08.A6a(), adError);
            return false;
        }
        if (this.A03 == null) {
            this.A06.A08().AAu(A09(130, 3, 68), AbstractC14128a.A0S, new C14138b(AdErrorType.INTERSTITIAL_CONTROLLER_IS_NULL.getDefaultErrorMessage()));
            this.A06.A0F().A3D(C1517Cu.A01(this.A00), adError.getErrorCode(), adError.getErrorMessage());
            this.A07.onError(this.A08.A6a(), adError);
            return false;
        }
