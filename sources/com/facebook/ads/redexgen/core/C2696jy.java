...
public final class C2696jy extends C8I {
    ...
    static {
        A04();
        A03 = new C8C(0, A00(170, 8, 107), A00(143, 16, 18));
        A02 = new C8C(1, A00(165, 5, 19), A00(139, 4, 34));
        A04 = new C8C[]{A03, A02};
        A08 = C2696jy.class.getSimpleName();
        C8C[] c8cArr = A04;
        String strA00 = A00(178, 6, 85);
        A06 = C8I.A02(strA00, c8cArr);
        A07 = C8I.A03(strA00, A04, A02);
        A05 = A00(5, 71, 80) + A03.A01 + A00(0, 3, 56) + A00(159, 6, 69) + A00(4, 1, 103) + C2697jz.A09.A01 + A00(3, 1, 99);
    }

    public C2696jy(C8E c8e) {
        super(c8e);
    }
    ...
    public final void A0D(C2698k0 c2698k0) {
        try {
            A05().execSQL(A05);
        } catch (SQLException e) {
            C8A c8aA05 = c2698k0.A05();
