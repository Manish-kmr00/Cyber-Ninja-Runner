...
public abstract class AbstractC1682Jd {
    ...
    public AbstractC1682Jd(String str, C1684Jf c1684Jf, JZ jz) {
        this.A03 = A00(0, 0, 34);
        if (str != null) {
            this.A03 = str;
        }
        if (c1684Jf != null && !c1684Jf.A06().isEmpty()) {
            this.A03 += A00(0, 1, 55) + c1684Jf.A06();
        }
        this.A00 = jz;
    }
