...
public abstract class AbstractC2795ld<E> extends AbstractCollection<E> implements Serializable {
    ...
    public final <T> T[] toArray(T[] tArr) {
        AbstractC2589iD.A04(tArr);
        int size = size();
        if (tArr.length < size) {
            Object[] objArrA0L = A0L();
            if (objArrA0L != null) {
                return (T[]) AbstractC2914nb.A02(objArrA0L, A0H(), A0G(), tArr);
            }
            tArr = (T[]) AbstractC2908nU.A05(tArr, size);
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.ld != com.google.common.collect.ImmutableCollection<E> */
    public int A0G() {
