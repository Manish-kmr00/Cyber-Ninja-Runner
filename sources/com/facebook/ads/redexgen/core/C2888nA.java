...
public class C2888nA extends BY {
    ...
    public C2888nA(C2A c2a, String str) {
        this.A00 = c2a;
        this.A01 = str;
    }
    ...
    public final void A05() {
        String strA01 = A01(0, 17, 81);
        try {
            this.A00.A06.await();
            if (this.A00.A0J(this.A01)) {
                ((C12662g) this.A00.A02.A05().get(this.A01)).A04((int) (System.currentTimeMillis() / 1000));
                this.A00.A02.A07(this.A01);
                this.A00.A02.A06();
                this.A00.A08();
            }
        } catch (InterruptedException e) {
            this.A00.A03.A08().AAu(strA01, AbstractC14128a.A1B, new C14138b(e));
        } catch (JSONException e2) {
            this.A00.A0M();
            this.A00.A03.A08().AAu(strA01, AbstractC14128a.A1A, new C14138b(e2));
        }
    }
}
