...
public final class GP extends RelativeLayout {
    ...
    public final C1581Fg A01;

    public GP(C2699k1 c2699k1, View view) {
        super(c2699k1);
        this.A00 = view;
        this.A01 = new C1581Fg(c2699k1);
        D3.A0I(this.A01);
    }
     ...
     */
    public final void A01(C1586Fl c1586Fl, boolean z) {
        ...
        if (c1586Fl != null) {
            if (z) {
                ...
                c1586Fl.setAlignment(3);
                layoutParams2.setMargins(AbstractC1594Ft.A07 / 2, AbstractC1594Ft.A07 / 2, AbstractC1594Ft.A07 / 2, AbstractC1594Ft.A07 / 2);
                linearLayout.addView(c1586Fl, layoutParams2);
                ...
                insideLayoutParams.setMargins(0, AbstractC1594Ft.A07, 0, 0);
                c1586Fl.setAlignment(17);
                addView(c1586Fl, insideLayoutParams);
            }
        }
