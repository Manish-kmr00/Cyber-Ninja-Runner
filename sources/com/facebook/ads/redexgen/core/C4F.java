...
public class C4F<K, V> {
    ...
    public int[] A01 = AnonymousClass45.A01;
    public Object[] A02 = AnonymousClass45.A03;
    public int A00 = 0;
    ...
    */
    public final V A0A(int r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C4F.A0A(int):java.lang.Object");
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof C4F) {
            ...
            for (int i = 0; i < this.A00; i++) {
                try {
                    K kA09 = A09(i);
                    V vA0B = A0B(i);
                    Object obj2 = c4f.get(kA09);
                    if (vA0B == null) {
                        if (obj2 == null && c4f.containsKey(kA09)) {
                        }
                        return false;
                    }
                    if (!vA0B.equals(obj2)) {
        ...
        for (int i2 = 0; i2 < this.A00; i2++) {
            try {
                K kA010 = A09(i2);
                V vA0B2 = A0B(i2);
                Object obj3 = map.get(kA010);
                if (vA0B2 == null) {
                    if (obj3 == null && map.containsKey(kA010)) {
                    }
                    return false;
                }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.4F != com.facebook.ads.internal.androidx.support.v4.util.SimpleArrayMap<K, V> */
    ...
    public static int A02(int[] iArr, int i, int i2) {
        try {
            return AnonymousClass45.A02(iArr, i, i2);
    ...
    public final void clear() {
        if (this.A00 > 0) {
            ...
            Object[] objArr = this.A02;
            int i = this.A00;
            int[] ohashes = AnonymousClass45.A01;
            this.A01 = ohashes;
            this.A02 = AnonymousClass45.A03;
            this.A00 = 0;
            A06(iArr, objArr, i);
        }
        if (this.A00 <= 0) {
