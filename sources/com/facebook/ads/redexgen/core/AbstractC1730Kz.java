...
public abstract class AbstractC1730Kz {
    ...
    public static int A0F(@Nullable StringBuilder sb, @Nullable String str, Object... objArr) {
        ...
        for (Object obj : objArr) {
            int length = A0E(sb, str, iA01, obj, !z);
            if (length == -1) {
                return -1;
            }
            if (argsWasEmpty) {
        ...
        int segIdx2 = A0B(sb, str, iA01, i, argsWasEmpty);
        return segIdx2;
    }
    ...
    public static String A0K(@Nullable String str, Object... objArr) {
        try {
            return String.format(null, str, (Object[]) L8.A00(objArr, A0G(2, 45, Sdk.SDKError.Reason.INVALID_LOG_ERROR_ENDPOINT_VALUE)));
