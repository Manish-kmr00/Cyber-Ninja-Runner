...
public abstract class AbstractC2925nm {
    ...
    public static final Object[] A02(Collection<?> collection) {
        C2923nk.A09(collection, A00(0, 10, 17));
        ...
        while (true) {
            ...
            if (i >= length) {
                ...
                C2923nk.A08(objArrCopyOf, strA00);
            } else if (!it.hasNext()) {
                Object[] objArrCopyOf2 = Arrays.copyOf(objArrCopyOf, i);
                C2923nk.A08(objArrCopyOf2, strA00);
                ...
                if (!it.hasNext()) {
                    ...
                    if (size$iv != $i$f$toArrayImpl2) {
                        ...
                        if (size <= length) {
                            ...
                            C2923nk.A07(objNewInstance, A00(21, 62, 11));
                            objArrCopyOf = (Object[]) objNewInstance;
                        }
                        int i$iv = 0;
                        while (true) {
                            i$iv++;
                            objArrCopyOf[i$iv] = it.next();
