...
public class ViewOnClickListenerC2616ig implements View.OnClickListener, View.OnLongClickListener, View.OnTouchListener, AnonymousClass80 {
    ...
    public static void A02() {
        A02 = new byte[]{101, SignedBytes.MAX_POWER_OF_TWO, 4, 71, 69, 74, 74, 75, 80, 4, 70, 65, 4, 71, 72, 77, 71, 79, 65, SignedBytes.MAX_POWER_OF_TWO, 4, 70, 65, 66, 75, 86, 65, 4, 77, 80, 4, 77, 87, 4, 82, 77, 65, 83, 65, SignedBytes.MAX_POWER_OF_TWO, 10, 42, 5, 0, 10, 2, Ascii.SUB, 73, 1, 8, Ascii.EM, Ascii.EM, Ascii.FF, 7, Ascii.FF, Ascii.CR, 73, Ascii.GS, 6, 6, 73, Ascii.SI, 8, Ascii.SUB, Ascii.GS, 71, Ascii.CR, 9, 10, 62, 47, 34, 46, 37, 40, 46, 5, 46, 63, 60, 36, 57, 32, Ascii.CAN, 57, 118, 34, 57, 35, 53, 62, 118, 50, 55, 34, 55, 118, 36, 51, 53, 57, 36, 50, 51, 50, 122, 118, 38, 58, 51, 55, 37, 51, 118, 51, 56, 37, 35, 36, 51, 118, 34, 57, 35, 53, 62, 118, 51, 32, 51, 56, 34, 37, 118, 36, 51, 55, 53, 62, 118, 34, 62, 51, 118, 55, 50, 118, 0, 63, 51, 33, 118, 52, 47, 118, 36, 51, 34, 35, 36, 56, 63, 56, 49, 118, 48, 55, 58, 37, 51, 118, 63, 48, 118, 47, 57, 35, 118, 63, 56, 34, 51, 36, 53, 51, 38, 34, 118, 34, 62, 51, 118, 51, 32, 51, 56, 34, 120, Ascii.CR, Ascii.VT, Ascii.DLE, 120, 98, 127};
    }
    ...
    public ViewOnClickListenerC2616ig(C2615ie c2615ie, C2699k1 c2699k1) {
        this.A01 = c2615ie;
        this.A00 = c2699k1;
    }

    public /* synthetic */ ViewOnClickListenerC2616ig(C2615ie c2615ie, C2699k1 c2699k1, C2625ip c2625ip) {
        this(c2615ie, c2699k1);
    }

    private Map<String, String> A01() {
        Map<String, String> mapA05 = new FB().A03(this.A01.A0R).A02(this.A01.A0f).A05();
    ...
    public final void onClick(View view) throws Throwable {
        ...
        try {
            ...
            int minimumElapsedTime = C14499m.A0J(this.A01.A0c);
