...
public final class C14228k {
    ...
    public static void A0A(AnonymousClass85 anonymousClass85) {
        try {
            Intent intentA00 = C4.A00(anonymousClass85, null, new IntentFilter(A01(24, 37, 65)));
            if (intentA00 == null) {
                return;
            }
            ...
            anonymousClass85.A08().AAu(A01(102, 7, 96), AbstractC14128a.A1T, new C14138b(e));
        }
    }

    public static synchronized void A0B(AnonymousClass85 anonymousClass85) {
        A09(anonymousClass85);
        A0A(anonymousClass85);
        if (A04 == null) {
            A04 = (SensorManager) anonymousClass85.getSystemService(A01(128, 6, 101));
            if (A04 == null) {
                return;
            }
        }
