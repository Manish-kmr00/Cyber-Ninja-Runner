...
public final class C2490gY implements CG {
    ...
    public C2490gY(int i, int i2, int i3, String str, String str2, DQ dq, ViewOnClickListenerC2488gW viewOnClickListenerC2488gW) {
        this.A01 = i;
        this.A00 = i2;
        this.A02 = i3;
        this.A05 = str;
        this.A04 = str2;
        this.A03 = dq;
        this.A06 = viewOnClickListenerC2488gW;
    }
    ...
    @Override // com.facebook.ads.redexgen.core.CG
    public final synchronized void AEg(float f) {
        if (!this.A09 && this.A03 != null) {
            if (this.A01 == 1) {
                if (!this.A0A) {
                    ...
                    this.A03.A08();
                    this.A03.setToolbarListener(new C2491gZ(this));
                    this.A0A = true;
