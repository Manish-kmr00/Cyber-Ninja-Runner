...
public abstract class AH {
    ...
    public static List<String> A02(C2699k1 c2699k1, JSONArray jSONArray) {
        ArrayList arrayList = new ArrayList();
        for (int eventIndex = 0; eventIndex < jSONArray.length(); eventIndex++) {
            try {
                arrayList.add(jSONArray.getString(eventIndex));
            } catch (JSONException e) {
                c2699k1.A08().AAu(A00(39, 17, 76), AbstractC14128a.A1C, new C14138b(e));
            }
        }
        return arrayList;
    }
    ...
    public static void A05(C2699k1 c2699k1, String str, long j) {
        A7 adEventManager = c2699k1.A0A();
        AF af = new AF(str, adEventManager);
        HashMap map = new HashMap();
        map.put(A00(24, 15, 67), C1517Cu.A07(j));
        map.put(A00(12, 12, 71), C1517Cu.A05(j));
        af.A04(AE.A0D, map);
    }

    public static void A06(C2699k1 c2699k1, JSONObject jSONObject, long j, String str) {
        ...
        if (TextUtils.isEmpty(str) && jSONArrayOptJSONArray != null) {
            A07(c2699k1, jSONObjectOptJSONObject, A02(c2699k1, jSONArrayOptJSONArray), j, null);
            return;
        }
        ...
        A07(c2699k1, jSONObjectOptJSONObject, A03.get(str), j, str);
    }

    public static void A07(C2699k1 c2699k1, JSONObject jSONObject, List<String> list, long j, String str) {
        String strA00 = A00(0, 2, 106);
        if (jSONObject.has(strA00)) {
            String clientToken = jSONObject.optString(strA00);
            A08(clientToken, str);
            A09(clientToken, list);
            A05(c2699k1, clientToken, j);
        }
    }
