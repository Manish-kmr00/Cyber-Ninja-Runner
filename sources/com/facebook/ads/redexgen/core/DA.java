...
public abstract class DA {
    ...
    public static Bitmap A00(C2699k1 c2699k1, Bitmap bitmap, int i) throws RSRuntimeException {
        ...
        try {
            renderScriptCreate = RenderScript.create(c2699k1);
    ...
    public static Bitmap A01(C2699k1 c2699k1, Bitmap bitmap, int i, int i2) {
        ...
        if (width != 0 && height != 0) {
            ...
            try {
                bitmapCreateBitmap = A00(c2699k1, bitmapCreateBitmap, i);
                if (i2 != 1) {
                ...
                return new C2579i1().A02(bitmapCreateBitmap, i);
            }
        }
        return null;
    }
