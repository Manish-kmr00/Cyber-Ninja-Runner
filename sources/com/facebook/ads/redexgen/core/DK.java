...
public final class DK {
    ...
    public static boolean A02(C2699k1 c2699k1) {
        return A03(c2699k1) && DL.A03(c2699k1);
    }
    ...
    public static boolean A03(C2699k1 c2699k1) {
        ...
        try {
            return ((PowerManager) c2699k1.getSystemService(A00(60, 5, 91))).isInteractive();
        } catch (Exception e) {
            Log.e(A02, A00(0, 60, 20), e);
            c2699k1.A08().AAu(A00(65, 5, 53), AbstractC14128a.A2S, new C14138b(e));
            return true;
        }
    }
}
