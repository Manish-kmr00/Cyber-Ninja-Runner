...
public final class C2N extends BroadcastReceiver {
    ...
    public C2N(C1745Lp c1745Lp, Context context) {
        this.A01 = c1745Lp;
        this.A00 = context;
    }
    ...
    public final void A02() {
        ...
        AnonymousClass42.A00(this.A00).A06(this, intentFilter);
    }

    public final void A03() {
        try {
            AnonymousClass42.A00(this.A00).A05(this);
        ...
        if (str3.length() == action4.length()) {
            ...
            if (str2.equals(action5)) {
                if (this.A01.getListener() != null) {
                    this.A01.getListener().AD2();
                    this.A01.getListener().AFm();
                    return;
                }
                return;
            }
            ...
            if (str4.equals(action6)) {
                ...
                if (serializableExtra instanceof C2202br) {
                    if (this.A01.getListener() != null) {
                        this.A01.getListener().AD8();
                        this.A01.getListener().AFm();
                    }
                    if (this.A02) {
                        this.A01.A0c(1);
                    } else {
                        this.A01.A0c(((C2202br) serializableExtra).A01());
                    }
                    this.A01.setVisibility(0);
                    this.A01.A0g(IP.A04, 1);
                    return;
                }
                if (serializableExtra instanceof C2210bz) {
                    if (this.A01.getListener() == null) {
                        return;
                    }
                    C1745Lp c1745Lp = this.A01;
                    String[] strArr3 = A04;
                    ...
                    if (str5.length() == action8.length()) {
                        ...
                        c1745Lp.getListener().ADG();
                        return;
                    }
                } else {
                    if (serializableExtra instanceof C2209by) {
                        if (this.A01.getListener() == null) {
                            return;
                        }
                    ...
                    if (serializableExtra instanceof C1705Ka) {
                        if (this.A01.getListener() != null) {
                            this.A01.getListener().ACg();
                        }
                        this.A02 = true;
                        return;
                    }
                    if (serializableExtra instanceof C2207bw) {
                        if (this.A01.getListener() != null) {
                            this.A01.getListener().AER();
                        }
                        this.A02 = false;
                        return;
                    }
                    boolean z = serializableExtra instanceof KY;
                    String[] strArr5 = A04;
