...
public abstract class AbstractC2861mj {
    ...
    public static int A00(@CheckForNull List<?> list, Object element) {
        ...
        while (listIterator.hasNext()) {
            if (AbstractC1813Or.A01(element, listIterator.next())) {
    ...
    public static int A01(@CheckForNull List<?> list, Object element) {
        ...
        while (listIterator.hasPrevious()) {
            if (AbstractC1813Or.A01(element, listIterator.previous())) {
    ...
    public static <E> ArrayList<E> A05(Iterator<? extends E> elements) {
        ...
        AbstractC2841mO.A0B(list, elements);
        return list;
    }

    public static boolean A06(@CheckForNull List<?> thisList, Object other) {
        if (other == AbstractC2589iD.A04(thisList)) {
            return true;
        }
        ...
        if (z && (list instanceof RandomAccess)) {
            for (int i = 0; i < size; i++) {
                if (!AbstractC1813Or.A01(thisList.get(i), list.get(i))) {
                    return false;
                }
            }
            return true;
        }
        return AbstractC2841mO.A0G(thisList.iterator(), list.iterator());
    }
}
