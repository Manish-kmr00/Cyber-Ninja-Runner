...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.Mm, reason: from Kotlin metadata */
...
public final class MetaExoPlayerCustomizedCollections {
    ...
    public static final <T> List<T> A02(T... tArr) {
        C2923nk.A09(tArr, A00(0, 8, 96));
        Object[] objArrCopyOf = Arrays.copyOf(tArr, tArr.length);
        return new ArrayList(NX.A07(Arrays.copyOf(objArrCopyOf, objArrCopyOf.length)));
    }
