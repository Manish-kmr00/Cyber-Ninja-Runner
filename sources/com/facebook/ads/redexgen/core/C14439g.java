...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.9g, reason: invalid class name and case insensitive filesystem */
/* JADX INFO: loaded from: assets/audience_network.dex */
public final class C14439g implements Closeable {
    ...
    public final Deque<C14429f> A02 = new LinkedList();
    ...
    public final synchronized int A09() throws IOException {
        ...
        iA01 = 0;
        Iterator<C14429f> it = this.A02.iterator();
        while (it.hasNext()) {
            iA01 += it.next().A01();
        }
        return iA01;
    ...
    public C14439g(C9W c9w, InterfaceC14419e interfaceC14419e) throws IOException {
        this.A01 = c9w;
        A05(c9w, interfaceC14419e);
        if (this.A02.isEmpty()) {
            A00();
        }
    }

    private C14429f A00() throws IOException {
        int iA00 = -1;
        if (!this.A02.isEmpty()) {
            iA00 = this.A02.getLast().A00();
        }
        int i = iA00 + 1;
        this.A02.add(new C14429f(i, new C14399c(new File(this.A01.A05(), A01(i)))));
    ...
    private void A04(int i, File file) throws IOException {
        C14399c c14399c = new C14399c(file);
        c14399c.A05();
        this.A02.addFirst(new C14429f(i, c14399c));
    }

    private void A05(C9W c9w, InterfaceC14419e interfaceC14419e) throws IOException {
        File[] fileArrListFiles = c9w.A05().listFiles();
        if (fileArrListFiles != null) {
            ...
            for (File file : fileArrListFiles) {
                try {
                    ...
                    hashSet.add(file);
                    interfaceC14419e.AHi(String.format(Locale.US, A02(260, 39, Sdk.SDKError.Reason.PROTOBUF_SERIALIZATION_ERROR_VALUE), file.getCanonicalPath()));
                }
            }
            ...
            if (!zIsEmpty) {
                ...
                while (it.hasNext()) {
                    ...
                    if (iIntValue < i3) {
                        interfaceC14419e.AHi(String.format(Locale.US, A02(166, 61, 41), Integer.valueOf(iIntValue), Integer.valueOf(i3)));
                ...
                while (i >= i3) {
                    ...
                    try {
                        ...
                        interfaceC14419e.AHj(String.format(Locale.US, A02(104, 62, 55), file2.getCanonicalPath(), Integer.valueOf(i)), e);
            ...
            for (Object obj : hashSet) {
                ...
                if (!file3.delete()) {
                    ...
                    if (A04[7].charAt(19) != 'm') {
                        ...
                        interfaceC14419e.AHi(String.format(locale, A02(40, 26, 116), objArr));
                    } else {
                        A04[7] = "xgRJlHLuW2qx7z7dN03x9GIdgxBOKXSD";
                        objArr[0] = canonicalPath;
                        interfaceC14419e.AHi(String.format(locale, A02(38, 20, 82), objArr));
                    }
                }
            }
            return;
        }
        IOException e2 = new IOException(String.format(Locale.US, A02(66, 38, 13), c9w.A05().getCanonicalPath()));
        throw e2;
    }
    ...
    public final synchronized C9U A0A(int i, int i2, byte[] bArr, int i3, int[] iArr, int i4) throws IOException {
        if (!this.A00) {
            for (C14429f file : this.A02) {
                if (file.A00() == i) {
                    return new C9U(i, file.A02(i2, bArr, i3, iArr, i4));
                }
            }
            return new C9U(-1, new C9T(C9S.A05, -1, -1, 0));
        }
        throw new IOException(A02(227, 33, 31));
    }
    ...
    public final synchronized boolean A0D() throws IOException {
        if (!this.A00) {
            ...
            C14429f first = this.A02.getFirst();
