...
public class LoginButton extends FacebookButtonBase {
    ...
    public static final void m4964onAttachedToWindow$lambda0(CallbackManager.ActivityResultParameters activityResultParameters) {
    }
  ...
  (r0v0 com.facebook.login.widget.LoginButton$ToolTipMode) from 0x0032: SPUT (r0v0 com.facebook.login.widget.LoginButton$ToolTipMode) (LINE:96) com.facebook.login.widget.LoginButton.ToolTipMode.DEFAULT com.facebook.login.widget.LoginButton$ToolTipMode
            ...
            if (getContext() instanceof ActivityResultRegistryOwner) {
                ...
                this.androidXLoginCaller = ((ActivityResultRegistryOwner) context).getActivityResultRegistry().register("facebook-login", this.loginManagerLazy.getValue().createLogInActivityResultContract(this.callbackManager, this.loggerID), new ActivityResultCallback() { // from class: com.facebook.login.widget.LoginButton$$ExternalSyntheticLambda2
                    ...
                    public final void onActivityResult(Object obj) {
                        LoginButton.m4964onAttachedToWindow$lambda0((CallbackManager.ActivityResultParameters) obj);
                    }
                });
            }
            ...
            if (i == 1) {
                ...
                FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.login.widget.LoginButton$$ExternalSyntheticLambda1
                    ...
                    public final void run() {
                        LoginButton.m4962checkToolTipSettings$lambda3(metadataApplicationId, this);
                    }
                });
                return;
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: checkToolTipSettings$lambda-3, reason: not valid java name */
    public static final void m4962checkToolTipSettings$lambda3(String appId, final LoginButton this$0) {
        ...
        this$0.getActivity().runOnUiThread(new Runnable() { // from class: com.facebook.login.widget.LoginButton$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                LoginButton.m4963checkToolTipSettings$lambda3$lambda2(this.f$0, fetchedAppSettingsQueryAppSettings);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: checkToolTipSettings$lambda-3$lambda-2, reason: not valid java name */
    public static final void m4963checkToolTipSettings$lambda3$lambda2(LoginButton this$0, FetchedAppSettings fetchedAppSettings) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    protected class LoginClickListener implements View.OnClickListener {
                ...
                if (this.this$0.confirmLogout) {
                    ...
                    builder.setMessage(string).setCancelable(true).setPositiveButton(string2, new DialogInterface.OnClickListener() { // from class: com.facebook.login.widget.LoginButton$LoginClickListener$$ExternalSyntheticLambda0
                        ...
                        public final void onClick(DialogInterface dialogInterface, int i) {
                            LoginButton.LoginClickListener.m4965performLogout$lambda2(loginManager, dialogInterface, i);
                        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        /* JADX INFO: renamed from: performLogout$lambda-2, reason: not valid java name */
        public static final void m4965performLogout$lambda2(LoginManager loginManager, DialogInterface dialogInterface, int i) {
