    ...
    public static final class Companion {
        ...
        public final AccessToken createAccessTokenFromWebBundle(Collection<String> requestedPermissions, Bundle bundle, AccessTokenSource source, String applicationId) throws FacebookException {
            ...
            if (string2 != null) {
                String str = string2;
                if (str.length() > 0) {
                    Object[] array = StringsKt.split$default((CharSequence) str, new String[]{StringUtils.COMMA}, false, 0, 6, (Object) null).toArray(new String[0]);
                    if (array != null) {
            ...
            if (string3 != null) {
                String str2 = string3;
                if (str2.length() > 0) {
                    Object[] array2 = StringsKt.split$default((CharSequence) str2, new String[]{StringUtils.COMMA}, false, 0, 6, (Object) null).toArray(new String[0]);
                    if (array2 != null) {
            ...
            if (string4 != null) {
                String str3 = string4;
                if (str3.length() > 0) {
                    Object[] array3 = StringsKt.split$default((CharSequence) str3, new String[]{StringUtils.COMMA}, false, 0, 6, (Object) null).toArray(new String[0]);
                    if (array3 != null) {
        ...
        public final String getUserIDFromSignedRequest(String signedRequest) throws FacebookException {
            ...
            try {
                Object[] array = StringsKt.split$default((CharSequence) signedRequest, new String[]{"."}, false, 0, 6, (Object) null).toArray(new String[0]);
                if (array != null) {
                    String[] strArr = (String[]) array;
                    if (strArr.length == 2) {
