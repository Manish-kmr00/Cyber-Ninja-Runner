...
public class LoginManager {
    ...
    public static void safedk_StartActivityDelegate_startActivityForResult_05ba5c64909d4884baa1ad0bdf7b46fb(StartActivityDelegate p0, Intent p1, int p2) {
    ...
    public final void registerCallback(CallbackManager callbackManager, final FacebookCallback<LoginResult> callback) {
        ...
        ((CallbackManagerImpl) callbackManager).registerCallback(CallbackManagerImpl.RequestCodeOffset.Login.toRequestCode(), new CallbackManagerImpl.Callback() { // from class: com.facebook.login.LoginManager$$ExternalSyntheticLambda0
            ...
            public final boolean onActivityResult(int i, Intent intent) {
                return LoginManager.m4955registerCallback$lambda0(this.f$0, callback, i, intent);
            }
        });
    }
    ...
    public static final boolean m4955registerCallback$lambda0(LoginManager this$0, FacebookCallback facebookCallback, int i, Intent intent) {
    ...
    public final void logIn(FragmentWrapper fragment, Collection<String> permissions, String loggerID) {
        Intrinsics.checkNotNullParameter(fragment, "fragment");
        LoginClient.Request requestCreateLoginRequestWithConfig = createLoginRequestWithConfig(new LoginConfiguration(permissions, null, 2, 0 == true ? 1 : 0));
        if (loggerID != null) {
    ...
    public final class FacebookLoginActivityResultContract extends ActivityResultContract<Collection<? extends String>, CallbackManager.ActivityResultParameters> {
        ...
        public Intent createIntent2(Context context, Collection<String> permissions) {
            Intrinsics.checkNotNullParameter(context, "context");
            Intrinsics.checkNotNullParameter(permissions, "permissions");
            LoginClient.Request requestCreateLoginRequestWithConfig = LoginManager.this.createLoginRequestWithConfig(new LoginConfiguration(permissions, null, 2, 0 == true ? 1 : 0));
    ...
    private final void startLogin(StartActivityDelegate startActivityDelegate, LoginClient.Request request) throws FacebookException {
        ...
        CallbackManagerImpl.INSTANCE.registerStaticCallback(CallbackManagerImpl.RequestCodeOffset.Login.toRequestCode(), new CallbackManagerImpl.Callback() { // from class: com.facebook.login.LoginManager$$ExternalSyntheticLambda2
            @Override // com.facebook.internal.CallbackManagerImpl.Callback
            public final boolean onActivityResult(int i, Intent intent) {
                return LoginManager.m4957startLogin$lambda1(this.f$0, i, intent);
            }
        });
    ...
    public static final boolean m4957startLogin$lambda1(LoginManager this$0, int i, Intent intent) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    private final boolean tryFacebookActivity(StartActivityDelegate startActivityDelegate, LoginClient.Request request) {
        ...
        try {
            safedk_StartActivityDelegate_startActivityForResult_05ba5c64909d4884baa1ad0bdf7b46fb(startActivityDelegate, facebookActivityIntent, LoginClient.INSTANCE.getLoginRequestCode());
            return true;
    ...
    private final void retrieveLoginStatusImpl(Context context, final LoginStatusCallback responseCallback, long toastDurationMs) {
        ...
        loginStatusClientNewInstance$facebook_common_release.setCompletedListener(new PlatformServiceClient.CompletedListener() { // from class: com.facebook.login.LoginManager$$ExternalSyntheticLambda1
            ...
            public final void completed(Bundle bundle) {
                LoginManager.m4956retrieveLoginStatusImpl$lambda2(string, loginLogger, responseCallback, applicationId, bundle);
            }
        });
    ...
    public static final void m4956retrieveLoginStatusImpl$lambda2(String loggerRef, LoginLogger logger, LoginStatusCallback responseCallback, String applicationId, Bundle bundle) {
    ...
    static final class AndroidxActivityResultRegistryOwnerStartActivityDelegate implements StartActivityDelegate {
        ...
        public void startActivityForResult(Intent intent, int requestCode) {
            ...
            loginManager$AndroidxActivityResultRegistryOwnerStartActivityDelegate$startActivityForResult$LauncherHolder.setLauncher(this.activityResultRegistryOwner.getActivityResultRegistry().register("facebook-login", new ActivityResultContract<Intent, Pair<Integer, Intent>>() { // from class: com.facebook.login.LoginManager$AndroidxActivityResultRegistryOwnerStartActivityDelegate$startActivityForResult$1
                ...
                public final void onActivityResult(Object obj) {
                    LoginManager.AndroidxActivityResultRegistryOwnerStartActivityDelegate.m4958startActivityForResult$lambda0(this.f$0, loginManager$AndroidxActivityResultRegistryOwnerStartActivityDelegate$startActivityForResult$LauncherHolder, (Pair) obj);
                }
            }));
        ...
        public static final void m4958startActivityForResult$lambda0(AndroidxActivityResultRegistryOwnerStartActivityDelegate this$0, LoginManager$AndroidxActivityResultRegistryOwnerStartActivityDelegate$startActivityForResult$LauncherHolder launcherHolder, Pair pair) {
            Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    private static final class ActivityStartActivityDelegate implements StartActivityDelegate {
        ...
        public void startActivityForResult(Intent intent, int requestCode) {
            Intrinsics.checkNotNullParameter(intent, "intent");
            safedk_Activity_startActivityForResult_206f42f0b65887e835d87ee52d14d221(getActivityContext(), intent, requestCode);
        }
    }
    ...
    private static final class FragmentStartActivityDelegate implements StartActivityDelegate {
        ...
        public void startActivityForResult(Intent intent, int requestCode) {
            Intrinsics.checkNotNullParameter(intent, "intent");
            safedk_FragmentWrapper_startActivityForResult_51accca8f1bb017fcda2a6aac31602e6(this.fragment, intent, requestCode);
        }
    ...
    private static final class LoginLoggerHolder {
        ...
        /* JADX WARN: Code duplicated, block: B:9:0x000e A[DONT_GENERATE] */
        /* JADX WARN: Instruction removed from duplicated block: B:9:0x000e, please report this as an issue */
