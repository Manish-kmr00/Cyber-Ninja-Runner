...
public final class InAppPurchaseBillingClientWrapper {
        ...
        try {
            ...
            queryPurchaseHistoryAsync(skuType, new Runnable() { // from class: com.facebook.appevents.iap.InAppPurchaseBillingClientWrapper$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    InAppPurchaseBillingClientWrapper.m4835queryPurchaseHistory$lambda0(this.f$0, queryPurchaseHistoryRunnable);
                }
            });
        } catch (Throwable th) {
    ...
    /* JADX INFO: renamed from: queryPurchaseHistory$lambda-0, reason: not valid java name */
    public static final void m4835queryPurchaseHistory$lambda0(InAppPurchaseBillingClientWrapper this$0, Runnable queryPurchaseHistoryRunnable) {
        if (CrashShieldHandler.isObjectCrashing(InAppPurchaseBillingClientWrapper.class)) {
            return;
        }
        try {
    ...
    public final void queryPurchase(String skuType, Runnable querySkuRunnable) {
        ...
        try {
            ...
            Object objInvokeMethod = InAppPurchaseUtils.invokeMethod(this.billingClientClazz, this.queryPurchasesMethod, this.billingClient, "inapp");
