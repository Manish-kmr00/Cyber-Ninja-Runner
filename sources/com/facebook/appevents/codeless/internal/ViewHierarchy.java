...
public final class ViewHierarchy {
    ...
    /* JADX WARN: Code duplicated, block: B:25:0x0045 A[PHI: r3
  0x0045: PHI (r3v3 int) = (r3v2 int), (r3v4 int) binds: [B:18:0x0031, B:23:0x003e] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public static final int getClassTypeBitmask(View view) {
        ...
        try {
            ...
            if (!(view instanceof Spinner) && !(view instanceof DatePicker)) {
                ...
                return ((view instanceof ViewGroup) && viewHierarchy.isRCTButton(view, RCTRootViewReference.get())) ? i2 | 64 : i2;
            }
            return i2 | 4096;
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, ViewHierarchy.class);
    ...
    /* JADX WARN: Code duplicated, block: B:45:0x0109 A[EDGE_INSN: B:45:0x0109->B:46:0x010a BREAK  A[LOOP:0: B:33:0x00db->B:40:0x00f8]] */
    @JvmStatic
