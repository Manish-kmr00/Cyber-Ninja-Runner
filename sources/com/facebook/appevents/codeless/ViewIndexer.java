...
public final class ViewIndexer {
            ...
            try {
                ...
                FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.appevents.codeless.ViewIndexer$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        ViewIndexer.m4825schedule$lambda0(this.f$0, timerTask);
                    }
                });
    ...
    /* JADX INFO: renamed from: schedule$lambda-0, reason: not valid java name */
    public static final void m4825schedule$lambda0(ViewIndexer this$0, TimerTask indexingTask) {
        if (CrashShieldHandler.isObjectCrashing(ViewIndexer.class)) {
            return;
        }
        try {
    ...
    private final void sendToServer(final String tree) {
        ...
        try {
            ...
            FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.appevents.codeless.ViewIndexer$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    ViewIndexer.m4826sendToServer$lambda1(tree, this);
                }
            });
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, this);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: sendToServer$lambda-1, reason: not valid java name */
    public static final void m4826sendToServer$lambda1(String tree, ViewIndexer this$0) {
        if (CrashShieldHandler.isObjectCrashing(ViewIndexer.class)) {
            return;
        }
        try {
    ...
    public static final class Companion {
        ...
        public final GraphRequest buildAppIndexingRequest(String appIndex, AccessToken accessToken, String appId, String requestType) {
            ...
            graphRequestNewPostRequest.setCallback(new GraphRequest.Callback() { // from class: com.facebook.appevents.codeless.ViewIndexer$Companion$$ExternalSyntheticLambda0
                ...
                public final void onCompleted(GraphResponse graphResponse) {
                    ViewIndexer.Companion.m4827buildAppIndexingRequest$lambda0(graphResponse);
                }
            });
        ...
        /* JADX INFO: Access modifiers changed from: private */
        /* JADX INFO: renamed from: buildAppIndexingRequest$lambda-0, reason: not valid java name */
        public static final void m4827buildAppIndexingRequest$lambda0(GraphResponse it) {
