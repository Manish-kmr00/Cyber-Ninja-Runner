...
public class InneractiveRichMediaVideoPlayerActivityCore extends Activity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.f1603a = (VideoView) findViewById(R.id.mraid_video_view);
        ...
        if (TextUtils.isEmpty(stringExtra)) {
            ...
            this.f1603a.setVideoPath(stringExtra);
            this.f1603a.setOnCompletionListener(new o(this));
            this.f1603a.setOnErrorListener(new p(this));
    ...
    public void onPause() {
        super.onPause();
        this.b = this.f1603a.getCurrentPosition();
        this.f1603a.pause();
    }
    ...
    public void onSaveInstanceState(Bundle bundle) {
        ...
        VideoView videoView = this.f1603a;
