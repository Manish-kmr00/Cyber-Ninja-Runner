...
public abstract class d {
    public static b a(com.fyber.inneractive.sdk.player.exoplayer2.extractor.b bVar) throws InterruptedException, r, EOFException {
        n nVar = new n(16);
        if (c.a(bVar, nVar).f2099a != z.a("RIFF")) {
            return null;
        }
        ...
        while (cVarA.f2099a != z.a("fmt ")) {
            bVar.a((int) cVarA.b, false);
            cVarA = c.a(bVar, nVar);
        }
        if (cVarA.b < 16) {
            throw new IllegalStateException();
        }
        bVar.a(nVar.f2184a, 0, 16, false);
        nVar.e(0);
        int iF = nVar.f();
        int iF2 = nVar.f();
        int iD = nVar.d();
        ...
        int i = (iF2 * iF4) / 8;
        if (iF3 != i) {
            throw new r("Expected block alignment: " + i + "; got: " + iF3);
        }
        int iA = z.a(iF4);
        if (iA == 0) {
