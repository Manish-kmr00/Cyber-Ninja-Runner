...
/* JADX INFO: renamed from: com.fyber.inneractive.sdk.network.t, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes6.dex */
public enum EnumC3143t {
    ...
    private static final HashMap<Integer, EnumC3143t> sMap = new HashMap<>();
    int val;

    static {
        for (EnumC3143t enumC3143t : values()) {
            sMap.put(Integer.valueOf(enumC3143t.val), enumC3143t);
        }
    }
    ...
    public static EnumC3143t a(com.digitalturbine.ignite.authenticator.events.d dVar) {
