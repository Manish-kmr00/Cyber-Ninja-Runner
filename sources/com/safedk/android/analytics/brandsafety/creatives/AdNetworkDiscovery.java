...
public interface AdNetworkDiscovery {
    ...
    public static final float f8031a = 0.15f;
    ...
    List<CreativeInfo> a(String str, String str2, byte[] bArr, Map<String, List<String>> map, com.safedk.android.analytics.brandsafety.creatives.discoveries.c.a aVar);
