...
public class AdMobFilesBridge {
    public static FileOutputStream fileOutputStreamCtor(File file) throws FileNotFoundException {
        Logger.d("AdMobFiles|SafeDK: Partial-Files> Lcom/safedk/android/internal/partials/AdMobFilesBridge;->fileOutputStreamCtor(Ljava/io/File;)Ljava/io/FileOutputStream;");
        if (!SafeDK.ae()) {
        ...
        return CreativeInfoManager.a(h.h, file.getPath(), new FileOutputStream(file));
    }
}
