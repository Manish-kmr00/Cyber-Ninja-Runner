...
public class VerveFilesBridge {
    public static FileOutputStream fileOutputStreamCtor(File file) throws FileNotFoundException {
        Logger.d("VerveFiles|SafeDK: Partial-Files> Lcom/safedk/android/internal/partials/VerveFilesBridge;->fileOutputStreamCtor(Ljava/io/File;)Ljava/io/FileOutputStream;");
        if (!SafeDK.ae()) {
    ...
    public static FileOutputStream fileOutputStreamCtor(String path) throws FileNotFoundException {
        Logger.d("VerveFiles|SafeDK: Partial-Files> Lcom/safedk/android/internal/partials/VerveFilesBridge;->fileOutputStreamCtor(Ljava/lang/String;)Ljava/io/FileOutputStream;");
        if (!SafeDK.ae()) {
        ...
        return CreativeInfoManager.a(h.C, path, new FileOutputStream(path));
    }
}
