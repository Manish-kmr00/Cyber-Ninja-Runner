...
/* JADX INFO: compiled from: AmazonPublisherServicesSourceFile */
/* JADX INFO: loaded from: classes.dex */
public class AmazonPublisherServicesNetworkBridge {
    public static InputStream urlConnectionGetInputStream(URLConnection targetInstance) throws IOException {
        Logger.d("AmazonPublisherServicesNetwork|SafeDK: Partial-Network> Lcom/safedk/android/internal/partials/AmazonPublisherServicesNetworkBridge;->urlConnectionGetInputStream(Ljava/net/URLConnection;)Ljava/io/InputStream;");
        if (SafeDK.getInstance() != null && SafeDK.getInstance().p()) {
            String string = targetInstance.getURL().toString();
            Logger.d("SafeDKNetwork", "urlConnectionGetInputStream : " + string + ", isOnUiThread = " + n.c() + ", SDK_PACKAGE_NAME =  " + h.A);
            ...
            InputStream inputStreamA = CreativeInfoManager.a(h.A, string, inputStream, headerFields);
    ...
    public static OutputStream urlConnectionGetOutputStream(URLConnection targetInstance) throws IOException {
        Logger.d("AmazonPublisherServicesNetwork|SafeDK: Partial-Network> Lcom/safedk/android/internal/partials/AmazonPublisherServicesNetworkBridge;->urlConnectionGetOutputStream(Ljava/net/URLConnection;)Ljava/io/OutputStream;");
        if (SafeDK.getInstance() == null || !SafeDK.getInstance().p()) {
            return targetInstance.getOutputStream();
        }
        OutputStream outputStream = targetInstance.getOutputStream();
        String string = targetInstance.getURL().toString();
        Logger.d("SafeDKNetwork", "urlConnectionGetOutputStream url=" + string + ", isOnUiThread = " + n.c() + ", SDK_PACKAGE_NAME = " + h.A);
        return CreativeInfoManager.a(h.A, string, outputStream);
    }

    public static int httpUrlConnectionGetResponseCode(HttpURLConnection targetInstance) throws IOException {
        Logger.d("AmazonPublisherServicesNetwork|SafeDK: Partial-Network> Lcom/safedk/android/internal/partials/AmazonPublisherServicesNetworkBridge;->httpUrlConnectionGetResponseCode(Ljava/net/HttpURLConnection;)I");
        ...
        if (SafeDK.getInstance() != null && SafeDK.getInstance().p() && responseCode >= 200 && responseCode < 300 && CreativeInfoManager.a(h.A, AdNetworkConfiguration.USE_INPUT_STREAM_EVENT_AS_RESOURCE_LOADED_INDICATION, false)) {
            CreativeInfoManager.onResourceLoaded(h.A, null, string);
        }
        return responseCode;
    }

    public static void httpUrlConnectionDisconnect(HttpURLConnection targetInstance) {
        Logger.d("AmazonPublisherServicesNetwork|SafeDK: Partial-Network> Lcom/safedk/android/internal/partials/AmazonPublisherServicesNetworkBridge;->httpUrlConnectionDisconnect(Ljava/net/HttpURLConnection;)V");
        if (SafeDK.getInstance() != null && SafeDK.getInstance().p()) {
            try {
    ...
    public static void webviewLoadUrl(WebView targetInstance, String url) {
        Logger.d("AmazonPublisherServicesNetwork|SafeDK: Partial-Network> Lcom/safedk/android/internal/partials/AmazonPublisherServicesNetworkBridge;->webviewLoadUrl(Landroid/webkit/WebView;Ljava/lang/String;)V");
    ...
    public static void webviewLoadDataWithBaseURL(WebView targetInstance, String baseUrl, String data, String mimeType, String encoding, String historyUrl) {
        Logger.d("AmazonPublisherServicesNetwork|SafeDK: Partial-Network> Lcom/safedk/android/internal/partials/AmazonPublisherServicesNetworkBridge;->webviewLoadDataWithBaseURL(Landroid/webkit/WebView;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V");
        if (SafeDK.getInstance() != null && SafeDK.getInstance().p()) {
            Logger.d("SafeDKNetwork", "webviewLoadDataWithBaseURL: " + baseUrl + ", WebView address : " + targetInstance.toString() + ", isOnUiThread = " + n.c() + ", SDK_PACKAGE_NAME = " + h.A);
    ...
    public static void onAddedJavascriptInterface(WebView targetInstance, Object object, String name) {
        Logger.d("AmazonPublisherServicesNetwork|SafeDK: Partial-Network> Lcom/safedk/android/internal/partials/AmazonPublisherServicesNetworkBridge;->onAddedJavascriptInterface(Landroid/webkit/WebView;Ljava/lang/Object;Ljava/lang/String;)V");
        Logger.d("SafeDKNetwork", "onAddedJavascriptInterface invoked, WebView address: " + targetInstance + ", SDK_PACKAGE_NAME: " + h.A + " object is: " + object + " and name: " + name);
        AdNetworkDiscovery adNetworkDiscoveryI = CreativeInfoManager.i(h.A);
        if (adNetworkDiscoveryI != null) {
