...
public class AdjustInstance {
    ...
    private void setSendingReferrersAsNotSent(final Context context) {
        new SingleThreadCachedScheduler("AdjustInstance").submit(new Runnable() { // from class: com.adjust.sdk.AdjustInstance$$ExternalSyntheticLambda0
    ...
    public void onPause() {
        if (checkActivityHandler(b9.h.t0)) {
            this.activityHandler.onPause();
        }
    }

    public void onResume() {
        if (checkActivityHandler(b9.h.u0)) {
