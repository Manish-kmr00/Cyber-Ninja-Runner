...
public class AdjustAttribution implements Serializable {
    ...
    public Map<String, String> toMap() {
        ...
        if (str6 != null) {
            map.put(Reporting.Key.CREATIVE, str6);
        }
