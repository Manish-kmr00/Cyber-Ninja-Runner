    ...
    private String getFacebookAttributionId(Context context) {
        ...
        try {
            if (Build.VERSION.SDK_INT >= 28) {
                ...
                apkContentsSigners = context.getPackageManager().getPackageInfo("com.facebook.katana", 64).signatures;
            }
            if (apkContentsSigners == null || apkContentsSigners.length != 1 || !OFFICIAL_FACEBOOK_SIGNATURE.equals(apkContentsSigners[0].toCharsString()) || (cursorQuery = context.getContentResolver().query(Uri.parse("content://com.facebook.katana.provider.AttributionIdProvider"), new String[]{yk.SESSION_HISTORY_KEY_AD_ID}, null, null, null)) == null) {
                return null;
            }
            ...
            String string = cursorQuery.getString(cursorQuery.getColumnIndex(yk.SESSION_HISTORY_KEY_AD_ID));
            cursorQuery.close();
            return string;
        } catch (Exception unused) {
        }
