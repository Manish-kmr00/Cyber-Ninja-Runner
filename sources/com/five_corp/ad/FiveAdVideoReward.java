...
import com.five_corp.ad.internal.C2978e;
...
public class FiveAdVideoReward implements FiveAdInterface, com.five_corp.ad.internal.adselector.b, c {
    public static final String l = FiveAdVideoReward.class.toString();
    ...
    public void onAdSuccessfullySelected(com.five_corp.ad.internal.context.l lVar) {
        ...
        f fVar = new f(this.f1252a, this.b, null, this.d, this.e, lVar, this);
        synchronized (this.g) {
            this.i = fVar;
        ...
        if (xVar != null) {
            ...
            this.f.a("notifyLoad failed @ FiveAdVideoReward.onAdSuccessfullySelected", 4);
        }
    }
    ...
    public void onFailureToSelectAd(com.five_corp.ad.internal.o oVar) {
        ...
        if (xVar != null) {
            xVar.b(this.c, com.five_corp.ad.internal.context.h.VIDEO_REWARD, oVar);
        } else {
            this.f.a("notifyLoadError failed @ FiveAdVideoReward.onFailureToSelectAd", 4);
        }
    }

    public void setEventListener(FiveAdVideoRewardEventListener fiveAdVideoRewardEventListener) {
        y yVar = this.d;
        yVar.d.set(new C2978e(fiveAdVideoRewardEventListener, this));
        y yVar2 = this.d;
        yVar2.e.set(new t(fiveAdVideoRewardEventListener, this));
    }
