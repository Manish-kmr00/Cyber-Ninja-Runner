...
class CSSParser {
    ...
    private static class CSSTextScanner extends SVGParser.TextScanner {
        ...
        private void parsePseudoClass(Selector selector, SimpleSelector simpleSelector) throws CSSParseException {
            ...
            switch (AnonymousClass1.$SwitchMap$com$caverock$androidsvg$CSSParser$PseudoClassIdents[pseudoClassIdentsFromString.ordinal()]) {
                case 1:
                    PseudoClass pseudoClassAnPlusB = new PseudoClassAnPlusB(0, 1, true, false, null);
                    selector.addedAttributeOrPseudo();
                    pseudoClass2 = pseudoClassAnPlusB;
                    simpleSelector.addPseudo(pseudoClass2);
                    return;
                case 2:
                    PseudoClass pseudoClassAnPlusB2 = new PseudoClassAnPlusB(0, 1, false, false, null);
                    selector.addedAttributeOrPseudo();
                ...
                case 3:
                    ...
                    return;
                case 4:
                    PseudoClass pseudoClassAnPlusB3 = new PseudoClassAnPlusB(0, 1, true, true, simpleSelector.tag);
                    selector.addedAttributeOrPseudo();
                ...
                case 12:
                    ...
                    PseudoClass pseudoClassAnPlusB5 = new PseudoClassAnPlusB(anPlusBNextAnPlusB.f959a, anPlusBNextAnPlusB.b, z, z2, simpleSelector.tag);
                    selector.addedAttributeOrPseudo();
    ...
    private static class PseudoClassAnPlusB implements PseudoClass {
        ...
        public boolean matches(RuleMatchContext ruleMatchContext, SVG.SvgElementBase svgElementBase) {
            ...
            int i5 = this.b;
            if ((i3 - i5) % i4 == 0) {
                return Integer.signum(i3 - i5) == 0 || Integer.signum(i3 - this.b) == Integer.signum(this.f960a);
            }
            return false;
        }
        ...
        public String toString() {
            ...
            return this.isOfType ? String.format("nth-%schild(%dn%+d of type <%s>)", str, Integer.valueOf(this.f960a), Integer.valueOf(this.b), this.nodeName) : String.format("nth-%schild(%dn%+d)", str, Integer.valueOf(this.f960a), Integer.valueOf(this.b));
        }
    }
