...
class SVGParser {
    ...
    private static class FontSizeKeywords {
        ...
        static {
            ...
            map.put(Constants.SMALL, new SVG.Length(10.0f, SVG.Unit.pt));
            map.put("medium", new SVG.Length(12.0f, SVG.Unit.pt));
            map.put(Constants.LARGE, new SVG.Length(14.4f, SVG.Unit.pt));
    ...
    public void handleProcessingInstruction(String str, Map<String, String> map) {
        ...
        if (map.get("type") == null || "text/css".equals(map.get("type"))) {
            if ((map.get("alternate") != null && !"no".equals(map.get("alternate"))) || (str2 = map.get("href")) == null || (strResolveCSSStyleSheet = SVG.getFileResolver().resolveCSSStyleSheet(str2)) == null) {
                return;
            }
    ...
    private static void parseStyle(SVG.SvgElementBase svgElementBase, String str) {
        ...
        while (true) {
            String strNextToken = textScanner.nextToken(AbstractJsonLexerKt.COLON);
            textScanner.skipWhitespace();
        ...
        try {
            switch (AnonymousClass1.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(str).ordinal()]) {
                ...
                case 72:
                    ...
                    return;
                case 73:
                    if (str2.indexOf(Sdk.SDKError.Reason.INVALID_LOG_ERROR_ENDPOINT_VALUE) >= 0 || !VALID_DISPLAY_VALUES.contains(l.ad + str2 + '|')) {
                        return;
                    }
                    ...
                    return;
                case 74:
                    if (str2.indexOf(Sdk.SDKError.Reason.INVALID_LOG_ERROR_ENDPOINT_VALUE) >= 0 || !VALID_VISIBILITY_VALUES.contains(l.ad + str2 + '|')) {
                        return;
                    }
        ...
        if ("|caption|icon|menu|message-box|small-caption|status-bar|".contains(l.ad + str + '|')) {
            ...
            while (true) {
                ...
                if (strNextToken != null) {
                    ...
                    if (!strNextToken.equals(Constants.NORMAL) && (num != null || (num = FontWeightKeywords.get(strNextToken)) == null)) {
    ...
    /* JADX WARN: Code duplicated, block: B:117:0x0273 A[SYNTHETIC] */
