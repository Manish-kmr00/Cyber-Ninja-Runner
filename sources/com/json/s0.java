...
@Metadata(d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u0006\b\u0000\u0018\u00002\u00020\u0001B!\u0012\u0006\u0010\u0006\u001a\u00020\u0004\u0012\b\u0010\n\u001a\u0004\u0018\u00010\u0007\u0012\u0006\u0010\u000e\u001a\u00020\u000b¢\u0006\u0004\b\u000f\u0010\u0010J\b\u0010\u0003\u001a\u00020\u0002H\u0016R\u0014\u0010\u0006\u001a\u00020\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0003\u0010\u0005R\u0016\u0010\n\u001a\u0004\u0018\u00010\u00078\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\b\u0010\tR\u0014\u0010\u000e\u001a\u00020\u000b8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\f\u0010\r¨\u0006\u0011"}, d2 = {"Lcom/ironsource/s0;", "Lcom/ironsource/lv;", "", "a", "", "Ljava/lang/String;", "adm", "Lcom/ironsource/ui;", DownloadCommon.DOWNLOAD_REPORT_FIND_FILE_RESULT_VALUE_B, "Lcom/ironsource/ui;", "adapterConfig", "", ApsMetricsDataMap.APSMETRICS_FIELD_CUSTOM, "Z", "isSDKInitialized", "<init>", "(Ljava/lang/String;Lcom/ironsource/ui;Z)V", "mediationsdk_release"}, k = 1, mv = {1, 8, 0})
public final class s0 implements lv {
    ...
    private final ui adapterConfig;
    ...
    public s0(String adm, ui uiVar, boolean z) {
        ...
        this.adm = adm;
        this.adapterConfig = uiVar;
        this.isSDKInitialized = z;
    }

    @Override // com.json.lv
    public void a() throws or {
        a(this.isSDKInitialized, a.f4247a);
        a(this.adapterConfig != null, b.f4248a);
        ui uiVar = this.adapterConfig;
        if (uiVar != null) {
            if (uiVar.c() == wi.NonBidder) {
                a(this.adm.length() == 0, c.f4249a);
            }
            if (uiVar.c() == wi.Bidder) {
                a(this.adm.length() > 0, d.f4250a);
            }
            a(uiVar.c() != wi.NotSupported, e.f4251a);
            a(uiVar.b().length() > 0, f.f4252a);
        }
    }
}
