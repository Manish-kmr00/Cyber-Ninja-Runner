...
public final class qg extends Throwable {
    ...
    public boolean equals(Object other) {
        ...
        if (other == null || !Intrinsics.areEqual(qg.class, other.getClass())) {
            return false;
        }
        qg qgVar = (qg) other;
        if (this.error.getErrorCode() != qgVar.error.getErrorCode()) {
            return false;
        }
        return Intrinsics.areEqual(this.error.getErrorMessage(), qgVar.error.getErrorMessage());
    }
