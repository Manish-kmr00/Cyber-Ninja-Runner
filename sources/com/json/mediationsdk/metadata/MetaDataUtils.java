...
public class MetaDataUtils {
    ...
    public static MetaData.MetaDataValueTypes getValueTypeForKey(String str) {
        return (str.equalsIgnoreCase(a.f3993a) || str.equalsIgnoreCase(a.b) || str.equalsIgnoreCase(a.c) || str.equalsIgnoreCase(a.d)) ? MetaData.MetaDataValueTypes.META_DATA_VALUE_BOOLEAN : MetaData.MetaDataValueTypes.META_DATA_VALUE_STRING;
    }
    ...
    public static boolean isValidCCPAMetaData(String str, String str2) {
        return isValidMetaData(str, a.f3993a, str2);
    }
