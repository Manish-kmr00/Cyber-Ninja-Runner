...
public final class WaterfallConfiguration {
    ...
    public final String toJsonString() {
        ...
        try {
            jSONObjectJsonObjectInit.put("ceiling", this.ceiling);
            jSONObjectJsonObjectInit.put("floor", this.floor);
