...
public class cq {
    ...
    private final ConcurrentHashMap<String, NetworkSettings> f3583a = new ConcurrentHashMap<>();
    ...
    public HashSet<String> a(String str, String str2) {
        ...
        try {
            for (NetworkSettings networkSettings : this.f3583a.values()) {
    ...
    public void a(NetworkSettings networkSettings) {
        ...
        this.f3583a.put(networkSettings.getProviderName(), networkSettings);
    }

    public boolean a(String str) {
        return this.f3583a.containsKey(str);
    }

    public NetworkSettings b(String str) {
        NetworkSettings networkSettings = this.f3583a.get(str);
