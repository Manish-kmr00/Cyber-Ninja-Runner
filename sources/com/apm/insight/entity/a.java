...
public class a {
    ...
    private JSONObject f197a;
    private Header b;

    public a() {
        this.f197a = new JSONObject();
    }
    ...
    public static a a(long j, Context context, Throwable th) {
        if (j == 0) {
        ...
        aVar.a("process_name", (Object) com.apm.insight.l.a.d(context));
    ...
    public final a a(Map<String, Integer> map) {
        ...
        try {
            if (map == null) {
                this.f197a.put("plugin_info", jSONArray);
                return this;
            }
    ...
    public final a b(Map<Integer, String> map) {
        if (map != null && map.size() > 0) {
            ...
            try {
                this.f197a.put("sdk_info", jSONObject);
    ...
    public final a a(int i, String str) {
        try {
            this.f197a.put("miniapp_id", i);
            this.f197a.put("miniapp_version", str);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        return this;
    ...
    public static void a(JSONObject jSONObject, JSONObject jSONObject2) {
        ...
        String str2;
        try {
            jSONObject.put(b9.a.k, jSONObject2);
        } catch (Throwable unused) {
        }
    ...
    public final boolean a() {
        Object objOpt = this.f197a.opt("data");
        if (objOpt instanceof JSONArray) {
            return !com.apm.insight.a.a(((JSONArray) objOpt).optJSONObject(0), "logcat");
        }
        return !com.apm.insight.a.a(this.f197a, "logcat");
    }

    private a a(String str, JSONArray jSONArray) {
        JSONObject jSONObjectOptJSONObject = this.f197a.optJSONObject("custom_long");
        if (jSONObjectOptJSONObject == null) {
            jSONObjectOptJSONObject = new JSONObject();
    ...
    public final a c(Map<? extends String, ? extends String> map) {
        ...
        if (map != null) {
            ...
            if (objOpt instanceof JSONArray) {
                ...
                jSONObjectOptJSONObject = this.f197a;
            }
            if (jSONObjectOptJSONObject == null) {
