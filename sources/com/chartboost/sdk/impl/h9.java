...
public final class h9 extends com.chartboost.sdk.impl.c {
    ...
    public h9(y adUnitLoader, g0 adUnitRenderer, sa uiPoster, AtomicReference<o9> sdkConfig, ScheduledExecutorService backgroundExecutorService, com.chartboost.sdk.impl.d adApiCallbackSender, s9 session, n1 base64Wrapper, m4 eventTracker, Function0<Integer> androidVersion) {
    ...
    public final void b(Rewarded ad, RewardedCallback callback) {
        ...
        if (g(ad.getLocation())) {
            ...
            a(ma.i.FINISH_FAILURE, "Invalid configuration. Check logs for more details.", u.c.g, ad.getLocation());
        } else if (b()) {
    ...
    public final void a(Rewarded ad, RewardedCallback callback, String bidResponse) {
        Intrinsics.checkNotNullParameter(ad, "ad");
        Intrinsics.checkNotNullParameter(callback, "callback");
        if (g(ad.getLocation())) {
            this.uiPoster.a(new b(callback, ad));
            a(ma.a.FINISH_FAILURE, "Invalid configuration. Check logs for more details.", u.c.g, ad.getLocation());
        } else {
    ...
    public /* synthetic */ h9(y yVar, g0 g0Var, sa saVar, AtomicReference atomicReference, ScheduledExecutorService scheduledExecutorService, com.chartboost.sdk.impl.d dVar, s9 s9Var, n1 n1Var, m4 m4Var, Function0 function0, int i, DefaultConstructorMarker defaultConstructorMarker) {
