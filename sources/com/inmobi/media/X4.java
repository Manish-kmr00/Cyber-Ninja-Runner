...
public final class X4 extends Sc {
    ...
    public X4(Context context, C3313b7 mAdContainer, Vc mViewableAd, L4 l4) {
        super(mAdContainer);
    ...
    public final void a(HashMap map) {
        ...
        try {
            ...
            if (context != null && viewB != null && !this.e.t) {
                ...
                c3397h7.a(context, viewB, c3313b7, c3313b7.i(), this.d.getViewability());
            }
        } catch (Exception e) {
            L4 l6 = this.g;
            if (l6 != null) {
                String TAG2 = this.h;
                Intrinsics.checkNotNullExpressionValue(TAG2, "TAG");
                ((M4) l6).b(TAG2, "Exception in startTrackingForImpression with message : " + e.getMessage());
            }
            C3339d5 c3339d5 = C3339d5.f3292a;
            P1 event = new P1(e);
            Intrinsics.checkNotNullParameter(event, "event");
    ...
    public final void a(Context context, byte b) {
        ...
        if (l4 != null) {
            String TAG = this.h;
            Intrinsics.checkNotNullExpressionValue(TAG, "TAG");
            ((M4) l4).a(TAG, "onActivityStateChanged - " + ((int) b));
        }
        try {
            if (b == 0) {
                C3397h7 c3397h7 = this.j;
