...
public final class V1 implements InterfaceC3308b2 {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final /* synthetic */ X1 f3214a;
    ...
    public final void a(T1 click, I3 errorCode) {
        ...
        L4 l4 = this.f3214a.f3232a;
        if (l4 != null) {
            String strF = C3364f2.f();
            ((M4) l4).b(strF, O5.a(strF, "access$getTAG$p(...)", "Pinging click (").append(click.b).append(") via HTTP failed ...").toString());
        }
