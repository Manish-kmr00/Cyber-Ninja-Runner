...
public class MOfferModel implements NoProGuard {
    ...
    private final String TNUM = CSSFontFeatureSettings.FEATURE_TNUM;
    ...
    class g implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            try {
                if (MOfferModel.this.mCampaignUnit == null || MOfferModel.this.mCampaignUnit.ads == null || MOfferModel.this.mCampaignUnit.ads.size() <= 0 || (campaignEx = MOfferModel.this.mCampaignUnit.ads.get(this.f5731a)) == null) {
                    return;
                }
    ...
    class h implements com.mbridge.msdk.foundation.same.image.c {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ RoundImageView f5732a;

        h(RoundImageView roundImageView) {
            this.f5732a = roundImageView;
        }
        ...
        public void onSuccessLoad(Bitmap bitmap, String str) {
            try {
                if (this.f5732a != null && bitmap != null && !bitmap.isRecycled()) {
                    this.f5732a.setBorderRadius(13);
    ...
    private View buildItemView(int i2) {
        ...
        View viewInflate = LayoutInflater.from(this.mContext).inflate(g0.a(context, "mbridge_reward_end_card_more_offer_item", "layout"), (ViewGroup) null, false);
        int iA = g0.a(this.mContext, "mbridge_reward_end_card_item_iv", "id");
        if (viewInflate == null) {
            return null;
        }
        setOfferData(this.mCampaignUnit.getAds(), i2, (RoundImageView) viewInflate.findViewById(iA), (TextView) viewInflate.findViewById(g0.a(this.mContext, "mbridge_reward_end_card_item_title_tv", "id")));
        viewInflate.setOnClickListener(new g(i2, viewInflate));
        return viewInflate;
    }
    ...
    private void buildRequestParams(CampaignEx campaignEx) {
        ...
        String strA = z0.a(campaignEx.getendcard_url(), "mof_testuid");
        if (TextUtils.isEmpty(strA)) {
            strA = z0.a(campaignEx.getendcard_url(), "mof_uid");
        }
        String strB = com.mbridge.msdk.foundation.controller.c.m().b();
        try {
            strK = (TextUtils.isEmpty(strB) || com.mbridge.msdk.setting.h.b().d(strB) == null) ? "CN" : com.mbridge.msdk.setting.h.b().d(strB).k();
        } catch (Exception unused) {
        }
        String strA2 = z0.a(campaignEx.getendcard_url(), "mcc");
        String strA3 = z0.a(campaignEx.getendcard_url(), "mnc");
        String strA4 = z0.a(campaignEx.getendcard_url(), "rv_tid");
        String strA5 = campaignEx.getendcard_url().contains("ecid") ? z0.a(campaignEx.getendcard_url(), "ecid") : String.valueOf(campaignEx.getEcTemplateId());
        String strA6 = z0.a(campaignEx.getendcard_url(), "tplgp");
        String strA7 = z0.a(campaignEx.getendcard_url(), "v_fmd5");
        String strA8 = z0.a(campaignEx.getendcard_url(), "i_fmd5");
        com.mbridge.msdk.foundation.same.net.utils.b.a(this.mParam, "app_id", com.mbridge.msdk.foundation.controller.c.m().b());
        com.mbridge.msdk.foundation.same.net.utils.b.a(this.mParam, "sign", SameMD5.getMD5(strB + com.mbridge.msdk.foundation.controller.c.m().c()));
        String str = "";
        ...
        com.mbridge.msdk.foundation.same.net.utils.b.a(this.mParam, "country_code", TextUtils.isEmpty(strK) ? "CN" : strK);
        ...
        this.mParam.a("parent_ad_type", str);
        ...
        com.mbridge.msdk.foundation.same.net.utils.b.a(this.mParam, CSSFontFeatureSettings.FEATURE_TNUM, "20");
        ...
        com.mbridge.msdk.foundation.same.net.utils.b.a(this.mParam, MBridgeConstans.PROPERTIES_UNIT_ID, strA);
    ...
    private void buildScrollViewGroup() {
        ...
        for (int i2 = 0; i2 < this.mCampaignUnit.ads.size(); i2++) {
            View viewBuildItemView = buildItemView(i2);
    ...
    private void doAdmfContorl() {
        ...
        try {
            ...
            if (campaignEx != null && !TextUtils.isEmpty(campaignEx.getMoreOfferJsonData())) {
                JSONObject jSONObjectJsonObjectInit = MintegralNetworkBridge.jsonObjectInit(this.mMainOfferCampaignEx.getMoreOfferJsonData());
                int i2 = this.mFromType;
                if (i2 != 1) {
                    jSONObject = i2 != 2 ? null : jSONObjectJsonObjectInit.getJSONObject(CampaignEx.ENDCARD_URL);
                } else {
                    jSONObject = jSONObjectJsonObjectInit.getJSONObject("template_url");
                }
                if (jSONObject == null) {
                    return;
                }
    ...
    private void initData() {
        ...
        if (!TextUtils.isEmpty(this.mMainOfferCampaignEx.getReq_ext_data())) {
            try {
                JSONObject jSONObjectJsonObjectInit = MintegralNetworkBridge.jsonObjectInit(this.mMainOfferCampaignEx.getReq_ext_data());
                String strOptString = jSONObjectJsonObjectInit.optString("mof_domain");
                if (!TextUtils.isEmpty(strOptString)) {
                    str2 = strOptString + "/openapi/ad/v3";
                }
                String strOptString2 = jSONObjectJsonObjectInit.optString("parent_id");
                if (!TextUtils.isEmpty(strOptString2)) {
                    com.mbridge.msdk.foundation.same.net.utils.b.a(this.mParam, "mof_parent_id", strOptString2);
                }
                String strOptString3 = jSONObjectJsonObjectInit.optString("oneId");
                if (!TextUtils.isEmpty(strOptString3)) {
                    com.mbridge.msdk.foundation.same.net.utils.b.a(this.mParam, "oneId", strOptString3);
                }
                String strOptString4 = jSONObjectJsonObjectInit.optString("mcd");
    ...
    private void setOfferData(List<CampaignEx> list, int i2, RoundImageView roundImageView, TextView textView) {
        ...
        String strA = z0.a(this.mMainOfferCampaignEx.getendcard_url(), "mof_textmod");
    ...
    class c extends com.mbridge.msdk.video.dynview.request.abs.a {
        ...
        public void a(int i, String str) {
            ...
            try {
                ...
                mOfferModel2.mRid = mOfferModel2.mParam.a().get("r_id");
                if (!MOfferModel.this.hasReportMoreOfferLoad) {
                    com.mbridge.msdk.video.dynview.request.a.a(MOfferModel.this.mMainOfferCampaignEx, com.mbridge.msdk.foundation.controller.c.m().d(), "more offer load failed errorCode:" + i + "errorMsg:" + str, MOfferModel.this.mUnitId, MOfferModel.this.mRid);
                    MOfferModel.this.hasReportMoreOfferLoad = true;
                }
                com.mbridge.msdk.foundation.same.report.metrics.e eVar = new com.mbridge.msdk.foundation.same.report.metrics.e();
                eVar.a("result", "2");
