...
public abstract class BTBaseView extends FrameLayout {
    ...
    protected JSONObject a(int i) {
        ...
        try {
            ...
            try {
                jSONObject2.put(a.h, t0.b(com.mbridge.msdk.foundation.controller.c.m().d(), this.i));
                jSONObject2.put(a.i, t0.b(com.mbridge.msdk.foundation.controller.c.m().d(), this.j));
    ...
    public int findColor(String str) {
        return g0.a(this.f5682a.getApplicationContext(), str, "color");
    }

    public int findDrawable(String str) {
        return g0.a(this.f5682a.getApplicationContext(), str, "drawable");
    }

    public int findID(String str) {
        return g0.a(this.f5682a.getApplicationContext(), str, "id");
    }

    public int findLayout(String str) {
        return g0.a(this.f5682a.getApplicationContext(), str, "layout");
    }
    ...
    public boolean isLandscape() {
        return this.f5682a.getResources().getConfiguration().orientation == 2;
    }
