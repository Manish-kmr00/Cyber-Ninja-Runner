...
public class NativeAdvancedExpandDialog extends Dialog {
    ...
    class d implements DialogInterface.OnDismissListener {
        ...
        public void onDismiss(DialogInterface dialogInterface) {
            ...
            MintegralNetworkBridge.webviewLoadDataWithBaseURL(NativeAdvancedExpandDialog.this.e, null, "", POBCommonConstants.CONTENT_TYPE_HTML, cc.N, null);
    ...
    class e implements com.mbridge.msdk.mbsignalcommon.mraid.b {
        ...
        public void useCustomClose(boolean z) {
            try {
                ...
                o0.b("NativeAdvancedExpandDialog", MraidJsMethods.USE_CUSTOM_CLOSE, th);
            }
        }
    }
    ...
    public NativeAdvancedExpandDialog(Context context, Bundle bundle, com.mbridge.msdk.advanced.middle.a aVar) {
        super(context);
        this.f4712a = "NativeAdvancedExpandDialog";
        this.j = new e();
        if (bundle != null) {
