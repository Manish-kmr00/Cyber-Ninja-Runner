...
public class SplashExpandDialog extends Dialog {
    ...
    class d implements DialogInterface.OnDismissListener {
        ...
        public void onDismiss(DialogInterface dialogInterface) {
            ...
            MintegralNetworkBridge.webviewLoadDataWithBaseURL(SplashExpandDialog.this.e, null, "", POBCommonConstants.CONTENT_TYPE_HTML, cc.N, null);
    ...
    class e implements com.mbridge.msdk.mbsignalcommon.mraid.b {
        ...
        public void open(String str) {
            try {
                if (SplashExpandDialog.this.e == null || System.currentTimeMillis() - SplashExpandDialog.this.e.lastTouchTime <= com.mbridge.msdk.click.utils.a.c || !com.mbridge.msdk.click.utils.a.a((CampaignEx) SplashExpandDialog.this.h.get(0), SplashExpandDialog.this.e.getUrl(), com.mbridge.msdk.click.utils.a.f4757a)) {
                ...
                o0.b("SplashExpandDialog", "open", th);
            }
        }
        ...
        public void useCustomClose(boolean z) {
            try {
                ...
                o0.b("SplashExpandDialog", MraidJsMethods.USE_CUSTOM_CLOSE, th);
            }
        }
    }
    ...
    public SplashExpandDialog(Context context, Bundle bundle, com.mbridge.msdk.splash.middle.a aVar) {
        super(context);
        this.f5452a = "SplashExpandDialog";
        this.j = new e();
        if (bundle != null) {
    ...
    public void c() {
        ...
        try {
            ...
            o0.b("SplashExpandDialog", "notifyMraid", th);
        }
    }
