...
public class MBImageView extends ImageView implements InterBase {
    ...
    private Map<String, Boolean> f4766a;
    private String b;
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f4767a[c.layout_height.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f4767a[c.visibility.ordinal()] = 3;
    ...
    public ViewGroup.LayoutParams generateLayoutParams(Context context, AttributeSet attributeSet) {
        ...
        for (int i = 0; i < attributeCount; i++) {
            ...
            if (cVar != null) {
                int i2 = AnonymousClass1.f4767a[cVar.ordinal()];
                if (i2 == 1) {
    ...
    protected void onAttachedToWindow() {
        ...
        Map<String, Boolean> map = this.f4766a;
        if (map != null && map.containsKey("mbridgeAttached") && this.f4766a.get("mbridgeAttached").booleanValue()) {
    ...
    protected void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f4766a;
        if (map != null && map.containsKey("mbridgeDetached") && this.f4766a.get("mbridgeDetached").booleanValue()) {
    ...
    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f4766a = com.mbridge.msdk.dycreator.utils.c.a(str);
        if (campaignEx != null) {
