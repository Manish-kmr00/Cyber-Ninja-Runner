...
public class a {
    ...
    /* JADX INFO: renamed from: com.mbridge.msdk.setting.util.a$a, reason: collision with other inner class name */
    /* JADX INFO: compiled from: MraidJSController.java */
    class C0486a extends com.mbridge.msdk.foundation.same.net.handler.a {
        ...
        public void a(String str) {
            o0.a("MraidJSController", "fail request mraid js. " + str);
        }

        @Override // com.mbridge.msdk.foundation.same.net.handler.a
        public void b(String str) {
            o0.a("MraidJSController", "request mraid js success, content = " + str);
    ...
    public String b() {
        try {
            if (TextUtils.isEmpty(this.f5400a)) {
                this.f5400a = c();
            }
            if (!TextUtils.isEmpty(this.f5400a)) {
                return this.f5400a;
            ...
            if (gVarD != null && !TextUtils.isEmpty(gVarD.O())) {
                a(com.mbridge.msdk.foundation.controller.c.m().d(), gVarD.O());
            }
            return b;
    ...
    public void a(Context context, String str) {
        ...
        String strA = com.mbridge.msdk.foundation.buffer.sharedperference.a.b().a("MraidJSController");
        if (TextUtils.isEmpty(strA) || !strA.equals(str)) {
            try {
                new com.mbridge.msdk.setting.net.a(context).get(0, str, (com.mbridge.msdk.foundation.same.net.wrapper.e) null, new C0486a(str), "mraid_js", 60000L);
            } catch (Exception e) {
                o0.b("MraidJSController", e.getMessage());
            }
        }
    }
