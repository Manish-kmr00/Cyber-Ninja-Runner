    ...
    private void changeSpeed(float f) {
        ...
        do {
            if (this.remainingInputToCopyFrameCount > 0) {
                ...
                iSkipPitchPeriod = ((double) f) > 1.0d ? iFindPitchPeriod + skipPitchPeriod(this.inputBuffer, i2, f, iFindPitchPeriod) : insertPitchPeriod(this.inputBuffer, i2, f, iFindPitchPeriod);
            }
            i2 += iSkipPitchPeriod;
