...
public class DefaultTrackSelector extends MappingTrackSelector {
    ...
    private static TrackSelection selectFixedVideoTrack(TrackGroupArray trackGroupArray, int[][] iArr, Parameters parameters) {
        ...
        int i7 = 0;
        int i8 = 0;
        while (i6 < trackGroupArray.length) {
            ...
            while (i9 < trackGroup2.length) {
                if (isSupported(iArr2[i9], parameters.exceedRendererCapabilitiesIfNecessary)) {
                    ...
                    boolean z = true;
                    boolean z2 = viewportFilteredTrackIndices.contains(Integer.valueOf(i9)) && ((i = format.width) == i4 || i <= parameters.maxVideoWidth) && (((i2 = format.height) == i4 || i2 <= parameters.maxVideoHeight) && ((i3 = format.bitrate) == i4 || i3 <= parameters.maxVideoBitrate));
                    if (z2 || parameters.exceedVideoConstraintsIfNecessary) {
                        ...
                        if (i10 != i8) {
                            ...
                            int iCompareFormatValues = pixelCount2 != pixelCount ? compareFormatValues(pixelCount2, pixelCount) : compareFormatValues(format.bitrate, i5);
                            if (!zIsSupported || !z2 ? iCompareFormatValues >= 0 : iCompareFormatValues <= 0) {
                                z = false;
                            }
                        } else if (compareFormatValues(format.bitrate, i5) >= 0) {
                            z = false;
                        }
                        if (z) {
                            i5 = format.bitrate;
    ...
    protected TrackSelection[] selectAllTracks(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, int[] iArr2, Parameters parameters) throws ExoPlaybackException {
        ...
        while (true) {
            ...
            if (2 == mappedTrackInfo.getRendererType(i)) {
                if (!z) {
                    TrackSelection trackSelectionSelectVideoTrack = selectVideoTrack(mappedTrackInfo.getTrackGroups(i), iArr[i], iArr2[i], parameters, this.adaptiveTrackSelectionFactory);
                    trackSelectionArr[i] = trackSelectionSelectVideoTrack;
                    z = trackSelectionSelectVideoTrack != null;
                }
            ...
            if (rendererType != 1) {
                if (rendererType != 2) {
                    if (rendererType != 3) {
                        ...
                        TrackSelection trackSelectionSelectTextTrack = selectTextTrack(mappedTrackInfo.getTrackGroups(i2), iArr[i2], parameters);
                        trackSelectionArr[i2] = trackSelectionSelectTextTrack;
                        z4 = trackSelectionSelectTextTrack != null;
                    }
                }
            } else if (!z3) {
                TrackSelection trackSelectionSelectAudioTrack = selectAudioTrack(mappedTrackInfo.getTrackGroups(i2), iArr[i2], iArr2[i2], parameters, z2 ? null : this.adaptiveTrackSelectionFactory);
                trackSelectionArr[i2] = trackSelectionSelectAudioTrack;
                z3 = trackSelectionSelectAudioTrack != null;
            }
        }
            ...
            for (int i4 = 0; i4 < trackGroup2.length; i4++) {
                if (isSupported(iArr2[i4], parameters.exceedRendererCapabilitiesIfNecessary)) {
                    ...
                    if (hasLanguage || (parameters.selectUndeterminedTextLanguage && formatHasNoLanguage(format))) {
                        i6 = (b == true ? 8 : b2 == false ? 6 : 4) + (hasLanguage ? 1 : 0);
                    } else if (b == true) {
                        i6 = 3;
                    } else if (b2 != false) {
    ...
    protected final Pair<RendererConfiguration[], TrackSelection[]> selectTracks(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, int[] iArr2) throws ExoPlaybackException {
        ...
        for (int i2 = 0; i2 < rendererCount; i2++) {
            rendererConfigurationArr[i2] = (parameters.getRendererDisabled(i2) || (mappedTrackInfo.getRendererType(i2) != 5 && trackSelectionArrSelectAllTracks[i2] == null)) ? null : RendererConfiguration.DEFAULT;
        }
