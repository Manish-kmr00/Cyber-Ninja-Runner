...
public final class ColorInfo implements Parcelable {
    ...
    public int hashCode() {
        if (this.hashCode == 0) {
            this.hashCode = ((((((this.colorSpace + IronSourceError.ERROR_NON_EXISTENT_INSTANCE) * 31) + this.colorRange) * 31) + this.colorTransfer) * 31) + Arrays.hashCode(this.hdrStaticInfo);
        }
