...
final class DefaultEbmlReader implements EbmlReader {
    ...
    private double readFloat(ExtractorInput extractorInput, int i) throws InterruptedException, IOException {
        long integer = readInteger(extractorInput, i);
        return i == 4 ? Float.intBitsToFloat((int) integer) : Double.longBitsToDouble(integer);
    }

    private long readInteger(ExtractorInput extractorInput, int i) throws InterruptedException, IOException {
    ...
    private String readString(ExtractorInput extractorInput, int i) throws InterruptedException, IOException {
        if (i == 0) {
            return "";
        }
