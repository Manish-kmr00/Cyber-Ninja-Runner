...
final class FlacReader extends StreamReader {
    ...
    protected boolean readHeaders(ParsableByteArray parsableByteArray, long j, StreamReader.SetupData setupData) throws InterruptedException, IOException {
        ...
        if (this.streamInfo == null) {
            ...
            setupData.format = Format.createAudioSampleFormat(null, "audio/flac", null, -1, iBitRate, flacStreamInfo.channels, flacStreamInfo.sampleRate, listSingletonList, null, 0, null);
            return true;
        }
        if ((bArr[0] & 127) == 3) {
