...
public final class WebvttCueParser {
    ...
    private static final class StartTag {
        ...
        public static StartTag buildStartTag(String str, int i) {
            ...
            String[] strArrSplit = Util.split(strTrim, DnsName.ESCAPED_DOT);
            return new StartTag(strArrSplit[0], i, str2, strArrSplit.length > 1 ? (String[]) Arrays.copyOfRange(strArrSplit, 1, strArrSplit.length) : NO_CLASSES);
        }
