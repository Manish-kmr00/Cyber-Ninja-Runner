...
public class SimpleExoPlayer implements ExoPlayer, Player.VideoComponent, Player.TextComponent {
    ...
    protected SimpleExoPlayer(RenderersFactory renderersFactory, TrackSelector trackSelector, LoadControl loadControl, DrmSessionManager<FrameworkMediaCrypto> drmSessionManager) {
        this(renderersFactory, trackSelector, loadControl, drmSessionManager, (StatsEvent) null);
    ...
    protected SimpleExoPlayer(RenderersFactory renderersFactory, TrackSelector trackSelector, LoadControl loadControl, DrmSessionManager<FrameworkMediaCrypto> drmSessionManager, AnalyticsCollector.Factory factory) {
        this(renderersFactory, trackSelector, loadControl, drmSessionManager, factory, (StatsEvent) null);
    ...
    protected SimpleExoPlayer(RenderersFactory renderersFactory, TrackSelector trackSelector, LoadControl loadControl, DrmSessionManager<FrameworkMediaCrypto> drmSessionManager, AnalyticsCollector.Factory factory, Clock clock) {
        this(renderersFactory, trackSelector, loadControl, drmSessionManager, factory, clock, null);
        Logger.d("Mintegral|SafeDK: Execution> Lcom/mbridge/msdk/playercommon/exoplayer2/SimpleExoPlayer;-><init>(Lcom/mbridge/msdk/playercommon/exoplayer2/RenderersFactory;Lcom/mbridge/msdk/playercommon/exoplayer2/trackselection/TrackSelector;Lcom/mbridge/msdk/playercommon/exoplayer2/LoadControl;Lcom/mbridge/msdk/playercommon/exoplayer2/drm/DrmSessionManager;Lcom/mbridge/msdk/playercommon/exoplayer2/analytics/AnalyticsCollector$Factory;Lcom/mbridge/msdk/playercommon/exoplayer2/util/Clock;)V");
        CreativeInfoManager.onVideoStart(h.o, this, "exo-player");
    }

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    private SimpleExoPlayer(RenderersFactory p1, TrackSelector p2, LoadControl p3, DrmSessionManager p4, StatsEvent p5) {
        this(p1, p2, p3, (DrmSessionManager<FrameworkMediaCrypto>) p4, new AnalyticsCollector.Factory());
        Logger.d("Mintegral|SafeDK: Execution> Lcom/mbridge/msdk/playercommon/exoplayer2/SimpleExoPlayer;-><init>(Lcom/mbridge/msdk/playercommon/exoplayer2/RenderersFactory;Lcom/mbridge/msdk/playercommon/exoplayer2/trackselection/TrackSelector;Lcom/mbridge/msdk/playercommon/exoplayer2/LoadControl;Lcom/mbridge/msdk/playercommon/exoplayer2/drm/DrmSessionManager;)V");
    ...
    @Override // com.mbridge.msdk.playercommon.exoplayer2.Player
    public void release() {
        Logger.d("Mintegral|SafeDK: Execution> Lcom/mbridge/msdk/playercommon/exoplayer2/SimpleExoPlayer;->release()V");
        CreativeInfoManager.onVideoCompleted(h.o, this, "exo-player");
        safedk_SimpleExoPlayer_release_72804aa32e024570d0a1198bedc3bdd2();
    }
    ...
    public void safedk_SimpleExoPlayer_release_72804aa32e024570d0a1198bedc3bdd2() {
        this.player.release();
    ...
    public void safedk_SimpleExoPlayer_stop_8c378597668e00d3466a051c09437117() {
        stop(false);
    }
    ...
    @Override // com.mbridge.msdk.playercommon.exoplayer2.Player
    public void stop() {
        Logger.d("Mintegral|SafeDK: Execution> Lcom/mbridge/msdk/playercommon/exoplayer2/SimpleExoPlayer;->stop()V");
        CreativeInfoManager.onVideoCompleted(h.o, this, "exo-player");
        safedk_SimpleExoPlayer_stop_8c378597668e00d3466a051c09437117();
    }

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    private SimpleExoPlayer(RenderersFactory p1, TrackSelector p2, LoadControl p3, DrmSessionManager p4, AnalyticsCollector.Factory p5, StatsEvent p6) {
        this(p1, p2, p3, (DrmSessionManager<FrameworkMediaCrypto>) p4, p5, Clock.DEFAULT);
        Logger.d("Mintegral|SafeDK: Execution> Lcom/mbridge/msdk/playercommon/exoplayer2/SimpleExoPlayer;-><init>(Lcom/mbridge/msdk/playercommon/exoplayer2/RenderersFactory;Lcom/mbridge/msdk/playercommon/exoplayer2/trackselection/TrackSelector;Lcom/mbridge/msdk/playercommon/exoplayer2/LoadControl;Lcom/mbridge/msdk/playercommon/exoplayer2/drm/DrmSessionManager;Lcom/mbridge/msdk/playercommon/exoplayer2/analytics/AnalyticsCollector$Factory;)V");
        if ("Mintegral|SafeDK: Execution> Lcom/mbridge/msdk/playercommon/exoplayer2/SimpleExoPlayer;-><init>(Lcom/mbridge/msdk/playercommon/exoplayer2/RenderersFactory;Lcom/mbridge/msdk/playercommon/exoplayer2/trackselection/TrackSelector;Lcom/mbridge/msdk/playercommon/exoplayer2/LoadControl;Lcom/mbridge/msdk/playercommon/exoplayer2/drm/DrmSessionManager;Lcom/mbridge/msdk/playercommon/exoplayer2/analytics/AnalyticsCollector$Factory;)V" == 0) {
        } else {
            this(p1, p2, p3, (DrmSessionManager<FrameworkMediaCrypto>) p4, p5, Clock.DEFAULT);
        }
    }
    ...
    private SimpleExoPlayer(RenderersFactory p1, TrackSelector p2, LoadControl p3, DrmSessionManager p4, AnalyticsCollector.Factory p5, Clock p6, StatsEvent p7) {
        Logger.d("Mintegral|SafeDK: Execution> Lcom/mbridge/msdk/playercommon/exoplayer2/SimpleExoPlayer;-><init>(Lcom/mbridge/msdk/playercommon/exoplayer2/RenderersFactory;Lcom/mbridge/msdk/playercommon/exoplayer2/trackselection/TrackSelector;Lcom/mbridge/msdk/playercommon/exoplayer2/LoadControl;Lcom/mbridge/msdk/playercommon/exoplayer2/drm/DrmSessionManager;Lcom/mbridge/msdk/playercommon/exoplayer2/analytics/AnalyticsCollector$Factory;Lcom/mbridge/msdk/playercommon/exoplayer2/util/Clock;)V");
        ...
        Renderer[] rendererArrCreateRenderers = p1.createRenderers(handler, componentListener, componentListener, componentListener, componentListener, p4);
        ...
        this.currentCues = Collections.emptyList();
        ExoPlayer exoPlayerCreateExoPlayerImpl = createExoPlayerImpl(rendererArrCreateRenderers, p2, p3, p6);
        this.player = exoPlayerCreateExoPlayerImpl;
        AnalyticsCollector analyticsCollectorCreateAnalyticsCollector = p5.createAnalyticsCollector(exoPlayerCreateExoPlayerImpl, p6);
        ...
        if (p4 instanceof DefaultDrmSessionManager) {
            ((DefaultDrmSessionManager) p4).addListener(handler, analyticsCollectorCreateAnalyticsCollector);
        }
    }
