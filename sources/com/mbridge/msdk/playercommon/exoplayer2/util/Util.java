...
public final class Util {
    ...
    public static String getUserAgent(Context context, String str) {
        ...
        return str + RemoteSettings.FORWARD_SLASH_STRING + str2 + " (Linux;Android " + Build.VERSION.RELEASE + ") ExoPlayerLib/2.8.4";
    }
    ...
    public static int inferContentType(Uri uri, String str) {
        return TextUtils.isEmpty(str) ? inferContentType(uri) : inferContentType("." + str);
    }
    ...
    public static String unescapeFileName(String str) {
        ...
        while (i > 0 && matcher.find()) {
            sb.append((CharSequence) str, iEnd, matcher.start()).append((char) Integer.parseInt(matcher.group(1), 16));
            iEnd = matcher.end();
            i--;
        }
        if (iEnd < length) {
    ...
    /* JADX WARN: Code duplicated, block: B:35:0x00ac A[Catch: NumberFormatException -> 0x00c2, TryCatch #0 {NumberFormatException -> 0x00c2, blocks: (B:33:0x009e, B:35:0x00ac, B:38:0x00bc), top: B:53:0x009e }] */
    /* JADX WARN: Code duplicated, block: B:53:0x009e A[EXC_TOP_SPLITTER, SYNTHETIC] */
            ...
            if (!"NVIDIA".equals(str2) || !MODEL.contains("SHIELD")) {
                if ("philips".equals(toLowerInvariant(str2))) {
                    ...
                    if (str3.startsWith("QM1") || str3.equals("QV151E") || str3.equals("TPM171E")) {
                        ...
                        if (!TextUtils.isEmpty(str)) {
                            try {
                                strArrSplit = split(str.trim(), VastAttributes.HORIZONTAL_POSITION);
                ...
                str = (String) cls2.getMethod("get", String.class).invoke(cls2, "sys.display-size");
                if (!TextUtils.isEmpty(str)) {
                    strArrSplit = split(str.trim(), VastAttributes.HORIZONTAL_POSITION);
                    if (strArrSplit.length == 2) {
                        i = Integer.parseInt(strArrSplit[0]);
