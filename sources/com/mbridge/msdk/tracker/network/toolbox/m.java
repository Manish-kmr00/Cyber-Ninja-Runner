...
public class m extends a {
    ...
    public g a(com.mbridge.msdk.tracker.network.t<?> tVar, Map<String, String> map) throws IOException {
        ...
        if (this.f5649a != null) {
            ...
            t.b bVarA = this.f5649a.s().a(arrayList).a(new MBridgeHostnameVerifier(strA));
            long j2 = iQ;
            TimeUnit timeUnit = TimeUnit.MILLISECONDS;
            t.b bVarA2 = bVarA.d(j2, timeUnit).b(j2, timeUnit).a(pVarH == null ? com.mbridge.msdk.thrid.okhttp.m.f5570a : new j(pVarH.H(), pVarH.b(), pVarH)).e(j2, timeUnit).a(Math.max(jR, 0L), timeUnit);
            a(pVarH, bVarA2);
            w.a aVar = new w.a();
