...
public class MBNewInterstitialHandler implements BaseExtraInterfaceForHandler {
    ...
    public void load() {
        a();
        if (this.f != null) {
            this.f.a(true, d.b().a(0, 287, this.g, true, 2));
        }
    }
    ...
    public void loadFormSelfFilling() {
        a();
        if (this.f != null) {
            this.f.a(false, d.b().a(0, 287, this.g, true, 1));
        }
    }
    ...
    public void show() {
        a();
        if (this.f != null) {
            this.f.a((String) null, (String) null, (String) null, d.b().a(0, 287, this.g, false, -1));
        }
    }
