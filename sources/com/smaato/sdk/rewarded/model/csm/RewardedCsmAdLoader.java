...
public class RewardedCsmAdLoader {
    ...
    public void loadAd() {
        ...
        interstitialNetworkEvent.requestRewardedInterstitial(context, rewardedCsmDelegate, mapCreateParamsMap, map);
    }
    ...
    private Consumer createOnAdLoadedRunnable(final Network network) {
        return new Consumer() { // from class: com.smaato.sdk.rewarded.model.csm.RewardedCsmAdLoader$$ExternalSyntheticLambda0
            ...
            public final void accept(Object obj) {
                this.f$0.m5630x7fa72f36(network, (InterstitialCsmBaseDelegate) obj);
            }
        };
    }

    /* JADX INFO: renamed from: lambda$createOnAdLoadedRunnable$0$com-smaato-sdk-rewarded-model-csm-RewardedCsmAdLoader, reason: not valid java name */
    /* synthetic */ void m5630x7fa72f36(Network network, InterstitialCsmBaseDelegate interstitialCsmBaseDelegate) {
    ...
    private SMARewardedNetworkEvent getInterstitialNetworkEvent(Network network) {
        ...
        ServiceLoader serviceLoaderLoad = ServiceLoader.load(SMARewardedNetworkEvent.class, this.context.getClassLoader());
        if (serviceLoaderLoad == null) {
            return null;
        }
        return (SMARewardedNetworkEvent) Iterables.filterFirst(serviceLoaderLoad, new Predicate() { // from class: com.smaato.sdk.rewarded.model.csm.RewardedCsmAdLoader$$ExternalSyntheticLambda1
            @Override // com.smaato.sdk.core.util.fi.Predicate
            public final boolean test(Object obj) {
                return ((SMARewardedNetworkEvent) obj).getNetworkName().equalsIgnoreCase(className);
            }
        });
    }
