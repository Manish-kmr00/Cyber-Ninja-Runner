...
public class omh extends SGo {
    ...
    protected void pA(Context context) {
        ...
        int iKZx3 = Vgu.KZx(context, 15.0f);
        int iKZx4 = Vgu.KZx(context, 20.0f);
        ...
        layoutParams2.rightMargin = iKZx3;
        layoutParams2.leftMargin = iKZx3;
        layoutParams2.bottomMargin = iKZx3;
        layoutParams2.setMarginEnd(iKZx3);
        layoutParams2.setMarginStart(iKZx3);
        ...
        layoutParams4.leftMargin = iKZx4;
        layoutParams4.setMarginStart(iKZx4);
        ...
        RelativeLayout.LayoutParams layoutParams5 = new RelativeLayout.LayoutParams(Vgu.KZx(context, 100.0f), Vgu.KZx(context, 30.0f));
        layoutParams5.addRule(21);
        layoutParams5.addRule(11);
        layoutParams5.addRule(15);
        layoutParams5.rightMargin = iKZx;
        layoutParams5.setMarginEnd(iKZx);
    ...
    protected com.bytedance.sdk.openadsdk.core.ML.omh Og(Context context) {
        ...
        omhVarOg.setMaxWidth(Vgu.KZx(context, 250.0f));
        omhVarOg.setTextColor(-1);
        omhVarOg.setTextSize(2, 17.0f);
