...
public class pA extends SGo {
    ...
    protected void pA(Context context) {
        ...
        sd.setLayoutParams(new LinearLayout.LayoutParams(-2, -2));
        ml2.addView(sd);
        this.KZx = SD(context);
        ...
        LinearLayout.LayoutParams layoutParams7 = new LinearLayout.LayoutParams(-1, Vgu.KZx(context, 32.0f));
