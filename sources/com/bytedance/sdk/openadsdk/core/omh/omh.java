...
public class omh extends com.bytedance.sdk.openadsdk.core.Og.pA {
    public omh(Context context, com.bytedance.sdk.openadsdk.core.model.yFO yfo, String str, int i) {
    ...
    protected com.bytedance.sdk.openadsdk.core.model.SGo pA(float f, float f2, float f3, float f4, SparseArray<com.bytedance.sdk.openadsdk.core.Og.KZx.pA> sparseArray, long j, long j2, View view, View view2, String str, float f5, int i, float f6, int i2, JSONObject jSONObject, JSONObject jSONObject2) {
        ...
        this.vZF = i6;
        return new com.bytedance.sdk.openadsdk.core.model.SGo.pA().JG(f7).ML(f8).ZZv(f9).KZx(fKZx).Og(j3).pA(j4).Og(iArrPA).pA(iArrPA2).KZx(Vgu.KZx(view)).ZZv(iArrKZx).ZZv(this.eG).ML(this.roi).JG(this.Mc).Og(com.bytedance.sdk.openadsdk.core.Bzk.Og().pA() ? i5 : 2).pA(sparseArray).pA(str).pA(f5).KZx(i).Og(f6).pA(i2).pA(jSONObject).Og(jSONObject2).pA();
    }
