...
public class KZx {
    ...
    public static boolean pA() {
        return com.bytedance.sdk.openadsdk.vZF.pA.pA("deeplink_utils_new", 0) == 1;
    }

    public static boolean pA(Context context, String str, yFO yfo, int i, Map<String, Object> map, boolean z) {
        ...
        map.put("can_query_install", Integer.valueOf(zOmh ? 1 : 0));
        map.put("url", str);
        if (zOmh) {
        ...
        try {
            ...
            if (zOmh && !aBv.ZZv().omh()) {
                rB.pA(context, yfo.dC(), yfo, i, strPA, z);
            }
            return false;
        }
    }
