...
public class SGo {
    public static void pA(String str, int i, String str2, String str3, String str4) {
        try {
            ...
            if (yfoPA != null) {
                ...
                if (yfoPA.Wo() != null) {
                    if (!TextUtils.isEmpty(str2)) {
                        yfoPA.Wo().pA(str2);
                        yfoPA.Wo().Og("Test the downloaded app");
                    } else {
                        yfoPA.Wo().pA((String) null);
                        yfoPA.Wo().Og("");
                    }
                    if (TextUtils.isEmpty(str2)) {
                        str2 = str4;
            ...
            arrayList.add(yfoPA);
            pAVar.pA(arrayList);
            new Wx(aBv.pA(), pAVar).pA(true);
        } catch (Exception e) {
            com.bytedance.sdk.component.utils.WV.pA("PlayableVerityHelper", e.getMessage());
        }
    }
}
