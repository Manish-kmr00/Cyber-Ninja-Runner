...
class ZZv {
    ...
    public void pA(String str, yFO yfo) {
        if (com.bytedance.sdk.openadsdk.common.pA.pA()) {
            com.bytedance.sdk.openadsdk.common.pA.pA("sp_full_screen_video").pA(str, yfo);
            return;
        }
    ...
    public void pA() {
        ...
        if (com.bytedance.sdk.openadsdk.common.pA.pA()) {
            com.bytedance.sdk.openadsdk.common.pA.pA("sp_full_screen_video").Og();
            return;
        }
        try {
            boolean zSD = com.bytedance.sdk.openadsdk.core.Bzk.SD("sp_full_screen_video");
            if (zSD) {
            ...
            if (file.exists() && file.isDirectory() && (fileArrListFiles2 = file.listFiles(new FileFilter() { // from class: com.bytedance.sdk.openadsdk.component.reward.ZZv.1
        ...
        try {
            ...
            if (cacheDir == null || !cacheDir.exists() || !cacheDir.isDirectory() || (fileArrListFiles = cacheDir.listFiles(new FileFilter() { // from class: com.bytedance.sdk.openadsdk.component.reward.ZZv.2
                @Override // java.io.FileFilter
    ...
    public void pA(AdSlot adSlot, com.bytedance.sdk.openadsdk.core.model.pA pAVar) {
        yFO yfoJG;
        if (com.bytedance.sdk.openadsdk.common.pA.pA()) {
            com.bytedance.sdk.openadsdk.common.pA.pA("sp_full_screen_video").pA(adSlot, pAVar);
            return;
        }
        ...
        try {
            this.KZx.pA(adSlot, pAVar.Wx().toString(), pAVar.Og());
        } catch (Throwable unused) {
        }
    }

    public static ZZv pA(Context context) {
        if (pA == null) {
    ...
    private ZZv(Context context) {
        ...
        this.KZx = new com.bytedance.sdk.openadsdk.common.pA.Og("sp_full_screen_video");
    }

    public String pA(yFO yfo) {
        if (com.bytedance.sdk.openadsdk.common.pA.pA()) {
            return com.bytedance.sdk.openadsdk.common.pA.pA("sp_full_screen_video").pA(yfo);
        }
    ...
    public String pA(String str, String str2, int i) {
        if (com.bytedance.sdk.openadsdk.common.pA.pA()) {
            return com.bytedance.sdk.openadsdk.common.pA.pA("sp_full_screen_video").pA(str, str2, i);
        }
        if (TextUtils.isEmpty(str)) {
            return null;
        }
    ...
    public com.bytedance.sdk.openadsdk.core.model.pA pA(String str, boolean z) {
        ...
        if (com.bytedance.sdk.openadsdk.common.pA.pA()) {
            com.bytedance.sdk.openadsdk.common.pA pAVarPA = com.bytedance.sdk.openadsdk.common.pA.pA("sp_full_screen_video");
    ...
    public void pA(final boolean z, final yFO yfo, final long j, String str) {
        ...
        com.bytedance.sdk.openadsdk.Sn.KZx.pA(str2, false, new com.bytedance.sdk.openadsdk.Sn.Og() { // from class: com.bytedance.sdk.openadsdk.component.reward.ZZv.3
    ...
    public void pA(final yFO yfo, final com.bytedance.sdk.openadsdk.common.pA.InterfaceC0223pA<Object> interfaceC0223pA) {
        ...
        if (com.bytedance.sdk.openadsdk.common.pA.pA()) {
            com.bytedance.sdk.openadsdk.common.pA.pA("sp_full_screen_video").pA(yfo, interfaceC0223pA);
            return;
        }
        ...
        if (yfo.Bf() == null || TextUtils.isEmpty(yfo.Bf().BSW())) {
            ...
            pAVarZZv.pA(new com.bytedance.sdk.component.SD.pA.pA() { // from class: com.bytedance.sdk.openadsdk.component.reward.ZZv.4
                ...
                public void pA(com.bytedance.sdk.component.SD.Og.KZx kZx, com.bytedance.sdk.component.SD.Og og) {
                    if (og.JG() && og.ML() != null && og.ML().exists()) {
                        ...
                        ZZv.this.pA(true, yfo, og.pA(), og.Og());
                        return;
                    }
                    ...
                    ZZv.this.pA(false, yfo, og.pA(), og.Og());
                }
                ...
                public void pA(com.bytedance.sdk.component.SD.Og.KZx kZx, IOException iOException) {
                    ...
                    ZZv.this.pA(false, yfo, -2L, iOException.getMessage());
                }
            });
        }
    }
    ...
    public void pA(String str) {
        if (com.bytedance.sdk.openadsdk.common.pA.pA()) {
            com.bytedance.sdk.openadsdk.common.pA.pA("sp_full_screen_video").Og(str);
        } else {
            this.KZx.SD(str);
        }
    }
