...
public class omh extends aBv {
    public omh() {
        super(com.bytedance.adsdk.pA.Og.ZZv.KZx.LT_EQ);
    }
    ...
    public Object pA(Map<String, JSONObject> map) {
        ...
        return Boolean.valueOf(!((Boolean) com.bytedance.adsdk.pA.Og.ML.pA.KZx.pA(objPA2, (Number) objPA)).booleanValue());
    }
}
