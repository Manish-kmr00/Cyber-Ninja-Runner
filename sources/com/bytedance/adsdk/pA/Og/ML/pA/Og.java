...
public class Og {
    private static boolean pA(int i, Number number) {
    ...
    private static boolean pA(long j, Number number) {
        if ((number instanceof Integer) || (number instanceof Short) || (number instanceof Byte)) {
    ...
    private static boolean pA(float f, Number number) {
        if ((number instanceof Integer) || (number instanceof Short) || (number instanceof Byte)) {
    ...
    private static boolean pA(double d, Number number) {
        if ((number instanceof Integer) || (number instanceof Short) || (number instanceof Byte)) {
    ...
    public static boolean pA(Number number, Number number2) {
        if ((number instanceof Integer) || (number instanceof Short) || (number instanceof Byte)) {
            return pA(number.intValue(), number2);
        }
        if (number instanceof Long) {
            return pA(number.longValue(), number2);
        }
        if (number instanceof Float) {
            return pA(number.floatValue(), number2);
        }
        if (number instanceof Double) {
            return pA(number.doubleValue(), number2);
        }
        throw new UnsupportedOperationException(number.getClass().getName() + "This type of addition operation is not supported");
    }
}
