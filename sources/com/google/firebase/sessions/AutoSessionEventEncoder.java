...
public final class AutoSessionEventEncoder implements Configurator {
    ...
    private static final class SessionEventEncoder implements ObjectEncoder<SessionEvent> {
        ...
        private static final FieldDescriptor APPLICATIONINFO_DESCRIPTOR = FieldDescriptor.of(POBCrashAnalyticsConstants.APPLICATION_INFO_KEY);
    ...
    private static final class SessionInfoEncoder implements ObjectEncoder<SessionInfo> {
        ...
        private static final FieldDescriptor SESSIONID_DESCRIPTOR = FieldDescriptor.of(JsonStorageKeyNames.SESSION_ID_KEY);
    ...
    private static final class DataCollectionStatusEncoder implements ObjectEncoder<DataCollectionStatus> {
        ...
        private static final FieldDescriptor PERFORMANCE_DESCRIPTOR = FieldDescriptor.of(AdExperience.PERFORMANCE);
    ...
    private static final class ApplicationInfoEncoder implements ObjectEncoder<ApplicationInfo> {
        ...
        private static final FieldDescriptor DEVICEMODEL_DESCRIPTOR = FieldDescriptor.of(b9.i.l);
        private static final FieldDescriptor SESSIONSDKVERSION_DESCRIPTOR = FieldDescriptor.of("sessionSdkVersion");
        private static final FieldDescriptor OSVERSION_DESCRIPTOR = FieldDescriptor.of(DtbDeviceData.DEVICE_DATA_OS_VERSION_KEY);
