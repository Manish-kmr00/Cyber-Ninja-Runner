...
public final class SessionFirelogPublisherImpl implements SessionFirelogPublisher {
    ...
    static final class C32881 extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        C32881(Continuation<? super C32881> continuation) {
            super(continuation);
        }
    ...
    public final Object shouldLogSession(Continuation<? super Boolean> continuation) throws Throwable {
        ...
        if (continuation instanceof C32881) {
            ...
            if ((c32881.label & Integer.MIN_VALUE) != 0) {
                c32881.label -= Integer.MIN_VALUE;
            } else {
        ...
        if (i == 0) {
            ...
            c32881.L$0 = this;
            c32881.label = 1;
            if (sessionsSettings.updateSettings(c32881) == coroutine_suspended) {
                return coroutine_suspended;
            }
            ...
            sessionFirelogPublisherImpl = (SessionFirelogPublisherImpl) c32881.L$0;
            ResultKt.throwOnFailure(obj);
        }
