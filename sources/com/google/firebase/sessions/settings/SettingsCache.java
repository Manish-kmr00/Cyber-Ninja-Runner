...
public final class SettingsCache {
    ...
    @DebugMetadata(c = "com.google.firebase.sessions.settings.SettingsCache", f = "SettingsCache.kt", i = {}, l = {Sdk.SDKError.Reason.JSON_ENCODE_ERROR_VALUE}, m = "updateConfigValue", n = {}, s = {})
    static final class C32891<T> extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;

        C32891(Continuation<? super C32891> continuation) {
            super(continuation);
        }
    ...
    public final <T> Object updateConfigValue(Preferences.Key<T> key, T t, Continuation<? super Unit> continuation) throws Throwable {
        C32891 c32891;
        if (continuation instanceof C32891) {
            c32891 = (C32891) continuation;
            if ((c32891.label & Integer.MIN_VALUE) != 0) {
                c32891.label -= Integer.MIN_VALUE;
            } else {
                c32891 = new C32891(continuation);
            }
        } else {
            c32891 = new C32891(continuation);
        }
        Object obj = c32891.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c32891.label;
        try {
            if (i == 0) {
                ...
                c32891.label = 1;
                if (PreferencesKt.edit(dataStore, anonymousClass2, c32891) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i != 1) {
