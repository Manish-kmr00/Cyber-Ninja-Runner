...
public final class SessionsSettings {
    ...
    public final long m5288getSessionRestartTimeoutUwyO8pc() {
        Duration durationMo5286getSessionRestartTimeoutFghU774 = this.localOverrideSettings.mo5286getSessionRestartTimeoutFghU774();
        if (durationMo5286getSessionRestartTimeoutFghU774 != null) {
            long rawValue = durationMo5286getSessionRestartTimeoutFghU774.getRawValue();
            if (m5287isValidSessionRestartTimeoutLRDsOJo(rawValue)) {
                return rawValue;
            }
        }
        Duration durationMo5286getSessionRestartTimeoutFghU775 = this.remoteSettings.mo5286getSessionRestartTimeoutFghU774();
        if (durationMo5286getSessionRestartTimeoutFghU775 != null) {
            long rawValue2 = durationMo5286getSessionRestartTimeoutFghU775.getRawValue();
            if (m5287isValidSessionRestartTimeoutLRDsOJo(rawValue2)) {
                return rawValue2;
            }
        }
    ...
    private final boolean m5287isValidSessionRestartTimeoutLRDsOJo(long sessionRestartTimeout) {
        return Duration.m9266isPositiveimpl(sessionRestartTimeout) && Duration.m9261isFiniteimpl(sessionRestartTimeout);
    }
