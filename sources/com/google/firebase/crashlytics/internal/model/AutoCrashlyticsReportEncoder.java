...
public final class AutoCrashlyticsReportEncoder implements Configurator {
    ...
    private static final class CrashlyticsReportSessionEncoder implements ObjectEncoder<CrashlyticsReport.Session> {
        ...
        private static final FieldDescriptor USER_DESCRIPTOR = FieldDescriptor.of(POBConstants.KEY_USER);
    ...
    private static final class CrashlyticsReportSessionEventEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event> {
        ...
        private static final FieldDescriptor APP_DESCRIPTOR = FieldDescriptor.of("app");
        private static final FieldDescriptor DEVICE_DESCRIPTOR = FieldDescriptor.of("device");
        private static final FieldDescriptor LOG_DESCRIPTOR = FieldDescriptor.of(CreativeInfo.f);
    ...
    private static final class CrashlyticsReportSessionEventApplicationEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Application> {
        ...
        private static final FieldDescriptor BACKGROUND_DESCRIPTOR = FieldDescriptor.of(J2.g);
    ...
    private static final class CrashlyticsReportSessionEventApplicationExecutionThreadFrameEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame> {
        ...
        private static final FieldDescriptor PC_DESCRIPTOR = FieldDescriptor.of(ApsMetricsDataMap.APSMETRICS_FIELD_PLATFORMCATEGORY);
    ...
    private static final class CrashlyticsReportSessionEventApplicationExecutionBinaryImageEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.BinaryImage> {
        ...
        private static final FieldDescriptor NAME_DESCRIPTOR = FieldDescriptor.of("name");
        private static final FieldDescriptor UUID_DESCRIPTOR = FieldDescriptor.of(CommonUrlParts.UUID);
    ...
    private static final class CrashlyticsReportSessionEventDeviceEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Device> {
        ...
        private static final FieldDescriptor BATTERYLEVEL_DESCRIPTOR = FieldDescriptor.of(b9.i.Y);
    ...
    private static final class CrashlyticsReportFilesPayloadEncoder implements ObjectEncoder<CrashlyticsReport.FilesPayload> {
        ...
        private static final FieldDescriptor FILES_DESCRIPTOR = FieldDescriptor.of(FileUploadManager.i);
