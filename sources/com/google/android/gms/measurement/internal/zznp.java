...
public final class zznp extends zzii {
    ...
    private final int zza(String str, String str2, String str3, Object obj, Bundle bundle, List<String> list, boolean z, boolean z2) {
        ...
        if (!zza(obj)) {
            ...
            if (size > 200) {
                zzj().zzv().zza("Parameter array is too long; discarded. Value kind, name, array length", Ad.VERIFICATIONPARAM, str3, Integer.valueOf(size));
                if (z3) {
        ...
        if (zza(Ad.VERIFICATIONPARAM, str3, (zzg(str2) || zzg(str3)) ? zze().zzb((String) null, false) : zze().zza((String) null, false), obj)) {
            return i;
        }
        if (!z2) {
            return 4;
            ...
            try {
                if (!zzb(context, str)) {
                    ...
                    if (packageInfo.signatures != null && packageInfo.signatures.length > 0) {
                        jZza = zza(messageDigestZzu.digest(packageInfo.signatures[0].toByteArray()));
                    } else {
    ...
    public static long zza(zzbc zzbcVar) {
        ...
        while (it.hasNext()) {
            Object objZzc = zzbcVar.zzc(it.next());
    ...
    public static String zza(String str, int i, boolean z) {
        ...
        return str.substring(0, str.offsetByCodePoints(0, i)) + APSSharedUtil.TRUNCATE_SEPARATOR;
    }
    ...
    public final URL zza(long j, String str, String str2, long j2, String str3) {
        try {
            ...
            if (!str3.isEmpty()) {
                if (str3.charAt(0) != '&') {
                    strConcat = strConcat.concat(b9.i.c);
                }
