...
final class zzw {
    private String zza;
    private boolean zzb;
    private com.google.android.gms.internal.measurement.zzfn.zzm zzc;
    private BitSet zzd;
    private BitSet zze;
    ...
    final com.google.android.gms.internal.measurement.zzfn.zzd zza(int i) {
        ArrayList arrayList;
        ?? arrayList2;
        ?? Zzb = com.google.android.gms.internal.measurement.zzfn.zzd.zzb();
        Zzb.zza(i);
        Zzb.zza(this.zzb);
        com.google.android.gms.internal.measurement.zzfn.zzm zzmVar = this.zzc;
        if (zzmVar != null) {
            Zzb.zza(zzmVar);
        }
        ?? Zzd = com.google.android.gms.internal.measurement.zzfn.zzm.zze().zzb(zznl.zza(this.zzd)).zzd(zznl.zza(this.zze));
        if (this.zzf == null) {
            arrayList = null;
        } else {
            ...
            while (it.hasNext()) {
                ...
                if (l != null) {
                    arrayList.add((com.google.android.gms.internal.measurement.zzfn.zze) ((com.google.android.gms.internal.measurement.zzjk) com.google.android.gms.internal.measurement.zzfn.zze.zzc().zza(iIntValue).zza(l.longValue()).zzai()));
                }
            }
        }
        if (arrayList != null) {
        ...
        if (this.zzg == null) {
            ...
            for (Integer num : this.zzg.keySet()) {
                com.google.android.gms.internal.measurement.zzfn.zzn.zza zzaVarZza = com.google.android.gms.internal.measurement.zzfn.zzn.zzc().zza(num.intValue());
                List<Long> list = this.zzg.get(num);
                if (list != null) {
                    Collections.sort(list);
                    zzaVarZza.zza(list);
                }
                arrayList2.add((com.google.android.gms.internal.measurement.zzfn.zzn) ((com.google.android.gms.internal.measurement.zzjk) zzaVarZza.zzai()));
            }
        }
        Zzd.zzc(arrayList2);
        Zzb.zza(Zzd);
        return (com.google.android.gms.internal.measurement.zzfn.zzd) ((com.google.android.gms.internal.measurement.zzjk) Zzb.zzai());
    }
    ...
    private zzw(zzu zzuVar, String str, com.google.android.gms.internal.measurement.zzfn.zzm zzmVar, BitSet bitSet, BitSet bitSet2, Map<Integer, Long> map, Map<Integer, Long> map2) {
        this.zzh = zzuVar;
        this.zza = str;
        this.zzd = bitSet;
        this.zze = bitSet2;
