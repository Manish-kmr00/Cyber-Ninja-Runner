...
final class zzy {
    private com.google.android.gms.internal.measurement.zzfn.zzf zza;
    private Long zzb;
    private long zzc;
    private final /* synthetic */ zzu zzd;

    final com.google.android.gms.internal.measurement.zzfn.zzf zza(String str, com.google.android.gms.internal.measurement.zzfn.zzf zzfVar) {
        String strZzg = zzfVar.zzg();
        List<com.google.android.gms.internal.measurement.zzfn.zzh> listZzh = zzfVar.zzh();
        this.zzd.g_();
        ...
        if (z && strZzg.equals("_ep")) {
            ...
            if (this.zza == null || this.zzb == null || l.longValue() != this.zzb.longValue()) {
                Pair<com.google.android.gms.internal.measurement.zzfn.zzf, Long> pairZza = this.zzd.zzh().zza(str, l);
                ...
                this.zza = (com.google.android.gms.internal.measurement.zzfn.zzf) pairZza.first;
            ...
            for (com.google.android.gms.internal.measurement.zzfn.zzh zzhVar : this.zza.zzh()) {
                this.zzd.g_();
        ...
        return (com.google.android.gms.internal.measurement.zzfn.zzf) ((com.google.android.gms.internal.measurement.zzjk) zzfVar.zzcc().zza(strZzg).zzd().zza(listZzh).zzai());
    }
