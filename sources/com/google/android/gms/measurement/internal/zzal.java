...
final class zzal extends zzmx {
    ...
    public final long zza(com.google.android.gms.internal.measurement.zzfn.zzk zzkVar) throws IOException {
        zzt();
        zzal();
        ...
        try {
            try {
                ...
                try {
                    ...
                    try {
                        com.google.android.gms.internal.measurement.zzfn.zzf zzfVar = (com.google.android.gms.internal.measurement.zzfn.zzf) ((com.google.android.gms.internal.measurement.zzjk) ((com.google.android.gms.internal.measurement.zzfn.zzf.zza) zznl.zza(com.google.android.gms.internal.measurement.zzfn.zzf.zze(), cursorRawQuery.getBlob(0))).zzai());
                        g_();
    ...
    public final Pair<com.google.android.gms.internal.measurement.zzfn.zzf, Long> zza(String str, Long l) throws Throwable {
        Cursor cursorRawQuery;
        Cursor cursor;
        zzt();
        zzal();
        ...
        try {
            try {
                ...
                try {
                    ...
                    try {
                        Pair<com.google.android.gms.internal.measurement.zzfn.zzf, Long> pairCreate = Pair.create((com.google.android.gms.internal.measurement.zzfn.zzf) ((com.google.android.gms.internal.measurement.zzjk) ((com.google.android.gms.internal.measurement.zzfn.zzf.zza) zznl.zza(com.google.android.gms.internal.measurement.zzfn.zzf.zze(), cursorRawQuery.getBlob(0))).zzai()), Long.valueOf(cursorRawQuery.getLong(1)));
                        if (cursorRawQuery != null) {
                            cursorRawQuery.close();
                        }
                        return pairCreate;
            ...
            try {
                ...
                try {
                    ...
                    if (!cursorQuery.isNull(26)) {
                        zzgVar.zza(Arrays.asList(cursorQuery.getString(26).split(StringUtils.COMMA, -1)));
                    }
                    if (!com.google.android.gms.internal.measurement.zznk.zza() || !zze().zza(zzbf.zzcv) || this.zzf.zzb(str).zza(zzin.zza.ANALYTICS_STORAGE)) {
                    ...
                    sQLiteException = e;
                    zzj().zzg().zza("Error querying app. appId", zzfw.zza(str), sQLiteException);
                    if (cursorQuery != null) {
                        cursorQuery.close();
                    }
                    return null;
    ...
    /* JADX WARN: Code duplicated, block: B:40:0x0159  */
            ...
            try {
                ...
                try {
                    try {
                        ...
                        String str3 = string;
                        zzae zzaeVar = new zzae(str, str3, new zzno(str2, cursorQuery.getLong(8), objZza, string), cursorQuery.getLong(6), z, cursorQuery.getString(3), (zzbd) g_().zza(cursorQuery.getBlob(5), zzbd.CREATOR), cursorQuery.getLong(4), (zzbd) g_().zza(cursorQuery.getBlob(7), zzbd.CREATOR), cursorQuery.getLong(9), (zzbd) g_().zza(cursorQuery.getBlob(10), zzbd.CREATOR));
                        if (cursorQuery.moveToNext()) {
                            zzj().zzg().zza("Got multiple records for conditional property, expected one", zzfw.zza(str), zzi().zzc(str2));
                        }
                        if (cursorQuery != null) {
                            cursorQuery.close();
                        }
                    ...
                    e = e;
                    zzj().zzg().zza("Error querying conditional property", zzfw.zza(str), zzi().zzc(str2), e);
                    if (cursorQuery != null) {
                        cursorQuery.close();
                    }
                    return null;
    ...
    public final zzaq zza(long j, String str, long j2, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6) throws Throwable {
        Cursor cursor;
        Cursor cursorQuery;
        Preconditions.checkNotEmpty(str);
        zzt();
        ...
        try {
            try {
                SQLiteDatabase sQLiteDatabaseE_ = e_();
                cursorQuery = sQLiteDatabaseE_.query("apps", new String[]{"day", "daily_events_count", "daily_public_events_count", "daily_conversions_count", "daily_error_events_count", "daily_realtime_events_count", "daily_realtime_dcu_count"}, "app_id=?", new String[]{str}, null, null, null);
                try {
                    if (!cursorQuery.moveToFirst()) {
    ...
    public final zznq zze(String str, String str2) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        zznq zznqVar = new zznq(str, cursorQuery.getString(2), str2, j, objZza);
                        if (cursorQuery.moveToNext()) {
                            zzj().zzg().zza("Got multiple records for user property, expected one. appId", zzfw.zza(str));
                        }
                        if (cursorQuery != null) {
                            cursorQuery.close();
                        }
        ...
        zzj().zzg().zza("Error querying user property. appId", zzfw.zza(str), zzi().zzc(str2), e);
        if (cursorQuery != null) {
            cursorQuery.close();
        }
        return null;
    ...
    public final List<Pair<com.google.android.gms.internal.measurement.zzfn.zzk, Long>> zza(String str, int i, int i2) {
        long jZzc;
        long jZzc2;
        zzt();
        zzal();
        ...
        try {
            try {
                ...
                if (!cursorQuery.moveToFirst()) {
                    List<Pair<com.google.android.gms.internal.measurement.zzfn.zzk, Long>> listEmptyList = Collections.emptyList();
                    if (cursorQuery != null) {
                        cursorQuery.close();
                    }
                ...
                while (true) {
                    ...
                    try {
                        ...
                        try {
                            com.google.android.gms.internal.measurement.zzfn.zzk.zza zzaVar = (com.google.android.gms.internal.measurement.zzfn.zzk.zza) zznl.zza(com.google.android.gms.internal.measurement.zzfn.zzk.zzw(), bArrZzc);
                            if (!arrayList.isEmpty()) {
                                com.google.android.gms.internal.measurement.zzfn.zzk zzkVar = (com.google.android.gms.internal.measurement.zzfn.zzk) ((Pair) arrayList.get(0)).first;
                                com.google.android.gms.internal.measurement.zzfn.zzk zzkVar2 = (com.google.android.gms.internal.measurement.zzfn.zzk) ((com.google.android.gms.internal.measurement.zzjk) zzaVar.zzai());
                                ...
                                Iterator<com.google.android.gms.internal.measurement.zzfn.zzo> it = zzkVar.zzas().iterator();
                                while (true) {
                                    jZzc = -1;
                                    if (!it.hasNext()) {
                                        jZzc2 = -1;
                                    ...
                                    com.google.android.gms.internal.measurement.zzfn.zzo next = it.next();
                                    if ("_npa".equals(next.zzg())) {
                                        jZzc2 = next.zzc();
                                        break;
                                    }
                                }
                                for (com.google.android.gms.internal.measurement.zzfn.zzo zzoVar : zzkVar2.zzas()) {
                            ...
                            arrayList.add(Pair.create((com.google.android.gms.internal.measurement.zzfn.zzk) ((com.google.android.gms.internal.measurement.zzjk) zzaVar.zzai()), Long.valueOf(j)));
                        } catch (IOException e) {
                ...
                List<Pair<com.google.android.gms.internal.measurement.zzfn.zzk, Long>> listEmptyList2 = Collections.emptyList();
                if (0 != 0) {
                    cursor.close();
                }
    ...
    /* JADX WARN: Code duplicated, block: B:36:0x0177  */
    /* JADX WARN: Multi-variable type inference failed */
        ...
        try {
            ...
            try {
                ...
                while (true) {
                    ...
                    arrayList.add(new zzae(string, string2, new zzno(string3, cursorQuery.getLong(10), objZza, string2), cursorQuery.getLong(8), i3, cursorQuery.getString(i2), (zzbd) g_().zza(cursorQuery.getBlob(7), zzbd.CREATOR), cursorQuery.getLong(6), (zzbd) g_().zza(cursorQuery.getBlob(9), zzbd.CREATOR), cursorQuery.getLong(11), (zzbd) g_().zza(cursorQuery.getBlob(12), zzbd.CREATOR)));
                    if (!cursorQuery.moveToNext()) {
                        break;
                    }
                    i2 = 5;
    ...
    public final List<zznq> zzk(String str) throws Throwable {
        Preconditions.checkNotEmpty(str);
        zzt();
        zzal();
        ArrayList arrayList = new ArrayList();
        ...
        zzj().zzg().zza("Error querying user properties. appId", zzfw.zza(str), e);
        List<zznq> listEmptyList2 = Collections.emptyList();
        if (cursorQuery != null) {
            cursorQuery.close();
        }
        return listEmptyList2;
                ...
                try {
                    ...
                    if (TextUtils.isEmpty(str2)) {
                        ...
                        try {
                            ...
                            e = e;
                            zzj().zzg().zza("(2)Error querying user properties", zzfw.zza(str), str4, e);
                            List<zznq> listEmptyList = Collections.emptyList();
                            if (cursorQuery != null) {
                                cursorQuery.close();
                            }
                    ...
                    while (true) {
                        ...
                        try {
                            try {
                                ...
                                if (objZza == null) {
                                    try {
                                        zzj().zzg().zza("(2)Read invalid user property value, ignoring it", zzfw.zza(str), string2, str3);
                                    } catch (SQLiteException e2) {
                                        e = e2;
                                        str4 = string2;
                                        zzj().zzg().zza("(2)Error querying user properties", zzfw.zza(str), str4, e);
                                    ...
                                    try {
                                        arrayList.add(new zznq(str, string2, string, j, objZza));
                                    } catch (SQLiteException e3) {
                                        e = e3;
                                        string2 = string2;
                                        str4 = string2;
                                        zzj().zzg().zza("(2)Error querying user properties", zzfw.zza(str), str4, e);
                                        List<zznq> listEmptyList3 = Collections.emptyList();
                                        if (cursorQuery != null) {
                                            cursorQuery.close();
                                        }
                                ...
                                try {
                                    ...
                                    str4 = string2;
                                    zzj().zzg().zza("(2)Error querying user properties", zzfw.zza(str), str4, e);
                                    List<zznq> listEmptyList4 = Collections.emptyList();
                                    if (cursorQuery != null) {
                                        cursorQuery.close();
                                    }
                    ...
                    str4 = str2;
                    zzj().zzg().zza("(2)Error querying user properties", zzfw.zza(str), str4, e);
                    List<zznq> listEmptyList5 = Collections.emptyList();
                    if (cursorQuery != null) {
                        cursorQuery.close();
                    }
    ...
    final Map<Integer, com.google.android.gms.internal.measurement.zzfn.zzm> zzl(String str) {
        zzal();
        zzt();
        Preconditions.checkNotEmpty(str);
        Cursor cursor = null;
        try {
            try {
                ...
                if (!cursorQuery.moveToFirst()) {
                    Map<Integer, com.google.android.gms.internal.measurement.zzfn.zzm> mapEmptyMap = Collections.emptyMap();
                    if (cursorQuery != null) {
                        cursorQuery.close();
                    }
                    return mapEmptyMap;
                ...
                do {
                    ...
                    try {
                        arrayMap.put(Integer.valueOf(i), (com.google.android.gms.internal.measurement.zzfn.zzm) ((com.google.android.gms.internal.measurement.zzjk) ((com.google.android.gms.internal.measurement.zzfn.zzm.zza) zznl.zza(com.google.android.gms.internal.measurement.zzfn.zzm.zze(), cursorQuery.getBlob(1))).zzai()));
                    } catch (IOException e) {
                ...
                Map<Integer, com.google.android.gms.internal.measurement.zzfn.zzm> mapEmptyMap2 = Collections.emptyMap();
                if (0 != 0) {
                    cursor.close();
                }
                return mapEmptyMap2;
    ...
    final Map<Integer, List<com.google.android.gms.internal.measurement.zzff.zzb>> zzm(String str) {
        Preconditions.checkNotEmpty(str);
        ArrayMap arrayMap = new ArrayMap();
        Cursor cursor = null;
        try {
            try {
                ...
                do {
                    try {
                        com.google.android.gms.internal.measurement.zzff.zzb zzbVar = (com.google.android.gms.internal.measurement.zzff.zzb) ((com.google.android.gms.internal.measurement.zzjk) ((com.google.android.gms.internal.measurement.zzff.zzb.zza) zznl.zza(com.google.android.gms.internal.measurement.zzff.zzb.zzc(), cursorQuery.getBlob(1))).zzai());
                        if (zzbVar.zzk()) {
                            int i = cursorQuery.getInt(0);
                ...
                Map<Integer, List<com.google.android.gms.internal.measurement.zzff.zzb>> mapEmptyMap2 = Collections.emptyMap();
                if (0 != 0) {
                    cursor.close();
                }
                return mapEmptyMap2;
    ...
    final Map<Integer, List<com.google.android.gms.internal.measurement.zzff.zzb>> zzf(String str, String str2) {
        zzal();
        zzt();
        Preconditions.checkNotEmpty(str);
        Preconditions.checkNotEmpty(str2);
    ...
    final Map<Integer, List<com.google.android.gms.internal.measurement.zzff.zze>> zzg(String str, String str2) {
        zzal();
        zzt();
        Preconditions.checkNotEmpty(str);
        Preconditions.checkNotEmpty(str2);
        ...
        try {
            try {
                ...
                if (!cursorQuery.moveToFirst()) {
                    Map<Integer, List<com.google.android.gms.internal.measurement.zzff.zze>> mapEmptyMap = Collections.emptyMap();
                    if (cursorQuery != null) {
                        cursorQuery.close();
                    }
                    return mapEmptyMap;
                ...
                do {
                    try {
                        com.google.android.gms.internal.measurement.zzff.zze zzeVar = (com.google.android.gms.internal.measurement.zzff.zze) ((com.google.android.gms.internal.measurement.zzjk) ((com.google.android.gms.internal.measurement.zzff.zze.zza) zznl.zza(com.google.android.gms.internal.measurement.zzff.zze.zzc(), cursorQuery.getBlob(1))).zzai());
                        int i = cursorQuery.getInt(0);
                        List arrayList = (List) arrayMap.get(Integer.valueOf(i));
                        if (arrayList == null) {
                            arrayList = new ArrayList();
                ...
                zzj().zzg().zza("Database error querying filters. appId", zzfw.zza(str), e2);
                Map<Integer, List<com.google.android.gms.internal.measurement.zzff.zze>> mapEmptyMap2 = Collections.emptyMap();
                if (0 != 0) {
                    cursor.close();
                }
                return mapEmptyMap2;
    ...
    /* JADX WARN: Code duplicated, block: B:72:0x010e A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:73:0x0110 A[ADDED_TO_REGION] */
    ...
    final void zza(String str, List<com.google.android.gms.internal.measurement.zzff.zza> list) {
        boolean z;
        boolean z2;
        boolean z3;
        Preconditions.checkNotNull(list);
        for (int i = 0; i < list.size(); i++) {
            com.google.android.gms.internal.measurement.zzff.zza.C0276zza c0276zzaZzcc = list.get(i).zzcc();
            if (c0276zzaZzcc.zza() != 0) {
                for (int i2 = 0; i2 < c0276zzaZzcc.zza(); i2++) {
                    com.google.android.gms.internal.measurement.zzff.zzb.zza zzaVarZzcc = c0276zzaZzcc.zza(i2).zzcc();
                    com.google.android.gms.internal.measurement.zzff.zzb.zza zzaVar = (com.google.android.gms.internal.measurement.zzff.zzb.zza) ((com.google.android.gms.internal.measurement.zzjk.zzb) zzaVarZzcc.clone());
                    ...
                    for (int i3 = 0; i3 < zzaVarZzcc.zza(); i3++) {
                        com.google.android.gms.internal.measurement.zzff.zzc zzcVarZza = zzaVarZzcc.zza(i3);
                        String strZza = zzip.zza(zzcVarZza.zze());
                        if (strZza != null) {
                            zzaVar.zza(i3, (com.google.android.gms.internal.measurement.zzff.zzc) ((com.google.android.gms.internal.measurement.zzjk) zzcVarZza.zzcc().zza(strZza).zzai()));
                            z3 = true;
                        }
                    }
                    if (z3) {
                        c0276zzaZzcc = c0276zzaZzcc.zza(i2, zzaVar);
                        list.set(i, (com.google.android.gms.internal.measurement.zzff.zza) ((com.google.android.gms.internal.measurement.zzjk) c0276zzaZzcc.zzai()));
                    }
                }
            }
            if (c0276zzaZzcc.zzb() != 0) {
                for (int i4 = 0; i4 < c0276zzaZzcc.zzb(); i4++) {
                    com.google.android.gms.internal.measurement.zzff.zze zzeVarZzb = c0276zzaZzcc.zzb(i4);
                    String strZza2 = zzis.zza(zzeVarZzb.zze());
                    if (strZza2 != null) {
                        c0276zzaZzcc = c0276zzaZzcc.zza(i4, zzeVarZzb.zzcc().zza(strZza2));
                        list.set(i, (com.google.android.gms.internal.measurement.zzff.zza) ((com.google.android.gms.internal.measurement.zzjk) c0276zzaZzcc.zzai()));
                    }
                }
            }
        ...
        try {
            ...
            for (com.google.android.gms.internal.measurement.zzff.zza zzaVar2 : list) {
                zzal();
                zzt();
                Preconditions.checkNotEmpty(str);
                ...
                if (!zzaVar2.zzg()) {
                    ...
                    Iterator<com.google.android.gms.internal.measurement.zzff.zzb> it = zzaVar2.zze().iterator();
                    while (true) {
                        if (it.hasNext()) {
                            if (!it.next().zzl()) {
                            ...
                            Iterator<com.google.android.gms.internal.measurement.zzff.zze> it2 = zzaVar2.zzf().iterator();
                            while (true) {
                                if (it2.hasNext()) {
                                    if (!it2.next().zzi()) {
                                    ...
                                    Iterator<com.google.android.gms.internal.measurement.zzff.zzb> it3 = zzaVar2.zze().iterator();
                                    while (true) {
                                        if (it3.hasNext()) {
                                    ...
                                    Iterator<com.google.android.gms.internal.measurement.zzff.zze> it4 = zzaVar2.zzf().iterator();
                                    while (true) {
                                        if (it4.hasNext()) {
            ...
            ArrayList arrayList = new ArrayList();
            for (com.google.android.gms.internal.measurement.zzff.zza zzaVar3 : list) {
    ...
    public final void zza(zzg zzgVar, boolean z, boolean z2) {
        ...
        if (listZzan != null) {
            if (listZzan.isEmpty()) {
                ...
                contentValues.put("safelisted_events", TextUtils.join(StringUtils.COMMA, listZzan));
            }
        }
    ...
    private final void zza(String str, String str2, ContentValues contentValues) {
        try {
            ...
            } else if (sQLiteDatabaseE_.update(str, contentValues, str2 + " = ?", new String[]{asString}) == 0 && sQLiteDatabaseE_.insertWithOnConflict(str, null, contentValues, 5) == -1) {
    ...
    private final boolean zzb(String str, List<Integer> list) {
        ...
        try {
            ...
            return sQLiteDatabaseE_.delete("audience_filter_values", new StringBuilder("audience_id in (select audience_id from audience_filter_values where app_id=? and audience_id not in ").append(new StringBuilder("(").append(TextUtils.join(StringUtils.COMMA, arrayList)).append(")").toString()).append(" order by rowid desc limit -1 offset ?)").toString(), new String[]{str, Integer.toString(iMax)}) > 0;
        } catch (SQLiteException e) {
    ...
    public final boolean zza(com.google.android.gms.internal.measurement.zzfn.zzk zzkVar, boolean z) {
        zzt();
        zzal();
        Preconditions.checkNotNull(zzkVar);
        Preconditions.checkNotEmpty(zzkVar.zzz());
    ...
    private final boolean zza(String str, int i, com.google.android.gms.internal.measurement.zzff.zzb zzbVar) {
        zzal();
        zzt();
        Preconditions.checkNotEmpty(str);
    ...
    private final boolean zza(String str, int i, com.google.android.gms.internal.measurement.zzff.zze zzeVar) {
        zzal();
        zzt();
        Preconditions.checkNotEmpty(str);
    ...
    public final boolean zza(String str, Long l, long j, com.google.android.gms.internal.measurement.zzfn.zzf zzfVar) {
        zzt();
        zzal();
