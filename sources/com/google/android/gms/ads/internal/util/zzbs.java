...
public final class zzbs {
                ...
                if (objOpt instanceof Boolean) {
                    ...
                    if (jSONArray.length() != 0) {
                        ...
                        if (objOpt2 == null) {
                            ...
                            int i3 = zze.zza;
                            com.google.android.gms.ads.internal.util.client.zzo.zzj("Expected JSONArray with at least 1 non-null element for key:".concat(strValueOf));
                    ...
                    int i5 = zze.zza;
                    com.google.android.gms.ads.internal.util.client.zzo.zzj("Unsupported type for key:".concat(strValueOf2));
                }
            }
        }
        return bundle;
    ...
    public static String zzb(String str, JSONObject jSONObject, String... strArr) {
        JSONObject jSONObjectZzn = zzn(jSONObject, strArr);
    ...
    public static String zzm(zzfaz zzfazVar) {
        if (zzfazVar == null) {
            return null;
        }
