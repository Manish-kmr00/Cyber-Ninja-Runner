...
public class zzv extends zzu {
    ...
    public final zzbbn.zzq zzg(Context context, TelephonyManager telephonyManager) {
        ...
        if (zzs.zzB(context, "android.permission.ACCESS_NETWORK_STATE")) {
            return telephonyManager.isDataEnabled() ? zzbbn.zzq.ENUM_TRUE : zzbbn.zzq.ENUM_FALSE;
        }
    ...
    public final void zzh(Context context, String str, String str2) {
        NotificationChannel notificationChannel = new NotificationChannel("offline_notification_channel", "AdMob Offline Notifications", ((Integer) com.google.android.gms.ads.internal.client.zzbd.zzc().zzb(zzbci.zziC)).intValue());
