...
public final class zzdtp extends zzfqi {
    ...
    public final void zza(SensorEvent sensorEvent) {
        if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.zzc().zzb(zzbci.zzjh)).booleanValue()) {
            ...
            if (this.zze + ((long) ((Integer) com.google.android.gms.ads.internal.client.zzbd.zzc().zzb(zzbci.zzjj)).intValue()) < jCurrentTimeMillis) {
                this.zzf = 0;
            ...
            this.zzd = fValueOf;
            if (fValueOf.floatValue() > this.zzc + ((Float) com.google.android.gms.ads.internal.client.zzbd.zzc().zzb(zzbci.zzji)).floatValue()) {
                this.zzc = this.zzd.floatValue();
                this.zzh = true;
            } else {
                if (this.zzd.floatValue() < this.zzc - ((Float) com.google.android.gms.ads.internal.client.zzbd.zzc().zzb(zzbci.zzji)).floatValue()) {
                    this.zzc = this.zzd.floatValue();
                    this.zzg = true;
                }
            }
            ...
            if (this.zzg && this.zzh) {
                ...
                if (zzdtoVar != null) {
                    if (i == ((Integer) com.google.android.gms.ads.internal.client.zzbd.zzc().zzb(zzbci.zzjk)).intValue()) {
