...
public final class zzrn extends zzco {
    ...
    private int zzj = 0;
    private int zzk = 0;
    private byte[] zzi = zzeu.zzc;
    private byte[] zzl = zzeu.zzc;
    ...
    private final void zzt(boolean z) {
        ...
        zzdc.zzg(length % this.zzd == 0, "bytesConsumed is not aligned to frame size: %s" + length);
        zzdc.zzf(i2 >= i);
        this.zzk -= length;
    ...
    private final void zzu(int i, int i2) {
        ...
        zzdc.zze(i % this.zzd == 0, "sizeToOutput is not aligned to frame size: " + i);
        zzdc.zzf(this.zzj < this.zzi.length);
        byte[] bArr3 = this.zzl;
        zzdc.zze(i % this.zzd == 0, "byteOutput size is not aligned to frame size " + i);
        if (i2 != 3) {
