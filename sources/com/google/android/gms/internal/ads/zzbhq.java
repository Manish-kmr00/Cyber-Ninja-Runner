...
public final class zzbhq extends RemoteCreator {
    ...
    public final zzbgd zza(View view, HashMap map, HashMap map2) {
        try {
            IBinder iBinderZze = ((zzbgg) getRemoteCreatorInstance(view.getContext())).zze(ObjectWrapper.wrap(view), ObjectWrapper.wrap(map), ObjectWrapper.wrap(map2));
            if (iBinderZze == null) {
                return null;
            }
            ...
            return iInterfaceQueryLocalInterface instanceof zzbgd ? (zzbgd) iInterfaceQueryLocalInterface : new zzbgb(iBinderZze);
