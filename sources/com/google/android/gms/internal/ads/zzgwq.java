...
final class zzgwq extends zzgwt {
    ...
    /* synthetic */ zzgwq(InputStream inputStream, int i, zzgws zzgwsVar) {
        super(null);
    ...
    public final zzgwn zzv() throws IOException {
        ...
        int i2 = this.zzi;
        if (iZzi <= i - i2 && iZzi > 0) {
            zzgwn zzgwnVarZzv = zzgwn.zzv(this.zzf, i2, iZzi);
            this.zzi += iZzi;
            return zzgwnVarZzv;
        }
        if (iZzi == 0) {
        ...
        if (bArrZzN != null) {
            return zzgwn.zzv(bArrZzN, 0, bArrZzN.length);
        }
        int i3 = this.zzi;
        int i4 = this.zzg;
        int i5 = i4 - i3;
    ...
    public final String zzw() throws IOException {
        ...
        if (iZzi > 0) {
            ...
            int i2 = this.zzi;
            if (iZzi <= i - i2) {
                String str = new String(this.zzf, i2, iZzi, zzgyi.zza);
                this.zzi += iZzi;
                return str;
            }
        }
        ...
        if (iZzi > this.zzg) {
            return new String(zzM(iZzi, false), zzgyi.zza);
        }
        zzK(iZzi);
        String str2 = new String(this.zzf, this.zzi, iZzi, zzgyi.zza);
        this.zzi += iZzi;
        return str2;
    }
    ...
    public final String zzx() throws IOException {
        ...
        return zzhax.zzh(bArrZzM, i, iZzi);
    }
