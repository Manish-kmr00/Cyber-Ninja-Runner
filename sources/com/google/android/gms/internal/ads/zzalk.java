...
public final class zzalk {
    ...
    public final zzalk zzh(int i) {
        this.zzh = i;
        this.zzi = true;
        return this;
    }

    public final zzalk zzi(boolean z) {
        this.zzk = 1;
        return this;
    }

    public final zzalk zzj(boolean z) {
        this.zzp = z;
        return this;
    }

    public final zzalk zzk(int i) {
        this.zzf = i;
        this.zzg = true;
        return this;
    }
    ...
    public final zzalk zzm(float f) {
        this.zzn = f;
        return this;
    }

    public final zzalk zzn(int i) {
        this.zzm = i;
        return this;
    }

    public final zzalk zzo(boolean z) {
        this.zzl = 1;
        return this;
    }

    public final zzalk zzp(int i) {
        this.zzo = i;
        return this;
    }

    public final zzalk zzq(boolean z) {
        this.zzj = 1;
        return this;
    }
