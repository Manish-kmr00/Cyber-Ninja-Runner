...
public final class zzdm implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public zzdm(Handler handler, zzdl zzdlVar) {
        this.zzb = handler;
    }
    ...
    public final void zzb(int i) throws zzdn {
        ...
        zzdo.zza(eGLDisplayEglGetDisplay != null, "eglGetDisplay failed");
        int[] iArr = new int[2];
        zzdo.zza(EGL14.eglInitialize(eGLDisplayEglGetDisplay, iArr, 0, iArr, 1), "eglInitialize failed");
        ...
        int i2 = zzeu.zza;
        zzdo.zza(z, String.format(Locale.US, "eglChooseConfig failed: success=%b, numConfigs[0]=%d, configs[0]=%s", objArr));
        ...
        zzdo.zza(eGLContextEglCreateContext != null, "eglCreateContext failed");
        ...
        if (i == 1) {
            ...
            zzdo.zza(eGLSurfaceEglCreatePbufferSurface != null, "eglCreatePbufferSurface failed");
        }
        zzdo.zza(EGL14.eglMakeCurrent(eGLDisplay, eGLSurfaceEglCreatePbufferSurface, eGLSurfaceEglCreatePbufferSurface, eGLContextEglCreateContext), "eglMakeCurrent failed");
