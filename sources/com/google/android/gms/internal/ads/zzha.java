    ...
    public static long zza(String str, String str2) {
        ...
        if (!TextUtils.isEmpty(str)) {
            try {
                ...
                zzdx.zzc("HttpUtil", "Unexpected Content-Length [" + str + b9.i.e);
            }
        }
        ...
        try {
            ...
            zzdx.zzf("HttpUtil", "Inconsistent headers [" + str + "] [" + str2 + b9.i.e);
            return Math.max(j, j3);
        } catch (NumberFormatException unused2) {
            zzdx.zzc("HttpUtil", "Unexpected Content-Range [" + str2 + b9.i.e);
            return j;
        }
    }
