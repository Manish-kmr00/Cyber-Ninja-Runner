...
final class zzhax {
    ...
    static String zzg(ByteBuffer byteBuffer, int i, int i2) throws zzgyk {
        zzhau zzhauVar = zza;
        if (byteBuffer.hasArray()) {
            return zzhauVar.zzb(byteBuffer.array(), byteBuffer.arrayOffset() + i, i2);
        }
        return byteBuffer.isDirect() ? zzhav.zzc(byteBuffer, i, i2) : zzhau.zzc(byteBuffer, i, i2);
    }

    static String zzh(byte[] bArr, int i, int i2) throws zzgyk {
