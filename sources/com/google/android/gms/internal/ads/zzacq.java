...
public class zzacq implements zzaeb {
    ...
    public zzacq(long j, long j2, int i, int i2, boolean z) {
        long jZzc;
        this.zza = j;
        this.zzb = j2;
        this.zzc = i2 == -1 ? 1 : i2;
    ...
    public final zzadz zzg(long j) {
        long j2 = this.zzd;
        if (j2 == -1) {
            zzaec zzaecVar = new zzaec(0L, this.zzb);
        ...
        long jZzb = zzb(jMax);
        zzaec zzaecVar2 = new zzaec(jZzb, jMax);
        if (j2 != -1 && jZzb < j) {
            long j5 = jMax + j4;
            if (j5 < this.zza) {
                return new zzadz(zzaecVar2, new zzaec(zzb(j5), j5));
            }
        }
