...
final class zzgwo extends zzgwt {
    ...
    /* synthetic */ zzgwo(byte[] bArr, int i, int i2, boolean z, zzgws zzgwsVar) {
        super(null);
    ...
    public final zzgwn zzv() throws IOException {
        ...
        if (iZzi > 0) {
            ...
            int i2 = this.zzh;
            if (iZzi <= i - i2) {
                zzgwn zzgwnVarZzv = zzgwn.zzv(this.zza, i2, iZzi);
                this.zzh += iZzi;
                return zzgwnVarZzv;
            }
        }
        ...
        if (iZzi > 0) {
            ...
            if (iZzi <= i3 - i4) {
                ...
                return new zzgwk(bArrCopyOfRange);
            }
        }
        if (iZzi <= 0) {
    ...
    public final String zzw() throws IOException {
        ...
        if (iZzi > 0) {
            ...
            int i2 = this.zzh;
            if (iZzi <= i - i2) {
                String str = new String(this.zza, i2, iZzi, zzgyi.zza);
                this.zzh += iZzi;
                return str;
            }
        }
    ...
    public final String zzx() throws IOException {
        ...
        if (iZzi > 0) {
            ...
            int i2 = this.zzh;
            if (iZzi <= i - i2) {
                String strZzh = zzhax.zzh(this.zza, i2, iZzi);
                this.zzh += iZzi;
                return strZzh;
            }
        }
