...
abstract class zzgap extends zzgbi implements Runnable {
    ...
    public final void run() {
        ...
        try {
            try {
                Object objZze = zze(obj, zzgbs.zzp(listenableFuture));
                this.zzb = null;
                zzf(objZze);
            } catch (Throwable th) {
                try {
    ...
    zzgap(ListenableFuture listenableFuture, Object obj) {
