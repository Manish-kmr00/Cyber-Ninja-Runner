...
public final class zzcbe extends Thread implements SurfaceTexture.OnFrameAvailableListener, zzcbc {
    ...
    public final void run() {
        ...
        zzbbz zzbbzVar = zzbci.zzbw;
        int iZzl = zzl(35633, !((String) com.google.android.gms.ads.internal.client.zzbd.zzc().zzb(zzbbzVar)).equals(zzbbzVar.zzk()) ? (String) com.google.android.gms.ads.internal.client.zzbd.zzc().zzb(zzbbzVar) : "attribute highp vec3 aPosition;varying vec3 pos;void main() {  gl_Position = vec4(aPosition, 1.0);  pos = aPosition;}");
        if (iZzl == 0) {
            iGlCreateProgram = 0;
        } else {
            zzbbz zzbbzVar2 = zzbci.zzbx;
            int iZzl2 = zzl(35632, !((String) com.google.android.gms.ads.internal.client.zzbd.zzc().zzb(zzbbzVar2)).equals(zzbbzVar2.zzk()) ? (String) com.google.android.gms.ads.internal.client.zzbd.zzc().zzb(zzbbzVar2) : "#extension GL_OES_EGL_image_external : require\n#define INV_PI 0.3183\nprecision highp float;varying vec3 pos;uniform samplerExternalOES uSplr;uniform mat3 uVMat;uniform float uFOVx;uniform float uFOVy;void main() {  vec3 ray = vec3(pos.x * tan(uFOVx), pos.y * tan(uFOVy), -1);  ray = (uVMat * ray).xyz;  ray = normalize(ray);  vec2 texCrd = vec2(    0.5 + atan(ray.x, - ray.z) * INV_PI * 0.5, acos(ray.y) * INV_PI);  gl_FragColor = vec4(texture2D(uSplr, texCrd).xyz, 1.0);}");
            if (iZzl2 == 0) {
                iGlCreateProgram = 0;
            } else {
        ...
        if (!z || i3 == 0) {
            ...
            com.google.android.gms.ads.internal.zzv.zzp().zzw(new Throwable(strConcat), "SphericalVideoProcessor.run.1");
            zzg();
            this.zzu.countDown();
            return;
        }
        ...
        try {
            try {
                ...
                com.google.android.gms.ads.internal.util.client.zzo.zzh("SphericalVideoProcessor died.", th2);
                com.google.android.gms.ads.internal.zzv.zzp().zzw(th2, "SphericalVideoProcessor.run.2");
            }
            this.zzb.zzd();
