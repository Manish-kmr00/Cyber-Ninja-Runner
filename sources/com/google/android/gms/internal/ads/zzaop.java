...
public final class zzaop {
    public static X509Certificate[][] zza(String str) throws SecurityException, IOException, zzaol {
        RandomAccessFile randomAccessFile = new RandomAccessFile(str, "r");
        try {
            Pair pairZzc = zzaoq.zzc(randomAccessFile);
            if (pairZzc == null) {
            ...
            long jZza = zzaoq.zza(byteBuffer);
            if (jZza >= jLongValue) {
                throw new zzaol("ZIP Central Directory offset out of range: " + jZza + ". ZIP End of Central Directory offset: " + jLongValue);
            }
            if (zzaoq.zzb(byteBuffer) + jZza != jLongValue) {
                throw new zzaol("ZIP Central Directory is not immediately followed by End of Central Directory");
            }
            if (jZza < 32) {
                throw new zzaol("APK too small for APK Signing Block. ZIP Central Directory offset: " + jZza);
            }
            ...
            if (j3 < byteBufferAllocate.capacity() || j3 > 2147483639) {
                throw new zzaol("APK Signing Block size out of range: " + j3);
            }
            int i = (int) (8 + j3);
            long j4 = jZza - ((long) i);
            if (j4 < 0) {
                throw new zzaol("APK Signing Block offset out of range: " + j4);
            }
            ...
            if (j5 != j3) {
                throw new zzaol("APK Signing Block sizes in header and footer do not match: " + j5 + " vs " + j3);
            }
            ...
            try {
                ...
                while (byteBufferSlice.hasRemaining()) {
                    ...
                    if (byteBufferSlice.remaining() < 8) {
                        throw new zzaol("Insufficient data to read size of APK Signing Block entry #" + i2);
                    }
                    long j6 = byteBufferSlice.getLong();
                    if (j6 < 4 || j6 > 2147483647L) {
                        throw new zzaol("APK Signing Block entry #" + i2 + " size out of range: " + j6);
                    }
                    int i3 = (int) j6;
                    int iPosition2 = byteBufferSlice.position() + i3;
                    if (i3 > byteBufferSlice.remaining()) {
                        throw new zzaol("APK Signing Block entry #" + i2 + " size out of range: " + i3 + ", available: " + byteBufferSlice.remaining());
                    }
                    if (byteBufferSlice.getInt() == 1896449818) {
                        X509Certificate[][] x509CertificateArrZzl = zzl(randomAccessFile.getChannel(), new zzaok(zze(byteBufferSlice, i3 - 4), jLongValue2, jZza, j2, byteBuffer, null));
    ...
    private static void zzh(Map map, FileChannel fileChannel, long j, long j2, long j3, ByteBuffer byteBuffer) throws SecurityException {
        ...
        zzaoj zzaojVar = new zzaoj(fileChannel, 0L, j);
        zzaoj zzaojVar2 = new zzaoj(fileChannel, j2, j3 - j2);
        ByteBuffer byteBufferDuplicate = byteBuffer.duplicate();
        byteBufferDuplicate.order(ByteOrder.LITTLE_ENDIAN);
        zzaoq.zzd(byteBufferDuplicate, j);
        zzaoh zzaohVar = new zzaoh(byteBufferDuplicate);
        int size = map.size();
        ...
        try {
            byte[][] bArrZzk = zzk(iArr, new zzaoi[]{zzaojVar, zzaojVar2, zzaohVar});
    ...
    private static X509Certificate[] zzj(ByteBuffer byteBuffer, Map map, CertificateFactory certificateFactory) throws IOException, SecurityException {
        ...
        try {
            ...
            while (byteBufferZzf6.hasRemaining()) {
                ...
                try {
                    arrayList3.add(new zzaom((X509Certificate) certificateFactory.generateCertificate(new ByteArrayInputStream(bArrZzi4)), bArrZzi4));
    ...
    private static byte[][] zzk(int[] iArr, zzaoi[] zzaoiVarArr) throws DigestException {
        ...
        while (true) {
            ...
            jZza += (zzaoiVarArr[i3].zza() + 1048575) / PlaybackStateCompat.ACTION_SET_CAPTIONING_ENABLED;
            i3++;
        }
        if (jZza >= 2097151) {
        ...
        int i8 = 0;
        for (i = 3; i7 < i; i = 3) {
            zzaoi zzaoiVar = zzaoiVarArr[i7];
            long j3 = j2;
            long jZza2 = zzaoiVar.zza();
            while (jZza2 > j2) {
                ...
                long j4 = j3;
                try {
                    zzaoiVar.zzb(messageDigestArr, j4, iMin);
                    byte[] bArr4 = bArr3;
                    int i10 = 0;
    ...
    private static X509Certificate[][] zzl(FileChannel fileChannel, zzaok zzaokVar) throws SecurityException {
        ...
        try {
            ...
            try {
                ByteBuffer byteBufferZzf = zzf(zzaokVar.zza);
                int i = 0;
                ...
                zzh(map, fileChannel, zzaokVar.zzb, zzaokVar.zzc, zzaokVar.zzd, zzaokVar.zze);
