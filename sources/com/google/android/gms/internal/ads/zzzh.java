...
public final class zzzh implements zzzd, zzhe {
    ...
    public static final zzfww zzd = zzfww.zzr(2500000L, 1700000L, Long.valueOf(d.N), 970000L, 680000L);
    ...
    private final long zzj(int i) {
        ...
        Long lValueOf = (Long) zzfwzVar.get(Integer.valueOf(i));
        if (lValueOf == null) {
            lValueOf = (Long) zzfwzVar.get(0);
        } else if (lValueOf.longValue() == -9223372036854775807L) {
            int[] iArrZzn = zzn(zzfun.zzc(this.zzt));
            if (i == 2) {
    ...
    /* JADX WARN: Code duplicated, block: B:22:0x0038 A[Catch: all -> 0x0077, TryCatch #0 {, blocks: (B:3:0x0001, B:5:0x0005, B:7:0x0009, B:13:0x0015, B:15:0x0019, B:17:0x001f, B:19:0x0029, B:21:0x0033, B:23:0x0044, B:22:0x0038, B:24:0x0046, B:26:0x0054, B:28:0x005b), top: B:36:0x0001 }] */
            ...
            if (i != 1 && i != 0 && i != 8) {
                if (this.zzt == null) {
                    ...
                    if (context == null || (telephonyManager = (TelephonyManager) context.getSystemService("phone")) == null) {
                        strZzb = zzftc.zzb(Locale.getDefault().getCountry());
                    } else {
                        String networkCountryIso = telephonyManager.getNetworkCountryIso();
                        if (TextUtils.isEmpty(networkCountryIso)) {
                            strZzb = zzftc.zzb(Locale.getDefault().getCountry());
                        } else {
                            strZzb = zzftc.zzb(networkCountryIso);
                        }
                    }
                    this.zzt = strZzb;
                }
    ...
    private static boolean zzm(zzgj zzgjVar, boolean z) {
        return z && !zzgjVar.zzb(8);
    }
    ...
    */
    ...
    public final synchronized void zzb(zzge zzgeVar, zzgj zzgjVar, boolean z) {
        if (zzm(zzgjVar, z)) {
            ...
            this.zzp = j + j2;
            if (i > 0) {
                zzzx zzzxVar = this.zzk;
                zzzxVar.zzb((int) Math.sqrt(j2), (j2 * 8000.0f) / i);
                if (this.zzo >= 2000 || this.zzp >= PlaybackStateCompat.ACTION_SET_SHUFFLE_MODE_ENABLED) {
                    this.zzq = (long) zzzxVar.zza(0.5f);
                }
    ...
    /* synthetic */ zzzh(Context context, Map map, int i, zzdg zzdgVar, boolean z, zzzg zzzgVar) {
        ...
        zzei zzeiVarZzb = zzei.zzb(context);
        int iZza = zzeiVarZzb.zza();
        this.zzs = iZza;
        this.zzq = zzj(iZza);
        zzeiVarZzb.zzf(new zzzf(this), zzdd.zza());
    }
    ...
    public static synchronized zzzh zzh(Context context) {
        if (zzg == null) {
            ...
            zzg = new zzzh(applicationContext, map, 2000, zzdgVar, true, null);
        }
        return zzg;
    }
