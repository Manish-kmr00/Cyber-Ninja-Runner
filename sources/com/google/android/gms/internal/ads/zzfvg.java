...
final class zzfvg extends zzfvj implements NavigableMap {
    ...
    zzfvg(zzfvp zzfvpVar, NavigableMap navigableMap) {
    ...
    public final NavigableMap descendingMap() {
        return new zzfvg(this.zzc, ((NavigableMap) ((SortedMap) this.zza)).descendingMap());
    }
    ...
    final Map.Entry zzc(Iterator it) {
        ...
        it.remove();
        return new zzfws(entry.getKey(), zzfvpVar.zzb(collectionZza));
    }
    ...
    public final NavigableSet zzg() {
        return new zzfvh(this.zzc, (NavigableMap) ((SortedMap) this.zza));
    }
    ...
    public final NavigableMap headMap(Object obj, boolean z) {
        return new zzfvg(this.zzc, ((NavigableMap) ((SortedMap) this.zza)).headMap(obj, z));
    }

    @Override // java.util.NavigableMap
    public final NavigableMap subMap(Object obj, boolean z, Object obj2, boolean z2) {
        return new zzfvg(this.zzc, ((NavigableMap) ((SortedMap) this.zza)).subMap(obj, z, obj2, z2));
    }

    @Override // java.util.NavigableMap
    public final NavigableMap tailMap(Object obj, boolean z) {
        return new zzfvg(this.zzc, ((NavigableMap) ((SortedMap) this.zza)).tailMap(obj, z));
    }
}
