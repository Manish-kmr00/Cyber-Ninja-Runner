...
public final class zzawc {
    ...
    private static boolean zzm(View view) {
        try {
            ...
            String str = (String) objInvoke.getClass().getMethod("adTypeToString", Integer.TYPE).invoke(null, Integer.valueOf(((Integer) objInvoke.getClass().getField(Ad.AD_TYPE).get(objInvoke)).intValue()));
            return str.contains("INTERSTITIAL") || str.contains("APP_OPEN") || str.contains(BrandSafetyUtils.k);
