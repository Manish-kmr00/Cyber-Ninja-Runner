...
public final class zzgvm implements zzgqc {
    ...
    public zzgvm(byte[] bArr) throws GeneralSecurityException {
        ...
        byte[] bArrZza = zzgpt.zza(cipherZzb.doFinal(new byte[16]));
        this.zzc = bArrZza;
        this.zzd = zzgpt.zza(bArrZza);
    }
    ...
    public final byte[] zza(byte[] bArr, int i) throws GeneralSecurityException {
        ...
        int i4 = i3 * 16;
        if (i2 * 16 == length) {
            bArrZzc = zzgus.zzc(bArr, i4, this.zzc, 0, 16);
        } else {
            ...
            bArrZzc = zzgus.zzc(bArrCopyOf, 0, bArr2, 0, 16);
        }
