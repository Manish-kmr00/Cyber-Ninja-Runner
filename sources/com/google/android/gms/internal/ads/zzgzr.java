...
final class zzgzr extends zzgvz implements RandomAccess {
    ...
    public final /* bridge */ /* synthetic */ zzgyh zzf(int i) {
        if (i >= this.zzd) {
            return new zzgzr(i == 0 ? zza : Arrays.copyOf(this.zzc, i), this.zzd, true);
        }
        throw new IllegalArgumentException();
    }

    private zzgzr(Object[] objArr, int i, boolean z) {
        super(z);
        this.zzc = objArr;
        this.zzd = i;
    }
