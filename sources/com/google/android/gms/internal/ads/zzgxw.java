...
final class zzgxw extends zzgvz implements RandomAccess, zzgyd, zzgzp {
    ...
    public final zzgyd zzf(int i) {
        if (i >= this.zzd) {
            return new zzgxw(i == 0 ? zza : Arrays.copyOf(this.zzc, i), this.zzd, true);
        }
    ...
    private zzgxw(int[] iArr, int i, boolean z) {
        super(z);
        this.zzc = iArr;
        this.zzd = i;
    }
