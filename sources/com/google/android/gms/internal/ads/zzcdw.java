...
final class zzcdw extends zzfx implements zzgz {
    ...
    zzcdw(String str, zzhe zzheVar, int i, int i2, long j, long j2) {
        super(true);
        zzdc.zzc(str);
        this.zzd = str;
        this.zze = new zzgy();
    ...
    public final int zza(byte[] bArr, int i, int i2) throws zzgv {
        ...
        try {
            ...
            if (j6 > j8) {
                long j9 = this.zzo;
                if (j7 < j9) {
                    long jMin = Math.min(j9, Math.max(((this.zzq + j8) - j5) - 1, (-1) + j8 + j4));
                    zzk(j8, jMin, 2);
                    this.zzp = jMin;
                    j7 = jMin;
                }
            ...
            throw new zzgv(e, this.zzf, 2000, 2);
        }
    }
        ...
        if (!TextUtils.isEmpty(headerField)) {
            ...
            if (matcher.find()) {
                try {
                    ...
                    String str = "Unexpected Content-Range [" + headerField + b9.i.e;
                    int i = com.google.android.gms.ads.internal.util.zze.zza;
        ...
        try {
            ...
            if (inputStream != null) {
                try {
                    ...
                    throw new zzgv(e, this.zzf, 2000, 3);
                }
            }
            this.zzi = null;
            zzl();
    ...
    final HttpURLConnection zzk(long j, long j2, int i) throws zzgv {
        ...
        try {
            ...
            try {
                ...
                if (iHttpUrlConnectionGetResponseCode < 200 || iHttpUrlConnectionGetResponseCode > 299) {
                    ...
                    zzl();
                    throw new zzcdv(this.zzk, headerFields, this.zzf, i);
                }
                try {
                    ...
                    zzl();
                    throw new zzgv(e, this.zzf, 2000, i);
                }
            } catch (IOException e2) {
                zzl();
                throw new zzgv("Unable to connect to ".concat(String.valueOf(string2)), e2, this.zzf, 2000, i);
            }
        } catch (IOException e3) {
            throw new zzgv("Unable to connect to ".concat(String.valueOf(string)), e3, this.zzf, 2000, i);
        }
    }
}
