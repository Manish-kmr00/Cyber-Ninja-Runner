...
public final class zzbfi extends AbstractSafeParcelable {
    ...
    public zzbfi(int i, boolean z, int i2, boolean z2, int i3, com.google.android.gms.ads.internal.client.zzfw zzfwVar, boolean z3, int i4, int i5, boolean z4, int i6) {
        this.zza = i;
        this.zzb = z;
        this.zzc = i2;
        this.zzd = z2;
    ...
    public static NativeAdOptions zza(zzbfi zzbfiVar) {
        ...
        if (i == 2) {
            ...
            if (i != 3) {
                if (i == 4) {
                    ...
                    builder.enableCustomClickGestureDirection(zzbfiVar.zzi, zzbfiVar.zzj);
                    int i3 = zzbfiVar.zzk;
                    if (i3 == 0) {
                        i2 = 1;
                    } else if (i3 == 2) {
    ...
    @Deprecated
    public zzbfi(com.google.android.gms.ads.formats.NativeAdOptions nativeAdOptions) {
