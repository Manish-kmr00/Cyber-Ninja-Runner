...
final class zzdp extends zzdq.zza {
    ...
    public final void zza() {
        ...
        try {
            ...
            ((zzdb) Preconditions.checkNotNull(this.zzg.zzj)).initialize(ObjectWrapper.wrap(this.zze), new zzdo(97001L, Math.max(localVersion, remoteVersion), remoteVersion < localVersion, str, str2, str3, this.zzf, com.google.android.gms.measurement.internal.zzhd.zza(this.zze)), this.zza);
        } catch (Exception e) {
