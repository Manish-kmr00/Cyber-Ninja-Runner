...
import com.facebook.ads.redexgen.core.VA;
...
public final class EventMessage implements Metadata.Entry {
    ...
    public EventMessage(Parcel parcel) {
        this.A03 = (String) AbstractC2471gE.A0f(parcel.readString());
        this.A04 = (String) AbstractC2471gE.A0f(parcel.readString());
        this.A01 = parcel.readLong();
        this.A02 = parcel.readLong();
        this.A05 = (byte[]) AbstractC2471gE.A0f(parcel.createByteArray());
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.A01 == eventMessage.A01 && this.A02 == eventMessage.A02 && AbstractC2471gE.A1E(this.A03, eventMessage.A03)) {
            boolean zA1E = AbstractC2471gE.A1E(this.A04, eventMessage.A04);
            String[] strArr = A07;
            ...
            strArr2[5] = CampaignEx.JSON_KEY_AD_K;
            if (zA1E && Arrays.equals(this.A05, eventMessage.A05)) {
                return true;
            }
        }
        return false;
