    ...
    public static int inferFileTypeFromMimeType(String str) {
        ...
        switch (strNormalizeMimeType.hashCode()) {
            ...
            case -1487394660:
                ...
                break;
            case -1248337486:
                b = !strNormalizeMimeType.equals("application/mp4") ? (byte) -1 : (byte) 6;
                break;
            case -1079884372:
                b = !strNormalizeMimeType.equals("video/x-msvideo") ? (byte) -1 : (byte) 7;
                break;
            case -1004728940:
                b = !strNormalizeMimeType.equals("text/vtt") ? (byte) -1 : (byte) 8;
                break;
            case -387023398:
                b = !strNormalizeMimeType.equals("audio/x-matroska") ? (byte) -1 : (byte) 9;
                break;
            case -43467528:
                b = !strNormalizeMimeType.equals("application/webm") ? (byte) -1 : (byte) 10;
                break;
            case 13915911:
                b = !strNormalizeMimeType.equals("video/x-flv") ? (byte) -1 : (byte) 11;
                break;
            case 187078296:
                b = !strNormalizeMimeType.equals("audio/ac3") ? (byte) -1 : (byte) 12;
                break;
            case 187078297:
                b = !strNormalizeMimeType.equals("audio/ac4") ? (byte) -1 : (byte) 13;
                break;
            case 187078669:
                b = !strNormalizeMimeType.equals("audio/amr") ? (byte) -1 : (byte) 14;
                break;
            case 187090232:
                b = !strNormalizeMimeType.equals("audio/mp4") ? (byte) -1 : (byte) 15;
                break;
            case 187091926:
                b = !strNormalizeMimeType.equals("audio/ogg") ? (byte) -1 : (byte) 16;
                break;
            case 187099443:
                b = !strNormalizeMimeType.equals("audio/wav") ? (byte) -1 : (byte) 17;
                break;
            case 1331848029:
                b = !strNormalizeMimeType.equals("video/mp4") ? (byte) -1 : Ascii.DC2;
                break;
            case 1503095341:
                b = !strNormalizeMimeType.equals("audio/3gpp") ? (byte) -1 : (byte) 19;
                break;
            case 1504578661:
                b = !strNormalizeMimeType.equals("audio/eac3") ? (byte) -1 : Ascii.DC4;
                break;
            case 1504619009:
                b = !strNormalizeMimeType.equals("audio/flac") ? (byte) -1 : Ascii.NAK;
                break;
            case 1504824762:
                b = !strNormalizeMimeType.equals("audio/midi") ? (byte) -1 : Ascii.SYN;
                break;
            case 1504831518:
                b = !strNormalizeMimeType.equals("audio/mpeg") ? (byte) -1 : Ascii.ETB;
                break;
            case 1505118770:
                b = !strNormalizeMimeType.equals("audio/webm") ? (byte) -1 : Ascii.CAN;
                break;
            case 2039520277:
                b = !strNormalizeMimeType.equals("video/x-matroska") ? (byte) -1 : Ascii.EM;
                break;
            default:
                b = -1;
                break;
