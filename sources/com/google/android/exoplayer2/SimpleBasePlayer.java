...
public abstract class SimpleBasePlayer extends BasePlayer {
    ...
    protected static final class State {
        ...
        public final com.google.android.exoplayer2.metadata.Metadata timedMetadata;
        ...
        public static final class Builder {
            ...
            private com.google.android.exoplayer2.metadata.Metadata timedMetadata;
            ...
            public Builder() {
                ...
                this.timedMetadata = new com.google.android.exoplayer2.metadata.Metadata(-9223372036854775807L, new com.google.android.exoplayer2.metadata.Metadata.Entry[0]);
            ...
            public Builder setTimedMetadata(com.google.android.exoplayer2.metadata.Metadata metadata) {
    ...
    protected SimpleBasePlayer(Looper looper, Clock clock) {
        ...
        this.listeners = new ListenerSet<>(looper, clock, new ListenerSet.IterationFinishedEvent() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda51
            ...
            public final void invoke(Object obj, FlagSet flagSet) {
                this.f$0.m5050lambda$new$0$comgoogleandroidexoplayer2SimpleBasePlayer((Player.Listener) obj, flagSet);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$new$0$com-google-android-exoplayer2-SimpleBasePlayer, reason: not valid java name */
    /* synthetic */ void m5050lambda$new$0$comgoogleandroidexoplayer2SimpleBasePlayer(Player.Listener listener, FlagSet flagSet) {
    ...
    private void setMediaItemsInternal(final List<MediaItem> list, final int i, final long j) {
        ...
        if (shouldHandleCommand(20) || (list.size() == 1 && shouldHandleCommand(31))) {
            updateStateForPendingOperation(handleSetMediaItems(list, i, j), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda47
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    return this.f$0.m5052xb80ed5ee(list, state, i, j);
                }
            });
        }
    }
    ...
    /* synthetic */ State m5052xb80ed5ee(List list, State state, int i, long j) {
    ...
    public final void moveMediaItems(final int i, int i2, int i3) {
        ...
        updateStateForPendingOperation(handleMoveMediaItems(i, iMin, iMin2), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda50
            @Override // com.google.common.base.Supplier
            public final Object get() {
                return this.f$0.m5049xfea097c0(state, i, iMin, iMin2);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$moveMediaItems$4$com-google-android-exoplayer2-SimpleBasePlayer, reason: not valid java name */
    /* synthetic */ State m5049xfea097c0(State state, int i, int i2, int i3) {
        ArrayList arrayList = new ArrayList(state.playlist);
    ...
    public final void removeMediaItems(final int i, int i2) {
        ...
        updateStateForPendingOperation(handleRemoveMediaItems(i, iMin), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda45
            @Override // com.google.common.base.Supplier
            public final Object get() {
                return this.f$0.m5051xc687f44c(state, i, iMin);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$removeMediaItems$5$com-google-android-exoplayer2-SimpleBasePlayer, reason: not valid java name */
    /* synthetic */ State m5051xc687f44c(State state, int i, int i2) {
        ArrayList arrayList = new ArrayList(state.playlist);
    ...
    public final void release() {
        ...
        updateStateForPendingOperation(handleRelease(), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda30
            @Override // com.google.common.base.Supplier
            public final Object get() {
                return SimpleBasePlayer.lambda$release$12(state);
            }
        });
        this.released = true;
    ...
    private void updateStateForPendingOperation(final ListenableFuture<?> listenableFuture, Supplier<State> supplier, boolean z, boolean z2) {
        ...
        listenableFuture.addListener(new Runnable() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda38
            ...
            public final void run() {
                this.f$0.m5053x902fbd44(listenableFuture);
            }
    ...
    /* JADX INFO: renamed from: lambda$updateStateForPendingOperation$55$com-google-android-exoplayer2-SimpleBasePlayer, reason: not valid java name */
    /* synthetic */ void m5053x902fbd44(ListenableFuture listenableFuture) {
