...
public final class ConcatenatingMediaSource2 extends CompositeMediaSource<Integer> {
    ...
    public void m5096x365769cd(Integer num, MediaSource mediaSource, Timeline timeline) {
        scheduleTimelineUpdate();
    }
    ...
    private ConcatenatedTimeline maybeCreateConcatenatedTimeline() {
        ...
        return new ConcatenatedTimeline(this.mediaItem, builder.build(), builder2.build(), builder3.build(), z3, z4, j3, j4, z2 ? obj : null);
    }
