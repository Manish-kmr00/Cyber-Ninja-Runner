...
public final class RtspMediaSource extends BaseMediaSource {
    ...
    public static final class Factory implements MediaSourceFactory {
        ...
        private String userAgent = "ExoPlayerLib/2.16.0";
        ...
        public RtspMediaSource createMediaSource(MediaItem mediaItem) {
            ...
            return new RtspMediaSource(mediaItem, udpDataSourceRtpDataChannelFactory, this.userAgent, this.debugLoggingEnabled);
        }
    }
    ...
    public MediaPeriod createPeriod(MediaSource.MediaPeriodId mediaPeriodId, Allocator allocator, long j) {
        return new RtspMediaPeriod(allocator, this.rtpDataChannelFactory, this.uri, new RtspMediaPeriod.Listener() { // from class: com.google.android.exoplayer2.source.rtsp.RtspMediaSource$$ExternalSyntheticLambda0
            ...
            public final void onSourceInfoRefreshed(RtspSessionTiming rtspSessionTiming) {
                this.f$0.m5133xb2d0ac94(rtspSessionTiming);
            }
        }, this.userAgent, this.debugLoggingEnabled);
    }

    /* JADX INFO: renamed from: lambda$createPeriod$0$com-google-android-exoplayer2-source-rtsp-RtspMediaSource, reason: not valid java name */
    /* synthetic */ void m5133xb2d0ac94(RtspSessionTiming rtspSessionTiming) {
