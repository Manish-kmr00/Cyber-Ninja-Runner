...
final class RtspClient implements Closeable {
    ...
    final class MessageListener implements RtspMessageChannel.MessageListener {
        ...
        public void m5131xbc9c051a(List<String> list) {
            ...
            try {
                ...
                if (i3 != 200) {
                    if (i3 != 401) {
                        ...
                        RtspClient.this.rtspAuthenticationInfo = RtspMessageUtil.parseWwwAuthenticateHeader(str2);
                    ...
                    rtspClient.dispatchRtspError(new RtspMediaSource.RtspPlaybackException(new StringBuilder(String.valueOf(methodString).length() + 12).append(methodString).append(" ").append(response.status).toString()));
                    return;
                }
                switch (i2) {
                    case 1:
                    ...
                    case 5:
                        ...
                        return;
                    case 6:
                        String str3 = response.headers.get("Range");
                        if (str3 == null) {
                            timing = RtspSessionTiming.DEFAULT;
                        } else {
                            timing = RtspSessionTiming.parseTiming(str3);
                        }
                        String str4 = response.headers.get(RtspHeaders.RTP_INFO);
                        if (str4 != null) {
                            trackTiming = RtspTrackTiming.parseTrackTiming(str4, RtspClient.this.uri);
                        } else {
                        ...
                        return;
                    case 10:
                        String str5 = response.headers.get(RtspHeaders.SESSION);
                        String str6 = response.headers.get(RtspHeaders.TRANSPORT);
                        if (str5 == null || str6 == null) {
                            throw ParserException.createForMalformedManifest("Missing mandatory session or transport header", null);
                        }
                        onSetupResponseReceived(new RtspSetupResponse(response.status, RtspMessageUtil.parseSessionHeader(str5), str6));
                        return;
                    default:
