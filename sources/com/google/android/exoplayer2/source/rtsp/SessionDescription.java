...
final class SessionDescription {
    ...
    public static final class Builder {
        ...
        public Builder addMediaDescription(MediaDescription mediaDescription) {
            this.mediaDescriptionListBuilder.add(mediaDescription);
            return this;
        }
    ...
    public int hashCode() {
        int iHashCode = (((((((((((Sdk.SDKError.Reason.AD_RESPONSE_TIMED_OUT_VALUE + this.attributes.hashCode()) * 31) + this.mediaDescriptionList.hashCode()) * 31) + this.origin.hashCode()) * 31) + this.sessionName.hashCode()) * 31) + this.timing.hashCode()) * 31) + this.bitrate) * 31;
