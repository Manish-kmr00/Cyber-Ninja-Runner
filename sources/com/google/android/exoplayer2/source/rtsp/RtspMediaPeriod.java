...
final class RtspMediaPeriod implements MediaPeriod {
    ...
    public RtspMediaPeriod(Allocator allocator, RtpDataChannel.Factory factory, Uri uri, Listener listener, String str, boolean z) {
        ...
        this.rtspClient = new RtspClient(internalListener, internalListener, str, uri, z);
    ...
    private static ImmutableList<TrackGroup> buildTrackGroups(ImmutableList<RtspLoaderWrapper> immutableList) {
        ...
        for (int i = 0; i < immutableList.size(); i++) {
            builder.add(new TrackGroup((Format) Assertions.checkNotNull(immutableList.get(i).sampleQueue.getUpstreamFormat())));
        }
        ...
        public RtpLoadInfo(RtspMediaTrack rtspMediaTrack, int i, RtpDataChannel.Factory factory) {
            ...
            this.loadable = new RtpDataLoadable(i, rtspMediaTrack, new RtpDataLoadable.EventListener() { // from class: com.google.android.exoplayer2.source.rtsp.RtspMediaPeriod$RtpLoadInfo$$ExternalSyntheticLambda0
                ...
                public final void onTransportReady(String str, RtpDataChannel rtpDataChannel) {
                    this.f$0.m5132x3d57be61(str, rtpDataChannel);
                }
            }, RtspMediaPeriod.this.internalListener, factory);
        }

        /* JADX INFO: renamed from: lambda$new$0$com-google-android-exoplayer2-source-rtsp-RtspMediaPeriod$RtpLoadInfo, reason: not valid java name */
        /* synthetic */ void m5132x3d57be61(String str, RtpDataChannel rtpDataChannel) {
            this.transport = str;
