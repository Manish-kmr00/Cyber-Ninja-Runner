...
public final class DashMediaSource extends BaseMediaSource {
    ...
    public static final class Factory implements MediaSourceFactory {
        ...
        public /* bridge */ /* synthetic */ MediaSourceFactory setStreamKeys(List list) {
            return m5121setStreamKeys((List<StreamKey>) list);
        }
        ...
        @Deprecated
        /* JADX INFO: renamed from: setStreamKeys, reason: collision with other method in class */
        public Factory m5121setStreamKeys(List<StreamKey> list) {
            if (list == null) {
        ...
        public DashMediaSource createMediaSource(DashManifest dashManifest, MediaItem mediaItem) {
            ...
            if (mediaItem.liveConfiguration.targetOffsetMs == -9223372036854775807L) {
                mimeType.setLiveConfiguration(mediaItem.liveConfiguration.buildUpon().setTargetOffsetMs(this.targetLiveOffsetOverrideMs).build());
            }
        ...
        public DashMediaSource createMediaSource(MediaItem mediaItem) {
            ...
            boolean z3 = mediaItemBuild.liveConfiguration.targetOffsetMs == -9223372036854775807L && this.targetLiveOffsetOverrideMs != -9223372036854775807L;
            if (z || z2 || z3) {
    ...
    private DashMediaSource(MediaItem mediaItem, DashManifest dashManifest, DataSource.Factory factory, ParsingLoadable.Parser<? extends DashManifest> parser, DashChunkSource.Factory factory2, CompositeSequenceableLoaderFactory compositeSequenceableLoaderFactory, DrmSessionManager drmSessionManager, LoadErrorHandlingPolicy loadErrorHandlingPolicy, long j) {
        ...
        this.simulateManifestRefreshRunnable = new Runnable() { // from class: com.google.android.exoplayer2.source.dash.DashMediaSource$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m5116x86b5dcdd();
            }
        };
    }

    /* JADX INFO: renamed from: lambda$new$0$com-google-android-exoplayer2-source-dash-DashMediaSource, reason: not valid java name */
    /* synthetic */ void m5116x86b5dcdd() {
    ...
    private void processManifest(boolean z) {
        ...
        if (this.manifest.dynamic) {
            ...
            j = jUsToMs;
            long jMin = Math.min(5000000L, j3 / 2);
    ...
    private void updateMediaItemLiveConfiguration(long j, long j2) {
        ...
        if (jConstrainValue > jUsToMs) {
            jConstrainValue = Util.constrainValue(Util.usToMs(j - Math.min(5000000L, j2 / 2)), j3, jUsToMs);
        }
        long j4 = jConstrainValue;
        ...
        this.liveConfiguration = new MediaItem.LiveConfiguration(j4, j3, jUsToMs, f, f2);
    }
