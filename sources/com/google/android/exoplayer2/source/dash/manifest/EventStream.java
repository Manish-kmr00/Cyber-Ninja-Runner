...
public final class EventStream {
    ...
    public String id() {
        ...
        return new StringBuilder(String.valueOf(str).length() + 1 + String.valueOf(str2).length()).append(str).append(RemoteSettings.FORWARD_SLASH_STRING).append(str2).toString();
    }
}
