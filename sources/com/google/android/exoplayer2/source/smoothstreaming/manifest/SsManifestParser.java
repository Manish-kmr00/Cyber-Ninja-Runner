    ...
    private static class StreamIndexParser extends ElementParser {
        ...
        private int parseType(XmlPullParser xmlPullParser) throws ParserException {
            ...
            if (attributeValue != null) {
                ...
                throw ParserException.createForMalformedManifest(new StringBuilder(String.valueOf(attributeValue).length() + 19).append("Invalid key value[").append(attributeValue).append(b9.i.e).toString(), null);
            }
        ...
        public void parseStartTag(XmlPullParser xmlPullParser) throws ParserException {
            ...
            if (iIntValue == 2) {
                ...
                if (strFourCCToMimeType == null) {
                    strFourCCToMimeType = "audio/mp4a-latm";
                }
                ...
                if (listBuildCodecSpecificData.isEmpty() && "audio/mp4a-latm".equals(strFourCCToMimeType)) {
