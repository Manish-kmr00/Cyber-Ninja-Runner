...
public final class SsMediaSource extends BaseMediaSource implements Loader.Callback<ParsingLoadable<SsManifest>> {
    ...
    public static final class Factory implements MediaSourceFactory {
        ...
        public /* bridge */ /* synthetic */ MediaSourceFactory setStreamKeys(List list) {
            return m5143setStreamKeys((List<StreamKey>) list);
        }
        ...
        public Factory m5143setStreamKeys(List<StreamKey> list) {
            if (list == null) {
        ...
        public SsMediaSource createMediaSource(SsManifest ssManifest, MediaItem mediaItem) {
            ...
            MediaItem mediaItemBuild = mediaItem.buildUpon().setMimeType("application/vnd.ms-sstr+xml").setUri(z ? mediaItem.localConfiguration.uri : Uri.EMPTY).setTag(z && mediaItem.localConfiguration.tag != null ? mediaItem.localConfiguration.tag : this.tag).setStreamKeys(list).build();
