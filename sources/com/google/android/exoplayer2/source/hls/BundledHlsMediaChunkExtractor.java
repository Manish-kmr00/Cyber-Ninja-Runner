...
public final class BundledHlsMediaChunkExtractor implements HlsMediaChunkExtractor {
    ...
    public HlsMediaChunkExtractor recreate() {
        ...
        if (extractor instanceof WebvttExtractor) {
            ...
            String strValueOf = String.valueOf(this.extractor.getClass().getSimpleName());
            throw new IllegalStateException(strValueOf.length() != 0 ? "Unexpected extractor type for recreation: ".concat(strValueOf) : new String("Unexpected extractor type for recreation: "));
        }
        return new BundledHlsMediaChunkExtractor(mp3Extractor, this.masterPlaylistFormat, this.timestampAdjuster);
    }
