...
public final class HlsMediaSource extends BaseMediaSource implements HlsPlaylistTracker.PrimaryPlaylistListener {
    ...
    public static final class Factory implements MediaSourceFactory {
        ...
        public /* bridge */ /* synthetic */ MediaSourceFactory setStreamKeys(List list) {
            return m5126setStreamKeys((List<StreamKey>) list);
        }
        ...
        public Factory m5126setStreamKeys(List<StreamKey> list) {
            if (list == null) {
    ...
    private void maybeUpdateLiveConfiguration(long j) {
        ...
        if (jUsToMs != this.liveConfiguration.targetOffsetMs) {
            this.liveConfiguration = this.liveConfiguration.buildUpon().setTargetOffsetMs(jUsToMs).build();
        }
    }
