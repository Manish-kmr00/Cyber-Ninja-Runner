...
public final class HlsMediaPeriod implements MediaPeriod, HlsSampleStreamWrapper.Callback, HlsPlaylistTracker.PlaylistEventListener {
    ...
    public List<StreamKey> getStreamKeys(List<ExoTrackSelection> list) {
        ...
        boolean zIsEmpty = hlsMasterPlaylist.variants.isEmpty();
        boolean z = !zIsEmpty;
    ...
    private void buildAndPrepareSampleStreamWrappers(long j) {
        ...
        while (i2 < list2.size()) {
            ...
            HlsSampleStreamWrapper hlsSampleStreamWrapperBuildSampleStreamWrapper = buildSampleStreamWrapper(3, uriArr, formatArr, null, Collections.emptyList(), map, j);
        ...
        int i3 = i;
        this.sampleStreamWrappers = (HlsSampleStreamWrapper[]) arrayList.toArray(new HlsSampleStreamWrapper[i3]);
        this.manifestUrlIndicesPerWrapper = (int[][]) arrayList2.toArray(new int[i3][]);
        HlsSampleStreamWrapper[] hlsSampleStreamWrapperArr = this.sampleStreamWrappers;
        this.pendingPrepareCount = hlsSampleStreamWrapperArr.length;
        hlsSampleStreamWrapperArr[i3].setIsTimestampMaster(true);
        HlsSampleStreamWrapper[] hlsSampleStreamWrapperArr2 = this.sampleStreamWrappers;
        int length = hlsSampleStreamWrapperArr2.length;
        while (i < length) {
            hlsSampleStreamWrapperArr2[i].continuePreparing();
            i++;
        }
    ...
    private void buildAndPrepareMainSampleStreamWrapper(HlsMasterPlaylist hlsMasterPlaylist, long j, List<HlsSampleStreamWrapper> list, List<int[]> list2, Map<String, DrmInitData> map) {
        ...
        HlsSampleStreamWrapper hlsSampleStreamWrapperBuildSampleStreamWrapper = buildSampleStreamWrapper((z || codecCountOfType2 <= 0) ? 0 : 1, uriArr, formatArr, hlsMasterPlaylist.muxedAudioFormat, hlsMasterPlaylist.muxedCaptionFormats, map, j);
