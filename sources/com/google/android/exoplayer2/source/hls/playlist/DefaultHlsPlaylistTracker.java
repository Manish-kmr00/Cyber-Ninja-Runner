...
public final class DefaultHlsPlaylistTracker implements HlsPlaylistTracker, Loader.Callback<ParsingLoadable<HlsPlaylist>> {
    ...
    final class MediaPlaylistBundle implements Loader.Callback<ParsingLoadable<HlsPlaylist>> {
        ...
        /* JADX INFO: renamed from: lambda$loadPlaylistInternal$0$com-google-android-exoplayer2-source-hls-playlist-DefaultHlsPlaylistTracker$MediaPlaylistBundle, reason: not valid java name */
        /* synthetic */ void m5129x4fadff69(Uri uri) {
        ...
        private Uri getMediaPlaylistUriForReload() {
            ...
            if (this.playlistSnapshot.serverControl.skipUntilUs != -9223372036854775807L) {
                builderBuildUpon.appendQueryParameter(SKIP_PARAM, this.playlistSnapshot.serverControl.canSkipDateRanges ? s.f6343a : "YES");
            }
            return builderBuildUpon.build();
        }
