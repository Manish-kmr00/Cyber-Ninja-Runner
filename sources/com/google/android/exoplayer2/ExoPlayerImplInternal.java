...
final class ExoPlayerImplInternal implements Handler.Callback, MediaPeriod.Callback, TrackSelector.InvalidationListener, MediaSourceList.MediaSourceListInfoRefreshListener, DefaultMediaClock.PlaybackParametersListener, PlayerMessage.Sender {
    ...
    public synchronized boolean release() {
        if (!this.released && this.playbackLooper.getThread().isAlive()) {
            ...
            waitUninterruptibly(new Supplier() { // from class: com.google.android.exoplayer2.ExoPlayerImplInternal$$ExternalSyntheticLambda1
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    return this.f$0.m5028x37739a9a();
                }
    ...
    /* synthetic */ Boolean m5028x37739a9a() {
        ...
        if (!looper.getThread().isAlive()) {
            ...
            this.clock.createHandler(looper, null).post(new Runnable() { // from class: com.google.android.exoplayer2.ExoPlayerImplInternal$$ExternalSyntheticLambda2
                ...
                public final void run() {
                    this.f$0.m5029xacec0129(playerMessage);
                }
            });
        }
    }
    ...
    /* synthetic */ void m5029xacec0129(PlayerMessage playerMessage) {
        try {
            deliverMessage(playerMessage);
        } catch (ExoPlaybackException e) {
    ...
    */
    ...
    /* JADX WARN: Code duplicated, block: B:55:0x00f4 A[ADDED_TO_REGION] */
    ...
    /* JADX WARN: Code duplicated, block: B:85:0x0186 A[ADDED_TO_REGION] */
    ...
    private void handleMediaSourceListInfoRefreshed(Timeline timeline, boolean z) throws Throwable {
        ...
        long j6 = positionUpdateForPlaylistChangeResolvePositionForPlaylistChange.periodPositionUs;
        int i4 = 1;
        boolean z5 = (this.playbackInfo.periodId.equals(mediaPeriodId) && j6 == this.playbackInfo.positionUs) ? false : true;
        try {
            ...
            try {
                if (z5) {
                    ...
                    if (timeline.isEmpty()) {
                        ...
                        try {
                            ...
                            j6 = j3;
                            try {
                                jSeekToPeriodPosition = seekToPeriodPosition(mediaPeriodId, j6, z4);
                            } catch (Throwable th) {
                                th = th;
                                j = j6;
                                updatePlaybackSpeedSettingsForNewPeriod(timeline, mediaPeriodId, this.playbackInfo.timeline, this.playbackInfo.periodId, positionUpdateForPlaylistChangeResolvePositionForPlaylistChange.setTargetLiveOffset ? j6 : -9223372036854775807L, false);
                                if (z5) {
                                    ...
                                    if (timeline.getIndexOfPeriod(obj) == i4) {
                                        i2 = i;
                                    } else {
                                        i2 = 3;
                                    }
                                    this.playbackInfo = handlePositionDiscontinuity(mediaPeriodId, j, j5, j7, z2, i2);
                                } else {
                                    obj = this.playbackInfo.periodId.periodUid;
                                    ...
                                    this.playbackInfo = handlePositionDiscontinuity(mediaPeriodId, j, j5, j8, z2, i2);
                                }
                                resetPendingPauseAtEndOfPeriod();
                    ...
                    updatePlaybackSpeedSettingsForNewPeriod(timeline, mediaPeriodId, timeline4, mediaPeriodId2, j4, false);
                    if (z5) {
                        ...
                        if (timeline.getIndexOfPeriod(obj2) == i4) {
                            i3 = i;
                        } else {
                            i3 = 3;
                        }
                        this.playbackInfo = handlePositionDiscontinuity(mediaPeriodId, jSeekToPeriodPosition, j5, j9, z3, i3);
                    } else {
                        obj2 = this.playbackInfo.periodId.periodUid;
                        ...
                        this.playbackInfo = handlePositionDiscontinuity(mediaPeriodId, jSeekToPeriodPosition, j5, j10, z3, i3);
                    }
                    resetPendingPauseAtEndOfPeriod();
                    resolvePendingMessagePositions(timeline, this.playbackInfo.timeline);
                    this.playbackInfo = this.playbackInfo.copyWithTimeline(timeline);
                ...
                try {
                    try {
                        ...
                        updatePlaybackSpeedSettingsForNewPeriod(timeline, mediaPeriodId, timeline7, mediaPeriodId3, j4, false);
                        if (z5 || j5 != this.playbackInfo.requestedContentPositionUs) {
                            obj2 = this.playbackInfo.periodId.periodUid;
                            Timeline timeline8 = this.playbackInfo.timeline;
                            if (z5 || !z || timeline8.isEmpty() || timeline8.getPeriodByUid(obj2, this.period).isPlaceholder) {
                                z3 = false;
                            } else {
                                z3 = true;
                            }
                            long j11 = this.playbackInfo.discontinuityStartPositionUs;
                            if (timeline.getIndexOfPeriod(obj2) == i4) {
                                i3 = i;
                            } else {
                                i3 = 3;
                            }
                            this.playbackInfo = handlePositionDiscontinuity(mediaPeriodId, jSeekToPeriodPosition, j5, j11, z3, i3);
                        }
                        resetPendingPauseAtEndOfPeriod();
                        resolvePendingMessagePositions(timeline, this.playbackInfo.timeline);
                        this.playbackInfo = this.playbackInfo.copyWithTimeline(timeline);
                        ...
                        if (z5 || j5 != this.playbackInfo.requestedContentPositionUs) {
                            obj = this.playbackInfo.periodId.periodUid;
                            Timeline timeline9 = this.playbackInfo.timeline;
                            if (z5 || !z || timeline9.isEmpty() || timeline9.getPeriodByUid(obj, this.period).isPlaceholder) {
                                z2 = false;
                            } else {
                                z2 = true;
                            }
                            ...
                            this.playbackInfo = handlePositionDiscontinuity(mediaPeriodId, j, j5, j12, z2, i2);
                        }
                        resetPendingPauseAtEndOfPeriod();
                        resolvePendingMessagePositions(timeline, this.playbackInfo.timeline);
                        this.playbackInfo = this.playbackInfo.copyWithTimeline(timeline);
    ...
    private PlaybackInfo handlePositionDiscontinuity(MediaSource.MediaPeriodId mediaPeriodId, long j, long j2, long j3, boolean z, int i) {
        ...
        List<com.google.android.exoplayer2.metadata.Metadata> listOf = this.playbackInfo.staticMetadata;
        if (this.mediaSourceList.isPrepared()) {
            ...
            ImmutableList<com.google.android.exoplayer2.metadata.Metadata> immutableListExtractMetadataFromTrackSelectionArray = extractMetadataFromTrackSelectionArray(trackSelectorResult2.selections);
    ...
    private ImmutableList<com.google.android.exoplayer2.metadata.Metadata> extractMetadataFromTrackSelectionArray(ExoTrackSelection[] exoTrackSelectionArr) {
        ...
        for (ExoTrackSelection exoTrackSelection : exoTrackSelectionArr) {
            if (exoTrackSelection != null) {
                ...
                if (format.metadata == null) {
                    builder.add(new com.google.android.exoplayer2.metadata.Metadata(new com.google.android.exoplayer2.metadata.Metadata.Entry[0]));
                } else {
