...
public final class Format implements Bundleable {
    ...
    public static final class Builder {
        ...
        public Builder setMetadata(com.google.android.exoplayer2.metadata.Metadata metadata) {
        ...
        public Builder setDrmInitData(com.google.android.exoplayer2.drm.DrmInitData drmInitData) {
        ...
        public Builder setColorInfo(com.google.android.exoplayer2.video.ColorInfo colorInfo) {
    ...
    @Deprecated
    public static Format createVideoSampleFormat(String str, String str2, String str3, int i, int i2, int i3, int i4, float f, List<byte[]> list, com.google.android.exoplayer2.drm.DrmInitData drmInitData) {
    ...
    @Deprecated
    public static Format createVideoSampleFormat(String str, String str2, String str3, int i, int i2, int i3, int i4, float f, List<byte[]> list, int i5, float f2, com.google.android.exoplayer2.drm.DrmInitData drmInitData) {
    ...
    @Deprecated
    public static Format createAudioSampleFormat(String str, String str2, String str3, int i, int i2, int i3, int i4, List<byte[]> list, com.google.android.exoplayer2.drm.DrmInitData drmInitData, int i5, String str4) {
    ...
    @Deprecated
    public static Format createAudioSampleFormat(String str, String str2, String str3, int i, int i2, int i3, int i4, int i5, List<byte[]> list, com.google.android.exoplayer2.drm.DrmInitData drmInitData, int i6, String str4) {
    ...
    public Format withManifestFormatInfo(Format format) {
        String str;
        com.google.android.exoplayer2.metadata.Metadata metadataCopyWithAppendedEntriesFrom;
        if (this == format) {
            return this;
        }
        ...
        return buildUpon().setId(str2).setLabel(str3).setLanguage(str4).setSelectionFlags(i3).setRoleFlags(this.roleFlags | format.roleFlags).setAverageBitrate(i).setPeakBitrate(i2).setCodecs(str5).setMetadata(metadataCopyWithAppendedEntriesFrom).setDrmInitData(com.google.android.exoplayer2.drm.DrmInitData.createSessionCreationData(format.drmInitData, this.drmInitData)).setFrameRate(f).build();
    }
    ...
    @Deprecated
    public Format copyWithDrmInitData(com.google.android.exoplayer2.drm.DrmInitData drmInitData) {
        return buildUpon().setDrmInitData(drmInitData).build();
    }

    @Deprecated
    public Format copyWithMetadata(com.google.android.exoplayer2.metadata.Metadata metadata) {
    ...
    public static String toLogString(Format format) {
        ...
        if (format.width != -1 && format.height != -1) {
            sb.append(", res=").append(format.width).append(VastAttributes.HORIZONTAL_POSITION).append(format.height);
        }
    ...
    public Bundle toBundle(boolean z) {
        ...
        com.google.android.exoplayer2.video.ColorInfo colorInfo = this.colorInfo;
        if (colorInfo != null) {
    ...
    public static Format fromBundle(Bundle bundle) {
        ...
        builder.setId((String) defaultIfNull(string, format.id)).setLabel((String) defaultIfNull(bundle.getString(FIELD_LABEL), format.label)).setLanguage((String) defaultIfNull(bundle.getString(FIELD_LANGUAGE), format.language)).setSelectionFlags(bundle.getInt(FIELD_SELECTION_FLAGS, format.selectionFlags)).setRoleFlags(bundle.getInt(FIELD_ROLE_FLAGS, format.roleFlags)).setAverageBitrate(bundle.getInt(FIELD_AVERAGE_BITRATE, format.averageBitrate)).setPeakBitrate(bundle.getInt(FIELD_PEAK_BITRATE, format.peakBitrate)).setCodecs((String) defaultIfNull(bundle.getString(FIELD_CODECS), format.codecs)).setMetadata((com.google.android.exoplayer2.metadata.Metadata) defaultIfNull((com.google.android.exoplayer2.metadata.Metadata) bundle.getParcelable(FIELD_METADATA), format.metadata)).setContainerMimeType((String) defaultIfNull(bundle.getString(FIELD_CONTAINER_MIME_TYPE), format.containerMimeType)).setSampleMimeType((String) defaultIfNull(bundle.getString(FIELD_SAMPLE_MIME_TYPE), format.sampleMimeType)).setMaxInputSize(bundle.getInt(FIELD_MAX_INPUT_SIZE, format.maxInputSize));
        ArrayList arrayList = new ArrayList();
        int i = 0;
        while (true) {
        ...
        Builder drmInitData = builder.setInitializationData(arrayList).setDrmInitData((com.google.android.exoplayer2.drm.DrmInitData) bundle.getParcelable(FIELD_DRM_INIT_DATA));
        ...
        if (bundle2 != null) {
            builder.setColorInfo((com.google.android.exoplayer2.video.ColorInfo) com.google.android.exoplayer2.video.ColorInfo.CREATOR.fromBundle(bundle2));
        }
