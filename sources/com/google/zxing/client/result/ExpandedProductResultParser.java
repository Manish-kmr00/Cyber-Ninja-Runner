    ...
    public ExpandedProductParsedResult parse(Result result) {
        ...
        while (i < massagedText.length()) {
            ...
            switch (strFindAIvalue.hashCode()) {
                case 1536:
                    b = !strFindAIvalue.equals(PhoneMasks.EXTRA_NUMBERS) ? (byte) -1 : (byte) 0;
                    break;
                case 1537:
                ...
                case 1567:
                    ...
                    break;
                case 1568:
                    b = !strFindAIvalue.equals(Protocol.VAST_4_1) ? (byte) -1 : (byte) 3;
                    break;
                case 1570:
                    b = !strFindAIvalue.equals(Protocol.VAST_4_2) ? (byte) -1 : (byte) 4;
                    break;
                case 1572:
