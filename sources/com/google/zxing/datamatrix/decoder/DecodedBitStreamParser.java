...
final class DecodedBitStreamParser {
    ...
    static {
        char[] cArr = {'!', '\"', '#', Typography.dollar, '%', Typography.amp, '\'', '(', ')', GMTDateParser.ANY, '+', AbstractJsonLexerKt.COMMA, '-', '.', '/', AbstractJsonLexerKt.COLON, ';', Typography.less, cc.T, Typography.greater, '?', '@', AbstractJsonLexerKt.BEGIN_LIST, AbstractJsonLexerKt.STRING_ESC, AbstractJsonLexerKt.END_LIST, '^', '_'};
    ...
    private static void parseTwoBytes(int i, int i2, int[] iArr) {
        int i3 = ((i << 8) + i2) - 1;
        int i4 = i3 / IronSourceConstants.RV_OPERATIONAL_LOAD_AD;
        iArr[0] = i4;
        int i5 = i3 - (i4 * IronSourceConstants.RV_OPERATIONAL_LOAD_AD);
        int i6 = i5 / 40;
        iArr[1] = i6;
        iArr[2] = i5 - (i6 * 40);
    }
