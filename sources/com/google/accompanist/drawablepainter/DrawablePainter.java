...
public final class DrawablePainter extends Painter implements RememberObserver {
    ...
    public DrawablePainter(Drawable drawable) {
        ...
        this.drawableIntrinsicSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m1452boximpl(DrawablePainterKt.getIntrinsicSize(drawable)), null, 2, null);
            ...
            public final AnonymousClass1 invoke() {
                ...
                return new Drawable.Callback() { // from class: com.google.accompanist.drawablepainter.DrawablePainter$callback$2.1
                    ...
                    public void invalidateDrawable(Drawable d) {
                        ...
                        drawablePainter3.m4977setDrawableIntrinsicSizeuvyYCjk(DrawablePainterKt.getIntrinsicSize(drawablePainter3.getDrawable()));
                    }
    ...
    private final long m4976getDrawableIntrinsicSizeNHjbRc() {
    ...
    public final void m4977setDrawableIntrinsicSizeuvyYCjk(long j) {
        this.drawableIntrinsicSize.setValue(Size.m1452boximpl(j));
    }
    ...
    public long getIntrinsicSize() {
        return m4976getDrawableIntrinsicSizeNHjbRc();
    }
    ...
    protected void onDraw(DrawScope drawScope) {
        ...
        this.drawable.setBounds(0, 0, MathKt.roundToInt(Size.m1464getWidthimpl(drawScope.mo2125getSizeNHjbRc())), MathKt.roundToInt(Size.m1461getHeightimpl(drawScope.mo2125getSizeNHjbRc())));
        try {
            canvas.save();
