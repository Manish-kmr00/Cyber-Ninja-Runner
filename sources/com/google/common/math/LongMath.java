...
public final class LongMath {
    ...
    public static long sqrt(long j, RoundingMode roundingMode) {
        MathPreconditions.checkNonNegative(VastAttributes.HORIZONTAL_POSITION, j);
        if (fitsInInt(j)) {
    ...
    public static long gcd(long a2, long b) {
        ...
        MathPreconditions.checkNonNegative(DownloadCommon.DOWNLOAD_REPORT_FIND_FILE_RESULT_VALUE_B, b);
        if (a2 == 0) {
            return b;
        }
        if (b == 0) {
