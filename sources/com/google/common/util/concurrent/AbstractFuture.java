...
public abstract class AbstractFuture<V> extends InternalFutureFailureAccess implements ListenableFuture<V> {
    ...
    public String toString() {
        ...
        return sb.append(b9.i.e).toString();
    }
    ...
    private void addPendingString(StringBuilder builder) {
        ...
        if (obj instanceof SetFuture) {
            ...
            if (strEmptyToNull != null) {
                builder.append(", info=[").append(strEmptyToNull).append(b9.i.e);
            }
        }
        if (isDone()) {
    ...
    private void addDoneString(StringBuilder builder) {
        try {
            ...
            builder.append("FAILURE, cause=[").append(e.getCause()).append(b9.i.e);
        } catch (Exception e2) {
    ...
    private static final class UnsafeAtomicHelper extends AtomicHelper {
        ...
        boolean casWaiters(AbstractFuture<?> future, @CheckForNull Waiter expect, @CheckForNull Waiter update) {
            return zzgaj$$ExternalSyntheticBackportWithForwarding0.m(UNSAFE, future, WAITERS_OFFSET, expect, update);
        }

        @Override // com.google.common.util.concurrent.AbstractFuture.AtomicHelper
        boolean casListeners(AbstractFuture<?> future, @CheckForNull Listener expect, Listener update) {
            return zzgaj$$ExternalSyntheticBackportWithForwarding0.m(UNSAFE, future, LISTENERS_OFFSET, expect, update);
        }
        ...
        boolean casValue(AbstractFuture<?> future, @CheckForNull Object expect, Object update) {
            return zzgaj$$ExternalSyntheticBackportWithForwarding0.m(UNSAFE, future, VALUE_OFFSET, expect, update);
        }
    }
