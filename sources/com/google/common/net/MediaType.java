...
public final class MediaType {
    ...
    public static final MediaType MP4_AUDIO = createConstant("audio", n.d);
    ...
    public static final MediaType MP4_VIDEO = createConstant("video", n.d);
    ...
    public static final MediaType APPLICATION_BINARY = createConstant("application", BuildConfig.SDK_DEPENDENCY);
    ...
    public static final MediaType ZIP = createConstant("application", POBCommonConstants.ZIP_PARAM);
    ...
    public static MediaType parse(String input) {
        ...
        try {
            ...
            while (tokenizer.hasMore()) {
                ...
                consumeSeparator(tokenizer, cc.T);
