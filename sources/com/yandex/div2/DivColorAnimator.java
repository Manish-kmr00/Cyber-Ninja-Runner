...
public final class DivColorAnimator implements JSONSerializable, Hashable, DivAnimatorBase {
    ...
    public final Expression<Integer> endValue;
    ...
    public final Expression<Integer> startValue;
    ...
    private static final Function2<ParsingEnvironment, JSONObject, DivColorAnimator> CREATOR = new Function2<ParsingEnvironment, JSONObject, DivColorAnimator>() { // from class: com.yandex.div2.DivColorAnimator$Companion$CREATOR$1
        @Override // kotlin.jvm.functions.Function2
        public final DivColorAnimator invoke(ParsingEnvironment env, JSONObject it) {
            Intrinsics.checkNotNullParameter(env, "env");
            Intrinsics.checkNotNullParameter(it, "it");
            return DivColorAnimator.INSTANCE.fromJson(env, it);
        }
    };

    @JvmStatic
    public static final DivColorAnimator fromJson(ParsingEnvironment parsingEnvironment, JSONObject jSONObject) {
    ...
    public int hash() {
        ...
        Expression<Integer> expression = this.startValue;
    ...
    public final boolean equals(DivColorAnimator other, ExpressionResolver resolver, ExpressionResolver otherResolver) {
        ...
        if (this.endValue.evaluate(resolver).intValue() != other.endValue.evaluate(otherResolver).intValue() || !Intrinsics.areEqual(getId(), other.getId()) || getInterpolator().evaluate(resolver) != other.getInterpolator().evaluate(otherResolver) || !getRepeatCount().equals(other.getRepeatCount(), resolver, otherResolver) || getStartDelay().evaluate(resolver).longValue() != other.getStartDelay().evaluate(otherResolver).longValue()) {
            return false;
        }
        Expression<Integer> expression = this.startValue;
        Integer numEvaluate = expression != null ? expression.evaluate(resolver) : null;
        Expression<Integer> expression2 = other.startValue;
        return Intrinsics.areEqual(numEvaluate, expression2 != null ? expression2.evaluate(otherResolver) : null) && Intrinsics.areEqual(getVariableName(), other.getVariableName());
    }

    public final DivColorAnimator copy(List<DivAction> cancelActions, Expression<DivAnimationDirection> direction, Expression<Long> duration, List<DivAction> endActions, Expression<Integer> endValue, String id, Expression<DivAnimationInterpolator> interpolator, DivCount repeatCount, Expression<Long> startDelay, Expression<Integer> startValue, String variableName) {
        Intrinsics.checkNotNullParameter(direction, "direction");
        Intrinsics.checkNotNullParameter(duration, "duration");
        Intrinsics.checkNotNullParameter(endValue, "endValue");
        Intrinsics.checkNotNullParameter(id, "id");
        ...
        Intrinsics.checkNotNullParameter(startDelay, "startDelay");
        Intrinsics.checkNotNullParameter(variableName, "variableName");
        return new DivColorAnimator(cancelActions, direction, duration, endActions, endValue, id, interpolator, repeatCount, startDelay, startValue, variableName);
    }

    @Override // com.yandex.div.json.JSONSerializable
    public JSONObject writeToJSON() {
        return BuiltInParserKt.getBuiltInParserComponent().getDivColorAnimatorJsonEntityParser().getValue().serialize(BuiltInParserKt.getBuiltInParsingContext(), this);
    }

    /* JADX INFO: compiled from: DivColorAnimator.kt */
    @Metadata(d1 = {"\u0000D\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0005\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u001e\u0010\u0015\u001a\u00020\u00072\u0006\u0010\u0016\u001a\u00020\u00052\u0006\u0010\u0017\u001a\u00020\u0006H\u0087\u0002¢\u0006\u0002\b\u0018R#\u0010\u0003\u001a\u0014\u0012\u0004\u0012\u00020\u0005\u0012\u0004\u0012\u00020\u0006\u0012\u0004\u0012\u00020\u00070\u0004¢\u0006\b\n\u0000\u001a\u0004\b\b\u0010\tR\u0014\u0010\n\u001a\b\u0012\u0004\u0012\u00020\f0\u000bX\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\r\u001a\b\u0012\u0004\u0012\u00020\u000e0\u000bX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u000f\u001a\u00020\u0010X\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u0011\u001a\b\u0012\u0004\u0012\u00020\u00120\u000bX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0013\u001a\u00020\u0014X\u0086T¢\u0006\u0002\n\u0000¨\u0006\u0019"}, d2 = {"Lcom/yandex/div2/DivColorAnimator$Companion;", "", "()V", "CREATOR", "Lkotlin/Function2;", "Lcom/yandex/div/json/ParsingEnvironment;", "Lorg/json/JSONObject;", "Lcom/yandex/div2/DivColorAnimator;", "getCREATOR", "()Lkotlin/jvm/functions/Function2;", "DIRECTION_DEFAULT_VALUE", "Lcom/yandex/div/json/expressions/Expression;", "Lcom/yandex/div2/DivAnimationDirection;", "INTERPOLATOR_DEFAULT_VALUE", "Lcom/yandex/div2/DivAnimationInterpolator;", "REPEAT_COUNT_DEFAULT_VALUE", "Lcom/yandex/div2/DivCount$Fixed;", "START_DELAY_DEFAULT_VALUE", "", "TYPE", "", "invoke", cc.o, "json", "fromJson", "div-data_release"}, k = 1, mv = {1, 5, 1}, xi = 48)
    public static final class Companion {
        ...
        @JvmStatic
        public final DivColorAnimator fromJson(ParsingEnvironment env, JSONObject json) {
            Intrinsics.checkNotNullParameter(env, "env");
            Intrinsics.checkNotNullParameter(json, "json");
            return BuiltInParserKt.getBuiltInParserComponent().getDivColorAnimatorJsonEntityParser().getValue().deserialize((ParsingContext) env, json);
        }

        public final Function2<ParsingEnvironment, JSONObject, DivColorAnimator> getCREATOR() {
            return DivColorAnimator.CREATOR;
        }
    }
}
