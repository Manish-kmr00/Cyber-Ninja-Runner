...
public final class DivSeparator implements JSONSerializable, Hashable, DivBase {
    ...
    @JvmStatic
    public static final DivSeparator fromJson(ParsingEnvironment parsingEnvironment, JSONObject jSONObject) {
    ...
    public /* synthetic */ DivSeparator(DivAccessibility divAccessibility, DivAction divAction, DivAnimation divAnimation, List list, Expression expression, Expression expression2, Expression expression3, List list2, List list3, DivBorder divBorder, Expression expression4, DelimiterStyle delimiterStyle, List list4, List list5, List list6, DivFocus divFocus, List list7, DivSize divSize, List list8, List list9, String str, DivLayoutProvider divLayoutProvider, List list10, DivEdgeInsets divEdgeInsets, DivEdgeInsets divEdgeInsets2, List list11, List list12, Expression expression5, Expression expression6, List list13, List list14, DivTransform divTransform, DivChangeTransition divChangeTransition, DivAppearanceTransition divAppearanceTransition, DivAppearanceTransition divAppearanceTransition2, List list15, List list16, List list17, Expression expression7, DivVisibilityAction divVisibilityAction, List list18, DivSize divSize2, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? null : divAccessibility, (i & 2) != 0 ? null : divAction, (i & 4) != 0 ? ACTION_ANIMATION_DEFAULT_VALUE : divAnimation, (i & 8) != 0 ? null : list, (i & 16) != 0 ? null : expression, (i & 32) != 0 ? null : expression2, (i & 64) != 0 ? ALPHA_DEFAULT_VALUE : expression3, (i & 128) != 0 ? null : list2, (i & 256) != 0 ? null : list3, (i & 512) != 0 ? null : divBorder, (i & 1024) != 0 ? null : expression4, (i & 2048) != 0 ? null : delimiterStyle, (i & 4096) != 0 ? null : list4, (i & 8192) != 0 ? null : list5, (i & 16384) != 0 ? null : list6, (i & 32768) != 0 ? null : divFocus, (i & 65536) != 0 ? null : list7, (i & 131072) != 0 ? HEIGHT_DEFAULT_VALUE : divSize, (i & 262144) != 0 ? null : list8, (i & 524288) != 0 ? null : list9, (i & 1048576) != 0 ? null : str, (i & 2097152) != 0 ? null : divLayoutProvider, (i & 4194304) != 0 ? null : list10, (i & 8388608) != 0 ? null : divEdgeInsets, (i & 16777216) != 0 ? null : divEdgeInsets2, (i & 33554432) != 0 ? null : list11, (i & 67108864) != 0 ? null : list12, (i & 134217728) != 0 ? null : expression5, (i & 268435456) != 0 ? null : expression6, (i & 536870912) != 0 ? null : list13, (i & 1073741824) != 0 ? null : list14, (i & Integer.MIN_VALUE) != 0 ? null : divTransform, (i2 & 1) != 0 ? null : divChangeTransition, (i2 & 2) != 0 ? null : divAppearanceTransition, (i2 & 4) != 0 ? null : divAppearanceTransition2, (i2 & 8) != 0 ? null : list15, (i2 & 16) != 0 ? null : list16, (i2 & 32) != 0 ? null : list17, (i2 & 64) != 0 ? VISIBILITY_DEFAULT_VALUE : expression7, (i2 & 128) != 0 ? null : divVisibilityAction, (i2 & 256) != 0 ? null : list18, (i2 & 512) != 0 ? WIDTH_DEFAULT_VALUE : divSize2);
    }
    ...
    public int hash() {
        ...
        int iHash20 = i3 + (border != null ? border.hash() : 0);
        Expression<Long> columnSpan = getColumnSpan();
        int iHashCode4 = iHash20 + (columnSpan != null ? columnSpan.hashCode() : 0);
        ...
        int iHash24 = iHashCode5 + (layoutProvider != null ? layoutProvider.hash() : 0);
        ...
        int i9 = iHash24 + iHash10;
        DivEdgeInsets margins = getMargins();
        int iHash25 = i9 + (margins != null ? margins.hash() : 0);
        DivEdgeInsets paddings = getPaddings();
        int iHash26 = iHash25 + (paddings != null ? paddings.hash() : 0);
        ...
        int iHash27 = i13 + (transform != null ? transform.hash() : 0);
        DivChangeTransition transitionChange = getTransitionChange();
        int iHash28 = iHash27 + (transitionChange != null ? transitionChange.hash() : 0);
        DivAppearanceTransition transitionIn = getTransitionIn();
        int iHash29 = iHash28 + (transitionIn != null ? transitionIn.hash() : 0);
        DivAppearanceTransition transitionOut = getTransitionOut();
        int iHash30 = iHash29 + (transitionOut != null ? transitionOut.hash() : 0);
        List<DivTransitionTrigger> transitionTriggers = getTransitionTriggers();
        int iHashCode8 = iHash30 + (transitionTriggers != null ? transitionTriggers.hashCode() : 0);
        ...
        int iHash31 = iHashCode9 + (visibilityAction != null ? visibilityAction.hash() : 0);
        ...
        this._hash = Integer.valueOf(iHash32);
        return iHash32;
    }

    public final boolean equals(DivSeparator other, ExpressionResolver resolver, ExpressionResolver otherResolver) {
        boolean zEquals;
        boolean zEquals2;
        boolean z;
        boolean z2;
        ...
        if (delimiterStyle != null) {
            zEquals4 = delimiterStyle.equals(other.delimiterStyle, resolver, otherResolver);
        } else {
            zEquals4 = other.delimiterStyle == null;
        }
        if (!zEquals4) {
            return false;
        }
    ...
    public static /* synthetic */ DivSeparator copy$default(DivSeparator divSeparator, DivAccessibility divAccessibility, DivAction divAction, DivAnimation divAnimation, List list, Expression expression, Expression expression2, Expression expression3, List list2, List list3, DivBorder divBorder, Expression expression4, DelimiterStyle delimiterStyle, List list4, List list5, List list6, DivFocus divFocus, List list7, DivSize divSize, List list8, List list9, String str, DivLayoutProvider divLayoutProvider, List list10, DivEdgeInsets divEdgeInsets, DivEdgeInsets divEdgeInsets2, List list11, List list12, Expression expression5, Expression expression6, List list13, List list14, DivTransform divTransform, DivChangeTransition divChangeTransition, DivAppearanceTransition divAppearanceTransition, DivAppearanceTransition divAppearanceTransition2, List list15, List list16, List list17, Expression expression7, DivVisibilityAction divVisibilityAction, List list18, DivSize divSize2, int i, int i2, Object obj) {
        ...
        Expression columnSpan = (i & 1024) != 0 ? divSeparator.getColumnSpan() : expression4;
        DelimiterStyle delimiterStyle2 = (i & 2048) != 0 ? divSeparator.delimiterStyle : delimiterStyle;
        List disappearActions = (i & 4096) != 0 ? divSeparator.getDisappearActions() : list4;
        List list20 = (i & 8192) != 0 ? divSeparator.doubletapActions : list5;
        List extensions = (i & 16384) != 0 ? divSeparator.getExtensions() : list6;
        DivFocus focus = (i & 32768) != 0 ? divSeparator.getFocus() : divFocus;
        List functions = (i & 65536) != 0 ? divSeparator.getFunctions() : list7;
        DivSize height = (i & 131072) != 0 ? divSeparator.getHeight() : divSize;
        List list21 = extensions;
        List list22 = (i & 262144) != 0 ? divSeparator.hoverEndActions : list8;
        List list23 = (i & 524288) != 0 ? divSeparator.hoverStartActions : list9;
        return divSeparator.copy(accessibility, divAction2, divAnimation2, list19, alignmentHorizontal, alignmentVertical, alpha, animators, background, border, columnSpan, delimiterStyle2, disappearActions, list20, list21, focus, functions, height, list22, list23, (i & 1048576) != 0 ? divSeparator.getId() : str, (i & 2097152) != 0 ? divSeparator.getLayoutProvider() : divLayoutProvider, (i & 4194304) != 0 ? divSeparator.longtapActions : list10, (i & 8388608) != 0 ? divSeparator.getMargins() : divEdgeInsets, (i & 16777216) != 0 ? divSeparator.getPaddings() : divEdgeInsets2, (i & 33554432) != 0 ? divSeparator.pressEndActions : list11, (i & 67108864) != 0 ? divSeparator.pressStartActions : list12, (i & 134217728) != 0 ? divSeparator.getReuseId() : expression5, (i & 268435456) != 0 ? divSeparator.getRowSpan() : expression6, (i & 536870912) != 0 ? divSeparator.getSelectedActions() : list13, (i & 1073741824) != 0 ? divSeparator.getTooltips() : list14, (i & Integer.MIN_VALUE) != 0 ? divSeparator.getTransform() : divTransform, (i2 & 1) != 0 ? divSeparator.getTransitionChange() : divChangeTransition, (i2 & 2) != 0 ? divSeparator.getTransitionIn() : divAppearanceTransition, (i2 & 4) != 0 ? divSeparator.getTransitionOut() : divAppearanceTransition2, (i2 & 8) != 0 ? divSeparator.getTransitionTriggers() : list15, (i2 & 16) != 0 ? divSeparator.getVariableTriggers() : list16, (i2 & 32) != 0 ? divSeparator.getVariables() : list17, (i2 & 64) != 0 ? divSeparator.getVisibility() : expression7, (i2 & 128) != 0 ? divSeparator.getVisibilityAction() : divVisibilityAction, (i2 & 256) != 0 ? divSeparator.getVisibilityActions() : list18, (i2 & 512) != 0 ? divSeparator.getWidth() : divSize2);
    }

    public final DivSeparator copy(DivAccessibility accessibility, DivAction action, DivAnimation actionAnimation, List<DivAction> actions, Expression<DivAlignmentHorizontal> alignmentHorizontal, Expression<DivAlignmentVertical> alignmentVertical, Expression<Double> alpha, List<? extends DivAnimator> animators, List<? extends DivBackground> background, DivBorder border, Expression<Long> columnSpan, DelimiterStyle delimiterStyle, List<DivDisappearAction> disappearActions, List<DivAction> doubletapActions, List<DivExtension> extensions, DivFocus focus, List<DivFunction> functions, DivSize height, List<DivAction> hoverEndActions, List<DivAction> hoverStartActions, String id, DivLayoutProvider layoutProvider, List<DivAction> longtapActions, DivEdgeInsets margins, DivEdgeInsets paddings, List<DivAction> pressEndActions, List<DivAction> pressStartActions, Expression<String> reuseId, Expression<Long> rowSpan, List<DivAction> selectedActions, List<DivTooltip> tooltips, DivTransform transform, DivChangeTransition transitionChange, DivAppearanceTransition transitionIn, DivAppearanceTransition transitionOut, List<? extends DivTransitionTrigger> transitionTriggers, List<DivTrigger> variableTriggers, List<? extends DivVariable> variables, Expression<DivVisibility> visibility, DivVisibilityAction visibilityAction, List<DivVisibilityAction> visibilityActions, DivSize width) {
        Intrinsics.checkNotNullParameter(actionAnimation, "actionAnimation");
        Intrinsics.checkNotNullParameter(alpha, "alpha");
        Intrinsics.checkNotNullParameter(height, "height");
        Intrinsics.checkNotNullParameter(visibility, "visibility");
        Intrinsics.checkNotNullParameter(width, "width");
        return new DivSeparator(accessibility, action, actionAnimation, actions, alignmentHorizontal, alignmentVertical, alpha, animators, background, border, columnSpan, delimiterStyle, disappearActions, doubletapActions, extensions, focus, functions, height, hoverEndActions, hoverStartActions, id, layoutProvider, longtapActions, margins, paddings, pressEndActions, pressStartActions, reuseId, rowSpan, selectedActions, tooltips, transform, transitionChange, transitionIn, transitionOut, transitionTriggers, variableTriggers, variables, visibility, visibilityAction, visibilityActions, width);
    }
    ...
    /* JADX INFO: compiled from: DivSeparator.kt */
    @Metadata(d1 = {"\u0000J\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0006\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u001e\u0010\u0017\u001a\u00020\f2\u0006\u0010\u0018\u001a\u00020\n2\u0006\u0010\u0019\u001a\u00020\u000bH\u0087\u0002¢\u0006\u0002\b\u001aR\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00070\u0006X\u0082\u0004¢\u0006\u0002\n\u0000R#\u0010\b\u001a\u0014\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\u000b\u0012\u0004\u0012\u00020\f0\t¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\u000eR\u000e\u0010\u000f\u001a\u00020\u0010X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0011\u001a\u00020\u0012X\u0086T¢\u0006\u0002\n\u0000R\u0014\u0010\u0013\u001a\b\u0012\u0004\u0012\u00020\u00140\u0006X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0015\u001a\u00020\u0016X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u001b"}, d2 = {"Lcom/yandex/div2/DivSeparator$Companion;", "", "()V", "ACTION_ANIMATION_DEFAULT_VALUE", "Lcom/yandex/div2/DivAnimation;", "ALPHA_DEFAULT_VALUE", "Lcom/yandex/div/json/expressions/Expression;", "", "CREATOR", "Lkotlin/Function2;", "Lcom/yandex/div/json/ParsingEnvironment;", "Lorg/json/JSONObject;", "Lcom/yandex/div2/DivSeparator;", "getCREATOR", "()Lkotlin/jvm/functions/Function2;", "HEIGHT_DEFAULT_VALUE", "Lcom/yandex/div2/DivSize$WrapContent;", "TYPE", "", "VISIBILITY_DEFAULT_VALUE", "Lcom/yandex/div2/DivVisibility;", "WIDTH_DEFAULT_VALUE", "Lcom/yandex/div2/DivSize$MatchParent;", "invoke", cc.o, "json", "fromJson", "div-data_release"}, k = 1, mv = {1, 5, 1}, xi = 48)
    public static final class Companion {
        ...
        @JvmStatic
        public final DivSeparator fromJson(ParsingEnvironment env, JSONObject json) {
            Intrinsics.checkNotNullParameter(env, "env");
            Intrinsics.checkNotNullParameter(json, "json");
            return BuiltInParserKt.getBuiltInParserComponent().getDivSeparatorJsonEntityParser().getValue().deserialize((ParsingContext) env, json);
        }
    ...
    public static final class DelimiterStyle implements JSONSerializable, Hashable {
        ...
        /* JADX INFO: renamed from: Companion, reason: from kotlin metadata */
        public static final Companion INSTANCE = new Companion(null);
        private static final Expression<Integer> COLOR_DEFAULT_VALUE = Expression.INSTANCE.constant(Integer.valueOf(DivSeparatorView.DEFAULT_DIVIDER_COLOR));
        ...
        private static final Function2<ParsingEnvironment, JSONObject, DelimiterStyle> CREATOR = new Function2<ParsingEnvironment, JSONObject, DelimiterStyle>() { // from class: com.yandex.div2.DivSeparator$DelimiterStyle$Companion$CREATOR$1
            @Override // kotlin.jvm.functions.Function2
        ...
        @JvmStatic
        public static final DelimiterStyle fromJson(ParsingEnvironment parsingEnvironment, JSONObject jSONObject) {
            return INSTANCE.fromJson(parsingEnvironment, jSONObject);
        }
        ...
        public int hash() {
            ...
            int iHashCode = Reflection.getOrCreateKotlinClass(getClass()).hashCode() + this.color.hashCode() + this.orientation.hashCode();
            this._hash = Integer.valueOf(iHashCode);
            return iHashCode;
        }

        public final boolean equals(DelimiterStyle other, ExpressionResolver resolver, ExpressionResolver otherResolver) {
            Intrinsics.checkNotNullParameter(resolver, "resolver");
            Intrinsics.checkNotNullParameter(otherResolver, "otherResolver");
        ...
        /* JADX WARN: Multi-variable type inference failed */
        public static /* synthetic */ DelimiterStyle copy$default(DelimiterStyle delimiterStyle, Expression expression, Expression expression2, int i, Object obj) {
            if ((i & 1) != 0) {
        ...
        public final DelimiterStyle copy(Expression<Integer> color, Expression<Orientation> orientation) {
            Intrinsics.checkNotNullParameter(color, "color");
            Intrinsics.checkNotNullParameter(orientation, "orientation");
        ...
        /* JADX INFO: compiled from: DivSeparator.kt */
        @Metadata(d1 = {"\u00002\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u001e\u0010\u000f\u001a\u00020\n2\u0006\u0010\u0010\u001a\u00020\b2\u0006\u0010\u0011\u001a\u00020\tH\u0087\u0002¢\u0006\u0002\b\u0012R\u0014\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R#\u0010\u0006\u001a\u0014\u0012\u0004\u0012\u00020\b\u0012\u0004\u0012\u00020\t\u0012\u0004\u0012\u00020\n0\u0007¢\u0006\b\n\u0000\u001a\u0004\b\u000b\u0010\fR\u0014\u0010\r\u001a\b\u0012\u0004\u0012\u00020\u000e0\u0004X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0013"}, d2 = {"Lcom/yandex/div2/DivSeparator$DelimiterStyle$Companion;", "", "()V", "COLOR_DEFAULT_VALUE", "Lcom/yandex/div/json/expressions/Expression;", "", "CREATOR", "Lkotlin/Function2;", "Lcom/yandex/div/json/ParsingEnvironment;", "Lorg/json/JSONObject;", "Lcom/yandex/div2/DivSeparator$DelimiterStyle;", "getCREATOR", "()Lkotlin/jvm/functions/Function2;", "ORIENTATION_DEFAULT_VALUE", "Lcom/yandex/div2/DivSeparator$DelimiterStyle$Orientation;", "invoke", cc.o, "json", "fromJson", "div-data_release"}, k = 1, mv = {1, 5, 1}, xi = 48)
        public static final class Companion {
            public /* synthetic */ Companion(DefaultConstructorMarker defaultConstructorMarker) {
                this();
            }
            ...
            @JvmStatic
            public final DelimiterStyle fromJson(ParsingEnvironment env, JSONObject json) {
                Intrinsics.checkNotNullParameter(env, "env");
                Intrinsics.checkNotNullParameter(json, "json");
                return BuiltInParserKt.getBuiltInParserComponent().getDivSeparatorDelimiterStyleJsonEntityParser().getValue().deserialize((ParsingContext) env, json);
            }
        ...
        public enum Orientation {
            ...
            /* JADX INFO: renamed from: com.yandex.div2.DivSeparator$DelimiterStyle$Orientation$Converter, reason: from kotlin metadata */
            /* JADX INFO: compiled from: DivSeparator.kt */
            @Metadata(d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\b\u001a\u0004\u0018\u00010\u00062\u0006\u0010\t\u001a\u00020\u0005J\u000e\u0010\n\u001a\u00020\u00052\u0006\u0010\u000b\u001a\u00020\u0006R\u001e\u0010\u0003\u001a\u0010\u0012\u0004\u0012\u00020\u0005\u0012\u0006\u0012\u0004\u0018\u00010\u00060\u00048\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u001c\u0010\u0007\u001a\u000e\u0012\u0004\u0012\u00020\u0006\u0012\u0004\u0012\u00020\u00050\u00048\u0006X\u0087\u0004¢\u0006\u0002\n\u0000¨\u0006\f"}, d2 = {"Lcom/yandex/div2/DivSeparator$DelimiterStyle$Orientation$Converter;", "", "()V", "FROM_STRING", "Lkotlin/Function1;", "", "Lcom/yandex/div2/DivSeparator$DelimiterStyle$Orientation;", "TO_STRING", "fromString", "value", "toString", "obj", "div-data_release"}, k = 1, mv = {1, 5, 1}, xi = 48)
            public static final class Companion {
                public /* synthetic */ Companion(DefaultConstructorMarker defaultConstructorMarker) {
                    this();
                }
