...
public final class PadStartInteger extends Function {
    ...
    private static final List<FunctionArgument> declaredArgs = CollectionsKt.listOf((Object[]) new FunctionArgument[]{new FunctionArgument(EvaluableType.INTEGER, false, 2, null), new FunctionArgument(EvaluableType.INTEGER, false, 2, null), new FunctionArgument(EvaluableType.STRING, false, 2, null)});
    ...
    protected Object mo6115evaluateex6DHhM(EvaluationContext evaluationContext, Evaluable expressionContext, List<? extends Object> args) {
        ...
        return StringFunctionsKt.m6183buildRepeatableStringzbMA7A(evaluationContext, expressionContext, (int) (jLongValue - ((long) strValueOf.length())), (String) obj3) + strValueOf;
    }
}
