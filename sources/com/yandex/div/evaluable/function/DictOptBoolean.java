...
public abstract class DictOptBoolean extends Function {
    ...
    public DictOptBoolean() {
        ...
        this.declaredArgs = CollectionsKt.listOf((Object[]) new FunctionArgument[]{new FunctionArgument(EvaluableType.BOOLEAN, z, i, defaultConstructorMarker), new FunctionArgument(EvaluableType.DICT, z, i, defaultConstructorMarker), new FunctionArgument(EvaluableType.STRING, true)});
    }
    ...
    protected Object mo6115evaluateex6DHhM(EvaluationContext evaluationContext, Evaluable expressionContext, List<? extends Object> args) {
        ...
        Object objEvaluateSafe$default = DictFunctionsKt.evaluateSafe$default(args, Boolean.valueOf(zBooleanValue), false, 4, null);
