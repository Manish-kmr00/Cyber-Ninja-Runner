...
public final class SetHours extends Function {
    ...
    protected Object mo6115evaluateex6DHhM(EvaluationContext evaluationContext, Evaluable expressionContext, List<? extends Object> args) throws EvaluableException {
        ...
        if (jLongValue > 23 || jLongValue < 0) {
            EvaluableExceptionKt.throwExceptionOnFunctionEvaluationFailed$default(getName(), args, "Expecting hours in [0..23], instead got " + jLongValue + '.', null, 8, null);
            throw new KotlinNothingValueException();
        }
        Calendar calendar = DateTimeFunctionsKt.toCalendar(dateTime);
        calendar.setTimeInMillis(dateTime.getTimestampMillis());
        calendar.set(11, (int) jLongValue);
