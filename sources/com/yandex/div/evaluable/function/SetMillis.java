...
public final class SetMillis extends Function {
    ...
    protected Object mo6115evaluateex6DHhM(EvaluationContext evaluationContext, Evaluable expressionContext, List<? extends Object> args) throws EvaluableException {
        ...
        if (jLongValue > 999 || jLongValue < 0) {
            EvaluableExceptionKt.throwExceptionOnFunctionEvaluationFailed$default(getName(), args, "Expecting millis in [0..999], instead got " + jLongValue + '.', null, 8, null);
