...
public final class ColorRgb extends Function {
    ...
    private static final List<FunctionArgument> declaredArgs = CollectionsKt.listOf((Object[]) new FunctionArgument[]{new FunctionArgument(EvaluableType.NUMBER, false, 2, null), new FunctionArgument(EvaluableType.NUMBER, false, 2, null), new FunctionArgument(EvaluableType.NUMBER, false, 2, null)});
    ...
    protected Object mo6115evaluateex6DHhM(EvaluationContext evaluationContext, Evaluable expressionContext, List<? extends Object> args) {
        ...
        try {
            ...
            return Color.m6217boximpl(Color.INSTANCE.m6226argbH0kstlE(255, colorIntComponentValue, colorIntComponentValue2, ColorFunctionsKt.toColorIntComponentValue(((Double) obj3).doubleValue())));
