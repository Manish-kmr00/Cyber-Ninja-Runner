...
public abstract class DictOptColorWithColorFallback extends Function {
    ...
    private final List<FunctionArgument> declaredArgs = CollectionsKt.listOf((Object[]) new FunctionArgument[]{new FunctionArgument(EvaluableType.COLOR, false, 2, null), new FunctionArgument(EvaluableType.DICT, false, 2, null), new FunctionArgument(EvaluableType.STRING, true)});
    ...
    protected Object mo6115evaluateex6DHhM(EvaluationContext evaluationContext, Evaluable expressionContext, List<? extends Object> args) {
        ...
        Object objEvaluateSafe$default = DictFunctionsKt.evaluateSafe$default(args, Color.m6217boximpl(iM6225unboximpl), false, 4, null);
        ...
        return colorSafeConvertToColor == null ? Color.m6217boximpl(iM6225unboximpl) : colorSafeConvertToColor;
    }
}
