...
public abstract class ColorStringComponentGetter extends Function {
    ...
    protected Object mo6115evaluateex6DHhM(EvaluationContext evaluationContext, Evaluable expressionContext, List<? extends Object> args) {
        ...
        try {
            return this.componentGetter.m6174invokeex6DHhM(evaluationContext, expressionContext, CollectionsKt.listOf(Color.m6217boximpl(Color.INSTANCE.m6227parseC4zCDoM((String) objFirst))));
