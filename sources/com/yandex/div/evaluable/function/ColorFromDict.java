...
public abstract class ColorFromDict extends Function {
    ...
    protected Object mo6115evaluateex6DHhM(EvaluationContext evaluationContext, Evaluable expressionContext, List<? extends Object> args) {
        ...
        try {
            ...
            ColorFromDict colorFromDict = this;
            objM7904constructorimpl = Result.m7904constructorimpl(Color.m6217boximpl(Color.INSTANCE.m6227parseC4zCDoM((String) objEvaluate)));
        } catch (Throwable th) {
