...
public final class SetMinutes extends Function {
    ...
    protected Object mo6115evaluateex6DHhM(EvaluationContext evaluationContext, Evaluable expressionContext, List<? extends Object> args) throws EvaluableException {
        ...
        if (jLongValue > 59 || jLongValue < 0) {
            EvaluableExceptionKt.throwExceptionOnFunctionEvaluationFailed$default(getName(), args, "Expecting minutes in [0..59], instead got " + jLongValue + '.', null, 8, null);
            throw new KotlinNothingValueException();
        }
        Calendar calendar = DateTimeFunctionsKt.toCalendar(dateTime);
        calendar.set(12, (int) jLongValue);
