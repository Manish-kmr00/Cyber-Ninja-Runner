...
public final class DoubleMul extends Function {
    ...
    protected Object mo6115evaluateex6DHhM(EvaluationContext evaluationContext, Evaluable expressionContext, List<? extends Object> args) {
        ...
        int i = 0;
        for (Object objEvalFactor$div_evaluable : args) {
            int i2 = i + 1;
            if (i < 0) {
            ...
            if (i != 0) {
                objEvalFactor$div_evaluable = Evaluator.INSTANCE.evalFactor$div_evaluable(Token.Operator.Binary.Factor.Multiplication.INSTANCE, Double.valueOf(dDoubleValue), objEvalFactor$div_evaluable);
            }
            Intrinsics.checkNotNull(objEvalFactor$div_evaluable, "null cannot be cast to non-null type kotlin.Double");
