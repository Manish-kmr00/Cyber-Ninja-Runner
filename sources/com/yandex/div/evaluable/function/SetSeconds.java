...
public final class SetSeconds extends Function {
    ...
    private static final List<FunctionArgument> declaredArgs = CollectionsKt.listOf((Object[]) new FunctionArgument[]{new FunctionArgument(EvaluableType.DATETIME, false, 2, null), new FunctionArgument(EvaluableType.INTEGER, false, 2, null)});
    ...
    protected Object mo6115evaluateex6DHhM(EvaluationContext evaluationContext, Evaluable expressionContext, List<? extends Object> args) throws EvaluableException {
        ...
        if (jLongValue > 59 || jLongValue < 0) {
            EvaluableExceptionKt.throwExceptionOnFunctionEvaluationFailed$default(getName(), args, "Expecting seconds in [0..59], instead got " + jLongValue + '.', null, 8, null);
