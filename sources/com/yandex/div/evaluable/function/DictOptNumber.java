...
public abstract class DictOptNumber extends Function {
    ...
    public DictOptNumber() {
        ...
        this.declaredArgs = CollectionsKt.listOf((Object[]) new FunctionArgument[]{new FunctionArgument(EvaluableType.NUMBER, z, i, defaultConstructorMarker), new FunctionArgument(EvaluableType.DICT, z, i, defaultConstructorMarker), new FunctionArgument(EvaluableType.STRING, true)});
    }
    ...
    protected Object mo6115evaluateex6DHhM(EvaluationContext evaluationContext, Evaluable expressionContext, List<? extends Object> args) {
        ...
        Object objEvaluateSafe$default = DictFunctionsKt.evaluateSafe$default(args, Double.valueOf(dDoubleValue), false, 4, null);
