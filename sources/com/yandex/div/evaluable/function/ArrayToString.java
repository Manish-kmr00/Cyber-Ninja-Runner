...
public final class ArrayToString extends Function {
    ...
    protected Object mo6115evaluateex6DHhM(EvaluationContext evaluationContext, Evaluable expressionContext, List<? extends Object> args) {
        ...
        Intrinsics.checkNotNull(objFirst, "null cannot be cast to non-null type org.json.JSONArray");
        String string = ((JSONArray) objFirst).toString();
        Intrinsics.checkNotNullExpressionValue(string, "args.first() as JSONArray).toString()");
        return string;
    }
}
