...
public final class DoubleRound extends Function {
    ...
    protected Object mo6115evaluateex6DHhM(EvaluationContext evaluationContext, Evaluable expressionContext, List<? extends Object> args) {
        ...
        return Double.valueOf(Math.signum(dDoubleValue) * Math.floor(Math.abs(dDoubleValue) + 0.5d));
    }
}
