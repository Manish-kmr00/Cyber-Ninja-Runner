...
public final class IntegerMax extends Function {
    ...
    protected Object mo6115evaluateex6DHhM(EvaluationContext evaluationContext, Evaluable expressionContext, List<? extends Object> args) {
        ...
        long jValueOf = Long.MIN_VALUE;
        for (Object obj : args) {
            long jLongValue = jValueOf.longValue();
            Intrinsics.checkNotNull(obj, "null cannot be cast to non-null type kotlin.Long");
            jValueOf = Long.valueOf(Math.max(jLongValue, ((Long) obj).longValue()));
        }
        return jValueOf;
    }
}
