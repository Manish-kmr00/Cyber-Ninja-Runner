...
public abstract class ColorComponentGetter extends Function {
    ...
    protected Object mo6115evaluateex6DHhM(EvaluationContext evaluationContext, Evaluable expressionContext, List<? extends Object> args) {
        ...
        Intrinsics.checkNotNull(objFirst, "null cannot be cast to non-null type com.yandex.div.evaluable.types.Color");
        return Double.valueOf(ColorFunctionsKt.toColorFloatComponentValue(function1.invoke((Color) objFirst).intValue()));
    }
}
