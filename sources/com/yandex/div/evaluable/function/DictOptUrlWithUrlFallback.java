...
public abstract class DictOptUrlWithUrlFallback extends Function {
    ...
    private final List<FunctionArgument> declaredArgs = CollectionsKt.listOf((Object[]) new FunctionArgument[]{new FunctionArgument(EvaluableType.URL, false, 2, null), new FunctionArgument(EvaluableType.DICT, false, 2, null), new FunctionArgument(EvaluableType.STRING, true)});
    ...
    protected Object mo6115evaluateex6DHhM(EvaluationContext evaluationContext, Evaluable expressionContext, List<? extends Object> args) {
        ...
        String strM6235unboximpl = ((Url) obj).m6235unboximpl();
        Object objEvaluateSafe$default = DictFunctionsKt.evaluateSafe$default(args, Url.m6229boximpl(strM6235unboximpl), false, 4, null);
        String str = objEvaluateSafe$default instanceof String ? (String) objEvaluateSafe$default : null;
        return (str == null || (strSafeConvertToUrl = ArrayFunctionsKt.safeConvertToUrl(str)) == null) ? Url.m6229boximpl(strM6235unboximpl) : Url.m6229boximpl(strSafeConvertToUrl);
    }
}
