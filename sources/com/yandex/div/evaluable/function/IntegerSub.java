...
public final class IntegerSub extends Function {
    ...
    protected Object mo6115evaluateex6DHhM(EvaluationContext evaluationContext, Evaluable expressionContext, List<? extends Object> args) {
        ...
        for (Object objEvalSum$div_evaluable : args) {
            ...
            if (i != 0) {
                objEvalSum$div_evaluable = Evaluator.INSTANCE.evalSum$div_evaluable(Token.Operator.Binary.Sum.Minus.INSTANCE, Long.valueOf(jLongValue), objEvalSum$div_evaluable);
            }
            Intrinsics.checkNotNull(objEvalSum$div_evaluable, "null cannot be cast to non-null type kotlin.Long");
            jValueOf = Long.valueOf(((Long) objEvalSum$div_evaluable).longValue());
            i = i2;
        }
        return jValueOf;
    }
