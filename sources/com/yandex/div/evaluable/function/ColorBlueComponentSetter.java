    ...
    private ColorBlueComponentSetter() {
        super(new Function2<Color, Double, Color>() { // from class: com.yandex.div.evaluable.function.ColorBlueComponentSetter.1
            ...
            public /* bridge */ /* synthetic */ Color invoke(Color color, Double d) {
                return Color.m6217boximpl(m6178invokeGnj5c28(color.m6225unboximpl(), d.doubleValue()));
            }

            /* JADX INFO: renamed from: invoke-Gnj5c28, reason: not valid java name */
            public final int m6178invokeGnj5c28(int i, double d) {
                return Color.INSTANCE.m6226argbH0kstlE(Color.m6215alphaimpl(i), Color.m6223redimpl(i), Color.m6221greenimpl(i), ColorFunctionsKt.toColorIntComponentValue(d));
            }
        });
    }
