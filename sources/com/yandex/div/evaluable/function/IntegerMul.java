...
public final class IntegerMul extends Function {
    ...
    private static final List<FunctionArgument> declaredArgs = CollectionsKt.listOf(new FunctionArgument(EvaluableType.INTEGER, true));
    ...
    protected Object mo6115evaluateex6DHhM(EvaluationContext evaluationContext, Evaluable expressionContext, List<? extends Object> args) {
        ...
        for (Object objEvalFactor$div_evaluable : args) {
            ...
            long jLongValue = jValueOf.longValue();
            if (i != 0) {
                objEvalFactor$div_evaluable = Evaluator.INSTANCE.evalFactor$div_evaluable(Token.Operator.Binary.Factor.Multiplication.INSTANCE, Long.valueOf(jLongValue), objEvalFactor$div_evaluable);
            }
            Intrinsics.checkNotNull(objEvalFactor$div_evaluable, "null cannot be cast to non-null type kotlin.Long");
            jValueOf = Long.valueOf(((Long) objEvalFactor$div_evaluable).longValue());
            i = i2;
        }
        return jValueOf;
    }
