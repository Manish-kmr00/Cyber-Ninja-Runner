...
public final class GetArrayLength extends Function {
    ...
    private static final String name = POBNativeConstants.NATIVE_LENGTH;
    ...
    protected Object mo6115evaluateex6DHhM(EvaluationContext evaluationContext, Evaluable expressionContext, List<? extends Object> args) {
        ...
        return Long.valueOf(((JSONArray) obj).length());
    }
}
