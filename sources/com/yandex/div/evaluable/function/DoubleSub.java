...
public final class DoubleSub extends Function {
    ...
    private static final List<FunctionArgument> declaredArgs = CollectionsKt.listOf(new FunctionArgument(EvaluableType.NUMBER, true));
    ...
    protected Object mo6115evaluateex6DHhM(EvaluationContext evaluationContext, Evaluable expressionContext, List<? extends Object> args) {
        ...
        int i = 0;
        for (Object objEvalSum$div_evaluable : args) {
            int i2 = i + 1;
            if (i < 0) {
            ...
            if (i != 0) {
                objEvalSum$div_evaluable = Evaluator.INSTANCE.evalSum$div_evaluable(Token.Operator.Binary.Sum.Minus.INSTANCE, Double.valueOf(dDoubleValue), objEvalSum$div_evaluable);
            }
            Intrinsics.checkNotNull(objEvalSum$div_evaluable, "null cannot be cast to non-null type kotlin.Double");
            dValueOf = Double.valueOf(((Double) objEvalSum$div_evaluable).doubleValue());
            i = i2;
        }
        return dValueOf;
    }
