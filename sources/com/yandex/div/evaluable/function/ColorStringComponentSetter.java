...
public abstract class ColorStringComponentSetter extends Function {
    ...
    protected Object mo6115evaluateex6DHhM(EvaluationContext evaluationContext, Evaluable expressionContext, List<? extends Object> args) {
        ...
        try {
            return this.componentSetter.m6174invokeex6DHhM(evaluationContext, expressionContext, CollectionsKt.listOf(Color.m6217boximpl(Color.INSTANCE.m6227parseC4zCDoM((String) obj)), args.get(1)));
