...
public final class IntegerDiv extends Function {
    ...
    private static final List<FunctionArgument> declaredArgs = CollectionsKt.listOf((Object[]) new FunctionArgument[]{new FunctionArgument(EvaluableType.INTEGER, false, 2, null), new FunctionArgument(EvaluableType.INTEGER, false, 2, null)});
    ...
    protected Object mo6115evaluateex6DHhM(EvaluationContext evaluationContext, Evaluable expressionContext, List<? extends Object> args) {
        ...
        Intrinsics.checkNotNull(objFirst, "null cannot be cast to non-null type kotlin.Long");
        long jLongValue = ((Long) objFirst).longValue();
        Object objLast = CollectionsKt.last(args);
        Intrinsics.checkNotNull(objLast, "null cannot be cast to non-null type kotlin.Long");
        long jLongValue2 = ((Long) objLast).longValue();
        if (jLongValue2 == 0) {
