...
public final class ColorArgb extends Function {
    ...
    private static final List<FunctionArgument> declaredArgs = CollectionsKt.listOf((Object[]) new FunctionArgument[]{new FunctionArgument(EvaluableType.NUMBER, false, 2, null), new FunctionArgument(EvaluableType.NUMBER, false, 2, null), new FunctionArgument(EvaluableType.NUMBER, false, 2, null), new FunctionArgument(EvaluableType.NUMBER, false, 2, null)});
    ...
    protected Object mo6115evaluateex6DHhM(EvaluationContext evaluationContext, Evaluable expressionContext, List<? extends Object> args) {
        ...
        try {
            ...
            return Color.m6217boximpl(Color.INSTANCE.m6226argbH0kstlE(colorIntComponentValue, colorIntComponentValue2, colorIntComponentValue3, ColorFunctionsKt.toColorIntComponentValue(((Double) obj4).doubleValue())));
        } catch (IllegalArgumentException unused) {
            EvaluableExceptionKt.throwExceptionOnFunctionEvaluationFailed$default(getName(), args, EvaluableExceptionKt.REASON_OUT_OF_RANGE, null, 8, null);
