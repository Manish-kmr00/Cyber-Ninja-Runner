...
public final class DoubleMax extends Function {
    ...
    protected Object mo6115evaluateex6DHhM(EvaluationContext evaluationContext, Evaluable expressionContext, List<? extends Object> args) {
        ...
        for (Object obj : args) {
            ...
            objFirst = Double.valueOf(Math.max(dDoubleValue, ((Double) obj).doubleValue()));
        }
        return objFirst;
    }
}
