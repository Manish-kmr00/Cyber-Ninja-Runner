...
public final class UrlToString extends Function {
    ...
    protected Object mo6115evaluateex6DHhM(EvaluationContext evaluationContext, Evaluable expressionContext, List<? extends Object> args) {
        ...
        Intrinsics.checkNotNull(objFirst, "null cannot be cast to non-null type com.yandex.div.evaluable.types.Url");
        return Url.m6234toStringimpl(((Url) objFirst).m6235unboximpl());
    }
}
