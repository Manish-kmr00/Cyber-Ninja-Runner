...
public final class TestRegex extends Function {
    ...
    protected Object mo6115evaluateex6DHhM(EvaluationContext evaluationContext, Evaluable expressionContext, List<? extends Object> args) {
        ...
        try {
            ...
            for (Object objReplace$default : list) {
                if (objReplace$default instanceof String) {
                    objReplace$default = StringsKt.replace$default((String) objReplace$default, "\\", "\\\\", false, 4, (Object) null);
                }
                arrayList.add(objReplace$default);
            }
