...
public final class GetStoredUrlValueWithStringFallback extends Function {
    ...
    private static final List<FunctionArgument> declaredArgs = CollectionsKt.listOf((Object[]) new FunctionArgument[]{new FunctionArgument(EvaluableType.STRING, false, 2, null), new FunctionArgument(EvaluableType.STRING, false, 2, null)});
    ...
    protected Object mo6115evaluateex6DHhM(EvaluationContext evaluationContext, Evaluable expressionContext, List<? extends Object> args) {
        ...
        String strM6235unboximpl = obj3 instanceof Url ? ((Url) obj3).m6235unboximpl() : null;
        if (strM6235unboximpl != null || (strM6235unboximpl = ArrayFunctionsKt.safeConvertToUrl(str)) != null) {
            return Url.m6229boximpl(strM6235unboximpl);
        }
        EvaluableExceptionKt.throwExceptionOnFunctionEvaluationFailed$default(getName(), args, EvaluableExceptionKt.REASON_CONVERT_TO_URL, null, 8, null);
