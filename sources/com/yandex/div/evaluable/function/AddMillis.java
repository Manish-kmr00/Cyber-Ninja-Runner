...
public final class AddMillis extends Function {
    ...
    protected Object mo6115evaluateex6DHhM(EvaluationContext evaluationContext, Evaluable expressionContext, List<? extends Object> args) {
        ...
        return new DateTime(dateTime.getTimestampMillis() + ((Long) obj2).longValue(), dateTime.getTimezone());
    }
}
