...
public final class DoubleCopySign extends Function {
    ...
    private static final List<FunctionArgument> declaredArgs = CollectionsKt.listOf((Object[]) new FunctionArgument[]{new FunctionArgument(EvaluableType.NUMBER, false, 2, null), new FunctionArgument(EvaluableType.NUMBER, false, 2, null)});
    private static final EvaluableType resultType = EvaluableType.NUMBER;
    private static final boolean isPure = true;

    private DoubleCopySign() {
    }
    ...
    protected Object mo6115evaluateex6DHhM(EvaluationContext evaluationContext, Evaluable expressionContext, List<? extends Object> args) {
        ...
        Intrinsics.checkNotNull(objFirst, "null cannot be cast to non-null type kotlin.Double");
        double dDoubleValue = ((Double) objFirst).doubleValue();
        Object objLast = CollectionsKt.last(args);
        Intrinsics.checkNotNull(objLast, "null cannot be cast to non-null type kotlin.Double");
        return Double.valueOf(Math.copySign(dDoubleValue, ((Double) objLast).doubleValue()));
    }
}
