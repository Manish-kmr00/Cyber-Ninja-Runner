...
public final class StringToInteger extends Function {
    ...
    protected Object mo6115evaluateex6DHhM(EvaluationContext evaluationContext, Evaluable expressionContext, List<? extends Object> args) {
        ...
        try {
            return Long.valueOf(Long.parseLong((String) objFirst));
        } catch (NumberFormatException e) {
            EvaluableExceptionKt.throwExceptionOnFunctionEvaluationFailed(getName(), args, EvaluableExceptionKt.REASON_CONVERT_TO_INTEGER, e);
