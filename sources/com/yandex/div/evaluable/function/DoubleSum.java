...
public final class DoubleSum extends Function {
    ...
    protected Object mo6115evaluateex6DHhM(EvaluationContext evaluationContext, Evaluable expressionContext, List<? extends Object> args) {
        ...
        while (it.hasNext()) {
            Object objEvalSum$div_evaluable = Evaluator.INSTANCE.evalSum$div_evaluable(Token.Operator.Binary.Sum.Plus.INSTANCE, Double.valueOf(dValueOf.doubleValue()), it.next());
