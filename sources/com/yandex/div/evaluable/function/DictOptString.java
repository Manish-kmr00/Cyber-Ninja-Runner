...
public abstract class DictOptString extends Function {
    ...
    public DictOptString() {
        ...
        this.declaredArgs = CollectionsKt.listOf((Object[]) new FunctionArgument[]{new FunctionArgument(EvaluableType.STRING, z, i, defaultConstructorMarker), new FunctionArgument(EvaluableType.DICT, z, i, defaultConstructorMarker), new FunctionArgument(EvaluableType.STRING, true)});
    }
