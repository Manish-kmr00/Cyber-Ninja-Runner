...
public final class GetUrlValueWithUrlFallback extends Function {
    ...
    private static final List<FunctionArgument> declaredArgs = CollectionsKt.listOf((Object[]) new FunctionArgument[]{new FunctionArgument(EvaluableType.STRING, false, 2, null), new FunctionArgument(EvaluableType.URL, false, 2, null)});
    ...
    protected Object mo6115evaluateex6DHhM(EvaluationContext evaluationContext, Evaluable expressionContext, List<? extends Object> args) {
        ...
        String strM6235unboximpl = obj2 instanceof Url ? ((Url) obj2).m6235unboximpl() : null;
        if (strM6235unboximpl != null) {
