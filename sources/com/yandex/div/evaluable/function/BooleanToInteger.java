...
public final class BooleanToInteger extends Function {
    ...
    private static final List<FunctionArgument> declaredArgs = CollectionsKt.listOf(new FunctionArgument(EvaluableType.BOOLEAN, false, 2, null));
    ...
    protected Object mo6115evaluateex6DHhM(EvaluationContext evaluationContext, Evaluable expressionContext, List<? extends Object> args) {
        ...
        Intrinsics.checkNotNull(objFirst, "null cannot be cast to non-null type kotlin.Boolean");
        return Long.valueOf(((Boolean) objFirst).booleanValue() ? 1L : 0L);
    }
}
