...
public final class h8 {
    ...
    public static TextView c(Context context) {
        ...
        i8 i8Var = i8.f;
        Intrinsics.checkNotNullParameter(context, "context");
        textView.setTextSize(0, oh2.a(context, i8Var.a(context)));
    ...
    public static ProgressBar d(Context context) {
        ...
        progressBar.setProgressDrawable(g8.a());
    ...
    private static ImageView a(Context context, String str, int i) {
        ...
        ColorDrawable colorDrawable = g8.f8976a;
        ColorDrawable colorDrawable2 = new ColorDrawable(f8.a());
