...
public final class gw1 implements zc0<ur1> {
    ...
    public gw1(gd0<ur1> rewardedAdLoadController, uu1 sdkEnvironmentModule, z51 infoProvider) {
        ...
        this.f9040a = rewardedAdLoadController;
        this.b = infoProvider;
        Context contextL = rewardedAdLoadController.l();
        o3 o3VarF = rewardedAdLoadController.f();
        this.e = o3VarF;
        this.f = new p71(o3VarF);
        g5 g5VarI = rewardedAdLoadController.i();
    ...
    private final class a implements wq1 {
        ...
        public final void a(w3 adRequestError) {
            ...
            qt1Var.a(context, this.f9041a, this.c.f);
            qt1 qt1Var2 = this.c.c;
            Context context2 = this.b;
            Intrinsics.checkNotNullExpressionValue(context2, "context");
            qt1Var2.a(context2, this.f9041a, (q71) null);
        }

        @Override // com.yandex.mobile.ads.impl.wq1
        public final void a(u61 nativeAdResponse) {
            Intrinsics.checkNotNullParameter(nativeAdResponse, "nativeAdResponse");
            q71 q71Var = new q71(this.f9041a, nativeAdResponse, this.c.e);
            qt1 qt1Var = this.c.c;
            Context context = this.b;
            Intrinsics.checkNotNullExpressionValue(context, "context");
            qt1Var.a(context, this.f9041a, this.c.f);
            ...
            Context context2 = this.b;
            Intrinsics.checkNotNullExpressionValue(context2, "context");
            qt1Var2.a(context2, this.f9041a, q71Var);
        }
    }
    ...
    private final class b implements v91.b {
        ...
        public final void a(w3 adRequestError) {
            ...
            gw1.this.i = null;
            gw1.this.f9040a.b(adRequestError);
        }
