...
public final class FirstPartyData$$serializer implements GeneratedSerializer<FirstPartyData> {
    ...
    public FirstPartyData deserialize(Decoder decoder) {
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            objDecodeNullableSerializableElement5 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 0, SessionContext$$serializer.INSTANCE, null);
            objDecodeNullableSerializableElement = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 1, Demographic$$serializer.INSTANCE, null);
            objDecodeNullableSerializableElement2 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 2, Location$$serializer.INSTANCE, null);
            objDecodeNullableSerializableElement3 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 3, Revenue$$serializer.INSTANCE, null);
            objDecodeNullableSerializableElement4 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 4, new LinkedHashMapSerializer(StringSerializer.INSTANCE, StringSerializer.INSTANCE), null);
            i = 31;
        } else {
            boolean z2 = true;
            int i2 = 0;
            ...
            while (z2) {
                ...
                if (iDecodeElementIndex == -1) {
                    ...
                    if (iDecodeElementIndex == 1) {
                        ...
                        objDecodeNullableSerializableElement10 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 4, new LinkedHashMapSerializer(StringSerializer.INSTANCE, StringSerializer.INSTANCE), objDecodeNullableSerializableElement10);
                        i2 |= 16;
                    }
                    z = false;
                } else {
        ...
        return new FirstPartyData(i, (SessionContext) objDecodeNullableSerializableElement5, (Demographic) objDecodeNullableSerializableElement, (Location) objDecodeNullableSerializableElement2, (Revenue) objDecodeNullableSerializableElement3, (Map) objDecodeNullableSerializableElement4, null);
    }
