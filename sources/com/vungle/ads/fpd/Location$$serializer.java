...
public final class Location$$serializer implements GeneratedSerializer<Location> {
    ...
    public Location deserialize(Decoder decoder) {
        ...
        return new Location(i, (String) objDecodeNullableSerializableElement3, (String) objDecodeNullableSerializableElement, (Integer) objDecodeNullableSerializableElement2, null);
    }
