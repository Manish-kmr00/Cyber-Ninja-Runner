...
public final class MRAIDAdWidget extends RelativeLayout {
        ...
        if (webView != null) {
            webView.setOnTouchListener(new View.OnTouchListener() { // from class: com.vungle.ads.internal.ui.view.MRAIDAdWidget$$ExternalSyntheticLambda0
                ...
                public final boolean onTouch(View view, MotionEvent motionEvent) {
                    return MRAIDAdWidget.m6098bindListeners$lambda0(this.f$0, view, motionEvent);
                }
            });
        }
    }
    ...
    public static final boolean m6098bindListeners$lambda0(MRAIDAdWidget this$0, View view, MotionEvent motionEvent) {
