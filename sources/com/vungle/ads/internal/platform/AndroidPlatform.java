...
public final class AndroidPlatform implements Platform {
    ...
    public void getUserAgentLazy(final Consumer<String> consumer) {
        ...
        this.uaExecutor.execute(new Runnable() { // from class: com.vungle.ads.internal.platform.AndroidPlatform$$ExternalSyntheticLambda0
            ...
            public final void run() {
                AndroidPlatform.m6065getUserAgentLazy$lambda0(this.f$0, consumer);
            }
        });
    }
    ...
    public static final void m6065getUserAgentLazy$lambda0(AndroidPlatform this$0, Consumer consumer) {
    ...
    private final AdvertisingInfo getAmazonAdvertisingInfo() {
        ...
        try {
            ...
            Logger.INSTANCE.w(TAG, "Error getting Amazon advertising info: Setting not found.", e);
        } catch (Exception e2) {
            Logger.INSTANCE.w(TAG, "Error getting Amazon advertising info", e2);
        }
            ...
            try {
                ...
                appSetIdInfo.addOnSuccessListener(new OnSuccessListener() { // from class: com.vungle.ads.internal.platform.AndroidPlatform$$ExternalSyntheticLambda1
                    ...
                    public final void onSuccess(Object obj) {
                        AndroidPlatform.m6066updateAppSetID$lambda2(this.f$0, (AppSetIdInfo) obj);
                    }
                });
            } catch (Exception e) {
    ...
    public static final void m6066updateAppSetID$lambda2(AndroidPlatform this$0, AppSetIdInfo appSetIdInfo) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
