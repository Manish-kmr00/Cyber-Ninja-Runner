...
public final class ConfigPayload$UserPrivacy$$serializer implements GeneratedSerializer<ConfigPayload.UserPrivacy> {
    ...
    public ConfigPayload.UserPrivacy deserialize(Decoder decoder) {
        ...
        return new ConfigPayload.UserPrivacy(i, (ConfigPayload.GDPRSettings) objDecodeNullableSerializableElement, (ConfigPayload.IABSettings) objDecodeNullableSerializableElement2, (SerializationConstructorMarker) null);
    }
