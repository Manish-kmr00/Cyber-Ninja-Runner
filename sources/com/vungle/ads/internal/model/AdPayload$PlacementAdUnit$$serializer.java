...
public final class AdPayload$PlacementAdUnit$$serializer implements GeneratedSerializer<AdPayload.PlacementAdUnit> {
    ...
    static {
        ...
        pluginGeneratedSerialDescriptor.addElement(t.c, true);
    ...
    public AdPayload.PlacementAdUnit deserialize(Decoder decoder) {
        ...
        return new AdPayload.PlacementAdUnit(i, (String) objDecodeNullableSerializableElement, (AdPayload.AdUnit) objDecodeNullableSerializableElement2, (SerializationConstructorMarker) null);
    }
