...
public final class CommonRequestBody$RequestExt$$serializer implements GeneratedSerializer<CommonRequestBody.RequestExt> {
    ...
    public CommonRequestBody.RequestExt deserialize(Decoder decoder) {
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            objDecodeNullableSerializableElement3 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 0, StringSerializer.INSTANCE, null);
            ...
            while (z) {
                ...
                if (iDecodeElementIndex == -1) {
                    ...
                    objDecodeNullableSerializableElement4 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 0, StringSerializer.INSTANCE, objDecodeNullableSerializableElement4);
                    i2 |= 1;
        ...
        return new CommonRequestBody.RequestExt(i, (String) objDecodeNullableSerializableElement3, (String) objDecodeNullableSerializableElement, (Long) objDecodeNullableSerializableElement2, (SerializationConstructorMarker) null);
    }
    ...
    public void serialize(Encoder encoder, CommonRequestBody.RequestExt value) {
        ...
        CommonRequestBody.RequestExt.write$Self(value, compositeEncoderBeginStructure, descriptor2);
