...
public final class CommonRequestBody$User$$serializer implements GeneratedSerializer<CommonRequestBody.User> {
    ...
    static {
        ...
        pluginGeneratedSerialDescriptor.addElement(RemoteConfigFeature.UserConsent.CCPA, true);
    ...
    public CommonRequestBody.User deserialize(Decoder decoder) {
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            objDecodeNullableSerializableElement5 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 0, CommonRequestBody$GDPR$$serializer.INSTANCE, null);
            objDecodeNullableSerializableElement = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 1, CommonRequestBody$CCPA$$serializer.INSTANCE, null);
            objDecodeNullableSerializableElement2 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 2, CommonRequestBody$COPPA$$serializer.INSTANCE, null);
            objDecodeNullableSerializableElement3 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 3, FirstPartyData$$serializer.INSTANCE, null);
            objDecodeNullableSerializableElement4 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 4, CommonRequestBody$IAB$$serializer.INSTANCE, null);
            i = 31;
        } else {
            boolean z = true;
            int i2 = 0;
        ...
        return new CommonRequestBody.User(i, (CommonRequestBody.GDPR) objDecodeNullableSerializableElement5, (CommonRequestBody.CCPA) objDecodeNullableSerializableElement, (CommonRequestBody.COPPA) objDecodeNullableSerializableElement2, (FirstPartyData) objDecodeNullableSerializableElement3, (CommonRequestBody.IAB) objDecodeNullableSerializableElement4, (SerializationConstructorMarker) null);
    }
