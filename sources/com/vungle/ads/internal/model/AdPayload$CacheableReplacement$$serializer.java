...
public final class AdPayload$CacheableReplacement$$serializer implements GeneratedSerializer<AdPayload.CacheableReplacement> {
    ...
    public AdPayload.CacheableReplacement deserialize(Decoder decoder) {
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            ...
            while (z) {
                ...
                if (iDecodeElementIndex == -1) {
                    ...
                    objDecodeNullableSerializableElement6 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 2, BooleanSerializer.INSTANCE, objDecodeNullableSerializableElement6);
                    i2 |= 4;
                }
            }
        ...
        return new AdPayload.CacheableReplacement(i, (String) objDecodeNullableSerializableElement3, (String) objDecodeNullableSerializableElement, (Boolean) objDecodeNullableSerializableElement2, (SerializationConstructorMarker) null);
    }
