...
public final class AdPayload$AdSizeInfo$$serializer implements GeneratedSerializer<AdPayload.AdSizeInfo> {
    ...
    public AdPayload.AdSizeInfo deserialize(Decoder decoder) {
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            ...
            objDecodeNullableSerializableElement2 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 1, IntSerializer.INSTANCE, null);
            i = 3;
        } else {
            boolean z = true;
            int i2 = 0;
        ...
        return new AdPayload.AdSizeInfo(i, (Integer) objDecodeNullableSerializableElement, (Integer) objDecodeNullableSerializableElement2, (SerializationConstructorMarker) null);
    }
