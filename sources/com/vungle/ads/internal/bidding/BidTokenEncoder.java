...
public final class BidTokenEncoder {
    ...
    private final BiddingTokenInfo generateBidToken() {
        ...
        try {
            ...
            Logger.INSTANCE.d(TAG, "BidToken: " + strConstructV6Token$vungle_ads_release);
            try {
    ...
    private static final VungleApiClient m6033constructV6Token$lambda0(Lazy<VungleApiClient> lazy) {
    ...
    public final String constructV6Token$vungle_ads_release() {
        ...
        CommonRequestBody commonRequestBodyRequestBody = m6033constructV6Token$lambda0(LazyKt.lazy(LazyThreadSafetyMode.SYNCHRONIZED, (Function0) new Function0<VungleApiClient>() { // from class: com.vungle.ads.internal.bidding.BidTokenEncoder$constructV6Token$$inlined$inject$1
