...
public final class VungleApiClient {
    ...
    public VungleApiClient(final Context applicationContext, Platform platform, FilePreferences filePreferences) {
        ...
        this.responseInterceptor = new Interceptor() { // from class: com.vungle.ads.internal.network.VungleApiClient$$ExternalSyntheticLambda0
            ...
            public final okhttp3.Response intercept(Interceptor.Chain chain) {
                return VungleApiClient.m6059responseInterceptor$lambda0(this.f$0, chain);
            }
        };
    ...
    /* JADX INFO: compiled from: VungleApiClient.kt */
    @Metadata(d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\"\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\r\u0010\u000e\u001a\u00020\u000fH\u0000¢\u0006\u0002\b\u0010R\u0014\u0010\u0003\u001a\u00020\u0004X\u0080D¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006R\u000e\u0010\u0007\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\tX\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\n\u001a\b\u0012\u0004\u0012\u00020\f0\u000bX\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\r\u001a\b\u0012\u0004\u0012\u00020\f0\u000bX\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0011"}, d2 = {"Lcom/vungle/ads/internal/network/VungleApiClient$Companion;", "", "()V", "BASE_URL", "", "getBASE_URL$vungle_ads_release", "()Ljava/lang/String;", "TAG", "json", "Lkotlinx/serialization/json/Json;", "logInterceptors", "", "Lokhttp3/Interceptor;", "networkInterceptors", TimerController.RESET_COMMAND, "", "reset$vungle_ads_release", "vungle-ads_release"}, k = 1, mv = {1, 7, 1}, xi = 48)
    ...
    public static final okhttp3.Response m6059responseInterceptor$lambda0(VungleApiClient this$0, Interceptor.Chain chain) {
    ...
    private final okhttp3.Response defaultErrorResponse(Request request) {
        return new okhttp3.Response.Builder().request(request).code(500).protocol(Protocol.HTTP_1_1).message("Server is busy").body(ResponseBody.INSTANCE.create("{\"Error\":\"Server is busy\"}", MediaType.INSTANCE.parse("application/json; charset=utf-8"))).build();
    }
    ...
    public final ErrorInfo pingTPAT(String url, Map<String, String> headers, String requestBody, HttpMethod requestType, LogEntry logEntry) {
        ...
        if (url.length() == 0 || HttpUrl.INSTANCE.parse(url) == null) {
            return new ErrorInfo(Sdk.SDKError.Reason.TPAT_ERROR, "Invalid URL : " + url, true);
        }
        try {
            if (!NetworkSecurityPolicy.getInstance().isCleartextTrafficPermitted(new URL(url).getHost()) && URLUtil.isHttpUrl(url)) {
                return new ErrorInfo(Sdk.SDKError.Reason.TPAT_ERROR, "Clear Text Traffic is blocked", false, 4, null);
            }
            try {
                ...
                return new ErrorInfo(Sdk.SDKError.Reason.TPAT_ERROR, "Tpat failed with error: " + numValueOf + ", message: " + (responseExecute != null ? responseExecute.message() : null), false, 4, null);
            } catch (Exception e) {
                ...
                return new ErrorInfo(reason, localizedMessage, false, 4, null);
            }
            ...
            return new ErrorInfo(reason2, localizedMessage2, true);
        }
    }
