...
public final class BannerView extends RelativeLayout {
    ...
    public BannerView(final Context context, final Placement placement, AdPayload advertisement, VungleAdSize adSize, AdConfig adConfig, final AdPlayCallback adPlayCallback, BidPayload bidPayload) throws InstantiationException {
        ...
        try {
            ...
            OMTracker.Factory factoryM5959_init_$lambda2 = m5959_init_$lambda2(LazyKt.lazy(LazyThreadSafetyMode.SYNCHRONIZED, (Function0) new Function0<OMTracker.Factory>() { // from class: com.vungle.ads.BannerView$special$$inlined$inject$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
                }
            ...
            OMTracker oMTrackerMake = factoryM5959_init_$lambda2.make(z);
            ...
            VungleWebClient vungleWebClient = new VungleWebClient(advertisement, placement, m5958_init_$lambda1(lazy).getOFFLOAD_EXECUTOR(), null, m5960_init_$lambda3(lazy2), 8, null);
            vungleWebClient.setWebViewObserver(oMTrackerMake);
            MRAIDPresenter mRAIDPresenter = new MRAIDPresenter(mRAIDAdWidget, advertisement, placement, vungleWebClient, m5958_init_$lambda1(lazy).getJOB_EXECUTOR(), oMTrackerMake, bidPayload, m5960_init_$lambda3(lazy2));
        ...
        if (!this.presenterStarted.getAndSet(true)) {
            ...
            getImpressionTracker().addView(this, new ImpressionTracker.ImpressionListener() { // from class: com.vungle.ads.BannerView.onAttachedToWindow.1
                ...
                public void onViewInvisible(View view) {
                    ...
                    AnalyticsClient.logMetric$vungle_ads_release$default(AnalyticsClient.INSTANCE, new SingleValueMetric(Sdk.SDKMetric.SDKMetricType.VIEW_NOT_VISIBLE_ON_PLAY), BannerView.this.getAdvertisement().getLogEntry(), (String) null, 4, (Object) null);
                }
            });
        }
        renderAd();
    ...
    private static final Executors m5958_init_$lambda1(Lazy<? extends Executors> lazy) {
        return lazy.getValue();
    }

    /* JADX INFO: renamed from: _init_$lambda-2, reason: not valid java name */
    private static final OMTracker.Factory m5959_init_$lambda2(Lazy<OMTracker.Factory> lazy) {
        return lazy.getValue();
    }

    /* JADX INFO: renamed from: _init_$lambda-3, reason: not valid java name */
    private static final Platform m5960_init_$lambda3(Lazy<? extends Platform> lazy) {
        return lazy.getValue();
    }
}
