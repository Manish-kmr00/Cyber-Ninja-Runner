    ...
    static Bitmap transformResult(Request request, Bitmap bitmap, int i) {
        ...
        if (request.needsMatrixTransform() || i != 0) {
            ...
            if (request.centerCrop) {
                ...
                float f14 = f10 / f11;
                if (f9 > f14) {
                    int iCeil = (int) Math.ceil(i5 * (f14 / f9));
                    if ((request.centerCropGravity & 48) == 48) {
                        i15 = 0;
                    } else {
                        i15 = (request.centerCropGravity & 80) == 80 ? i5 - iCeil : (i5 - iCeil) / 2;
                    }
                    f12 = iFloor2 / iCeil;
                    i7 = iCeil;
                    i9 = 0;
                    ...
                    int iCeil2 = (int) Math.ceil(i4 * (f9 / f14));
                    if ((request.centerCropGravity & 3) == 3) {
                        i10 = 0;
                    } else {
                        i10 = (request.centerCropGravity & 5) == 5 ? i4 - iCeil2 : (i4 - iCeil2) / 2;
                    }
                    i9 = i10;
                    i6 = iCeil2;
                    i7 = i5;
                ...
                if (shouldResize(z, i4, i5, iFloor, iFloor2)) {
                ...
                if (request.centerInside) {
                    ...
                    if (shouldResize(z, i3, i2, iFloor, iFloor2)) {
                        matrix2.preScale(f15, f15);
                    }
                } else if ((iFloor != 0 || iFloor2 != 0) && (iFloor != i3 || iFloor2 != i2)) {
                    if (iFloor != 0) {
                        f = iFloor;
                        f2 = i3;
                    } else {
            ...
            bitmapCreateBitmap = Bitmap.createBitmap(bitmap, i13, i11, i14, i12, matrix2, true);
