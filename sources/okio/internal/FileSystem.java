...
public final class FileSystem {
    ...
    static final class C49841 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super Path>, Continuation<? super Unit>, Object> {
        ...
        C49841(Path path, okio.FileSystem fileSystem, boolean z, Continuation<? super C49841> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C49841 c49841 = new C49841(this.$dir, this.$this_commonListRecursively, this.$followSymlinks, continuation);
            c49841.L$0 = obj;
            return c49841;
        }
        ...
        public final Object invoke(SequenceScope<? super Path> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C49841) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final Sequence<Path> commonListRecursively(okio.FileSystem fileSystem, Path dir, boolean z) throws IOException {
        Intrinsics.checkNotNullParameter(fileSystem, "<this>");
        Intrinsics.checkNotNullParameter(dir, "dir");
        return SequencesKt.sequence(new C49841(dir, fileSystem, z, null));
    }
