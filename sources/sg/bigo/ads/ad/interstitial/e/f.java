...
public class f extends d {
    public f(sg.bigo.ads.ad.interstitial.e.b.a aVar, List<NativeAd> list, sg.bigo.ads.ad.interstitial.e.a.b bVar) {
        super(aVar, list, bVar);
    }

    @Override // sg.bigo.ads.ad.interstitial.e.d
    protected final b a() {
        int iA = sg.bigo.ads.common.utils.e.a(this.d, 8);
        float f = iA;
        return new b(f, f, 0.0f, 0.0f, new Rect(0, iA, 0, 0), this.h, new boolean[]{false, false, false, true}, this.g);
    }
    ...
    protected final List<View> b(a aVar) {
        ...
        if (!Objects.equals(aVar.f12793a.getTag(), Boolean.TRUE)) {
            a(aVar.f12793a);
            aVar.f12793a.setTag(Boolean.TRUE);
        }
        ...
        if (size == 2) {
            View viewA2 = sg.bigo.ads.common.utils.a.a(this.d, R.layout.bigo_ad_layout_interstitial_icon_item_cta_style2, this.f12810a, false);
            View viewA3 = sg.bigo.ads.common.utils.a.a(this.d, R.layout.bigo_ad_layout_interstitial_icon_item_cta_style2, this.f12810a, false);
            ...
            this.f12810a.addView(new Space(this.d), new LinearLayout.LayoutParams(sg.bigo.ads.common.utils.e.a(this.d, 31), iA));
