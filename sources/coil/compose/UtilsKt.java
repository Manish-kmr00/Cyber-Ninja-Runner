...
public final class UtilsKt {
    ...
    public static final float m4353constrainWidthK40F9xA(long j, float f) {
        return RangesKt.coerceIn(f, Constraints.m3801getMinWidthimpl(j), Constraints.m3799getMaxWidthimpl(j));
    }

    /* JADX INFO: renamed from: constrainHeight-K40F9xA, reason: not valid java name */
    public static final float m4352constrainHeightK40F9xA(long j, float f) {
        return RangesKt.coerceIn(f, Constraints.m3800getMinHeightimpl(j), Constraints.m3798getMaxHeightimpl(j));
    }
    ...
    public static final long m4354toIntSizeuvyYCjk(long j) {
        return IntSizeKt.IntSize(MathKt.roundToInt(Size.m1464getWidthimpl(j)), MathKt.roundToInt(Size.m1461getHeightimpl(j)));
    }
