...
public final class ConstraintsSizeResolver implements SizeResolver, LayoutModifier {
    private final MutableStateFlow<Constraints> _constraints = StateFlowKt.MutableStateFlow(Constraints.m3787boximpl(UtilsKt.getZeroConstraints()));
            ...
            public static final class AnonymousClass2<T> implements FlowCollector {
                ...
                public final Object emit(Object obj, Continuation continuation) throws Throwable {
                    ...
                    if (i == 0) {
                        ...
                        Size sizeM4320toSizeOrNullBRTryo0 = AsyncImageKt.m4320toSizeOrNullBRTryo0(((Constraints) obj).getValue());
                        if (sizeM4320toSizeOrNullBRTryo0 != null) {
                            anonymousClass1.label = 1;
                            if (flowCollector.emit(sizeM4320toSizeOrNullBRTryo0, anonymousClass1) == coroutine_suspended) {
    ...
    public MeasureResult mo33measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        this._constraints.setValue(Constraints.m3787boximpl(j));
        final Placeable placeableMo3124measureBRTryo0 = measurable.mo3124measureBRTryo0(j);
        return MeasureScope.layout$default(measureScope, placeableMo3124measureBRTryo0.getWidth(), placeableMo3124measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: coil.compose.ConstraintsSizeResolver$measure$1
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.place$default(placementScope, placeableMo3124measureBRTryo0, 0, 0, 0.0f, 4, null);
            }
        }, 4, null);
    }

    /* JADX INFO: renamed from: setConstraints-BRTryo0, reason: not valid java name */
    public final void m4330setConstraintsBRTryo0(long constraints) {
        this._constraints.setValue(Constraints.m3787boximpl(constraints));
    }
}
