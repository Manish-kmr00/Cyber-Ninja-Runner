...
public final class CrossfadePainter extends Painter {
    ...
    public long getIntrinsicSize() {
        return m4334computeIntrinsicSizeNHjbRc();
    }
    ...
    private final long m4334computeIntrinsicSizeNHjbRc() {
        Painter painter = this.start;
        long intrinsicSize = painter != null ? painter.getIntrinsicSize() : Size.INSTANCE.m1473getZeroNHjbRc();
        Painter painter2 = this.end;
        long intrinsicSize2 = painter2 != null ? painter2.getIntrinsicSize() : Size.INSTANCE.m1473getZeroNHjbRc();
        boolean z = intrinsicSize != Size.INSTANCE.m1472getUnspecifiedNHjbRc();
        boolean z2 = intrinsicSize2 != Size.INSTANCE.m1472getUnspecifiedNHjbRc();
        if (z && z2) {
            return SizeKt.Size(Math.max(Size.m1464getWidthimpl(intrinsicSize), Size.m1464getWidthimpl(intrinsicSize2)), Math.max(Size.m1461getHeightimpl(intrinsicSize), Size.m1461getHeightimpl(intrinsicSize2)));
        }
    ...
    private final void drawPainter(DrawScope drawScope, Painter painter, float f) {
        ...
        long jMo2125getSizeNHjbRc = drawScope.mo2125getSizeNHjbRc();
        long jM4333computeDrawSizex8L_9b0 = m4333computeDrawSizex8L_9b0(painter.getIntrinsicSize(), jMo2125getSizeNHjbRc);
        if (jMo2125getSizeNHjbRc == Size.INSTANCE.m1472getUnspecifiedNHjbRc() || Size.m1466isEmptyimpl(jMo2125getSizeNHjbRc)) {
            painter.m2200drawx_KDEd0(drawScope, jM4333computeDrawSizex8L_9b0, f, getColorFilter());
            return;
        }
        float f2 = 2;
        float fM1464getWidthimpl = (Size.m1464getWidthimpl(jMo2125getSizeNHjbRc) - Size.m1464getWidthimpl(jM4333computeDrawSizex8L_9b0)) / f2;
        float fM1461getHeightimpl = (Size.m1461getHeightimpl(jMo2125getSizeNHjbRc) - Size.m1461getHeightimpl(jM4333computeDrawSizex8L_9b0)) / f2;
        drawScope.getDrawContext().getTransform().inset(fM1464getWidthimpl, fM1461getHeightimpl, fM1464getWidthimpl, fM1461getHeightimpl);
        painter.m2200drawx_KDEd0(drawScope, jM4333computeDrawSizex8L_9b0, f, getColorFilter());
        float f3 = -fM1464getWidthimpl;
        float f4 = -fM1461getHeightimpl;
        drawScope.getDrawContext().getTransform().inset(f3, f4, f3, f4);
    }

    /* JADX INFO: renamed from: computeDrawSize-x8L_9b0, reason: not valid java name */
    private final long m4333computeDrawSizex8L_9b0(long srcSize, long dstSize) {
        return (srcSize == Size.INSTANCE.m1472getUnspecifiedNHjbRc() || Size.m1466isEmptyimpl(srcSize) || dstSize == Size.INSTANCE.m1472getUnspecifiedNHjbRc() || Size.m1466isEmptyimpl(dstSize)) ? dstSize : ScaleFactorKt.m3200timesUQTWf7w(srcSize, this.contentScale.mo3115computeScaleFactorH7hwNQA(srcSize, dstSize));
    }
}
