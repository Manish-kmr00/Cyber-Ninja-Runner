...
public final class AsyncImagePainter extends Painter implements RememberObserver {
    ...
    private final MutableStateFlow<Size> drawSize = StateFlowKt.MutableStateFlow(Size.m1452boximpl(Size.INSTANCE.m1473getZeroNHjbRc()));
    ...
    private int filterQuality = DrawScope.INSTANCE.m2127getDefaultFilterQualityfv9h1I();
    ...
    public final void m4322setFilterQualityvDHp3xo$coil_compose_base_release(int i) {
    ...
    public long getIntrinsicSize() {
        ...
        return painter != null ? painter.getIntrinsicSize() : Size.INSTANCE.m1472getUnspecifiedNHjbRc();
    }

    @Override // androidx.compose.ui.graphics.painter.Painter
    protected void onDraw(DrawScope drawScope) {
        this.drawSize.setValue(Size.m1452boximpl(drawScope.mo2125getSizeNHjbRc()));
        Painter painter = getPainter();
        if (painter != null) {
            painter.m2200drawx_KDEd0(drawScope, drawScope.mo2125getSizeNHjbRc(), getAlpha(), getColorFilter());
        }
    }
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: compiled from: AsyncImagePainter.kt */
        @Metadata(d1 = {"\u0000\f\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\u008a@"}, d2 = {"<anonymous>", "Lcoil/compose/AsyncImagePainter$State;", "it", "Lcoil/request/ImageRequest;"}, k = 3, mv = {1, 7, 1}, xi = 48)
                        ...
                        public static final class AnonymousClass2<T> implements FlowCollector {
                            ...
                            public final Object emit(Object obj, Continuation continuation) throws Throwable {
                                ...
                                if (i == 0) {
                                    ...
                                    coil.size.Size sizeM4327toSizeOrNulluvyYCjk = AsyncImagePainterKt.m4327toSizeOrNulluvyYCjk(((Size) obj).getPackedValue());
                                    if (sizeM4327toSizeOrNulluvyYCjk != null) {
                                        anonymousClass1.label = 1;
                                        if (flowCollector.emit(sizeM4327toSizeOrNulluvyYCjk, anonymousClass1) == coroutine_suspended) {
                                            return coroutine_suspended;
                                        }
                                    }
                                } else {
    ...
    public final Painter toPainter(Drawable drawable) {
        if (drawable instanceof BitmapDrawable) {
            return BitmapPainterKt.m2197BitmapPainterQZhYCtY$default(AndroidImageBitmap_androidKt.asImageBitmap(((BitmapDrawable) drawable).getBitmap()), 0L, 0L, this.filterQuality, 6, null);
        }
    ...
    /* JADX INFO: compiled from: AsyncImagePainter.kt */
    @Metadata(d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b7\u0018\u00002\u00020\u0001:\u0004\u0007\b\t\nB\u0007\b\u0004¢\u0006\u0002\u0010\u0002R\u0014\u0010\u0003\u001a\u0004\u0018\u00010\u0004X¦\u0004¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006\u0082\u0001\u0004\u000b\f\r\u000e¨\u0006\u000f"}, d2 = {"Lcoil/compose/AsyncImagePainter$State;", "", "()V", "painter", "Landroidx/compose/ui/graphics/painter/Painter;", "getPainter", "()Landroidx/compose/ui/graphics/painter/Painter;", "Empty", "Error", "Loading", InitializationStatus.SUCCESS, "Lcoil/compose/AsyncImagePainter$State$Empty;", "Lcoil/compose/AsyncImagePainter$State$Error;", "Lcoil/compose/AsyncImagePainter$State$Loading;", "Lcoil/compose/AsyncImagePainter$State$Success;", "coil-compose-base_release"}, k = 1, mv = {1, 7, 1}, xi = 48)
