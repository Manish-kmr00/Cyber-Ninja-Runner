...
public final class SingletonSubcomposeAsyncImageKt {
    ...
    public static final void m4349SubcomposeAsyncImageylYTKUw(final Object obj, final String str, Modifier modifier, Function4<? super SubcomposeAsyncImageScope, ? super AsyncImagePainter.State.Loading, ? super Composer, ? super Integer, Unit> function4, Function4<? super SubcomposeAsyncImageScope, ? super AsyncImagePainter.State.Success, ? super Composer, ? super Integer, Unit> function5, Function4<? super SubcomposeAsyncImageScope, ? super AsyncImagePainter.State.Error, ? super Composer, ? super Integer, Unit> function6, Function1<? super AsyncImagePainter.State.Loading, Unit> function1, Function1<? super AsyncImagePainter.State.Success, Unit> function2, Function1<? super AsyncImagePainter.State.Error, Unit> function3, Alignment alignment, ContentScale contentScale, float f, ColorFilter colorFilter, int i, Composer composer, final int i2, final int i3, final int i4) {
        ...
        Function4<? super SubcomposeAsyncImageScope, ? super AsyncImagePainter.State.Loading, ? super Composer, ? super Integer, Unit> function7 = (i4 & 8) != 0 ? null : function4;
        Function4<? super SubcomposeAsyncImageScope, ? super AsyncImagePainter.State.Success, ? super Composer, ? super Integer, Unit> function8 = (i4 & 16) != 0 ? null : function5;
        Function4<? super SubcomposeAsyncImageScope, ? super AsyncImagePainter.State.Error, ? super Composer, ? super Integer, Unit> function9 = (i4 & 32) != 0 ? null : function6;
        Function1<? super AsyncImagePainter.State.Loading, Unit> function10 = (i4 & 64) != 0 ? null : function1;
        Function1<? super AsyncImagePainter.State.Success, Unit> function11 = (i4 & 128) != 0 ? null : function2;
        Function1<? super AsyncImagePainter.State.Error, Unit> function12 = (i4 & 256) != 0 ? null : function3;
        ...
        int i6 = i2 << 3;
        int i7 = i5 << 3;
        SubcomposeAsyncImageKt.m4350SubcomposeAsyncImageQ4Kwu38(obj, str, ImageLoaderProvidableCompositionLocal.getCurrent(LocalImageLoaderKt.getLocalImageLoader(), composerStartRestartGroup, 6), modifier2, function7, function8, function9, function10, function11, function12, center, fit, f2, colorFilter2, iM2127getDefaultFilterQualityfv9h1I, composerStartRestartGroup, (i2 & 112) | IronSourceError.ERROR_NO_INTERNET_CONNECTION | (i6 & 7168) | (i6 & 57344) | (i6 & 458752) | (i6 & 3670016) | (i6 & 29360128) | (i6 & 234881024) | (i6 & 1879048192), ((i2 >> 27) & 14) | (i7 & 112) | (i7 & 896) | (i7 & 7168) | (i7 & 57344), 0);
        if (ComposerKt.isTraceInProgress()) {
        ...
        final Function4<? super SubcomposeAsyncImageScope, ? super AsyncImagePainter.State.Loading, ? super Composer, ? super Integer, Unit> function13 = function7;
        final Function4<? super SubcomposeAsyncImageScope, ? super AsyncImagePainter.State.Success, ? super Composer, ? super Integer, Unit> function14 = function8;
        final Function4<? super SubcomposeAsyncImageScope, ? super AsyncImagePainter.State.Error, ? super Composer, ? super Integer, Unit> function15 = function9;
        final Function1<? super AsyncImagePainter.State.Loading, Unit> function16 = function10;
        final Function1<? super AsyncImagePainter.State.Success, Unit> function17 = function11;
        final Function1<? super AsyncImagePainter.State.Error, Unit> function18 = function12;
        final Alignment alignment2 = center;
        final ContentScale contentScale2 = fit;
        final float f3 = f2;
        final ColorFilter colorFilter3 = colorFilter2;
        final int i8 = iM2127getDefaultFilterQualityfv9h1I;
    ...
    public static final void m4348SubcomposeAsyncImage10Xjiaw(final Object obj, final String str, Modifier modifier, Function1<? super AsyncImagePainter.State, ? extends AsyncImagePainter.State> function1, Function1<? super AsyncImagePainter.State, Unit> function2, Alignment alignment, ContentScale contentScale, float f, ColorFilter colorFilter, int i, final Function3<? super SubcomposeAsyncImageScope, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i2, final int i3, final int i4) {
        ...
        int i6 = i5 << 3;
        SubcomposeAsyncImageKt.m4351SubcomposeAsyncImagesKDTAoQ(obj, str, ImageLoaderProvidableCompositionLocal.getCurrent(LocalImageLoaderKt.getLocalImageLoader(), composerStartRestartGroup, 6), modifier2, defaultTransform, function4, center, fit, f2, colorFilter2, iM2127getDefaultFilterQualityfv9h1I, function3, composerStartRestartGroup, (i5 & 112) | IronSourceError.ERROR_NO_INTERNET_CONNECTION | (i6 & 7168) | (57344 & i6) | (458752 & i6) | (3670016 & i6) | (29360128 & i6) | (234881024 & i6) | (i6 & 1879048192), ((i5 >> 27) & 14) | ((i3 << 3) & 112), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ScopeUpdateScope scopeUpdateScopeEndRestartGroup = composerStartRestartGroup.endRestartGroup();
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: coil.compose.SingletonSubcomposeAsyncImageKt$SubcomposeAsyncImage$2
            ...
            public final void invoke(Composer composer2, int i8) {
                SingletonSubcomposeAsyncImageKt.m4348SubcomposeAsyncImage10Xjiaw(obj, str, modifier2, function5, function6, alignment2, contentScale2, f3, colorFilter3, i7, function3, composer2, i2 | 1, i3, i4);
            }
        });
    }
}
