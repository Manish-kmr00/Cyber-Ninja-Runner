...
public final class HardwareBitmaps {
    ...
    /* JADX WARN: Code duplicated, block: B:12:0x015f  */
    static {
        String str;
        ...
        if (i == 26) {
            ...
            if (str2 == null) {
                zContains = false;
            } else if (!StringsKt.startsWith$default(StringsKt.removePrefix(str2, (CharSequence) "SAMSUNG-"), "SM-", false, 2, (Object) null)) {
