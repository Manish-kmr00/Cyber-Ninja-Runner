...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    /* JADX WARN: Code duplicated, block: B:71:0x014c A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:72:0x014c A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:73:? A[LOOP:0: B:67:0x0097->B:73:?, LOOP_END, SYNTHETIC] */
    ...
    private final Request createTunnelRequest() throws IOException {
        Request requestBuild = new Request.Builder().url(this.route.address().url()).method("CONNECT", null).header(HttpHeaders.HOST, Util.toHostHeader(this.route.address().url(), true)).header("Proxy-Connection", HttpHeaders.KEEP_ALIVE).header("User-Agent", "okhttp/4.12.0").build();
